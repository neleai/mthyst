...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;it=rb_funcall(self,sy_Tests_bind_lb_0_rb__pl__fbc2,1,bind); goto alt1_2;
;goto accept1;
...
int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;it=rb_funcall(self,sy_Tests_bind_lb_0_rb__pl__fbc2,1,bind); goto alt2_2;
;goto accept2;
...
int oldpos3=ptr->pos;
alt3_1: ptr->pos=oldpos3;it=rb_funcall(self,sy_Tests_bind_lb_0_rb__pl__fbc2,1,bind);   it=Tests_abc(self ); FAILTEST(alt3_2); bind_aset(bind,1/*_result*/,it);
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;  it=Tests_foo(self ); FAILTEST(alt1_2); bind_aset(bind,0/*_result*/,it);
...
alt1_1: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_2);it=i_3; bind_aset(bind,0/*_result*/,it);
...
alt2_1: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,0/*_result*/,it);
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2; it=rb_obj_clone(s_a_0cc1); arg0=it; it=rb_funcall(self,sy_seq,1,arg0); FAILTEST(alt2_2);
;goto accept2;
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1; it=rb_obj_clone(s_a_0cc1); arg0=it; it=rb_funcall(self,sy_token,1,arg0); FAILTEST(alt1_2);it=i_1; bind_aset(bind,0/*_result*/,it);
...
rb_define_method(cls_Tests,"test",Tests_test,0);
 rb_eval_string("testversiontests('82b495559d92f50149acdc9c18cc073f')");}
