...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC('d') ... UC('d'):;  it=rb_str_new2("d"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("d");
 rb_ary_store(bind,0/*_result*/,it);  break;case UC('a') ... UC('a'):; unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC('a') ... UC('a'):;  it=rb_str_new2("a"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("a"); break;} it=rb_str_new2("c"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("c");
 rb_ary_store(bind,0/*_result*/,it);  break;case UC('b') ... UC('b'):; unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC('b') ... UC('b'):;  it=rb_str_new2("b"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("b"); break;} it=rb_str_new2("c"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("c");
...
rb_define_method(cls_Tests,"sw",Tests_sw,0);
 rb_eval_string("testversiontests('1ebd43e67bfa43982e204b2d4a385eaa')");}
