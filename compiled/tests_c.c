...
char chr1=*ame_curstr(self);  switch(chr1){case 100:;  it=rb_str_new2("d"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("d");
 rb_ary_store(bind,0/*_result*/,it);  break;case 97:; char chr2=*ame_curstr(self);  switch(chr2){case 97:;  it=rb_str_new2("a"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("a"); break;default:;   it=CALL(fails,0 ); FAILTEST(fail); break;} it=rb_str_new2("c"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("c");
 rb_ary_store(bind,0/*_result*/,it);  break;case 98:; char chr3=*ame_curstr(self);  switch(chr3){case 98:;  it=rb_str_new2("b"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("b"); break;default:;   it=CALL(fails,0 ); FAILTEST(fail); break;} it=rb_str_new2("c"); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("c");
...
rb_define_method(cls_Tests,"sw",Tests_sw,0);
 rb_eval_string("testversiontests('34cbab1cd31413974e9700080a176b24')");}
