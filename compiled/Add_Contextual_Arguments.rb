...
def Add_Contextual_Arguments__at__contex_5f56(bind)
@_context_arguments||={};bind[1]=@_context_arguments;bind[2]=@_context_arguments.dup
end
def Add_Contextual_Arguments__at__contex_cdb3(bind)
...
def Add_Contextual_Arguments__lp__at_cargs_lb__e1d6(bind)
(@cargs[src.ary[0]]) || FAIL
end
def Add_Contextual_Arguments__lp_src_dot_cla_2024(bind)
(src.class.attributes).map{|v| src.instance_variable_get("@"+v.to_s) }
end
def Add_Contextual_Arguments_bind_lb_1_rb__eq__9326(bind)
