...
VALUE profile_report_Inliner2(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  return Qnil;}VALUE Inliner2_root(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_from=Qnil,_to=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_name=Qnil,_args=Qnil,_body=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,__result=Qnil,_autovar_10=Qnil;VALUE bind2=bind_new2(4);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Inliner2__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;} _from=it;;
  it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;} _to=it;;
it=_from; _autovar_3=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar_3;ptr->len=1;
                   switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Rule*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_4=it;;
 break;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Inliner2_src_dot_name_80f3,1,bind2); _name=it;;
it=rb_funcall(self,sy_Inliner2_src_dot_args_2df5,1,bind2); _args=it;;
it=rb_funcall(self,sy_Inliner2_src_dot_loca_1df0,1,bind2);it=rb_funcall(self,sy_Inliner2_Seq_lb_src_dot__3406,1,bind2); _body=it;;

                   goto success2;
                   pass2: *ptr=oldpass2;if (1){it=failobj;goto fail;}
                   success2: *ptr=oldpass2;
                bind_aset(bind2,1,_name);bind_aset(bind2,2,_autovar_2);bind_aset(bind2,3,_args);bind_aset(bind2,4,_body);it=rb_funcall(self,sy_Inliner2__at_name_eq_bi_118d,1,bind2);_name=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;_args=bind_aget(bind2,3);;_body=bind_aget(bind2,4);;it=_to; _autovar_6=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Rule*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_7=it;;
 break;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   bind_aset(bind2,1,_autovar_2);it=rb_funcall(self,sy_Inliner2__at__contex_d6d5,1,bind2);_autovar_2=bind_aget(bind2,1);;  it=Inliner2_traverse(self ); if (it==failobj){it=failobj;goto pass4;} _autovar_9=it;;
 ...
 _autovar_10=it;;
bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_10);it=rb_funcall(self,sy_Inliner2__at__contex_cdb3,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_10=bind_aget(bind2,2);;
fail: return it;
}
VALUE Inliner2_traverse(VALUE self ){VALUE vals[0]; VALUE it ,_nvars=Qnil,_ivars=Qnil,_autovar=Qnil,_autovar_2=Qnil,_it=Qnil,__result=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);ptr->pos=ptr->len;it=rb_ary_new3(0); _nvars=it;;
it=rb_funcall(self,sy_Inliner2__lp_src_dot_cla_2024,1,bind2); _ivars=it;;
...
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Inliner2_traverse_item(self ); if (it==failobj){it=failobj;goto revert1;} _it=it;;
bind_aset(bind2,1,_nvars);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Inliner2_bind_lb_1_rb__sp__6af0,1,bind2);_nvars=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto pass2;};
 accept1:;
                   ...
                   pass1: *ptr=oldpass1;if (1){it=failobj;goto fail;}
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,_ivars);bind_aset(bind2,2,_nvars);it=rb_funcall(self,sy_Inliner2_if_sp_bind_lb__1bed,1,bind2);_ivars=bind_aget(bind2,1);;_nvars=bind_aget(bind2,2);; __result=it;;

fail: return it;
}
VALUE Inliner2_traverse_item(VALUE self ){VALUE vals[0]; VALUE it ,__result=Qnil,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_ar=Qnil,_it=Qnil,_autovar_4=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_4,rb_obj_class(ame_curobj2(ptr))))){case 0/*AmethystAST*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3;   it=Inliner2_visit(self ); if (it==failobj){it=failobj;goto revert1;} __result=it;;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Inliner2_traverse(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Inliner2_traverse(self ); if (it==failobj){it=failobj;goto pass2;} _autovar_2=it;;
...
case 1/*Array*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_6,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos3=ptr->pos;int cut3=0;
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Inliner2_visit(self ); if (it==failobj){it=failobj;goto revert6;} __result=it;;
...
alt4_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Inliner2_traverse_item(self ); if (it==failobj){it=failobj;goto revert8;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Inliner2_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
alt5_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Inliner2_traverse_item(self ); if (it==failobj){it=failobj;goto revert10;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Inliner2_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
case 2/*Object*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_7,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos6=ptr->pos;int cut6=0;
alt6_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Inliner2_visit(self ); if (it==failobj){it=failobj;goto revert12;} __result=it;;
...
VALUE Inliner2_visit(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_name=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_args=Qnil,__result=Qnil,_autovar_6=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Inliner2_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Inliner2__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_3=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_3);
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass1;} _name=it;;
bind_aset(bind2,1,_name);it=rb_funcall(self,sy_Inliner2__lp_bind_lb_1_rb__709e,1,bind2);_name=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto pass1;};it=rb_ary_new3(0); _autovar_4=it;;
int stop1=0; while(!stop1){ int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert1;} _autovar_5=it;;
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto pass1;};
 accept1:;
 } it=_autovar_4; _args=it;;

                   goto success1;
                   pass1: *ptr=oldpass1;if (1){it=failobj;goto fail;}
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,_autovar_2);bind_aset(bind2,2,_args);it=rb_funcall(self,sy_Inliner2_body_eq_bin_3feb,1,bind2);_autovar_2=bind_aget(bind2,1);;_args=bind_aget(bind2,2);; __result=it;;
 _autovar_6=it;;
bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_6);it=rb_funcall(self,sy_Inliner2__at__contex_cdb3,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_6=bind_aget(bind2,2);; break;
case 1/*Object*/:; bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Inliner2__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;if (1){it=failobj;goto fail;} break;
}
fail: return it;
}
