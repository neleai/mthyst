...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it); it=CALL(vars_in_Dataflowcb_4,1,bind); it=CALL(vars_in_Dataflowcb_5,1,bind); int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos7);   it=Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
alt4_1: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,7/*autovar*/,it); int oldpos11=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,10/*autovar*/,it); it=CALL(vars_in_Dataflowcb_8,1,bind); it=CALL(vars_in_Dataflowcb_5,1,bind); int oldpos14; while(1){oldpos14=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos14=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos14);   it=Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
alt6_1: ame_setpos(self,oldpos15);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,11/*autovar*/,it); int oldpos16=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass6);it=CALL(vars_in_Dataflowcb_2,1,bind); 
...
alt7_1: ame_setpos(self,oldpos17);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,13/*autovar*/,it); int oldpos18=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,13/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,14/*autovar*/,it); it=CALL(vars_in_Dataflowcb_10,1,bind); int oldpos19; while(1){oldpos19=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos19);   it=Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,15/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16/*autovar*/,it); it=CALL(visit_Dataflowcb_10,1,bind); int oldpos22=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,16/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,17/*autovar*/,it); it=CALL(vars_in_Dataflowcb_12,1,bind);   it=Dataflow_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
ame_setsrc(self,rb_ary_entry(bind,10/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,11/*prev*/,it); it=rb_ary_new3(0);
 rb_ary_store(bind,12/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break2);
 rb_ary_store(bind,13/*autovar*/,it); it=CALL(visit_Dataflowcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,12/*autovar*/);
 rb_ary_store(bind,0/*t*/,it); it=CALL(visit_Dataflowcb_7,1,bind); it=CALL(visit_Dataflowcb_8,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,15/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16/*autovar*/,it); it=CALL(visit_Dataflowcb_10,1,bind); int oldpos8=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,16/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,18/*autovar*/,it); int oldpos10; while(1){oldpos10=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break3);
 rb_ary_store(bind,19/*autovar*/,it); it=CALL(visit_Dataflowcb_11,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,18/*autovar*/);
 rb_ary_store(bind,7/*var*/,it);   it=Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
  ...
  it=Dataflow_eof(self ); FAILTEST(pass6);
	...
	if(fail6) goto pass5;
it=CALL(visit_Dataflowcb_12,1,bind); 
 rb_ary_store(bind,20/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
it=rb_ary_entry(bind,20/*autovar*/);
 ...
 rb_ary_store(bind,21/*autovar*/,it); int oldpos11=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,21/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,22/*join*/,it); it=CALL(visit_Dataflowcb_13,1,bind); 
 rb_ary_store(bind,23/*old*/,it); int oldpos12; while(1){oldpos12=ame_getpos(self); it=CALL(visit_Dataflowcb_14,1,bind);   it=Dataflow_traverse_item(self ); FAILTEST(break4);
 rb_ary_store(bind,24/*autovar*/,it); it=CALL(visit_Dataflowcb_15,1,bind); it=CALL(visit_Dataflowcb_16,1,bind);  if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos12); it=CALL(visit_Dataflowcb_17,1,bind); it=CALL(visit_Dataflowcb_18,1,bind); 
 rb_ary_store(bind,25/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
...
it=rb_ary_entry(bind,25/*autovar*/);
 ...
 rb_ary_store(bind,26/*autovar*/,it); int oldpos13=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,26/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos14; while(1){oldpos14=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos14=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos14); it=CALL(visit_Dataflowcb_19,1,bind); 
 rb_ary_store(bind,27/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
it=rb_ary_entry(bind,27/*autovar*/);
 ...
 rb_ary_store(bind,28/*autovar*/,it); int oldpos15=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,28/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,29/*autovar*/,it); it=CALL(visit_Dataflowcb_21,1,bind); int oldpos16=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,rb_ary_entry(bind,29/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,30/*to*/,it);   it=Dataflow_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
	success11: ame_setsrc(self,oldsrc11); ame_setpos(self,oldpos16); ame_setlen(self,oldlen11);
	if(fail11) goto pass10;
it=CALL(visit_Dataflowcb_22,1,bind); 
 rb_ary_store(bind,31/*autovar*/,it); it=CALL(visit_Dataflowcb_23,1,bind); int oldpos17=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,rb_ary_entry(bind,31/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Dataflow_traverse_item(self ); FAILTEST(pass12);
 rb_ary_store(bind,7/*var*/,it);   it=Dataflow_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
	success12: ame_setsrc(self,oldsrc12); ame_setpos(self,oldpos17); ame_setlen(self,oldlen12);
	if(fail12) goto pass10;
it=CALL(visit_Dataflowcb_24,1,bind); it=CALL(visit_Dataflowcb_25,1,bind); 
 rb_ary_store(bind,32/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
ame_setsrc(self,rb_ary_entry(bind,33/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,34/*autovar*/,it); int oldpos19; while(1){oldpos19=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break6);
 rb_ary_store(bind,35/*autovar*/,it); it=CALL(visit_Dataflowcb_26,1,bind);  if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos19); it=rb_ary_entry(bind,34/*autovar*/);
 rb_ary_store(bind,0/*t*/,it); it=CALL(visit_Dataflowcb_27,1,bind); 
 rb_ary_store(bind,36/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass13);
	goto success13;
	pass13: fail13=1;
...
it=rb_ary_entry(bind,36/*autovar*/);
 ...
 rb_ary_store(bind,37/*autovar*/,it); int oldpos20=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,rb_ary_entry(bind,37/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,0/*t*/,it); it=CALL(visit_Dataflowcb_28,1,bind); 
 rb_ary_store(bind,38/*act*/,it); it=CALL(visit_Dataflowcb_29,1,bind); it=CALL(visit_Dataflowcb_30,1,bind); 
 rb_ary_store(bind,39/*autovar*/,it); it=CALL(visit_Dataflowcb_31,1,bind); int oldpos21=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
...
ame_setsrc(self,rb_ary_entry(bind,40/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,41/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass16);
	goto success16;
	pass16: fail16=1;
...
it=rb_ary_entry(bind,41/*autovar*/);
 rb_ary_store(bind,7/*var*/,it);   it=Dataflow_eof(self ); FAILTEST(pass15);
	goto success15;
	pass15: fail15=1;
...
it=CALL(visit_Dataflowcb_32,1,bind); 
 rb_ary_store(bind,42/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass14);
	goto success14;
	pass14: fail14=1;
	success14: ame_setsrc(self,oldsrc14); ame_setpos(self,oldpos20); ame_setlen(self,oldlen14);
	if(fail14) goto fail;
it=rb_ary_entry(bind,42/*autovar*/);
 rb_ary_store(bind,9/*_result*/,it);  break;case 8:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,43/*autovar*/,it); int oldpos23=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
ame_setsrc(self,rb_ary_entry(bind,43/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Dataflow_traverse(self ); FAILTEST(pass17);
 rb_ary_store(bind,44/*autovar*/,it); int oldpos24=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
ame_setsrc(self,rb_ary_entry(bind,44/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,45/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass18);
	goto success18;
	pass18: fail18=1;
	success18: ame_setsrc(self,oldsrc18); ame_setpos(self,oldpos24); ame_setlen(self,oldlen18);
	if(fail18) goto pass17;
it=rb_ary_entry(bind,45/*autovar*/);
 rb_ary_store(bind,46/*autovar*/,it);   it=Dataflow_eof(self ); FAILTEST(pass17);
	goto success17;
	pass17: fail17=1;
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('469887fa3156ef131af36fb738aff018')");}
