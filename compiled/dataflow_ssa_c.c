...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(traverse_item_CloneLocalscb_2,1,bind);  arg0=it; it=CloneLocals_clas(self ,arg0); FAILTEST(alt1_3);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(traverse_item_CloneLocalscb_4,1,bind);  arg0=it; it=CloneLocals_clas(self ,arg0); FAILTEST(alt1_4);
...
it=rb_ary_new3(0); it=CALL(visit_CloneLocalscb_1,1,bind);  arg0=it; it=CloneLocals_clas(self ,arg0); FAILTEST(fail);
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dataflowcb_13,1,bind);  arg0=it; it=Dataflow_clas(self ,arg0); FAILTEST(alt1_4);
...
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dataflowcb_17,1,bind);  arg0=it; it=Dataflow_clas(self ,arg0); FAILTEST(alt1_5);
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dataflowcb_20,1,bind);  arg0=it; it=Dataflow_clas(self ,arg0); FAILTEST(alt1_6);
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dataflowcb_25,1,bind);  arg0=it; it=Dataflow_clas(self ,arg0); FAILTEST(alt1_7);
...
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dataflowcb_28,1,bind);  arg0=it; it=Dataflow_clas(self ,arg0); FAILTEST(alt1_8);
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dead_Code_Deleter3cb_4,1,bind);  arg0=it; it=Dead_Code_Deleter3_clas(self ,arg0); FAILTEST(alt1_3);
...
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Dead_Code_Deleter3cb_11,1,bind);  arg0=it; it=Dead_Code_Deleter3_clas(self ,arg0); FAILTEST(alt1_5);
