...
it=rb_funcall(self,sy_Dataflow_bind_lb_53_rb__04dc,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass22);
	goto success22;
	pass22: fail22=1;
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('a027c88eda3a8cdd39c3def23135b0cb')");}
