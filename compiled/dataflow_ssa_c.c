...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=c_300; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(pass1);
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6/*var*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos4); ame_setlen(self,oldlen4);
	if(fail4) goto pass3;
  it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
it=rb_ary_entry(bind,8/*autovar*/);
 ...
 rb_ary_store(bind,10/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos2); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
it=rb_ary_entry(bind,10/*autovar*/);
 rb_ary_store(bind,11/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Dataflowcb_5,1,bind);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,2/*autovar*/,it); it=CALL(vars_in_Dataflowcb_3,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4);   it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,4/*autovar*/,it); it=CALL(vars_in_Dataflowcb_4,1,bind);   it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,7/*autovar*/,it); it=CALL(vars_in_Dataflowcb_7,1,bind);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,9/*autovar*/,it); it=CALL(vars_in_Dataflowcb_8,1,bind); int oldpos12; while(1){oldpos12=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos12);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
ame_setsrc(self,rb_ary_entry(bind,10/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,11/*autovar*/,it); it=CALL(vars_in_Dataflowcb_9,1,bind); it=CALL(vars_in_Dataflowcb_10,1,bind); int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos15);   it=CALL(eof,0 ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ame_setsrc(self,rb_ary_entry(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,13/*autovar*/,it); it=CALL(vars_in_Dataflowcb_11,1,bind); it=CALL(vars_in_Dataflowcb_10,1,bind); int oldpos18; while(1){oldpos18=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos18=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos18);   it=CALL(eof,0 ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,14/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,15/*autovar*/,it); it=CALL(vars_in_Dataflowcb_12,1,bind);   it=CALL(eof,0 ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
...
ame_setsrc(self,rb_ary_entry(bind,16/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(vars_in_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,17/*autovar*/,it); it=CALL(vars_in_Dataflowcb_13,1,bind);   it=CALL(eof,0 ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
ame_setsrc(self,rb_ary_entry(bind,18/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,19/*autovar*/,it); it=CALL(vars_in_Dataflowcb_14,1,bind);   it=CALL(eof,0 ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
it=rb_ary_entry(bind,5/*autovar*/);
 rb_ary_store(bind,6/*var*/,it);   it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos2); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
ame_setsrc(self,rb_ary_entry(bind,14/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6/*var*/,it);   it=CALL(eof,0 ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos7); ame_setlen(self,oldlen6);
	if(fail6) goto pass5;
  it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos6); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=CALL(visit_Dataflowcb_9,1,bind); it=rb_ary_entry(bind,12/*app*/);
 rb_ary_store(bind,15/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos4); ame_setlen(self,oldlen4);
	if(fail4) goto fail;
...
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,18/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos9); ame_setlen(self,oldlen8);
	if(fail8) goto pass7;
it=rb_ary_entry(bind,18/*autovar*/);
 rb_ary_store(bind,19/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,22/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,25/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
ame_setsrc(self,rb_ary_entry(bind,26/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,30/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
...
ame_setsrc(self,rb_ary_entry(bind,31/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,35/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
...
ame_setsrc(self,rb_ary_entry(bind,37/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,38/*to*/,it);   it=CALL(eof,0 ); FAILTEST(pass14);
	goto success14;
	pass14: fail14=1;
...
ame_setsrc(self,rb_ary_entry(bind,39/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6/*var*/,it);   it=CALL(eof,0 ); FAILTEST(pass15);
	goto success15;
	pass15: fail15=1;
...
it=CALL(visit_Dataflowcb_28,1,bind); it=CALL(visit_Dataflowcb_29,1,bind); 
 rb_ary_store(bind,40/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass13);
	goto success13;
	pass13: fail13=1;
...
it=CALL(visit_Dataflowcb_33,1,bind); 
 rb_ary_store(bind,46/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass16);
	goto success16;
	pass16: fail16=1;
	success16: ame_setsrc(self,oldsrc16); ame_setpos(self,oldpos22); ame_setlen(self,oldlen16);
	if(fail16) goto fail;
it=rb_ary_entry(bind,46/*autovar*/);
 rb_ary_store(bind,8/*_result*/,it);  break;case 9:;   it=CALL(fails,0 ); FAILTEST(fail); break;}it=rb_ary_entry(bind,8/*_result*/);
return it;
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=c_305; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(pass1);
 rb_ary_store(bind,1/*autovar*/,it); int oldpos2=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Dead_Code_Deleter3cb_5,1,bind);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto break2;
...
unsigned char chr1=FIX2INT(rb_hash_aref(switchhashDead_Code_Deleter35,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;case 2:;case 4:;case 5:; unsigned char chr2=FIX2INT(rb_hash_aref(switchhashDead_Code_Deleter34,rb_obj_class(ame_curobj(self))));  switch(chr2){case 0:;case 1:;case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0/*autovar*/,it);  break;case 3:;   it=CALL(fails,0 ); FAILTEST(fail); break;}int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Dead_Code_Deleter3cb_1,1,bind); 
 rb_ary_store(bind,1/*this*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2);   it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
...
ame_setsrc(self,rb_ary_entry(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,1/*this*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=c_310; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(pass1);
 rb_ary_store(bind,1/*autovar*/,it); int oldpos2=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Forget_SSAcb_5,1,bind);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto break2;
...
VALUE Forget_SSA_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(3);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 it=c_308; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(fail);
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('8bf7f6d8a140c20ca3a687dad1bfa89f')");}
