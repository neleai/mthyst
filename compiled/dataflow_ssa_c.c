...
cstruct oldpass8=*ptr; int fail8=0;
          ptr->src=bind_aget(bind,40/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass13=*ptr; int fail13=0;
          ptr->src=bind_aget(bind,46/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_Dataflow_bind_lb_49_rb_,1,bind); cstruct oldpass15=*ptr; int fail15=0;
          ptr->src=bind_aget(bind,49/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass16=*ptr; int fail16=0;
          ptr->src=bind_aget(bind,51/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_Dataflow_bind_lb_52_rb_,1,bind); cstruct oldpass17=*ptr; int fail17=0;
          ptr->src=bind_aget(bind,52/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
   it=AmethystCore_anything(self ); FAILTEST(pass17); bind_aset(bind,53/*autovar*/,it);
cstruct oldpass18=*ptr; int fail18=0;
          ptr->src=bind_aget(bind,53/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass19=*ptr; int fail19=0;
          ptr->src=bind_aget(bind,57/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass20=*ptr; int fail20=0;
          ptr->src=bind_aget(bind,60/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('10a78b7c00ba0c660a1e6c210d4a6d28')");}
