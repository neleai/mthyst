...
static VALUE sy_Dataflow_Switch_lb__le_;
...
it=rb_funcall(self,sy_Dataflow__append_lp_12,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break10;} } } break10: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=bind_aget(bind,59/*autovar*/);it=rb_funcall(self,sy_Dataflow_or_end_lp_b,1,bind); it=rb_funcall(self,sy_Dataflow_Switch_lb__le_,1,bind);  bind_aset(bind,64/*autovar*/,it);
...
sy_Dataflow_Switch_lb__le_=rb_intern("Dataflow_Switch_lb__le_");
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('c1d6987b2fad5a4578b8560497e6a0c4')");}
