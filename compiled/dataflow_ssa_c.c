...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass4; accept1:;   it=var5/*autovar*/; var7/*var*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Dataflow__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
bind_aset(bind2,1,var0/*ary*/);it=rb_funcall(self,sy_Dataflow_bind_lb_1_rb__eq__fe02,1,bind2);var0/*ary*/=bind_aget(bind2,1);;int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Dataflow_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:; int oldpos2=ptr->pos;int cut1=0;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto pass1; accept3:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var2/*autovar*/=it;;
...
alt1_4: ptr->pos=oldpos2;goto break1;
 accept2:;
 break;
case 1/*Args*/:; int oldpos5=ptr->pos;int cut3=0;
...
;goto accept5;
alt3_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt3_3);
;goto accept5;
alt3_3: ptr->pos=oldpos5;stop1=1;
;goto accept5;
alt3_4: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
case 2/*Bind*/:; int oldpos6=ptr->pos;int cut4=0;
...
;goto accept6;
alt4_3: ptr->pos=oldpos6;stop1=1;
;goto accept6;
alt4_4: ptr->pos=oldpos6;goto break1;
 accept6:;
 break;
case 3/*CAct*/:; int oldpos7=ptr->pos;int cut5=0;
...
alt6_3: ptr->pos=oldpos9;goto break3;
 accept9:;
 if (stop3) goto accept8; } break3: goto pass4; accept8:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var8/*autovar*/=it;;
...
;goto accept7;
alt5_3: ptr->pos=oldpos7;stop1=1;
;goto accept7;
alt5_4: ptr->pos=oldpos7;goto break1;
 accept7:;
 break;
case 4/*Global*/:; int oldpos10=ptr->pos;int cut7=0;
...
alt8_3: ptr->pos=oldpos12;goto break4;
 accept12:;
 if (stop4) goto accept11; } break4: goto pass5; accept11:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var10/*autovar*/=it;;
...
;goto accept10;
alt7_2: ptr->pos=oldpos10;  it=AmethystCore_anything(self ); FAILTEST(alt7_3);
;goto accept10;
alt7_3: ptr->pos=oldpos10;stop1=1;
;goto accept10;
alt7_4: ptr->pos=oldpos10;goto break1;
 accept10:;
 break;
case 5/*Key*/:; int oldpos13=ptr->pos;int cut9=0;
...
alt10_3: ptr->pos=oldpos15;goto break5;
 accept15:;
 if (stop5) goto accept14; } break5: goto pass6; accept14:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var12/*autovar*/=it;;
...
;goto accept13;
alt9_3: ptr->pos=oldpos13;stop1=1;
;goto accept13;
alt9_4: ptr->pos=oldpos13;goto break1;
 accept13:;
 break;
case 6/*Local*/:; int oldpos16=ptr->pos;int cut11=0;
...
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos17; int stop6=0; while(1){oldpos17=ptr->pos; int oldpos18=ptr->pos;int cut12=0;
alt12_1:;  it=AmethystCore_anything(self ); FAILTEST(alt12_2);
;goto accept18;
alt12_2: ptr->pos=oldpos18;stop6=1;
;goto accept18;
alt12_3: ptr->pos=oldpos18;goto break6;
 accept18:;
 if (stop6) goto accept17; } break6: goto pass7; accept17:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var14/*autovar*/=it;;
...
;goto accept16;
alt11_2: ptr->pos=oldpos16;  it=AmethystCore_anything(self ); FAILTEST(alt11_3);
;goto accept16;
alt11_3: ptr->pos=oldpos16;stop1=1;
;goto accept16;
alt11_4: ptr->pos=oldpos16;goto break1;
 accept16:;
 break;
case 7/*Result*/:; int oldpos19=ptr->pos;int cut13=0;
...
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos20; int stop7=0; while(1){oldpos20=ptr->pos; int oldpos21=ptr->pos;int cut14=0;
alt14_1:;  it=AmethystCore_anything(self ); FAILTEST(alt14_2);
;goto accept21;
alt14_2: ptr->pos=oldpos21;stop7=1;
;goto accept21;
alt14_3: ptr->pos=oldpos21;goto break7;
 accept21:;
 if (stop7) goto accept20; } break7: goto pass8; accept20:;   it=rb_funcall(self,sy_Dataflow_src_25d9,1,bind2); var16/*autovar*/=it;;
...
;goto accept19;
alt13_3: ptr->pos=oldpos19;stop1=1;
;goto accept19;
alt13_4: ptr->pos=oldpos19;goto break1;
 accept19:;
 break;
case 8/*Object*/:; int oldpos22=ptr->pos;int cut15=0;
alt15_1:;  it=AmethystCore_anything(self ); FAILTEST(alt15_2);
;goto accept22;
alt15_2: ptr->pos=oldpos22;stop1=1;
;goto accept22;
alt15_3: ptr->pos=oldpos22;goto break1;
 accept22:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   bind_aset(bind2,1,var0/*ary*/);it=rb_funcall(self,sy_Dataflow_bind_lb_1_rb_,1,bind2);var0/*ary*/=bind_aget(bind2,1);; var17/*_result*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass1; accept1:;   it=var1/*autovar*/; var3/*t*/=it;;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto pass4; accept3:;   it=var13/*autovar*/; var3/*t*/=it;;
...
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos5; int stop3=0; while(1){oldpos5=ptr->pos; int oldpos6=ptr->pos;int cut3=0;
alt3_1:;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);
;goto accept6;
alt3_2: ptr->pos=oldpos6;stop3=1;
;goto accept6;
alt3_3: ptr->pos=oldpos6;goto break3;
 accept6:;
 if (stop3) goto accept5; } break3: goto pass7; accept5:;     it=Dataflow_traverse(self ); FAILTEST(pass7); var20/*autovar*/=it;;
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos7; int stop4=0; while(1){oldpos7=ptr->pos; int oldpos8=ptr->pos;int cut4=0;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);
;goto accept8;
alt4_2: ptr->pos=oldpos8;stop4=1;
;goto accept8;
alt4_3: ptr->pos=oldpos8;goto break4;
 accept8:;
 if (stop4) goto accept7; } break4: goto pass8; accept7:;   it=rb_funcall(self,sy_Dataflow_bind_end_6e13,1,bind2); var21/*autovar*/=it;;
...
cstruct oldpass9=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos9; int stop5=0; while(1){oldpos9=ptr->pos; int oldpos10=ptr->pos;int cut5=0;
alt5_1:;  it=AmethystCore_anything(self ); FAILTEST(alt5_2);
;goto accept10;
alt5_2: ptr->pos=oldpos10;stop5=1;
;goto accept10;
alt5_3: ptr->pos=oldpos10;goto break5;
 accept10:;
 if (stop5) goto accept9; } break5: goto pass9; accept9:;   it=rb_funcall(self,sy_Dataflow_ssanum_lp_s_3920,1,bind2); var24/*autovar*/=it;;
...
int oldpos11; int stop6=0; while(1){oldpos11=ptr->pos; int oldpos12=ptr->pos;int cut6=0;
...
;goto accept12;
alt6_2: ptr->pos=oldpos12;stop6=1;
;goto accept12;
alt6_3: ptr->pos=oldpos12;goto break6;
 accept12:;
 if (stop6) goto accept11; } break6: goto pass10; accept11:;   it=var27/*autovar*/; var3/*t*/=it;;
...
int oldpos13; int stop7=0; while(1){oldpos13=ptr->pos; int oldpos14=ptr->pos;int cut7=0;
...
;goto accept14;
alt7_2: ptr->pos=oldpos14;stop7=1;
;goto accept14;
alt7_3: ptr->pos=oldpos14;goto break7;
 accept14:;
 if (stop7) goto accept13; } break7: goto pass11; accept13:;   it=var32/*autovar*/; var3/*t*/=it;;
...
it=rb_funcall(self,sy_Dataflow_oldssanu_073d,1,bind2); var26/*old*/=it;;
int oldpos15; int stop8=0; while(1){oldpos15=ptr->pos; int oldpos16=ptr->pos;int cut8=0;
...
;goto accept16;
alt8_2: ptr->pos=oldpos16;stop8=1;
;goto accept16;
alt8_3: ptr->pos=oldpos16;goto break8;
 accept16:;
 if (stop8) goto accept15; } break8: goto pass12; accept15:;   bind_aset(bind2,1,var36/*join*/);it=rb_funcall(self,sy_Dataflow_or_end_lp_b_33b4,1,bind2);var36/*join*/=bind_aget(bind2,1);;bind_aset(bind2,1,var3/*t*/);it=rb_funcall(self,sy_Dataflow_Or_lb__ti_bind_d486,1,bind2);var3/*t*/=bind_aget(bind2,1);; var38/*autovar*/=it;;
...
int oldpos17; int stop9=0; while(1){oldpos17=ptr->pos; int oldpos18=ptr->pos;int cut9=0;
...
;goto accept18;
alt9_2: ptr->pos=oldpos18;stop9=1;
;goto accept18;
alt9_3: ptr->pos=oldpos18;goto break9;
 accept18:;
 if (stop9) goto accept17; } break9: goto pass18; accept17:;   it=var49/*autovar*/; var9/*var*/=it;;
...
it=rb_ary_new3(0); var36/*join*/=it;;
it=rb_funcall(self,sy_Dataflow_oldssanu_073d,1,bind2); var26/*old*/=it;;
int oldpos19; int stop10=0; while(1){oldpos19=ptr->pos; int oldpos20=ptr->pos;int cut10=0;
...
;goto accept20;
alt10_2: ptr->pos=oldpos20;stop10=1;
;goto accept20;
alt10_3: ptr->pos=oldpos20;goto break10;
 accept20:;
 if (stop10) goto accept19; } break10: goto pass19; accept19:;   bind_aset(bind2,1,var36/*join*/);it=rb_funcall(self,sy_Dataflow_or_end_lp_b_33b4,1,bind2);var36/*join*/=bind_aget(bind2,1);;bind_aset(bind2,1,var53/*alts*/);it=rb_funcall(self,sy_Dataflow_src_dot_clas_68f9,1,bind2);var53/*alts*/=bind_aget(bind2,1);; var57/*autovar*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Dead_Code_Deleter3__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass1; accept1:;   it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto pass2; accept3:;   it=rb_funcall(self,sy_Dead_Code_Deleter3_src_25d9,1,bind2); var4/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
                   pass2: *ptr=oldpass2; goto fail;
                   success2: *ptr=oldpass2;
...
alt3_3: ptr->pos=oldpos6;goto break3;
 accept6:;
 if (stop3) goto accept5; } break3: goto pass3; accept5:;   it=rb_funcall(self,sy_Dead_Code_Deleter3_src_25d9,1,bind2);it=rb_funcall(self,sy_Dead_Code_Deleter3__at_bounded_6bb2,1,bind2);  it=Dead_Code_Deleter3_traverse(self ); FAILTEST(pass3); var6/*autovar*/=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var6/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   int oldpos7; int stop4=0; while(1){oldpos7=ptr->pos; int oldpos8=ptr->pos;int cut4=0;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);
...
alt4_3: ptr->pos=oldpos8;goto break4;
 accept8:;
 if (stop4) goto accept7; } break4: goto pass4; accept7:;   it=rb_funcall(self,sy_Dead_Code_Deleter3__at_bounded_7c82,1,bind2);it=rb_funcall(self,sy_Dead_Code_Deleter3__at_reachab_005c,1,bind2); var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto pass3;
                   success4: *ptr=oldpass4;
...
alt5_3: ptr->pos=oldpos10;goto break5;
 accept10:;
 if (stop5) goto accept9; } break5: goto pass5; accept9:;   it=rb_funcall(self,sy_Dead_Code_Deleter3_src_25d9,1,bind2); var1/*this*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Forget_SSA__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass1; accept1:;   it=rb_funcall(self,sy_Forget_SSA_src_dot_unss_5845,1,bind2); var1/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
                    rb_eval_string("testversiondataflow_ssa('292f011fbbf5230469f71b2536f467eb')");}
