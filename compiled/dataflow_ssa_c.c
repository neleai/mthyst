...
unsigned char chr1=FIX2INT(CALL(switchcbDataflow3,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0/*ary*/,it); it=CALL(vars_in_Dataflowcb_1,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self); unsigned char chr1=FIX2INT(CALL(switchcbDataflow2,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0/*t*/,it); unsigned char chr1=FIX2INT(CALL(switchcbDataflow1,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
unsigned char chr1=FIX2INT(CALL(switchcbDead_Code_Deleter36,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
unsigned char chr1=FIX2INT(CALL(switchcbDead_Code_Deleter35,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;case 2:;case 4:;case 5:; unsigned char chr2=FIX2INT(CALL(switchcbDead_Code_Deleter34,1,rb_obj_class(ame_curobj(self))));  switch(chr2){case 0:;case 1:;case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
unsigned char chr1=FIX2INT(CALL(switchcbForget_SSA7,1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('67592f4eb4726e11921a91150a331286')");}
