...
switch(FIX2LONG(rb_hash_aref(switchhash_Dataflow_4,rb_obj_class(ame_curobj(self))))){case 0:; int oldpos1=ame_getpos(self);
...
it=rb_funcall(self,sy_Dataflow_bind_lb_0_rb__eq__943e,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self); switch(FIX2LONG(rb_hash_aref(switchhash_Dataflow_3,rb_obj_class(ame_curobj(self))))){case 0:; int oldpos2=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
 break;
case 4:; int oldpos10=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 break;
case 5:; int oldpos11=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept6;
 ...
 accept6:;
 break;
case 6:; int oldpos12=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept7;
 ...
 accept7:;
 break;
case 7:; int oldpos13=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept8;
 ...
 accept8:;
 break;
case 8:;   it=AmethystCore_anything(self ); FAILTEST(break1); break;
...
switch(FIX2LONG(rb_hash_aref(switchhash_Dataflow_2,rb_obj_class(ame_curobj(self))))){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,1/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,1/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=bind_aget(bind,14/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,15/*autovar*/,it);
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,15/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=bind_aget(bind,20/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 3:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,21/*autovar*/,it);
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=bind_aget(bind,23/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 4:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,24/*autovar*/,it);
...
it=bind_aget(bind,28/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 5:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,29/*autovar*/,it);
...
it=bind_aget(bind,35/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 6:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,36/*autovar*/,it);
...
it=bind_aget(bind,44/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,45/*autovar*/,it);
...
it=bind_aget(bind,48/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 8:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,49/*autovar*/,it);
...
it=bind_aget(bind,54/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 9:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,55/*autovar*/,it);
...
it=bind_aget(bind,58/*autovar*/); bind_aset(bind,9/*_result*/,it);
 break;
case 10:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,59/*autovar*/,it);
...
switch(FIX2LONG(rb_hash_aref(switchhash_Dead_Code_Deleter3_3,rb_obj_class(ame_curobj(self))))){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
switch(FIX2LONG(rb_hash_aref(switchhash_Dead_Code_Deleter3_2,rb_obj_class(ame_curobj(self))))){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__lp_,1,bind);  bind_aset(bind,2/*_result*/,it);
 break;
case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*autovar*/,it);
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Dead_Code_Deleter3_src_25d9,1,bind);  bind_aset(bind,1/*this*/,it);
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__lp_,1,bind);  bind_aset(bind,2/*_result*/,it);
 break;
case 3:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,3/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=bind_aget(bind,4/*autovar*/); bind_aset(bind,2/*_result*/,it);
 break;
case 4:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,5/*autovar*/,it);
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,5/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=bind_aget(bind,8/*autovar*/); bind_aset(bind,2/*_result*/,it);
 break;
case 5:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,9/*autovar*/,it);
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,9/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
switch(FIX2LONG(rb_hash_aref(switchhash_Forget_SSA_3,rb_obj_class(ame_curobj(self))))){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('742fdcb2a658ab2564bc29154d3d2b33')");}
