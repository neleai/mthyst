...
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,15,it); it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break3);
 rb_ary_store(bind,17,it); it=CALL(visit_Dataflowcb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,3,it); it=CALL(visit_Dataflowcb_13,1,bind); it=CALL(visit_Dataflowcb_14,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,20,it); it=CALL(visit_Dataflowcb_16,1,bind); int oldpos10=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,21,it);   it=Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos10); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=CALL(visit_Dataflowcb_17,1,bind); it=CALL(visit_Dataflowcb_18,1,bind); 
 rb_ary_store(bind,22,it);   it=Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
it=rb_ary_entry(bind,22);
 ...
 rb_ary_store(bind,23,it); int oldpos11=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Dataflow_traverse_item(self ); FAILTEST(pass8);it=CALL(visit_Dataflowcb_19,1,bind); it=CALL(visit_Dataflowcb_20,1,bind); 
 rb_ary_store(bind,24,it); it=CALL(visit_Dataflowcb_21,1,bind); int oldpos12=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,24)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,25,it); int oldpos13=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,26,it);   it=Dataflow_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
it=rb_ary_entry(bind,26);
 rb_ary_store(bind,7,it);   it=Dataflow_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
ame_setsrc(self,rb_ary_entry(bind,28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,29,it); int oldpos15=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,rb_ary_entry(bind,29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos16; while(1){oldpos16=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos16=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos16); it=CALL(visit_Dataflowcb_23,1,bind); it=CALL(visit_Dataflowcb_24,1,bind); 
 rb_ary_store(bind,30,it);   it=Dataflow_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
...
it=rb_ary_entry(bind,31);
 ...
 rb_ary_store(bind,32,it); int oldpos17=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,rb_ary_entry(bind,32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,33,it); int oldpos18=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,rb_ary_entry(bind,33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos19; while(1){oldpos19=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos19); it=CALL(visit_Dataflowcb_25,1,bind); 
 rb_ary_store(bind,34,it); it=CALL(visit_Dataflowcb_26,1,bind); int oldpos20=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
ame_setsrc(self,rb_ary_entry(bind,34)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,35,it); int oldpos21=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=ame_getsrc(self); int fail16=0;
ame_setsrc(self,rb_ary_entry(bind,35)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,36,it);   it=Dataflow_eof(self ); FAILTEST(pass16);
	goto success16;
	pass16: fail16=1;
...
it=CALL(visit_Dataflowcb_27,1,bind); 
 rb_ary_store(bind,37,it);   it=Dataflow_eof(self ); FAILTEST(pass14);
	goto success14;
	pass14: fail14=1;
...
it=rb_ary_entry(bind,37);
 rb_ary_store(bind,38,it);   it=Dataflow_eof(self ); FAILTEST(pass13);
	goto success13;
	pass13: fail13=1;
...
it=rb_ary_entry(bind,38);
 ...
 rb_ary_store(bind,39,it); int oldpos22=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
ame_setsrc(self,rb_ary_entry(bind,39)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos23; while(1){oldpos23=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); if (IGET(stop)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos23); it=CALL(visit_Dataflowcb_28,1,bind); 
 rb_ary_store(bind,40,it);   it=Dataflow_eof(self ); FAILTEST(pass17);
	goto success17;
	pass17: fail17=1;
...
it=rb_ary_entry(bind,40);
 ...
 rb_ary_store(bind,41,it); int oldpos24=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
ame_setsrc(self,rb_ary_entry(bind,41)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,42,it); int oldpos25; while(1){oldpos25=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break7);
 rb_ary_store(bind,43,it); it=CALL(visit_Dataflowcb_29,1,bind);  if (IGET(stop)!=Qnil){{oldpos25=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos25); it=rb_ary_entry(bind,42);
 rb_ary_store(bind,44,it); it=CALL(visit_Dataflowcb_30,1,bind); 
...
it=rb_ary_entry(bind,45);
 rb_ary_store(bind,9,it);  break;case 9:; int oldpos26=ame_getpos(self);
  alt1_1:  ame_setpos(self,oldpos26); goto fail;
 accept1:;
...
rb_define_method(cls_Dead_Code_Deleter3,"visit",Dead_Code_Deleter3_visit,0);
 rb_eval_string("testversiondataflow_ssa('9f3e23c0a02d348da28d079b7e437250')");}
