...
ISET(cut,Qnil);goto accept9;
 ...
 accept9:;
 break;case 9:;   it=AmethystCore_anything(self ); FAILTEST(break1); break;default: goto break1;} if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=BGET(ary_1);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
rb_define_method(cls_Dead_Code_Deleter3,"visit",Dead_Code_Deleter3_visit,0);
 rb_eval_string("testversion('14385ece6ec5211a840b553ff6935920')");}
