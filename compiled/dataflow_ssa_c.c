...
static VALUE sy_Dataflow__append_lp__984f;
...
static VALUE sy_Dataflow_bind_lb_11_rb__a30c;
...
return it;
fail: return failobj; }
VALUE Dataflow_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Dataflow_traverse_item(self ); FAILTEST(break1); bind_aset(bind,13/*it*/,it);
it=rb_funcall(self,sy_Dataflow_bind_lb_11_rb__a30c,1,bind);  bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp__984f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,12/*autovar*/);it=bind_aget(bind,11/*ar*/); bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
ame_setcut(self,Qnil);goto accept8;
 ...
 break;}it=rb_funcall(self,sy_Dataflow__append_lp__b40f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_Dataflow_bind_lb_0_rb_,1,bind);  bind_aset(bind,43/*_result*/,it);
...
static VALUE sy_Dead_Code_Deleter3__append_lp__984f;
...
static VALUE sy_Dead_Code_Deleter3_bind_lb_11_rb__a30c;
...
return it;
fail: return failobj; }
VALUE Dead_Code_Deleter3_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,11/*ar*/,it);
it=rb_ary_new3(0); bind_aset(bind,12/*autovar*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Dead_Code_Deleter3_traverse_item(self ); FAILTEST(break1); bind_aset(bind,13/*it*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3_bind_lb_11_rb__a30c,1,bind);  bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp__984f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,12/*autovar*/);it=bind_aget(bind,11/*ar*/); bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp__26c5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,18/*autovar*/);it=rb_funcall(self,sy_Dead_Code_Deleter3_src_25d9,1,bind);  bind_aset(bind,1/*this*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	...
	success5: *ptr=oldpass5;
	if(fail5) goto fail;
it=rb_funcall(self,sy_Dead_Code_Deleter3__at_reachab_725b,1,bind);  bind_aset(bind,4/*_result*/,it);
...
static VALUE sy_Forget_SSA__append_lp__984f;
...
static VALUE sy_Forget_SSA_bind_lb_11_rb__a30c;
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,11/*ar*/,it);
it=rb_ary_new3(0); bind_aset(bind,12/*autovar*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Forget_SSA_traverse_item(self ); FAILTEST(break1); bind_aset(bind,13/*it*/,it);
it=rb_funcall(self,sy_Forget_SSA_bind_lb_11_rb__a30c,1,bind);  bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Forget_SSA__append_lp__984f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,12/*autovar*/);it=bind_aget(bind,11/*ar*/); bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
sy_Dataflow__append_lp__984f=rb_intern("Dataflow__append_lp__984f");
...
sy_Dataflow_bind_lb_11_rb__a30c=rb_intern("Dataflow_bind_lb_11_rb__a30c");
...
sy_Dead_Code_Deleter3__append_lp__984f=rb_intern("Dead_Code_Deleter3__append_lp__984f");
...
sy_Dead_Code_Deleter3_bind_lb_11_rb__a30c=rb_intern("Dead_Code_Deleter3_bind_lb_11_rb__a30c");
...
sy_Forget_SSA__append_lp__984f=rb_intern("Forget_SSA__append_lp__984f");
...
sy_Forget_SSA_bind_lb_11_rb__a30c=rb_intern("Forget_SSA_bind_lb_11_rb__a30c");
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('9541b5cfedc9c1170b6c469ffd0ba7c3')");}
