...
static VALUE c_Rule;
static VALUE sy_Dataflow_Act_lb_bind_lb_0_rb_;
static VALUE sy_Dataflow_Apply_lb__ti_bind_lb_;
static VALUE sy_Dataflow_Lookahead_lb__ti_b;
static VALUE sy_Dataflow_Many_dot_create_lp_;
static VALUE sy_Dataflow_Or_lb__ti_bind_lb_0_rb__rb_;
static VALUE sy_Dataflow_Pass_dot_create_lp_;
static VALUE sy_Dataflow_Switch_lb__le__co_ary;
static VALUE sy_Dataflow__append_lp_bind10;
static VALUE sy_Dataflow__append_lp_bind11;
static VALUE sy_Dataflow__append_lp_bind12;
static VALUE sy_Dataflow__append_lp_bind13;
static VALUE sy_Dataflow__append_lp_bind14;
static VALUE sy_Dataflow__append_lp_bind15;
static VALUE sy_Dataflow__append_lp_bind16;
static VALUE sy_Dataflow__append_lp_bind17;
static VALUE sy_Dataflow__append_lp_bind18;
static VALUE sy_Dataflow__append_lp_bind19;
static VALUE sy_Dataflow__append_lp_bind20;
static VALUE sy_Dataflow__append_lp_bind21;
static VALUE sy_Dataflow__append_lp_bind22;
static VALUE sy_Dataflow__append_lp_bind23;
static VALUE sy_Dataflow__append_lp_bind24;
static VALUE sy_Dataflow__append_lp_bind25;
static VALUE sy_Dataflow__append_lp_bind26;
static VALUE sy_Dataflow__append_lp_bind27;
static VALUE sy_Dataflow__append_lp_bind2;
static VALUE sy_Dataflow__append_lp_bind3;
static VALUE sy_Dataflow__append_lp_bind4;
static VALUE sy_Dataflow__append_lp_bind5;
static VALUE sy_Dataflow__append_lp_bind6;
static VALUE sy_Dataflow__append_lp_bind7;
static VALUE sy_Dataflow__append_lp_bind8;
static VALUE sy_Dataflow__append_lp_bind9;
static VALUE sy_Dataflow__append_lp_bind;
static VALUE sy_Dataflow__at_bnding_eq_src_dot_;
static VALUE sy_Dataflow__at_changed;
static VALUE sy_Dataflow__at_changed_eq_fal;
static VALUE sy_Dataflow__at_changed_eq_tru;
static VALUE sy_Dataflow__at_marked_lt__lt_bin2;
static VALUE sy_Dataflow__at_marked_lt__lt_bin;
static VALUE sy_Dataflow__at_marked_lt__lt_src;
static VALUE sy_Dataflow__at_oldssanums_eq_2;
static VALUE sy_Dataflow__at_oldssanums_eq_;
static VALUE sy_Dataflow__lp_bind_lb_4_rb_;
static VALUE sy_Dataflow__lp_src_dot_instanc;
static VALUE sy_Dataflow_bind_end_lp_src;
static VALUE sy_Dataflow_bind_lb_0_rb__eq__lb__rb_;
static VALUE sy_Dataflow_bind_lb_41_rb__lt__lt_ol;
static VALUE sy_Dataflow_bind_lb_4_rb__dot_ary;
static VALUE sy_Dataflow_bind_lb_58_rb__lt__lt__lb_b;
static VALUE sy_Dataflow_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Dataflow_bind_lb_6_rb__dot_each;
static VALUE sy_Dataflow_bind_lb_8_rb__dot_each2;
static VALUE sy_Dataflow_bind_lb_8_rb__dot_each;
static VALUE sy_Dataflow_if_sp_bind_lb_5_rb_;
static VALUE sy_Dataflow_many_end_lp_bin;
static VALUE sy_Dataflow_n_eq_Result_lb__le__co_n;
static VALUE sy_Dataflow_oldssanums_dot_c;
static VALUE sy_Dataflow_or_end_lp_bind_lb_;
static VALUE sy_Dataflow_src;
static VALUE sy_Dataflow_src_dot_args;
static VALUE sy_Dataflow_src_dot_body;
static VALUE sy_Dataflow_src_dot_body_eq_bin;
static VALUE sy_Dataflow_src_dot_reachabl;
static VALUE sy_Dataflow_src_dot_to;
static VALUE sy_Dataflow_src_dot_var;
static VALUE sy_Dataflow_src_dot_vars;
static VALUE sy_Dataflow_ssanum_lp_src_rp_;
static VALUE sy_Dataflow_ssanums_dot_clon;
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_Dataflow__at_bnding_eq_src_dot_,1,bind); it=rb_funcall(self,sy_Dataflow_src_dot_args,1,bind);  bind_aset(bind,2/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*var*/,it);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass3);
	...
	if(fail3) goto pass2;
it=rb_funcall(self,sy_Dataflow_bind_lb_6_rb__dot_each,1,bind); it=rb_funcall(self,sy_Dataflow_src_dot_body,1,bind);  bind_aset(bind,7/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow_src_dot_body_eq_bin,1,bind); it=rb_funcall(self,sy_Dataflow_src_dot_reachabl,1,bind); it=rb_funcall(self,sy_Dataflow_src,1,bind);  bind_aset(bind,10/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind26,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Dataflow__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Dataflow__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Dataflow__at_changed_eq_fal,1,bind);   it=Dataflow_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind27,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Dataflow_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
...
it=rb_funcall(self,sy_Dataflow__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Dataflow_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind25,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Dataflow_bind_lb_0_rb__eq__lb__rb_,1,bind); it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind13,1,bind); it=rb_ary_new3(0); bind_aset(bind,5/*autovar*/,it);
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind14,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,5/*autovar*/); bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind15,1,bind); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,12/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind16,1,bind); it=bind_aget(bind,15/*autovar*/); bind_aset(bind,16/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind17,1,bind); it=rb_ary_new3(0); bind_aset(bind,20/*autovar*/,it);
int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind18,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,20/*autovar*/); bind_aset(bind,22/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind19,1,bind); it=rb_funcall(self,sy_Dataflow__at_marked_lt__lt_src,1,bind); it=rb_ary_new3(0); bind_aset(bind,26/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,27/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind20,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,26/*autovar*/); bind_aset(bind,28/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind21,1,bind); it=rb_funcall(self,sy_Dataflow__at_marked_lt__lt_src,1,bind); it=rb_ary_new3(0); bind_aset(bind,32/*autovar*/,it);
int oldpos11; while(1){oldpos11=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); bind_aset(bind,33/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos11=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos11); it=bind_aget(bind,32/*autovar*/); bind_aset(bind,34/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind22,1,bind); it=bind_aget(bind,37/*autovar*/); bind_aset(bind,38/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind23,1,bind); it=bind_aget(bind,41/*autovar*/); bind_aset(bind,42/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept8;
 ...
 break;}it=rb_funcall(self,sy_Dataflow__append_lp_bind24,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=bind_aget(bind,0/*ary*/); bind_aset(bind,43/*_result*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,2/*autovar*/); bind_aset(bind,0/*t*/,it);
it=rb_funcall(self,sy_Dataflow_Act_lb_bind_lb_0_rb_,1,bind);  bind_aset(bind,4/*act*/,it);
it=rb_funcall(self,sy_Dataflow__at_marked_lt__lt_bin,1,bind); it=rb_funcall(self,sy_Dataflow_bind_lb_4_rb__dot_ary,1,bind);  bind_aset(bind,5/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=bind_aget(bind,7/*autovar*/); bind_aset(bind,8/*var*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	...
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
it=rb_funcall(self,sy_Dataflow_bind_lb_8_rb__dot_each,1,bind);  bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,12/*autovar*/); bind_aset(bind,0/*t*/,it);
it=rb_funcall(self,sy_Dataflow_Apply_lb__ti_bind_lb_,1,bind);  bind_aset(bind,14/*app*/,it);
...
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass5);
	...
	success5: *ptr=oldpass5;
	if(fail5) goto pass4;
it=rb_funcall(self,sy_Dataflow_bind_lb_8_rb__dot_each2,1,bind); it=bind_aget(bind,14/*app*/); bind_aset(bind,17/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,19/*autovar*/);  it=Dataflow_traverse(self ); FAILTEST(pass7); bind_aset(bind,21/*autovar*/,it);
cstruct oldpass8=*ptr; int fail8=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,22/*autovar*/);it=rb_funcall(self,sy_Dataflow_bind_end_lp_src,1,bind);  bind_aset(bind,24/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: *ptr=oldpass8;
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,27/*autovar*/);it=rb_funcall(self,sy_Dataflow_ssanum_lp_src_rp_,1,bind);  bind_aset(bind,29/*autovar*/,it);
...
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,30/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Dataflow_oldssanums_dot_c,1,bind);  bind_aset(bind,31/*old*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,32/*autovar*/); bind_aset(bind,0/*t*/,it);
it=rb_funcall(self,sy_Dataflow__at_oldssanums_eq_,1,bind); it=rb_funcall(self,sy_Dataflow_Lookahead_lb__ti_b,1,bind);  bind_aset(bind,34/*autovar*/,it);
...
cstruct oldpass11=*ptr; int fail11=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_Dataflow_ssanums_dot_clon,1,bind);  bind_aset(bind,36/*prev*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind8,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,37/*autovar*/); bind_aset(bind,0/*t*/,it);
it=rb_funcall(self,sy_Dataflow_many_end_lp_bin,1,bind); it=rb_funcall(self,sy_Dataflow_Many_dot_create_lp_,1,bind);  bind_aset(bind,39/*autovar*/,it);
...
int oldpos8; while(1){oldpos8=ame_getpos(self); it=rb_funcall(self,sy_Dataflow__at_oldssanums_eq_2,1,bind);   it=Dataflow_traverse_item(self ); FAILTEST(break8); bind_aset(bind,43/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind9,1,bind); it=rb_funcall(self,sy_Dataflow_bind_lb_41_rb__lt__lt_ol,1,bind);  bind_aset(bind,44/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind10,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,42/*autovar*/);it=rb_funcall(self,sy_Dataflow_or_end_lp_bind_lb_,1,bind); it=rb_funcall(self,sy_Dataflow_Or_lb__ti_bind_lb_0_rb__rb_,1,bind);  bind_aset(bind,45/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__at_marked_lt__lt_bin2,1,bind); it=rb_funcall(self,sy_Dataflow_Pass_dot_create_lp_,1,bind);  bind_aset(bind,50/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow__append_lp_bind11,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break9;} } } break9: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,54/*autovar*/); bind_aset(bind,8/*var*/,it);
...
it=rb_funcall(self,sy_Dataflow_n_eq_Result_lb__le__co_n,1,bind);  bind_aset(bind,56/*autovar*/,it);
...
int oldpos10; while(1){oldpos10=ame_getpos(self); it=rb_funcall(self,sy_Dataflow__at_oldssanums_eq_2,1,bind);   it=AmethystCore_anything(self ); FAILTEST(break10); bind_aset(bind,60/*autovar*/,it);
...
it=rb_funcall(self,sy_Dataflow_bind_lb_58_rb__lt__lt__lb_b,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass20);
	goto success20;
	pass20: fail20=1;
	success20: *ptr=oldpass20;
	if(fail20) goto break10;
it=rb_funcall(self,sy_Dataflow_bind_lb_41_rb__lt__lt_ol,1,bind);  bind_aset(bind,63/*autovar*/,it);
it=rb_funcall(self,sy_Dataflow__append_lp_bind12,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break10;} } } break10: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=bind_aget(bind,59/*autovar*/);it=rb_funcall(self,sy_Dataflow_or_end_lp_bind_lb_,1,bind); it=rb_funcall(self,sy_Dataflow_Switch_lb__le__co_ary,1,bind);  bind_aset(bind,64/*autovar*/,it);
...
VALUE switchhashTraverser_Clone21;
static VALUE c_Rule;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind2;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind3;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind4;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind5;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind6;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind7;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind8;
static VALUE sy_Dead_Code_Deleter3__append_lp_bind;
static VALUE sy_Dead_Code_Deleter3__at_bounded;
static VALUE sy_Dead_Code_Deleter3__at_bounded_eq_fal;
static VALUE sy_Dead_Code_Deleter3__at_changed;
static VALUE sy_Dead_Code_Deleter3__at_changed_eq_fal;
static VALUE sy_Dead_Code_Deleter3__at_changed_eq_tru;
static VALUE sy_Dead_Code_Deleter3__at_reachable_eq_s;
static VALUE sy_Dead_Code_Deleter3__at_reachable_lb_b;
static VALUE sy_Dead_Code_Deleter3__at_reachable_lb_s;
static VALUE sy_Dead_Code_Deleter3__lp_;
static VALUE sy_Dead_Code_Deleter3__lp_bind_lb_4_rb_;
static VALUE sy_Dead_Code_Deleter3__lp_src_dot_instanc;
static VALUE sy_Dead_Code_Deleter3_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Dead_Code_Deleter3_if_sp_bind_lb_5_rb_;
static VALUE sy_Dead_Code_Deleter3_src;
static VALUE sy_Dead_Code_Deleter3_src_dot_reachabl;
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,1/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Dead_Code_Deleter3__at_reachable_eq_s,1,bind); it=rb_funcall(self,sy_Dead_Code_Deleter3_src_dot_reachabl,1,bind);   it=Dead_Code_Deleter3_traverse(self ); FAILTEST(pass2); bind_aset(bind,2/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Dead_Code_Deleter3__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3_src,1,bind);  bind_aset(bind,3/*this*/,it);
it=Qnil; bind_aset(bind,4/*clon*/,it);
it=Qfalse; bind_aset(bind,5/*changed*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,6/*autovar*/);ptr->len=1;
   it=AmethystCore_anything(self ); FAILTEST(pass1); bind_aset(bind,7/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,9/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=AmethystCore_anything(self ); FAILTEST(pass3); bind_aset(bind,10/*key*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__at_changed_eq_fal,1,bind);   it=Dead_Code_Deleter3_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__lp_bind_lb_4_rb_,1,bind);  bind_aset(bind,12/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	...
	if(fail3) goto break2;
it=bind_aget(bind,12/*autovar*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind8,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Dead_Code_Deleter3_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Dead_Code_Deleter3_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,2/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,6/*autovar*/);it=rb_funcall(self,sy_Dead_Code_Deleter3_src,1,bind);  bind_aset(bind,8/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,13/*autovar*/);it=rb_funcall(self,sy_Dead_Code_Deleter3__at_bounded_eq_fal,1,bind); it=rb_funcall(self,sy_Dead_Code_Deleter3__at_reachable_lb_s,1,bind);  bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
it=rb_funcall(self,sy_Dead_Code_Deleter3__append_lp_bind5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,18/*autovar*/);it=rb_funcall(self,sy_Dead_Code_Deleter3_src,1,bind);  bind_aset(bind,1/*this*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
	if(fail5) goto fail;
it=rb_funcall(self,sy_Dead_Code_Deleter3__at_reachable_lb_b,1,bind);  bind_aset(bind,4/*_result*/,it);
...
static VALUE c_Rule;
static VALUE sy_Forget_SSA__append_lp_bind2;
static VALUE sy_Forget_SSA__append_lp_bind3;
static VALUE sy_Forget_SSA__append_lp_bind4;
static VALUE sy_Forget_SSA__append_lp_bind;
static VALUE sy_Forget_SSA__at_changed;
static VALUE sy_Forget_SSA__at_changed_eq_fal;
static VALUE sy_Forget_SSA__at_changed_eq_tru;
static VALUE sy_Forget_SSA__lp_bind_lb_4_rb_;
static VALUE sy_Forget_SSA__lp_src_dot_instanc;
static VALUE sy_Forget_SSA_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Forget_SSA_if_sp_bind_lb_5_rb_;
static VALUE sy_Forget_SSA_src;
static VALUE sy_Forget_SSA_src_dot_unssa;
...
it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Forget_SSA__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Forget_SSA__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
it=rb_funcall(self,sy_Forget_SSA_src,1,bind);  bind_aset(bind,3/*this*/,it);
it=Qnil; bind_aset(bind,4/*clon*/,it);
it=Qfalse; bind_aset(bind,5/*changed*/,it);
it=rb_funcall(self,sy_Forget_SSA__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,6/*autovar*/);ptr->len=1;
   it=AmethystCore_anything(self ); FAILTEST(pass1); bind_aset(bind,7/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,9/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=AmethystCore_anything(self ); FAILTEST(pass3); bind_aset(bind,10/*key*/,it);
it=rb_funcall(self,sy_Forget_SSA__at_changed_eq_fal,1,bind);   it=Forget_SSA_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
it=rb_funcall(self,sy_Forget_SSA__lp_bind_lb_4_rb_,1,bind);  bind_aset(bind,12/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	...
	if(fail3) goto break2;
it=bind_aget(bind,12/*autovar*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Forget_SSA__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Forget_SSA_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
...
it=rb_funcall(self,sy_Forget_SSA__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Forget_SSA_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Forget_SSA__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Forget_SSA__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_Forget_SSA_src_dot_unssa,1,bind);  bind_aset(bind,3/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
sy_Dataflow_Act_lb_bind_lb_0_rb_=rb_intern("Dataflow_Act_lb_bind_lb_0_rb_");
sy_Dataflow_Apply_lb__ti_bind_lb_=rb_intern("Dataflow_Apply_lb__ti_bind_lb_");
sy_Dataflow_Lookahead_lb__ti_b=rb_intern("Dataflow_Lookahead_lb__ti_b");
sy_Dataflow_Many_dot_create_lp_=rb_intern("Dataflow_Many_dot_create_lp_");
sy_Dataflow_Or_lb__ti_bind_lb_0_rb__rb_=rb_intern("Dataflow_Or_lb__ti_bind_lb_0_rb__rb_");
sy_Dataflow_Pass_dot_create_lp_=rb_intern("Dataflow_Pass_dot_create_lp_");
sy_Dataflow_Switch_lb__le__co_ary=rb_intern("Dataflow_Switch_lb__le__co_ary");
sy_Dataflow__append_lp_bind10=rb_intern("Dataflow__append_lp_bind10");
sy_Dataflow__append_lp_bind11=rb_intern("Dataflow__append_lp_bind11");
sy_Dataflow__append_lp_bind12=rb_intern("Dataflow__append_lp_bind12");
sy_Dataflow__append_lp_bind13=rb_intern("Dataflow__append_lp_bind13");
sy_Dataflow__append_lp_bind14=rb_intern("Dataflow__append_lp_bind14");
sy_Dataflow__append_lp_bind15=rb_intern("Dataflow__append_lp_bind15");
sy_Dataflow__append_lp_bind16=rb_intern("Dataflow__append_lp_bind16");
sy_Dataflow__append_lp_bind17=rb_intern("Dataflow__append_lp_bind17");
sy_Dataflow__append_lp_bind18=rb_intern("Dataflow__append_lp_bind18");
sy_Dataflow__append_lp_bind19=rb_intern("Dataflow__append_lp_bind19");
sy_Dataflow__append_lp_bind20=rb_intern("Dataflow__append_lp_bind20");
sy_Dataflow__append_lp_bind21=rb_intern("Dataflow__append_lp_bind21");
sy_Dataflow__append_lp_bind22=rb_intern("Dataflow__append_lp_bind22");
sy_Dataflow__append_lp_bind23=rb_intern("Dataflow__append_lp_bind23");
sy_Dataflow__append_lp_bind24=rb_intern("Dataflow__append_lp_bind24");
sy_Dataflow__append_lp_bind25=rb_intern("Dataflow__append_lp_bind25");
sy_Dataflow__append_lp_bind26=rb_intern("Dataflow__append_lp_bind26");
sy_Dataflow__append_lp_bind27=rb_intern("Dataflow__append_lp_bind27");
sy_Dataflow__append_lp_bind2=rb_intern("Dataflow__append_lp_bind2");
sy_Dataflow__append_lp_bind3=rb_intern("Dataflow__append_lp_bind3");
sy_Dataflow__append_lp_bind4=rb_intern("Dataflow__append_lp_bind4");
sy_Dataflow__append_lp_bind5=rb_intern("Dataflow__append_lp_bind5");
sy_Dataflow__append_lp_bind6=rb_intern("Dataflow__append_lp_bind6");
sy_Dataflow__append_lp_bind7=rb_intern("Dataflow__append_lp_bind7");
sy_Dataflow__append_lp_bind8=rb_intern("Dataflow__append_lp_bind8");
sy_Dataflow__append_lp_bind9=rb_intern("Dataflow__append_lp_bind9");
sy_Dataflow__append_lp_bind=rb_intern("Dataflow__append_lp_bind");
sy_Dataflow__at_bnding_eq_src_dot_=rb_intern("Dataflow__at_bnding_eq_src_dot_");
sy_Dataflow__at_changed=rb_intern("Dataflow__at_changed");
sy_Dataflow__at_changed_eq_fal=rb_intern("Dataflow__at_changed_eq_fal");
sy_Dataflow__at_changed_eq_tru=rb_intern("Dataflow__at_changed_eq_tru");
sy_Dataflow__at_marked_lt__lt_bin2=rb_intern("Dataflow__at_marked_lt__lt_bin2");
sy_Dataflow__at_marked_lt__lt_bin=rb_intern("Dataflow__at_marked_lt__lt_bin");
sy_Dataflow__at_marked_lt__lt_src=rb_intern("Dataflow__at_marked_lt__lt_src");
sy_Dataflow__at_oldssanums_eq_2=rb_intern("Dataflow__at_oldssanums_eq_2");
sy_Dataflow__at_oldssanums_eq_=rb_intern("Dataflow__at_oldssanums_eq_");
sy_Dataflow__lp_bind_lb_4_rb_=rb_intern("Dataflow__lp_bind_lb_4_rb_");
sy_Dataflow__lp_src_dot_instanc=rb_intern("Dataflow__lp_src_dot_instanc");
sy_Dataflow_bind_end_lp_src=rb_intern("Dataflow_bind_end_lp_src");
sy_Dataflow_bind_lb_0_rb__eq__lb__rb_=rb_intern("Dataflow_bind_lb_0_rb__eq__lb__rb_");
sy_Dataflow_bind_lb_41_rb__lt__lt_ol=rb_intern("Dataflow_bind_lb_41_rb__lt__lt_ol");
sy_Dataflow_bind_lb_4_rb__dot_ary=rb_intern("Dataflow_bind_lb_4_rb__dot_ary");
sy_Dataflow_bind_lb_58_rb__lt__lt__lb_b=rb_intern("Dataflow_bind_lb_58_rb__lt__lt__lb_b");
sy_Dataflow_bind_lb_5_rb__lt__lt_bin=rb_intern("Dataflow_bind_lb_5_rb__lt__lt_bin");
sy_Dataflow_bind_lb_6_rb__dot_each=rb_intern("Dataflow_bind_lb_6_rb__dot_each");
sy_Dataflow_bind_lb_8_rb__dot_each2=rb_intern("Dataflow_bind_lb_8_rb__dot_each2");
sy_Dataflow_bind_lb_8_rb__dot_each=rb_intern("Dataflow_bind_lb_8_rb__dot_each");
sy_Dataflow_if_sp_bind_lb_5_rb_=rb_intern("Dataflow_if_sp_bind_lb_5_rb_");
sy_Dataflow_many_end_lp_bin=rb_intern("Dataflow_many_end_lp_bin");
sy_Dataflow_n_eq_Result_lb__le__co_n=rb_intern("Dataflow_n_eq_Result_lb__le__co_n");
sy_Dataflow_oldssanums_dot_c=rb_intern("Dataflow_oldssanums_dot_c");
sy_Dataflow_or_end_lp_bind_lb_=rb_intern("Dataflow_or_end_lp_bind_lb_");
...
sy_Dataflow_src_dot_body_eq_bin=rb_intern("Dataflow_src_dot_body_eq_bin");
sy_Dataflow_src_dot_reachabl=rb_intern("Dataflow_src_dot_reachabl");
...
sy_Dataflow_ssanum_lp_src_rp_=rb_intern("Dataflow_ssanum_lp_src_rp_");
sy_Dataflow_ssanums_dot_clon=rb_intern("Dataflow_ssanums_dot_clon");
...
switchhashTraverser_Clone21=rb_eval_string("Hash.new{|h,k|\nnext h[k]=0 if k<=AmethystAST\nnext h[k]=1 if k<=Array\nnext h[k]=2 if k<=Object\n}\n");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),switchhashTraverser_Clone21);
sy_Dead_Code_Deleter3__append_lp_bind2=rb_intern("Dead_Code_Deleter3__append_lp_bind2");
sy_Dead_Code_Deleter3__append_lp_bind3=rb_intern("Dead_Code_Deleter3__append_lp_bind3");
sy_Dead_Code_Deleter3__append_lp_bind4=rb_intern("Dead_Code_Deleter3__append_lp_bind4");
sy_Dead_Code_Deleter3__append_lp_bind5=rb_intern("Dead_Code_Deleter3__append_lp_bind5");
sy_Dead_Code_Deleter3__append_lp_bind6=rb_intern("Dead_Code_Deleter3__append_lp_bind6");
sy_Dead_Code_Deleter3__append_lp_bind7=rb_intern("Dead_Code_Deleter3__append_lp_bind7");
sy_Dead_Code_Deleter3__append_lp_bind8=rb_intern("Dead_Code_Deleter3__append_lp_bind8");
sy_Dead_Code_Deleter3__append_lp_bind=rb_intern("Dead_Code_Deleter3__append_lp_bind");
sy_Dead_Code_Deleter3__at_bounded=rb_intern("Dead_Code_Deleter3__at_bounded");
sy_Dead_Code_Deleter3__at_bounded_eq_fal=rb_intern("Dead_Code_Deleter3__at_bounded_eq_fal");
sy_Dead_Code_Deleter3__at_changed=rb_intern("Dead_Code_Deleter3__at_changed");
sy_Dead_Code_Deleter3__at_changed_eq_fal=rb_intern("Dead_Code_Deleter3__at_changed_eq_fal");
sy_Dead_Code_Deleter3__at_changed_eq_tru=rb_intern("Dead_Code_Deleter3__at_changed_eq_tru");
sy_Dead_Code_Deleter3__at_reachable_eq_s=rb_intern("Dead_Code_Deleter3__at_reachable_eq_s");
sy_Dead_Code_Deleter3__at_reachable_lb_b=rb_intern("Dead_Code_Deleter3__at_reachable_lb_b");
sy_Dead_Code_Deleter3__at_reachable_lb_s=rb_intern("Dead_Code_Deleter3__at_reachable_lb_s");
...
sy_Dead_Code_Deleter3__lp_src_dot_instanc=rb_intern("Dead_Code_Deleter3__lp_src_dot_instanc");
sy_Dead_Code_Deleter3_bind_lb_5_rb__lt__lt_bin=rb_intern("Dead_Code_Deleter3_bind_lb_5_rb__lt__lt_bin");
sy_Dead_Code_Deleter3_if_sp_bind_lb_5_rb_=rb_intern("Dead_Code_Deleter3_if_sp_bind_lb_5_rb_");
sy_Dead_Code_Deleter3_src=rb_intern("Dead_Code_Deleter3_src");
sy_Dead_Code_Deleter3_src_dot_reachabl=rb_intern("Dead_Code_Deleter3_src_dot_reachabl");
...
c_Rule=rb_const_get(rb_cObject, rb_intern("Rule"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_Rule);
switchhashTraverser_Clone21=rb_eval_string("Hash.new{|h,k|\nnext h[k]=0 if k<=AmethystAST\nnext h[k]=1 if k<=Array\nnext h[k]=2 if k<=Object\n}\n");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),switchhashTraverser_Clone21);
sy_Forget_SSA__append_lp_bind2=rb_intern("Forget_SSA__append_lp_bind2");
sy_Forget_SSA__append_lp_bind3=rb_intern("Forget_SSA__append_lp_bind3");
sy_Forget_SSA__append_lp_bind4=rb_intern("Forget_SSA__append_lp_bind4");
sy_Forget_SSA__append_lp_bind=rb_intern("Forget_SSA__append_lp_bind");
sy_Forget_SSA__at_changed=rb_intern("Forget_SSA__at_changed");
sy_Forget_SSA__at_changed_eq_fal=rb_intern("Forget_SSA__at_changed_eq_fal");
sy_Forget_SSA__at_changed_eq_tru=rb_intern("Forget_SSA__at_changed_eq_tru");
sy_Forget_SSA__lp_bind_lb_4_rb_=rb_intern("Forget_SSA__lp_bind_lb_4_rb_");
sy_Forget_SSA__lp_src_dot_instanc=rb_intern("Forget_SSA__lp_src_dot_instanc");
sy_Forget_SSA_bind_lb_5_rb__lt__lt_bin=rb_intern("Forget_SSA_bind_lb_5_rb__lt__lt_bin");
sy_Forget_SSA_if_sp_bind_lb_5_rb_=rb_intern("Forget_SSA_if_sp_bind_lb_5_rb_");
sy_Forget_SSA_src=rb_intern("Forget_SSA_src");
sy_Forget_SSA_src_dot_unssa=rb_intern("Forget_SSA_src_dot_unssa");
...
rb_define_method(cls_Forget_SSA,"visit",Forget_SSA_visit,0);
 rb_eval_string("testversiondataflow_ssa('b942ca024b264470e834fc796d1fbb91')");}
