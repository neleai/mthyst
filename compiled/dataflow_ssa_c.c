...
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,12,it); it=rb_ary_new3(0);int oldpos6; while(1){oldpos6=ame_getpos(self); it=CALL(visit_Dataflowcb_6,1,bind);   it=Dataflow_traverse_item(self ); FAILTEST(break2);it=CALL(visit_Dataflowcb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=CALL(visit_Dataflowcb_8,1,bind); it=CALL(visit_Dataflowcb_9,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16,it); it=CALL(visit_Dataflowcb_10,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,15);
 rb_ary_store(bind,17,it); it=CALL(visit_Dataflowcb_11,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,22,it); it=CALL(visit_Dataflowcb_13,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,3,it); it=CALL(visit_Dataflowcb_14,1,bind); it=CALL(visit_Dataflowcb_15,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,24)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,25,it); it=CALL(visit_Dataflowcb_17,1,bind); int oldpos12=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,26,it);   it=Dataflow_eof(self ); FAILTEST(pass8);
	...
	if(fail8) goto pass7;
it=CALL(visit_Dataflowcb_18,1,bind); it=CALL(visit_Dataflowcb_19,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Dataflow_traverse_item(self ); FAILTEST(pass9);it=CALL(visit_Dataflowcb_20,1,bind); it=CALL(visit_Dataflowcb_21,1,bind); 
 rb_ary_store(bind,29,it); it=CALL(visit_Dataflowcb_22,1,bind); int oldpos14=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
...
ame_setsrc(self,rb_ary_entry(bind,34)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos18; while(1){oldpos18=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos18=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos18); it=CALL(visit_Dataflowcb_24,1,bind); it=CALL(visit_Dataflowcb_25,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,37)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,38,it); it=CALL(visit_Dataflowcb_27,1,bind); int oldpos20=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
...
ame_setsrc(self,rb_ary_entry(bind,42)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,44,it); it=CALL(visit_Dataflowcb_29,1,bind);  if (IGET(stop)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos23); it=rb_ary_entry(bind,43);
 rb_ary_store(bind,3,it); it=CALL(visit_Dataflowcb_30,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,46)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos26; while(1){oldpos26=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos26=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos26); it=CALL(visit_Dataflowcb_35,1,bind); 
...
rb_define_method(cls_Dead_Code_Deleter3,"visit",Dead_Code_Deleter3_visit,0);
 rb_eval_string("testversiondataflow_ssa('98381292c1507cf7335c0d619795de16')");}
