...
alt1_4: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case 1/*Args*/:; int oldpos2=ptr->pos;int cut2=0;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt2_3);
;goto accept2;
alt2_3: ptr->pos=oldpos2;stop1=1;
;goto accept2;
alt2_4: ptr->pos=oldpos2;goto fail;
 accept2:;
 break;
case 2/*Bind*/:; int oldpos3=ptr->pos;int cut3=0;
...
alt3_4: ptr->pos=oldpos3;goto fail;
 accept3:;
 break;
case 3/*CAct*/:; int oldpos4=ptr->pos;int cut4=0;
...
alt4_4: ptr->pos=oldpos4;goto fail;
 accept4:;
 break;
case 4/*Global*/:; int oldpos5=ptr->pos;int cut5=0;
...
alt5_4: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
case 5/*Key*/:; int oldpos6=ptr->pos;int cut6=0;
...
;goto accept6;
alt6_3: ptr->pos=oldpos6;stop1=1;
;goto accept6;
alt6_4: ptr->pos=oldpos6;goto fail;
 accept6:;
 break;
case 6/*Local*/:; int oldpos7=ptr->pos;int cut7=0;
...
alt7_4: ptr->pos=oldpos7;goto fail;
 accept7:;
 break;
case 7/*Result*/:; int oldpos8=ptr->pos;int cut8=0;
...
;goto accept8;
alt8_4: ptr->pos=oldpos8;goto fail;
 accept8:;
 break;
case 8/*Object*/:; int oldpos9=ptr->pos;int cut9=0;
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);
;goto accept9;
alt9_2: ptr->pos=oldpos9;stop1=1;
;goto accept9;
...
alt3_1:;  it=Dataflow_traverse_item(self ); FAILTEST(alt3_2); var28/*autovar*/=it;;
...
;goto accept3;
alt3_3: ptr->pos=oldpos3;goto pass10;
 accept3:;
...
alt4_1:;  it=Dataflow_traverse_item(self ); FAILTEST(alt4_2); var33/*autovar*/=it;;
...
alt5_1:;bind_aset(bind2,1,var26/*old*/);it=rb_funcall(self,sy_Dataflow__at_oldssan_37c2,1,bind2);var26/*old*/=bind_aget(bind2,1);;  it=Dataflow_traverse_item(self ); FAILTEST(alt5_2); var37/*autovar*/=it;;
...
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto pass12;
 accept5:;
...
alt6_1:;  it=Dataflow_traverse_item(self ); FAILTEST(alt6_2); var50/*autovar*/=it;;
...
;goto accept6;
alt6_3: ptr->pos=oldpos6;goto pass18;
 accept6:;
...
alt7_1:;bind_aset(bind2,1,var26/*old*/);it=rb_funcall(self,sy_Dataflow__at_oldssan_37c2,1,bind2);var26/*old*/=bind_aget(bind2,1);;  it=AmethystCore_anything(self ); FAILTEST(alt7_2); var54/*autovar*/=it;;
...
bind_aset(bind2,1,var53/*alts*/);bind_aset(bind2,2,var55/*pred*/);bind_aset(bind2,3,var56/*a*/);it=rb_funcall(self,sy_Dataflow_bind_lb_1_rb__lt__c37a,1,bind2);var53/*alts*/=bind_aget(bind2,1);;var55/*pred*/=bind_aget(bind2,2);;var56/*a*/=bind_aget(bind2,3);;it=Qnil;if (ptr->pos<ptr->len) goto pass20;
                   goto success20;
                   pass20: *ptr=oldpass20; goto alt7_2;
...
;goto accept7;
alt7_3: ptr->pos=oldpos7;goto pass19;
 accept7:;
