...
char chr1=FIX2INT(CALL(switchcb3,1,ame_curobj(self)));  switch(chr1){case 0:; char chr2=FIX2INT(CALL(switchcb2,1,ame_curobj(self)));  switch(chr2){case 0:;  it=CALL(visit_Dead_Code_Deleter3cb_1,1,bind);  arg0=it; it=Dead_Code_Deleter3_clas(self ,arg0); FAILTEST(fail);
...
it=CALL(visit_Dead_Code_Deleter3cb_9,1,bind); 
 BSET(_result_1,it);  break;case 2:; char chr3=FIX2INT(CALL(switchcb2,1,ame_curobj(self)));  switch(chr3){case 0:;  it=CALL(visit_Dead_Code_Deleter3cb_10,1,bind);  arg0=it; it=Dead_Code_Deleter3_clas(self ,arg0); FAILTEST(fail);
...
it=CALL(visit_Dead_Code_Deleter3cb_17,1,bind); 
 BSET(_result_1,it);  break;case 4:; char chr4=FIX2INT(CALL(switchcb2,1,ame_curobj(self)));  switch(chr4){case 0:;  it=CALL(visit_Dead_Code_Deleter3cb_18,1,bind);  arg0=it; it=Dead_Code_Deleter3_clas(self ,arg0); FAILTEST(fail);
...
rb_define_method(cls_Dead_Code_Deleter3,"visit",Dead_Code_Deleter3_visit,0);
 rb_eval_string("testversion('feb7754cfd9d21e24e28b80ee525b03b')");}
