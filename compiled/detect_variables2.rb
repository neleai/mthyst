...
connectstring(bind[6].flatten)
end
def visit_Analyze_Variables2cb_5(bind)
(bind[7].size==1&&(bind[7][0].is_a?(Local)||bind[7][0].is_a?(Global)||bind[7][0].is_a?(Key))) ? bind[7][0] : Args[*bind[7]]
end
...
'a5750affd8782b211c07073b8a8effb0'
end
