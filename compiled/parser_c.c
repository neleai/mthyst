...
int oldpos5; int stop4=0; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos6=ptr->pos;int cut2=0;
...
case UC(92) ... UC(92):; int oldpos8=ptr->pos;int cut3=0;
...
int oldpos16; int stop10=0; while(1){oldpos16=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos17=ptr->pos;int cut7=0;
...
case UC(92) ... UC(92):; int oldpos19=ptr->pos;int cut8=0;
...
int oldpos27; int stop16=0; while(1){oldpos27=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos28=ptr->pos;int cut12=0;
...
case UC(92) ... UC(92):; int oldpos30=ptr->pos;int cut13=0;
...
int oldpos38; int stop22=0; while(1){oldpos38=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos39=ptr->pos;int cut17=0;
...
case UC(92) ... UC(92):; int oldpos41=ptr->pos;int cut18=0;
...
int oldpos50; int stop29=0; while(1){oldpos50=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos51=ptr->pos;int cut22=0;
...
case UC(92) ... UC(92):; int oldpos53=ptr->pos;int cut23=0;
...
int oldpos62; int stop35=0; while(1){oldpos62=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos63=ptr->pos;int cut28=0;
...
case UC(92) ... UC(92):; int oldpos65=ptr->pos;int cut29=0;
...
int oldpos73; int stop41=0; while(1){oldpos73=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos74=ptr->pos;int cut33=0;
...
case UC(92) ... UC(92):; int oldpos76=ptr->pos;int cut34=0;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('a3a9c5f7dfd5fbb1f467ec76dafa8a79')");}
