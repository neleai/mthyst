...
static VALUE sy_AmethystParser_Apply_lb__dq_s_22c0;
static VALUE sy_AmethystParser_Apply_lb__dq_t_3d7c;
...
static VALUE sy_AmethystParser_Args_lb__le__co_a_6fff;
static VALUE sy_AmethystParser_Bind_lb_loc_eddf;
static VALUE sy_AmethystParser_Comment_lb__1c29;
static VALUE sy_AmethystParser_Enter_lb_Ap_7f5a;
...
static VALUE sy_AmethystParser_Lambda_lb_B_4765;
...
static VALUE sy_AmethystParser_Strin_lb__lb__dq__bc99;
static VALUE sy_AmethystParser_Strin_lb__lb__qu__5f8f;
static VALUE sy_AmethystParser__append_lp__0639;
static VALUE sy_AmethystParser__append_lp__088f;
static VALUE sy_AmethystParser__append_lp__132b;
...
static VALUE sy_AmethystParser__lb_bind_lb_24_09cc;
static VALUE sy_AmethystParser__lp_bind_lb_0_rb__418b;
static VALUE sy_AmethystParser_a_eq_autova_41ab;
...
static VALUE sy_AmethystParser_bind_lb_19_rb__7bbf;
...
return it;
fail: return failobj; }
VALUE AmethystParser_interpolated(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=bind_new2(15); bind_aset(bind,1/*e*/,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  } break2: ptr->pos=oldpos4;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_6fff,1,bind);  bind_aset(bind,11/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__73f1,1,bind);   it=AmethystCore_anything(self ); FAILTEST(alt3_3); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__f8f8,1,bind); 
;goto accept5;
alt3_3: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind); 
;goto accept2;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__29a3,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  } break1: ptr->pos=oldpos5;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__7140,1,bind);  break;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  } break3: ptr->pos=oldpos11;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__0639,1,bind);   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7140,1,bind);  break;
} if (stop2) goto accept9; } break2: goto alt7_2; accept9:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_12_rb__b690,1,bind);  bind_aset(bind,16/*_result*/,it);
it=bind_aget(bind,16/*_result*/); bind_aset(bind,17/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Strin_lb__lb__qu__5f8f,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__4548,1,bind);  break;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__132b,1,bind);   it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__4548,1,bind);  break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut14=1;stop4=1; break;
} break;
} if (stop4) goto accept18; } break4: goto alt14_2; accept18:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_19_rb__7bbf,1,bind);  bind_aset(bind,22/*_result*/,it);
it=bind_aget(bind,22/*_result*/); bind_aset(bind,17/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Strin_lb__lb__dq__bc99,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  } break5: ptr->pos=oldpos22;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
}it=rb_funcall(self,sy_AmethystParser__lb_bind_lb_24_09cc,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  } break6: ptr->pos=oldpos36;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}it=rb_funcall(self,sy_AmethystParser_Lambda_lb_B_4765,1,bind);  bind_aset(bind,3/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_term(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(12);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__6adb,1,bind);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__dd73,1,bind);  break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop1=1; break;
} break;
} if (stop1) goto accept7; } break1: goto alt3_7; accept7:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_3_rb__dot__e626,1,bind);  bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_t_3d7c,1,bind);  bind_aset(bind,0/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser_Comment_lb__1c29,1,bind);  bind_aset(bind,0/*_result*/,it);
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__6adb,1,bind);   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__dd73,1,bind);  break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut5=1;stop2=1; break;
} break;
} if (stop2) goto accept12; } break2: goto alt5_7; accept12:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_3_rb__dot__e626,1,bind);  bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_s_22c0,1,bind);  bind_aset(bind,0/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser_a_eq_autova_41ab,1,bind);  bind_aset(bind,10/*_result*/,it);
...
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}it=rb_funcall(self,sy_AmethystParser_Enter_lb_Ap_7f5a,1,bind);  bind_aset(bind,0/*_result*/,it);
...
sy_AmethystParser_Apply_lb__dq_s_22c0=rb_intern("AmethystParser_Apply_lb__dq_s_22c0");
sy_AmethystParser_Apply_lb__dq_t_3d7c=rb_intern("AmethystParser_Apply_lb__dq_t_3d7c");
...
sy_AmethystParser_Args_lb__le__co_a_6fff=rb_intern("AmethystParser_Args_lb__le__co_a_6fff");
sy_AmethystParser_Bind_lb_loc_eddf=rb_intern("AmethystParser_Bind_lb_loc_eddf");
sy_AmethystParser_Comment_lb__1c29=rb_intern("AmethystParser_Comment_lb__1c29");
sy_AmethystParser_Enter_lb_Ap_7f5a=rb_intern("AmethystParser_Enter_lb_Ap_7f5a");
...
sy_AmethystParser_Lambda_lb_B_4765=rb_intern("AmethystParser_Lambda_lb_B_4765");
...
sy_AmethystParser_Strin_lb__lb__dq__bc99=rb_intern("AmethystParser_Strin_lb__lb__dq__bc99");
sy_AmethystParser_Strin_lb__lb__qu__5f8f=rb_intern("AmethystParser_Strin_lb__lb__qu__5f8f");
sy_AmethystParser__append_lp__0639=rb_intern("AmethystParser__append_lp__0639");
sy_AmethystParser__append_lp__088f=rb_intern("AmethystParser__append_lp__088f");
sy_AmethystParser__append_lp__132b=rb_intern("AmethystParser__append_lp__132b");
...
sy_AmethystParser__lb_bind_lb_24_09cc=rb_intern("AmethystParser__lb_bind_lb_24_09cc");
sy_AmethystParser__lp_bind_lb_0_rb__418b=rb_intern("AmethystParser__lp_bind_lb_0_rb__418b");
sy_AmethystParser_a_eq_autova_41ab=rb_intern("AmethystParser_a_eq_autova_41ab");
...
sy_AmethystParser_bind_lb_19_rb__7bbf=rb_intern("AmethystParser_bind_lb_19_rb__7bbf");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('79bcf0059355dc834f95239d4f5a7169')");}
