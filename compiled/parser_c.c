...
int oldpos11;  while(1){oldpos11=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break3); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; } break3: ptr->pos=oldpos11;   it=var4/*autovar*/; var6/*r*/=it;;
...
alt10_3: ptr->pos=oldpos13;goto alt7_3;
 accept13:;
  it=AmethystParser_name(self ); FAILTEST(alt7_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept8;
alt7_3: ptr->pos=oldpos8;  it=AmethystParser_key(self ); FAILTEST(alt7_4); var3/*_result*/=it;;
...
alt13_3: ptr->pos=oldpos16;goto alt11_2;
 accept16:;
  it=AmethystParser_name(self ); FAILTEST(alt11_2); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept14;
alt11_2: ptr->pos=oldpos14;  it=AmethystParser_key(self ); FAILTEST(alt11_3); var3/*_result*/=it;;

;goto accept14;
alt11_3: ptr->pos=oldpos14;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;
...
alt16_3: ptr->pos=oldpos20;goto alt14_3;
 accept20:;
  it=AmethystParser_name(self ); FAILTEST(alt14_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept17;
alt14_3: ptr->pos=oldpos17;  it=AmethystParser_key(self ); FAILTEST(alt14_4); var3/*_result*/=it;;
...
int oldpos22;  while(1){oldpos22=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break5); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; } break5: ptr->pos=oldpos22;   it=var4/*autovar*/; var6/*r*/=it;;
...
;goto accept21;
alt17_3: ptr->pos=oldpos21;  it=AmethystParser_key(self ); FAILTEST(alt17_4); var3/*_result*/=it;;
...
alt22_3: ptr->pos=oldpos27;goto alt20_2;
 accept27:;
  it=AmethystParser_name(self ); FAILTEST(alt20_2); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept25;
alt20_2: ptr->pos=oldpos25;  it=AmethystParser_key(self ); FAILTEST(alt20_3); var3/*_result*/=it;;
...
alt24_1:;if (ame_curstr2(ptr)[0]=='.'&&ame_curstr2(ptr)[1]=='.')  ptr->pos+=2; else goto alt24_2;it=rb_obj_clone(s__dot__dot__dot__2f43); var23/*_result*/=it;;
it=var23/*_result*/; var3/*_result*/=it;;

;goto accept29;
alt24_2: ptr->pos=oldpos29;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt24_3;it=rb_obj_clone(s__dot__dot__58b9); var23/*_result*/=it;;
it=var23/*_result*/; var3/*_result*/=it;;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept30;
alt25_2: ptr->pos=oldpos30;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var18/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var18/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var18/*autovar*/=bind_aget(bind2,2);;
;goto accept30;
...
alt26_3: ptr->pos=oldpos31;goto alt23_3;
 accept31:;
  it=AmethystParser_name(self ); FAILTEST(alt23_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept28;
alt23_3: ptr->pos=oldpos28;  it=AmethystParser_key(self ); FAILTEST(alt23_4); var3/*_result*/=it;;

;goto accept28;
alt23_4: ptr->pos=oldpos28;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;
...
alt27_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var24/*e*/=it;;
...
;goto accept32;
alt27_3: ptr->pos=oldpos32;  it=AmethystParser_key(self ); FAILTEST(alt27_4); var3/*_result*/=it;;

;goto accept32;
alt27_4: ptr->pos=oldpos32;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;
...
alt30_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt30_2);it=rb_ary_new3(0); var4/*autovar*/=it;;
int oldpos36;  while(1){oldpos36=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break6); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; } break6: ptr->pos=oldpos36;   it=var4/*autovar*/; var6/*r*/=it;;
...
alt32_3: ptr->pos=oldpos38;goto alt30_3;
 accept38:;
  it=AmethystParser_name(self ); FAILTEST(alt30_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept35;
alt30_3: ptr->pos=oldpos35;  it=AmethystParser_key(self ); FAILTEST(alt30_4); var3/*_result*/=it;;
...
alt33_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt33_2); var24/*e*/=it;;
...
alt35_3: ptr->pos=oldpos41;goto alt33_3;
 accept41:;
  it=AmethystParser_name(self ); FAILTEST(alt33_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept39;
alt33_3: ptr->pos=oldpos39;  it=AmethystParser_key(self ); FAILTEST(alt33_4); var3/*_result*/=it;;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('84e97cd409a4a5ae4dd5328c84e34ecb')");}
