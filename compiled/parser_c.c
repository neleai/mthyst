...
static VALUE sy_AmethystParser_Apply_lb__dq_m_4186;
...
case '-' ... '-':;case '0' ... '9':;   it=Amethyst_number(self ); FAILTEST(alt8_2); bind_aset(bind,14/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__b0ba,1,bind); 
;goto accept8;
alt8_2: ptr->pos=oldpos9;it=bind_aget(bind,11/*autovar*/); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0a14,1,bind); 
;goto accept8;
alt8_3: ptr->pos=oldpos9;goto alt7_2;
 accept8:;
it=bind_aget(bind,8/*autovar*/); bind_aset(bind,16/*num*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_4186,1,bind);  bind_aset(bind,7/*_result*/,it);
...
sy_AmethystParser_Apply_lb__dq_m_4186=rb_intern("AmethystParser_Apply_lb__dq_m_4186");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('65e94f70dbe5f3e294e1034f507fa313')");}
