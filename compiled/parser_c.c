...
static VALUE sy__Seq_AST_dot__a126;
static VALUE sy__Seq_AST_lb__1817;
...
static VALUE sy__x_eq__dq_ameth_2569;
...
alt2_1:
            ;
            it=rb_funcall(self,sy_lambda,0);
            if (it==failobj) {
                it=failobj;
                goto alt2_2;
            }
...
VALUE AmethystParser_collect(VALUE self ,VALUE a0) {
    ...
    it=rb_funcall(self,sy__a_eq_autova_57aa,1,bind2);
...
VALUE AmethystParser_file(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_autovar,_autovar_2,_autovar_3,_autovar_4,_it,_autovar_5,_oldpos,_autovar_6,_autovar_7,_g,__result;
    VALUE bind2=bind_new2(16);
    int x;
    VALUE arg0,arg1,arg2,arg3;
    cstruct *ptr;
...
alt2_2:
            ...
            it=rb_funcall(self,sy__pos_5e0b,1,bind2);
            _oldpos=it;;
            ...
            it=rb_funcall(self,sy__x_eq__dq_ameth_2569,1,bind2);
...
alt1_1:
            ...
            case ':' ... ':':
                ...
                case '{' ... '{':
                    ...
                    it=rb_funcall(self,sy__Seq_AST_lb__66a7,1,bind2);
                    _from=bind_aget(bind2,1);;
...
VALUE AmethystParser_rule(VALUE self ) {
    ...
    _locals=it;;
    bind_aset(bind2,1,_body);
    it=rb_funcall(self,sy__bind_lb_1_rb__eq__e198,1,bind2);
    _body=bind_aget(bind2,1);;
...
accept1:
    ...
    _ary=it;;
    bind_aset(bind2,1,_ary);
    it=rb_funcall(self,sy__Seq_AST_dot__a126,1,bind2);
    _ary=bind_aget(bind2,1);;
    __result=it;;
...
void Init_parser_c() {
    ...
    sy__Seq_AST_dot__a126=rb_intern("_Seq_AST_dot__a126");
    sy__Seq_AST_lb__1817=rb_intern("_Seq_AST_lb__1817");
    ...
    sy__x_eq__dq_ameth_2569=rb_intern("_x_eq__dq_ameth_2569");
    ...
    rb_eval_string("testversionparser('3c95e700d2b4589fe98f68ad59eb7ff9')");
}
