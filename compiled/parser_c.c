...
it=rb_ary_new3(0); it=BGET(o_1); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("");
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2("\\"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_char(self ); FAILTEST(alt1_2);
...
it=rb_str_new2("{");
 ...
 BSET(s_1,it);   it=AmethystParser_spaces(self ); FAILTEST(fail); it=BGET(s_1); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=CALL(grammar_AmethystParsercb_3,1,bind);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
alt4_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_2;}
  it=rb_str_new2("amethyst"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt4_2);ISET(cut,Qtrue);  it=AmethystParser_fails(self ); FAILTEST(alt4_2); 
...
alt6_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  it=rb_str_new2("amethyst"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_2);ISET(cut,Qtrue);  it=AmethystParser_fails(self ); FAILTEST(alt6_2); 
...
alt6_4: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_str_new2("?");
 BSET(s_1,it);   it=AmethystParser_spaces(self ); FAILTEST(alt6_5); it=BGET(s_1); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_5);it=CALL(prefixed_AmethystParsercb_9,1,bind); 
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept7;
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_3); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);  it=AmethystParser_expression(self ); FAILTEST(alt1_3);
 BSET(expr_1,it); it=rb_str_new2(")");
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_3); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);it=CALL(term_AmethystParsercb_2,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("break");
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_4); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_4);it=CALL(term_AmethystParsercb_3,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("\"");
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_8); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_8);it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self); int oldpos4=ame_getpos(self);
...
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("'");
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_9); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_9);it=rb_ary_new3(0);int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("<");
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_11); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_11);it=rb_ary_new3(0);int oldpos7; while(1){oldpos7=ame_getpos(self); int oldpos8=ame_getpos(self);
