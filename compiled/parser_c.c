...
#include "../lib/c/memo.c"
 memo_struct *mem;VALUE memo_val;VALUE profile_report(VALUE self){printf("argsOpt hit: %i miss: %i\n",mem->hits[113],mem->miss[113]);printf("name hit: %i miss: %i\n",mem->hits[115],mem->miss[115]);return Qnil;}VALUE AmethystParser__args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=bind_new2(7);VALUE bind2=bind_new2(16); bind_aset(bind,0/*o*/,a0);bind_aset(bind,5/*c*/,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*r*/,it);
it=bind_aget(bind,5/*c*/); bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=bind_aget(bind,1/*s*/);bind_aset(bind2,1,bind_aget(bind,4/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,4/*r*/,bind_aget(bind2,1)); bind_aset(bind,6/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=bind_new2(11);VALUE bind2=bind_new2(16); bind_aset(bind,2/*o*/,a0);bind_aset(bind,0/*c*/,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,5/*autovar*/));bind_aset(bind2,2,bind_aget(bind,6/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,5/*autovar*/,bind_aget(bind2,1));bind_aset(bind,6/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,5/*autovar*/); bind_aset(bind,7/*r*/,it);
it=bind_aget(bind,1/*c*/); bind_aset(bind,4/*s*/,it);
 it=bind_aget(bind,4/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=bind_aget(bind,4/*s*/);bind_aset(bind2,1,bind_aget(bind,7/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,7/*r*/,bind_aget(bind2,1)); bind_aset(bind,8/*_result*/,it);
it=bind_aget(bind,8/*_result*/); bind_aset(bind,9/*r*/,it);
bind_aset(bind2,1,bind_aget(bind,2/*o*/));bind_aset(bind2,2,bind_aget(bind,9/*r*/));bind_aset(bind2,3,bind_aget(bind,0/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,2/*o*/,bind_aget(bind2,1));bind_aset(bind,9/*r*/,bind_aget(bind2,2));bind_aset(bind,0/*c*/,bind_aget(bind2,3)); bind_aset(bind,10/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_argsOpt(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos3;   it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt1_2; break;
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,2/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,2/*r*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*r*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__pl__b087,1,bind2);bind_aset(bind,4/*r*/,bind_aget(bind2,1)); bind_aset(bind,5/*autovar*/,it);
...
VALUE AmethystParser_call(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*klas*/));bind_aset(bind2,2,bind_aget(bind,1/*name*/));bind_aset(bind2,3,bind_aget(bind,2/*arg*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__lb_b_099b,1,bind2);bind_aset(bind,0/*klas*/,bind_aget(bind2,1));bind_aset(bind,1/*name*/,bind_aget(bind2,2));bind_aset(bind,2/*arg*/,bind_aget(bind2,3)); bind_aset(bind,3/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,1/*name*/));bind_aset(bind2,2,bind_aget(bind,2/*arg*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb_bi_9146,1,bind2);bind_aset(bind,1/*name*/,bind_aget(bind2,1));bind_aset(bind,2/*arg*/,bind_aget(bind2,2)); bind_aset(bind,3/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_cases(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(15);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt2_3: ptr->pos=oldpos2;goto alt1_2;
 accept2:;
 break;
}bind_aset(bind2,1,bind_aget(bind,0/*clas*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_c_a8b6,1,bind2);bind_aset(bind,0/*clas*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2));switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... UC(255):; goto alt3_2; break;
...
alt4_3: ptr->pos=oldpos4;goto alt3_2;
 accept4:;
 break;
}bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));  it=Amethyst_number(self ); FAILTEST(alt3_2); bind_aset(bind,6/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,6/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,6/*autovar*/,bind_aget(bind2,2));it=bind_aget(bind,2/*autovar*/); bind_aset(bind,7/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,7/*it*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);bind_aset(bind,7/*it*/,bind_aget(bind2,1)); bind_aset(bind,8/*num*/,it);
...
alt3_3: ptr->pos=oldpos3;goto alt1_3;
 accept3:;
bind_aset(bind2,1,bind_aget(bind,8/*num*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ec1,1,bind2);bind_aset(bind,8/*num*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,10/*x*/));bind_aset(bind2,2,bind_aget(bind,11/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,10/*x*/,bind_aget(bind2,1));bind_aset(bind,11/*autovar*/,bind_aget(bind2,2));
;goto accept6;
...
goto alt6_2;
;goto accept7;
alt6_2: ptr->pos=oldpos7;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,12/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,10/*x*/));bind_aset(bind2,2,bind_aget(bind,12/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,10/*x*/,bind_aget(bind2,1));bind_aset(bind,12/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(alt6_3); bind_aset(bind,11/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,10/*x*/));bind_aset(bind2,2,bind_aget(bind,11/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,10/*x*/,bind_aget(bind2,1));bind_aset(bind,11/*autovar*/,bind_aget(bind2,2));
;goto accept7;
...
} if (stop1) goto accept5; } break1: goto alt1_4; accept5:;   bind_aset(bind2,1,bind_aget(bind,10/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,10/*x*/,bind_aget(bind2,1)); bind_aset(bind,13/*_result*/,it);
it=bind_aget(bind,13/*_result*/); bind_aset(bind,14/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,14/*s*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_269c,1,bind2);bind_aset(bind,14/*s*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_className(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(7);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2));it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); break;
} } break1: ptr->pos=oldpos1;   it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,4/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,4/*autovar*/,bind_aget(bind2,2));it=bind_aget(bind,0/*autovar*/); bind_aset(bind,5/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,5/*it*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);bind_aset(bind,5/*it*/,bind_aget(bind2,1)); bind_aset(bind,6/*_result*/,it);
 break;
}
return it;
fail: return failobj; }
VALUE AmethystParser_collect(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=bind_new2(2);VALUE bind2=bind_new2(16); bind_aset(bind,0/*ors*/,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
bind_aset(bind2,1,bind_aget(bind,0/*ors*/));it=rb_funcall(self,sy_AmethystParser_a_eq_autova_5b84,1,bind2);bind_aset(bind,0/*ors*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_expression(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(8);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_ary_new3(0); bind_aset(bind,0/*f*/,it);
int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=AmethystParser_sequence(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*f*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*f*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2));it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos2;   it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*f*/));bind_aset(bind2,2,bind_aget(bind,4/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*f*/,bind_aget(bind2,1));bind_aset(bind,4/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*f*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,0/*f*/,bind_aget(bind2,1)); bind_aset(bind,5/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,6/*ary*/));it=rb_funcall(self,sy_AmethystParser_Or_AST_dot_c_19e2,1,bind2);bind_aset(bind,6/*ary*/,bind_aget(bind2,1)); bind_aset(bind,7/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_grammar(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos2;   it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*rules*/,it);
  it=Amethyst_spaces(self ); FAILTEST(fail);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '|':;case '~' ... UC(255):; goto fail; break;
case '}' ... '}':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,0/*name*/));bind_aset(bind2,2,bind_aget(bind,1/*parent*/));bind_aset(bind2,3,bind_aget(bind,4/*rules*/));it=rb_funcall(self,sy_AmethystParser_Grammar_dot__a510,1,bind2);bind_aset(bind,0/*name*/,bind_aget(bind2,1));bind_aset(bind,1/*parent*/,bind_aget(bind2,2));bind_aset(bind,4/*rules*/,bind_aget(bind2,3)); bind_aset(bind,5/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_host_expr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,1/*s*/));it=rb_funcall(self,sy_AmethystParser__dq__le__dq__pl_bind_567e,1,bind2);bind_aset(bind,1/*s*/,bind_aget(bind2,1)); bind_aset(bind,2/*autovar*/,it);
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
return it;
fail: return failobj; }
VALUE AmethystParser_igrammar(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(8);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));int oldpos3;  while(1){oldpos3=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,3/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); break;
...
bind_aset(bind2,1,bind_aget(bind,4/*it*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);bind_aset(bind,4/*it*/,bind_aget(bind2,1)); bind_aset(bind,5/*autovar*/,it);
...
alt1_4: ptr->pos=oldpos2;goto break1;
 accept2:;
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); break;
...
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));int oldpos7;  while(1){oldpos7=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,3/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2)); break;
...
return it;
fail: return failobj; }
VALUE AmethystParser_inline_host_expr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '|':;case '~' ... UC(255):; goto fail; break;
case '}' ... '}':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,2/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,2/*r*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*r*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*r*/));it=rb_funcall(self,sy_AmethystParser_Act_lb_Args_23b1,1,bind2);bind_aset(bind,4/*r*/,bind_aget(bind2,1)); bind_aset(bind,5/*_result*/,it);
 break;
}
return it;
fail: return failobj; }
VALUE AmethystParser_interpolated(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=bind_new2(15);VALUE bind2=bind_new2(16); bind_aset(bind,1/*e*/,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*x*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2));
;goto accept2;
...
;goto accept3;
alt2_2: ptr->pos=oldpos3;if (cut2) goto break1;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='{')  ptr->pos+=1; else goto alt2_3;  it=Amethyst_spaces(self ); FAILTEST(alt2_3);it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos4;  while(1){oldpos4=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break2); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,4/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); } break2: ptr->pos=oldpos4;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '|':;case '~' ... UC(255):; goto alt2_3; break;
case '}' ... '}':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,6/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,6/*r*/,bind_aget(bind2,1)); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*r*/,it);
it=rb_obj_clone(s__bs__sh__le__a90f); bind_aset(bind,9/*o*/,it);
it=rb_obj_clone(s__re__cbb1); bind_aset(bind,10/*c*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*o*/));bind_aset(bind2,2,bind_aget(bind,8/*r*/));bind_aset(bind2,3,bind_aget(bind,10/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,9/*o*/,bind_aget(bind2,1));bind_aset(bind,8/*r*/,bind_aget(bind2,2));bind_aset(bind,10/*c*/,bind_aget(bind2,3)); bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,12/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*x*/));bind_aset(bind2,2,bind_aget(bind,12/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1));bind_aset(bind,12/*autovar*/,bind_aget(bind2,2));
;goto accept3;
...
;goto accept5;
alt3_2: ptr->pos=oldpos5;if (cut3) goto break1;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,13/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(alt3_3); bind_aset(bind,3/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*x*/));bind_aset(bind2,2,bind_aget(bind,3/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1));bind_aset(bind,3/*autovar*/,bind_aget(bind2,2));
;goto accept5;
alt3_3: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   bind_aset(bind2,1,bind_aget(bind,0/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1)); bind_aset(bind,14/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_key(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(3);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*name*/));it=rb_funcall(self,sy_AmethystParser_Result_lb__le__a3b4,1,bind2);bind_aset(bind,0/*name*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);

;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystParser_name(self ); FAILTEST(alt1_3); bind_aset(bind,0/*name*/,it);
  it=AmethystParser_argsOpt(self ); FAILTEST(alt1_3); bind_aset(bind,2/*arg*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*name*/));bind_aset(bind2,2,bind_aget(bind,2/*arg*/));it=rb_funcall(self,sy_AmethystParser_Key_lb_bind_5e9f,1,bind2);bind_aset(bind,0/*name*/,bind_aget(bind2,1));bind_aset(bind,2/*arg*/,bind_aget(bind2,2)); bind_aset(bind,1/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,0/*name*/));it=rb_funcall(self,sy_AmethystParser_Global_lb_b_0216,1,bind2);bind_aset(bind,0/*name*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_local(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=bind_new2(2);VALUE bind2=bind_new2(16); bind_aset(bind,0/*x*/,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
bind_aset(bind2,1,bind_aget(bind,0/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__cc9d,1,bind2);bind_aset(bind,0/*x*/,bind_aget(bind2,1)); bind_aset(bind,1/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_name(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(7);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
VALUE AmethystParser_nr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(1);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
return it;
fail: return failobj; }
VALUE AmethystParser_postfixed(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(7);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*from*/));bind_aset(bind2,2,bind_aget(bind,1/*one*/));it=rb_funcall(self,sy_AmethystParser_Many_lb_bin_14d1,1,bind2);bind_aset(bind,0/*from*/,bind_aget(bind2,1));bind_aset(bind,1/*one*/,bind_aget(bind2,2)); bind_aset(bind,0/*from*/,it);
 break;
...
alt4_3: ptr->pos=oldpos5;goto alt2_2;
 accept5:;
 break;
}bind_aset(bind2,1,bind_aget(bind,2/*name*/));bind_aset(bind2,2,bind_aget(bind,3/*append*/));bind_aset(bind2,3,bind_aget(bind,0/*from*/));it=rb_funcall(self,sy_AmethystParser__at_appends_975f,1,bind2);bind_aset(bind,2/*name*/,bind_aget(bind2,1));bind_aset(bind,3/*append*/,bind_aget(bind2,2));bind_aset(bind,0/*from*/,bind_aget(bind2,3)); bind_aset(bind,0/*from*/,it);

;goto accept3;
alt2_2: ptr->pos=oldpos3;  it=AmethystParser_inline_host_expr(self ); FAILTEST(alt2_3); bind_aset(bind,5/*e*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*from*/));bind_aset(bind2,2,bind_aget(bind,5/*e*/));it=rb_funcall(self,sy_AmethystParser_Seq_lb_Bind_bbb6,1,bind2);bind_aset(bind,0/*from*/,bind_aget(bind2,1));bind_aset(bind,5/*e*/,bind_aget(bind2,2)); bind_aset(bind,0/*from*/,it);
...
bind_aset(bind2,1,bind_aget(bind,0/*from*/));bind_aset(bind2,2,bind_aget(bind,5/*e*/));it=rb_funcall(self,sy_AmethystParser_Pass_lb_bin_2f93,1,bind2);bind_aset(bind,0/*from*/,bind_aget(bind2,1));bind_aset(bind,5/*e*/,bind_aget(bind2,2)); bind_aset(bind,0/*from*/,it);
 break;
case '?' ... '?':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;bind_aset(bind2,1,bind_aget(bind,0/*from*/));it=rb_funcall(self,sy_AmethystParser_Or_AST_lb_b_0657,1,bind2);bind_aset(bind,0/*from*/,bind_aget(bind2,1)); bind_aset(bind,0/*from*/,it);
 break;
...
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,0/*from*/));bind_aset(bind2,2,bind_aget(bind,5/*e*/));it=rb_funcall(self,sy_AmethystParser_Enter_lb_bi_9246,1,bind2);bind_aset(bind,0/*from*/,bind_aget(bind2,1));bind_aset(bind,5/*e*/,bind_aget(bind2,2)); bind_aset(bind,0/*from*/,it);
 break;
} } break1: ptr->pos=oldpos1;   it=bind_aget(bind,0/*from*/); bind_aset(bind,6/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_prefixed(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,4/*expr*/));bind_aset(bind2,2,bind_aget(bind,3/*neg*/));it=rb_funcall(self,sy_AmethystParser_Pred_lb_bin_ae38,1,bind2);bind_aset(bind,4/*expr*/,bind_aget(bind2,1));bind_aset(bind,3/*neg*/,bind_aget(bind2,2)); bind_aset(bind,0/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,5/*m*/));bind_aset(bind2,2,bind_aget(bind,3/*neg*/));it=rb_funcall(self,sy_AmethystParser_Lookahea_0946,1,bind2);bind_aset(bind,5/*m*/,bind_aget(bind2,1));bind_aset(bind,3/*neg*/,bind_aget(bind2,2)); bind_aset(bind,0/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_procargs(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(2);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*c*/));it=rb_funcall(self,sy_AmethystParser__lp_bind_lb_1_rb__a724,1,bind2);bind_aset(bind,0/*c*/,bind_aget(bind2,1));FAILTEST(alt1_2);it=rb_funcall(self,sy_AmethystParser__at_ary_lt__lt_Ar_59e3,1,bind2);
;goto accept2;
alt1_2: ptr->pos=oldpos2;  it=AmethystParser_procargs2(self ); FAILTEST(alt1_3);
;goto accept2;
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 } break1: ptr->pos=oldpos1;   it=rb_funcall(self,sy_AmethystParser__at_ary_ff69,1,bind2); bind_aset(bind,1/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_procargs2(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos2;   it=bind_aget(bind,1/*autovar*/); bind_aset(bind,3/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto alt1_2;
                   success1: *ptr=oldpass1;
...
bind_aset(bind2,1,bind_aget(bind,5/*a*/));it=rb_funcall(self,sy_AmethystParser__at_tmp_lt__lt_bi_b81c,1,bind2);bind_aset(bind,5/*a*/,bind_aget(bind2,1)); bind_aset(bind,4/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_rubyarg(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(25);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,1/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2));
;goto accept2;
...
alt3_3: ptr->pos=oldpos3;goto alt1_2;
 accept3:;
  it=AmethystParser_name(self ); FAILTEST(alt1_2); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystParser_key(self ); FAILTEST(alt1_3); bind_aset(bind,3/*_result*/,it);

;goto accept1;
alt1_3: ptr->pos=oldpos1;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,3/*_result*/,it);
...
alt4_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt4_2);it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos5;  while(1){oldpos5=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,4/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos5;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '|':;case '~' ... UC(255):; goto alt4_2; break;
case '}' ... '}':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,6/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,6/*r*/,bind_aget(bind2,1)); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*r*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,9/*o*/,it);
it=rb_obj_clone(s__re__cbb1); bind_aset(bind,10/*c*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*o*/));bind_aset(bind2,2,bind_aget(bind,8/*r*/));bind_aset(bind2,3,bind_aget(bind,10/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,9/*o*/,bind_aget(bind2,1));bind_aset(bind,8/*r*/,bind_aget(bind2,2));bind_aset(bind,10/*c*/,bind_aget(bind2,3)); bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,3/*_result*/,it);
...
alt6_3: ptr->pos=oldpos7;goto alt4_3;
 accept7:;
  it=AmethystParser_name(self ); FAILTEST(alt4_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept4;
alt4_3: ptr->pos=oldpos4;  it=AmethystParser_key(self ); FAILTEST(alt4_4); bind_aset(bind,3/*_result*/,it);
...
alt7_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_ary_new3(0); bind_aset(bind,12/*x*/,it);
int oldpos9; int stop2=0; while(1){oldpos9=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '$' ... '[':;case ']' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,13/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*autovar*/,bind_aget(bind2,2)); break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut7=1;stop2=1; break;
case '#' ... '#':; int oldpos10=ptr->pos;int cut8=0;
alt8_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='{')  ptr->pos+=1; else goto alt8_2;  it=Amethyst_spaces(self ); FAILTEST(alt8_2);it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos11;  while(1){oldpos11=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break3); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,4/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); } break3: ptr->pos=oldpos11;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
...
it=rb_obj_clone(s__re__cbb1); bind_aset(bind,10/*c*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*o*/));bind_aset(bind2,2,bind_aget(bind,8/*r*/));bind_aset(bind2,3,bind_aget(bind,10/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,9/*o*/,bind_aget(bind2,1));bind_aset(bind,8/*r*/,bind_aget(bind2,2));bind_aset(bind,10/*c*/,bind_aget(bind2,3)); bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,14/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*x*/));bind_aset(bind2,2,bind_aget(bind,14/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1));bind_aset(bind,14/*autovar*/,bind_aget(bind2,2));
;goto accept10;
alt8_2: ptr->pos=oldpos10;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt8_3); bind_aset(bind,13/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*autovar*/,bind_aget(bind2,2));
;goto accept10;
alt8_3: ptr->pos=oldpos10;goto break2;
 accept10:;
 break;
case UC(92) ... UC(92):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,15/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*x*/));bind_aset(bind2,2,bind_aget(bind,15/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1));bind_aset(bind,15/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,13/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*autovar*/,bind_aget(bind2,2)); break;
} if (stop2) goto accept9; } break2: goto alt7_2; accept9:;   bind_aset(bind2,1,bind_aget(bind,12/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,12/*x*/,bind_aget(bind2,1)); bind_aset(bind,16/*_result*/,it);
it=bind_aget(bind,16/*_result*/); bind_aset(bind,17/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,17/*s*/));it=rb_funcall(self,sy_AmethystParser_Strin_lb__lb__qu__88c8,1,bind2);bind_aset(bind,17/*s*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
...
alt10_3: ptr->pos=oldpos13;goto alt7_3;
 accept13:;
  it=AmethystParser_name(self ); FAILTEST(alt7_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept8;
alt7_3: ptr->pos=oldpos8;  it=AmethystParser_key(self ); FAILTEST(alt7_4); bind_aset(bind,3/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2));
;goto accept15;
alt12_2: ptr->pos=oldpos15;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,18/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,18/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,18/*autovar*/,bind_aget(bind2,2));
;goto accept15;
...
alt13_3: ptr->pos=oldpos16;goto alt11_2;
 accept16:;
  it=AmethystParser_name(self ); FAILTEST(alt11_2); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept14;
alt11_2: ptr->pos=oldpos14;  it=AmethystParser_key(self ); FAILTEST(alt11_3); bind_aset(bind,3/*_result*/,it);

;goto accept14;
alt11_3: ptr->pos=oldpos14;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,3/*_result*/,it);
...
alt14_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_ary_new3(0); bind_aset(bind,19/*x*/,it);
int oldpos18; int stop4=0; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,19/*x*/));bind_aset(bind2,2,bind_aget(bind,20/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,19/*x*/,bind_aget(bind2,1));bind_aset(bind,20/*autovar*/,bind_aget(bind2,2)); break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut14=1;stop4=1; break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,21/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,19/*x*/));bind_aset(bind2,2,bind_aget(bind,21/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,19/*x*/,bind_aget(bind2,1));bind_aset(bind,21/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,19/*x*/));bind_aset(bind2,2,bind_aget(bind,20/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,19/*x*/,bind_aget(bind2,1));bind_aset(bind,20/*autovar*/,bind_aget(bind2,2)); break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut14=1;stop4=1; break;
} break;
} if (stop4) goto accept18; } break4: goto alt14_2; accept18:;   bind_aset(bind2,1,bind_aget(bind,19/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,19/*x*/,bind_aget(bind2,1)); bind_aset(bind,22/*_result*/,it);
it=bind_aget(bind,22/*_result*/); bind_aset(bind,17/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,17/*s*/));it=rb_funcall(self,sy_AmethystParser_Strin_lb__lb__dq__b20e,1,bind2);bind_aset(bind,17/*s*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
...
alt16_3: ptr->pos=oldpos20;goto alt14_3;
 accept20:;
  it=AmethystParser_name(self ); FAILTEST(alt14_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept17;
alt14_3: ptr->pos=oldpos17;  it=AmethystParser_key(self ); FAILTEST(alt14_4); bind_aset(bind,3/*_result*/,it);
...
alt17_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt17_2);it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos22;  while(1){oldpos22=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break5); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,4/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); } break5: ptr->pos=oldpos22;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt17_2; break;
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,6/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,6/*r*/,bind_aget(bind2,1)); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*r*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,9/*o*/,it);
it=rb_obj_clone(s__rp__9371); bind_aset(bind,10/*c*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*o*/));bind_aset(bind2,2,bind_aget(bind,8/*r*/));bind_aset(bind2,3,bind_aget(bind,10/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,9/*o*/,bind_aget(bind2,1));bind_aset(bind,8/*r*/,bind_aget(bind2,2));bind_aset(bind,10/*c*/,bind_aget(bind2,3)); bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,3/*_result*/,it);
...
alt19_3: ptr->pos=oldpos24;goto alt17_3;
 accept24:;
  it=AmethystParser_name(self ); FAILTEST(alt17_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept21;
alt17_3: ptr->pos=oldpos21;  it=AmethystParser_key(self ); FAILTEST(alt17_4); bind_aset(bind,3/*_result*/,it);
...
alt22_3: ptr->pos=oldpos27;goto alt20_2;
 accept27:;
  it=AmethystParser_name(self ); FAILTEST(alt20_2); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept25;
alt20_2: ptr->pos=oldpos25;  it=AmethystParser_key(self ); FAILTEST(alt20_3); bind_aset(bind,3/*_result*/,it);
...
alt24_1:;if (ame_curstr2(ptr)[0]=='.'&&ame_curstr2(ptr)[1]=='.')  ptr->pos+=2; else goto alt24_2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,23/*_result*/,it);
it=bind_aget(bind,23/*_result*/); bind_aset(bind,3/*_result*/,it);

;goto accept29;
alt24_2: ptr->pos=oldpos29;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt24_3;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,23/*_result*/,it);
it=bind_aget(bind,23/*_result*/); bind_aset(bind,3/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2));
;goto accept30;
alt25_2: ptr->pos=oldpos30;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,18/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,18/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,18/*autovar*/,bind_aget(bind2,2));
;goto accept30;
...
alt26_3: ptr->pos=oldpos31;goto alt23_3;
 accept31:;
  it=AmethystParser_name(self ); FAILTEST(alt23_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept28;
alt23_3: ptr->pos=oldpos28;  it=AmethystParser_key(self ); FAILTEST(alt23_4); bind_aset(bind,3/*_result*/,it);

;goto accept28;
alt23_4: ptr->pos=oldpos28;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,3/*_result*/,it);
...
alt27_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,24/*e*/,it);
...
}bind_aset(bind2,1,bind_aget(bind,24/*e*/));it=rb_funcall(self,sy_AmethystParser__lb_bind_lb_1_rb__6281,1,bind2);bind_aset(bind,24/*e*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
...
alt29_3: ptr->pos=oldpos34;goto alt27_3;
 accept34:;
  it=AmethystParser_name(self ); FAILTEST(alt27_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept32;
alt27_3: ptr->pos=oldpos32;  it=AmethystParser_key(self ); FAILTEST(alt27_4); bind_aset(bind,3/*_result*/,it);

;goto accept32;
alt27_4: ptr->pos=oldpos32;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,3/*_result*/,it);
...
alt30_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt30_2);it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos36;  while(1){oldpos36=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break6); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*autovar*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,4/*autovar*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2)); } break6: ptr->pos=oldpos36;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*r*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(92):;case '^' ... UC(255):; goto alt30_2; break;
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,6/*r*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);bind_aset(bind,6/*r*/,bind_aget(bind2,1)); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*r*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,9/*o*/,it);
it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,10/*c*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*o*/));bind_aset(bind2,2,bind_aget(bind,8/*r*/));bind_aset(bind2,3,bind_aget(bind,10/*c*/));it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_9abe,1,bind2);bind_aset(bind,9/*o*/,bind_aget(bind2,1));bind_aset(bind,8/*r*/,bind_aget(bind2,2));bind_aset(bind,10/*c*/,bind_aget(bind2,3)); bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,3/*_result*/,it);
...
alt32_3: ptr->pos=oldpos38;goto alt30_3;
 accept38:;
  it=AmethystParser_name(self ); FAILTEST(alt30_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept35;
alt30_3: ptr->pos=oldpos35;  it=AmethystParser_key(self ); FAILTEST(alt30_4); bind_aset(bind,3/*_result*/,it);
...
alt33_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt33_2); bind_aset(bind,24/*e*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt33_2; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,24/*e*/));it=rb_funcall(self,sy_AmethystParser_Lambda_lb_B_2c90,1,bind2);bind_aset(bind,24/*e*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);
...
alt35_3: ptr->pos=oldpos41;goto alt33_3;
 accept41:;
  it=AmethystParser_name(self ); FAILTEST(alt33_3); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*n*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*n*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,0/*n*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

;goto accept39;
alt33_3: ptr->pos=oldpos39;  it=AmethystParser_key(self ); FAILTEST(alt33_4); bind_aset(bind,3/*_result*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystParser_rule(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_funcall(self,sy_AmethystParser__at_locals_eq__4fc1,1,bind2);it=rb_funcall(self,sy_AmethystParser__at_bnding_7d3c,1,bind2); bind_aset(bind,0/*bnding*/,it);
...
bind_aset(bind2,1,bind_aget(bind,3/*body*/));it=rb_funcall(self,sy_AmethystParser_Bind_lb_loc_37df,1,bind2);bind_aset(bind,3/*body*/,bind_aget(bind2,1)); bind_aset(bind,3/*body*/,it);
it=rb_funcall(self,sy_AmethystParser__at_locals_dot__bdc6,1,bind2); bind_aset(bind,4/*locals*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*body*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__eq__f15c,1,bind2);bind_aset(bind,3/*body*/,bind_aget(bind2,1));bind_aset(bind2,1,bind_aget(bind,0/*bnding*/));bind_aset(bind2,2,bind_aget(bind,1/*name*/));bind_aset(bind2,3,bind_aget(bind,2/*args*/));bind_aset(bind2,4,bind_aget(bind,3/*body*/));bind_aset(bind2,5,bind_aget(bind,4/*locals*/));it=rb_funcall(self,sy_AmethystParser_Rule_dot_cre_3767,1,bind2);bind_aset(bind,0/*bnding*/,bind_aget(bind2,1));bind_aset(bind,1/*name*/,bind_aget(bind2,2));bind_aset(bind,2/*args*/,bind_aget(bind2,3));bind_aset(bind,3/*body*/,bind_aget(bind2,4));bind_aset(bind,4/*locals*/,bind_aget(bind2,5)); bind_aset(bind,5/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_ruleargs(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,4/*name*/));it=rb_funcall(self,sy_AmethystParser_local_lp_bi_196b,1,bind2);bind_aset(bind,4/*name*/,bind_aget(bind2,1)); bind_aset(bind,5/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,2/*autovar*/));bind_aset(bind2,2,bind_aget(bind,6/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,2/*autovar*/,bind_aget(bind2,1));bind_aset(bind,6/*autovar*/,bind_aget(bind2,2)); break;
...
return it;
fail: return failobj; }
VALUE AmethystParser_sequence(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*ary*/,it);
bind_aset(bind2,1,bind_aget(bind,2/*ary*/));it=rb_funcall(self,sy_AmethystParser_Seq_dot_crea_bfbb,1,bind2);bind_aset(bind,2/*ary*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystParser_term(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(12);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
} x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ptr->pos=oldpos2; if (x==0) goto alt1_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);

;goto accept1;
alt1_4: ptr->pos=oldpos1;  it=AmethystParser_key(self ); FAILTEST(alt1_5); bind_aset(bind,1/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*it*/));it=rb_funcall(self,sy_AmethystParser_Act_lb_bind_7d0b,1,bind2);bind_aset(bind,1/*it*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,2/*expr*/));it=rb_funcall(self,sy_AmethystParser_Nested_lb_b_1ac2,1,bind2);bind_aset(bind,2/*expr*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept4;  reject2: x=0; accept4: it=Qnil; ptr->pos=oldpos4; if (x==0) goto alt2_5;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept6;  reject3: x=0; accept6: it=Qnil; ptr->pos=oldpos6; if (x==0) goto alt3_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,3/*x*/));bind_aset(bind2,2,bind_aget(bind,4/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1));bind_aset(bind,4/*autovar*/,bind_aget(bind2,2)); break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop1=1; break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*x*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,4/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*x*/));bind_aset(bind2,2,bind_aget(bind,4/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1));bind_aset(bind,4/*autovar*/,bind_aget(bind2,2)); break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop1=1; break;
} break;
} if (stop1) goto accept7; } break1: goto alt3_7; accept7:;   bind_aset(bind2,1,bind_aget(bind,3/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1)); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,7/*s*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_t_e958,1,bind2);bind_aset(bind,7/*s*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept9;  reject4: x=0; accept9: it=Qnil; ptr->pos=oldpos9; if (x==0) goto alt4_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
;goto accept8;
alt4_6: ptr->pos=oldpos8;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_line(self ); FAILTEST(alt4_7); bind_aset(bind,7/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,7/*s*/));it=rb_funcall(self,sy_AmethystParser_Comment_lb__ed6f,1,bind2);bind_aset(bind,7/*s*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept11;  reject5: x=0; accept11: it=Qnil; ptr->pos=oldpos11; if (x==0) goto alt5_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*x*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,4/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*x*/));bind_aset(bind2,2,bind_aget(bind,4/*autovar*/));it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1));bind_aset(bind,4/*autovar*/,bind_aget(bind2,2)); break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut5=1;stop2=1; break;
} break;
} if (stop2) goto accept12; } break2: goto alt5_7; accept12:;   bind_aset(bind2,1,bind_aget(bind,3/*x*/));it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);bind_aset(bind,3/*x*/,bind_aget(bind2,1)); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,7/*s*/));it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_s_9322,1,bind2);bind_aset(bind,7/*s*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept14;  reject6: x=0; accept14: it=Qnil; ptr->pos=oldpos14; if (x==0) goto alt6_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
;goto accept13;
alt6_6: ptr->pos=oldpos13;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt6_7); bind_aset(bind,8/*x*/,it);
  it=Amethyst_spaces(self ); FAILTEST(alt6_7);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt6_7; break;
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; it=Qnil;it=bind_aget(bind,8/*x*/); bind_aset(bind,0/*_result*/,it);
 break;
case '[' ... '[':; int oldpos15=ptr->pos;int cut7=0;
alt7_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt7_2;it=bind_aget(bind,8/*x*/); bind_aset(bind,9/*ors*/,it);
bind_aset(bind2,1,bind_aget(bind,9/*ors*/));it=rb_funcall(self,sy_AmethystParser_a_eq_autova_5b84,1,bind2);bind_aset(bind,9/*ors*/,bind_aget(bind2,1)); bind_aset(bind,10/*_result*/,it);
it=bind_aget(bind,10/*_result*/); bind_aset(bind,0/*_result*/,it);

;goto accept15;
alt7_2: ptr->pos=oldpos15;it=Qnil;it=bind_aget(bind,8/*x*/); bind_aset(bind,0/*_result*/,it);
...
alt9_3: ptr->pos=oldpos18;goto alt8_4;
 accept18:;
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept20;  reject8: x=0; accept20: it=Qnil; ptr->pos=oldpos20; if (x==0) goto alt10_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);

;goto accept19;
alt10_4: ptr->pos=oldpos19;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt10_5); bind_aset(bind,11/*e*/,it);
...
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,bind_aget(bind,11/*e*/));it=rb_funcall(self,sy_AmethystParser_Enter_lb_Ap_7d1f,1,bind2);bind_aset(bind,11/*e*/,bind_aget(bind2,1)); bind_aset(bind,0/*_result*/,it);
...
alt11_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='r'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='a'&&ame_curstr2(ptr)[3]=='k')  ptr->pos+=4; else goto alt11_2;it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb__3505,1,bind2); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept22;  reject9: x=0; accept22: it=Qnil; ptr->pos=oldpos22; if (x==0) goto alt11_5;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); bind_aset(bind,0/*_result*/,it);
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('788533ef526d4c97f13f1ff2b5b7ff31')");}
