...
alt1_1: ptr->pos=oldpos1;  it=Amethyst_empty(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... UC(39):;case ')' ... UC(255):; goto alt1_2; break;
...
alt2_1: ptr->pos=oldpos3;int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;  it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2;
...
alt1_1: ptr->pos=oldpos1;  it=AmethystParser_className(self ); FAILTEST(alt1_2); bind_aset(bind,0/*klas*/,it);
...
alt1_1: ptr->pos=oldpos2;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt1_2;
;goto accept1;
...
alt2_1: ptr->pos=oldpos3;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt3_1: ptr->pos=oldpos4;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt3_2;
;goto accept3;
alt3_2: ptr->pos=oldpos4;int oldpos5=ptr->pos;
alt4_1: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
...
alt5_1: ptr->pos=oldpos6;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt6_1: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept6;
...
alt7_1: ptr->pos=oldpos8;  it=Amethyst_number(self ); FAILTEST(alt7_2); bind_aset(bind,8/*autovar*/,it);
it=bind_aget(bind,8/*autovar*/); bind_aset(bind,9/*autovar*/,it);
it=bind_aget(bind,9/*autovar*/); bind_aset(bind,10/*autovar*/,it);
int oldpos9=ptr->pos;
alt8_1: ptr->pos=oldpos9;it=bind_aget(bind,10/*autovar*/);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):; goto alt8_2; break;
case '.' ... '.':;   it=AmethystCore_anything(self ); FAILTEST(alt8_2);int oldpos10=ptr->pos;
alt9_1: ptr->pos=oldpos10;if (strncmp(ame_curstr(self),"..",2)) goto alt9_2; else ptr->pos+=2;
;goto accept9;
alt9_2: ptr->pos=oldpos10;if (strncmp(ame_curstr(self),".",1)) goto alt9_3; else ptr->pos+=1;
;goto accept9;
...
;goto accept8;
alt8_2: ptr->pos=oldpos9;it=bind_aget(bind,10/*autovar*/); bind_aset(bind,11/*num*/,it);
...
alt10_1: ptr->pos=oldpos12;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt10_2;
;goto accept10;
alt10_2: ptr->pos=oldpos12;  it=Amethyst_empty(self ); FAILTEST(alt10_3);  it=AmethystCore_anything(self ); FAILTEST(alt10_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept10;
...
alt11_1: ptr->pos=oldpos13;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt11_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt11_3);  it=AmethystCore_anything(self ); FAILTEST(alt11_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept11;
...
alt12_1: ptr->pos=oldpos14;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt12_2;
;goto accept12;
alt12_2: ptr->pos=oldpos14;int oldpos15=ptr->pos;
alt13_1: ptr->pos=oldpos15;  it=AmethystCore_anything(self ); FAILTEST(alt13_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept13;
alt13_2: ptr->pos=oldpos15;  it=Amethyst_empty(self ); FAILTEST(alt13_3);
;goto accept13;
...
alt14_1: ptr->pos=oldpos16;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt14_2: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos17=ptr->pos;
alt15_1: ptr->pos=oldpos17;  it=AmethystCore_anything(self ); FAILTEST(alt15_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept15;
alt15_2: ptr->pos=oldpos17;  it=Amethyst_empty(self ); FAILTEST(alt15_3);
;goto accept15;
...
alt16_1: ptr->pos=oldpos18;  it=AmethystParser_className(self ); FAILTEST(alt16_2); bind_aset(bind,12/*clas*/,it);
...
alt17_1: ptr->pos=oldpos19;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);if (strncmp(ame_curstr(self),":",1)) goto alt17_2; else ptr->pos+=1;ame_setcut(self,Qtrue);goto alt17_2;
ame_setcut(self,Qnil);goto accept17;
alt17_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_2;}  it=Amethyst_empty(self ); FAILTEST(alt17_3);
;goto accept17;
...
;goto accept16;
alt16_2: ptr->pos=oldpos18;it=rb_obj_clone(s__lt__524a); bind_aset(bind,0/*s*/,it);
...
alt18_1: ptr->pos=oldpos21;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt18_2;
;goto accept18;
alt18_2: ptr->pos=oldpos21;  it=Amethyst_empty(self ); FAILTEST(alt18_3);  it=AmethystCore_anything(self ); FAILTEST(alt18_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept18;
...
alt19_1: ptr->pos=oldpos22;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt19_2: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}  it=Amethyst_empty(self ); FAILTEST(alt19_3);  it=AmethystCore_anything(self ); FAILTEST(alt19_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept19;
...
alt20_1: ptr->pos=oldpos23;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt20_2;
;goto accept20;
alt20_2: ptr->pos=oldpos23;int oldpos24=ptr->pos;
alt21_1: ptr->pos=oldpos24;  it=AmethystCore_anything(self ); FAILTEST(alt21_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept21;
alt21_2: ptr->pos=oldpos24;  it=Amethyst_empty(self ); FAILTEST(alt21_3);
;goto accept21;
...
alt22_1: ptr->pos=oldpos25;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt22_2: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}int oldpos26=ptr->pos;
alt23_1: ptr->pos=oldpos26;  it=AmethystCore_anything(self ); FAILTEST(alt23_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept23;
alt23_2: ptr->pos=oldpos26;  it=Amethyst_empty(self ); FAILTEST(alt23_3);
;goto accept23;
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;  it=AmethystParser_sequence(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind); it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
...
alt1_1: ptr->pos=oldpos1;  it=Amethyst_spaces(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... ';':;case '=' ... UC(255):; goto alt1_2; break;
case '<' ... '<':;   it=AmethystCore_anything(self ); FAILTEST(alt1_2); break;
...
alt1_1: ptr->pos=oldpos2;it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
...
alt2_1: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt2_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt2_2;
ame_setcut(self,Qnil);goto accept2;
...
;goto accept1;
alt1_2: ptr->pos=oldpos2;  it=Amethyst_spaces(self ); FAILTEST(alt1_3);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt1_3; break;
...
alt3_1: ptr->pos=oldpos5;it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
...
alt4_1: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt4_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt4_2;
...
;goto accept3;
alt3_3: ptr->pos=oldpos5;  it=Amethyst_spaces(self ); FAILTEST(alt3_4);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt3_4; break;
...
alt5_1: ptr->pos=oldpos8;it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos9=ptr->pos;
alt6_1: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt6_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt6_2;
...
alt7_1: ptr->pos=oldpos11;  it=AmethystCore_anything(self ); FAILTEST(alt7_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt7_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt7_2;
...
;goto accept5;
alt5_3: ptr->pos=oldpos8;  it=Amethyst_spaces(self ); FAILTEST(alt5_4);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt5_4; break;
...
alt3_1: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,9/*_result*/,it);
...
alt1_1: ptr->pos=oldpos1;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_2; break;
case 'A' ... 'Z':; int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;  it=AmethystParser_className(self ); FAILTEST(alt2_2); bind_aset(bind,0/*name*/,it);
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;if (strncmp(ame_curstr(self),"@",1)) goto alt1_3; else ptr->pos+=1;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_3; break;
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;  it=Amethyst_spaces(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_2; break;
...
alt1_1: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_2);if (strncmp(ame_curstr(self),"]",1)) goto alt1_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"]",1)) goto alt2_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
...
alt4_1: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr(self),"]",1)) goto alt4_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos6=ptr->pos;
alt5_1: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt5_2);if (strncmp(ame_curstr(self),"]",1)) goto alt5_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
...
alt1_1: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;it=bind_aget(bind,2/*autovar*/); bind_aset(bind,3/*neg*/,it);
...
alt1_1: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,0/*c*/,it);
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
...
alt2_1: ptr->pos=oldpos2;  it=Amethyst_spaces(self ); FAILTEST(alt2_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt2_2; break;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos3=ptr->pos;
alt3_1: ptr->pos=oldpos3;  it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2;
ame_setcut(self,Qnil);goto accept3;
...
int oldpos4=ptr->pos;
alt4_1: ptr->pos=oldpos4;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt5_1: ptr->pos=oldpos6;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
...
alt6_1: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept6;
...
alt7_1: ptr->pos=oldpos8;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
alt8_1: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt8_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
...
alt9_1: ptr->pos=oldpos10;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
...
alt10_1: ptr->pos=oldpos11;  it=AmethystCore_anything(self ); FAILTEST(alt10_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__283c,1,bind); 
;goto accept10;
...
alt11_1: ptr->pos=oldpos12;  it=Amethyst_spaces(self ); FAILTEST(alt11_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt11_2; break;
...
alt12_1: ptr->pos=oldpos13;  it=Amethyst__(self ); FAILTEST(alt12_2);ame_setcut(self,Qtrue);goto alt12_2;
...
alt13_1: ptr->pos=oldpos14;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt14_1: ptr->pos=oldpos15;  it=Amethyst_spaces(self ); FAILTEST(alt14_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt14_2; break;
...
alt15_1: ptr->pos=oldpos16;  it=Amethyst__(self ); FAILTEST(alt15_2);ame_setcut(self,Qtrue);goto alt15_2;
...
alt16_1: ptr->pos=oldpos17;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt17_1: ptr->pos=oldpos19;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept17;
...
alt18_1: ptr->pos=oldpos20;  it=AmethystCore_anything(self ); FAILTEST(alt18_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
...
alt19_1: ptr->pos=oldpos21;  it=AmethystCore_anything(self ); FAILTEST(alt19_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept19;
alt19_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos22=ptr->pos;
alt20_1: ptr->pos=oldpos22;  it=AmethystCore_anything(self ); FAILTEST(alt20_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__595b,1,bind); 
;goto accept20;
...
alt21_1: ptr->pos=oldpos23;  it=Amethyst_spaces(self ); FAILTEST(alt21_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt21_2; break;
...
alt22_1: ptr->pos=oldpos24;  it=Amethyst__(self ); FAILTEST(alt22_2);ame_setcut(self,Qtrue);goto alt22_2;
ame_setcut(self,Qnil);goto accept22;
...
alt23_1: ptr->pos=oldpos25;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt24_1: ptr->pos=oldpos26;  it=Amethyst_spaces(self ); FAILTEST(alt24_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt24_2; break;
...
alt25_1: ptr->pos=oldpos27;  it=Amethyst__(self ); FAILTEST(alt25_2);ame_setcut(self,Qtrue);goto alt25_2;
...
alt26_1: ptr->pos=oldpos28;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt27_1: ptr->pos=oldpos29;if (strncmp(ame_curstr(self),"..",2)) goto alt27_2; else ptr->pos+=2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept27;
alt27_2: ptr->pos=oldpos29;if (strncmp(ame_curstr(self),".",1)) goto alt27_3; else ptr->pos+=1;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);
...
alt28_1: ptr->pos=oldpos30;  it=Amethyst_spaces(self ); FAILTEST(alt28_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt28_2; break;
...
alt29_1: ptr->pos=oldpos31;  it=Amethyst__(self ); FAILTEST(alt29_2);ame_setcut(self,Qtrue);goto alt29_2;
...
alt30_1: ptr->pos=oldpos32;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt31_1: ptr->pos=oldpos33;  it=Amethyst_spaces(self ); FAILTEST(alt31_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt31_2; break;
...
alt32_1: ptr->pos=oldpos34;  it=Amethyst__(self ); FAILTEST(alt32_2);ame_setcut(self,Qtrue);goto alt32_2;
...
alt33_1: ptr->pos=oldpos35;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt34_1: ptr->pos=oldpos36;  it=Amethyst_spaces(self ); FAILTEST(alt34_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt34_2; break;
...
alt35_1: ptr->pos=oldpos37;  it=Amethyst__(self ); FAILTEST(alt35_2);ame_setcut(self,Qtrue);goto alt35_2;
...
alt36_1: ptr->pos=oldpos38;  it=AmethystCore_anything(self ); FAILTEST(alt36_2);  it=AmethystParser_expression(self ); FAILTEST(alt36_2); bind_aset(bind,21/*e*/,it);
...
alt37_1: ptr->pos=oldpos39;  it=Amethyst_spaces(self ); FAILTEST(alt37_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt37_2; break;
...
alt38_1: ptr->pos=oldpos40;  it=Amethyst__(self ); FAILTEST(alt38_2);ame_setcut(self,Qtrue);goto alt38_2;
...
alt1_1: ptr->pos=oldpos1;  it=AmethystParser_cases(self ); FAILTEST(alt1_2); bind_aset(bind,0/*_result*/,it);
...
case '.' ... '.':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);
;goto accept3;
alt2_2: ptr->pos=oldpos3;  it=Amethyst_empty(self ); FAILTEST(alt2_3);
;goto accept3;
...
alt3_1: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);if (strncmp(ame_curstr(self),"ested(",6)) goto alt3_2; else ptr->pos+=6;  it=AmethystParser_expression(self ); FAILTEST(alt3_2); bind_aset(bind,3/*expr*/,it);
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystParser_cases(self ); FAILTEST(alt3_3); bind_aset(bind,0/*_result*/,it);

;goto accept4;
alt3_3: ptr->pos=oldpos4;  it=AmethystParser_call(self ); FAILTEST(alt3_4); bind_aset(bind,0/*_result*/,it);

;goto accept4;
alt3_4: ptr->pos=oldpos4;int oldpos5=ptr->pos;
...
case '.' ... '.':; int oldpos6=ptr->pos;
alt4_1: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);
;goto accept6;
alt4_2: ptr->pos=oldpos6;  it=Amethyst_empty(self ); FAILTEST(alt4_3);
;goto accept6;
...
;goto accept4;
alt3_5: ptr->pos=oldpos4;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
;goto accept4;
 ...
 break;
case UC(34) ... UC(34):; int oldpos7=ptr->pos;
alt5_1: ptr->pos=oldpos7;  it=AmethystParser_cases(self ); FAILTEST(alt5_2); bind_aset(bind,0/*_result*/,it);

;goto accept7;
alt5_2: ptr->pos=oldpos7;int oldpos8=ptr->pos;
...
alt6_1: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);
;goto accept9;
alt6_2: ptr->pos=oldpos9;  it=Amethyst_empty(self ); FAILTEST(alt6_3);
;goto accept9;
...
;goto accept7;
alt5_3: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt5_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
...
alt7_1: ptr->pos=oldpos11;  it=AmethystCore_anything(self ); FAILTEST(alt7_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept10;
alt7_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt7_3);  it=AmethystCore_anything(self ); FAILTEST(alt7_3); bind_aset(bind,5/*autovar*/,it);
...
alt8_1: ptr->pos=oldpos12;  it=AmethystCore_anything(self ); FAILTEST(alt8_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept11;
alt8_2: ptr->pos=oldpos12;  it=Amethyst_empty(self ); FAILTEST(alt8_3);
;goto accept11;
...
alt9_1: ptr->pos=oldpos13;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept12;
alt9_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}int oldpos14=ptr->pos;
alt10_1: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt10_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept13;
alt10_2: ptr->pos=oldpos14;  it=Amethyst_empty(self ); FAILTEST(alt10_3);
;goto accept13;
...
;goto accept7;
alt5_4: ptr->pos=oldpos7;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt11_1: ptr->pos=oldpos15;  it=AmethystParser_cases(self ); FAILTEST(alt11_2); bind_aset(bind,0/*_result*/,it);

;goto accept14;
alt11_2: ptr->pos=oldpos15;int oldpos16=ptr->pos;
...
alt12_1: ptr->pos=oldpos17;  it=AmethystCore_anything(self ); FAILTEST(alt12_2);
;goto accept16;
alt12_2: ptr->pos=oldpos17;  it=Amethyst_empty(self ); FAILTEST(alt12_3);
;goto accept16;
...
;goto accept14;
alt11_3: ptr->pos=oldpos15;  it=AmethystCore_anything(self ); FAILTEST(alt11_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(39) ... UC(39):; int oldpos19=ptr->pos;
alt13_1: ptr->pos=oldpos19;  it=AmethystCore_anything(self ); FAILTEST(alt13_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept17;
alt13_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt13_3);  it=AmethystCore_anything(self ); FAILTEST(alt13_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind); 
;goto accept17;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '&':;case '(' ... UC(255):; int oldpos20=ptr->pos;
alt14_1: ptr->pos=oldpos20;  it=AmethystCore_anything(self ); FAILTEST(alt14_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept18;
alt14_2: ptr->pos=oldpos20;  it=Amethyst_empty(self ); FAILTEST(alt14_3);
;goto accept18;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(39) ... UC(39):; int oldpos21=ptr->pos;
alt15_1: ptr->pos=oldpos21;  it=AmethystCore_anything(self ); FAILTEST(alt15_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept19;
alt15_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos22=ptr->pos;
alt16_1: ptr->pos=oldpos22;  it=AmethystCore_anything(self ); FAILTEST(alt16_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept20;
alt16_2: ptr->pos=oldpos22;  it=Amethyst_empty(self ); FAILTEST(alt16_3);
;goto accept20;
...
;goto accept14;
alt11_4: ptr->pos=oldpos15;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt17_1: ptr->pos=oldpos23;  it=AmethystParser_cases(self ); FAILTEST(alt17_2); bind_aset(bind,0/*_result*/,it);

;goto accept21;
alt17_2: ptr->pos=oldpos23;int oldpos24=ptr->pos;
...
case '.' ... '.':; int oldpos25=ptr->pos;
alt18_1: ptr->pos=oldpos25;  it=AmethystCore_anything(self ); FAILTEST(alt18_2);
;goto accept23;
alt18_2: ptr->pos=oldpos25;  it=Amethyst_empty(self ); FAILTEST(alt18_3);
;goto accept23;
...
;goto accept21;
alt17_3: ptr->pos=oldpos23;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
;goto accept21;
alt17_4: ptr->pos=oldpos23;  it=AmethystCore_anything(self ); FAILTEST(alt17_5);  it=AmethystParser_expression(self ); FAILTEST(alt17_5); bind_aset(bind,9/*x*/,it);
...
alt19_1: ptr->pos=oldpos26;  it=AmethystCore_anything(self ); FAILTEST(alt19_2);if (strncmp(ame_curstr(self),"]",1)) goto alt19_2; else ptr->pos+=1;it=bind_aget(bind,9/*x*/); bind_aset(bind,10/*ors*/,it);
...
;goto accept24;
alt19_2: ptr->pos=oldpos26;  it=Amethyst_empty(self ); FAILTEST(alt19_3);it=bind_aget(bind,9/*x*/); bind_aset(bind,0/*_result*/,it);
...
alt20_1: ptr->pos=oldpos27;  it=AmethystParser_cases(self ); FAILTEST(alt20_2); bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt20_2: ptr->pos=oldpos27;int oldpos28=ptr->pos;
...
alt21_1: ptr->pos=oldpos29;  it=AmethystCore_anything(self ); FAILTEST(alt21_2);
;goto accept27;
alt21_2: ptr->pos=oldpos29;  it=Amethyst_empty(self ); FAILTEST(alt21_3);
;goto accept27;
...
;goto accept25;
alt20_3: ptr->pos=oldpos27;  it=AmethystParser_host_expr(self ); FAILTEST(alt20_4); bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt20_4: ptr->pos=oldpos27;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt22_1: ptr->pos=oldpos30;  it=AmethystParser_cases(self ); FAILTEST(alt22_2); bind_aset(bind,0/*_result*/,it);

;goto accept28;
alt22_2: ptr->pos=oldpos30;int oldpos31=ptr->pos;
...
alt23_1: ptr->pos=oldpos32;  it=AmethystCore_anything(self ); FAILTEST(alt23_2);
;goto accept30;
alt23_2: ptr->pos=oldpos32;  it=Amethyst_empty(self ); FAILTEST(alt23_3);
;goto accept30;
...
;goto accept28;
alt22_3: ptr->pos=oldpos30;  it=AmethystParser_key(self ); FAILTEST(alt22_4); bind_aset(bind,12/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Act_lb_bind_23ab,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept28;
alt22_4: ptr->pos=oldpos30;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt24_1: ptr->pos=oldpos33;  it=AmethystParser_cases(self ); FAILTEST(alt24_2); bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt24_2: ptr->pos=oldpos33;  it=AmethystParser_call(self ); FAILTEST(alt24_3); bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt24_3: ptr->pos=oldpos33;int oldpos34=ptr->pos;
...
alt25_1: ptr->pos=oldpos35;  it=AmethystCore_anything(self ); FAILTEST(alt25_2);
;goto accept33;
alt25_2: ptr->pos=oldpos35;  it=Amethyst_empty(self ); FAILTEST(alt25_3);
;goto accept33;
...
;goto accept31;
alt24_4: ptr->pos=oldpos33;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt26_1: ptr->pos=oldpos36;  it=AmethystParser_cases(self ); FAILTEST(alt26_2); bind_aset(bind,0/*_result*/,it);

;goto accept34;
alt26_2: ptr->pos=oldpos36;int oldpos37=ptr->pos;
...
alt27_1: ptr->pos=oldpos38;  it=AmethystCore_anything(self ); FAILTEST(alt27_2);
;goto accept36;
alt27_2: ptr->pos=oldpos38;  it=Amethyst_empty(self ); FAILTEST(alt27_3);
;goto accept36;
...
;goto accept34;
alt26_3: ptr->pos=oldpos36;  it=AmethystCore_anything(self ); FAILTEST(alt26_4);  it=AmethystParser_expression(self ); FAILTEST(alt26_4); bind_aset(bind,13/*e*/,it);
...
;goto accept34;
alt26_4: ptr->pos=oldpos36;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt28_1: ptr->pos=oldpos39;  it=AmethystCore_anything(self ); FAILTEST(alt28_2);if (strncmp(ame_curstr(self),"reak",4)) goto alt28_2; else ptr->pos+=4;it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb__3505,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept37;
alt28_2: ptr->pos=oldpos39;  it=AmethystParser_cases(self ); FAILTEST(alt28_3); bind_aset(bind,0/*_result*/,it);

;goto accept37;
alt28_3: ptr->pos=oldpos39;  it=AmethystParser_call(self ); FAILTEST(alt28_4); bind_aset(bind,0/*_result*/,it);

;goto accept37;
alt28_4: ptr->pos=oldpos39;int oldpos40=ptr->pos;
...
alt29_1: ptr->pos=oldpos41;  it=AmethystCore_anything(self ); FAILTEST(alt29_2);
;goto accept39;
alt29_2: ptr->pos=oldpos41;  it=Amethyst_empty(self ); FAILTEST(alt29_3);
;goto accept39;
...
;goto accept37;
alt28_5: ptr->pos=oldpos39;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('c92c8e61dae5ab4780f8d6a370fc18aa')");}
