...
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); var3/*autovar*/=it;;
...
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break1; break;
} } break1: ptr->pos=oldpos1;   it=var2/*autovar*/; var4/*r*/=it;;
it=var5/*c*/; var1/*s*/=it;;
...
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); var6/*autovar*/=it;;
bind_aset(bind2,1,var5/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var5/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break1; break;
} } break1: ptr->pos=oldpos1;   it=var5/*autovar*/; var7/*r*/=it;;
it=var1/*c*/; var4/*s*/=it;;
...
int oldpos2;  while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break1; break;
} } break1: ptr->pos=oldpos2;   it=var0/*autovar*/; var2/*r*/=it;;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos3=ptr->pos;int cut2=0;
alt2_1:;int oldpos4=ptr->pos;int cut3=0;
alt3_1:;  it=Amethyst__(self ); FAILTEST(alt3_2);cut3=1;goto alt3_2;
;goto accept4;
alt3_2: ptr->pos=oldpos4;if (cut3) goto alt2_2;it=Qnil;
;goto accept4;
alt3_3: ptr->pos=oldpos4;goto alt2_2;
 accept4:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(39):;case ')' ... UC(255):; goto alt2_2; break;
case '(' ... '(':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}  it=Amethyst_spaces(self ); FAILTEST(alt2_2);it=rb_ary_new3(0); var0/*autovar*/=it;;
int oldpos5;  while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break2); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break2; break;
} } break2: ptr->pos=oldpos5;   it=var0/*autovar*/; var2/*r*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt2_2; break;
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,var2/*r*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var2/*r*/=bind_aget(bind2,1);; var3/*_result*/=it;;
it=var3/*_result*/; var4/*r*/=it;;
bind_aset(bind2,1,var4/*r*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__pl__b087,1,bind2);var4/*r*/=bind_aget(bind2,1);; var5/*autovar*/=it;;
...
;goto accept3;
alt2_2: ptr->pos=oldpos3;it=rb_ary_new3(0); var9/*_result*/=it;;
...
}  it=Amethyst_spaces(self ); FAILTEST(fail);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto fail; break;
...
case '<' ... '<':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}  it=Amethyst_spaces(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_2; break;
...
int oldpos2;  while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto break1; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':;case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_rule(self ); FAILTEST(break1); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
} } break1: ptr->pos=oldpos2;   it=var2/*autovar*/; var4/*rules*/=it;;
...
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '`':;case 'b' ... UC(255):; int oldpos2=ptr->pos;int cut1=0;
...
;goto accept2;
alt1_2: ptr->pos=oldpos2;  it=Amethyst_spaces(self ); FAILTEST(alt1_3);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt1_3; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}  it=AmethystParser_expression(self ); FAILTEST(alt1_3);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt1_3; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos5=ptr->pos;int cut3=0;
alt3_1:;it=rb_ary_new3(0); var1/*autovar*/=it;;
it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt3_2); var2/*autovar*/=it;;
...
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
case 'a' ... 'a':; int oldpos7=ptr->pos;int cut4=0;
...
;goto accept7;
alt4_2: ptr->pos=oldpos7;if (cut4) goto break3;it=Qnil;
;goto accept7;
alt4_3: ptr->pos=oldpos7;goto break3;
 accept7:;
  it=AmethystCore_anything(self ); FAILTEST(break3); var3/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
} } break3: ptr->pos=oldpos6;   it=var1/*autovar*/; var4/*it*/=it;;
bind_aset(bind2,1,var4/*it*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);var4/*it*/=bind_aget(bind2,1);; var5/*autovar*/=it;;
...
alt5_1:;it=rb_ary_new3(0); var1/*autovar*/=it;;
int oldpos9=ptr->pos;int cut6=0;
alt6_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='m'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='y'&&ame_curstr2(ptr)[5]=='s'&&ame_curstr2(ptr)[6]=='t')  ptr->pos+=7; else goto alt6_2;cut6=1;goto alt6_2;
;goto accept9;
alt6_2: ptr->pos=oldpos9;if (cut6) goto alt5_2;it=Qnil;
;goto accept9;
alt6_3: ptr->pos=oldpos9;goto alt5_2;
 accept9:;
  it=AmethystCore_anything(self ); FAILTEST(alt5_2); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;int oldpos10;  while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break4); var3/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
case 'a' ... 'a':; int oldpos11=ptr->pos;int cut7=0;
alt7_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='m'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='y'&&ame_curstr2(ptr)[5]=='s'&&ame_curstr2(ptr)[6]=='t')  ptr->pos+=7; else goto alt7_2;cut7=1;goto alt7_2;
;goto accept11;
alt7_2: ptr->pos=oldpos11;if (cut7) goto break4;it=Qnil;
;goto accept11;
alt7_3: ptr->pos=oldpos11;goto break4;
 accept11:;
  it=AmethystCore_anything(self ); FAILTEST(break4); var3/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
} } break4: ptr->pos=oldpos10;   it=var1/*autovar*/; var4/*it*/=it;;
bind_aset(bind2,1,var4/*it*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);var4/*it*/=bind_aget(bind2,1);; var5/*autovar*/=it;;

;goto accept8;
alt5_2: ptr->pos=oldpos8;  it=AmethystParser_grammar(self ); FAILTEST(alt5_3); var5/*autovar*/=it;;

;goto accept8;
alt5_3: ptr->pos=oldpos8;  it=Amethyst_spaces(self ); FAILTEST(alt5_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt5_4; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}  it=AmethystParser_expression(self ); FAILTEST(alt5_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt5_4; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}it=rb_obj_clone(s__bq__8333); var6/*_result*/=it;;
it=var6/*_result*/; var5/*autovar*/=it;;
...
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break1; break;
} } break1: ptr->pos=oldpos1;   it=var0/*autovar*/; var2/*r*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '|':;case '~' ... UC(255):; goto fail; break;
case '}' ... '}':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,var2/*r*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var2/*r*/=bind_aget(bind2,1);; var3/*_result*/=it;;
it=var3/*_result*/; var4/*r*/=it;;
...
int oldpos4;  while(1){oldpos4=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break2); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break2; break;
} } break2: ptr->pos=oldpos4;   it=var4/*autovar*/; var6/*r*/=it;;
...
int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=Amethyst_spaces(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_2; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt1_2); break;
}  it=AmethystParser_argsOpt(self ); FAILTEST(alt1_2);  it=Amethyst_spaces(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '<':;case '>' ... UC(255):; goto alt1_2; break;
case '=' ... '=':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}cut1=1;goto alt1_2;
;goto accept1;
...
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil;switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ')':;case ',' ... '9':;case ';' ... '<':;case '>' ... '>':;case '@' ... 'Z':;case UC(92) ... UC(255):; goto break1; break;
...
bind_aset(bind2,1,var0/*from*/);bind_aset(bind2,2,var1/*one*/);it=rb_funcall(self,sy_AmethystParser_Many_lb_bin_14d1,1,bind2);var0/*from*/=bind_aget(bind2,1);;var1/*one*/=bind_aget(bind2,2);; var0/*from*/=it;;
 break;
case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '?':;case '[' ... '^':;case '`' ... '`':;case '|' ... UC(255):; goto break1; break;
case '{' ... '{':;   it=AmethystParser_inline_host_expr(self ); FAILTEST(break1); var2/*e*/=it;;
bind_aset(bind2,1,var0/*from*/);bind_aset(bind2,2,var2/*e*/);it=rb_funcall(self,sy_AmethystParser_Seq_lb_Bind_bbb6,1,bind2);var0/*from*/=bind_aget(bind2,1);;var2/*e*/=bind_aget(bind2,2);; var0/*from*/=it;;
 break;
case '@' ... '@':;   it=AmethystParser_key(self ); FAILTEST(break1); var3/*name*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; it=Qnil; var4/*append*/=it;;
 break;
case '[' ... '[':; int oldpos2=ptr->pos;int cut1=0;
alt1_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt1_2;it=rb_obj_clone(s__lb__rb__d751); var5/*_result*/=it;;
it=var5/*_result*/; var4/*append*/=it;;

;goto accept2;
alt1_2: ptr->pos=oldpos2;it=Qnil; var4/*append*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 ...
 break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(break1); var3/*name*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; it=Qnil; var4/*append*/=it;;
 break;
case '[' ... '[':; int oldpos3=ptr->pos;int cut2=0;
...
case '=' ... '=':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='>')  ptr->pos+=1; else goto break1;  it=AmethystParser_term(self ); FAILTEST(break1); var2/*e*/=it;;
...
case '?' ... '?':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;bind_aset(bind2,1,var0/*from*/);it=rb_funcall(self,sy_AmethystParser_Or_AST_lb_b_0657,1,bind2);var0/*from*/=bind_aget(bind2,1);; var0/*from*/=it;;
 break;
case '[' ... '[':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(break1); var2/*e*/=it;;
...
alt3_1:;  it=Amethyst__(self ); FAILTEST(alt3_2);cut3=1;goto alt3_2;
;goto accept4;
alt3_2: ptr->pos=oldpos4;if (cut3) goto break1;it=Qnil;
;goto accept4;
...
alt4_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt4_2;it=rb_obj_clone(s__lb__rb__d751); var5/*_result*/=it;;
it=var5/*_result*/; var4/*append*/=it;;

;goto accept5;
alt4_2: ptr->pos=oldpos5;it=Qnil; var4/*append*/=it;;
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; it=Qnil; var4/*append*/=it;;
 break;
case '[' ... '[':; int oldpos6=ptr->pos;int cut5=0;
alt5_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt5_2;it=rb_obj_clone(s__lb__rb__d751); var5/*_result*/=it;;
it=var5/*_result*/; var4/*append*/=it;;

;goto accept6;
alt5_2: ptr->pos=oldpos6;it=Qnil; var4/*append*/=it;;
...
int oldpos5;  while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break1; break;
} } break1: ptr->pos=oldpos5;   it=var4/*autovar*/; var6/*r*/=it;;
...
alt5_3: ptr->pos=oldpos6;goto alt4_3;
 accept6:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos7=ptr->pos;int cut6=0;
...
alt7_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_ary_new3(0); var12/*x*/=it;;
int oldpos9; int stop2=0; while(1){oldpos9=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '$' ... '[':;case ']' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break2); var13/*autovar*/=it;;
...
alt8_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='{')  ptr->pos+=1; else goto alt8_2;  it=Amethyst_spaces(self ); FAILTEST(alt8_2);it=rb_ary_new3(0); var4/*autovar*/=it;;
int oldpos11;  while(1){oldpos11=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break3); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break3; break;
} } break3: ptr->pos=oldpos11;   it=var4/*autovar*/; var6/*r*/=it;;
...
;goto accept10;
alt8_2: ptr->pos=oldpos10;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt8_3); var13/*autovar*/=it;;
...
bind_aset(bind2,1,var12/*x*/);bind_aset(bind2,2,var13/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var12/*x*/=bind_aget(bind2,1);;var13/*autovar*/=bind_aget(bind2,2);; break;
} if (stop2) goto accept9; } break2: goto alt7_2; accept9:;   bind_aset(bind2,1,var12/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var12/*x*/=bind_aget(bind2,1);; var16/*_result*/=it;;
...
alt9_3: ptr->pos=oldpos12;goto alt7_3;
 accept12:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos13=ptr->pos;int cut10=0;
...
alt10_3: ptr->pos=oldpos13;goto alt7_3;
 accept13:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt7_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt7_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept15;
alt12_2: ptr->pos=oldpos15;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var18/*autovar*/=it;;
...
alt12_3: ptr->pos=oldpos15;goto alt11_2;
 accept15:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos16=ptr->pos;int cut13=0;
...
alt13_3: ptr->pos=oldpos16;goto alt11_2;
 accept16:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt11_2; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt11_2); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept14;
alt11_2: ptr->pos=oldpos14;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept14;
alt11_3: ptr->pos=oldpos14;goto fail;
 accept14:;
 break;
case UC(39) ... UC(39):; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos17=ptr->pos;int cut14=0;
alt14_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_ary_new3(0); var19/*x*/=it;;
int oldpos18; int stop4=0; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(break4); var20/*autovar*/=it;;
...
} if (stop4) goto accept18; } break4: goto alt14_2; accept18:;   bind_aset(bind2,1,var19/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var19/*x*/=bind_aget(bind2,1);; var22/*_result*/=it;;
...
alt15_3: ptr->pos=oldpos19;goto alt14_3;
 accept19:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos20=ptr->pos;int cut16=0;
...
alt16_3: ptr->pos=oldpos20;goto alt14_3;
 accept20:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt14_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt14_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept17;
alt14_3: ptr->pos=oldpos17;goto fail;
 accept17:;
 break;
case '(' ... '(':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos21=ptr->pos;int cut17=0;
alt17_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt17_2);it=rb_ary_new3(0); var4/*autovar*/=it;;
int oldpos22;  while(1){oldpos22=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break5); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break5; break;
} } break5: ptr->pos=oldpos22;   it=var4/*autovar*/; var6/*r*/=it;;
...
alt18_3: ptr->pos=oldpos23;goto alt17_3;
 accept23:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos24=ptr->pos;int cut19=0;
...
alt19_3: ptr->pos=oldpos24;goto alt17_3;
 accept24:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt17_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt17_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept21;
alt17_3: ptr->pos=oldpos21;goto fail;
 accept21:;
 break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos25=ptr->pos;int cut20=0;
alt20_1:;  it=Amethyst_spaces(self ); FAILTEST(alt20_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt20_2; break;
case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt20_2; break;
}it=rb_obj_clone(s__co__at__4bf0); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept25;
alt20_2: ptr->pos=oldpos25;it=Qnil;
;goto accept25;
alt20_3: ptr->pos=oldpos25;goto fail;
 accept25:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos26=ptr->pos;int cut21=0;
alt21_1:;  it=Amethyst__(self ); FAILTEST(alt21_2);cut21=1;goto alt21_2;
;goto accept26;
alt21_2: ptr->pos=oldpos26;if (cut21) goto fail;it=Qnil;
;goto accept26;
alt21_3: ptr->pos=oldpos26;goto fail;
 accept26:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto fail; break;
...
alt22_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos28=ptr->pos;int cut23=0;
alt23_1:;if (ame_curstr2(ptr)[0]=='.'&&ame_curstr2(ptr)[1]=='.')  ptr->pos+=2; else goto alt23_2;it=rb_obj_clone(s__dot__dot__dot__2f43); var23/*_result*/=it;;
it=var23/*_result*/; var3/*_result*/=it;;

;goto accept28;
alt23_2: ptr->pos=oldpos28;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt23_3;it=rb_obj_clone(s__dot__dot__58b9); var23/*_result*/=it;;
it=var23/*_result*/; var3/*_result*/=it;;

;goto accept28;
alt23_3: ptr->pos=oldpos28;goto alt22_2;
 accept28:;

;goto accept27;
alt22_2: ptr->pos=oldpos27;int oldpos29=ptr->pos;int cut24=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept29;
alt24_2: ptr->pos=oldpos29;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var18/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var18/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var18/*autovar*/=bind_aget(bind2,2);;
;goto accept29;
alt24_3: ptr->pos=oldpos29;goto alt22_3;
 accept29:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos30=ptr->pos;int cut25=0;
alt25_1:;  it=Amethyst__(self ); FAILTEST(alt25_2);cut25=1;goto alt25_2;
;goto accept30;
alt25_2: ptr->pos=oldpos30;if (cut25) goto alt22_3;it=Qnil;
;goto accept30;
alt25_3: ptr->pos=oldpos30;goto alt22_3;
 accept30:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt22_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt22_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept27;
alt22_3: ptr->pos=oldpos27;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept27;
alt22_4: ptr->pos=oldpos27;goto fail;
 accept27:;
 break;
case '0' ... '9':;case '_' ... '_':;case 'a' ... 'z':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos31=ptr->pos;int cut26=0;
alt26_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var24/*e*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ';':;case '=' ... UC(255):; goto alt26_2; break;
case '<' ... '<':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='<')  ptr->pos+=1; else goto alt26_2; break;
...
;goto accept31;
alt26_2: ptr->pos=oldpos31;int oldpos32=ptr->pos;int cut27=0;
alt27_1:;  it=Amethyst_spaces(self ); FAILTEST(alt27_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt27_2; break;
case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt27_2; break;
}it=rb_obj_clone(s__co__at__4bf0); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept32;
alt27_2: ptr->pos=oldpos32;it=Qnil;
;goto accept32;
alt27_3: ptr->pos=oldpos32;goto alt26_3;
 accept32:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept33;
alt28_2: ptr->pos=oldpos33;if (cut28) goto alt26_3;it=Qnil;
;goto accept33;
alt28_3: ptr->pos=oldpos33;goto alt26_3;
 accept33:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt26_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt26_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept31;
alt26_3: ptr->pos=oldpos31;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept31;
alt26_4: ptr->pos=oldpos31;goto fail;
 accept31:;
 break;
case '@' ... '@':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos34=ptr->pos;int cut29=0;
alt29_1:;int oldpos35=ptr->pos;int cut30=0;
...
;goto accept35;
alt30_3: ptr->pos=oldpos35;goto alt29_2;
 accept35:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept36;
alt31_2: ptr->pos=oldpos36;if (cut31) goto alt29_2;it=Qnil;
;goto accept36;
alt31_3: ptr->pos=oldpos36;goto alt29_2;
 accept36:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt29_2; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt29_2); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept34;
alt29_2: ptr->pos=oldpos34;  it=AmethystParser_key(self ); FAILTEST(alt29_3); var3/*_result*/=it;;
...
alt32_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_spaces(self ); FAILTEST(alt32_2);it=rb_ary_new3(0); var4/*autovar*/=it;;
int oldpos38;  while(1){oldpos38=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):;   it=AmethystParser_rubyarg(self ); FAILTEST(break6); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; goto break6; break;
} } break6: ptr->pos=oldpos38;   it=var4/*autovar*/; var6/*r*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(92):;case '^' ... UC(255):; goto alt32_2; break;
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
}bind_aset(bind2,1,var6/*r*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var6/*r*/=bind_aget(bind2,1);; var7/*_result*/=it;;
it=var7/*_result*/; var8/*r*/=it;;
...
;goto accept37;
alt32_2: ptr->pos=oldpos37;int oldpos39=ptr->pos;int cut33=0;
alt33_1:;  it=Amethyst_spaces(self ); FAILTEST(alt33_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt33_2; break;
case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt33_2; break;
}it=rb_obj_clone(s__co__at__4bf0); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept39;
alt33_2: ptr->pos=oldpos39;it=Qnil;
;goto accept39;
alt33_3: ptr->pos=oldpos39;goto alt32_3;
 accept39:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos40=ptr->pos;int cut34=0;
alt34_1:;  it=Amethyst__(self ); FAILTEST(alt34_2);cut34=1;goto alt34_2;
;goto accept40;
alt34_2: ptr->pos=oldpos40;if (cut34) goto alt32_3;it=Qnil;
;goto accept40;
alt34_3: ptr->pos=oldpos40;goto alt32_3;
 accept40:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt32_3; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt32_3); var2/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;bind_aset(bind2,1,var0/*n*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var0/*n*/=bind_aget(bind2,1);; var3/*_result*/=it;;

;goto accept37;
alt32_3: ptr->pos=oldpos37;goto fail;
 accept37:;
 break;
case '`' ... '`':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos41=ptr->pos;int cut35=0;
alt35_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt35_2); var24/*e*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt35_2; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
;goto accept41;
alt35_2: ptr->pos=oldpos41;int oldpos42=ptr->pos;int cut36=0;
alt36_1:;  it=Amethyst_spaces(self ); FAILTEST(alt36_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt36_2; break;
case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt36_2; break;
}it=rb_obj_clone(s__co__at__4bf0); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept42;
alt36_2: ptr->pos=oldpos42;it=Qnil;
;goto accept42;
alt36_3: ptr->pos=oldpos42;goto alt35_3;
 accept42:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos43=ptr->pos;int cut37=0;
alt37_1:;  it=Amethyst__(self ); FAILTEST(alt37_2);cut37=1;goto alt37_2;
;goto accept43;
alt37_2: ptr->pos=oldpos43;if (cut37) goto alt35_3;it=Qnil;
;goto accept43;
...
;goto accept41;
alt35_3: ptr->pos=oldpos41;goto fail;
 accept41:;
 break;
}
return it;
...
alt6_3: ptr->pos=oldpos13;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt6_4); var7/*x*/=it;;
  it=Amethyst_spaces(self ); FAILTEST(alt6_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt6_4; break;
case ')' ... ')':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
alt13_3: ptr->pos=oldpos25;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt13_4); var11/*e*/=it;;
  it=Amethyst_spaces(self ); FAILTEST(alt13_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(92):;case '^' ... UC(255):; goto alt13_4; break;
case ']' ... ']':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('9552b2ea23be51d417b78e769236c982')");}
