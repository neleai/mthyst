...
;goto accept4;
alt4_2: ptr->pos=oldpos4;if (cut4) goto alt3_2;it=Qnil;
;goto accept4;
...
int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(92):;case '^' ... '|':;case '~' ... UC(255):; int oldpos5=ptr->pos;int cut5=0;
alt5_1:;  it=AmethystParser_rubyarg(self ); FAILTEST(alt5_2); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt5_2: ptr->pos=oldpos5;stop2=1;
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto alt3_2;
 accept5:;
 break;
...
;goto accept3;
alt3_2: ptr->pos=oldpos3;it=rb_ary_new3(0); var9/*_result*/=it;;
...
int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos1=ptr->pos;int cut1=0;
alt1_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt1_2;
;goto accept1;
alt1_2: ptr->pos=oldpos1;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt1_3); var2/*autovar*/=it;;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos2=ptr->pos;int cut2=0;
alt2_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt2_2;
;goto accept2;
alt2_2: ptr->pos=oldpos2;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var3/*autovar*/=it;;
...
} } bind_aset(bind2,1,var1/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var1/*x*/=bind_aget(bind2,1);; var4/*_result*/=it;;
...
bind_aset(bind2,1,var5/*s*/);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_269c,1,bind2);var5/*s*/=bind_aget(bind2,1);; var6/*_result*/=it;;
 break;
case '-' ... '-':;case '0' ... '9':; int oldpos3=ptr->pos;int cut3=0;
alt3_1:;int oldpos4=ptr->pos;int cut4=0;
...
;goto accept5;
alt5_2: ptr->pos=oldpos5;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt5_3;it=rb_obj_clone(s__dot__dot__58b9); var9/*_result*/=it;;
it=var9/*_result*/; var10/*autovar*/=it;;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;  it=Amethyst_number(self ); FAILTEST(alt4_3); var13/*num*/=it;;
...
;goto accept3;
alt3_2: ptr->pos=oldpos3;it=rb_obj_clone(s__lt__524a); var0/*s*/=it;;
 it=var0/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt3_3);it=var0/*s*/;it=rb_ary_new3(0); var1/*x*/=it;;
int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos6=ptr->pos;int cut6=0;
alt6_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt6_2;
;goto accept6;
alt6_2: ptr->pos=oldpos6;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*x*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*x*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
alt6_3: ptr->pos=oldpos6;goto alt3_3;
 accept6:;
 break;
case '>' ... '>':; it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop2=1; break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos7=ptr->pos;int cut7=0;
alt7_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt7_2;
;goto accept7;
alt7_2: ptr->pos=oldpos7;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var3/*autovar*/=it;;
...
bind_aset(bind2,1,var1/*x*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*x*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;
;goto accept7;
alt7_3: ptr->pos=oldpos7;goto alt3_3;
 accept7:;
 break;
case '>' ... '>':; it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop2=1; break;
...
;goto accept3;
alt3_3: ptr->pos=oldpos3;if (cut3) goto fail;goto fail;
 accept3:;
 break;
...
;goto accept8;
alt8_2: ptr->pos=oldpos8;it=rb_obj_clone(s__lt__524a); var0/*s*/=it;;
 it=var0/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_3);it=var0/*s*/;it=rb_ary_new3(0); var1/*x*/=it;;
int stop3=0; while(!stop3){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos10=ptr->pos;int cut10=0;
alt10_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt10_2;
;goto accept10;
alt10_2: ptr->pos=oldpos10;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt10_3); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*x*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*x*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;
;goto accept10;
alt10_3: ptr->pos=oldpos10;goto alt8_3;
 accept10:;
 break;
case '>' ... '>':; it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut8=1;stop3=1; break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos11=ptr->pos;int cut11=0;
alt11_1:;it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
goto alt11_2;
;goto accept11;
alt11_2: ptr->pos=oldpos11;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var3/*autovar*/=it;;
...
bind_aset(bind2,1,var1/*x*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*x*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;
;goto accept11;
alt11_3: ptr->pos=oldpos11;goto alt8_3;
 accept11:;
 break;
case '>' ... '>':; it=rb_obj_clone(s__gt__cedf); var0/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut8=1;stop3=1; break;
...
;goto accept8;
alt8_3: ptr->pos=oldpos8;if (cut8) goto fail;goto fail;
 accept8:;
 break;
}
return it;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':;case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':; int oldpos2=ptr->pos;int cut2=0;
...
int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '`':;case 'b' ... UC(255):; int oldpos1=ptr->pos;int cut1=0;
...
alt3_3: ptr->pos=oldpos3;goto alt2_2;
 accept3:;
 break;
case 'a' ... 'a':; int oldpos4=ptr->pos;int cut4=0;
alt4_1:;int oldpos5=ptr->pos;int cut5=0;
...
;goto accept5;
alt5_2: ptr->pos=oldpos5;if (cut5) goto alt4_2;it=Qnil;
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto alt4_2;
 accept5:;
...
;goto accept4;
alt4_3: ptr->pos=oldpos4;goto alt2_2;
 accept4:;
 break;
} } it=var1/*autovar*/; var4/*it*/=it;;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt2_3; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;int stop3=0; while(!stop3){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; int oldpos8=ptr->pos;int cut8=0;
alt8_1:;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt8_2); var3/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);;
;goto accept8;
alt8_2: ptr->pos=oldpos8;stop3=1;
;goto accept8;
alt8_3: ptr->pos=oldpos8;goto alt7_2;
 accept8:;
 break;
case 'a' ... 'a':; int oldpos9=ptr->pos;int cut9=0;
alt9_1:;int oldpos10=ptr->pos;int cut10=0;
...
;goto accept10;
alt10_2: ptr->pos=oldpos10;if (cut10) goto alt9_2;it=Qnil;
;goto accept10;
...
;goto accept9;
alt9_3: ptr->pos=oldpos9;goto alt7_2;
 accept9:;
 break;
} } it=var1/*autovar*/; var4/*it*/=it;;
bind_aset(bind2,1,var4/*it*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);var4/*it*/=bind_aget(bind2,1);; var5/*autovar*/=it;;
...
;goto accept7;
alt7_2: ptr->pos=oldpos7;  it=AmethystParser_grammar(self ); FAILTEST(alt7_3); var5/*autovar*/=it;;

;goto accept7;
alt7_3: ptr->pos=oldpos7;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt7_4; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
;goto accept7;
alt7_4: ptr->pos=oldpos7;goto alt6_2;
 accept7:;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
...
alt6_3: ptr->pos=oldpos6;goto fail;
 accept6:;
 break;
case 'a' ... 'a':; int oldpos11=ptr->pos;int cut11=0;
alt11_1:;int oldpos12=ptr->pos;int cut12=0;
...
;goto accept13;
alt13_2: ptr->pos=oldpos13;if (cut13) goto alt12_2;it=Qnil;
;goto accept13;
alt13_3: ptr->pos=oldpos13;goto alt12_2;
 accept13:;
  it=AmethystCore_anything(self ); FAILTEST(alt12_2); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;int stop4=0; while(!stop4){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; int oldpos14=ptr->pos;int cut14=0;
alt14_1:;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt14_2); var3/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);;
;goto accept14;
alt14_2: ptr->pos=oldpos14;stop4=1;
;goto accept14;
alt14_3: ptr->pos=oldpos14;goto alt12_2;
 accept14:;
 break;
case 'a' ... 'a':; int oldpos15=ptr->pos;int cut15=0;
alt15_1:;int oldpos16=ptr->pos;int cut16=0;
...
;goto accept16;
alt16_2: ptr->pos=oldpos16;if (cut16) goto alt15_2;it=Qnil;
;goto accept16;
...
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);;
;goto accept15;
alt15_2: ptr->pos=oldpos15;stop4=1;
;goto accept15;
alt15_3: ptr->pos=oldpos15;goto alt12_2;
 accept15:;
 break;
} } it=var1/*autovar*/; var4/*it*/=it;;
bind_aset(bind2,1,var4/*it*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__7b93,1,bind2);var4/*it*/=bind_aget(bind2,1);; var5/*autovar*/=it;;
...
;goto accept12;
alt12_2: ptr->pos=oldpos12;  it=AmethystParser_grammar(self ); FAILTEST(alt12_3); var5/*autovar*/=it;;

;goto accept12;
alt12_3: ptr->pos=oldpos12;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt12_4; break;
case '`' ... '`':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
...
;goto accept12;
alt12_4: ptr->pos=oldpos12;goto alt11_2;
 accept12:;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept11;
alt11_2: ptr->pos=oldpos11;stop1=1;
;goto accept11;
alt11_3: ptr->pos=oldpos11;goto fail;
 accept11:;
 break;
} } it=var0/*autovar*/; var7/*_result*/=it;;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;if (cut2) goto fail;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='{')  ptr->pos+=1; else goto alt2_3;  it=Amethyst_spaces(self );it=rb_ary_new3(0); var4/*autovar*/=it;;
...
alt3_2: ptr->pos=oldpos3;stop2=1;
;goto accept3;
alt3_3: ptr->pos=oldpos3;goto alt2_3;
 accept3:;
 break;
case ')' ... ')':;case ']' ... ']':;case '}' ... '}':; stop2=1; break;
} } it=var4/*autovar*/; var6/*r*/=it;;
...
;goto accept2;
alt2_3: ptr->pos=oldpos2;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt2_4); var3/*autovar*/=it;;
bind_aset(bind2,1,var0/*x*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*x*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);;
;goto accept2;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;if (cut4) goto fail;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var13/*autovar*/=it;;
...
alt4_3: ptr->pos=oldpos4;goto fail;
 accept4:;
 break;
} } bind_aset(bind2,1,var0/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var0/*x*/=bind_aget(bind2,1);; var14/*_result*/=it;;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;it=Qnil; var4/*append*/=it;;
...
;goto accept3;
alt3_2: ptr->pos=oldpos3;it=Qnil; var4/*append*/=it;;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos4=ptr->pos;int cut4=0;
alt4_1:;int oldpos5=ptr->pos;int cut5=0;
...
;goto accept6;
alt6_2: ptr->pos=oldpos6;it=Qnil; var4/*append*/=it;;

;goto accept6;
alt6_3: ptr->pos=oldpos6;goto alt4_2;
 accept6:;
 break;
}bind_aset(bind2,1,var3/*name*/);bind_aset(bind2,2,var4/*append*/);bind_aset(bind2,3,var0/*from*/);it=rb_funcall(self,sy_AmethystParser__at_appends_975f,1,bind2);var3/*name*/=bind_aget(bind2,1);;var4/*append*/=bind_aget(bind2,2);;var0/*from*/=bind_aget(bind2,3);; var0/*from*/=it;;
 break;
...
;goto accept7;
alt7_2: ptr->pos=oldpos7;it=Qnil; var4/*append*/=it;;

;goto accept7;
alt7_3: ptr->pos=oldpos7;goto alt4_2;
 accept7:;
 break;
}bind_aset(bind2,1,var3/*name*/);bind_aset(bind2,2,var4/*append*/);bind_aset(bind2,3,var0/*from*/);it=rb_funcall(self,sy_AmethystParser__at_appends_975f,1,bind2);var3/*name*/=bind_aget(bind2,1);;var4/*append*/=bind_aget(bind2,2);;var0/*from*/=bind_aget(bind2,3);; var0/*from*/=it;;
 break;
...
it=rb_funcall(self,sy_AmethystParser__at_ary_eq__lb__rb_,1,bind2);int stop1=0; while(!stop1){ int oldpos1=ptr->pos;int cut1=0;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystParser_procargs2(self ); FAILTEST(alt1_3);
;goto accept1;
alt1_3: ptr->pos=oldpos1;stop1=1;
;goto accept1;
alt1_4: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_AmethystParser__at_ary_ff69,1,bind2); var1/*_result*/=it;;
...
alt2_3: ptr->pos=oldpos2;goto pass1;
 accept2:;
 } it=var1/*autovar*/; var3/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto alt1_2;
                   success1: *ptr=oldpass1;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;int oldpos6=ptr->pos;int cut6=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
alt6_2: ptr->pos=oldpos6;it=Qnil;
;goto accept6;
alt6_3: ptr->pos=oldpos6;goto alt4_3;
 accept6:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept7;
alt7_2: ptr->pos=oldpos7;if (cut7) goto alt4_3;it=Qnil;
;goto accept7;
...
int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '$' ... '[':;case ']' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt8_2); var13/*autovar*/=it;;
...
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept10;
alt10_2: ptr->pos=oldpos10;stop3=1;
;goto accept10;
alt10_3: ptr->pos=oldpos10;goto alt9_2;
 accept10:;
 break;
...
;goto accept9;
alt9_2: ptr->pos=oldpos9;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt9_3); var13/*autovar*/=it;;
...
bind_aset(bind2,1,var12/*x*/);bind_aset(bind2,2,var15/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var12/*x*/=bind_aget(bind2,1);;var15/*autovar*/=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); FAILTEST(alt8_2); var13/*autovar*/=it;;
bind_aset(bind2,1,var12/*x*/);bind_aset(bind2,2,var13/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var12/*x*/=bind_aget(bind2,1);;var13/*autovar*/=bind_aget(bind2,2);; break;
} } bind_aset(bind2,1,var12/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb_,1,bind2);var12/*x*/=bind_aget(bind2,1);; var16/*_result*/=it;;
...
;goto accept8;
alt8_2: ptr->pos=oldpos8;if (cut8) goto fail;int oldpos11=ptr->pos;int cut11=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept11;
alt11_2: ptr->pos=oldpos11;it=Qnil;
;goto accept11;
alt11_3: ptr->pos=oldpos11;goto alt8_3;
 accept11:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept12;
alt12_2: ptr->pos=oldpos12;if (cut12) goto alt8_3;it=Qnil;
;goto accept12;
alt12_3: ptr->pos=oldpos12;goto alt8_3;
 accept12:;
 break;
...
int oldpos13=ptr->pos;int cut13=0;
alt13_1:;int oldpos14=ptr->pos;int cut14=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept14;
alt14_2: ptr->pos=oldpos14;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var18/*autovar*/=it;;
...
;goto accept15;
alt15_2: ptr->pos=oldpos15;if (cut15) goto alt13_2;it=Qnil;
;goto accept15;
alt15_3: ptr->pos=oldpos15;goto alt13_2;
 accept15:;
 break;
...
;goto accept13;
alt13_2: ptr->pos=oldpos13;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept13;
alt13_3: ptr->pos=oldpos13;goto fail;
 accept13:;
 break;
...
int stop4=0; while(!stop4){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt16_2); var20/*autovar*/=it;;
...
bind_aset(bind2,1,var19/*x*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var19/*x*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); FAILTEST(alt16_2); var20/*autovar*/=it;;
bind_aset(bind2,1,var19/*x*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var19/*x*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut16=1;stop4=1; break;
} break;
} } bind_aset(bind2,1,var19/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var19/*x*/=bind_aget(bind2,1);; var22/*_result*/=it;;
...
;goto accept16;
alt16_2: ptr->pos=oldpos16;if (cut16) goto fail;int oldpos17=ptr->pos;int cut17=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept17;
alt17_2: ptr->pos=oldpos17;it=Qnil;
;goto accept17;
alt17_3: ptr->pos=oldpos17;goto alt16_3;
 accept17:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept18;
alt18_2: ptr->pos=oldpos18;if (cut18) goto alt16_3;it=Qnil;
;goto accept18;
alt18_3: ptr->pos=oldpos18;goto alt16_3;
 accept18:;
 break;
...
;goto accept16;
alt16_3: ptr->pos=oldpos16;goto fail;
 accept16:;
 break;
case '(' ... '(':; it=rb_ary_new3(0); var0/*n*/=it;;
...
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept20;
alt20_2: ptr->pos=oldpos20;stop5=1;
;goto accept20;
alt20_3: ptr->pos=oldpos20;goto alt19_2;
 accept20:;
 break;
...
;goto accept19;
alt19_2: ptr->pos=oldpos19;int oldpos21=ptr->pos;int cut21=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept21;
alt21_2: ptr->pos=oldpos21;it=Qnil;
;goto accept21;
alt21_3: ptr->pos=oldpos21;goto alt19_3;
 accept21:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept22;
alt22_2: ptr->pos=oldpos22;if (cut22) goto alt19_3;it=Qnil;
;goto accept22;
alt22_3: ptr->pos=oldpos22;goto alt19_3;
 accept22:;
 break;
...
;goto accept19;
alt19_3: ptr->pos=oldpos19;goto fail;
 accept19:;
 break;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept23;
alt23_2: ptr->pos=oldpos23;it=Qnil;
;goto accept23;
alt23_3: ptr->pos=oldpos23;goto fail;
 accept23:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept24;
alt24_2: ptr->pos=oldpos24;if (cut24) goto fail;it=Qnil;
;goto accept24;
alt24_3: ptr->pos=oldpos24;goto fail;
 accept24:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto fail; break;
...
alt25_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos26=ptr->pos;int cut26=0;
...
;goto accept26;
alt26_2: ptr->pos=oldpos26;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt26_3;it=rb_obj_clone(s__dot__dot__58b9); var23/*_result*/=it;;
it=var23/*_result*/; var3/*_result*/=it;;

;goto accept26;
alt26_3: ptr->pos=oldpos26;goto alt25_2;
 accept26:;

;goto accept25;
alt25_2: ptr->pos=oldpos25;int oldpos27=ptr->pos;int cut27=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept27;
alt27_2: ptr->pos=oldpos27;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var18/*autovar*/=it;;
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var18/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var18/*autovar*/=bind_aget(bind2,2);;
;goto accept27;
alt27_3: ptr->pos=oldpos27;goto alt25_3;
 accept27:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept28;
alt28_2: ptr->pos=oldpos28;if (cut28) goto alt25_3;it=Qnil;
;goto accept28;
alt28_3: ptr->pos=oldpos28;goto alt25_3;
 accept28:;
 break;
...
;goto accept25;
alt25_3: ptr->pos=oldpos25;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept25;
alt25_4: ptr->pos=oldpos25;goto fail;
 accept25:;
 break;
...
;goto accept29;
alt29_2: ptr->pos=oldpos29;int oldpos30=ptr->pos;int cut30=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept30;
alt30_2: ptr->pos=oldpos30;it=Qnil;
;goto accept30;
alt30_3: ptr->pos=oldpos30;goto alt29_3;
 accept30:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept31;
alt31_2: ptr->pos=oldpos31;if (cut31) goto alt29_3;it=Qnil;
;goto accept31;
alt31_3: ptr->pos=oldpos31;goto alt29_3;
 accept31:;
 break;
...
;goto accept29;
alt29_3: ptr->pos=oldpos29;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept29;
alt29_4: ptr->pos=oldpos29;goto fail;
 accept29:;
 break;
case '@' ... '@':; it=rb_ary_new3(0); var0/*n*/=it;;
int oldpos32=ptr->pos;int cut32=0;
alt32_1:;int oldpos33=ptr->pos;int cut33=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept33;
alt33_2: ptr->pos=oldpos33;it=Qnil;
;goto accept33;
alt33_3: ptr->pos=oldpos33;goto alt32_2;
 accept33:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept34;
alt34_2: ptr->pos=oldpos34;if (cut34) goto alt32_2;it=Qnil;
;goto accept34;
alt34_3: ptr->pos=oldpos34;goto alt32_2;
 accept34:;
 break;
...
;goto accept32;
alt32_2: ptr->pos=oldpos32;  it=AmethystParser_key(self ); FAILTEST(alt32_3); var3/*_result*/=it;;

;goto accept32;
alt32_3: ptr->pos=oldpos32;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var3/*_result*/=it;;

;goto accept32;
alt32_4: ptr->pos=oldpos32;goto fail;
 accept32:;
 break;
case '[' ... '[':; it=rb_ary_new3(0); var0/*n*/=it;;
...
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept36;
alt36_2: ptr->pos=oldpos36;stop6=1;
;goto accept36;
alt36_3: ptr->pos=oldpos36;goto alt35_2;
 accept36:;
 break;
...
;goto accept35;
alt35_2: ptr->pos=oldpos35;int oldpos37=ptr->pos;int cut37=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept37;
alt37_2: ptr->pos=oldpos37;it=Qnil;
;goto accept37;
alt37_3: ptr->pos=oldpos37;goto alt35_3;
 accept37:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept38;
alt38_2: ptr->pos=oldpos38;if (cut38) goto alt35_3;it=Qnil;
;goto accept38;
alt38_3: ptr->pos=oldpos38;goto alt35_3;
 accept38:;
 break;
...
;goto accept35;
alt35_3: ptr->pos=oldpos35;goto fail;
 accept35:;
 break;
case '`' ... '`':; it=rb_ary_new3(0); var0/*n*/=it;;
...
;goto accept39;
alt39_2: ptr->pos=oldpos39;int oldpos40=ptr->pos;int cut40=0;
...
bind_aset(bind2,1,var0/*n*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var0/*n*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept40;
alt40_2: ptr->pos=oldpos40;it=Qnil;
;goto accept40;
alt40_3: ptr->pos=oldpos40;goto alt39_3;
 accept40:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; it=Qnil; break;
...
;goto accept41;
alt41_2: ptr->pos=oldpos41;if (cut41) goto alt39_3;it=Qnil;
;goto accept41;
alt41_3: ptr->pos=oldpos41;goto alt39_3;
 accept41:;
 break;
...
;goto accept39;
alt39_3: ptr->pos=oldpos39;goto fail;
 accept39:;
 break;
}
return it;
...
} } it=var2/*autovar*/; var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
                   pass2: *ptr=oldpass2; goto pass1;
                   success2: *ptr=oldpass2;
...
int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt3_4); var3/*autovar*/=it;;
...
bind_aset(bind2,1,var2/*x*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*x*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); FAILTEST(alt3_4); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*x*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*x*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut3=1;stop1=1; break;
} break;
} } bind_aset(bind2,1,var2/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var2/*x*/=bind_aget(bind2,1);; var5/*_result*/=it;;
...
alt3_4: ptr->pos=oldpos5;if (cut3) goto fail;goto fail;
 accept5:;
 break;
case '#' ... '#':; int oldpos7=ptr->pos;int cut4=0;
alt4_1:;  it=AmethystParser_cases(self ); FAILTEST(alt4_2); var0/*_result*/=it;;

;goto accept7;
alt4_2: ptr->pos=oldpos7;int oldpos8=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject4; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept8;  reject4: x=0; accept8: it=Qnil; ptr->pos=oldpos8; if (x==0) goto alt4_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept7;
alt4_3: ptr->pos=oldpos7;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=Amethyst_line(self ); FAILTEST(alt4_4); var6/*s*/=it;;
...
;goto accept7;
alt4_4: ptr->pos=oldpos7;goto fail;
 accept7:;
 break;
...
;goto accept9;
alt5_2: ptr->pos=oldpos9;int oldpos10=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject5; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept10;  reject5: x=0; accept10: it=Qnil; ptr->pos=oldpos10; if (x==0) goto alt5_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept9;
alt5_3: ptr->pos=oldpos9;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_ary_new3(0); var2/*x*/=it;;
int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt5_4); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*x*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*x*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut5=1;stop2=1; break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var4/*autovar*/=it;;
bind_aset(bind2,1,var2/*x*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*x*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); FAILTEST(alt5_4); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*x*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind2);var2/*x*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut5=1;stop2=1; break;
} break;
} } bind_aset(bind2,1,var2/*x*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind2);var2/*x*/=bind_aget(bind2,1);; var5/*_result*/=it;;
...
;goto accept9;
alt5_4: ptr->pos=oldpos9;if (cut5) goto fail;goto fail;
 accept9:;
 break;
...
;goto accept11;
alt6_2: ptr->pos=oldpos11;int oldpos12=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject6; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept12;  reject6: x=0; accept12: it=Qnil; ptr->pos=oldpos12; if (x==0) goto alt6_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept11;
alt6_3: ptr->pos=oldpos11;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt6_4); var7/*x*/=it;;
...
;goto accept13;
alt7_2: ptr->pos=oldpos13;it=Qnil;it=var7/*x*/; var0/*_result*/=it;;

;goto accept13;
alt7_3: ptr->pos=oldpos13;goto alt6_4;
 accept13:;
 break;
}
;goto accept11;
alt6_4: ptr->pos=oldpos11;goto fail;
 accept11:;
 break;
case '-' ... '-':;case '{' ... '{':; int oldpos14=ptr->pos;int cut8=0;
alt8_1:;  it=AmethystParser_cases(self ); FAILTEST(alt8_2); var0/*_result*/=it;;

;goto accept14;
alt8_2: ptr->pos=oldpos14;int oldpos15=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject7; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept15;  reject7: x=0; accept15: it=Qnil; ptr->pos=oldpos15; if (x==0) goto alt8_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept14;
alt8_3: ptr->pos=oldpos14;  it=AmethystParser_host_expr(self ); FAILTEST(alt8_4); var0/*_result*/=it;;

;goto accept14;
alt8_4: ptr->pos=oldpos14;goto fail;
 accept14:;
 break;
case '.' ... '.':; int oldpos16=ptr->pos;int cut9=0;
alt9_1:;  it=AmethystParser_cases(self ); FAILTEST(alt9_2); var0/*_result*/=it;;

;goto accept16;
alt9_2: ptr->pos=oldpos16;int oldpos17=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject8; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept17;  reject8: x=0; accept17: it=Qnil; ptr->pos=oldpos17; if (x==0) goto alt9_3;int oldpos18=ptr->pos;int cut10=0;
alt10_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;
;goto accept18;
alt10_2: ptr->pos=oldpos18;it=Qnil;
;goto accept18;
alt10_3: ptr->pos=oldpos18;goto alt9_3;
 accept18:;
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept16;
alt9_3: ptr->pos=oldpos16;goto fail;
 accept16:;
 break;
case '@' ... '@':; int oldpos19=ptr->pos;int cut11=0;
alt11_1:;  it=AmethystParser_cases(self ); FAILTEST(alt11_2); var0/*_result*/=it;;

;goto accept19;
alt11_2: ptr->pos=oldpos19;int oldpos20=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject9; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept20;  reject9: x=0; accept20: it=Qnil; ptr->pos=oldpos20; if (x==0) goto alt11_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept19;
alt11_3: ptr->pos=oldpos19;  it=AmethystParser_key(self ); FAILTEST(alt11_4); var10/*it*/=it;;
...
;goto accept19;
alt11_4: ptr->pos=oldpos19;goto fail;
 accept19:;
 break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'a':;case 'c' ... 'm':;case 'o' ... 'z':; int oldpos21=ptr->pos;int cut12=0;
alt12_1:;  it=AmethystParser_cases(self ); FAILTEST(alt12_2); var0/*_result*/=it;;

;goto accept21;
alt12_2: ptr->pos=oldpos21;  it=AmethystParser_call(self ); FAILTEST(alt12_3); var0/*_result*/=it;;

;goto accept21;
alt12_3: ptr->pos=oldpos21;int oldpos22=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject10; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept22;  reject10: x=0; accept22: it=Qnil; ptr->pos=oldpos22; if (x==0) goto alt12_4;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept21;
alt12_4: ptr->pos=oldpos21;goto fail;
 accept21:;
 break;
case '[' ... '[':; int oldpos23=ptr->pos;int cut13=0;
alt13_1:;  it=AmethystParser_cases(self ); FAILTEST(alt13_2); var0/*_result*/=it;;

;goto accept23;
alt13_2: ptr->pos=oldpos23;int oldpos24=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject11; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept24;  reject11: x=0; accept24: it=Qnil; ptr->pos=oldpos24; if (x==0) goto alt13_3;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept23;
alt13_3: ptr->pos=oldpos23;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystParser_expression(self ); FAILTEST(alt13_4); var11/*e*/=it;;
...
;goto accept23;
alt13_4: ptr->pos=oldpos23;goto fail;
 accept23:;
 break;
case 'b' ... 'b':; int oldpos25=ptr->pos;int cut14=0;
...
;goto accept25;
alt14_2: ptr->pos=oldpos25;  it=AmethystParser_cases(self ); FAILTEST(alt14_3); var0/*_result*/=it;;

;goto accept25;
alt14_3: ptr->pos=oldpos25;  it=AmethystParser_call(self ); FAILTEST(alt14_4); var0/*_result*/=it;;

;goto accept25;
alt14_4: ptr->pos=oldpos25;int oldpos26=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject12; break;
case '.' ... '.':;case ':' ... ':':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} x=1; goto accept26;  reject12: x=0; accept26: it=Qnil; ptr->pos=oldpos26; if (x==0) goto alt14_5;it=Qnil;it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind2); var0/*_result*/=it;;

;goto accept25;
alt14_5: ptr->pos=oldpos25;goto fail;
 accept25:;
 break;
}
return it;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('820cad8d6c840f6222ba080f4f00bf12')");}
