...
static VALUE sy_AmethystParser_Comment_lb__7f66;
static VALUE sy_AmethystParser_Enter_lb_Ap_a65d;
...
static VALUE sy_AmethystParser_Nested_lb_b_ffed;
...
static VALUE sy_AmethystParser_a_eq_autova_c9d1;
...
return it;
fail: return failobj; }
VALUE AmethystParser_term(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(26);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt1_7: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_8);it=bind_aget(bind,9/*s*/);int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
...
if (strncmp(ame_curstr(self),">",1)) goto alt4_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept5;
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt1_8: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_9);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept6;
 ...
 accept6:;
  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt6_1: ame_setpos(self,oldpos9);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"nested(",7)) goto alt6_2; else ame_setpos(self,ame_getpos(self)+7);  it=AmethystParser_expression(self ); FAILTEST(alt6_2); bind_aset(bind,14/*expr*/,it);
  it=Amethyst_spaces(self ); FAILTEST(alt6_2);if (strncmp(ame_curstr(self),")",1)) goto alt6_2; else ame_setpos(self,ame_getpos(self)+1);it=rb_funcall(self,sy_AmethystParser_Nested_lb_b_ffed,1,bind);  bind_aset(bind,2/*_result*/,it);
...
it=bind_aget(bind,4/*autovar*/); bind_aset(bind,5/*autovar*/,it);
it=bind_aget(bind,5/*autovar*/); bind_aset(bind,15/*autovar*/,it);
int oldpos12=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt6_8;}
 it=bind_aget(bind,15/*autovar*/); bind_aset(bind,7/*a*/,it);
...
alt8_3: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt6_8;}
 it=bind_aget(bind,15/*autovar*/); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ae7,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt6_8: ame_setpos(self,oldpos9);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt6_9);it=bind_aget(bind,9/*s*/);int oldpos13; while(1){oldpos13=ame_getpos(self); int oldpos14=ame_getpos(self);
...
if (strncmp(ame_curstr(self),">",1)) goto alt9_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept11;
alt9_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
   it=AmethystParser_eChar(self ); FAILTEST(alt9_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept11;
  alt9_3:  ame_setpos(self,oldpos14); goto break3;
 accept11:;
 if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
alt6_9: ame_setpos(self,oldpos9);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt6_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept12;
 ...
 accept12:;
  it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos15); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt11_2: ame_setpos(self,oldpos17);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos18=ame_getpos(self);
  it=rb_funcall(self,sy_AmethystParser__di__lb__dot__co__rb__di__8a62,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject3); x=1; goto accept14;  reject3: x=0; accept14: it=Qnil; ame_setpos(self,oldpos18); if (x==0) goto alt11_3;unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt11_3); break;case UC(46) ... UC(46):; int oldpos19=ame_getpos(self);
...
alt11_6: ame_setpos(self,oldpos17);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"\"",1)) goto alt11_7; else ame_setpos(self,ame_getpos(self)+1);int oldpos20; while(1){oldpos20=ame_getpos(self); unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(0) ... UC(33):;case UC(35) ... UC(255):;   it=AmethystParser_eChar(self ); FAILTEST(break5); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0605,1,bind);  break;case UC(34) ... UC(34):; int oldpos21=ame_getpos(self);
...
alt13_2: ame_setpos(self,oldpos21);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break5;}
   it=AmethystParser_eChar(self ); FAILTEST(alt13_3); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0605,1,bind);  
ame_setcut(self,Qnil);goto accept16;
  alt13_3:  ame_setpos(self,oldpos21); goto break5;
 accept16:;
 break;} if (ame_getstop(self)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos20); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_t_bf73,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt11_8: ame_setpos(self,oldpos17);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt11_9);it=bind_aget(bind,9/*s*/);int oldpos23; while(1){oldpos23=ame_getpos(self); int oldpos24=ame_getpos(self);
...
alt15_2: ame_setpos(self,oldpos24);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
   it=AmethystParser_eChar(self ); FAILTEST(alt15_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept18;
  alt15_3:  ame_setpos(self,oldpos24); goto break6;
 accept18:;
 if (ame_getstop(self)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos23); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept13;
alt11_9: ame_setpos(self,oldpos17);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt11_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept19;
 ...
 accept19:;
  it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos25=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos25); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt17_2: ame_setpos(self,oldpos27);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos28=ame_getpos(self);
  it=rb_funcall(self,sy_AmethystParser__di__lb__dot__co__rb__di__8a62,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject4); x=1; goto accept21;  reject4: x=0; accept21: it=Qnil; ame_setpos(self,oldpos28); if (x==0) goto alt17_3;unsigned char chr6=*ame_curstr(self);  switch(chr6){case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt17_3); break;case UC(46) ... UC(46):; int oldpos29=ame_getpos(self);
...
alt17_6: ame_setpos(self,oldpos27);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"'",1)) goto alt17_7; else ame_setpos(self,ame_getpos(self)+1);int oldpos30; while(1){oldpos30=ame_getpos(self); unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(0) ... UC(38):;case UC(40) ... UC(255):;   it=AmethystParser_eChar(self ); FAILTEST(break8); bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__1484,1,bind);  break;case UC(39) ... UC(39):; int oldpos31=ame_getpos(self);
alt19_1: ame_setpos(self,oldpos31);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break8;}
 if (strncmp(ame_curstr(self),"'",1)) goto alt19_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
...
alt19_2: ame_setpos(self,oldpos31);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break8;}
   it=AmethystParser_eChar(self ); FAILTEST(alt19_3); bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__1484,1,bind);  
ame_setcut(self,Qnil);goto accept23;
  alt19_3:  ame_setpos(self,oldpos31); goto break8;
 accept23:;
 break;} if (ame_getstop(self)!=Qnil){{oldpos30=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos30); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_s_59f4,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt20_1: ame_setpos(self,oldpos32);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_8;}
 it=bind_aget(bind,19/*autovar*/); bind_aset(bind,7/*a*/,it);
...
alt20_3: ame_setpos(self,oldpos32);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_8;}
 it=bind_aget(bind,19/*autovar*/); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ae7,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt17_8: ame_setpos(self,oldpos27);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt17_9);it=bind_aget(bind,9/*s*/);int oldpos33; while(1){oldpos33=ame_getpos(self); int oldpos34=ame_getpos(self);
...
alt21_2: ame_setpos(self,oldpos34);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break9;}
   it=AmethystParser_eChar(self ); FAILTEST(alt21_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept25;
  alt21_3:  ame_setpos(self,oldpos34); goto break9;
 accept25:;
 if (ame_getstop(self)!=Qnil){{oldpos33=ame_getpos(self);goto break9;} } } break9: ame_setstop(self,Qnil);  ame_setpos(self,oldpos33); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept20;
alt17_9: ame_setpos(self,oldpos27);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt17_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept26;
 ...
 accept26:;
  it=AmethystCore_anything(self ); FAILTEST(break10); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos35=ame_getpos(self);goto break10;} } } break10: ame_setstop(self,Qnil);  ame_setpos(self,oldpos35); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt25_3: ame_setpos(self,oldpos40);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_7;}
 it=bind_aget(bind,20/*autovar*/); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ae7,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt23_7: ame_setpos(self,oldpos37);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt23_8);it=bind_aget(bind,9/*s*/);int oldpos41; while(1){oldpos41=ame_getpos(self); int oldpos42=ame_getpos(self);
...
if (strncmp(ame_curstr(self),">",1)) goto alt26_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
...
alt26_2: ame_setpos(self,oldpos42);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break11;}
   it=AmethystParser_eChar(self ); FAILTEST(alt26_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept31;
  alt26_3:  ame_setpos(self,oldpos42); goto break11;
 accept31:;
 if (ame_getstop(self)!=Qnil){{oldpos41=ame_getpos(self);goto break11;} } } break11: ame_setstop(self,Qnil);  ame_setpos(self,oldpos41); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt27_1: ame_setpos(self,oldpos43);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_9;}
 if (strncmp(ame_curstr(self),"[]",2)) goto alt27_2; else ame_setpos(self,ame_getpos(self)+2);it=bind_aget(bind,1/*x*/); bind_aset(bind,21/*ors*/,it);
it=rb_funcall(self,sy_AmethystParser_a_eq_autova_c9d1,1,bind);  bind_aset(bind,22/*_result*/,it);
it=bind_aget(bind,22/*_result*/); bind_aset(bind,2/*_result*/,it);
...
alt23_9: ame_setpos(self,oldpos37);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt23_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept33;
 ...
 accept33:;
  it=AmethystCore_anything(self ); FAILTEST(break12); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos44=ame_getpos(self);goto break12;} } } break12: ame_setstop(self,Qnil);  ame_setpos(self,oldpos44); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept27;
  alt23_10:  ame_setpos(self,oldpos37); goto fail;
 accept27:;
 break;case UC(91) ... UC(91):; int oldpos46=ame_getpos(self);
alt29_1: ame_setpos(self,oldpos46);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_call(self ); FAILTEST(alt29_2); bind_aset(bind,2/*_result*/,it);
...
alt29_2: ame_setpos(self,oldpos46);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos47=ame_getpos(self);
  it=rb_funcall(self,sy_AmethystParser__di__lb__dot__co__rb__di__8a62,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject6); x=1; goto accept35;  reject6: x=0; accept35: it=Qnil; ame_setpos(self,oldpos47); if (x==0) goto alt29_3;unsigned char chr10=*ame_curstr(self);  switch(chr10){case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt29_3); break;case UC(46) ... UC(46):; int oldpos48=ame_getpos(self);
alt30_1: ame_setpos(self,oldpos48);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt29_3;}
 if (strncmp(ame_curstr(self),".",1)) goto alt30_2; else ame_setpos(self,ame_getpos(self)+1); 
ame_setcut(self,Qnil);goto accept36;
alt30_2: ame_setpos(self,oldpos48);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt29_3;}
   it=Amethyst_empty(self ); FAILTEST(alt30_3); 
ame_setcut(self,Qnil);goto accept36;
  alt30_3:  ame_setpos(self,oldpos48); goto alt29_3;
 accept36:;
 break;}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept34;
alt29_3: ame_setpos(self,oldpos46);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"[",1)) goto alt29_4; else ame_setpos(self,ame_getpos(self)+1);  it=AmethystParser_expression(self ); FAILTEST(alt29_4); bind_aset(bind,23/*e*/,it);
  it=Amethyst_spaces(self ); FAILTEST(alt29_4);if (strncmp(ame_curstr(self),"]",1)) goto alt29_4; else ame_setpos(self,ame_getpos(self)+1);it=rb_funcall(self,sy_AmethystParser_Enter_lb_Ap_a65d,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt31_1: ame_setpos(self,oldpos49);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt29_8;}
 it=bind_aget(bind,24/*autovar*/); bind_aset(bind,7/*a*/,it);
...
alt31_3: ame_setpos(self,oldpos49);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt29_8;}
 it=bind_aget(bind,24/*autovar*/); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ae7,1,bind);  bind_aset(bind,2/*_result*/,it);
...
alt29_8: ame_setpos(self,oldpos46);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt29_9);it=bind_aget(bind,9/*s*/);int oldpos50; while(1){oldpos50=ame_getpos(self); int oldpos51=ame_getpos(self);
...
if (strncmp(ame_curstr(self),">",1)) goto alt32_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
...
alt32_2: ame_setpos(self,oldpos51);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break13;}
   it=AmethystParser_eChar(self ); FAILTEST(alt32_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept38;
  alt32_3:  ame_setpos(self,oldpos51); goto break13;
 accept38:;
 if (ame_getstop(self)!=Qnil){{oldpos50=ame_getpos(self);goto break13;} } } break13: ame_setstop(self,Qnil);  ame_setpos(self,oldpos50); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept34;
alt29_9: ame_setpos(self,oldpos46);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt29_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept39;
 ...
 accept39:;
  it=AmethystCore_anything(self ); FAILTEST(break14); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos52=ame_getpos(self);goto break14;} } } break14: ame_setstop(self,Qnil);  ame_setpos(self,oldpos52); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept34;
  alt29_10:  ame_setpos(self,oldpos46); goto fail;
 accept34:;
 break;case UC(98) ... UC(98):; int oldpos54=ame_getpos(self);
alt34_1: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"break",5)) goto alt34_2; else ame_setpos(self,ame_getpos(self)+5);it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb__3505,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_2: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_call(self ); FAILTEST(alt34_3); bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_3: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos55=ame_getpos(self);
  it=rb_funcall(self,sy_AmethystParser__di__lb__dot__co__rb__di__8a62,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject7); x=1; goto accept41;  reject7: x=0; accept41: it=Qnil; ame_setpos(self,oldpos55); if (x==0) goto alt34_4;unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt34_4); break;case UC(46) ... UC(46):; int oldpos56=ame_getpos(self);
alt35_1: ame_setpos(self,oldpos56);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt34_4;}
 if (strncmp(ame_curstr(self),".",1)) goto alt35_2; else ame_setpos(self,ame_getpos(self)+1); 
ame_setcut(self,Qnil);goto accept42;
alt35_2: ame_setpos(self,oldpos56);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt34_4;}
   it=Amethyst_empty(self ); FAILTEST(alt35_3); 
ame_setcut(self,Qnil);goto accept42;
  alt35_3:  ame_setpos(self,oldpos56); goto alt34_4;
 accept42:;
 break;}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_4: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_key(self ); FAILTEST(alt34_5); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Act_lb_bind_3e5d,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_5: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_host_expr(self ); FAILTEST(alt34_6); bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_6: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_line_host_expr(self ); FAILTEST(alt34_7); bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_7: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
int oldpos57=ame_getpos(self);
alt36_1: ame_setpos(self,oldpos57);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt34_8;}
 it=bind_aget(bind,25/*autovar*/); bind_aset(bind,7/*a*/,it);
if (strncmp(ame_curstr(self),"...",3)) goto alt36_2; else ame_setpos(self,ame_getpos(self)+3);  it=Amethyst_number(self ); FAILTEST(alt36_2); bind_aset(bind,8/*b*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_f71c,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept43;
alt36_2: ame_setpos(self,oldpos57);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt34_8;}
 it=bind_aget(bind,25/*autovar*/); bind_aset(bind,7/*a*/,it);
if (strncmp(ame_curstr(self),"..",2)) goto alt36_3; else ame_setpos(self,ame_getpos(self)+2);  it=Amethyst_number(self ); FAILTEST(alt36_3); bind_aset(bind,8/*b*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_ee57,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept43;
alt36_3: ame_setpos(self,oldpos57);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt34_8;}
 it=bind_aget(bind,25/*autovar*/); bind_aset(bind,3/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_2ae7,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept43;
  alt36_4:  ame_setpos(self,oldpos57); goto alt34_8;
 accept43:;
 
ame_setcut(self,Qnil);goto accept40;
alt34_8: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt34_9);it=bind_aget(bind,9/*s*/);int oldpos58; while(1){oldpos58=ame_getpos(self); int oldpos59=ame_getpos(self);
alt37_1: ame_setpos(self,oldpos59);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break15;}
   it=Amethyst_spaces(self ); FAILTEST(alt37_2);it=rb_obj_clone(s__gt__cedf); bind_aset(bind,9/*s*/,it);
if (strncmp(ame_curstr(self),">",1)) goto alt37_2; else ame_setpos(self,ame_getpos(self)+1);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept44;
alt37_2: ame_setpos(self,oldpos59);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break15;}
   it=AmethystParser_eChar(self ); FAILTEST(alt37_3); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be4f,1,bind);  
ame_setcut(self,Qnil);goto accept44;
  alt37_3:  ame_setpos(self,oldpos59); goto break15;
 accept44:;
 if (ame_getstop(self)!=Qnil){{oldpos58=ame_getpos(self);goto break15;} } } break15: ame_setstop(self,Qnil);  ame_setpos(self,oldpos58); it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_7fae,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
alt34_9: ame_setpos(self,oldpos54);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,9/*s*/,it);
 it=bind_aget(bind,9/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt34_10);it=bind_aget(bind,9/*s*/);it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
int oldpos60; while(1){oldpos60=ame_getpos(self); int oldpos61=ame_getpos(self);
alt38_1: ame_setpos(self,oldpos61);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break16;}
   it=Amethyst_endline(self ); FAILTEST(alt38_2);ame_setcut(self,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt38_2); 
ame_setcut(self,Qnil);goto accept45;
alt38_2: ame_setpos(self,oldpos61);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break16;}
   it=Amethyst_empty(self ); FAILTEST(alt38_3); 
ame_setcut(self,Qnil);goto accept45;
  alt38_3:  ame_setpos(self,oldpos61); goto break16;
 accept45:;
  it=AmethystCore_anything(self ); FAILTEST(break16); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__be78,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos60=ame_getpos(self);goto break16;} } } break16: ame_setstop(self,Qnil);  ame_setpos(self,oldpos60); it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*c*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__7f66,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept40;
  alt34_10:  ame_setpos(self,oldpos54); goto fail;
 accept40:;
 break;}it=bind_aget(bind,2/*_result*/);
return it;
fail: return failobj; }
...
sy_AmethystParser_Comment_lb__7f66=rb_intern("AmethystParser_Comment_lb__7f66");
sy_AmethystParser_Enter_lb_Ap_a65d=rb_intern("AmethystParser_Enter_lb_Ap_a65d");
...
sy_AmethystParser_Nested_lb_b_ffed=rb_intern("AmethystParser_Nested_lb_b_ffed");
...
sy_AmethystParser_a_eq_autova_c9d1=rb_intern("AmethystParser_a_eq_autova_c9d1");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('f0c3924dd8c0895cb58b251c280eccc0')");}
