...
it=rb_ary_entry(bind,0/*o*/);
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,2/*autovar*/);
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAmethystParser,0)));
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=CALL(addargs_AmethystParsercb_2,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto break1;
 if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=CALL(addargs_AmethystParsercb_3,1,bind); 
...
alt2_1: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
 ...
 rb_ary_store(bind,6/*autovar*/,it); it=CALL(args_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,5/*autovar*/);
...
it=rb_ary_entry(bind,0/*c*/);
 ...
 rb_ary_store(bind,6/*autovar*/,it); it=CALL(args_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,5/*autovar*/);
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8/*autovar*/,it); it=CALL(argsOpt_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,7/*autovar*/);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
 ...
 rb_ary_store(bind,1/*autovar*/,it); it=CALL(number_AmethystParsercb_2,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0/*autovar*/);
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2/*autovar*/);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
   it=Amethyst_empty(self ); FAILTEST(alt1_3);it=CALL(grammar_AmethystParsercb_1,1,bind);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2/*autovar*/);
 rb_ary_store(bind,4/*rules*/,it);   it=Amethyst_spaces(self ); FAILTEST(fail); it=rb_obj_clone(c_64); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_obj_clone(c_65);it=CALL(grammar_AmethystParsercb_2,1,bind);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept2;
 ...
 rb_ary_store(bind,2/*autovar*/,it); it=CALL(procargs2_AmethystParsercb_1,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC('\000') ... UC('`'):;case UC('b') ... UC('\377'):;   it=Amethyst_empty(self ); FAILTEST(break2); break;case UC('a') ... UC('a'):; int oldpos5=ame_getpos(self);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept3;
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=CALL(igrammar_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,1/*autovar*/);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
it=CALL(igrammar_AmethystParsercb_3,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0/*autovar*/);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept2;
 ...
 accept2:;
  it=AmethystCore_anything(self ); FAILTEST(break1);
 rb_ary_store(bind,4/*autovar*/,it); it=CALL(modifier_AmethystParsercb_2,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,3/*autovar*/);
...
alt2_1: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt1_2;}
 ...
 rb_ary_store(bind,1/*autovar*/,it); it=CALL(number_AmethystParsercb_2,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,0/*autovar*/);
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0/*autovar*/,it);  it=CALL(number_AmethystParsercb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(fail);
 rb_ary_store(bind,1/*autovar*/,it); it=CALL(number_AmethystParsercb_2,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self);  it=CALL(number_AmethystParsercb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(break1);
 rb_ary_store(bind,2/*autovar*/,it); it=CALL(number_AmethystParsercb_3,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0/*autovar*/);
 rb_ary_store(bind,3/*_result*/,it); it=rb_ary_entry(bind,3/*_result*/);
return it;
fail: return failobj; }
...
alt2_2: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt1_4;}
  ...
  it=CALL(prefixed_AmethystParsercb_3,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos3); if (x==0) goto alt2_3;int oldpos4=ame_getpos(self);
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
 if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos1); it=CALL(procargs_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,1/*_result*/,it); it=rb_ary_entry(bind,1/*_result*/);
return it;
fail: return failobj; }
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAmethystParser,0)));
 ...
 rb_ary_store(bind,2/*autovar*/,it); it=CALL(procargs2_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,1/*autovar*/);
...
alt2_2: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt1_5;}
  it=CALL(rubyarg_AmethystParsercb_2,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt2_3);
 rb_ary_store(bind,1/*n*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept2;
...
alt1_6: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
  it=CALL(rubyarg_AmethystParsercb_4,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt1_7);
 rb_ary_store(bind,6/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept6;
 ...
 accept6:;
 break;}it=CALL(rubyarg_AmethystParsercb_6,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos6=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,9/*autovar*/);
...
alt7_2: ame_setpos(self,oldpos8);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt5_6;}
  it=CALL(rubyarg_AmethystParsercb_2,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,1/*n*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept7;
...
alt5_7: ame_setpos(self,oldpos5);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
  it=CALL(rubyarg_AmethystParsercb_4,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt5_8);
 rb_ary_store(bind,6/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept5;
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept11;
 ...
 accept11:;
 break;}it=CALL(rubyarg_AmethystParsercb_10,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos12=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos12); it=rb_ary_entry(bind,13/*autovar*/);
...
alt12_2: ame_setpos(self,oldpos14);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt10_6;}
  it=CALL(rubyarg_AmethystParsercb_2,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt12_3);
 rb_ary_store(bind,1/*n*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept12;
...
alt10_7: ame_setpos(self,oldpos11);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
  it=CALL(rubyarg_AmethystParsercb_4,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt10_8);
 rb_ary_store(bind,6/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept10;
...
alt16_2: ame_setpos(self,oldpos18);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt15_7;}
  it=CALL(rubyarg_AmethystParsercb_2,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt16_3);
 rb_ary_store(bind,1/*n*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept16;
...
alt15_8: ame_setpos(self,oldpos17);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
  it=CALL(rubyarg_AmethystParsercb_4,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt15_9);
 rb_ary_store(bind,6/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept15;
...
alt20_2: ame_setpos(self,oldpos22);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto alt19_6;}
  it=CALL(rubyarg_AmethystParsercb_2,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt20_3);
 rb_ary_store(bind,1/*n*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept20;
...
alt19_7: ame_setpos(self,oldpos21);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
  it=CALL(rubyarg_AmethystParsercb_4,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt19_8);
 rb_ary_store(bind,6/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept19;
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
 ...
 rb_ary_store(bind,2/*autovar*/,it); it=CALL(procargs2_AmethystParsercb_1,1,bind);  if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,1/*autovar*/);
...
alt1_2: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
 ...
 rb_ary_store(bind,4/*expr*/,it);   it=Amethyst_spaces(self ); FAILTEST(alt1_3); it=rb_obj_clone(c_77); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_3);it=rb_obj_clone(c_78);it=CALL(term_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,3/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
   it=Amethyst_spaces(self ); FAILTEST(alt1_4); it=rb_obj_clone(c_79); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_4);it=rb_obj_clone(c_80);it=CALL(term_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,3/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutAmethystParser)!=Qnil) {rb_ivar_set(self,s__at_cutAmethystParser,Qnil); goto fail;}
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept3;
 ...
 accept3:;
 break;} if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos3); it=CALL(term_AmethystParsercb_7,1,bind); 
 rb_ary_store(bind,3/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept4;
 ...
 accept4:;
 break;} if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos5); it=CALL(term_AmethystParsercb_9,1,bind); 
 rb_ary_store(bind,3/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
...
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept5;
 ...
 accept5:;
 if (rb_ivar_get(self,s__at_stopAmethystParser)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: rb_ivar_set(self,s__at_stopAmethystParser,Qnil);  ame_setpos(self,oldpos7); it=CALL(term_AmethystParsercb_12,1,bind); 
 rb_ary_store(bind,3/*_result*/,it);  
rb_ivar_set(self,s__at_cutAmethystParser,Qnil);goto accept1;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('84a57d5d6b37646584ff03adb1141f93')");}
