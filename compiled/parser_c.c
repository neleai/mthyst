...
it=rb_ary_new3(0); it=rb_ary_entry(bind,0); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_ary_new3(0);
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); it=rb_ary_new3(0);it=rb_ary_new3(0);int oldpos1; while(1){oldpos1=ame_getpos(self);  it=CALL(addargs_AmethystParsercb_1,1,bind);  arg0=it; it=AmethystParser_clas(self ,arg0); FAILTEST(break1);
...
return it;
fail: return failobj; }
VALUE AmethystParser_application(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(15);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=rb_str_new2(")");it=rb_str_new2("(");int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2(")");it=rb_str_new2("(");it=rb_str_new2(")");it=rb_str_new2("(");it=rb_ary_new3(0); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt2_2); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_new3(0);
 rb_ary_store(bind,2,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystParser_rubyarg(self ); FAILTEST(break1);
 rb_ary_store(bind,3,it); it=CALL(application_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_entry(bind,4);
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it); it=CALL(application_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,7,it); it=CALL(application_AmethystParsercb_4,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,9,it);   it=AmethystParser_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos5); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it);   it=AmethystParser_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
it=rb_ary_entry(bind,12);
 rb_ary_store(bind,13,it); it=CALL(application_AmethystParsercb_5,1,bind); 
...
it=rb_ary_entry(bind,0);
 ...
 rb_ary_store(bind,3,it); it=rb_ary_new3(0); it=rb_ary_entry(bind,3); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_ary_new3(0);
...
return it;
fail: return failobj; }
VALUE AmethystParser_argsOpt(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=rb_ary_new2(17); rb_ary_store(bind,2,a0);rb_ary_store(bind,0,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_ary_entry(bind,0);
 rb_ary_store(bind,1,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,4,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,5,it); it=rb_ary_new3(0); it=rb_ary_entry(bind,5); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_new3(0);
 rb_ary_store(bind,6,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystParser_rubyarg(self ); FAILTEST(break1);
 rb_ary_store(bind,7,it); it=CALL(argsOpt_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,6);
 rb_ary_store(bind,8,it);  it=rb_ary_entry(bind,4); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it); it=CALL(argsOpt_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,11,it); it=CALL(argsOpt_AmethystParsercb_3,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,12,it); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystParser_procargs(self ); FAILTEST(pass2);
 rb_ary_store(bind,13,it);   it=AmethystParser_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
it=rb_ary_entry(bind,13);
 rb_ary_store(bind,14,it);   it=AmethystParser_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos3); ame_setlen(self,oldlen1);
	if(fail1) goto alt1_2;
it=rb_ary_entry(bind,14);
 rb_ary_store(bind,15,it); it=rb_ary_entry(bind,15);
...
it=rb_ary_new3(0);it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);  it=AmethystParser_upper(self ); FAILTEST(fail);
...
it=rb_ary_new3(0);it=rb_str_new2("amethyst");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2("amethyst"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);  it=AmethystParser_name(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("<");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2("<"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_name(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
it=rb_str_new2("{");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2("{"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,4,it); it=rb_str_new2("}");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2("}"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=CALL(grammar_AmethystParsercb_3,1,bind);
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
...
it=rb_str_new2("}");it=rb_str_new2("{");it=rb_str_new2("}");it=rb_str_new2("{");it=rb_ary_new3(0); it=rb_str_new2("{"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=rb_ary_new3(0);
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("@");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2("@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_className(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,0,it); it=CALL(key_AmethystParsercb_1,1,bind); 
 rb_ary_store(bind,1,it); it=CALL(key_AmethystParsercb_2,1,bind);
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("@@");  it=AmethystParser_spaces(self ); FAILTEST(alt1_4); it=rb_str_new2("@@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_4);  it=AmethystParser_name(self ); FAILTEST(alt1_4);
...
it=rb_ary_new3(0);it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);  it=AmethystParser_nameFirst(self ); FAILTEST(fail);
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystParser_name(self ); FAILTEST(alt1_2);it=rb_str_new2(")");it=rb_str_new2("(");int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_2;}
 it=rb_str_new2(")");it=rb_str_new2("(");it=rb_str_new2(")");it=rb_str_new2("(");it=rb_ary_new3(0); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt2_2); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystParser_rubyarg(self ); FAILTEST(break1);
 rb_ary_store(bind,1,it); it=CALL(nr_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it); it=CALL(nr_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(nr_AmethystParsercb_3,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
ISET(cut,Qnil);goto accept2;
 ...
 accept2:;
it=rb_str_new2("=");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2("="); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);ISET(cut,Qtrue);  it=AmethystParser_fails(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,7,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystParser_empty(self ); FAILTEST(alt1_3);
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("&");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2("&"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_inlineHostExpr(self ); FAILTEST(alt1_2);
...
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
 it=rb_str_new2("&");  it=AmethystParser_spaces(self ); FAILTEST(alt2_2); it=rb_str_new2("&"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
 it=rb_str_new2("~");  it=AmethystParser_spaces(self ); FAILTEST(alt2_3); it=rb_str_new2("~"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_3);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept2;
...
alt3_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_4;}
 it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt3_3); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt3_3);int oldpos4=ame_getpos(self);
...
alt4_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_3;}
 it=rb_str_new2(".");  it=AmethystParser_spaces(self ); FAILTEST(alt4_2); it=rb_str_new2("."); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt4_2); 
...
alt6_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_str_new2("=>");  it=AmethystParser_spaces(self ); FAILTEST(alt6_2); it=rb_str_new2("=>"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_2);  it=AmethystParser_prefixed(self ); FAILTEST(alt6_2);
...
alt6_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_str_new2("[");  it=AmethystParser_spaces(self ); FAILTEST(alt6_3); it=rb_str_new2("["); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_3);  it=AmethystParser_expression(self ); FAILTEST(alt6_3);
 rb_ary_store(bind,10,it); it=CALL(prefixed_AmethystParsercb_8,1,bind); it=rb_str_new2("]");  it=AmethystParser_spaces(self ); FAILTEST(alt6_3); it=rb_str_new2("]"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_3); 
ISET(cut,Qnil);goto accept7;
...
alt7_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
 it=rb_str_new2("*");  it=AmethystParser_spaces(self ); FAILTEST(alt7_2); it=rb_str_new2("*"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_2);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
...
alt7_2: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
 it=rb_str_new2("+");  it=AmethystParser_spaces(self ); FAILTEST(alt7_3); it=rb_str_new2("+"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,11,it);  
ISET(cut,Qnil);goto accept8;
...
alt6_4: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_str_new2("?");  it=AmethystParser_spaces(self ); FAILTEST(alt6_5); it=rb_str_new2("?"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_5);it=CALL(prefixed_AmethystParsercb_10,1,bind); 
 rb_ary_store(bind,5,it);  
ISET(cut,Qnil);goto accept7;
alt6_5: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_str_new2(":");  it=AmethystParser_spaces(self ); FAILTEST(alt6_6); it=rb_str_new2(":"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_6);int oldpos10=ame_getpos(self);
...
it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbAmethystParser1,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2);
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); char chr1=*ame_curstr(self);  switch(chr1){case 34:;case 39:;case 96:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,17,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_10);
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_18,1,bind); FAILTEST(alt1_10);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_19,1,bind); FAILTEST(alt1_10);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
...
alt7_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,2,it);  it=rb_str_new2("`"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_2);it=CALL(rubyarg_AmethystParsercb_20,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2(")");
 rb_ary_store(bind,4,it); it=rb_str_new2("(");
 rb_ary_store(bind,5,it);  it=rb_str_new2("("); arg0=it;it=rb_str_new2(")"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt7_3);
 rb_ary_store(bind,6,it); it=CALL(rubyarg_AmethystParsercb_21,1,bind); 
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
alt7_3: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("]");
 rb_ary_store(bind,4,it); it=rb_str_new2("[");
 rb_ary_store(bind,5,it);  it=rb_str_new2("["); arg0=it;it=rb_str_new2("]"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt7_4);
 rb_ary_store(bind,6,it); it=CALL(rubyarg_AmethystParsercb_22,1,bind); 
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
alt7_4: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("}");
 rb_ary_store(bind,4,it); it=rb_str_new2("{");
 rb_ary_store(bind,5,it);  it=rb_str_new2("{"); arg0=it;it=rb_str_new2("}"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt7_5);
 rb_ary_store(bind,6,it); it=CALL(rubyarg_AmethystParsercb_23,1,bind); 
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
alt7_5: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); it=CALL(rubyarg_AmethystParsercb_24,1,bind); it=rb_ary_new3(0);
 rb_ary_store(bind,9,it); int oldpos10; while(1){oldpos10=ame_getpos(self); int oldpos11=ame_getpos(self);
...
ISET(cut,Qnil);goto accept8;
 ...
 accept8:;
it=CALL(rubyarg_AmethystParsercb_25,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,11,it); it=CALL(rubyarg_AmethystParsercb_26,1,bind); it=CALL(rubyarg_AmethystParsercb_27,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
alt7_6: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,12,it); it=CALL(rubyarg_AmethystParsercb_28,1,bind); it=rb_ary_new3(0);
 rb_ary_store(bind,13,it); int oldpos12; while(1){oldpos12=ame_getpos(self); int oldpos13=ame_getpos(self);
...
ISET(cut,Qnil);goto accept9;
 ...
 accept9:;
it=CALL(rubyarg_AmethystParsercb_29,1,bind);  if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos12); it=rb_ary_entry(bind,13);
 rb_ary_store(bind,15,it); it=CALL(rubyarg_AmethystParsercb_30,1,bind); it=CALL(rubyarg_AmethystParsercb_31,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
alt10_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_10;}
 it=rb_str_new2(":@");  it=AmethystParser_spaces(self ); FAILTEST(alt10_2); it=rb_str_new2(":@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt10_2);
 rb_ary_store(bind,16,it); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept10;
alt10_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_10;}
 it=CALL(rubyarg_AmethystParsercb_32,1,bind); 
 rb_ary_store(bind,17,it);   it=AmethystCore_anything(self ); FAILTEST(alt10_3);
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_33,1,bind); FAILTEST(alt10_3);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_34,1,bind); FAILTEST(alt10_3);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept10;
...
ISET(cut,Qnil);goto accept11;
 ...
 rb_ary_store(bind,22,it); it=CALL(rubyarg_AmethystParsercb_35,1,bind); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
alt7_11: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,17,it);   it=AmethystCore_anything(self ); FAILTEST(alt7_12);
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_37,1,bind); FAILTEST(alt7_12);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_38,1,bind); FAILTEST(alt7_12);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
  alt7_12:  ame_setpos(self,oldpos9); goto fail;
 accept7:;
 break;}it=rb_ary_entry(bind,3);
return it;
fail: return failobj; }
...
it=CALL(rule_AmethystParsercb_1,1,bind); it=CALL(rule_AmethystParsercb_2,1,bind); 
 ...
 rb_ary_store(bind,2,it); it=rb_str_new2("=");  it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2("="); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);  it=AmethystParser_expression(self ); FAILTEST(fail);
...
it=rb_str_new2(")");it=rb_str_new2("(");int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2(")");it=rb_str_new2("(");it=rb_str_new2(")");it=rb_str_new2("(");it=rb_ary_new3(0); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystParser_rubyarg(self ); FAILTEST(break1);
 rb_ary_store(bind,1,it); it=CALL(ruleargs_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it); it=CALL(ruleargs_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(ruleargs_AmethystParsercb_3,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=rb_ary_entry(bind,10);
 rb_ary_store(bind,11,it); it=CALL(ruleargs_AmethystParsercb_4,1,bind); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,12,it); int oldpos6=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystParser_addargs(self ); FAILTEST(pass4);
 rb_ary_store(bind,13,it);   it=AmethystParser_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos6); ame_setlen(self,oldlen4);
	if(fail4) goto pass3;
it=rb_ary_entry(bind,13);
 rb_ary_store(bind,14,it);   it=AmethystParser_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); it=rb_ary_new3(0);int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("nested");  it=AmethystParser_spaces(self ); FAILTEST(alt1_3); it=rb_str_new2("nested"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);  it=AmethystParser_expression(self ); FAILTEST(alt1_3);
 rb_ary_store(bind,4,it); it=rb_str_new2(")");  it=AmethystParser_spaces(self ); FAILTEST(alt1_3); it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);it=CALL(term_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("break");  it=AmethystParser_spaces(self ); FAILTEST(alt1_4); it=rb_str_new2("break"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_4);it=CALL(term_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 it=rb_str_new2("->");  it=AmethystParser_spaces(self ); FAILTEST(alt2_2); it=rb_str_new2("->"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);  it=AmethystParser_atomicHostExpr(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 it=rb_str_new2("");  it=AmethystParser_spaces(self ); FAILTEST(alt2_3); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_3);  it=AmethystParser_inlineHostExpr(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept2;
...
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("\"");  it=AmethystParser_spaces(self ); FAILTEST(alt1_8); it=rb_str_new2("\""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_8);it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self); int oldpos4=ame_getpos(self);
...
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("'");  it=AmethystParser_spaces(self ); FAILTEST(alt1_9); it=rb_str_new2("'"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_9);it=rb_ary_new3(0);int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("<");
 rb_ary_store(bind,8,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_11); it=rb_ary_entry(bind,8); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_11);it=rb_ary_new3(0);int oldpos7; while(1){oldpos7=ame_getpos(self); int oldpos8=ame_getpos(self);
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("(");  it=AmethystParser_spaces(self ); FAILTEST(alt1_12); it=rb_str_new2("("); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_12);  it=AmethystParser_expression(self ); FAILTEST(alt1_12);
 rb_ary_store(bind,1,it); it=rb_str_new2(")");  it=AmethystParser_spaces(self ); FAILTEST(alt1_12); it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_12);int oldpos9=ame_getpos(self);
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversionparser('9f46a5e33da69380aa6a7743b2a40f7d')");}
