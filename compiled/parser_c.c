...
alt2_1:;  it=Amethyst__(self ); FAILTEST(alt2_2);ame_setcut(self,Qtrue);goto alt2_2;
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}  it=Amethyst_empty(self ); FAILTEST(alt2_3);
;goto accept2;
...
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr2(ptr),":",1)) goto alt2_2; else ptr->pos+=1;ame_setcut(self,Qtrue);goto alt2_2;
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}  it=Amethyst_empty(self ); FAILTEST(alt2_3);
;goto accept2;
alt2_3: ptr->pos=oldpos2;goto alt1_2;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__4297,1,bind);   it=AmethystCore_anything(self ); FAILTEST(alt4_2);int oldpos5=ptr->pos;
...
int oldpos6; int stop1=0; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos7=ptr->pos;
...
alt6_3: ptr->pos=oldpos7;goto break1;
 accept7:;
 break;
case '>' ... '>':; int oldpos8=ptr->pos;
alt7_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,13/*s*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt7_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept8;
alt7_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt7_3);  it=AmethystCore_anything(self ); FAILTEST(alt7_3); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__a474,1,bind); 
;goto accept8;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos9=ptr->pos;
alt8_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,13/*s*/,it);
goto alt8_2;
;goto accept9;
alt8_2: ptr->pos=oldpos9;int oldpos10=ptr->pos;
...
alt8_3: ptr->pos=oldpos9;goto break1;
 accept9:;
 break;
case '>' ... '>':; int oldpos11=ptr->pos;
alt10_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,13/*s*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt10_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept11;
alt10_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}int oldpos12=ptr->pos;
...
it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1;  while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; int oldpos2=ptr->pos;
...
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr2(ptr),"methyst",7)) goto alt2_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt2_2;
ame_setcut(self,Qnil);goto accept4;
alt2_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt2_3);
;goto accept4;
...
case 'a' ... 'a':; int oldpos5=ptr->pos;
alt3_1:;it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos6=ptr->pos;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr2(ptr),"methyst",7)) goto alt4_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt4_2;
ame_setcut(self,Qnil);goto accept6;
alt4_2: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}  it=Amethyst_empty(self ); FAILTEST(alt4_3);
;goto accept6;
...
alt5_1:;  it=AmethystCore_anything(self ); FAILTEST(alt5_2);if (strncmp(ame_curstr2(ptr),"methyst",7)) goto alt5_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt5_2;
ame_setcut(self,Qnil);goto accept8;
alt5_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}  it=Amethyst_empty(self ); FAILTEST(alt5_3);
;goto accept8;
...
ame_setcut(self,Qnil);goto accept2;
alt1_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}it=rb_obj_clone(s__re__cbb1); bind_aset(bind,3/*c*/,it);
...
;goto accept2;
alt1_3: ptr->pos=oldpos2;  it=Amethyst_empty(self ); FAILTEST(alt1_4);  it=AmethystCore_anything(self ); FAILTEST(alt1_4); bind_aset(bind,8/*autovar*/,it);
...
alt2_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}it=rb_obj_clone(s__re__cbb1); bind_aset(bind,3/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,4/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__6ac6,1,bind); 
;goto accept3;
alt2_3: ptr->pos=oldpos3;int oldpos4=ptr->pos;
alt3_1:;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,9/*_result*/,it);
it=bind_aget(bind,9/*_result*/); bind_aset(bind,10/*autovar*/,it);
...
alt2_4: ptr->pos=oldpos3;goto break1;
 accept3:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb_,1,bind);  bind_aset(bind,11/*_result*/,it);
...
alt1_1:;  it=Amethyst__(self ); FAILTEST(alt1_2);ame_setcut(self,Qtrue);goto alt1_2;
ame_setcut(self,Qnil);goto accept2;
alt1_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt1_3);
;goto accept2;
...
it=rb_funcall(self,sy_AmethystParser_Many_lb_bin_33ac,1,bind);  bind_aset(bind,0/*from*/,it);
 break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(break1);int oldpos3=ptr->pos;
alt2_1:;int oldpos4=ptr->pos;
...
;goto accept1;
alt1_4: ptr->pos=oldpos1;int oldpos2=ptr->pos;
...
alt2_3: ptr->pos=oldpos2;goto alt1_5;
 accept2:;
int oldpos3=ptr->pos;
alt3_1:;  it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2;
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}  it=Amethyst_empty(self ); FAILTEST(alt3_3);
;goto accept3;
...
;goto accept1;
alt1_5: ptr->pos=oldpos1;  it=AmethystParser_key(self ); FAILTEST(alt1_6); bind_aset(bind,5/*_result*/,it);

;goto accept1;
alt1_6: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_7); bind_aset(bind,5/*_result*/,it);
...
int oldpos4=ptr->pos;
alt4_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept4;
alt4_3: ptr->pos=oldpos4;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept4;
alt4_4: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt4_5);it=rb_ary_new3(0); bind_aset(bind,10/*x*/,it);
int oldpos5; int stop1=0; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos6=ptr->pos;
alt5_1:;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
...
;goto accept6;
alt5_2: ptr->pos=oldpos6;  it=Amethyst_empty(self ); FAILTEST(alt5_3);  it=AmethystCore_anything(self ); FAILTEST(alt5_3); bind_aset(bind,12/*autovar*/,it);
...
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept7;
alt6_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind); 
;goto accept7;
alt6_3: ptr->pos=oldpos7;  it=Amethyst_empty(self ); FAILTEST(alt6_4);  it=AmethystCore_anything(self ); FAILTEST(alt6_4); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d43a,1,bind); 
;goto accept7;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos8=ptr->pos;
alt7_1:;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind); 
;goto accept8;
alt7_2: ptr->pos=oldpos8;int oldpos9=ptr->pos;
alt8_1:;  it=AmethystCore_anything(self ); FAILTEST(alt8_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
...
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept10;
alt9_2: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind); 
;goto accept10;
alt9_3: ptr->pos=oldpos10;int oldpos11=ptr->pos;
alt10_1:;  it=AmethystCore_anything(self ); FAILTEST(alt10_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__283c,1,bind); 
;goto accept11;
...
} if (stop1) goto accept5; } break1: goto alt4_5; accept5:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_10_rb__ff8c,1,bind);  bind_aset(bind,14/*_result*/,it);
...
;goto accept4;
alt4_5: ptr->pos=oldpos4;int oldpos12=ptr->pos;
...
alt12_1:;  it=Amethyst__(self ); FAILTEST(alt12_2);ame_setcut(self,Qtrue);goto alt12_2;
ame_setcut(self,Qnil);goto accept13;
alt12_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_6;}  it=Amethyst_empty(self ); FAILTEST(alt12_3);
;goto accept13;
...
;goto accept4;
alt4_6: ptr->pos=oldpos4;  it=AmethystParser_key(self ); FAILTEST(alt4_7); bind_aset(bind,5/*_result*/,it);
...
alt13_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept14;
alt13_2: ptr->pos=oldpos14;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept14;
alt13_3: ptr->pos=oldpos14;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept14;
alt13_4: ptr->pos=oldpos14;int oldpos15=ptr->pos;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
;goto accept15;
alt14_2: ptr->pos=oldpos15;  it=AmethystCore_anything(self ); FAILTEST(alt14_3); bind_aset(bind,16/*autovar*/,it);
...
alt15_1:;  it=Amethyst__(self ); FAILTEST(alt15_2);ame_setcut(self,Qtrue);goto alt15_2;
ame_setcut(self,Qnil);goto accept16;
alt15_2: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}  it=Amethyst_empty(self ); FAILTEST(alt15_3);
;goto accept16;
alt15_3: ptr->pos=oldpos16;goto alt13_5;
 accept16:;
  it=AmethystParser_name(self ); FAILTEST(alt13_5); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept14;
alt13_5: ptr->pos=oldpos14;  it=AmethystParser_key(self ); FAILTEST(alt13_6); bind_aset(bind,5/*_result*/,it);

;goto accept14;
alt13_6: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt13_7); bind_aset(bind,5/*_result*/,it);
...
;goto accept17;
alt16_2: ptr->pos=oldpos17;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept17;
alt16_3: ptr->pos=oldpos17;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept17;
alt16_4: ptr->pos=oldpos17;  it=AmethystCore_anything(self ); FAILTEST(alt16_5);it=rb_ary_new3(0); bind_aset(bind,17/*x*/,it);
int oldpos18; int stop2=0; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__835a,1,bind);  break;
case UC(39) ... UC(39):; int oldpos19=ptr->pos;
alt17_1:;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);ame_setcut(self,Qtrue);stop2=1;
ame_setcut(self,Qnil);goto accept19;
alt17_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt17_3);  it=AmethystCore_anything(self ); FAILTEST(alt17_3); bind_aset(bind,18/*autovar*/,it);
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; int oldpos20=ptr->pos;
alt18_1:;  it=AmethystCore_anything(self ); FAILTEST(alt18_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
...
alt19_1:;  it=AmethystCore_anything(self ); FAILTEST(alt19_2);ame_setcut(self,Qtrue);stop2=1;
ame_setcut(self,Qnil);goto accept21;
alt19_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos22=ptr->pos;
alt20_1:;  it=AmethystCore_anything(self ); FAILTEST(alt20_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__595b,1,bind); 
;goto accept22;
...
} if (stop2) goto accept18; } break2: goto alt16_5; accept18:;   it=rb_funcall(self,sy_AmethystParser_bind_lb_17_rb__8424,1,bind);  bind_aset(bind,20/*_result*/,it);
...
;goto accept17;
alt16_5: ptr->pos=oldpos17;int oldpos23=ptr->pos;
...
alt22_1:;  it=Amethyst__(self ); FAILTEST(alt22_2);ame_setcut(self,Qtrue);goto alt22_2;
ame_setcut(self,Qnil);goto accept24;
alt22_2: ptr->pos=oldpos24;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_6;}  it=Amethyst_empty(self ); FAILTEST(alt22_3);
;goto accept24;
alt22_3: ptr->pos=oldpos24;goto alt16_6;
 accept24:;
  it=AmethystParser_name(self ); FAILTEST(alt16_6); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept17;
alt16_6: ptr->pos=oldpos17;  it=AmethystParser_key(self ); FAILTEST(alt16_7); bind_aset(bind,5/*_result*/,it);
...
alt23_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept25;
alt23_2: ptr->pos=oldpos25;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept25;
alt23_3: ptr->pos=oldpos25;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept25;
alt23_4: ptr->pos=oldpos25;int oldpos26=ptr->pos;
...
alt25_1:;  it=Amethyst__(self ); FAILTEST(alt25_2);ame_setcut(self,Qtrue);goto alt25_2;
ame_setcut(self,Qnil);goto accept27;
alt25_2: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_5;}  it=Amethyst_empty(self ); FAILTEST(alt25_3);
;goto accept27;
alt25_3: ptr->pos=oldpos27;goto alt23_5;
 accept27:;
  it=AmethystParser_name(self ); FAILTEST(alt23_5); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept25;
alt23_5: ptr->pos=oldpos25;  it=AmethystParser_key(self ); FAILTEST(alt23_6); bind_aset(bind,5/*_result*/,it);
...
alt26_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept28;
alt26_2: ptr->pos=oldpos28;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept28;
alt26_3: ptr->pos=oldpos28;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept28;
alt26_4: ptr->pos=oldpos28;  it=AmethystCore_anything(self ); FAILTEST(alt26_5);int oldpos29=ptr->pos;
alt27_1:;if (strncmp(ame_curstr2(ptr),"..",2)) goto alt27_2; else ptr->pos+=2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept29;
alt27_2: ptr->pos=oldpos29;if (strncmp(ame_curstr2(ptr),".",1)) goto alt27_3; else ptr->pos+=1;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);
...
;goto accept28;
alt26_5: ptr->pos=oldpos28;int oldpos30=ptr->pos;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
;goto accept30;
alt28_2: ptr->pos=oldpos30;  it=AmethystCore_anything(self ); FAILTEST(alt28_3); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0605,1,bind); 
;goto accept30;
...
alt29_1:;  it=Amethyst__(self ); FAILTEST(alt29_2);ame_setcut(self,Qtrue);goto alt29_2;
ame_setcut(self,Qnil);goto accept31;
alt29_2: ptr->pos=oldpos31;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}  it=Amethyst_empty(self ); FAILTEST(alt29_3);
;goto accept31;
...
;goto accept28;
alt26_6: ptr->pos=oldpos28;  it=AmethystParser_key(self ); FAILTEST(alt26_7); bind_aset(bind,5/*_result*/,it);

;goto accept28;
alt26_7: ptr->pos=oldpos28;  it=AmethystCore_anything(self ); FAILTEST(alt26_8); bind_aset(bind,5/*_result*/,it);
...
alt30_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept32;
alt30_2: ptr->pos=oldpos32;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept32;
alt30_3: ptr->pos=oldpos32;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept32;
alt30_4: ptr->pos=oldpos32;  it=AmethystCore_anything(self ); FAILTEST(alt30_5); bind_aset(bind,21/*e*/,it);
...
;goto accept32;
alt30_5: ptr->pos=oldpos32;int oldpos33=ptr->pos;
...
alt32_1:;  it=Amethyst__(self ); FAILTEST(alt32_2);ame_setcut(self,Qtrue);goto alt32_2;
ame_setcut(self,Qnil);goto accept34;
alt32_2: ptr->pos=oldpos34;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt30_6;}  it=Amethyst_empty(self ); FAILTEST(alt32_3);
;goto accept34;
alt32_3: ptr->pos=oldpos34;goto alt30_6;
 accept34:;
  it=AmethystParser_name(self ); FAILTEST(alt30_6); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept32;
alt30_6: ptr->pos=oldpos32;  it=AmethystParser_key(self ); FAILTEST(alt30_7); bind_aset(bind,5/*_result*/,it);

;goto accept32;
alt30_7: ptr->pos=oldpos32;  it=AmethystCore_anything(self ); FAILTEST(alt30_8); bind_aset(bind,5/*_result*/,it);
...
alt33_1:;  it=AmethystCore_anything(self ); FAILTEST(alt33_2);  it=AmethystParser_expression(self ); FAILTEST(alt33_2); bind_aset(bind,21/*e*/,it);
...
;goto accept35;
alt33_2: ptr->pos=oldpos35;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
 it=rb_obj_clone(s__lp__84c4); arg0=it;it=rb_obj_clone(s__rp__9371); arg1=it; it=AmethystParser__args(self ,arg0,arg1); FAILTEST(alt33_3); bind_aset(bind,3/*r*/,it);
it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_4968,1,bind);  bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept35;
alt33_3: ptr->pos=oldpos35;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
 it=rb_obj_clone(s__lb__8154); arg0=it;it=rb_obj_clone(s__rb__0fbd); arg1=it; it=AmethystParser__args(self ,arg0,arg1); FAILTEST(alt33_4); bind_aset(bind,3/*r*/,it);
it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_4968,1,bind);  bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept35;
alt33_4: ptr->pos=oldpos35;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
 it=rb_obj_clone(s__le__f95b); arg0=it;it=rb_obj_clone(s__re__cbb1); arg1=it; it=AmethystParser__args(self ,arg0,arg1); FAILTEST(alt33_5); bind_aset(bind,3/*r*/,it);
it=rb_funcall(self,sy_AmethystParser_Args_lb__le__co_a_4968,1,bind);  bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept35;
alt33_5: ptr->pos=oldpos35;int oldpos36=ptr->pos;
...
alt35_1:;  it=Amethyst__(self ); FAILTEST(alt35_2);ame_setcut(self,Qtrue);goto alt35_2;
ame_setcut(self,Qnil);goto accept37;
alt35_2: ptr->pos=oldpos37;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_6;}  it=Amethyst_empty(self ); FAILTEST(alt35_3);
;goto accept37;
alt35_3: ptr->pos=oldpos37;goto alt33_6;
 accept37:;
  it=AmethystParser_name(self ); FAILTEST(alt33_6); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept35;
alt33_6: ptr->pos=oldpos35;  it=AmethystParser_key(self ); FAILTEST(alt33_7); bind_aset(bind,5/*_result*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '&':;case ')' ... '-':;case '/' ... 'Z':;case UC(92) ... 'a':;case 'c' ... 'm':;case 'o' ... UC(255):; int oldpos1=ptr->pos;
...
alt2_8: ptr->pos=oldpos3;goto fail;
 accept3:;
 break;
case UC(34) ... UC(34):; int oldpos5=ptr->pos;
...
case UC(34) ... UC(34):; int oldpos8=ptr->pos;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept8;
alt4_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt4_3);  it=AmethystCore_anything(self ); FAILTEST(alt4_3); bind_aset(bind,6/*autovar*/,it);
...
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept10;
alt6_2: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}int oldpos11=ptr->pos;
...
alt3_8: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
case UC(39) ... UC(39):; int oldpos12=ptr->pos;
...
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);stop2=1;
ame_setcut(self,Qnil);goto accept15;
alt9_2: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt9_3);  it=AmethystCore_anything(self ); FAILTEST(alt9_3); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__6f56,1,bind); 
;goto accept15;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):; int oldpos16=ptr->pos;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__6f56,1,bind);  break;
case UC(39) ... UC(39):; int oldpos17=ptr->pos;
alt11_1:;  it=AmethystCore_anything(self ); FAILTEST(alt11_2);ame_setcut(self,Qtrue);stop2=1;
ame_setcut(self,Qnil);goto accept17;
alt11_2: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos18=ptr->pos;
...
} x=1; goto accept23;  reject6: x=0; accept23: it=Qnil; ptr->pos=oldpos23; if (x==0) goto alt15_4;int oldpos24=ptr->pos;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('9db1a921fe39922421ec890d415d3a0e')");}
