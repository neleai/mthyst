...
;goto accept3;
alt2_2: ptr->pos=oldpos3;if (cut2) goto break1;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,3/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,4/*o*/,it);
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt2_2; break;
...
;goto accept7;
alt6_2: ptr->pos=oldpos7;if (cut6) goto break1;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
;goto accept10;
alt9_2: ptr->pos=oldpos10;if (cut9) goto break1;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt11_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt11_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt14_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt14_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
;goto accept19;
alt17_2: ptr->pos=oldpos19;if (cut17) goto break2;  it=Amethyst_empty(self ); FAILTEST(alt17_3);  it=AmethystCore_anything(self ); FAILTEST(alt17_3); bind_aset(bind,18/*autovar*/,it);
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt21_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt21_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt24_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt24_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
alt27_1:;if (ame_curstr2(ptr)[0]=='.'&&ame_curstr2(ptr)[1]=='.')  ptr->pos+=2; else goto alt27_2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);

;goto accept29;
alt27_2: ptr->pos=oldpos29;if (ame_curstr2(ptr)[0]=='.')  ptr->pos+=1; else goto alt27_3;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt28_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt28_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
case '<' ... '<':;   it=AmethystCore_anything(self ); FAILTEST(alt30_5);if (ame_curstr2(ptr)[0]=='<')  ptr->pos+=1; else goto alt30_5; break;
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt31_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt31_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt34_2);if (ame_curstr2(ptr)[0]=='@')  ptr->pos+=1; else goto alt34_2; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('a3c26a05b447277e87fb1aa11b185d3d')");}
