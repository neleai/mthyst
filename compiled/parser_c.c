...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,1/*n*/,it); char chr1=*ame_curstr(self);  switch(chr1){case 34 ... 34:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2(")");
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
 break;case 39 ... 39:; int oldpos7=ame_getpos(self);
...
ISET(cut,Qnil);goto accept6;
 ...
 accept6:;
 break;case 46 ... 46:; int oldpos13=ame_getpos(self);
...
ISET(cut,Qnil);goto accept11;
 ...
 accept11:;
 break;case 58 ... 58:; int oldpos17=ame_getpos(self);
...
ISET(cut,Qnil);goto accept15;
 ...
 accept15:;
 break;case 96 ... 96:; int oldpos21=ame_getpos(self);
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversionparser('a09b22d51e51c9aaa844d007d1877651')");}
