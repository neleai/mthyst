...
static VALUE sy_AmethystParser_Apply_lb__dq_c_eb18;
static VALUE sy_AmethystParser_Apply_lb__dq_m_90ac;
...
static VALUE sy_AmethystParser_bind_lb_17_rb__3a5a;
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; int oldpos1=ptr->pos;
alt1_1:;  it=Amethyst_empty(self ); FAILTEST(alt1_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(39):;case ')' ... UC(255):; goto alt1_2; break;
...
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_2;}  it=Amethyst_empty(self ); FAILTEST(alt3_3);
;goto accept3;
...
;goto accept2;
alt2_2: ptr->pos=oldpos3;it=rb_ary_new3(0); bind_aset(bind,9/*_result*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ',':;case '.' ... '/':;case ':' ... '@':;case '[' ... UC(255):; it=rb_obj_clone(s__lt__524a); bind_aset(bind,0/*s*/,it);
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos2=ptr->pos;
alt1_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt1_2;
;goto accept1;
alt1_2: ptr->pos=oldpos2;  it=Amethyst_empty(self ); FAILTEST(alt1_3);  it=AmethystCore_anything(self ); FAILTEST(alt1_3); bind_aset(bind,2/*autovar*/,it);
...
alt2_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt2_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt2_3);  it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept2;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos4=ptr->pos;
alt3_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt3_2;
;goto accept3;
alt3_2: ptr->pos=oldpos4;int oldpos5=ptr->pos;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept4;
alt4_2: ptr->pos=oldpos5;  it=Amethyst_empty(self ); FAILTEST(alt4_3);
;goto accept4;
...
alt5_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt5_2: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}int oldpos7=ptr->pos;
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept6;
alt6_2: ptr->pos=oldpos7;  it=Amethyst_empty(self ); FAILTEST(alt6_3);
;goto accept6;
...
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);
 break;
case '-' ... '-':;case '0' ... '9':; it=rb_ary_new3(0); bind_aset(bind,8/*autovar*/,it);
int oldpos8=ptr->pos;
alt7_1:;  it=Amethyst_number(self ); FAILTEST(alt7_2); bind_aset(bind,9/*autovar*/,it);
it=bind_aget(bind,9/*autovar*/); bind_aset(bind,10/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... UC(255):; it=bind_aget(bind,10/*autovar*/); bind_aset(bind,11/*autovar*/,it);
int oldpos9=ptr->pos;
alt8_1:;it=bind_aget(bind,11/*autovar*/); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__9707,1,bind); goto alt8_2;
;goto accept8;
alt8_2: ptr->pos=oldpos9;it=bind_aget(bind,11/*autovar*/); bind_aset(bind,13/*num*/,it);

;goto accept8;
alt8_3: ptr->pos=oldpos9;goto alt7_2;
 accept8:;
 break;
case '.' ... '.':; it=bind_aget(bind,10/*autovar*/); bind_aset(bind,14/*autovar*/,it);
int oldpos10=ptr->pos;
alt9_1:;it=bind_aget(bind,14/*autovar*/); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__9707,1,bind);   it=AmethystCore_anything(self ); FAILTEST(alt9_2);int oldpos11=ptr->pos;
alt10_1:;if (strncmp(ame_curstr2(ptr),"..",2)) goto alt10_2; else ptr->pos+=2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,15/*autovar*/,it);

;goto accept10;
alt10_2: ptr->pos=oldpos11;if (strncmp(ame_curstr2(ptr),".",1)) goto alt10_3; else ptr->pos+=1;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,15/*autovar*/,it);

;goto accept10;
alt10_3: ptr->pos=oldpos11;goto alt9_2;
 accept10:;
it=rb_funcall(self,sy_AmethystParser__append_lp__0a14,1,bind); switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ',':;case '.' ... '/':;case ':' ... UC(255):; goto alt9_2; break;
case '-' ... '-':;case '0' ... '9':;   it=Amethyst_number(self ); FAILTEST(alt9_2); bind_aset(bind,16/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__e567,1,bind); it=bind_aget(bind,8/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_bind_lb_17_rb__3a5a,1,bind);  bind_aset(bind,13/*num*/,it);

;goto accept9;
alt9_2: ptr->pos=oldpos10;it=bind_aget(bind,14/*autovar*/); bind_aset(bind,13/*num*/,it);

;goto accept9;
alt9_3: ptr->pos=oldpos10;goto alt7_2;
 accept9:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_m_90ac,1,bind);  bind_aset(bind,7/*_result*/,it);

;goto accept7;
alt7_2: ptr->pos=oldpos8;it=rb_obj_clone(s__lt__524a); bind_aset(bind,0/*s*/,it);
...
int oldpos12; while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos13=ptr->pos;
alt11_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt11_2;
;goto accept11;
alt11_2: ptr->pos=oldpos13;  it=Amethyst_empty(self ); FAILTEST(alt11_3);  it=AmethystCore_anything(self ); FAILTEST(alt11_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept11;
alt11_3: ptr->pos=oldpos13;goto break2;
 accept11:;
 break;
case '>' ... '>':; int oldpos14=ptr->pos;
alt12_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt12_2: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt12_3);  it=AmethystCore_anything(self ); FAILTEST(alt12_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept12;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos15=ptr->pos;
alt13_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt13_2;
;goto accept13;
alt13_2: ptr->pos=oldpos15;int oldpos16=ptr->pos;
alt14_1:;  it=AmethystCore_anything(self ); FAILTEST(alt14_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept14;
alt14_2: ptr->pos=oldpos16;  it=Amethyst_empty(self ); FAILTEST(alt14_3);
;goto accept14;
alt14_3: ptr->pos=oldpos16;goto alt13_3;
 accept14:;
  it=AmethystCore_anything(self ); FAILTEST(alt13_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept13;
alt13_3: ptr->pos=oldpos15;goto break2;
 accept13:;
 break;
case '>' ... '>':; int oldpos17=ptr->pos;
alt15_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt15_2: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}int oldpos18=ptr->pos;
alt16_1:;  it=AmethystCore_anything(self ); FAILTEST(alt16_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept16;
alt16_2: ptr->pos=oldpos18;  it=Amethyst_empty(self ); FAILTEST(alt16_3);
;goto accept16;
alt16_3: ptr->pos=oldpos18;goto alt15_3;
 accept16:;
  it=AmethystCore_anything(self ); FAILTEST(alt15_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept15;
alt15_3: ptr->pos=oldpos17;goto break2;
 accept15:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){oldpos12=ptr->pos;goto break2;} } break2: ame_setstop(self,Qnil); ptr->pos=oldpos12; it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);
...
alt7_3: ptr->pos=oldpos8;goto fail;
 accept7:;
 break;
case 'A' ... 'Z':; int oldpos19=ptr->pos;
alt17_1:;  it=AmethystParser_className(self ); FAILTEST(alt17_2); bind_aset(bind,18/*clas*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt17_2); break;
case ':' ... ':':; int oldpos20=ptr->pos;
alt18_1:;  it=AmethystCore_anything(self ); FAILTEST(alt18_2);if (strncmp(ame_curstr2(ptr),":",1)) goto alt18_2; else ptr->pos+=1;ame_setcut(self,Qtrue);goto alt18_2;
ame_setcut(self,Qnil);goto accept18;
alt18_2: ptr->pos=oldpos20;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_2;}  it=Amethyst_empty(self ); FAILTEST(alt18_3);
;goto accept18;
alt18_3: ptr->pos=oldpos20;goto alt17_2;
 accept18:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_c_eb18,1,bind);  bind_aset(bind,7/*_result*/,it);

;goto accept17;
alt17_2: ptr->pos=oldpos19;it=rb_obj_clone(s__lt__524a); bind_aset(bind,0/*s*/,it);
 it=bind_aget(bind,0/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt17_3);it=bind_aget(bind,0/*s*/);it=rb_ary_new3(0); bind_aset(bind,1/*x*/,it);
int oldpos21; while(1){oldpos21=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos22=ptr->pos;
alt19_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt19_2;
;goto accept19;
alt19_2: ptr->pos=oldpos22;  it=Amethyst_empty(self ); FAILTEST(alt19_3);  it=AmethystCore_anything(self ); FAILTEST(alt19_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept19;
...
alt20_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt20_2: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}  it=Amethyst_empty(self ); FAILTEST(alt20_3);  it=AmethystCore_anything(self ); FAILTEST(alt20_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept20;
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos24=ptr->pos;
alt21_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt21_2;
;goto accept21;
alt21_2: ptr->pos=oldpos24;int oldpos25=ptr->pos;
alt22_1:;  it=AmethystCore_anything(self ); FAILTEST(alt22_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept22;
alt22_2: ptr->pos=oldpos25;  it=Amethyst_empty(self ); FAILTEST(alt22_3);
;goto accept22;
alt22_3: ptr->pos=oldpos25;goto alt21_3;
 accept22:;
  it=AmethystCore_anything(self ); FAILTEST(alt21_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept21;
alt21_3: ptr->pos=oldpos24;goto break3;
 accept21:;
 break;
case '>' ... '>':; int oldpos26=ptr->pos;
alt23_1:;it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt23_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept23;
alt23_2: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}int oldpos27=ptr->pos;
alt24_1:;  it=AmethystCore_anything(self ); FAILTEST(alt24_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0d6a,1,bind); 
;goto accept24;
alt24_2: ptr->pos=oldpos27;  it=Amethyst_empty(self ); FAILTEST(alt24_3);
;goto accept24;
alt24_3: ptr->pos=oldpos27;goto alt23_3;
 accept24:;
  it=AmethystCore_anything(self ); FAILTEST(alt23_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); 
;goto accept23;
alt23_3: ptr->pos=oldpos26;goto break3;
 accept23:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){oldpos21=ptr->pos;goto break3;} } break3: ame_setstop(self,Qnil); ptr->pos=oldpos21; it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);

;goto accept17;
alt17_3: ptr->pos=oldpos19;goto fail;
 accept17:;
 break;
}
return it;
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '`':;case 'b' ... UC(255):; int oldpos2=ptr->pos;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); int oldpos6; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break3);  it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
...
alt4_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}  it=Amethyst_empty(self ); FAILTEST(alt4_3);
;goto accept4;
...
alt5_1:;it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos9=ptr->pos;
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);if (strncmp(ame_curstr2(ptr),"methyst",7)) goto alt6_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt6_2;
ame_setcut(self,Qnil);goto accept6;
alt6_2: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_2;}  it=Amethyst_empty(self ); FAILTEST(alt6_3);
;goto accept6;
alt6_3: ptr->pos=oldpos9;goto alt5_2;
 accept6:;
  it=AmethystCore_anything(self ); FAILTEST(alt5_2); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); int oldpos10; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break4);  it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
case 'a' ... 'a':; int oldpos11=ptr->pos;
alt7_1:;  it=AmethystCore_anything(self ); FAILTEST(alt7_2);if (strncmp(ame_curstr2(ptr),"methyst",7)) goto alt7_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt7_2;
ame_setcut(self,Qnil);goto accept7;
alt7_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break4;}  it=Amethyst_empty(self ); FAILTEST(alt7_3);
;goto accept7;
...
;goto accept5;
alt5_2: ptr->pos=oldpos8;  it=AmethystParser_grammar(self ); FAILTEST(alt5_3); bind_aset(bind,5/*autovar*/,it);
...
alt2_1:;  it=AmethystParser_className(self ); FAILTEST(alt2_2); bind_aset(bind,0/*name*/,it);
it=rb_funcall(self,sy_AmethystParser_Result_lb__le__ae0e,1,bind);  bind_aset(bind,1/*_result*/,it);

;goto accept2;
alt2_2: ptr->pos=oldpos2;  it=AmethystParser_name(self ); FAILTEST(alt2_3); bind_aset(bind,0/*name*/,it);
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;if (strncmp(ame_curstr2(ptr),"@",1)) goto alt1_3; else ptr->pos+=1;switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_3; break;
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ')':;case ',' ... '9':;case ';' ... '<':;case '>' ... '>':;case '@' ... 'Z':;case UC(92) ... UC(255):; goto break1; break;
...
it=rb_funcall(self,sy_AmethystParser_Many_lb_bin_33ac,1,bind);  bind_aset(bind,0/*from*/,it);
 break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(break1);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '?':;case '[' ... '^':;case '`' ... '`':;case '|' ... UC(255):; goto break1; break;
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos2=ptr->pos;
alt1_1:;  it=AmethystCore_anything(self ); FAILTEST(alt1_2);if (strncmp(ame_curstr2(ptr),"]",1)) goto alt1_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);

;goto accept1;
alt1_2: ptr->pos=oldpos2;  it=Amethyst_empty(self ); FAILTEST(alt1_3); bind_aset(bind,4/*append*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos3=ptr->pos;
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr2(ptr),"]",1)) goto alt2_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);

;goto accept2;
alt2_2: ptr->pos=oldpos3;  it=Amethyst_empty(self ); FAILTEST(alt2_3); bind_aset(bind,4/*append*/,it);
...
case '=' ... '=':;   it=AmethystCore_anything(self ); FAILTEST(break1);if (strncmp(ame_curstr2(ptr),">",1)) goto break1; else ptr->pos+=1;  it=AmethystParser_term(self ); FAILTEST(break1); bind_aset(bind,2/*e*/,it);
...
alt3_1:;  it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2;
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt3_3);
;goto accept3;
alt3_3: ptr->pos=oldpos4;goto break1;
 accept3:;
...
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr2(ptr),"]",1)) goto alt4_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);

;goto accept4;
alt4_2: ptr->pos=oldpos5;  it=Amethyst_empty(self ); FAILTEST(alt4_3); bind_aset(bind,4/*append*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos6=ptr->pos;
alt5_1:;  it=AmethystCore_anything(self ); FAILTEST(alt5_2);if (strncmp(ame_curstr2(ptr),"]",1)) goto alt5_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);

;goto accept5;
alt5_2: ptr->pos=oldpos6;  it=Amethyst_empty(self ); FAILTEST(alt5_3); bind_aset(bind,4/*append*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'z':;case '|' ... UC(255):; it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
int oldpos2=ptr->pos;
alt2_1:;it=bind_aget(bind,2/*autovar*/);goto alt2_2;
;goto accept2;
...
int oldpos3=ptr->pos;
alt3_1:;it=bind_aget(bind,5/*autovar*/); bind_aset(bind,3/*neg*/,it);
...
;goto accept3;
alt3_2: ptr->pos=oldpos3;it=bind_aget(bind,5/*autovar*/); bind_aset(bind,3/*neg*/,it);
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '#':;case '%' ... '&':;case '*' ... '-':;case '/' ... '/':;case ';' ... '?':;case 'A' ... 'Z':;case UC(92) ... UC(92):;case '^' ... '^':;case '|' ... '|':;case '~' ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos1=ptr->pos;
...
alt2_3: ptr->pos=oldpos2;goto alt1_5;
 accept2:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt1_5); break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos3=ptr->pos;
alt3_1:;  it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2;
ame_setcut(self,Qnil);goto accept3;
...
alt3_3: ptr->pos=oldpos3;goto alt1_5;
 accept3:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_5; break;
...
;goto accept1;
alt1_5: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_6); bind_aset(bind,5/*_result*/,it);
...
int oldpos5; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos6=ptr->pos;
...
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept6;
...
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
...
alt11_3: ptr->pos=oldpos12;goto alt4_6;
 accept11:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt4_6); break;
...
alt12_3: ptr->pos=oldpos13;goto alt4_6;
 accept12:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt4_6; break;
...
alt14_4: ptr->pos=oldpos15;goto alt13_5;
 accept14:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt13_5); break;
...
alt15_3: ptr->pos=oldpos16;goto alt13_5;
 accept15:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt13_5; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt13_5); bind_aset(bind,9/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept13;
alt13_5: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt13_6); bind_aset(bind,5/*_result*/,it);
...
int oldpos18; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__835a,1,bind);  break;
case UC(39) ... UC(39):; int oldpos19=ptr->pos;
alt17_1:;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
...
alt19_1:;  it=AmethystCore_anything(self ); FAILTEST(alt19_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
...
alt21_3: ptr->pos=oldpos23;goto alt16_6;
 accept21:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt16_6); break;
...
alt22_3: ptr->pos=oldpos24;goto alt16_6;
 accept22:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt16_6; break;
...
alt24_3: ptr->pos=oldpos26;goto alt23_5;
 accept24:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt23_5); break;
...
alt25_3: ptr->pos=oldpos27;goto alt23_5;
 accept25:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt23_5; break;
...
alt28_4: ptr->pos=oldpos30;goto alt26_6;
 accept28:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt26_6); break;
...
alt29_3: ptr->pos=oldpos31;goto alt26_6;
 accept29:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt26_6; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt26_6); bind_aset(bind,9/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept26;
alt26_6: ptr->pos=oldpos28;  it=AmethystCore_anything(self ); FAILTEST(alt26_7); bind_aset(bind,5/*_result*/,it);
...
alt31_3: ptr->pos=oldpos33;goto alt30_6;
 accept31:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt30_6); break;
...
alt32_3: ptr->pos=oldpos34;goto alt30_6;
 accept32:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt30_6; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt30_6); bind_aset(bind,9/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept30;
alt30_6: ptr->pos=oldpos32;  it=AmethystCore_anything(self ); FAILTEST(alt30_7); bind_aset(bind,5/*_result*/,it);
...
alt33_1:;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept33;
alt33_2: ptr->pos=oldpos35;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept33;
alt33_3: ptr->pos=oldpos35;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept33;
alt33_4: ptr->pos=oldpos35;int oldpos36=ptr->pos;
...
alt34_3: ptr->pos=oldpos36;goto alt33_5;
 accept34:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt33_5); break;
...
alt35_2: ptr->pos=oldpos37;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_5;}  it=Amethyst_empty(self ); FAILTEST(alt35_3);
;goto accept35;
alt35_3: ptr->pos=oldpos37;goto alt33_5;
 accept35:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt33_5; break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':;   it=AmethystParser_name(self ); FAILTEST(alt33_5); bind_aset(bind,9/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_AmethystParser__append_lp__653e,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,5/*_result*/,it);

;goto accept33;
alt33_5: ptr->pos=oldpos35;  it=AmethystParser_key(self ); FAILTEST(alt33_6); bind_aset(bind,5/*_result*/,it);

;goto accept33;
alt33_6: ptr->pos=oldpos35;  it=AmethystCore_anything(self ); FAILTEST(alt33_7); bind_aset(bind,5/*_result*/,it);
...
alt36_1:;  it=AmethystCore_anything(self ); FAILTEST(alt36_2);  it=AmethystParser_expression(self ); FAILTEST(alt36_2); bind_aset(bind,21/*e*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '_':;case 'a' ... UC(255):; goto alt36_2; break;
...
;goto accept36;
alt36_2: ptr->pos=oldpos38;it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
;goto accept36;
alt36_3: ptr->pos=oldpos38;it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
;goto accept36;
alt36_4: ptr->pos=oldpos38;it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
;goto accept36;
alt36_5: ptr->pos=oldpos38;int oldpos39=ptr->pos;
alt37_1:;  it=Amethyst_spaces(self ); FAILTEST(alt37_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt37_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt37_2);if (strncmp(ame_curstr2(ptr),"@",1)) goto alt37_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind); 
;goto accept37;
alt37_2: ptr->pos=oldpos39;  it=Amethyst_empty(self ); FAILTEST(alt37_3);
;goto accept37;
alt37_3: ptr->pos=oldpos39;goto alt36_6;
 accept37:;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt36_6); break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos40=ptr->pos;
alt38_1:;  it=Amethyst__(self ); FAILTEST(alt38_2);ame_setcut(self,Qtrue);goto alt38_2;
ame_setcut(self,Qnil);goto accept38;
alt38_2: ptr->pos=oldpos40;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt36_6;}  it=Amethyst_empty(self ); FAILTEST(alt38_3);
;goto accept38;
alt38_3: ptr->pos=oldpos40;goto alt36_6;
 accept38:;
 break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt36_6; break;
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '&':;case ')' ... ',':;case '/' ... '?':;case UC(92) ... '^':;case '`' ... '`':;case '|' ... UC(255):; int oldpos1=ptr->pos;
...
} x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ptr->pos=oldpos2; if (x==0) goto alt1_3;  it=Amethyst_empty(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept1;
alt1_3: ptr->pos=oldpos1;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr2(ptr),"ested(",6)) goto alt2_2; else ptr->pos+=6;  it=AmethystParser_expression(self ); FAILTEST(alt2_2); bind_aset(bind,3/*expr*/,it);
...
;goto accept3;
alt2_5: ptr->pos=oldpos3;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt2_6);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt2_6); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept3;
alt2_6: ptr->pos=oldpos3;goto fail;
 accept3:;
 break;
...
} x=1; goto accept6;  reject3: x=0; accept6: it=Qnil; ptr->pos=oldpos6; if (x==0) goto alt3_3;  it=Amethyst_empty(self ); FAILTEST(alt3_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept5;
alt3_3: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt3_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
int oldpos7; while(1){oldpos7=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1);  it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept7;
alt4_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}  it=Amethyst_empty(self ); FAILTEST(alt4_3);  it=AmethystCore_anything(self ); FAILTEST(alt4_3); bind_aset(bind,5/*autovar*/,it);
...
alt5_1:;  it=AmethystCore_anything(self ); FAILTEST(alt5_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
...
alt7_1:;  it=AmethystCore_anything(self ); FAILTEST(alt7_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept10;
...
alt7_3: ptr->pos=oldpos11;goto alt6_3;
 accept10:;
  it=AmethystCore_anything(self ); FAILTEST(alt6_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind); 
;goto accept9;
...
} if (ame_getstop(self)!=Qnil){oldpos7=ptr->pos;goto break1;} } break1: ame_setstop(self,Qnil); ptr->pos=oldpos7; it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__1e8d,1,bind);  bind_aset(bind,8/*_result*/,it);
...
;goto accept5;
alt3_4: ptr->pos=oldpos5;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt3_5);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt3_5); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept5;
alt3_5: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
...
;goto accept11;
alt8_2: ptr->pos=oldpos12;int oldpos13=ptr->pos;
...
} x=1; goto accept12;  reject4: x=0; accept12: it=Qnil; ptr->pos=oldpos13; if (x==0) goto alt8_3;  it=Amethyst_empty(self ); FAILTEST(alt8_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept11;
alt8_3: ptr->pos=oldpos12;  it=AmethystCore_anything(self ); FAILTEST(alt8_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
int oldpos14; while(1){oldpos14=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(39) ... UC(39):; int oldpos15=ptr->pos;
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue);
ame_setcut(self,Qnil);goto accept13;
alt9_2: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt9_3);  it=AmethystCore_anything(self ); FAILTEST(alt9_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind); 
;goto accept13;
...
alt12_1:;  it=AmethystCore_anything(self ); FAILTEST(alt12_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind); 
;goto accept16;
...
alt12_3: ptr->pos=oldpos18;goto alt11_3;
 accept16:;
  it=AmethystCore_anything(self ); FAILTEST(alt11_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind); 
;goto accept15;
...
} if (ame_getstop(self)!=Qnil){oldpos14=ptr->pos;goto break2;} } break2: ame_setstop(self,Qnil); ptr->pos=oldpos14; it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__1e8d,1,bind);  bind_aset(bind,8/*_result*/,it);
it=bind_aget(bind,8/*_result*/); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_s_319b,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept11;
alt8_4: ptr->pos=oldpos12;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_5);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt8_5); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept11;
alt8_5: ptr->pos=oldpos12;goto fail;
 accept11:;
 break;
...
;goto accept17;
alt13_2: ptr->pos=oldpos19;int oldpos20=ptr->pos;
...
} x=1; goto accept18;  reject5: x=0; accept18: it=Qnil; ptr->pos=oldpos20; if (x==0) goto alt13_3;  it=Amethyst_empty(self ); FAILTEST(alt13_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept17;
alt13_3: ptr->pos=oldpos19;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt13_4);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt13_4); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept17;
alt13_4: ptr->pos=oldpos19;  it=AmethystCore_anything(self ); FAILTEST(alt13_5);  it=AmethystParser_expression(self ); FAILTEST(alt13_5); bind_aset(bind,9/*x*/,it);
  it=Amethyst_spaces(self ); FAILTEST(alt13_5);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '(':;case '*' ... UC(255):; goto alt13_5; break;
case ')' ... ')':;   it=AmethystCore_anything(self ); FAILTEST(alt13_5); break;
}switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt13_5);it=bind_aget(bind,9/*x*/); bind_aset(bind,0/*_result*/,it);
 break;
case '[' ... '[':; int oldpos21=ptr->pos;
alt14_1:;  it=AmethystCore_anything(self ); FAILTEST(alt14_2);if (strncmp(ame_curstr2(ptr),"]",1)) goto alt14_2; else ptr->pos+=1;it=bind_aget(bind,9/*x*/); bind_aset(bind,10/*ors*/,it);
...
;goto accept19;
alt14_2: ptr->pos=oldpos21;  it=Amethyst_empty(self ); FAILTEST(alt14_3);it=bind_aget(bind,9/*x*/); bind_aset(bind,0/*_result*/,it);

;goto accept19;
alt14_3: ptr->pos=oldpos21;goto alt13_5;
 accept19:;
 break;
}
;goto accept17;
alt13_5: ptr->pos=oldpos19;goto fail;
 accept17:;
 break;
case '-' ... '-':;case '{' ... '{':; int oldpos22=ptr->pos;
alt15_1:;  it=AmethystParser_cases(self ); FAILTEST(alt15_2); bind_aset(bind,0/*_result*/,it);

;goto accept20;
alt15_2: ptr->pos=oldpos22;int oldpos23=ptr->pos;
...
} x=1; goto accept21;  reject6: x=0; accept21: it=Qnil; ptr->pos=oldpos23; if (x==0) goto alt15_3;  it=Amethyst_empty(self ); FAILTEST(alt15_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept20;
alt15_3: ptr->pos=oldpos22;  it=AmethystParser_host_expr(self ); FAILTEST(alt15_4); bind_aset(bind,0/*_result*/,it);

;goto accept20;
alt15_4: ptr->pos=oldpos22;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt15_5);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt15_5); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept20;
alt15_5: ptr->pos=oldpos22;goto fail;
 accept20:;
 break;
case '.' ... '.':; int oldpos24=ptr->pos;
alt16_1:;  it=AmethystParser_cases(self ); FAILTEST(alt16_2); bind_aset(bind,0/*_result*/,it);

;goto accept22;
alt16_2: ptr->pos=oldpos24;int oldpos25=ptr->pos;
...
} x=1; goto accept23;  reject7: x=0; accept23: it=Qnil; ptr->pos=oldpos25; if (x==0) goto alt16_3;int oldpos26=ptr->pos;
alt17_1:;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);
;goto accept24;
alt17_2: ptr->pos=oldpos26;  it=Amethyst_empty(self ); FAILTEST(alt17_3);
;goto accept24;
alt17_3: ptr->pos=oldpos26;goto alt16_3;
 accept24:;
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept22;
alt16_3: ptr->pos=oldpos24;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt16_4);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt16_4); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept22;
alt16_4: ptr->pos=oldpos24;goto fail;
 accept22:;
 break;
case '@' ... '@':; int oldpos27=ptr->pos;
alt18_1:;  it=AmethystParser_cases(self ); FAILTEST(alt18_2); bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt18_2: ptr->pos=oldpos27;int oldpos28=ptr->pos;
...
} x=1; goto accept26;  reject8: x=0; accept26: it=Qnil; ptr->pos=oldpos28; if (x==0) goto alt18_3;  it=Amethyst_empty(self ); FAILTEST(alt18_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt18_3: ptr->pos=oldpos27;  it=AmethystParser_key(self ); FAILTEST(alt18_4); bind_aset(bind,12/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_Act_lb_bind_23ab,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt18_4: ptr->pos=oldpos27;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt18_5);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt18_5); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept25;
alt18_5: ptr->pos=oldpos27;goto fail;
 accept25:;
 break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'a':;case 'c' ... 'm':;case 'o' ... 'z':; int oldpos29=ptr->pos;
alt19_1:;  it=AmethystParser_cases(self ); FAILTEST(alt19_2); bind_aset(bind,0/*_result*/,it);

;goto accept27;
alt19_2: ptr->pos=oldpos29;  it=AmethystParser_call(self ); FAILTEST(alt19_3); bind_aset(bind,0/*_result*/,it);

;goto accept27;
alt19_3: ptr->pos=oldpos29;int oldpos30=ptr->pos;
...
} x=1; goto accept28;  reject9: x=0; accept28: it=Qnil; ptr->pos=oldpos30; if (x==0) goto alt19_4;  it=Amethyst_empty(self ); FAILTEST(alt19_4);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept27;
alt19_4: ptr->pos=oldpos29;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt19_5);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt19_5); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept27;
alt19_5: ptr->pos=oldpos29;goto fail;
 accept27:;
 break;
case '[' ... '[':; int oldpos31=ptr->pos;
alt20_1:;  it=AmethystParser_cases(self ); FAILTEST(alt20_2); bind_aset(bind,0/*_result*/,it);

;goto accept29;
alt20_2: ptr->pos=oldpos31;int oldpos32=ptr->pos;
...
} x=1; goto accept30;  reject10: x=0; accept30: it=Qnil; ptr->pos=oldpos32; if (x==0) goto alt20_3;  it=Amethyst_empty(self ); FAILTEST(alt20_3);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept29;
alt20_3: ptr->pos=oldpos31;  it=AmethystCore_anything(self ); FAILTEST(alt20_4);  it=AmethystParser_expression(self ); FAILTEST(alt20_4); bind_aset(bind,13/*e*/,it);
  it=Amethyst_spaces(self ); FAILTEST(alt20_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(92):;case '^' ... UC(255):; goto alt20_4; break;
case ']' ... ']':;   it=AmethystCore_anything(self ); FAILTEST(alt20_4); break;
}it=rb_funcall(self,sy_AmethystParser_Enter_lb_Ap_57b6,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept29;
alt20_4: ptr->pos=oldpos31;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
;goto accept29;
alt20_5: ptr->pos=oldpos31;goto fail;
 accept29:;
 break;
case 'b' ... 'b':; int oldpos33=ptr->pos;
alt21_1:;  it=AmethystCore_anything(self ); FAILTEST(alt21_2);if (strncmp(ame_curstr2(ptr),"reak",4)) goto alt21_2; else ptr->pos+=4;it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb__3505,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt21_2: ptr->pos=oldpos33;  it=AmethystParser_cases(self ); FAILTEST(alt21_3); bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt21_3: ptr->pos=oldpos33;  it=AmethystParser_call(self ); FAILTEST(alt21_4); bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt21_4: ptr->pos=oldpos33;int oldpos34=ptr->pos;
 switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '-':;case '/' ... '9':;case ';' ... UC(255):; goto reject11; break;
case '.' ... '.':;case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(reject11); break;
} x=1; goto accept32;  reject11: x=0; accept32: it=Qnil; ptr->pos=oldpos34; if (x==0) goto alt21_5;  it=Amethyst_empty(self ); FAILTEST(alt21_5);it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt21_5: ptr->pos=oldpos33;it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
 it=bind_aget(bind,1/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt21_6);it=bind_aget(bind,1/*s*/);  it=Amethyst_line(self ); FAILTEST(alt21_6); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Comment_lb__b447,1,bind);  bind_aset(bind,0/*_result*/,it);

;goto accept31;
alt21_6: ptr->pos=oldpos33;goto fail;
 accept31:;
 break;
}
return it;
...
sy_AmethystParser_Apply_lb__dq_c_eb18=rb_intern("AmethystParser_Apply_lb__dq_c_eb18");
sy_AmethystParser_Apply_lb__dq_m_90ac=rb_intern("AmethystParser_Apply_lb__dq_m_90ac");
...
sy_AmethystParser_bind_lb_17_rb__3a5a=rb_intern("AmethystParser_bind_lb_17_rb__3a5a");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
                    rb_eval_string("testversionparser('6b548cec60e0d06241c7abb75ae51638')");}
