...
static VALUE sy_AmethystParser_a_eq_autova_3ea7;
static VALUE sy_AmethystParser_a_eq_autova_a9cb;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__4297,1,bind); it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos5=ptr->pos;int cut5=0;
...
goto alt6_2;
;goto accept7;
alt6_2: ptr->pos=oldpos7;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__a474,1,bind); 
;goto accept7;
alt6_3: ptr->pos=oldpos7;goto break1;
 accept7:;
 break;
case '>' ... '>':; it=rb_obj_clone(s__gt__cedf); bind_aset(bind,13/*s*/,it);
...
goto alt7_2;
;goto accept8;
alt7_2: ptr->pos=oldpos8;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,9/*_result*/,it);
it=bind_aget(bind,9/*_result*/); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__50ed,1,bind);   it=AmethystCore_anything(self ); FAILTEST(alt7_3); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__a474,1,bind); 
;goto accept8;
...
it=rb_funcall(self,sy_AmethystParser_a_eq_autova_a9cb,1,bind);  bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser_a_eq_autova_3ea7,1,bind);  bind_aset(bind,12/*_result*/,it);
...
sy_AmethystParser_a_eq_autova_3ea7=rb_intern("AmethystParser_a_eq_autova_3ea7");
sy_AmethystParser_a_eq_autova_a9cb=rb_intern("AmethystParser_a_eq_autova_a9cb");
