...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3,it); it=CALL(addargs_AmethystParsercb_3,1,bind); 
...
return it;
fail: return failobj; }
VALUE AmethystParser_args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=rb_ary_new2(12); rb_ary_store(bind,2,a0);rb_ary_store(bind,0,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
return it;
fail: return failobj; }
VALUE AmethystParser_atomicHostExpr(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(6);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
return it;
fail: return failobj; }
VALUE AmethystParser_inlineHostExpr(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(9);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_2;}
 ...
 rb_ary_store(bind,0,it); int oldpos3=ame_getpos(self);
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystParser_spaces(self ); FAILTEST(alt1_3);char chr1=*ame_curstr(self);  switch(chr1){case 38:;  it=rb_str_new2("&"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it);  break;case 126:;  it=rb_str_new2("~"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it);  break;default: goto alt1_3;}  it=AmethystParser_prefixed(self ); FAILTEST(alt1_3);
...
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_4;}
   it=AmethystParser_spaces(self ); FAILTEST(alt2_3); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_3);int oldpos3=ame_getpos(self);
 ...
 rb_ary_store(bind,8,it); it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=CALL(prefixed_AmethystParsercb_5,1,bind); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos3); if (x==0) goto alt2_3;int oldpos4=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_3;}
   it=AmethystParser_spaces(self ); FAILTEST(alt3_2); it=rb_str_new2("."); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt3_2); 
...
alt5_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,10,it); it=CALL(prefixed_AmethystParsercb_7,1,bind);  break;default: goto alt5_2;} break;case 91:; char chr4=*ame_curstr(self);  switch(chr4){case 91:;  it=rb_str_new2("["); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_2);  it=AmethystParser_expression(self ); FAILTEST(alt5_2);
 rb_ary_store(bind,10,it); it=CALL(prefixed_AmethystParsercb_8,1,bind);   it=AmethystParser_spaces(self ); FAILTEST(alt5_2); it=rb_str_new2("]"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_2); break;default: goto alt5_2;} break;default: goto alt5_2;} 
...
alt5_2: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,11,it);  break;case 43:;  it=rb_str_new2("+"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_3);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,11,it);  break;default: goto alt5_3;}it=CALL(prefixed_AmethystParsercb_9,1,bind); 
 rb_ary_store(bind,5,it);  
ISET(cut,Qnil);goto accept6;
alt5_3: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=AmethystParser_spaces(self ); FAILTEST(alt5_4);char chr6=*ame_curstr(self);  switch(chr6){case 58:;  it=rb_str_new2(":"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_4);int oldpos8=ame_getpos(self);
...
alt8_1: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=rb_str_new2("[]"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt8_2);it=Qtrue;
...
alt6_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_4;}
   it=AmethystParser_inlineHostExpr(self ); FAILTEST(alt6_3);
 rb_ary_store(bind,14,it); it=CALL(prefixed_AmethystParsercb_11,1,bind); 
 rb_ary_store(bind,5,it);  
ISET(cut,Qnil);goto accept7;
  alt6_3:  ame_setpos(self,oldpos8); goto alt5_4;
 accept7:;
 break;case 63:;  it=rb_str_new2("?"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_4);it=CALL(prefixed_AmethystParsercb_12,1,bind); 
 rb_ary_store(bind,5,it);  break;default: goto alt5_4;} 
ISET(cut,Qnil);goto accept6;
  alt5_4:  ame_setpos(self,oldpos7); goto break1;
 accept6:;
 if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
return it;
fail: return failobj; }
VALUE AmethystParser_procargs2(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(5);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,2,it); it=CALL(procargs2_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,4,it); it=CALL(procargs2_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 break;case 1:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,4,it); it=CALL(procargs2_AmethystParsercb_4,1,bind); 
...
return it;
fail: return failobj; }
VALUE AmethystParser_ruleargs(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(4);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversion('73634559cc07a11fa3279bb8d314fcd3')");}
