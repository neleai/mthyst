...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,0,it);  break;default:;   it=AmethystParser_fails(self ); FAILTEST(fail); break;}it=rb_ary_entry(bind,0);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,0,it); it=rb_str_new2("]");it=rb_str_new2("[");int oldpos2=ame_getpos(self);
...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,1,it); char chr1=*ame_curstr(self);  switch(chr1){case 96:;case 34:;case 39:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
 break;default:;case 46:; int oldpos9=ame_getpos(self);
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversionparser('2e0d5b7dc065a10a44a6b067e03d010b')");}
