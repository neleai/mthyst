...
it=rb_ary_new3(0); arg0=CALL(__args_AmethystParsercb_1,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(fail);it=CALL(__args_AmethystParsercb_2,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(choice_AmethystParsercb_4,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(alt1_2);
 BSET(autovar_1,it); it=CALL(choice_AmethystParsercb_5,1,bind); it=rb_ary_new3(0);
 BSET(autovar_2,it); int oldpos2; while(1){oldpos2=ame_getpos(self);  arg0=CALL(choice_AmethystParsercb_6,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(break1); arg0=CALL(choice_AmethystParsercb_7,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(choice_AmethystParsercb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_2);
 BSET(autovar_4,it); it=CALL(choice_AmethystParsercb_9,1,bind); it=BGET(f_1);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystParser_empty(self ); FAILTEST(alt1_3);it=CALL(choice_AmethystParsercb_10,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
it=BGET(_result_1);
 BSET(ary_1,it); it=CALL(choice_AmethystParsercb_11,1,bind);
 BSET(_result_2,it); it=BGET(_result_2);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);it=rb_ary_new3(0);
 ...
 BSET(s_1,it);   it=AmethystParser_spaces(self ); FAILTEST(fail); arg0=CALL(className_AmethystParsercb_2,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(fail);  it=AmethystParser_upper(self ); FAILTEST(fail);
 BSET(autovar_2,it); it=CALL(className_AmethystParsercb_3,1,bind); it=rb_ary_new3(0);
 ...
 BSET(autovar_5,it); it=CALL(className_AmethystParsercb_5,1,bind); it=BGET(autovar_1);
...
it=rb_ary_new3(0);it=CALL(grammar_AmethystParsercb_1,1,bind); 
...
it=rb_ary_new3(0);it=rb_ary_new3(0);
 ...
 BSET(s_1,it);   it=AmethystParser_spaces(self ); FAILTEST(fail); arg0=CALL(name_AmethystParsercb_2,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(fail);  it=AmethystParser_nameFirst(self ); FAILTEST(fail);
 BSET(autovar_2,it); it=CALL(name_AmethystParsercb_3,1,bind); it=rb_ary_new3(0);
 BSET(autovar_3,it); int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystParser_nameRest(self ); FAILTEST(break1);
 ...
 BSET(autovar_5,it); it=CALL(name_AmethystParsercb_5,1,bind); it=BGET(autovar_1);
...
alt4_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
 ...
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt4_2); arg0=CALL(rubyarg_AmethystParsercb_25,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt4_2);
 BSET(_result_2,it); it=BGET(_result_2);
 BSET(n_1,it);  
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
 ...
 BSET(c_1,it); it=CALL(rubyarg_AmethystParsercb_27,1,bind); FAILTEST(alt4_3);it=BGET(c_1);
 BSET(_result_3,it); it=BGET(_result_3);
 BSET(n_1,it);  
ISET(cut,Qnil);goto accept4;
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_3); arg0=CALL(term_AmethystParsercb_3,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_3); arg0=CALL(term_AmethystParsercb_4,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_3);  it=AmethystParser_expression(self ); FAILTEST(alt1_3);
 BSET(expr_1,it); it=CALL(term_AmethystParsercb_5,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_3); arg0=CALL(term_AmethystParsercb_6,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_3);it=CALL(term_AmethystParsercb_7,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(term_AmethystParsercb_8,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_4); arg0=CALL(term_AmethystParsercb_9,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_4);it=CALL(term_AmethystParsercb_10,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(it_1,it); it=CALL(term_AmethystParsercb_11,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 ...
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt2_2); arg0=CALL(term_AmethystParsercb_13,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt2_2);  it=AmethystParser_atomicHostExpr(self ); FAILTEST(alt2_2);
 BSET(x_1,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 it=CALL(term_AmethystParsercb_14,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt2_3); arg0=CALL(term_AmethystParsercb_15,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt2_3);  it=AmethystParser_inlineHostExpr(self ); FAILTEST(alt2_3);
 BSET(x_1,it);  
ISET(cut,Qnil);goto accept2;
...
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(term_AmethystParsercb_17,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_8); arg0=CALL(term_AmethystParsercb_18,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_8);it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self); int oldpos4=ame_getpos(self);
...
alt3_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=AmethystParser_eChar(self ); FAILTEST(alt3_3);
 BSET(autovar_1,it); it=CALL(term_AmethystParsercb_20,1,bind);  
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos4); goto break1;
 accept3:;
 if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(term_AmethystParsercb_21,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(term_AmethystParsercb_22,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_9); arg0=CALL(term_AmethystParsercb_23,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_9);it=rb_ary_new3(0);int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
  arg0=CALL(term_AmethystParsercb_24,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt4_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
   it=AmethystParser_eChar(self ); FAILTEST(alt4_3);
 BSET(autovar_2,it); it=CALL(term_AmethystParsercb_25,1,bind);  
ISET(cut,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos6); goto break2;
 accept4:;
 if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=CALL(term_AmethystParsercb_26,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystParser_number(self ); FAILTEST(alt1_10);
 BSET(it_1,it); it=CALL(term_AmethystParsercb_27,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(term_AmethystParsercb_28,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_11); arg0=CALL(term_AmethystParsercb_29,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_11);it=rb_ary_new3(0);int oldpos7; while(1){oldpos7=ame_getpos(self); int oldpos8=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
 it=CALL(term_AmethystParsercb_30,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt5_2); arg0=CALL(term_AmethystParsercb_31,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt5_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
   it=AmethystParser_eChar(self ); FAILTEST(alt5_3);
 BSET(autovar_3,it); it=CALL(term_AmethystParsercb_32,1,bind);  
ISET(cut,Qnil);goto accept5;
  alt5_3:  ame_setpos(self,oldpos8); goto break3;
 accept5:;
 if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos7); it=CALL(term_AmethystParsercb_33,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(term_AmethystParsercb_34,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_12); arg0=CALL(term_AmethystParsercb_35,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_12);  it=AmethystParser_expression(self ); FAILTEST(alt1_12);
 BSET(x_1,it); it=CALL(term_AmethystParsercb_36,1,bind); 
 BSET(s_2,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_12); arg0=CALL(term_AmethystParsercb_37,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_12);int oldpos9=ame_getpos(self);
alt6_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_12;}
  arg0=CALL(term_AmethystParsercb_38,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt6_2);it=CALL(term_AmethystParsercb_39,1,bind); 
 BSET(ors_1,it); it=CALL(term_AmethystParsercb_40,1,bind); 
 BSET(_result_2,it); it=BGET(_result_2);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept6;
