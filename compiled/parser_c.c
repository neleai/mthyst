...
it=rb_funcall(self,sy_AmethystParser__append_lp__4de3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*r*/,it);
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; int oldpos1=ptr->pos;
...
int oldpos2; while(1){oldpos2=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos2; it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*r*/,it);
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_2;}
   it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2; 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_2;}
...
int oldpos5; while(1){oldpos5=ptr->pos;   it=AmethystParser_rubyarg(self ); FAILTEST(break2); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos5; it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*r*/,it);
...
alt2_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_ary_new3(0); bind_aset(bind,9/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept2;
  alt2_3:  ptr->pos=oldpos3; goto fail;
 accept2:;
 break;
}
return it;
...
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt1_2);if (strncmp(ame_curstr(self),":",1)) goto alt1_2; else ptr->pos+=1; break;
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos2=ptr->pos;
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;
case '>' ... '>':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt2_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt3_2; 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos5=ptr->pos;
alt4_1: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_3;}
...
alt4_2: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_3;}
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
 break;
case '>' ... '>':; int oldpos6=ptr->pos;
alt5_1: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt5_2: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos7=ptr->pos;
alt6_1: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
...
alt6_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
   it=Amethyst_empty(self ); FAILTEST(alt6_3); 
ame_setcut(self,Qnil);goto accept6;
  alt6_3:  ptr->pos=oldpos7; goto alt5_3;
 accept6:;
...
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind);  bind_aset(bind,5/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);
 break;
case '-' ... '-':;case '0' ... '9':; int oldpos8=ptr->pos;
alt7_1: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
int oldpos9=ptr->pos;
alt8_1: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt7_2;}
 it=bind_aget(bind,10/*autovar*/);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):; goto alt8_2; break;
case '.' ... '.':;   it=AmethystCore_anything(self ); FAILTEST(alt8_2);int oldpos10=ptr->pos;
alt9_1: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt8_2;}
 if (strncmp(ame_curstr(self),"..",2)) goto alt9_2; else ptr->pos+=2; 
ame_setcut(self,Qnil);goto accept9;
alt9_2: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt8_2;}
 if (strncmp(ame_curstr(self),".",1)) goto alt9_3; else ptr->pos+=1; 
ame_setcut(self,Qnil);goto accept9;
  alt9_3:  ptr->pos=oldpos10; goto alt8_2;
 accept9:;
 break;
...
alt8_2: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt7_2;}
 it=bind_aget(bind,10/*autovar*/); bind_aset(bind,11/*num*/,it);
 
ame_setcut(self,Qnil);goto accept8;
  alt8_3:  ptr->pos=oldpos9; goto alt7_2;
 accept8:;
...
alt7_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
int oldpos11; while(1){oldpos11=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos12=ptr->pos;
alt10_1: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt10_2; 
ame_setcut(self,Qnil);goto accept10;
alt10_2: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3);  it=AmethystCore_anything(self ); FAILTEST(alt10_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept10;
  alt10_3:  ptr->pos=oldpos12; goto break2;
 accept10:;
 break;
case '>' ... '>':; int oldpos13=ptr->pos;
alt11_1: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt11_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=Amethyst_empty(self ); FAILTEST(alt11_3);  it=AmethystCore_anything(self ); FAILTEST(alt11_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept11;
  alt11_3:  ptr->pos=oldpos13; goto break2;
 accept11:;
 break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos14=ptr->pos;
alt12_1: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt12_2; 
ame_setcut(self,Qnil);goto accept12;
alt12_2: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 int oldpos15=ptr->pos;
alt13_1: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt12_3;}
...
alt13_2: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt12_3;}
   it=Amethyst_empty(self ); FAILTEST(alt13_3); 
ame_setcut(self,Qnil);goto accept13;
  alt13_3:  ptr->pos=oldpos15; goto alt12_3;
 accept13:;
  it=AmethystCore_anything(self ); FAILTEST(alt12_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept12;
  alt12_3:  ptr->pos=oldpos14; goto break2;
 accept12:;
 break;
case '>' ... '>':; int oldpos16=ptr->pos;
alt14_1: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt14_2: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 int oldpos17=ptr->pos;
alt15_1: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt14_3;}
...
alt15_2: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt14_3;}
   it=Amethyst_empty(self ); FAILTEST(alt15_3); 
ame_setcut(self,Qnil);goto accept15;
  alt15_3:  ptr->pos=oldpos17; goto alt14_3;
 accept15:;
  it=AmethystCore_anything(self ); FAILTEST(alt14_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept14;
  alt14_3:  ptr->pos=oldpos16; goto break2;
 accept14:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){{oldpos11=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos11; it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
  alt7_3:  ptr->pos=oldpos8; goto fail;
 accept7:;
 break;
case 'A' ... 'Z':; int oldpos18=ptr->pos;
alt16_1: ptr->pos=oldpos18;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
case ':' ... ':':; int oldpos19=ptr->pos;
alt17_1: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_2;}
   it=AmethystCore_anything(self ); FAILTEST(alt17_2);if (strncmp(ame_curstr(self),":",1)) goto alt17_2; else ptr->pos+=1;ame_setcut(self,Qtrue);goto alt17_2; 
ame_setcut(self,Qnil);goto accept17;
alt17_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_2;}
   it=Amethyst_empty(self ); FAILTEST(alt17_3); 
ame_setcut(self,Qnil);goto accept17;
  alt17_3:  ptr->pos=oldpos19; goto alt16_2;
 accept17:;
 break;
...
alt16_2: ptr->pos=oldpos18;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__lt__524a); bind_aset(bind,0/*s*/,it);
...
int oldpos20; while(1){oldpos20=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos21=ptr->pos;
alt18_1: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt18_2; 
ame_setcut(self,Qnil);goto accept18;
alt18_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
   it=Amethyst_empty(self ); FAILTEST(alt18_3);  it=AmethystCore_anything(self ); FAILTEST(alt18_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept18;
  alt18_3:  ptr->pos=oldpos21; goto break3;
 accept18:;
 break;
case '>' ... '>':; int oldpos22=ptr->pos;
alt19_1: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt19_2: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
   it=Amethyst_empty(self ); FAILTEST(alt19_3);  it=AmethystCore_anything(self ); FAILTEST(alt19_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept19;
  alt19_3:  ptr->pos=oldpos22; goto break3;
 accept19:;
 break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '=':;case '?' ... UC(255):; int oldpos23=ptr->pos;
alt20_1: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
goto alt20_2; 
ame_setcut(self,Qnil);goto accept20;
alt20_2: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 int oldpos24=ptr->pos;
alt21_1: ptr->pos=oldpos24;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt20_3;}
...
alt21_2: ptr->pos=oldpos24;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt20_3;}
   it=Amethyst_empty(self ); FAILTEST(alt21_3); 
ame_setcut(self,Qnil);goto accept21;
  alt21_3:  ptr->pos=oldpos24; goto alt20_3;
 accept21:;
  it=AmethystCore_anything(self ); FAILTEST(alt20_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept20;
  alt20_3:  ptr->pos=oldpos23; goto break3;
 accept20:;
 break;
case '>' ... '>':; int oldpos25=ptr->pos;
alt22_1: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,0/*s*/,it);
...
alt22_2: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
 int oldpos26=ptr->pos;
alt23_1: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt22_3;}
...
alt23_2: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt22_3;}
   it=Amethyst_empty(self ); FAILTEST(alt23_3); 
ame_setcut(self,Qnil);goto accept23;
  alt23_3:  ptr->pos=oldpos26; goto alt22_3;
 accept23:;
  it=AmethystCore_anything(self ); FAILTEST(alt22_3); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  
ame_setcut(self,Qnil);goto accept22;
  alt22_3:  ptr->pos=oldpos25; goto break3;
 accept22:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){{oldpos20=ptr->pos;goto break3;} } } break3: ame_setstop(self,Qnil); ptr->pos=oldpos20; it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__dot__e879,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_6064,1,bind);  bind_aset(bind,7/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept16;
  alt16_3:  ptr->pos=oldpos18; goto fail;
 accept16:;
 break;
}
return it;
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '/':;case ':' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto break1; break;
...
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__4de3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos2; it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*autovar*/,it);
...
case 'a' ... 'a':;   it=AmethystCore_anything(self ); FAILTEST(fail);if (strncmp(ame_curstr(self),"methyst",7)) goto fail; else ptr->pos+=7; break;
...
int oldpos2; while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto break1; break;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__4de3,1,bind);  break;
} if (ame_getstop(self)!=Qnil){{oldpos2=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos2; it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*rules*/,it);
...
case '{' ... '{':;   it=AmethystParser_inline_host_expr(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
 break;
case '-' ... '-':;   it=AmethystCore_anything(self ); FAILTEST(fail);if (strncmp(ame_curstr(self),">",1)) goto fail; else ptr->pos+=1;  it=Amethyst_line(self ); FAILTEST(fail); bind_aset(bind,1/*s*/,it);
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... '`':;case 'b' ... UC(255):; int oldpos2=ptr->pos;
alt1_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); int oldpos3; while(1){oldpos3=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '`':;case 'b' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
case 'a' ... 'a':; int oldpos4=ptr->pos;
alt2_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt2_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt2_2; 
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
} if (ame_getstop(self)!=Qnil){{oldpos3=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos3; it=bind_aget(bind,1/*autovar*/); bind_aset(bind,4/*it*/,it);
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos5=ptr->pos;
alt3_1: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
  it=Amethyst_empty(self ); FAILTEST(alt3_2);  it=AmethystCore_anything(self ); FAILTEST(alt3_2); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); int oldpos6; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '`':;case 'b' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break3);  it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
case 'a' ... 'a':; int oldpos7=ptr->pos;
alt4_1: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt4_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt4_2; 
ame_setcut(self,Qnil);goto accept4;
alt4_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break3;}
   it=Amethyst_empty(self ); FAILTEST(alt4_3); 
ame_setcut(self,Qnil);goto accept4;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
} if (ame_getstop(self)!=Qnil){{oldpos6=ptr->pos;goto break3;} } } break3: ame_setstop(self,Qnil); ptr->pos=oldpos6; it=bind_aget(bind,1/*autovar*/); bind_aset(bind,4/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__e4b4,1,bind);  bind_aset(bind,5/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystParser_grammar(self ); FAILTEST(alt3_3); bind_aset(bind,5/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept3;
alt3_3: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
it=rb_funcall(self,sy_AmethystParser__append_lp__81ec,1,bind);  break;
case 'a' ... 'a':; int oldpos8=ptr->pos;
alt5_1: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos9=ptr->pos;
alt6_1: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_2;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt6_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt6_2; 
ame_setcut(self,Qnil);goto accept6;
alt6_2: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_2;}
   it=Amethyst_empty(self ); FAILTEST(alt6_3); 
ame_setcut(self,Qnil);goto accept6;
  alt6_3:  ptr->pos=oldpos9; goto alt5_2;
 accept6:;
  it=AmethystCore_anything(self ); FAILTEST(alt5_2); bind_aset(bind,2/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind); int oldpos10; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '`':;case 'b' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break4);  it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
case 'a' ... 'a':; int oldpos11=ptr->pos;
alt7_1: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break4;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt7_2; else ptr->pos+=7;ame_setcut(self,Qtrue);goto alt7_2; 
ame_setcut(self,Qnil);goto accept7;
alt7_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break4;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__8061,1,bind);  break;
} if (ame_getstop(self)!=Qnil){{oldpos10=ptr->pos;goto break4;} } } break4: ame_setstop(self,Qnil); ptr->pos=oldpos10; it=bind_aget(bind,1/*autovar*/); bind_aset(bind,4/*it*/,it);
it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__e4b4,1,bind);  bind_aset(bind,5/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept5;
alt5_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystParser_grammar(self ); FAILTEST(alt5_3); bind_aset(bind,5/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept5;
alt5_3: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
ame_setcut(self,Qnil);goto accept5;
  alt5_4:  ptr->pos=oldpos8; goto break1;
 accept5:;
it=rb_funcall(self,sy_AmethystParser__append_lp__81ec,1,bind);  break;
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,0/*autovar*/); bind_aset(bind,7/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*r*/,it);
switch((unsigned char)*ame_curstr(self)){case UC(0) ... '|':;case '~' ... UC(255):; goto fail; break;
case '}' ... '}':;   it=AmethystCore_anything(self ); FAILTEST(fail); break;
}it=rb_funcall(self,sy_AmethystParser_bind_lb_2_rb_,1,bind);  bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/); bind_aset(bind,4/*r*/,it);
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; int oldpos2=ptr->pos;
alt1_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
ame_setcut(self,Qnil);goto accept1;
alt1_3: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__6ac6,1,bind);  
ame_setcut(self,Qnil);goto accept2;
alt2_3: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_4;}
...
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_4;}
   it=Amethyst_empty(self ); FAILTEST(alt3_3); 
ame_setcut(self,Qnil);goto accept3;
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb_,1,bind);  bind_aset(bind,11/*_result*/,it);
...
case '@' ... '@':;   it=AmethystCore_anything(self ); FAILTEST(fail);int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 switch((unsigned char)*ame_curstr(self)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_2; break;
case 'A' ... 'Z':; int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
...
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
...
ame_setcut(self,Qnil);goto accept1;
alt1_2: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 if (strncmp(ame_curstr(self),"@",1)) goto alt1_3; else ptr->pos+=1;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto alt1_3; break;
...
int oldpos1; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1);switch((unsigned char)*ame_curstr(self)){case UC(0) ... ')':;case ',' ... '9':;case ';' ... '<':;case '>' ... '>':;case '@' ... 'Z':;case UC(92) ... UC(255):; goto break1; break;
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos2=ptr->pos;
alt1_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2);if (strncmp(ame_curstr(self),"]",1)) goto alt1_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
...
case '[' ... '[':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"]",1)) goto alt2_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
...
case '=' ... '=':;   it=AmethystCore_anything(self ); FAILTEST(break1);if (strncmp(ame_curstr(self),">",1)) goto break1; else ptr->pos+=1;  it=AmethystParser_term(self ); FAILTEST(break1); bind_aset(bind,2/*e*/,it);
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2; 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... 'Z':;case UC(92) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1); bind_aset(bind,4/*append*/,it);
 break;
case '[' ... '[':; int oldpos5=ptr->pos;
alt4_1: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr(self),"]",1)) goto alt4_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
 
ame_setcut(self,Qnil);goto accept4;
alt4_2: ptr->pos=oldpos5;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
case '[' ... '[':; int oldpos6=ptr->pos;
alt5_1: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_2);if (strncmp(ame_curstr(self),"]",1)) goto alt5_2; else ptr->pos+=1;it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,4/*append*/,it);
...
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,0/*from*/); bind_aset(bind,6/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystParser__at_ary_eq__lb__rb_,1,bind); int oldpos1; while(1){oldpos1=ptr->pos; int oldpos2=ptr->pos;
alt1_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ptr->pos=oldpos2; goto break1;
 accept1:;
 if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=rb_funcall(self,sy_AmethystParser__at_ary_ff69,1,bind);  bind_aset(bind,1/*_result*/,it);
...
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystParser_2,rb_obj_class(ame_curobj(self))))){case 0/*Args*/:; int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__d113,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos2; it=bind_aget(bind,1/*autovar*/); bind_aset(bind,3/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
ame_setcut(self,Qnil);goto accept1;
alt1_4: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}
   it=Amethyst_spaces(self ); FAILTEST(alt2_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt2_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"@",1)) goto alt2_2; else ptr->pos+=1; break;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept2;
alt2_2: ptr->pos=oldpos2;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}
   it=Amethyst_empty(self ); FAILTEST(alt2_3); 
ame_setcut(self,Qnil);goto accept2;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos3=ptr->pos;
alt3_1: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}
   it=Amethyst__(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);goto alt3_2; 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}
   it=Amethyst_empty(self ); FAILTEST(alt3_3); 
ame_setcut(self,Qnil);goto accept3;
...
ame_setcut(self,Qnil);goto accept1;
alt1_5: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept4;
alt4_3: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept4;
alt4_4: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_5);it=rb_ary_new3(0); bind_aset(bind,10/*x*/,it);
int oldpos5; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos6=ptr->pos;
alt5_1: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 break;
case UC(34) ... UC(34):; int oldpos7=ptr->pos;
alt6_1: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept6;
alt6_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind);  
ame_setcut(self,Qnil);goto accept6;
alt6_3: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos8=ptr->pos;
alt7_1: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind);  
ame_setcut(self,Qnil);goto accept7;
alt7_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos9=ptr->pos;
alt8_1: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt7_3;}
...
ame_setcut(self,Qnil);goto accept8;
alt8_2: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt7_3;}
...
ame_setcut(self,Qnil);goto accept7;
 ...
 accept7:;
 break;
case UC(34) ... UC(34):; int oldpos10=ptr->pos;
alt9_1: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept9;
alt9_2: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,2/*o*/,it);
...
it=rb_funcall(self,sy_AmethystParser__append_lp__9ca5,1,bind);  
ame_setcut(self,Qnil);goto accept9;
alt9_3: ptr->pos=oldpos10;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos11=ptr->pos;
alt10_1: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt9_4;}
   it=AmethystCore_anything(self ); FAILTEST(alt10_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__283c,1,bind);  
ame_setcut(self,Qnil);goto accept10;
alt10_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt9_4;}
...
} if (ame_getstop(self)!=Qnil){{oldpos5=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos5; it=rb_funcall(self,sy_AmethystParser_bind_lb_10_rb__ff8c,1,bind);  bind_aset(bind,14/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept4;
alt4_5: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos12=ptr->pos;
alt11_1: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_6;}
   it=Amethyst_spaces(self ); FAILTEST(alt11_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt11_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt11_2);if (strncmp(ame_curstr(self),"@",1)) goto alt11_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept11;
alt11_2: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_6;}
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos13=ptr->pos;
alt12_1: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_6;}
   it=Amethyst__(self ); FAILTEST(alt12_2);ame_setcut(self,Qtrue);goto alt12_2; 
ame_setcut(self,Qnil);goto accept12;
alt12_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_6;}
...
ame_setcut(self,Qnil);goto accept4;
  alt4_6:  ptr->pos=oldpos4; goto fail;
 accept4:;
 break;
case '$' ... '$':;case ':' ... ':':; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos14=ptr->pos;
alt13_1: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept13;
alt13_2: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept13;
alt13_3: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept13;
alt13_4: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos15=ptr->pos;
alt14_1: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}
   it=Amethyst_spaces(self ); FAILTEST(alt14_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt14_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt14_2);if (strncmp(ame_curstr(self),"@",1)) goto alt14_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept14;
alt14_2: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}
...
ame_setcut(self,Qnil);goto accept14;
alt14_3: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos16=ptr->pos;
alt15_1: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}
   it=Amethyst__(self ); FAILTEST(alt15_2);ame_setcut(self,Qtrue);goto alt15_2; 
ame_setcut(self,Qnil);goto accept15;
alt15_2: ptr->pos=oldpos16;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt13_5;}
   it=Amethyst_empty(self ); FAILTEST(alt15_3); 
ame_setcut(self,Qnil);goto accept15;
...
ame_setcut(self,Qnil);goto accept13;
alt13_5: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt13_6); bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept13;
  alt13_6:  ptr->pos=oldpos14; goto fail;
 accept13:;
 break;
case UC(39) ... UC(39):; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos17=ptr->pos;
alt16_1: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept16;
alt16_2: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept16;
alt16_3: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept16;
alt16_4: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt16_5);it=rb_ary_new3(0); bind_aset(bind,17/*x*/,it);
int oldpos18; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '&':;case '(' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__835a,1,bind);  break;
case UC(39) ... UC(39):; int oldpos19=ptr->pos;
alt17_1: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt17_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept17;
alt17_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
...
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '&':;case '(' ... UC(255):; int oldpos20=ptr->pos;
alt18_1: ptr->pos=oldpos20;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
...
ame_setcut(self,Qnil);goto accept18;
alt18_2: ptr->pos=oldpos20;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
...
it=rb_funcall(self,sy_AmethystParser__append_lp__835a,1,bind);  break;
case UC(39) ... UC(39):; int oldpos21=ptr->pos;
alt19_1: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt19_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept19;
alt19_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 int oldpos22=ptr->pos;
alt20_1: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt19_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt20_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__595b,1,bind);  
ame_setcut(self,Qnil);goto accept20;
alt20_2: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt19_3;}
...
} if (ame_getstop(self)!=Qnil){{oldpos18=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos18; it=rb_funcall(self,sy_AmethystParser_bind_lb_17_rb__8424,1,bind);  bind_aset(bind,20/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept16;
alt16_5: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos23=ptr->pos;
alt21_1: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_6;}
   it=Amethyst_spaces(self ); FAILTEST(alt21_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt21_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt21_2);if (strncmp(ame_curstr(self),"@",1)) goto alt21_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept21;
alt21_2: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_6;}
   it=Amethyst_empty(self ); FAILTEST(alt21_3); 
ame_setcut(self,Qnil);goto accept21;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos24=ptr->pos;
alt22_1: ptr->pos=oldpos24;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_6;}
   it=Amethyst__(self ); FAILTEST(alt22_2);ame_setcut(self,Qtrue);goto alt22_2; 
ame_setcut(self,Qnil);goto accept22;
alt22_2: ptr->pos=oldpos24;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt16_6;}
...
ame_setcut(self,Qnil);goto accept16;
  alt16_6:  ptr->pos=oldpos17; goto fail;
 accept16:;
 break;
case '(' ... ')':;case '[' ... '[':;case ']' ... ']':;case '{' ... '{':;case '}' ... '}':; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos25=ptr->pos;
alt23_1: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept23;
alt23_2: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept23;
alt23_3: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept23;
alt23_4: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos26=ptr->pos;
alt24_1: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_5;}
   it=Amethyst_spaces(self ); FAILTEST(alt24_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt24_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt24_2);if (strncmp(ame_curstr(self),"@",1)) goto alt24_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept24;
alt24_2: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_5;}
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos27=ptr->pos;
alt25_1: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_5;}
   it=Amethyst__(self ); FAILTEST(alt25_2);ame_setcut(self,Qtrue);goto alt25_2; 
ame_setcut(self,Qnil);goto accept25;
alt25_2: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt23_5;}
...
ame_setcut(self,Qnil);goto accept23;
  alt23_5:  ptr->pos=oldpos25; goto fail;
 accept23:;
 break;
case '.' ... '.':; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos28=ptr->pos;
alt26_1: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt26_2: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept26;
alt26_3: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept26;
alt26_4: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt26_5);int oldpos29=ptr->pos;
alt27_1: ptr->pos=oldpos29;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_5;}
 if (strncmp(ame_curstr(self),"..",2)) goto alt27_2; else ptr->pos+=2;it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept27;
alt27_2: ptr->pos=oldpos29;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_5;}
 if (strncmp(ame_curstr(self),".",1)) goto alt27_3; else ptr->pos+=1;it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,5/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept26;
alt26_5: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos30=ptr->pos;
alt28_1: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}
   it=Amethyst_spaces(self ); FAILTEST(alt28_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt28_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt28_2);if (strncmp(ame_curstr(self),"@",1)) goto alt28_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept28;
alt28_2: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}
   it=AmethystCore_anything(self ); FAILTEST(alt28_3); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0605,1,bind);  
ame_setcut(self,Qnil);goto accept28;
alt28_3: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos31=ptr->pos;
alt29_1: ptr->pos=oldpos31;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}
   it=Amethyst__(self ); FAILTEST(alt29_2);ame_setcut(self,Qtrue);goto alt29_2; 
ame_setcut(self,Qnil);goto accept29;
alt29_2: ptr->pos=oldpos31;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_6;}
...
ame_setcut(self,Qnil);goto accept26;
alt26_6: ptr->pos=oldpos28;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt26_7); bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept26;
  alt26_7:  ptr->pos=oldpos28; goto fail;
 accept26:;
 break;
case '0' ... '9':;case '_' ... '_':;case 'a' ... 'z':; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos32=ptr->pos;
alt30_1: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt30_2: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept30;
alt30_3: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept30;
alt30_4: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
case '<' ... '<':;   it=AmethystCore_anything(self ); FAILTEST(alt30_5);if (strncmp(ame_curstr(self),"<",1)) goto alt30_5; else ptr->pos+=1; break;
}it=rb_funcall(self,sy_AmethystParser__lb_bind_lb_21_9dcf,1,bind);  bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept30;
alt30_5: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos33=ptr->pos;
alt31_1: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt30_6;}
   it=Amethyst_spaces(self ); FAILTEST(alt31_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt31_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt31_2);if (strncmp(ame_curstr(self),"@",1)) goto alt31_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept31;
alt31_2: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt30_6;}
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos34=ptr->pos;
alt32_1: ptr->pos=oldpos34;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt30_6;}
   it=Amethyst__(self ); FAILTEST(alt32_2);ame_setcut(self,Qtrue);goto alt32_2; 
ame_setcut(self,Qnil);goto accept32;
alt32_2: ptr->pos=oldpos34;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt30_6;}
...
ame_setcut(self,Qnil);goto accept30;
alt30_6: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt30_7); bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept30;
  alt30_7:  ptr->pos=oldpos32; goto fail;
 accept30:;
 break;
case '@' ... '@':; it=rb_ary_new3(0); bind_aset(bind,0/*n*/,it);
int oldpos35=ptr->pos;
alt33_1: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
alt33_2: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept33;
alt33_3: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept33;
alt33_4: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos36=ptr->pos;
alt34_1: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_5;}
   it=Amethyst_spaces(self ); FAILTEST(alt34_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt34_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt34_2);if (strncmp(ame_curstr(self),"@",1)) goto alt34_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept34;
alt34_2: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_5;}
   it=Amethyst_empty(self ); FAILTEST(alt34_3); 
ame_setcut(self,Qnil);goto accept34;
  alt34_3:  ptr->pos=oldpos36; goto alt33_5;
 accept34:;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos37=ptr->pos;
alt35_1: ptr->pos=oldpos37;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_5;}
   it=Amethyst__(self ); FAILTEST(alt35_2);ame_setcut(self,Qtrue);goto alt35_2; 
ame_setcut(self,Qnil);goto accept35;
alt35_2: ptr->pos=oldpos37;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt33_5;}
   it=Amethyst_empty(self ); FAILTEST(alt35_3); 
ame_setcut(self,Qnil);goto accept35;
  alt35_3:  ptr->pos=oldpos37; goto alt33_5;
 accept35:;
 break;
...
ame_setcut(self,Qnil);goto accept33;
alt33_5: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_key(self ); FAILTEST(alt33_6); bind_aset(bind,5/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept33;
alt33_6: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
alt36_1: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
alt36_2: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rp__9371); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lp__84c4); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept36;
alt36_3: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__rb__0fbd); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__lb__8154); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept36;
alt36_4: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,1/*c*/,it);
it=rb_obj_clone(s__le__f95b); bind_aset(bind,2/*o*/,it);
...
ame_setcut(self,Qnil);goto accept36;
alt36_5: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos39=ptr->pos;
alt37_1: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt36_6;}
   it=Amethyst_spaces(self ); FAILTEST(alt37_2);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '9':;case ';' ... UC(255):; goto alt37_2; break;
case ':' ... ':':;   it=AmethystCore_anything(self ); FAILTEST(alt37_2);if (strncmp(ame_curstr(self),"@",1)) goto alt37_2; else ptr->pos+=1; break;
}it=rb_obj_clone(s__co__at__4bf0); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*_result*/,it);
it=bind_aget(bind,7/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__0eeb,1,bind);  
ame_setcut(self,Qnil);goto accept37;
alt37_2: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt36_6;}
   it=Amethyst_empty(self ); FAILTEST(alt37_3); 
ame_setcut(self,Qnil);goto accept37;
  alt37_3:  ptr->pos=oldpos39; goto alt36_6;
 accept37:;
...
case UC(9) ... UC(10):;case UC(12) ... UC(13):;case ' ' ... ' ':; int oldpos40=ptr->pos;
alt38_1: ptr->pos=oldpos40;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt36_6;}
   it=Amethyst__(self ); FAILTEST(alt38_2);ame_setcut(self,Qtrue);goto alt38_2; 
ame_setcut(self,Qnil);goto accept38;
alt38_2: ptr->pos=oldpos40;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt36_6;}
   it=Amethyst_empty(self ); FAILTEST(alt38_3); 
ame_setcut(self,Qnil);goto accept38;
  alt38_3:  ptr->pos=oldpos40; goto alt36_6;
 accept38:;
 break;
...
ame_setcut(self,Qnil);goto accept36;
  alt36_6:  ptr->pos=oldpos38; goto fail;
 accept36:;
 break;
}
return it;
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
int oldpos1; while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_AmethystParser_1,rb_obj_class(ame_curobj(self))))){case 0/*Args*/:;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,3/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
} if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,2/*autovar*/); bind_aset(bind,7/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_AmethystParser__append_lp__cbd1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*ary*/,it);
...
switch((unsigned char)*ame_curstr(self)){case UC(0) ... '!':;case '#' ... '&':;case ')' ... ',':;case '.' ... '?':;case UC(92) ... '^':;case '`' ... '`':;case '|' ... UC(255):; int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ptr->pos=oldpos2; if (x==0) goto alt1_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt1_3); break;
case '.' ... '.':; int oldpos3=ptr->pos;
alt2_1: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2); 
ame_setcut(self,Qnil);goto accept3;
alt2_2: ptr->pos=oldpos3;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_3;}
   it=Amethyst_empty(self ); FAILTEST(alt2_3); 
ame_setcut(self,Qnil);goto accept3;
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;
case 'n' ... 'n':; int oldpos4=ptr->pos;
alt3_1: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt3_2);if (strncmp(ame_curstr(self),"ested(",6)) goto alt3_2; else ptr->pos+=6;  it=AmethystParser_expression(self ); FAILTEST(alt3_2); bind_aset(bind,3/*expr*/,it);
...
ame_setcut(self,Qnil);goto accept4;
alt3_3: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_call(self ); FAILTEST(alt3_4); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept4;
alt3_4: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos5=ptr->pos;
...
} x=1; goto accept5;  reject2: x=0; accept5: it=Qnil; ptr->pos=oldpos5; if (x==0) goto alt3_5;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt3_5); break;
case '.' ... '.':; int oldpos6=ptr->pos;
alt4_1: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_5;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_2); 
ame_setcut(self,Qnil);goto accept6;
alt4_2: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_5;}
   it=Amethyst_empty(self ); FAILTEST(alt4_3); 
ame_setcut(self,Qnil);goto accept6;
  alt4_3:  ptr->pos=oldpos6; goto alt3_5;
 accept6:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept4;
alt3_5: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept4;
  alt3_6:  ptr->pos=oldpos4; goto fail;
 accept4:;
 break;
case UC(34) ... UC(34):; int oldpos7=ptr->pos;
alt5_1: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt5_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
alt5_2: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos8=ptr->pos;
...
} x=1; goto accept8;  reject3: x=0; accept8: it=Qnil; ptr->pos=oldpos8; if (x==0) goto alt5_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt5_3); break;
case '.' ... '.':; int oldpos9=ptr->pos;
alt6_1: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_2); 
ame_setcut(self,Qnil);goto accept9;
alt6_2: ptr->pos=oldpos9;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
   it=Amethyst_empty(self ); FAILTEST(alt6_3); 
ame_setcut(self,Qnil);goto accept9;
  alt6_3:  ptr->pos=oldpos9; goto alt5_3;
 accept9:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
alt5_3: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
int oldpos10; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '!':;case '#' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break1);  it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(34) ... UC(34):; int oldpos11=ptr->pos;
alt7_1: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept10;
alt7_2: ptr->pos=oldpos11;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
...
ame_setcut(self,Qnil);goto accept10;
  alt7_3:  ptr->pos=oldpos11; goto break1;
 accept10:;
 break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '!':;case '#' ... UC(255):; int oldpos12=ptr->pos;
alt8_1: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind);  
ame_setcut(self,Qnil);goto accept11;
alt8_2: ptr->pos=oldpos12;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=Amethyst_empty(self ); FAILTEST(alt8_3); 
ame_setcut(self,Qnil);goto accept11;
  alt8_3:  ptr->pos=oldpos12; goto break1;
 accept11:;
  it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(34) ... UC(34):; int oldpos13=ptr->pos;
alt9_1: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept12;
alt9_2: ptr->pos=oldpos13;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 int oldpos14=ptr->pos;
alt10_1: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt9_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt10_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind);  
ame_setcut(self,Qnil);goto accept13;
alt10_2: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt9_3;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3); 
ame_setcut(self,Qnil);goto accept13;
  alt10_3:  ptr->pos=oldpos14; goto alt9_3;
 accept13:;
  it=AmethystCore_anything(self ); FAILTEST(alt9_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  
ame_setcut(self,Qnil);goto accept12;
  alt9_3:  ptr->pos=oldpos13; goto break1;
 accept12:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){{oldpos10=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos10; it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__1e8d,1,bind);  bind_aset(bind,8/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept7;
alt5_4: ptr->pos=oldpos7;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept7;
  alt5_5:  ptr->pos=oldpos7; goto fail;
 accept7:;
 break;
case UC(39) ... UC(39):; int oldpos15=ptr->pos;
alt11_1: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt11_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept14;
alt11_2: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept15;  reject4: x=0; accept15: it=Qnil; ptr->pos=oldpos16; if (x==0) goto alt11_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt11_3); break;
case '.' ... '.':; int oldpos17=ptr->pos;
alt12_1: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt11_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt12_2); 
ame_setcut(self,Qnil);goto accept16;
alt12_2: ptr->pos=oldpos17;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt11_3;}
   it=Amethyst_empty(self ); FAILTEST(alt12_3); 
ame_setcut(self,Qnil);goto accept16;
...
ame_setcut(self,Qnil);goto accept14;
alt11_3: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt11_4);it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
int oldpos18; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '[':;case ']' ... UC(255):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '&':;case '(' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2);  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(39) ... UC(39):; int oldpos19=ptr->pos;
alt13_1: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt13_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept17;
alt13_2: ptr->pos=oldpos19;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=Amethyst_empty(self ); FAILTEST(alt13_3);  it=AmethystCore_anything(self ); FAILTEST(alt13_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  
ame_setcut(self,Qnil);goto accept17;
  alt13_3:  ptr->pos=oldpos19; goto break2;
 accept17:;
 break;
} break;
case UC(92) ... UC(92):; switch((unsigned char)*ame_curstr(self)){case UC(0) ... '&':;case '(' ... UC(255):; int oldpos20=ptr->pos;
alt14_1: ptr->pos=oldpos20;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt14_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind);  
ame_setcut(self,Qnil);goto accept18;
alt14_2: ptr->pos=oldpos20;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=Amethyst_empty(self ); FAILTEST(alt14_3); 
ame_setcut(self,Qnil);goto accept18;
  alt14_3:  ptr->pos=oldpos20; goto break2;
 accept18:;
  it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  break;
case UC(39) ... UC(39):; int oldpos21=ptr->pos;
alt15_1: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
   it=AmethystCore_anything(self ); FAILTEST(alt15_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept19;
alt15_2: ptr->pos=oldpos21;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 int oldpos22=ptr->pos;
alt16_1: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt15_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt16_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__7352,1,bind);  
ame_setcut(self,Qnil);goto accept20;
alt16_2: ptr->pos=oldpos22;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt15_3;}
   it=Amethyst_empty(self ); FAILTEST(alt16_3); 
ame_setcut(self,Qnil);goto accept20;
  alt16_3:  ptr->pos=oldpos22; goto alt15_3;
 accept20:;
  it=AmethystCore_anything(self ); FAILTEST(alt15_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__088f,1,bind);  
ame_setcut(self,Qnil);goto accept19;
  alt15_3:  ptr->pos=oldpos21; goto break2;
 accept19:;
 break;
} break;
} if (ame_getstop(self)!=Qnil){{oldpos18=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos18; it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__dot__1e8d,1,bind);  bind_aset(bind,8/*_result*/,it);
it=bind_aget(bind,8/*_result*/); bind_aset(bind,2/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_s_319b,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept14;
alt11_4: ptr->pos=oldpos15;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept14;
  alt11_5:  ptr->pos=oldpos15; goto fail;
 accept14:;
 break;
case '(' ... '(':; int oldpos23=ptr->pos;
alt17_1: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt17_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept21;
alt17_2: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos24=ptr->pos;
...
} x=1; goto accept22;  reject5: x=0; accept22: it=Qnil; ptr->pos=oldpos24; if (x==0) goto alt17_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt17_3); break;
case '.' ... '.':; int oldpos25=ptr->pos;
alt18_1: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt18_2); 
ame_setcut(self,Qnil);goto accept23;
alt18_2: ptr->pos=oldpos25;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_3;}
   it=Amethyst_empty(self ); FAILTEST(alt18_3); 
ame_setcut(self,Qnil);goto accept23;
  alt18_3:  ptr->pos=oldpos25; goto alt17_3;
 accept23:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept21;
alt17_3: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept21;
alt17_4: ptr->pos=oldpos23;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
case ')' ... ')':;   it=AmethystCore_anything(self ); FAILTEST(alt17_5); break;
 ...
 break;
case '[' ... '[':; int oldpos26=ptr->pos;
alt19_1: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_5;}
   it=AmethystCore_anything(self ); FAILTEST(alt19_2);if (strncmp(ame_curstr(self),"]",1)) goto alt19_2; else ptr->pos+=1;it=bind_aget(bind,9/*x*/); bind_aset(bind,10/*ors*/,it);
...
ame_setcut(self,Qnil);goto accept24;
alt19_2: ptr->pos=oldpos26;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt17_5;}
   it=Amethyst_empty(self ); FAILTEST(alt19_3);it=bind_aget(bind,9/*x*/); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept24;
  alt19_3:  ptr->pos=oldpos26; goto alt17_5;
 accept24:;
 break;
} 
ame_setcut(self,Qnil);goto accept21;
  alt17_5:  ptr->pos=oldpos23; goto fail;
 accept21:;
 break;
case '-' ... '-':;case '{' ... '{':; int oldpos27=ptr->pos;
alt20_1: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt20_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept25;
alt20_2: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 int oldpos28=ptr->pos;
...
} x=1; goto accept26;  reject6: x=0; accept26: it=Qnil; ptr->pos=oldpos28; if (x==0) goto alt20_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt20_3); break;
case '.' ... '.':; int oldpos29=ptr->pos;
alt21_1: ptr->pos=oldpos29;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt20_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt21_2); 
ame_setcut(self,Qnil);goto accept27;
alt21_2: ptr->pos=oldpos29;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt20_3;}
   it=Amethyst_empty(self ); FAILTEST(alt21_3); 
ame_setcut(self,Qnil);goto accept27;
  alt21_3:  ptr->pos=oldpos29; goto alt20_3;
 accept27:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept25;
alt20_3: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_host_expr(self ); FAILTEST(alt20_4); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept25;
alt20_4: ptr->pos=oldpos27;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept25;
  alt20_5:  ptr->pos=oldpos27; goto fail;
 accept25:;
 break;
case '@' ... '@':; int oldpos30=ptr->pos;
alt22_1: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt22_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept28;
alt22_2: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept29;  reject7: x=0; accept29: it=Qnil; ptr->pos=oldpos31; if (x==0) goto alt22_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt22_3); break;
case '.' ... '.':; int oldpos32=ptr->pos;
alt23_1: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt22_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt23_2); 
ame_setcut(self,Qnil);goto accept30;
alt23_2: ptr->pos=oldpos32;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt22_3;}
   it=Amethyst_empty(self ); FAILTEST(alt23_3); 
ame_setcut(self,Qnil);goto accept30;
  alt23_3:  ptr->pos=oldpos32; goto alt22_3;
 accept30:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept28;
alt22_3: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept28;
alt22_4: ptr->pos=oldpos30;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept28;
  alt22_5:  ptr->pos=oldpos30; goto fail;
 accept28:;
 break;
case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'a':;case 'c' ... 'm':;case 'o' ... 'z':; int oldpos33=ptr->pos;
alt24_1: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt24_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept31;
alt24_2: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_call(self ); FAILTEST(alt24_3); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept31;
alt24_3: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept32;  reject8: x=0; accept32: it=Qnil; ptr->pos=oldpos34; if (x==0) goto alt24_4;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt24_4); break;
case '.' ... '.':; int oldpos35=ptr->pos;
alt25_1: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt24_4;}
   it=AmethystCore_anything(self ); FAILTEST(alt25_2); 
ame_setcut(self,Qnil);goto accept33;
alt25_2: ptr->pos=oldpos35;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt24_4;}
   it=Amethyst_empty(self ); FAILTEST(alt25_3); 
ame_setcut(self,Qnil);goto accept33;
  alt25_3:  ptr->pos=oldpos35; goto alt24_4;
 accept33:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept31;
alt24_4: ptr->pos=oldpos33;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept31;
  alt24_5:  ptr->pos=oldpos33; goto fail;
 accept31:;
 break;
case '[' ... '[':; int oldpos36=ptr->pos;
alt26_1: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt26_2); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept34;
alt26_2: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept35;  reject9: x=0; accept35: it=Qnil; ptr->pos=oldpos37; if (x==0) goto alt26_3;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt26_3); break;
case '.' ... '.':; int oldpos38=ptr->pos;
alt27_1: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_3;}
   it=AmethystCore_anything(self ); FAILTEST(alt27_2); 
ame_setcut(self,Qnil);goto accept36;
alt27_2: ptr->pos=oldpos38;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt26_3;}
   it=Amethyst_empty(self ); FAILTEST(alt27_3); 
ame_setcut(self,Qnil);goto accept36;
  alt27_3:  ptr->pos=oldpos38; goto alt26_3;
 accept36:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept34;
alt26_3: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept34;
alt26_4: ptr->pos=oldpos36;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept34;
  alt26_5:  ptr->pos=oldpos36; goto fail;
 accept34:;
 break;
case 'b' ... 'b':; int oldpos39=ptr->pos;
alt28_1: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt28_2);if (strncmp(ame_curstr(self),"reak",4)) goto alt28_2; else ptr->pos+=4;it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb__3505,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept37;
alt28_2: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_cases(self ); FAILTEST(alt28_3); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept37;
alt28_3: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_call(self ); FAILTEST(alt28_4); bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept37;
alt28_4: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
} x=1; goto accept38;  reject10: x=0; accept38: it=Qnil; ptr->pos=oldpos40; if (x==0) goto alt28_5;switch((unsigned char)*ame_curstr(self)){case UC(0) ... '-':;case '/' ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(alt28_5); break;
case '.' ... '.':; int oldpos41=ptr->pos;
alt29_1: ptr->pos=oldpos41;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt28_5;}
   it=AmethystCore_anything(self ); FAILTEST(alt29_2); 
ame_setcut(self,Qnil);goto accept39;
alt29_2: ptr->pos=oldpos41;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt28_5;}
   it=Amethyst_empty(self ); FAILTEST(alt29_3); 
ame_setcut(self,Qnil);goto accept39;
  alt29_3:  ptr->pos=oldpos41; goto alt28_5;
 accept39:;
 break;
}it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_a_1437,1,bind);  bind_aset(bind,0/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept37;
alt28_5: ptr->pos=oldpos39;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser__dq__sh__dq__b65f,1,bind);  bind_aset(bind,1/*s*/,it);
...
ame_setcut(self,Qnil);goto accept37;
  alt28_6:  ptr->pos=oldpos39; goto fail;
 accept37:;
 break;
}
return it;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('f84be2306849558cd08d83a2634b8293')");}
