...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,2/*klas*/,it);  it=rb_obj_clone(c_115); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_name(self ); FAILTEST(alt1_2);
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(0) ... UC(39):;case UC(41) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(fail);it=rb_ary_new3(0);
 bind_aset(bind,4/*_result*/,it);  break;case UC(40) ... UC(40):; int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,7/*r*/,it);  it=rb_obj_clone(c_120); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt2_2);it=bind_aget(bind,7/*r*/);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 bind_aset(bind,15/*arg*/,it); it=rb_funcall(self,s_application_AmethystParsercb_5AmethystParser,1,bind); 
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('5692ef9abdd627b35c384e2ab000ff21')");}
