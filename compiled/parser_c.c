...
cstruct oldpass2=*ptr; int fail2=0;
          ptr->src=bind_aget(bind,12/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_AmethystParser_bind_lb_10_rb_2,1,bind); cstruct oldpass1=*ptr; int fail1=0;
          ptr->src=bind_aget(bind,10/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass2=*ptr; int fail2=0;
          ptr->src=bind_aget(bind,13/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('183103bf30d95aad4b258c74214ede35')");}
