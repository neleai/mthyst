...
static VALUE sy_AmethystParser_1;
static VALUE sy_AmethystParser_2;
static VALUE sy_AmethystParser_3;
static VALUE sy_AmethystParser_4;
static VALUE sy_AmethystParser_Act_lb_Args1;
static VALUE sy_AmethystParser_Act_lb_bind1;
static VALUE sy_AmethystParser_Apply_lb_1;
...
static VALUE sy_AmethystParser_Apply_lb_bi1;
static VALUE sy_AmethystParser_Args_lb_1;
static VALUE sy_AmethystParser_Args_lb_2;
static VALUE sy_AmethystParser_Args_lb_3;
static VALUE sy_AmethystParser_Comment_lb_1;
static VALUE sy_AmethystParser_Exp_lb__bod1;
static VALUE sy_AmethystParser_Global_lb_b1;
static VALUE sy_AmethystParser_Grammar_dot_1;
static VALUE sy_AmethystParser_Key_lb_bind1;
static VALUE sy_AmethystParser_Lookahea1;
static VALUE sy_AmethystParser_Many_lb_bin1;
static VALUE sy_AmethystParser_Nested_lb_b1;
static VALUE sy_AmethystParser_Object_dot_c1;
static VALUE sy_AmethystParser_Or_dot_creat1;
static VALUE sy_AmethystParser_Or_lb_bind_lb_1;
static VALUE sy_AmethystParser_Pass_lb_bin1;
static VALUE sy_AmethystParser_Pred_lb_bin1;
static VALUE sy_AmethystParser_Result_lb_1;
static VALUE sy_AmethystParser_Rule_dot_cre1;
static VALUE sy_AmethystParser_Seq_dot_crea1;
static VALUE sy_AmethystParser_Seq_lb_Cut_lb_1;
static VALUE sy_AmethystParser_Seq_lb__Bin1;
static VALUE sy_AmethystParser_Strin_lb_co1;
static VALUE sy_AmethystParser__Bind_lp_bi1;
static VALUE sy_AmethystParser__Local_lp_b1;
...
static VALUE sy_AmethystParser__append_lp_1;
...
static VALUE sy_AmethystParser__at_ary1;
static VALUE sy_AmethystParser__at_ary_eq__lb__rb_1;
static VALUE sy_AmethystParser__at_ary_lt__lt_Ar1;
static VALUE sy_AmethystParser__at_bnding1;
static VALUE sy_AmethystParser__at_locals_dot_1;
static VALUE sy_AmethystParser__at_locals_eq_1;
static VALUE sy_AmethystParser__at_tmp_lt__lt_bi1;
static VALUE sy_AmethystParser__body_lp_bi1;
static VALUE sy_AmethystParser__di__lb_1;
static VALUE sy_AmethystParser__di__lb__do__dot__co__rb__di_1;
static VALUE sy_AmethystParser__di__lb__dot__co__bs__lb__rb__di_1;
static VALUE sy_AmethystParser__lb_bind_lb_3_rb_1;
static VALUE sy_AmethystParser__lp_bind_lb_1_rb_1;
static VALUE sy_AmethystParser__lp_bind_lb_5_rb_1;
static VALUE sy_AmethystParser_a_eq_autova1;
static VALUE sy_AmethystParser_a_eq_autova2;
static VALUE sy_AmethystParser_bind_lb_0_rb_1;
static VALUE sy_AmethystParser_bind_lb_10_rb_1;
static VALUE sy_AmethystParser_bind_lb_10_rb_2;
static VALUE sy_AmethystParser_bind_lb_11_rb_1;
static VALUE sy_AmethystParser_bind_lb_11_rb_2;
static VALUE sy_AmethystParser_bind_lb_12_rb_1;
static VALUE sy_AmethystParser_bind_lb_1_rb__eq_1;
static VALUE sy_AmethystParser_bind_lb_1_rb__ti_1;
static VALUE sy_AmethystParser_bind_lb_3_rb__eq_1;
static VALUE sy_AmethystParser_bind_lb_3_rb__eq_2;
static VALUE sy_AmethystParser_bind_lb_4_rb__pl_1;
static VALUE sy_AmethystParser_bind_lb_4_rb__ti_1;
static VALUE sy_AmethystParser_bind_lb_5_rb__eq_1;
static VALUE sy_AmethystParser_bind_lb_5_rb__pl_1;
static VALUE sy_AmethystParser_bind_lb_6_rb__eq_1;
static VALUE sy_AmethystParser_bind_lb_6_rb__eq_2;
static VALUE sy_AmethystParser_bind_lb_9_rb__pl_1;
static VALUE sy_AmethystParser_leterize1;
...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,3/*name*/,it); it=rb_funcall(self,sy_AmethystParser__Local_lp_b1,1,bind); 
...
it=bind_aget(bind,5/*autovar*/);
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_16,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_AmethystParser_bind_lb_0_rb_1,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,4/*rule*/,it); it=rb_funcall(self,sy_AmethystParser__lb_bind_lb_3_rb_1,1,bind); 
...
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,10/*r*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_10_rb_1,1,bind); 
 bind_aset(bind,11/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_11_rb_1,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setcut(self,Qnil);goto accept2;
 ...
 bind_aset(bind,16/*arg*/,it); it=rb_funcall(self,sy_AmethystParser_Apply_lb_bi1,1,bind); 
...
it=bind_aget(bind,0/*c*/);
 ...
 bind_aset(bind,9/*r*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_9_rb__pl_1,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,12/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_12_rb_1,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,bind_aget(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
it=bind_aget(bind,5/*_result*/);
 bind_aset(bind,6/*ary*/,it); it=rb_funcall(self,sy_AmethystParser_Or_dot_creat1,1,bind); 
 bind_aset(bind,7/*_result*/,it); it=bind_aget(bind,7/*_result*/);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,5/*it*/,it); it=rb_funcall(self,sy_AmethystParser_leterize1,1,bind); 
 bind_aset(bind,6/*_result*/,it); it=bind_aget(bind,6/*_result*/);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,2/*r*/,it); it=rb_funcall(self,sy_AmethystParser_Args_lb_1,1,bind); 
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
 bind_aset(bind,4/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 bind_aset(bind,5/*c*/,it); it=rb_funcall(self,sy_AmethystParser__lp_bind_lb_5_rb_1,1,bind); FAILTEST(alt1_3);it=bind_aget(bind,5/*c*/);
 bind_aset(bind,6/*_result*/,it); it=bind_aget(bind,6/*_result*/);
 bind_aset(bind,4/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
...
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,5/*c*/,it); it=rb_funcall(self,sy_AmethystParser__lp_bind_lb_5_rb_1,1,bind); FAILTEST(alt2_2);it=bind_aget(bind,5/*c*/);
 bind_aset(bind,6/*_result*/,it); it=bind_aget(bind,6/*_result*/);
...
alt2_3: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,5/*c*/,it); it=rb_funcall(self,sy_AmethystParser__lp_bind_lb_5_rb_1,1,bind); FAILTEST(alt2_4);it=bind_aget(bind,5/*c*/);
 bind_aset(bind,6/*_result*/,it); it=bind_aget(bind,6/*_result*/);
 bind_aset(bind,4/*_result*/,it);  
ame_setcut(self,Qnil);goto accept2;
...
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=Amethyst_empty(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__eq_1,1,bind);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 ...
 bind_aset(bind,3/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,2/*autovar*/);
 bind_aset(bind,4/*rules*/,it);   it=Amethyst_spaces(self ); FAILTEST(fail); it=rb_obj_clone(s_2); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(fail);it=rb_funcall(self,sy_AmethystParser_Grammar_dot_1,1,bind); 
...
ame_setcut(self,Qnil);goto accept2;
 ...
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_1,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC(0) ... UC(96):;case UC(98) ... UC(255):;   it=Amethyst_empty(self ); FAILTEST(break2); break;case UC(97) ... UC(97):; int oldpos5=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept3;
 ...
 bind_aset(bind,4/*it*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__ti_1,1,bind); 
...
VALUE AmethystParser_inlineHostExpr(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(11);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
 bind_aset(bind,4/*r*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__pl_1,1,bind); 
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_5_rb__eq_1,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*name*/,it); it=rb_funcall(self,sy_AmethystParser_Object_dot_c1,1,bind); 
 bind_aset(bind,1/*vars*/,it); it=rb_funcall(self,sy_AmethystParser_Result_lb_1,1,bind); 
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*name*/,it); it=rb_funcall(self,sy_AmethystParser_Key_lb_bind1,1,bind); 
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*name*/,it); it=rb_funcall(self,sy_AmethystParser_Global_lb_b1,1,bind); 
 bind_aset(bind,2/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_AmethystParser_1,1,bind); 
...
ame_setcut(self,Qnil);goto accept2;
 ...
 bind_aset(bind,5/*c*/,it); it=rb_funcall(self,sy_AmethystParser_Comment_lb_1,1,bind); 
 bind_aset(bind,0/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 ...
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
 bind_aset(bind,4/*r*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_4_rb__pl_1,1,bind); 
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_5_rb__eq_1,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,bind_aget(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*expr*/,it); it=rb_funcall(self,sy_AmethystParser_Pred_lb_bin1,1,bind); 
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,5/*m*/,it); it=rb_funcall(self,sy_AmethystParser_Lookahea1,1,bind); 
 bind_aset(bind,1/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
alt2_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_4;}
  ...
  it=rb_funcall(self,sy_AmethystParser__di__lb__dot__co__bs__lb__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos3); if (x==0) goto alt2_3;int oldpos4=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
it=rb_funcall(self,sy_AmethystParser_Apply_lb_1,1,bind); 
 bind_aset(bind,6/*from*/,it);  
ame_setcut(self,Qnil);goto accept2;
...
ame_setcut(self,Qnil);goto accept5;
 ...
 bind_aset(bind,2/*_result*/,it); it=bind_aget(bind,2/*_result*/);
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
 bind_aset(bind,8/*one*/,it); it=rb_funcall(self,sy_AmethystParser_Many_lb_bin1,1,bind); 
 bind_aset(bind,6/*from*/,it); 
...
ame_setcut(self,Qnil);goto accept8;
 ...
 accept8:;
 break;}it=rb_funcall(self,sy_AmethystParser__Bind_lp_bi1,1,bind); 
 bind_aset(bind,6/*from*/,it); 
...
alt5_2: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 ...
 bind_aset(bind,12/*e*/,it); it=rb_funcall(self,sy_AmethystParser_Seq_lb__Bin1,1,bind); 
 bind_aset(bind,6/*from*/,it); 
 bind_aset(bind,9/*autovar*/,it);  
ame_setcut(self,Qnil);goto accept6;
 ...
 bind_aset(bind,13/*it*/,it); it=rb_funcall(self,sy_AmethystParser_Pass_lb_bin1,1,bind); 
 bind_aset(bind,6/*from*/,it); 
 bind_aset(bind,9/*autovar*/,it);  break;case UC(63) ... UC(63):;  it=rb_obj_clone(s_7); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(break1);it=rb_funcall(self,sy_AmethystParser_Or_lb_bind_lb_1,1,bind); 
 bind_aset(bind,6/*from*/,it); 
 ...
 bind_aset(bind,13/*it*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_6_rb__eq_1,1,bind);   it=Amethyst_spaces(self ); FAILTEST(break1); it=rb_obj_clone(s__rb_1); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(break1);it=bind_aget(bind,6/*from*/);
 bind_aset(bind,6/*from*/,it); 
...
it=rb_funcall(self,sy_AmethystParser__at_ary_eq__lb__rb_1,1,bind); it=rb_ary_new3(0);
 bind_aset(bind,0/*autovar*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2);
 bind_aset(bind,1/*c*/,it); it=rb_funcall(self,sy_AmethystParser__lp_bind_lb_1_rb_1,1,bind); FAILTEST(alt1_2);it=rb_funcall(self,sy_AmethystParser__at_ary_lt__lt_Ar1,1,bind); 
...
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
it=rb_funcall(self,sy_AmethystParser__append_lp_27,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_AmethystParser__at_ary1,1,bind); 
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
return it;
fail: return failobj; }
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,0/*autovar*/);
 bind_aset(bind,6/*a*/,it); it=rb_funcall(self,sy_AmethystParser__at_tmp_lt__lt_bi1,1,bind); 
 bind_aset(bind,5/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt2_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_5;}
  it=rb_funcall(self,sy_AmethystParser__di__lb__do__dot__co__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt2_3);
...
ame_setcut(self,Qnil);goto accept3;
 ...
 bind_aset(bind,11/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_20,1,bind); it=rb_funcall(self,sy_AmethystParser_bind_lb_1_rb__ti_1,1,bind); 
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
alt1_6: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_funcall(self,sy_AmethystParser__di__lb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt1_7);
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
ame_setcut(self,Qnil);goto accept6;
 ...
 bind_aset(bind,15/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_23,1,bind); it=rb_funcall(self,sy_AmethystParser_Strin_lb_co1,1,bind); 
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept5;
...
alt7_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_6;}
  it=rb_funcall(self,sy_AmethystParser__di__lb__do__dot__co__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt7_3);
 bind_aset(bind,10/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_19,1,bind);  
ame_setcut(self,Qnil);goto accept7;
...
alt5_7: ame_setpos(self,oldpos5);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_funcall(self,sy_AmethystParser__di__lb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt5_8);
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept5;
...
ame_setcut(self,Qnil);goto accept11;
 ...
 bind_aset(bind,19/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_26,1,bind); it=rb_funcall(self,sy_AmethystParser_Strin_lb_co1,1,bind); 
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept10;
...
alt12_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt10_6;}
  it=rb_funcall(self,sy_AmethystParser__di__lb__do__dot__co__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt12_3);
 bind_aset(bind,10/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_19,1,bind);  
ame_setcut(self,Qnil);goto accept12;
...
alt10_7: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_funcall(self,sy_AmethystParser__di__lb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt10_8);
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept10;
...
alt16_2: ame_setpos(self,oldpos18);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt15_7;}
  it=rb_funcall(self,sy_AmethystParser__di__lb__do__dot__co__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt16_3);
 bind_aset(bind,10/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_19,1,bind);  
ame_setcut(self,Qnil);goto accept16;
...
alt15_8: ame_setpos(self,oldpos17);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_funcall(self,sy_AmethystParser__di__lb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt15_9);
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept15;
...
alt19_1: ame_setpos(self,oldpos21);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,20/*e*/,it);  it=rb_obj_clone(s_9); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt19_2);it=rb_funcall(self,sy_AmethystParser_Exp_lb__bod1,1,bind); 
 bind_aset(bind,6/*_result*/,it);  
...
alt20_2: ame_setpos(self,oldpos22);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt19_6;}
  it=rb_funcall(self,sy_AmethystParser__di__lb__do__dot__co__rb__di_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt20_3);
 bind_aset(bind,10/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_19,1,bind);  
ame_setcut(self,Qnil);goto accept20;
...
alt19_7: ame_setpos(self,oldpos21);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
  it=rb_funcall(self,sy_AmethystParser__di__lb_1,1,bind);  arg0=it; it=Amethyst_regch(self ,arg0); FAILTEST(alt19_8);
 bind_aset(bind,6/*_result*/,it);  
ame_setcut(self,Qnil);goto accept19;
...
it=rb_funcall(self,sy_AmethystParser__at_locals_eq_1,1,bind); it=rb_funcall(self,sy_AmethystParser__at_bnding1,1,bind); 
 ...
 bind_aset(bind,3/*body*/,it); it=rb_funcall(self,sy_AmethystParser__body_lp_bi1,1,bind); 
 bind_aset(bind,3/*body*/,it); it=rb_funcall(self,sy_AmethystParser__at_locals_dot_1,1,bind); 
 bind_aset(bind,4/*locals*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_3_rb__eq_1,1,bind); it=rb_funcall(self,sy_AmethystParser_Rule_dot_cre1,1,bind); 
 bind_aset(bind,5/*_result*/,it); it=bind_aget(bind,5/*_result*/);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,1/*autovar*/);
 ...
 bind_aset(bind,5/*r*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_5_rb__pl_1,1,bind); 
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;}it=bind_aget(bind,0/*_result*/);
 bind_aset(bind,11/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser_bind_lb_11_rb_1,1,bind); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,bind_aget(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_AmethystParser__append_lp_5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);
 bind_aset(bind,2/*ary*/,it); it=rb_funcall(self,sy_AmethystParser_Seq_dot_crea1,1,bind); 
 bind_aset(bind,3/*_result*/,it); it=bind_aget(bind,3/*_result*/);
return it;
fail: return failobj; }
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,6/*expr*/,it);   it=Amethyst_spaces(self ); FAILTEST(alt1_3); it=rb_obj_clone(s__rp_1); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_3);it=rb_funcall(self,sy_AmethystParser_Nested_lb_b1,1,bind); 
 bind_aset(bind,5/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=Amethyst_spaces(self ); FAILTEST(alt1_4); it=rb_obj_clone(s_break1); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_4);it=rb_funcall(self,sy_AmethystParser_Seq_lb_Cut_lb_1,1,bind); 
 bind_aset(bind,5/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
alt1_5: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystParser_key(self ); FAILTEST(alt1_6);
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_AmethystParser_Act_lb_Args1,1,bind); 
 bind_aset(bind,5/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;}it=rb_funcall(self,sy_AmethystParser_Act_lb_bind1,1,bind); 
 bind_aset(bind,5/*_result*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
alt6_1: ame_setpos(self,oldpos9);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_12;}
 ...
 bind_aset(bind,17/*ors*/,it); it=rb_funcall(self,sy_AmethystParser_a_eq_autova1,1,bind); 
...
sy_AmethystParser_1=rb_intern("AmethystParser_1");
...
sy_AmethystParser_Act_lb_Args1=rb_intern("AmethystParser_Act_lb_Args1");
sy_AmethystParser_Act_lb_bind1=rb_intern("AmethystParser_Act_lb_bind1");
sy_AmethystParser_Apply_lb_1=rb_intern("AmethystParser_Apply_lb_1");
...
sy_AmethystParser_Apply_lb_bi1=rb_intern("AmethystParser_Apply_lb_bi1");
sy_AmethystParser_Args_lb_1=rb_intern("AmethystParser_Args_lb_1");
...
sy_AmethystParser_Comment_lb_1=rb_intern("AmethystParser_Comment_lb_1");
sy_AmethystParser_Exp_lb__bod1=rb_intern("AmethystParser_Exp_lb__bod1");
sy_AmethystParser_Global_lb_b1=rb_intern("AmethystParser_Global_lb_b1");
sy_AmethystParser_Grammar_dot_1=rb_intern("AmethystParser_Grammar_dot_1");
sy_AmethystParser_Key_lb_bind1=rb_intern("AmethystParser_Key_lb_bind1");
sy_AmethystParser_Lookahea1=rb_intern("AmethystParser_Lookahea1");
sy_AmethystParser_Many_lb_bin1=rb_intern("AmethystParser_Many_lb_bin1");
sy_AmethystParser_Nested_lb_b1=rb_intern("AmethystParser_Nested_lb_b1");
sy_AmethystParser_Object_dot_c1=rb_intern("AmethystParser_Object_dot_c1");
sy_AmethystParser_Or_dot_creat1=rb_intern("AmethystParser_Or_dot_creat1");
sy_AmethystParser_Or_lb_bind_lb_1=rb_intern("AmethystParser_Or_lb_bind_lb_1");
sy_AmethystParser_Pass_lb_bin1=rb_intern("AmethystParser_Pass_lb_bin1");
sy_AmethystParser_Pred_lb_bin1=rb_intern("AmethystParser_Pred_lb_bin1");
sy_AmethystParser_Result_lb_1=rb_intern("AmethystParser_Result_lb_1");
sy_AmethystParser_Rule_dot_cre1=rb_intern("AmethystParser_Rule_dot_cre1");
sy_AmethystParser_Seq_dot_crea1=rb_intern("AmethystParser_Seq_dot_crea1");
sy_AmethystParser_Seq_lb_Cut_lb_1=rb_intern("AmethystParser_Seq_lb_Cut_lb_1");
sy_AmethystParser_Seq_lb__Bin1=rb_intern("AmethystParser_Seq_lb__Bin1");
sy_AmethystParser_Strin_lb_co1=rb_intern("AmethystParser_Strin_lb_co1");
sy_AmethystParser__Bind_lp_bi1=rb_intern("AmethystParser__Bind_lp_bi1");
sy_AmethystParser__Local_lp_b1=rb_intern("AmethystParser__Local_lp_b1");
...
sy_AmethystParser__append_lp_1=rb_intern("AmethystParser__append_lp_1");
...
sy_AmethystParser__at_ary1=rb_intern("AmethystParser__at_ary1");
sy_AmethystParser__at_ary_eq__lb__rb_1=rb_intern("AmethystParser__at_ary_eq__lb__rb_1");
sy_AmethystParser__at_ary_lt__lt_Ar1=rb_intern("AmethystParser__at_ary_lt__lt_Ar1");
sy_AmethystParser__at_bnding1=rb_intern("AmethystParser__at_bnding1");
sy_AmethystParser__at_locals_dot_1=rb_intern("AmethystParser__at_locals_dot_1");
sy_AmethystParser__at_locals_eq_1=rb_intern("AmethystParser__at_locals_eq_1");
sy_AmethystParser__at_tmp_lt__lt_bi1=rb_intern("AmethystParser__at_tmp_lt__lt_bi1");
sy_AmethystParser__body_lp_bi1=rb_intern("AmethystParser__body_lp_bi1");
sy_AmethystParser__di__lb_1=rb_intern("AmethystParser__di__lb_1");
sy_AmethystParser__di__lb__do__dot__co__rb__di_1=rb_intern("AmethystParser__di__lb__do__dot__co__rb__di_1");
sy_AmethystParser__di__lb__dot__co__bs__lb__rb__di_1=rb_intern("AmethystParser__di__lb__dot__co__bs__lb__rb__di_1");
sy_AmethystParser__lb_bind_lb_3_rb_1=rb_intern("AmethystParser__lb_bind_lb_3_rb_1");
sy_AmethystParser__lp_bind_lb_1_rb_1=rb_intern("AmethystParser__lp_bind_lb_1_rb_1");
sy_AmethystParser__lp_bind_lb_5_rb_1=rb_intern("AmethystParser__lp_bind_lb_5_rb_1");
sy_AmethystParser_a_eq_autova1=rb_intern("AmethystParser_a_eq_autova1");
sy_AmethystParser_a_eq_autova2=rb_intern("AmethystParser_a_eq_autova2");
sy_AmethystParser_bind_lb_0_rb_1=rb_intern("AmethystParser_bind_lb_0_rb_1");
sy_AmethystParser_bind_lb_10_rb_1=rb_intern("AmethystParser_bind_lb_10_rb_1");
sy_AmethystParser_bind_lb_10_rb_2=rb_intern("AmethystParser_bind_lb_10_rb_2");
sy_AmethystParser_bind_lb_11_rb_1=rb_intern("AmethystParser_bind_lb_11_rb_1");
sy_AmethystParser_bind_lb_11_rb_2=rb_intern("AmethystParser_bind_lb_11_rb_2");
sy_AmethystParser_bind_lb_12_rb_1=rb_intern("AmethystParser_bind_lb_12_rb_1");
sy_AmethystParser_bind_lb_1_rb__eq_1=rb_intern("AmethystParser_bind_lb_1_rb__eq_1");
sy_AmethystParser_bind_lb_1_rb__ti_1=rb_intern("AmethystParser_bind_lb_1_rb__ti_1");
sy_AmethystParser_bind_lb_3_rb__eq_1=rb_intern("AmethystParser_bind_lb_3_rb__eq_1");
sy_AmethystParser_bind_lb_3_rb__eq_2=rb_intern("AmethystParser_bind_lb_3_rb__eq_2");
sy_AmethystParser_bind_lb_4_rb__pl_1=rb_intern("AmethystParser_bind_lb_4_rb__pl_1");
sy_AmethystParser_bind_lb_4_rb__ti_1=rb_intern("AmethystParser_bind_lb_4_rb__ti_1");
sy_AmethystParser_bind_lb_5_rb__eq_1=rb_intern("AmethystParser_bind_lb_5_rb__eq_1");
sy_AmethystParser_bind_lb_5_rb__pl_1=rb_intern("AmethystParser_bind_lb_5_rb__pl_1");
sy_AmethystParser_bind_lb_6_rb__eq_1=rb_intern("AmethystParser_bind_lb_6_rb__eq_1");
sy_AmethystParser_bind_lb_6_rb__eq_2=rb_intern("AmethystParser_bind_lb_6_rb__eq_2");
sy_AmethystParser_bind_lb_9_rb__pl_1=rb_intern("AmethystParser_bind_lb_9_rb__pl_1");
sy_AmethystParser_leterize1=rb_intern("AmethystParser_leterize1");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('c5bc15a8cecd0ce929aad4b5001113bb')");}
