...
static VALUE sy_AmethystParser_Apply_lb__dq_r_c360;
...
static VALUE sy_AmethystParser_bind_lb_7_rb__dot__c17d;
...
alt4_1: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}
 unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(46) ... UC(46):;   it=AmethystCore_anything(self ); FAILTEST(alt4_2);if (strncmp(ame_curstr(self),"..",2)) goto alt4_2; else ame_setpos(self,ame_getpos(self)+2); break;case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_2); break;} 
ame_setcut(self,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}
 unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(46) ... UC(46):;   it=AmethystCore_anything(self ); FAILTEST(alt4_3);if (strncmp(ame_curstr(self),".",1)) goto alt4_3; else ame_setpos(self,ame_getpos(self)+1); break;case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_3); break;} 
ame_setcut(self,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos4); goto alt3_2;
 accept4:;
unsigned char chr6=*ame_curstr(self);  switch(chr6){case UC(45) ... UC(45):;case UC(48) ... UC(57):;   it=Amethyst_number(self ); FAILTEST(alt3_2); bind_aset(bind,5/*num*/,it);
...
alt1_3: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 it=bind_aget(bind,6/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_4);it=bind_aget(bind,6/*s*/);it=rb_ary_new3(0); bind_aset(bind,7/*x*/,it);
...
alt5_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__gt__cedf); bind_aset(bind,6/*s*/,it);
unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(62) ... UC(62):;   it=AmethystCore_anything(self ); FAILTEST(alt5_2); break;case UC(0) ... UC(61):;case UC(63) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt5_2); break;}ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
...
alt6_1: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
 unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(92) ... UC(92):;   it=AmethystCore_anything(self ); FAILTEST(alt6_2); break;case UC(0) ... UC(91):;case UC(93) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt6_2); break;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,8/*_result*/,it);
it=bind_aget(bind,8/*_result*/); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__4f82,1,bind);  
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=rb_funcall(self,sy_AmethystParser_bind_lb_7_rb__dot__c17d,1,bind);  bind_aset(bind,11/*_result*/,it);
it=bind_aget(bind,11/*_result*/); bind_aset(bind,12/*s*/,it);
it=rb_funcall(self,sy_AmethystParser_Apply_lb__dq_r_c360,1,bind);  bind_aset(bind,1/*_result*/,it);
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 break;case UC(0) ... UC(122):;case UC(124) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_2); break;} 
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
alt2_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(97) ... UC(97):;   it=AmethystCore_anything(self ); FAILTEST(alt2_2);if (strncmp(ame_curstr(self),"methyst",7)) goto alt2_2; else ame_setpos(self,ame_getpos(self)+7); break;case UC(0) ... UC(96):;case UC(98) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt2_2); break;}ame_setcut(self,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt2_2); 
ame_setcut(self,Qnil);goto accept2;
...
alt4_1: ame_setpos(self,oldpos5);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}
 unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(64) ... UC(64):;   it=AmethystParser_key(self ); FAILTEST(alt4_2); bind_aset(bind,3/*name*/,it);
 break;case UC(0) ... UC(63):;case UC(65) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_2); break;} 
ame_setcut(self,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos5);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}
 unsigned char chr9=*ame_curstr(self);  switch(chr9){case UC(65) ... UC(90):;case UC(95) ... UC(95):;case UC(97) ... UC(122):;   it=AmethystParser_name(self ); FAILTEST(alt4_3); bind_aset(bind,3/*name*/,it);
 break;case UC(0) ... UC(64):;case UC(91) ... UC(94):;case UC(96) ... UC(96):;case UC(123) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_3); break;} 
ame_setcut(self,Qnil);goto accept4;
...
alt5_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_2;}
 unsigned char chr10=*ame_curstr(self);  switch(chr10){case UC(91) ... UC(91):;   it=AmethystCore_anything(self ); FAILTEST(alt5_2);if (strncmp(ame_curstr(self),"]",1)) goto alt5_2; else ame_setpos(self,ame_getpos(self)+1); break;case UC(0) ... UC(90):;case UC(92) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt5_2); break;}it=rb_obj_clone(s__lb__rb__d751); bind_aset(bind,4/*_result*/,it);
...
alt3_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_6;}
 unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(123) ... UC(123):;   it=AmethystParser_inline_host_expr(self ); FAILTEST(alt3_3); bind_aset(bind,1/*e*/,it);
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 break;case UC(0) ... UC(37):;case UC(39) ... UC(125):;case UC(127) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_2); break;}it=bind_aget(bind,0/*autovar*/); bind_aset(bind,1/*autovar*/,it);
int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*neg*/,it);
unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC(123) ... UC(123):;   it=AmethystParser_inline_host_expr(self ); FAILTEST(alt2_2); bind_aset(bind,3/*expr*/,it);
 break;case UC(0) ... UC(122):;case UC(124) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt2_2); break;}it=rb_funcall(self,sy_AmethystParser_Pred_lb_bin_bcee,1,bind);  bind_aset(bind,4/*_result*/,it);
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(96) ... UC(96):;   it=AmethystCore_anything(self ); FAILTEST(alt1_2); break;case UC(0) ... UC(95):;case UC(97) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_2); break;}  it=AmethystParser_expression(self ); FAILTEST(alt1_2); bind_aset(bind,1/*e*/,it);
...
alt1_5: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC(34) ... UC(34):;   it=AmethystCore_anything(self ); FAILTEST(alt1_6); break;case UC(0) ... UC(33):;case UC(35) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_6); break;}it=rb_ary_new3(0); bind_aset(bind,7/*x*/,it);
int oldpos2; while(1){oldpos2=ame_getpos(self); int oldpos3=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(34) ... UC(34):;   it=AmethystCore_anything(self ); FAILTEST(alt2_2); break;case UC(0) ... UC(33):;case UC(35) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt2_2); break;}ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 it=rb_obj_clone(s__re__cbb1); bind_aset(bind,3/*c*/,it);
it=rb_funcall(self,sy_AmethystParser__qu__sh__le__qu__9722,1,bind);  bind_aset(bind,4/*o*/,it);
...
alt3_1: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_4;}
 unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(92) ... UC(92):;   it=AmethystCore_anything(self ); FAILTEST(alt3_2); break;case UC(0) ... UC(91):;case UC(93) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt3_2); break;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,9/*_result*/,it);
...
alt1_7: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(39) ... UC(39):;   it=AmethystCore_anything(self ); FAILTEST(alt1_8); break;case UC(0) ... UC(38):;case UC(40) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_8); break;}it=rb_ary_new3(0); bind_aset(bind,14/*x*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 unsigned char chr9=*ame_curstr(self);  switch(chr9){case UC(39) ... UC(39):;   it=AmethystCore_anything(self ); FAILTEST(alt4_2); break;case UC(0) ... UC(38):;case UC(40) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_2); break;}ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept4;
...
alt5_1: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt4_3;}
 unsigned char chr10=*ame_curstr(self);  switch(chr10){case UC(92) ... UC(92):;   it=AmethystCore_anything(self ); FAILTEST(alt5_2); break;case UC(0) ... UC(91):;case UC(93) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt5_2); break;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,9/*_result*/,it);
...
alt1_8: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(46) ... UC(46):;   it=AmethystCore_anything(self ); FAILTEST(alt1_9);if (strncmp(ame_curstr(self),"..",2)) goto alt1_9; else ame_setpos(self,ame_getpos(self)+2); break;case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_9); break;}it=rb_obj_clone(s__dot__dot__dot__2f43); bind_aset(bind,9/*_result*/,it);
...
alt1_9: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr12=*ame_curstr(self);  switch(chr12){case UC(46) ... UC(46):;   it=AmethystCore_anything(self ); FAILTEST(alt1_10);if (strncmp(ame_curstr(self),".",1)) goto alt1_10; else ame_setpos(self,ame_getpos(self)+1); break;case UC(0) ... UC(45):;case UC(47) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_10); break;}it=rb_obj_clone(s__dot__dot__58b9); bind_aset(bind,9/*_result*/,it);
it=bind_aget(bind,9/*_result*/); bind_aset(bind,2/*_result*/,it);
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(110) ... UC(110):;   it=AmethystCore_anything(self ); FAILTEST(alt1_2);if (strncmp(ame_curstr(self),"ested(",6)) goto alt1_2; else ame_setpos(self,ame_getpos(self)+6); break;case UC(0) ... UC(109):;case UC(111) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_2); break;}  it=AmethystParser_expression(self ); FAILTEST(alt1_2); bind_aset(bind,0/*expr*/,it);
...
ame_setcut(self,Qnil);goto accept1;
alt1_9: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(34) ... UC(34):;   it=AmethystCore_anything(self ); FAILTEST(alt1_10); break;case UC(0) ... UC(33):;case UC(35) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_10); break;}it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
...
alt3_1: ame_setpos(self,oldpos5);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 unsigned char chr12=*ame_curstr(self);  switch(chr12){case UC(34) ... UC(34):;   it=AmethystCore_anything(self ); FAILTEST(alt3_2); break;case UC(0) ... UC(33):;case UC(35) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt3_2); break;}ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept4;
...
alt4_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt3_3;}
 unsigned char chr13=*ame_curstr(self);  switch(chr13){case UC(92) ... UC(92):;   it=AmethystCore_anything(self ); FAILTEST(alt4_2); break;case UC(0) ... UC(91):;case UC(93) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt4_2); break;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr14=*ame_curstr(self);  switch(chr14){case UC(39) ... UC(39):;   it=AmethystCore_anything(self ); FAILTEST(alt1_11); break;case UC(0) ... UC(38):;case UC(40) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_11); break;}it=rb_ary_new3(0); bind_aset(bind,4/*x*/,it);
...
alt5_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}
 unsigned char chr15=*ame_curstr(self);  switch(chr15){case UC(39) ... UC(39):;   it=AmethystCore_anything(self ); FAILTEST(alt5_2); break;case UC(0) ... UC(38):;case UC(40) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt5_2); break;}ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept6;
...
alt6_1: ame_setpos(self,oldpos9);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt5_3;}
 unsigned char chr16=*ame_curstr(self);  switch(chr16){case UC(92) ... UC(92):;   it=AmethystCore_anything(self ); FAILTEST(alt6_2); break;case UC(0) ... UC(91):;case UC(93) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt6_2); break;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_AmethystParser__append_lp__b9cb,1,bind);  
ame_setcut(self,Qnil);goto accept7;
...
ame_setcut(self,Qnil);goto accept1;
alt1_12: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 unsigned char chr17=*ame_curstr(self);  switch(chr17){case UC(40) ... UC(40):;   it=AmethystCore_anything(self ); FAILTEST(alt1_13); break;case UC(0) ... UC(39):;case UC(41) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt1_13); break;}  it=AmethystParser_expression(self ); FAILTEST(alt1_13); bind_aset(bind,11/*x*/,it);
...
sy_AmethystParser_Apply_lb__dq_r_c360=rb_intern("AmethystParser_Apply_lb__dq_r_c360");
...
sy_AmethystParser_bind_lb_7_rb__dot__c17d=rb_intern("AmethystParser_bind_lb_7_rb__dot__c17d");
...
rb_define_method(cls_AmethystParser,"term",AmethystParser_term,0);
 rb_eval_string("testversionparser('afbcca0a76e27218f5d1d9e9a2a7f101')");}
