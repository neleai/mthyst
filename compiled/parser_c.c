...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,7,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_7);
 rb_ary_store(bind,8,it); it=CALL(rubyarg_AmethystParsercb_5,1,bind); FAILTEST(alt1_7);it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it); it=CALL(rubyarg_AmethystParsercb_6,1,bind); FAILTEST(alt1_7);it=rb_ary_entry(bind,10);
 rb_ary_store(bind,11,it); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept1;
  alt1_7:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 break;default:; int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2("`"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);  it=AmethystParser_expression(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,12,it);  it=rb_str_new2("`"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=CALL(rubyarg_AmethystParsercb_7,1,bind); 
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2(")");
 rb_ary_store(bind,2,it); it=rb_str_new2("(");
 rb_ary_store(bind,3,it);  it=rb_str_new2("("); arg0=it;it=rb_str_new2(")"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt2_3);
 rb_ary_store(bind,4,it); it=CALL(rubyarg_AmethystParsercb_8,1,bind); 
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("]");
 rb_ary_store(bind,2,it); it=rb_str_new2("[");
 rb_ary_store(bind,3,it);  it=rb_str_new2("["); arg0=it;it=rb_str_new2("]"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt2_4);
 rb_ary_store(bind,4,it); it=CALL(rubyarg_AmethystParsercb_9,1,bind); 
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_4: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("}");
 rb_ary_store(bind,2,it); it=rb_str_new2("{");
 rb_ary_store(bind,3,it);  it=rb_str_new2("{"); arg0=it;it=rb_str_new2("}"); arg1=it; it=AmethystParser___args(self ,arg0,arg1); FAILTEST(alt2_5);
 rb_ary_store(bind,4,it); it=CALL(rubyarg_AmethystParsercb_10,1,bind); 
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_5: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2("\""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_6);
 rb_ary_store(bind,13,it); it=CALL(rubyarg_AmethystParsercb_11,1,bind); it=rb_ary_new3(0);
 rb_ary_store(bind,14,it); int oldpos3; while(1){oldpos3=ame_getpos(self); int oldpos4=ame_getpos(self);
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
it=CALL(rubyarg_AmethystParsercb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,14);
 rb_ary_store(bind,16,it); it=CALL(rubyarg_AmethystParsercb_13,1,bind); it=CALL(rubyarg_AmethystParsercb_14,1,bind); 
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_6: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2("\'"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_7);
 rb_ary_store(bind,17,it); it=CALL(rubyarg_AmethystParsercb_15,1,bind); it=rb_ary_new3(0);
 rb_ary_store(bind,18,it); int oldpos5; while(1){oldpos5=ame_getpos(self); int oldpos6=ame_getpos(self);
...
ISET(cut,Qnil);goto accept4;
 ...
 accept4:;
it=CALL(rubyarg_AmethystParsercb_16,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,18);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_17,1,bind); it=CALL(rubyarg_AmethystParsercb_18,1,bind); 
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_7: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2("..."); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_8);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_8: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=rb_str_new2(".."); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_9);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_9: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos7=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_10;}
 it=rb_str_new2(":@");  it=AmethystParser_spaces(self ); FAILTEST(alt5_2); it=rb_str_new2(":@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_2);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_10;}
 it=CALL(rubyarg_AmethystParsercb_19,1,bind); 
 rb_ary_store(bind,7,it);   it=AmethystCore_anything(self ); FAILTEST(alt5_3);
 rb_ary_store(bind,8,it); it=CALL(rubyarg_AmethystParsercb_20,1,bind); FAILTEST(alt5_3);it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it); it=CALL(rubyarg_AmethystParsercb_21,1,bind); FAILTEST(alt5_3);it=rb_ary_entry(bind,10);
 rb_ary_store(bind,11,it); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept5;
alt5_3: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_10;}
   it=AmethystParser_empty(self ); FAILTEST(alt5_4); 
ISET(cut,Qnil);goto accept5;
  alt5_4:  ame_setpos(self,oldpos7); goto alt2_10;
 accept5:;
int oldpos8=ame_getpos(self);
alt6_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_10;}
   it=AmethystParser__(self ); FAILTEST(alt6_2);ISET(cut,Qtrue);  it=AmethystParser_fails(self ); FAILTEST(alt6_2); 
ISET(cut,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_10;}
   it=AmethystParser_empty(self ); FAILTEST(alt6_3); 
ISET(cut,Qnil);goto accept6;
  alt6_3:  ame_setpos(self,oldpos8); goto alt2_10;
 accept6:;
  it=AmethystParser_name(self ); FAILTEST(alt2_10);
 rb_ary_store(bind,22,it); it=CALL(rubyarg_AmethystParsercb_22,1,bind); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_10: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos9=ame_getpos(self);
alt7_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_11;}
   it=AmethystParser__(self ); FAILTEST(alt7_2);ISET(cut,Qtrue);  it=AmethystParser_fails(self ); FAILTEST(alt7_2); 
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt2_11;}
   it=AmethystParser_empty(self ); FAILTEST(alt7_3); 
ISET(cut,Qnil);goto accept7;
  alt7_3:  ame_setpos(self,oldpos9); goto alt2_11;
 accept7:;
  it=AmethystParser_key(self ); FAILTEST(alt2_11);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
alt2_11: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(rubyarg_AmethystParsercb_23,1,bind); 
 rb_ary_store(bind,7,it);   it=AmethystCore_anything(self ); FAILTEST(alt2_12);
 rb_ary_store(bind,8,it); it=CALL(rubyarg_AmethystParsercb_24,1,bind); FAILTEST(alt2_12);it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it); it=CALL(rubyarg_AmethystParsercb_25,1,bind); FAILTEST(alt2_12);it=rb_ary_entry(bind,10);
 rb_ary_store(bind,11,it); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept2;
  alt2_12:  ame_setpos(self,oldpos2); goto fail;
 accept2:;
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversionparser('139fd9f845f6918bdc29be1eacbae5b3')");}
