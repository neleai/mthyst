...
VALUE AmethystParser___args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=rb_ary_new2(6); rb_ary_store(bind,0,a0);rb_ary_store(bind,4,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,2,it); it=CALL(procargs2_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,1);
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,2,it);  it=rb_str_new2("::"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_name(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,3,it); it=CALL(application_AmethystParsercb_1,1,bind); 
...
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,4,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystParser_rubyarg(self ); FAILTEST(break1);
 rb_ary_store(bind,5,it); it=CALL(args_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,6,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_entry(bind,6);
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,8,it); it=CALL(args_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,9,it); it=CALL(args_AmethystParsercb_3,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,10,it); int oldpos5=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
it=rb_ary_entry(bind,14);
 rb_ary_store(bind,15,it); it=CALL(application_AmethystParsercb_2,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,5,it);  it=rb_ary_entry(bind,5); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_spaces(self ); FAILTEST(alt1_2); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_new3(0);
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,2,it); it=CALL(atomicHostExpr_AmethystParsercb_1,1,bind); 
 rb_ary_store(bind,3,it); it=CALL(atomicHostExpr_AmethystParsercb_2,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,1,it); it=CALL(inlineHostExpr_AmethystParsercb_1,1,bind); it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,3,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it); it=CALL(name_AmethystParsercb_2,1,bind); it=rb_ary_entry(bind,0);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it); it=CALL(choice_AmethystParsercb_1,1,bind);
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,3,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it); it=CALL(name_AmethystParsercb_2,1,bind); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,5,it); it=CALL(name_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,6,it); it=rb_ary_entry(bind,6);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,0,it); it=CALL(char_AmethystParsercb_1,1,bind); FAILTEST(alt1_2);it=rb_ary_entry(bind,0);
 rb_ary_store(bind,1,it); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,2,it); it=CALL(eChar_AmethystParsercb_1,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("}");
 rb_ary_store(bind,4,it); it=CALL(eChar_AmethystParsercb_2,1,bind); 
 ...
 rb_ary_store(bind,6,it); it=CALL(eChar_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_4);
 rb_ary_store(bind,0,it); it=CALL(char_AmethystParsercb_1,1,bind); FAILTEST(alt1_4);it=rb_ary_entry(bind,0);
 rb_ary_store(bind,1,it); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,3,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it);   it=AmethystParser_spaces(self ); FAILTEST(fail); it=rb_str_new2("}"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);it=CALL(grammar_AmethystParsercb_2,1,bind);
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
...
ISET(cut,Qnil);goto accept2;
 ...
 rb_ary_store(bind,2,it); it=CALL(procargs2_AmethystParsercb_1,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); int oldpos5=ame_getpos(self);
...
ISET(cut,Qnil);goto accept3;
 ...
 rb_ary_store(bind,3,it); it=CALL(igrammar_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,4,it); it=CALL(igrammar_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,5,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
...
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
it=CALL(igrammar_AmethystParsercb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,6,it); it=rb_ary_entry(bind,6);
 rb_ary_store(bind,7,it); it=rb_ary_entry(bind,7);
return it;
fail: return failobj; }
...
VALUE AmethystParser_key(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(4);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_ary_entry(bind,0); it=rb_str_new2("@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);  it=AmethystParser_className(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,1,it); it=CALL(key_AmethystParsercb_1,1,bind); 
 rb_ary_store(bind,2,it); it=CALL(key_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_ary_entry(bind,0); it=rb_str_new2("@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_3);  it=AmethystParser_name(self ); FAILTEST(alt1_3);
 rb_ary_store(bind,1,it); it=CALL(key_AmethystParsercb_3,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_ary_entry(bind,0); it=rb_str_new2("@@"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_4);  it=AmethystParser_name(self ); FAILTEST(alt1_4);
 rb_ary_store(bind,1,it); it=CALL(key_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,6,it); it=CALL(number_AmethystParsercb_2,1,bind); it=rb_ary_entry(bind,0);
...
ISET(cut,Qnil);goto accept2;
 ...
 accept2:;
  it=AmethystCore_anything(self ); FAILTEST(break1);
 rb_ary_store(bind,3,it); it=CALL(name_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it); it=CALL(modifier_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,0,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_2;}
 ...
 rb_ary_store(bind,1,it); it=CALL(inlineHostExpr_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it); it=CALL(inlineHostExpr_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(inlineHostExpr_AmethystParsercb_3,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,2,it); it=CALL(spaces_AmethystParsercb_2,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it); it=CALL(spaces_AmethystParsercb_3,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,4);
 rb_ary_store(bind,5,it); it=rb_ary_entry(bind,5);
 rb_ary_store(bind,6,it); it=CALL(number_AmethystParsercb_2,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self); it=CALL(number_AmethystParsercb_1,1,bind); 
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,2,it); int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
 it=rb_ary_entry(bind,2); it=rb_str_new2("&"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
 it=rb_ary_entry(bind,2); it=rb_str_new2("~"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_3);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it);  
ISET(cut,Qnil);goto accept2;
 ...
 rb_ary_store(bind,5,it); it=CALL(prefixed_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
alt3_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_4;}
 ...
 rb_ary_store(bind,7,it);   it=AmethystCore_anything(self ); FAILTEST(reject1);
 rb_ary_store(bind,8,it); it=CALL(prefixed_AmethystParsercb_4,1,bind); FAILTEST(reject1);it=rb_ary_entry(bind,8);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,10,it); it=CALL(prefixed_AmethystParsercb_5,1,bind); FAILTEST(reject1); x=1; goto accept4;  reject1: x=0; accept4: it=Qnil; ame_setpos(self,oldpos4); if (x==0) goto alt3_3;int oldpos5=ame_getpos(self);
...
ISET(cut,Qnil);goto accept6;
 ...
 rb_ary_store(bind,11,it); int oldpos8=ame_getpos(self);
alt6_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_ary_entry(bind,11); it=rb_str_new2("=>"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_2);  it=AmethystParser_prefixed(self ); FAILTEST(alt6_2);
 rb_ary_store(bind,12,it); it=CALL(prefixed_AmethystParsercb_7,1,bind);  
ISET(cut,Qnil);goto accept7;
alt6_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_ary_entry(bind,11); it=rb_str_new2("["); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_3);  it=AmethystParser_expression(self ); FAILTEST(alt6_3);
 rb_ary_store(bind,12,it); it=CALL(prefixed_AmethystParsercb_8,1,bind);   it=AmethystParser_spaces(self ); FAILTEST(alt6_3); it=rb_str_new2("]"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_3); 
ISET(cut,Qnil);goto accept7;
alt6_3: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_ary_entry(bind,11);
 rb_ary_store(bind,13,it); int oldpos9=ame_getpos(self);
alt7_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
 it=rb_ary_entry(bind,13); it=rb_str_new2("*"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,14,it);  
ISET(cut,Qnil);goto accept8;
alt7_2: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
 it=rb_ary_entry(bind,13); it=rb_str_new2("+"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,14,it);  
ISET(cut,Qnil);goto accept8;
...
alt6_4: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_ary_entry(bind,11); it=rb_str_new2("?"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_5);it=CALL(prefixed_AmethystParsercb_10,1,bind); 
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept7;
alt6_5: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=rb_ary_entry(bind,11); it=rb_str_new2(":"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt6_6);int oldpos10=ame_getpos(self);
...
alt8_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_6;}
 ...
 rb_ary_store(bind,17,it); it=CALL(prefixed_AmethystParsercb_12,1,bind); 
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept9;
...
ISET(cut,Qnil);goto accept7;
 ...
 accept7:;
 if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,6);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
VALUE AmethystParser_regch(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_ary_new2(5); rb_ary_store(bind,3,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,0,it); it=CALL(char_AmethystParsercb_1,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,0);
 rb_ary_store(bind,1,it); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,2,it); it=CALL(regch_AmethystParsercb_1,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,4,it); it=rb_ary_entry(bind,4);
return it;
fail: return failobj; }
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); it=CALL(term_AmethystParsercb_7,1,bind); it=rb_ary_new3(0);
...
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos3); goto break1;
 accept2:;
it=CALL(rubyarg_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,11,it); it=CALL(rubyarg_AmethystParsercb_3,1,bind); it=CALL(rubyarg_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,12,it); it=CALL(rubyarg_AmethystParsercb_5,1,bind); it=rb_ary_new3(0);
...
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos5); goto break2;
 accept3:;
it=CALL(rubyarg_AmethystParsercb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,13);
 rb_ary_store(bind,15,it); it=CALL(rubyarg_AmethystParsercb_7,1,bind); it=CALL(rubyarg_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
...
alt4_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_8;}
 ...
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_9,1,bind); FAILTEST(alt4_3);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_10,1,bind); FAILTEST(alt4_3);it=rb_ary_entry(bind,20);
...
ISET(cut,Qnil);goto accept5;
 ...
 rb_ary_store(bind,22,it); it=CALL(rubyarg_AmethystParsercb_11,1,bind); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_9,1,bind); FAILTEST(alt1_10);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_10,1,bind); FAILTEST(alt1_10);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
...
alt7_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,2,it);  it=rb_str_new2("`"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt7_2);it=CALL(rubyarg_AmethystParsercb_1,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
ISET(cut,Qnil);goto accept8;
 ...
 accept8:;
it=CALL(rubyarg_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,11,it); it=CALL(rubyarg_AmethystParsercb_3,1,bind); it=CALL(rubyarg_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
ISET(cut,Qnil);goto accept9;
 ...
 accept9:;
it=CALL(rubyarg_AmethystParsercb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos12); it=rb_ary_entry(bind,13);
 rb_ary_store(bind,15,it); it=CALL(rubyarg_AmethystParsercb_7,1,bind); it=CALL(rubyarg_AmethystParsercb_4,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
alt10_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_10;}
 ...
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_9,1,bind); FAILTEST(alt10_3);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_10,1,bind); FAILTEST(alt10_3);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept10;
...
alt7_11: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,18,it); it=CALL(rubyarg_AmethystParsercb_9,1,bind); FAILTEST(alt7_12);it=rb_ary_entry(bind,18);
 rb_ary_store(bind,19,it); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,20,it); it=CALL(rubyarg_AmethystParsercb_10,1,bind); FAILTEST(alt7_12);it=rb_ary_entry(bind,20);
 rb_ary_store(bind,21,it); it=rb_ary_entry(bind,21);
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept7;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,1,it); it=CALL(inlineHostExpr_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it);  it=rb_str_new2(")"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_2);it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,4,it); it=CALL(inlineHostExpr_AmethystParsercb_2,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(inlineHostExpr_AmethystParsercb_3,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
it=rb_ary_entry(bind,10);
 rb_ary_store(bind,11,it); it=CALL(argsOpt_AmethystParsercb_3,1,bind); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,1,it); it=CALL(inlineHostExpr_AmethystParsercb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it); it=CALL(sequence_AmethystParsercb_1,1,bind);
 rb_ary_store(bind,3,it); it=rb_ary_entry(bind,3);
return it;
fail: return failobj; }
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,6,it); int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 it=rb_ary_entry(bind,6); it=rb_str_new2("->"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_2);  it=AmethystParser_atomicHostExpr(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
 it=rb_ary_entry(bind,6); it=rb_str_new2(""); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt2_3);  it=AmethystParser_inlineHostExpr(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,1,it);  
ISET(cut,Qnil);goto accept2;
...
alt3_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=AmethystParser_eChar(self ); FAILTEST(alt3_3);
 rb_ary_store(bind,7,it); it=CALL(spaces_AmethystParsercb_4,1,bind);  
ISET(cut,Qnil);goto accept3;
...
alt4_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 ...
 rb_ary_store(bind,8,it); it=CALL(term_AmethystParsercb_7,1,bind);  
ISET(cut,Qnil);goto accept4;
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,5,it); it=CALL(term_AmethystParsercb_9,1,bind); 
 rb_ary_store(bind,3,it);  
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=rb_str_new2("<");
 rb_ary_store(bind,9,it);   it=AmethystParser_spaces(self ); FAILTEST(alt1_11); it=rb_ary_entry(bind,9); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt1_11);int oldpos7; while(1){oldpos7=ame_getpos(self); int oldpos8=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
 it=rb_str_new2(">");
 rb_ary_store(bind,9,it);   it=AmethystParser_spaces(self ); FAILTEST(alt5_2); it=rb_str_new2(">"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(alt5_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
   it=AmethystParser_eChar(self ); FAILTEST(alt5_3);
 rb_ary_store(bind,10,it); it=CALL(term_AmethystParsercb_10,1,bind);  
ISET(cut,Qnil);goto accept5;
...
alt6_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_12;}
 ...
 rb_ary_store(bind,11,it); it=CALL(term_AmethystParsercb_12,1,bind); 
...
rb_define_method(cls_AmethystParser,"upper",AmethystParser_upper,0);
 rb_eval_string("testversionparser('cb40cb2441a28f1148e1531889a52499')");}
