...
VALUE profile_report_Resolve_Calls(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  return Qnil;}VALUE Resolve_Calls_root(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,__result=Qnil,_autovar_7=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;  it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;} _autovar_3=it;;
bind_aset(bind2,1,_autovar_2);bind_aset(bind2,2,_autovar_3);it=rb_funcall(self,sy_Resolve_Calls_bind_lb_1_rb__lb__7c6b,1,bind2);_autovar_2=bind_aget(bind2,1);;_autovar_3=bind_aget(bind2,2);;switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Rule*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_4=it;;
 break;
case 1/*Object*/:; if (1){it=failobj;goto fail;} break;
}cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_4);
                   it=rb_funcall(self,sy_Resolve_Calls_src_dot_name_80f3,1,bind2); _autovar_5=it;;
bind_aset(bind2,1,_autovar_2);bind_aset(bind2,2,_autovar_5);it=rb_funcall(self,sy_Resolve_Calls_bind_lb_1_rb__lb__9d9a,1,bind2);_autovar_2=bind_aget(bind2,1);;_autovar_5=bind_aget(bind2,2);;bind_aset(bind2,1,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls__at__contex_d6d5,1,bind2);_autovar_2=bind_aget(bind2,1);;  it=Resolve_Calls_traverse(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_6=it;;
 ...
 _autovar_7=it;;
bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_7);it=rb_funcall(self,sy_Resolve_Calls__at__contex_cdb3,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_7=bind_aget(bind2,2);;
fail: return it;
}
VALUE Resolve_Calls_traverse(VALUE self ){VALUE vals[0]; VALUE it ,_nvars=Qnil,_ivars=Qnil,_autovar=Qnil,_autovar_2=Qnil,_it=Qnil,__result=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);ptr->pos=ptr->len;it=rb_ary_new3(0); _nvars=it;;
it=rb_funcall(self,sy_Resolve_Calls__lp_src_dot_cla_2024,1,bind2); _ivars=it;;
...
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Resolve_Calls_traverse_item(self ); if (it==failobj){it=failobj;goto revert1;} _it=it;;
bind_aset(bind2,1,_nvars);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Resolve_Calls_bind_lb_1_rb__sp__6af0,1,bind2);_nvars=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto pass2;};
 accept1:;
                   ...
                   pass1: *ptr=oldpass1;if (1){it=failobj;goto fail;}
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,_ivars);bind_aset(bind2,2,_nvars);it=rb_funcall(self,sy_Resolve_Calls_if_sp_bind_lb__1bed,1,bind2);_ivars=bind_aget(bind2,1);;_nvars=bind_aget(bind2,2);; __result=it;;

fail: return it;
}
VALUE Resolve_Calls_traverse_item(VALUE self ){VALUE vals[0]; VALUE it ,__result=Qnil,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_ar=Qnil,_it=Qnil,_autovar_4=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_4,rb_obj_class(ame_curobj2(ptr))))){case 0/*AmethystAST*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3;   it=Resolve_Calls_visit(self ); if (it==failobj){it=failobj;goto revert1;} __result=it;;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Resolve_Calls_traverse(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Resolve_Calls_traverse(self ); if (it==failobj){it=failobj;goto pass2;} _autovar_2=it;;
...
case 1/*Array*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_6,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos3=ptr->pos;int cut3=0;
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Resolve_Calls_visit(self ); if (it==failobj){it=failobj;goto revert6;} __result=it;;
...
alt4_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Resolve_Calls_traverse_item(self ); if (it==failobj){it=failobj;goto revert8;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Resolve_Calls_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
alt5_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Resolve_Calls_traverse_item(self ); if (it==failobj){it=failobj;goto revert10;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Resolve_Calls_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
case 2/*Object*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_7,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos6=ptr->pos;int cut6=0;
alt6_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Resolve_Calls_visit(self ); if (it==failobj){it=failobj;goto revert12;} __result=it;;
...
VALUE Resolve_Calls_visit(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,__result=Qnil,_autovar_9=Qnil,_autovar_10=Qnil,_name=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,_args=Qnil,_autovar_13=Qnil,_autovar_14=Qnil,_autovar_15=Qnil,_autovar_16=Qnil,_autovar_17=Qnil;VALUE bind2=bind_new2(3);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_3=it;;
it=_autovar_3; _autovar_4=it;;
it=_autovar_4; _autovar_5=it;;
int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3; it=_autovar_5; _autovar_6=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_6);
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_7=it;;
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_7);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'r':;case 't' ... UC(255):; if (1){it=failobj;goto pass2;} break;
case 's' ... 's':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='u'&&ame_curstr2(ptr)[1]=='p'&&ame_curstr2(ptr)[2]=='e'&&ame_curstr2(ptr)[3]=='r')  ptr->pos+=4; else if (1){it=failobj;goto pass2;} break;
}
                   goto success2;
                   pass2: *ptr=oldpass2;if (1){it=failobj;goto pass1;}
                   success2: *ptr=oldpass2;
                bind_aset(bind2,1,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls_super_na_296f,1,bind2);_autovar_2=bind_aget(bind2,1);; _autovar_8=it;;
...
;ptr->branches-=3; goto accept1;
alt1_2: ptr->pos=oldpos1;ptr->branches-=1; it=_autovar_5; _autovar_10=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_10);
                   switch(FIX2LONG(rb_hash_aref(switchhash_Resolve_Calls_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Array*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _name=it;;
it=rb_ary_new3(0); _autovar_11=it;;
int stop1=0; while(!stop1){ int oldpos2=ptr->pos;int cut2=0;
alt2_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert3;} _autovar_12=it;;
...
alt2_3: ptr->pos=oldpos2;ptr->branches-=1;if (1){it=failobj;goto pass3;};
 accept4:;
 } it=_autovar_11; _args=it;;
bind_aset(bind2,1,_name);bind_aset(bind2,2,_args);it=rb_funcall(self,sy_Resolve_Calls_Apply_lb_bi_2f93,1,bind2);_name=bind_aget(bind2,1);;_args=bind_aget(bind2,2);; _autovar_13=it;;
 break;
...
;ptr->branches-=2; goto accept1;
alt1_3: ptr->pos=oldpos1;ptr->branches-=1; it=_autovar_5; _autovar_14=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert6;} _autovar_16=it;;
...
alt3_3: ptr->pos=oldpos3;ptr->branches-=1;if (1){it=failobj;goto pass4;};
 accept8:;
 } it=_autovar_15; _args=it;;
bind_aset(bind2,1,_name);bind_aset(bind2,2,_args);bind_aset(bind2,3,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls_Apply_lb_bi_49fd,1,bind2);_name=bind_aget(bind2,1);;_args=bind_aget(bind2,2);;_autovar_2=bind_aget(bind2,3);; _autovar_17=it;;
...
alt1_4: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto fail;};
 accept1:;
bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_9);it=rb_funcall(self,sy_Resolve_Calls__at__contex_cdb3,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_9=bind_aget(bind2,2);; break;
case 1/*Object*/:; bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Resolve_Calls__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;if (1){it=failobj;goto fail;} break;
}
fail: return it;
}
