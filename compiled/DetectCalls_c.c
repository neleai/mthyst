...
VALUE DetectCalls_traverse_item(VALUE self ) {
    ...
    case 0/*AmethystAST*/:
        ;
        switch(FIX2LONG(rb_hash_aref(switchhash_DetectCalls_4,rb_obj_class(ame_curobj2(ptr))))) {
        case 0/*Apply*/:
            ;
            int oldpos1=ptr->pos;
            int cut1=0;
...
accept5:
    ...
    case 1/*Array*/:
        ;
        switch(FIX2LONG(rb_hash_aref(switchhash_DetectCalls_5,rb_obj_class(ame_curobj2(ptr))))) {
        case 0/*Apply*/:
            ;
            int oldpos3=ptr->pos;
            int cut3=0;
...
alt6_1:
                ;
                VALUE revert12autovar_5=rb_funcall(_autovar_5,rb_intern("dup"),0);
                it=DetectCalls_traverse_item(self );
                if (it==failobj) {
                    it=failobj;
                    goto revert12;
...
accept15:
    ...
    case 2/*Object*/:
        ;
        switch(FIX2LONG(rb_hash_aref(switchhash_DetectCalls_6,rb_obj_class(ame_curobj2(ptr))))) {
        case 0/*Apply*/:
            ;
            int oldpos7=ptr->pos;
            int cut7=0;
...
VALUE DetectCalls_visit(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_autovar=Qnil,_name=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,__result=Qnil;
    VALUE bind2=bind_new2(16);
    VALUE arg0,arg1,arg2,arg3;
    cstruct *ptr;
    Data_Get_Struct(self,cstruct,ptr);
