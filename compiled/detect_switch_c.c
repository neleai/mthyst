...
static VALUE sy_First_Dataflow__append_lp__05b0;
...
static VALUE sy_First_Dataflow__sh_puts_sp_bi_67f8;
static VALUE sy_First_Dataflow_bind_lb_0_rb__dot__b660;
static VALUE sy_First_Dataflow_bind_lb_17_rb__cd44;
static VALUE sy_First_Dataflow_bind_lb_22_rb__94b0;
static VALUE sy_First_Dataflow_bind_lb_22_rb__a94e;
...
VALUE First_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(34);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_First_Dataflow__lp_src_dot_fir_1e1a,1,bind); FAILTEST(pass2);int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=rb_funcall(self,sy_First_Dataflow_src_dot_firs_8482,1,bind);  bind_aset(bind,8/*autovar*/,it);
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,10/*autovar*/,it);
...
alt5_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
 it=rb_funcall(self,sy_First_Dataflow__lp_bind_lb_11_35dc,1,bind); FAILTEST(alt5_2);  it=First_Dataflow_value(self ); FAILTEST(alt5_2); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_First_Dataflow__append_lp__66a2,1,bind);  
ame_setcut(self,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_3); 
ame_setcut(self,Qnil);goto accept5;
  alt5_3:  ame_setpos(self,oldpos8); goto pass4;
 accept5:;
 ...
 if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=rb_funcall(self,sy_First_Dataflow_bind_lb_0_rb__dot__b660,1,bind);  bind_aset(bind,13/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
	if(fail3) goto alt4_3;
...
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break4); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_First_Dataflow__append_lp__8bfa,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,15/*autovar*/); bind_aset(bind,17/*it*/,it);
...
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=First_Dataflow_value(self ); FAILTEST(pass6); bind_aset(bind,20/*autovar*/,it);
...
alt6_2: ame_setpos(self,oldpos10);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_3);it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
alt7_1: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_2); bind_aset(bind,21/*autovar*/,it);
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=First_Dataflow_value(self ); FAILTEST(pass7); bind_aset(bind,22/*val*/,it);
it=rb_funcall(self,sy_First_Dataflow_bind_lb_22_rb__a94e,1,bind);  bind_aset(bind,23/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
	if(fail7) goto alt7_2;
it=bind_aget(bind,23/*autovar*/); bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_3);it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept7;
  alt7_3:  ame_setpos(self,oldpos11); goto fail;
 accept7:;
 break;case 6:; int oldpos12=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_2); bind_aset(bind,24/*autovar*/,it);
...
int oldpos13; while(1){oldpos13=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break5); bind_aset(bind,26/*autovar*/,it);
it=rb_funcall(self,sy_First_Dataflow__append_lp__05b0,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=bind_aget(bind,25/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_First_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,27/*autovar*/,it);
...
alt8_2: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_3);it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept8;
  alt8_3:  ame_setpos(self,oldpos12); goto fail;
 accept8:;
 break;case 8:; int oldpos14=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_2); bind_aset(bind,28/*autovar*/,it);
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2c4f,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,29/*el*/,it);
it=bind_aget(bind,29/*el*/); bind_aset(bind,30/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=First_Dataflow_value(self ); FAILTEST(pass10); bind_aset(bind,31/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
	success10: *ptr=oldpass10;
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_First_Dataflow__sh_puts_sp_bi_67f8,1,bind); it=rb_funcall(self,sy_First_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
 it=rb_funcall(self,sy_First_Dataflow__lp_,1,bind); FAILTEST(alt10_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept10;
alt10_2: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3); 
ame_setcut(self,Qnil);goto accept10;
  alt10_3:  ame_setpos(self,oldpos16); goto break6;
 accept10:;
 if (ame_getstop(self)!=Qnil){{oldpos15=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos15); int oldpos17; while(1){oldpos17=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (ame_getstop(self)!=Qnil){{oldpos17=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos17); it=bind_aget(bind,22/*val*/); bind_aset(bind,33/*autovar*/,it);
...
alt9_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_3);it=rb_funcall(self,sy_First_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept9;
  alt9_3:  ame_setpos(self,oldpos14); goto fail;
 accept9:;
...
static VALUE c_CAct;
static VALUE sy_Sizes_Dataflow__append_lp__05b0;
static VALUE sy_Sizes_Dataflow__append_lp__66a2;
...
static VALUE sy_Sizes_Dataflow__lp_bind_lb_11_35dc;
static VALUE sy_Sizes_Dataflow__lp_src_dot_fir_1e1a;
static VALUE sy_Sizes_Dataflow__sh_puts_sp_bi_67f8;
static VALUE sy_Sizes_Dataflow_bind_lb_0_rb__dot__b660;
static VALUE sy_Sizes_Dataflow_bind_lb_17_rb__cd44;
static VALUE sy_Sizes_Dataflow_bind_lb_22_rb__94b0;
static VALUE sy_Sizes_Dataflow_bind_lb_22_rb__a94e;
...
unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashSizes_Dataflow2,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;case 10:;case 11:;case 12:;case 2:;case 3:;case 4:;case 5:;case 6:;case 7:;case 8:;case 9:;   it=Sizes_Dataflow_first_Sizes_Dataflow(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
...
unsigned char chr2=FIX2LONG(rb_hash_aref(switchhashSizes_Dataflow1,rb_obj_class(ame_curobj(self))));  switch(chr2){case 0:;case 1:; it=bind_aget(bind,3/*autovar*/); bind_aset(bind,4/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Sizes_Dataflow_first_Sizes_Dataflow(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(34);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,7/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Sizes_Dataflow__lp_src_dot_fir_1e1a,1,bind); FAILTEST(pass2);int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=rb_funcall(self,sy_Sizes_Dataflow_src_dot_firs_8482,1,bind);  bind_aset(bind,8/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
int oldpos8=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
 it=rb_funcall(self,sy_Sizes_Dataflow__lp_bind_lb_11_35dc,1,bind); FAILTEST(alt5_2);  it=First_Dataflow_value(self ); FAILTEST(alt5_2); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow__append_lp__66a2,1,bind);  
ame_setcut(self,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_3); 
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
  it=Amethyst_eof(self ); FAILTEST(pass4);
	...
	success4: *ptr=oldpass4;
	if(fail4) goto break3;
 if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_0_rb__dot__b660,1,bind);  bind_aset(bind,13/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,15/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break4); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow__append_lp__8bfa,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,15/*autovar*/); bind_aset(bind,17/*it*/,it);
...
ame_setcut(self,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos10);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_3);it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,21/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=First_Dataflow_value(self ); FAILTEST(pass7); bind_aset(bind,22/*val*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_22_rb__a94e,1,bind);  bind_aset(bind,23/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
...
ame_setcut(self,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_3);it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass8=*ptr; int fail8=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,25/*autovar*/,it);
int oldpos13; while(1){oldpos13=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break5); bind_aset(bind,26/*autovar*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow__append_lp__05b0,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=bind_aget(bind,25/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,27/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: *ptr=oldpass8;
...
ame_setcut(self,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_3);it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,28/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2c4f,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,29/*el*/,it);
it=bind_aget(bind,29/*el*/); bind_aset(bind,30/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,30/*autovar*/);ptr->len=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow__sh_puts_sp_bi_67f8,1,bind); it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
 it=rb_funcall(self,sy_Sizes_Dataflow__lp_,1,bind); FAILTEST(alt10_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept10;
alt10_2: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3); 
ame_setcut(self,Qnil);goto accept10;
...
ame_setcut(self,Qnil);goto accept9;
alt9_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_3);it=rb_funcall(self,sy_Sizes_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
static VALUE c_Act;
static VALUE c_CAct;
static VALUE sy_Switch_Dataflow__append_lp__05b0;
static VALUE sy_Switch_Dataflow__append_lp__66a2;
static VALUE sy_Switch_Dataflow__append_lp__8bfa;
...
static VALUE sy_Switch_Dataflow__lp_bind_lb_11_35dc;
static VALUE sy_Switch_Dataflow__lp_src_dot_fir_1e1a;
static VALUE sy_Switch_Dataflow__sh_puts_sp_bi_67f8;
static VALUE sy_Switch_Dataflow_bind_lb_0_rb__dot__b660;
static VALUE sy_Switch_Dataflow_bind_lb_17_rb__cd44;
static VALUE sy_Switch_Dataflow_bind_lb_22_rb__94b0;
static VALUE sy_Switch_Dataflow_bind_lb_22_rb__a94e;
...
unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashSwitch_Dataflow3,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;case 10:;case 11:;case 12:;case 2:;case 3:;case 4:;case 5:;case 6:;case 7:;case 8:;case 9:;   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
 break;case 1:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
...
it=bind_aget(bind,5/*autovar*/); bind_aset(bind,6/*autovar*/,it);
unsigned char chr2=FIX2LONG(rb_hash_aref(switchhashSwitch_Dataflow2,rb_obj_class(ame_curobj(self))));  switch(chr2){case 0:;case 1:;case 2:; it=bind_aget(bind,6/*autovar*/); bind_aset(bind,7/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Switch_Dataflow_first_Switch_Dataflow(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(34);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,7/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Switch_Dataflow__lp_src_dot_fir_1e1a,1,bind); FAILTEST(pass2);int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=rb_funcall(self,sy_Switch_Dataflow_src_dot_firs_8482,1,bind);  bind_aset(bind,8/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
int oldpos8=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
 it=rb_funcall(self,sy_Switch_Dataflow__lp_bind_lb_11_35dc,1,bind); FAILTEST(alt5_2);  it=First_Dataflow_value(self ); FAILTEST(alt5_2); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_Switch_Dataflow__append_lp__66a2,1,bind);  
ame_setcut(self,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_3); 
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
  it=Amethyst_eof(self ); FAILTEST(pass4);
	...
	success4: *ptr=oldpass4;
	if(fail4) goto break3;
 if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_0_rb__dot__b660,1,bind);  bind_aset(bind,13/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,15/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break4); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Switch_Dataflow__append_lp__8bfa,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,15/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,18/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
...
ame_setcut(self,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos10);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_3);it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,21/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=First_Dataflow_value(self ); FAILTEST(pass7); bind_aset(bind,22/*val*/,it);
it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_22_rb__a94e,1,bind);  bind_aset(bind,23/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
...
ame_setcut(self,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_3);it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass8=*ptr; int fail8=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,25/*autovar*/,it);
int oldpos13; while(1){oldpos13=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break5); bind_aset(bind,26/*autovar*/,it);
it=rb_funcall(self,sy_Switch_Dataflow__append_lp__05b0,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=bind_aget(bind,25/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,27/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: *ptr=oldpass8;
...
ame_setcut(self,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_3);it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,28/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2c4f,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,29/*el*/,it);
it=bind_aget(bind,29/*el*/); bind_aset(bind,30/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,30/*autovar*/);ptr->len=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_Switch_Dataflow__sh_puts_sp_bi_67f8,1,bind); it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
 it=rb_funcall(self,sy_Switch_Dataflow__lp_,1,bind); FAILTEST(alt10_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept10;
alt10_2: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3); 
ame_setcut(self,Qnil);goto accept10;
...
ame_setcut(self,Qnil);goto accept9;
alt9_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_3);it=rb_funcall(self,sy_Switch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
VALUE switchhashFirst_Dataflow2;
static VALUE c_CAct;
static VALUE sy_ClasSwitch_Dataflow__append_lp__05b0;
static VALUE sy_ClasSwitch_Dataflow__append_lp__66a2;
static VALUE sy_ClasSwitch_Dataflow__append_lp__8bfa;
...
static VALUE sy_ClasSwitch_Dataflow__lp_bind_lb_11_35dc;
static VALUE sy_ClasSwitch_Dataflow__lp_src_dot_fir_1e1a;
static VALUE sy_ClasSwitch_Dataflow__sh_puts_sp_bi_67f8;
static VALUE sy_ClasSwitch_Dataflow_bind_lb_0_rb__dot__b660;
static VALUE sy_ClasSwitch_Dataflow_bind_lb_17_rb__cd44;
static VALUE sy_ClasSwitch_Dataflow_bind_lb_22_rb__94b0;
static VALUE sy_ClasSwitch_Dataflow_bind_lb_22_rb__a94e;
...
unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashClasSwitch_Dataflow1,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;case 10:;case 11:;case 12:;case 2:;case 3:;case 4:;case 5:;case 6:;case 7:;case 8:;case 9:;   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
 break;case 1:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(34);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,7/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_ClasSwitch_Dataflow__lp_src_dot_fir_1e1a,1,bind); FAILTEST(pass2);int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=rb_funcall(self,sy_ClasSwitch_Dataflow_src_dot_firs_8482,1,bind);  bind_aset(bind,8/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
int oldpos8=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
 it=rb_funcall(self,sy_ClasSwitch_Dataflow__lp_bind_lb_11_35dc,1,bind); FAILTEST(alt5_2);  it=First_Dataflow_value(self ); FAILTEST(alt5_2); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow__append_lp__66a2,1,bind);  
ame_setcut(self,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_3); 
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
  it=Amethyst_eof(self ); FAILTEST(pass4);
	...
	success4: *ptr=oldpass4;
	if(fail4) goto break3;
 if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_0_rb__dot__b660,1,bind);  bind_aset(bind,13/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,15/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break4); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow__append_lp__8bfa,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,15/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,18/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
...
ame_setcut(self,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos10);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt6_3);it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,21/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=First_Dataflow_value(self ); FAILTEST(pass7); bind_aset(bind,22/*val*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_22_rb__a94e,1,bind);  bind_aset(bind,23/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
...
ame_setcut(self,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos11);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_3);it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass8=*ptr; int fail8=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,25/*autovar*/,it);
int oldpos13; while(1){oldpos13=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break5); bind_aset(bind,26/*autovar*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow__append_lp__05b0,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=bind_aget(bind,25/*autovar*/); bind_aset(bind,17/*it*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_17_rb__cd44,1,bind);  bind_aset(bind,27/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: *ptr=oldpass8;
...
ame_setcut(self,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos12);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_3);it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,28/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2c4f,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,29/*el*/,it);
it=bind_aget(bind,29/*el*/); bind_aset(bind,30/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,30/*autovar*/);ptr->len=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow__sh_puts_sp_bi_67f8,1,bind); it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
 it=rb_funcall(self,sy_ClasSwitch_Dataflow__lp_,1,bind); FAILTEST(alt10_2);ame_setcut(self,Qtrue);ame_setstop(self,Qtrue); 
ame_setcut(self,Qnil);goto accept10;
alt10_2: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
   it=Amethyst_empty(self ); FAILTEST(alt10_3); 
ame_setcut(self,Qnil);goto accept10;
...
ame_setcut(self,Qnil);goto accept9;
alt9_2: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt9_3);it=rb_funcall(self,sy_ClasSwitch_Dataflow_lattice_dot__2ce9,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashDetect_Switch6,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,4/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,4/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,2/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=Detect_Switch_traverse(self ); FAILTEST(pass2); bind_aset(bind,3/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
ame_setcut(self,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos2); goto fail;
 accept2:;
 break;} break;case 1:; unsigned char chr3=FIX2LONG(rb_hash_aref(switchhashDetect_Switch3,rb_obj_class(ame_curobj(self))));  switch(chr3){case 0:; int oldpos3=ame_getpos(self);
...
int oldpos4; while(1){oldpos4=ame_getpos(self);   it=Detect_Switch_traverse_item(self ); FAILTEST(break1); bind_aset(bind,6/*it*/,it);
it=rb_funcall(self,sy_Detect_Switch_bind_lb_5_rb__lt__1671,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,5/*ar*/); bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,4/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,5/*ar*/,it);
int oldpos6; while(1){oldpos6=ame_getpos(self);   it=Detect_Switch_traverse_item(self ); FAILTEST(break2); bind_aset(bind,6/*it*/,it);
it=rb_funcall(self,sy_Detect_Switch_bind_lb_5_rb__lt__1671,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,5/*ar*/); bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
 break;} break;case 2:; unsigned char chr4=FIX2LONG(rb_hash_aref(switchhashDetect_Switch4,rb_obj_class(ame_curobj(self))));  switch(chr4){case 0:; int oldpos7=ame_getpos(self);
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,4/*autovar*/);ptr->len=1;
 unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashDetect_ClasSwitch5,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,5/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,5/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,2/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=Detect_ClasSwitch_traverse(self ); FAILTEST(pass2); bind_aset(bind,3/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
ame_setcut(self,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos2); goto fail;
 accept2:;
 break;} break;case 1:; unsigned char chr3=FIX2LONG(rb_hash_aref(switchhashDetect_ClasSwitch2,rb_obj_class(ame_curobj(self))));  switch(chr3){case 0:; int oldpos3=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,4/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,5/*ar*/,it);
int oldpos4; while(1){oldpos4=ame_getpos(self);   it=Detect_ClasSwitch_traverse_item(self ); FAILTEST(break1); bind_aset(bind,6/*it*/,it);
it=rb_funcall(self,sy_Detect_ClasSwitch_bind_lb_5_rb__lt__1671,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,5/*ar*/); bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,4/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,5/*ar*/,it);
int oldpos6; while(1){oldpos6=ame_getpos(self);   it=Detect_ClasSwitch_traverse_item(self ); FAILTEST(break2); bind_aset(bind,6/*it*/,it);
it=rb_funcall(self,sy_Detect_ClasSwitch_bind_lb_5_rb__lt__1671,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,5/*ar*/); bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
ame_setcut(self,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos5); goto fail;
 accept4:;
 break;} break;case 2:; unsigned char chr4=FIX2LONG(rb_hash_aref(switchhashDetect_ClasSwitch3,rb_obj_class(ame_curobj(self))));  switch(chr4){case 0:; int oldpos7=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
sy_First_Dataflow__append_lp__05b0=rb_intern("First_Dataflow__append_lp__05b0");
...
sy_First_Dataflow__sh_puts_sp_bi_67f8=rb_intern("First_Dataflow__sh_puts_sp_bi_67f8");
...
sy_First_Dataflow_bind_lb_22_rb__94b0=rb_intern("First_Dataflow_bind_lb_22_rb__94b0");
sy_First_Dataflow_bind_lb_22_rb__a94e=rb_intern("First_Dataflow_bind_lb_22_rb__a94e");
...
sy_Sizes_Dataflow__append_lp__05b0=rb_intern("Sizes_Dataflow__append_lp__05b0");
sy_Sizes_Dataflow__append_lp__66a2=rb_intern("Sizes_Dataflow__append_lp__66a2");
...
sy_Sizes_Dataflow__lp_bind_lb_11_35dc=rb_intern("Sizes_Dataflow__lp_bind_lb_11_35dc");
sy_Sizes_Dataflow__lp_src_dot_fir_1e1a=rb_intern("Sizes_Dataflow__lp_src_dot_fir_1e1a");
sy_Sizes_Dataflow__sh_puts_sp_bi_67f8=rb_intern("Sizes_Dataflow__sh_puts_sp_bi_67f8");
...
sy_Sizes_Dataflow_bind_lb_22_rb__94b0=rb_intern("Sizes_Dataflow_bind_lb_22_rb__94b0");
sy_Sizes_Dataflow_bind_lb_22_rb__a94e=rb_intern("Sizes_Dataflow_bind_lb_22_rb__a94e");
...
sy_Switch_Dataflow__append_lp__05b0=rb_intern("Switch_Dataflow__append_lp__05b0");
sy_Switch_Dataflow__append_lp__66a2=rb_intern("Switch_Dataflow__append_lp__66a2");
sy_Switch_Dataflow__append_lp__8bfa=rb_intern("Switch_Dataflow__append_lp__8bfa");
...
sy_Switch_Dataflow__lp_bind_lb_11_35dc=rb_intern("Switch_Dataflow__lp_bind_lb_11_35dc");
sy_Switch_Dataflow__lp_src_dot_fir_1e1a=rb_intern("Switch_Dataflow__lp_src_dot_fir_1e1a");
sy_Switch_Dataflow__sh_puts_sp_bi_67f8=rb_intern("Switch_Dataflow__sh_puts_sp_bi_67f8");
sy_Switch_Dataflow_bind_lb_0_rb__dot__b660=rb_intern("Switch_Dataflow_bind_lb_0_rb__dot__b660");
sy_Switch_Dataflow_bind_lb_17_rb__cd44=rb_intern("Switch_Dataflow_bind_lb_17_rb__cd44");
sy_Switch_Dataflow_bind_lb_22_rb__94b0=rb_intern("Switch_Dataflow_bind_lb_22_rb__94b0");
sy_Switch_Dataflow_bind_lb_22_rb__a94e=rb_intern("Switch_Dataflow_bind_lb_22_rb__a94e");
...
switchhashFirst_Dataflow1=rb_eval_string("Hash.new{|h,k|\nnext h[k]=0 if k<=Act\nnext h[k]=1 if k<=CAct\nnext h[k]=2 if k<=Cut\nnext h[k]=3 if k<=Local\nnext h[k]=4 if k<=Result\nnext h[k]=5 if k<=Stop\nnext h[k]=6 if k<=Object\n}\n");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),switchhashFirst_Dataflow1);
switchhashFirst_Dataflow2=rb_eval_string("Hash.new{|h,k|\nnext h[k]=0 if k<=Act\nnext h[k]=1 if k<=Bind\nnext h[k]=2 if k<=CAct\nnext h[k]=3 if k<=Cut\nnext h[k]=4 if k<=Local\nnext h[k]=5 if k<=Many\nnext h[k]=6 if k<=Or\nnext h[k]=7 if k<=Result\nnext h[k]=8 if k<=Seq\nnext h[k]=9 if k<=Stop\nnext h[k]=10 if k<=Switch\nnext h[k]=11 if k<=Object\n}\n");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),switchhashFirst_Dataflow2);
sy_ClasSwitch_Dataflow__append_lp__05b0=rb_intern("ClasSwitch_Dataflow__append_lp__05b0");
sy_ClasSwitch_Dataflow__append_lp__66a2=rb_intern("ClasSwitch_Dataflow__append_lp__66a2");
sy_ClasSwitch_Dataflow__append_lp__8bfa=rb_intern("ClasSwitch_Dataflow__append_lp__8bfa");
...
sy_ClasSwitch_Dataflow__lp_bind_lb_11_35dc=rb_intern("ClasSwitch_Dataflow__lp_bind_lb_11_35dc");
sy_ClasSwitch_Dataflow__lp_src_dot_fir_1e1a=rb_intern("ClasSwitch_Dataflow__lp_src_dot_fir_1e1a");
sy_ClasSwitch_Dataflow__sh_puts_sp_bi_67f8=rb_intern("ClasSwitch_Dataflow__sh_puts_sp_bi_67f8");
sy_ClasSwitch_Dataflow_bind_lb_0_rb__dot__b660=rb_intern("ClasSwitch_Dataflow_bind_lb_0_rb__dot__b660");
sy_ClasSwitch_Dataflow_bind_lb_17_rb__cd44=rb_intern("ClasSwitch_Dataflow_bind_lb_17_rb__cd44");
sy_ClasSwitch_Dataflow_bind_lb_22_rb__94b0=rb_intern("ClasSwitch_Dataflow_bind_lb_22_rb__94b0");
sy_ClasSwitch_Dataflow_bind_lb_22_rb__a94e=rb_intern("ClasSwitch_Dataflow_bind_lb_22_rb__a94e");
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('d40f8755f5e88827e93593bb4f247027')");}
