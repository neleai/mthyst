...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,1,it);   it=First_Dataflow_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break2);
 rb_ary_store(bind,5,it); it=CALL(first_First_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,6,it); it=CALL(first_First_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,7,it);   it=First_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
alt2_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); int oldpos7=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,9,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break3);
 rb_ary_store(bind,10,it); it=CALL(first_First_Dataflowcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,6,it); it=CALL(first_First_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,11,it);   it=First_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,13,it); it=CALL(first_First_Dataflowcb_8,1,bind); 
 rb_ary_store(bind,14,it);   it=First_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
alt4_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,15,it); int oldpos12=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break4);
 rb_ary_store(bind,17,it); it=CALL(first_First_Dataflowcb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,6,it); it=CALL(first_First_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,18,it);   it=First_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
alt5_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,19,it); int oldpos15=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,20,it); it=CALL(first_First_Dataflowcb_11,1,bind); int oldpos16=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,21,it);   it=First_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos16); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=rb_ary_entry(bind,21);
 rb_ary_store(bind,22,it);   it=First_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
alt7_1: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_First_Dataflowcb_12,1,bind);  arg0=it; it=First_Dataflow_clas(self ,arg0); FAILTEST(alt7_2);
...
alt7_2: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_First_Dataflowcb_13,1,bind);  arg0=it; it=First_Dataflow_clas(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,23,it);  
ISET(cut,Qnil);goto accept7;
...
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos20; while(1){oldpos20=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=CALL(first_First_Dataflowcb_14,1,bind); 
 rb_ary_store(bind,24,it);   it=First_Dataflow_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
...
return it;
fail: return failobj; }
VALUE Switch_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(12);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass2); it=rb_str_new2("seq"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass2);  it=Switch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
 it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_13,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(pass1);
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,7,it); int oldpos6=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass5); it=rb_str_new2("anything"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass5);  it=Switch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos6); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=CALL(first_Switch_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,8,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,10,it); int oldpos8=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass7); it=rb_str_new2("regch"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass7);  it=Switch_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos8); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=CALL(first_Switch_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,11,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,5,it);  break;}it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
...
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=CALL(value,0 ); FAILTEST(break2);
 rb_ary_store(bind,5,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,6,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,7,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto alt1_3;
...
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,9,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=CALL(value,0 ); FAILTEST(break3);
 rb_ary_store(bind,10,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,6,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_7,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,13,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_8,1,bind); 
 rb_ary_store(bind,14,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos10); ame_setlen(self,oldlen4);
	if(fail4) goto alt3_2;
...
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=CALL(value,0 ); FAILTEST(break4);
 rb_ary_store(bind,17,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,6,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,18,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos12); ame_setlen(self,oldlen5);
	if(fail5) goto alt4_2;
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,20,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_11,1,bind); int oldpos16=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(value,0 ); FAILTEST(pass7);
 rb_ary_store(bind,21,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos16); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=rb_ary_entry(bind,21);
 rb_ary_store(bind,22,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos15); ame_setlen(self,oldlen6);
	if(fail6) goto alt5_2;
...
alt6_1: ame_setpos(self,oldpos17);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos18=ame_getpos(self);
alt7_1: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_12,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt7_2);
 rb_ary_store(bind,23,it);  
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_13,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,23,it);  
ISET(cut,Qnil);goto accept7;
  alt7_3:  ame_setpos(self,oldpos18); goto alt6_2;
 accept7:;
int oldpos19=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos20; while(1){oldpos20=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_14,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,1,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_spaces(self ); FAILTEST(pass2); it=rb_str_new2("clas"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass2);  it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
 it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_12,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(pass1);
 rb_ary_store(bind,2,it); int oldpos4=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,3,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos4); ame_setlen(self,oldlen3);
	if(fail3) goto pass1;
...
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break2);
 rb_ary_store(bind,5,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,6,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,7,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto alt1_3;
...
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,9,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break3);
 rb_ary_store(bind,10,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,6,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_7,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,13,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_8,1,bind); 
 rb_ary_store(bind,14,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos10); ame_setlen(self,oldlen4);
	if(fail4) goto alt3_2;
...
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break4);
 rb_ary_store(bind,17,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,6,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,18,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos12); ame_setlen(self,oldlen5);
	if(fail5) goto alt4_2;
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,20,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_11,1,bind); int oldpos16=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_value(self ); FAILTEST(pass7);
 rb_ary_store(bind,21,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos16); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=rb_ary_entry(bind,21);
 rb_ary_store(bind,22,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos15); ame_setlen(self,oldlen6);
	if(fail6) goto alt5_2;
...
alt6_1: ame_setpos(self,oldpos17);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos18=ame_getpos(self);
alt7_1: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_12,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt7_2);
 rb_ary_store(bind,23,it);  
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_2;}
  it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_13,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt7_3);
 rb_ary_store(bind,23,it);  
ISET(cut,Qnil);goto accept7;
  alt7_3:  ame_setpos(self,oldpos18); goto alt6_2;
 accept7:;
int oldpos19=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos20; while(1){oldpos20=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_14,1,bind); 
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos1; while(1){oldpos1=ame_getpos(self); char chr1=FIX2INT(CALL(switchcbDetect_First9,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
...
char chr1=FIX2INT(CALL(switchcbDetect_Switch11,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 char chr1=FIX2INT(CALL(switchcbDetect_ClasSwitch12,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
...
char chr1=FIX2INT(CALL(switchcbDetect_ClasSwitch13,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('0dbeaad9a3eb207692e9e5bd93d9e85e')");}
