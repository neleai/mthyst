...
int oldpos8; int stop2=0; while(1){oldpos8=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break2); var18/*el*/=it;;
...
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_First_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
...
alt7_3: ptr->pos=oldpos9;goto break2;
 accept9:;
 if (stop2) goto accept8; } break2: goto pass7; accept8:;   ptr->pos=ptr->len;it=var11/*val*/; var22/*autovar*/=it;;
...
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_Minsize_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
...
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_Maxsize_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
...
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_Switch_Char_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
...
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_Switch_Clas_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
...
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;bind_aset(bind2,1,var18/*el*/);it=rb_funcall(self,sy_Cant_Fail_Dataflow__lp_,1,bind2);var18/*el*/=bind_aget(bind2,1);;FAILTEST(alt7_2);cut7=1;stop2=1;
;goto accept9;
