...
static VALUE sy_Detect_Switch_Seq_lb__lb_bin_880b;
static VALUE sy_Detect_Switch__append_lp__3c16;
static VALUE sy_Detect_Switch__append_lp__7352;
static VALUE sy_Detect_Switch__append_lp__89bf;
...
static VALUE sy_Detect_Switch__lp_bind_lb_22_061d;
...
static VALUE sy_Detect_Switch_s_eq_Switch_a407;
...
cstruct oldpass11=*ptr; int fail11=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=Detect_Switch_traverse_item(self ); FAILTEST(pass11); bind_aset(bind,22/*frst*/,it);
it=rb_ary_new3(0); bind_aset(bind,23/*autovar*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Detect_Switch_traverse_item(self ); FAILTEST(break3); bind_aset(bind,24/*autovar*/,it);
it=rb_funcall(self,sy_Detect_Switch__append_lp__89bf,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,23/*autovar*/); bind_aset(bind,25/*rest*/,it);
int oldpos6=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass11;}
 it=rb_funcall(self,sy_Detect_Switch__lp_bind_lb_22_061d,1,bind); FAILTEST(alt3_2);it=rb_funcall(self,sy_Detect_Switch_s_eq_Switch_a407,1,bind);  bind_aset(bind,26/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass11;}
 it=rb_funcall(self,sy_Detect_Switch_Seq_lb__lb_bin_880b,1,bind);  bind_aset(bind,26/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos6); goto pass11;
 accept3:;
  it=Amethyst_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
...
cstruct oldpass12=*ptr; int fail12=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,27/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,28/*autovar*/,it);
int oldpos7; while(1){oldpos7=ame_getpos(self);   it=Detect_Switch_traverse_item(self ); FAILTEST(break4); bind_aset(bind,29/*autovar*/,it);
it=rb_funcall(self,sy_Detect_Switch__append_lp__3c16,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,28/*autovar*/); bind_aset(bind,30/*items*/,it);
it=Qfalse; bind_aset(bind,31/*aswitch*/,it);
it=rb_funcall(self,sy_Detect_Switch_bind_lb_30_rb__fcfe,1,bind); it=rb_funcall(self,sy_Detect_Switch_puts_sp_bin_756b,1,bind); int oldpos8=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass12;}
 it=rb_funcall(self,sy_Detect_Switch__lp_2,1,bind); FAILTEST(alt4_2);it=rb_funcall(self,sy_Detect_Switch_Or_lb__ti_bind_a2aa,1,bind);  bind_aset(bind,32/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos8);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass12;}
...
ame_setcut(self,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos8); goto pass12;
 accept4:;
  it=Amethyst_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
	success12: *ptr=oldpass12;
	if(fail12) goto alt1_6;
...
sy_Detect_Switch_Seq_lb__lb_bin_880b=rb_intern("Detect_Switch_Seq_lb__lb_bin_880b");
...
sy_Detect_Switch__append_lp__89bf=rb_intern("Detect_Switch__append_lp__89bf");
...
sy_Detect_Switch__lp_bind_lb_22_061d=rb_intern("Detect_Switch__lp_bind_lb_22_061d");
...
sy_Detect_Switch_s_eq_Switch_a407=rb_intern("Detect_Switch_s_eq_Switch_a407");
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('f41d9fe56750e1fff6aacf2aaad2b7ae')");}
