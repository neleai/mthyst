...
it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,1,it); int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 rb_ary_store(bind,2,it); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3,it); it=CALL(itrans_Detect_Switchcb_3,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
ame_setsrc(self,rb_ary_entry(bind,4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=CALL(itrans_Detect_Switchcb_4,1,bind);  arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(break2);
...
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6,it); it=CALL(itrans_Detect_Switchcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,0);
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,8,it); it=CALL(itrans_Detect_Switchcb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,1);
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it);  it=CALL(visit_Detect_Switchcb_1,1,bind);  arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,2,it); it=CALL(visit_Detect_Switchcb_3,1,bind); 
 rb_ary_store(bind,3,it); it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=CALL(traverse_item,0 ); FAILTEST(break1);
 rb_ary_store(bind,4,it); it=CALL(visit_Detect_Switchcb_4,1,bind); FAILTEST(break1);it=CALL(visit_Detect_Switchcb_5,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(visit_Detect_Switchcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,0);int oldpos3=ame_getpos(self);
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3,it); it=CALL(itrans_Detect_ClasSwitchcb_3,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass2);
 rb_ary_store(bind,4,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=CALL(itrans_Detect_ClasSwitchcb_4,1,bind);  arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(break2);
 rb_ary_store(bind,5,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(root,0 ); FAILTEST(pass4);
	if (CALL(eof,0)==failobj) goto pass4;
 ...
 rb_ary_store(bind,6,it); it=CALL(itrans_Detect_ClasSwitchcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,0);
 rb_ary_store(bind,7,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,8,it); it=CALL(itrans_Detect_ClasSwitchcb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,9,it); it=rb_ary_entry(bind,9);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it);  it=CALL(visit_Detect_ClasSwitchcb_1,1,bind);  arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(fail);
 rb_ary_store(bind,1,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Detect_ClasSwitchcb_2,1,bind); 
 rb_ary_store(bind,2,it); it=CALL(visit_Detect_ClasSwitchcb_3,1,bind); 
 rb_ary_store(bind,3,it); it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=CALL(traverse_item,0 ); FAILTEST(break1);
 rb_ary_store(bind,4,it); it=CALL(visit_Detect_ClasSwitchcb_4,1,bind); FAILTEST(break1);it=CALL(visit_Detect_ClasSwitchcb_5,1,bind); 
 rb_ary_store(bind,5,it); it=CALL(visit_Detect_ClasSwitchcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,0);int oldpos3=ame_getpos(self);
