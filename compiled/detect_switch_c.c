...
it=rb_ary_entry(bind,6);
 rb_ary_store(bind,7,it); it=CALL(itrans_Detect_Switchcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,4);
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,10,it);  break;default: goto break1;}it=CALL(itrans_Detect_Switchcb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
  it=CALL(predicate_Detect_ClasSwitchcb_2,1,bind);  arg0=it; it=Detect_ClasSwitch_clas(self ,arg0); FAILTEST(alt1_2);
 rb_ary_store(bind,2,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass2);
 ...
 rb_ary_store(bind,5,it); it=CALL(predicate_Detect_ClasSwitchcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,6,it); it=CALL(predicate_Detect_ClasSwitchcb_4,1,bind); 
...
alt2_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
  it=CALL(predicate_Detect_ClasSwitchcb_5,1,bind);  arg0=it; it=Detect_ClasSwitch_clas(self ,arg0); FAILTEST(alt2_2);
...
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,11,it); it=CALL(predicate_Detect_ClasSwitchcb_6,1,bind); FAILTEST(pass3); it=CALL(predicate_Detect_ClasSwitchcb_7,1,bind);  arg0=it; it=Detect_ClasSwitch_clas(self ,arg0); FAILTEST(pass3);
...
alt3_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
  it=CALL(predicate_Detect_ClasSwitchcb_10,1,bind);  arg0=it; it=Detect_ClasSwitch_clas(self ,arg0); FAILTEST(alt3_2);
...
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,11,it); it=CALL(predicate_Detect_ClasSwitchcb_12,1,bind); 
 rb_ary_store(bind,16,it); it=CALL(predicate_Detect_ClasSwitchcb_13,1,bind);
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversion('2598f74f6f43a376a1ecf609bb10a6e0')");}
