...
static VALUE sy_First_Dataflow_puts_sp__dq__sh__le__86bc;
...
it=rb_funcall(self,sy_First_Dataflow_puts_sp__dq__sh__le__86bc,1,bind); it=rb_funcall(self,sy_First_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
...
static VALUE sy_Sizes_Dataflow_puts_sp__dq__sh__le__86bc;
...
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow_puts_sp__dq__sh__le__86bc,1,bind); it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
...
static VALUE sy_Switch_Dataflow_puts_sp__dq__sh__le__86bc;
...
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_Switch_Dataflow_puts_sp__dq__sh__le__86bc,1,bind); it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
...
static VALUE sy_ClasSwitch_Dataflow_puts_sp__dq__sh__le__86bc;
...
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass10);
	...
	if(fail10) goto break6;
it=bind_aget(bind,31/*autovar*/); bind_aset(bind,32/*nev*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow_puts_sp__dq__sh__le__86bc,1,bind); it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_22_rb__94b0,1,bind);  bind_aset(bind,22/*val*/,it);
int oldpos16=ame_getpos(self);
alt10_1: ame_setpos(self,oldpos16);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break6;}
...
sy_First_Dataflow_puts_sp__dq__sh__le__86bc=rb_intern("First_Dataflow_puts_sp__dq__sh__le__86bc");
...
sy_Sizes_Dataflow_puts_sp__dq__sh__le__86bc=rb_intern("Sizes_Dataflow_puts_sp__dq__sh__le__86bc");
...
sy_Switch_Dataflow_puts_sp__dq__sh__le__86bc=rb_intern("Switch_Dataflow_puts_sp__dq__sh__le__86bc");
...
sy_ClasSwitch_Dataflow_puts_sp__dq__sh__le__86bc=rb_intern("ClasSwitch_Dataflow_puts_sp__dq__sh__le__86bc");
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('9209cf10a968e049e2fbe73264c1de1f')");}
