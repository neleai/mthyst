...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,0/*autovar*/,it);  break;case 6:;   it=CALL(fails,0 ); FAILTEST(alt1_2); break;}int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,12/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
ame_setsrc(self,rb_ary_entry(bind,14/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*it*/,it); it=CALL(first_First_Dataflowcb_6,1,bind); 
 rb_ary_store(bind,20/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,23/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,24/*nev*/,it);   it=CALL(eof,0 ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
alt8_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
 it=CALL(first_First_Dataflowcb_13,1,bind); ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt8_2); 
...
ISET(cut,Qnil);goto accept7;
 ...
 rb_ary_store(bind,25/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass2); it=rb_obj_clone(c_332); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass2);it=rb_obj_clone(c_333);  it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto alt2_2;
 it=c_334; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(alt2_2);
...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,5/*str*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass4);unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC('r') ... UC('r'):;  it=rb_obj_clone(c_335); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass4);it=rb_obj_clone(c_336); break;case UC('a') ... UC('a'):;  it=rb_obj_clone(c_337); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass4);it=rb_obj_clone(c_338); break;case UC('c') ... UC('c'):;  it=rb_obj_clone(c_339); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass4);it=rb_obj_clone(c_340); break;default:;   it=CALL(fails,0 ); FAILTEST(pass4); break;}  it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
ISET(cut,Qnil);goto accept2;
 ...
 accept2:;
 break;}  it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto alt1_2;
...
alt7_1: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break5;}
 int oldpos22=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
 it=CALL(first_Sizes_Dataflow_Sizes_Dataflowcb_13,1,bind); ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt8_2); 
ISET(cut,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
   it=CALL(empty,0 ); FAILTEST(alt8_3); 
ISET(cut,Qnil);goto accept8;
...
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 ...
 rb_ary_store(bind,3/*autovar*/,it); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass2); it=rb_obj_clone(c_345); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass2);it=rb_obj_clone(c_346);  it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto alt2_2;
 it=c_347; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(alt2_2);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,5/*str*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
...
alt2_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 ...
 rb_ary_store(bind,7/*autovar*/,it); int oldpos6=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass4); it=rb_obj_clone(c_348); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass4);it=rb_obj_clone(c_349);  it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos6); ame_setlen(self,oldlen4);
	if(fail4) goto alt2_3;
 it=c_350; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(alt2_3);
...
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,5/*str*/,it);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
ame_setsrc(self,rb_ary_entry(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass6); it=rb_obj_clone(c_351); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass6);it=rb_obj_clone(c_352);  it=CALL(eof,0 ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
alt7_1: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break5;}
 int oldpos22=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
 it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_13,1,bind); ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt8_2); 
ISET(cut,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
   it=CALL(empty,0 ); FAILTEST(alt8_3); 
ISET(cut,Qnil);goto accept8;
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(spaces,0 ); FAILTEST(pass2); it=rb_obj_clone(c_355); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(pass2);it=rb_obj_clone(c_356);  it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
 it=c_357; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(pass1);
...
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,3/*cls*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
it=CALL(first_ClasSwitch_Dataflowcb_1,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto alt1_2;
...
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(value,0 ); FAILTEST(pass5);
 rb_ary_store(bind,9/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos7); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=rb_ary_entry(bind,9/*autovar*/);
 rb_ary_store(bind,10/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
alt7_1: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break5;}
 int oldpos22=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
 it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_13,1,bind); ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt8_2); 
ISET(cut,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt7_2;}
   it=CALL(empty,0 ); FAILTEST(alt8_3); 
ISET(cut,Qnil);goto accept8;
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=c_360; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(break2);
...
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
it=rb_ary_entry(bind,6/*autovar*/);
 ...
 rb_ary_store(bind,8/*rules*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto pass2;
  it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=c_365; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(break2);
 rb_ary_store(bind,5/*autovar*/,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,9/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto alt2_2;
...
ame_setsrc(self,rb_ary_entry(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos7); ame_setlen(self,oldlen3);
...
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,18/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos10); ame_setlen(self,oldlen4);
...
ISET(cut,Qnil);goto accept4;
 ...
 rb_ary_store(bind,10/*autovar*/,it);  break;}  it=CALL(eof,0 ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,2/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
ame_setsrc(self,rb_ary_entry(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,14/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Detect_Switchcb_5,1,bind);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
...
VALUE Detect_Switch_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(11);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 it=c_366; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,5/*autovar*/,it); it=CALL(visit_Detect_Switchcb_3,1,bind); it=CALL(visit_Detect_Switchcb_4,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); int oldpos3=ame_getpos(self);
   it=CALL(eof,0 ); FAILTEST(reject1); x=1; goto accept1;  reject1: x=0; accept1: it=Qnil; ame_setpos(self,oldpos3); if (x==0) goto pass1;it=rb_ary_entry(bind,1/*ary2*/);
...
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Detect_Switch_split(self ); FAILTEST(pass2);  it=CALL(eof,0 ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=c_379; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(break2);
 rb_ary_store(bind,5/*autovar*/,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass2);
 rb_ary_store(bind,6/*name*/,it); it=CALL(predicate_Detect_ClasSwitchcb_5,1,bind); FAILTEST(pass2); it=c_374; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(pass2);
 rb_ary_store(bind,7/*autovar*/,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,8/*match*/,it);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto pass2;
...
ame_setsrc(self,rb_ary_entry(bind,14/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,19/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
ame_setsrc(self,rb_ary_entry(bind,20/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,25/*autovar*/,it);   it=CALL(eof,0 ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Detect_ClasSwitchcb_4,1,bind);   it=CALL(eof,0 ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto break2;
...
VALUE Detect_ClasSwitch_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 it=c_380; arg0=it; it=CALL(clas,1 ,arg0); FAILTEST(fail);
 rb_ary_store(bind,0/*autovar*/,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('70295b497a49f6ce487e9ef4b4ca42d5')");}
