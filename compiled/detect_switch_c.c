...
static VALUE sy_First_Dataflow_bind_lb_20_rb__48db;
...
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass4);int oldpos7=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass4;}
   it=First_Dataflow_value(self ); FAILTEST(alt4_2); bind_aset(bind,10/*autovar*/,it);
...
it=bind_aget(bind,4/*el*/); bind_aset(bind,27/*autovar*/,it);
cstruct oldpass14=*ptr; int fail14=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=First_Dataflow_value(self ); FAILTEST(pass14); bind_aset(bind,28/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass14);
	goto success14;
	pass14: fail14=1;
	success14: *ptr=oldpass14;
	if(fail14) goto break10;
it=bind_aget(bind,28/*autovar*/); bind_aset(bind,29/*nev*/,it);
it=rb_funcall(self,sy_First_Dataflow_bind_lb_20_rb__48db,1,bind);  bind_aset(bind,20/*val*/,it);
...
static VALUE sy_Sizes_Dataflow_bind_lb_20_rb__48db;
...
cstruct oldpass14=*ptr; int fail14=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass14);
	...
	if(fail14) goto break10;
it=bind_aget(bind,28/*autovar*/); bind_aset(bind,29/*nev*/,it);
it=rb_funcall(self,sy_Sizes_Dataflow_bind_lb_20_rb__48db,1,bind);  bind_aset(bind,20/*val*/,it);
int oldpos19=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos19);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break10;}
...
static VALUE sy_Switch_Dataflow_bind_lb_20_rb__48db;
...
cstruct oldpass14=*ptr; int fail14=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass14);
	...
	if(fail14) goto break10;
it=bind_aget(bind,28/*autovar*/); bind_aset(bind,29/*nev*/,it);
it=rb_funcall(self,sy_Switch_Dataflow_bind_lb_20_rb__48db,1,bind);  bind_aset(bind,20/*val*/,it);
int oldpos19=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos19);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break10;}
...
static VALUE sy_ClasSwitch_Dataflow_bind_lb_20_rb__48db;
...
cstruct oldpass14=*ptr; int fail14=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass14);
	...
	if(fail14) goto break10;
it=bind_aget(bind,28/*autovar*/); bind_aset(bind,29/*nev*/,it);
it=rb_funcall(self,sy_ClasSwitch_Dataflow_bind_lb_20_rb__48db,1,bind);  bind_aset(bind,20/*val*/,it);
int oldpos19=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos19);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break10;}
...
static VALUE sy_Detect_Switch_nary_eq_bin_5217;
...
return it;
fail: return failobj; }
VALUE Detect_Switch_predicate(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=bind_new2(19); bind_aset(bind,1/*chr*/,a0);bind_aset(bind,0/*p*/,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);

int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=rb_funcall(self,sy_Detect_Switch__lp_,1,bind); FAILTEST(alt1_2);it=rb_funcall(self,sy_Detect_Switch_Placehol_6875,1,bind);  bind_aset(bind,2/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,0/*p*/); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*e*/,it);
 it=bind_aget(bind,1/*chr*/); arg0=it;it=bind_aget(bind,6/*e*/); arg1=it; it=Detect_Switch_predicate(self ,arg0,arg1); FAILTEST(break1); bind_aset(bind,7/*autovar*/,it);
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=bind_aget(bind,1/*chr*/); arg0=it;it=bind_aget(bind,6/*e*/); arg1=it; it=Detect_Switch_predicate(self ,arg0,arg1); FAILTEST(pass3); bind_aset(bind,12/*f*/,it);
it=rb_ary_new3(0); bind_aset(bind,13/*autovar*/,it);
...
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,17/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=rb_funcall(self,sy_Detect_Switch_nary_eq_bin_5217,1,bind);  bind_aset(bind,18/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
static VALUE sy_Detect_ClasSwitch__lp_child_lp_b_9e71;
...
static VALUE sy_Detect_ClasSwitch_predicat_8b40;
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass3);
	...
	success3: *ptr=oldpass3;
	if(fail3) goto pass2;
it=rb_funcall(self,sy_Detect_ClasSwitch__lp_child_lp_b_9e71,1,bind); FAILTEST(pass2);it=rb_funcall(self,sy_Detect_ClasSwitch_Apply_lb__dq_a_eeac,1,bind);  bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Detect_ClasSwitch_predicat_8b40,1,bind);  bind_aset(bind,13/*expr*/,it);
...
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,17/*e*/,it);
 it=bind_aget(bind,1/*clas*/); arg0=it;it=bind_aget(bind,2/*i*/); arg1=it;it=bind_aget(bind,17/*e*/); arg2=it; it=Detect_ClasSwitch_predicate(self ,arg0,arg1,arg2); FAILTEST(break1); bind_aset(bind,18/*autovar*/,it);
...
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=bind_aget(bind,1/*clas*/); arg0=it;it=bind_aget(bind,2/*i*/); arg1=it;it=bind_aget(bind,17/*e*/); arg2=it; it=Detect_ClasSwitch_predicate(self ,arg0,arg1,arg2); FAILTEST(pass6); bind_aset(bind,22/*f*/,it);
it=rb_ary_new3(0); bind_aset(bind,23/*autovar*/,it);
...
sy_First_Dataflow_bind_lb_20_rb__48db=rb_intern("First_Dataflow_bind_lb_20_rb__48db");
...
sy_Sizes_Dataflow_bind_lb_20_rb__48db=rb_intern("Sizes_Dataflow_bind_lb_20_rb__48db");
...
sy_Switch_Dataflow_bind_lb_20_rb__48db=rb_intern("Switch_Dataflow_bind_lb_20_rb__48db");
...
sy_ClasSwitch_Dataflow_bind_lb_20_rb__48db=rb_intern("ClasSwitch_Dataflow_bind_lb_20_rb__48db");
...
sy_Detect_Switch_nary_eq_bin_5217=rb_intern("Detect_Switch_nary_eq_bin_5217");
...
sy_Detect_ClasSwitch__lp_child_lp_b_9e71=rb_intern("Detect_ClasSwitch__lp_child_lp_b_9e71");
...
sy_Detect_ClasSwitch_predicat_8b40=rb_intern("Detect_ClasSwitch_predicat_8b40");
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('3907c6dcf40783fdc1967b54997da52f')");}
