...
VALUE First_Dataflow_clas(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_ary_new2(3); rb_ary_store(bind,1,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

  it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); it=CALL(clas_First_Dataflowcb_1,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,0);
...
return it;
fail: return failobj; }
VALUE First_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(18);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

char chr1=FIX2INT(CALL(switchcbFirst_Dataflow1,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break1);
 rb_ary_store(bind,2,it); it=CALL(first_First_Dataflowcb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it); it=CALL(first_First_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,4,it);   it=First_Dataflow_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
it=rb_ary_entry(bind,4);
 rb_ary_store(bind,5,it);  break;case 1:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,7,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break2);
 rb_ary_store(bind,8,it); it=CALL(first_First_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it); it=CALL(first_First_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,9,it);   it=First_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto fail;
it=rb_ary_entry(bind,9);
 rb_ary_store(bind,5,it);  break;case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,10,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,11,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=First_Dataflow_value(self ); FAILTEST(break3);
 rb_ary_store(bind,12,it); it=CALL(first_First_Dataflowcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,3,it); it=CALL(first_First_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,13,it);   it=First_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto fail;
it=rb_ary_entry(bind,13);
 rb_ary_store(bind,5,it);  break;case 3:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,14,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,15,it); it=CALL(first_First_Dataflowcb_7,1,bind); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,16,it);   it=First_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos8); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=rb_ary_entry(bind,16);
 rb_ary_store(bind,17,it);   it=First_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos7); ame_setlen(self,oldlen4);
	if(fail4) goto fail;
it=rb_ary_entry(bind,17);
 rb_ary_store(bind,5,it);  break;case 4:;   it=First_Dataflow_fails(self ); FAILTEST(fail); break;}it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
...
return it;
fail: return failobj; }
VALUE Switch_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(19);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(first_Switch_Dataflowcb_1,1,bind); FAILTEST(pass1);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(first_Switch_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,1,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_4);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept1;
...
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_value(self ); FAILTEST(pass2);
 rb_ary_store(bind,4,it); it=CALL(first_Switch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,5,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
alt2_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_4);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept2;
...
alt4_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_2;}
  it=CALL(first_Switch_Dataflowcb_5,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt4_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_2;}
  it=CALL(first_Switch_Dataflowcb_6,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt4_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos7); goto alt3_2;
 accept4:;
int oldpos8=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos9; while(1){oldpos9=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=CALL(first_Switch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
alt3_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(alt3_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept3;
alt3_3: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt3_4);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept3;
  alt3_4:  ame_setpos(self,oldpos6); goto fail;
 accept3:;
...
alt6_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  it=CALL(first_Switch_Dataflowcb_5,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt6_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  it=CALL(first_Switch_Dataflowcb_6,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt6_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept6;
  alt6_3:  ame_setpos(self,oldpos11); goto alt5_2;
 accept6:;
int oldpos12=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos13; while(1){oldpos13=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=CALL(first_Switch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
alt5_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(alt5_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept5;
alt5_3: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_4);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept5;
  alt5_4:  ame_setpos(self,oldpos10); goto fail;
 accept5:;
 break;case 4:; int oldpos14=ame_getpos(self);
alt7_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_2);
 rb_ary_store(bind,8,it); int oldpos15=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,9,it); int oldpos16=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass6); it=rb_str_new2("seq"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass6);  it=Switch_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos16); ame_setlen(self,oldlen6);
	if(fail6) goto pass5;
 it=CALL(first_Switch_Dataflowcb_6,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(pass5);
 rb_ary_store(bind,10,it); int oldpos17=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass7);
 rb_ary_store(bind,11,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos17); ame_setlen(self,oldlen7);
	if(fail7) goto pass5;
it=CALL(first_Switch_Dataflowcb_8,1,bind); 
 rb_ary_store(bind,12,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos15); ame_setlen(self,oldlen5);
	if(fail5) goto alt7_2;
it=rb_ary_entry(bind,12);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_3);
 rb_ary_store(bind,13,it); int oldpos18=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,14,it); int oldpos19=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass9); it=rb_str_new2("anything"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass9);  it=Switch_Dataflow_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
	success9: ame_setsrc(self,oldsrc9); ame_setpos(self,oldpos19); ame_setlen(self,oldlen9);
	if(fail9) goto pass8;
it=CALL(first_Switch_Dataflowcb_9,1,bind); 
 rb_ary_store(bind,15,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos18); ame_setlen(self,oldlen8);
	if(fail8) goto alt7_3;
it=rb_ary_entry(bind,15);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_3: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_4);
 rb_ary_store(bind,16,it); int oldpos20=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,17,it); int oldpos21=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,rb_ary_entry(bind,17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_spaces(self ); FAILTEST(pass11); it=rb_str_new2("regch"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass11);  it=Switch_Dataflow_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
	success11: ame_setsrc(self,oldsrc11); ame_setpos(self,oldpos21); ame_setlen(self,oldlen11);
	if(fail11) goto pass10;
it=CALL(first_Switch_Dataflowcb_9,1,bind); 
 rb_ary_store(bind,18,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
it=rb_ary_entry(bind,18);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_4: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(alt7_5);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_5: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_6);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
  alt7_6:  ame_setpos(self,oldpos14); goto fail;
 accept7:;
 break;case 5:; int oldpos22=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos23=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos23);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
  it=CALL(first_Switch_Dataflowcb_5,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt9_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept9;
alt9_2: ame_setpos(self,oldpos23);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
  it=CALL(first_Switch_Dataflowcb_6,1,bind);  arg0=it; it=Switch_Dataflow_clas(self ,arg0); FAILTEST(alt9_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept9;
  alt9_3:  ame_setpos(self,oldpos23); goto alt8_2;
 accept9:;
int oldpos24=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos25; while(1){oldpos25=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos25=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos25); it=CALL(first_Switch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
...
alt8_2: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=Switch_Dataflow_first_Switch_Dataflow(self ); FAILTEST(alt8_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept8;
alt8_3: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_4);it=CALL(first_Switch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept8;
  alt8_4:  ame_setpos(self,oldpos22); goto fail;
 accept8:;
 break;}it=rb_ary_entry(bind,2);
return it;
fail: return failobj; }
VALUE Switch_Dataflow_first_Switch_Dataflow(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(18);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

char chr1=FIX2INT(CALL(switchcbSwitch_Dataflow2,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=Switch_Dataflow_value(self ); FAILTEST(break1);
 rb_ary_store(bind,2,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_2,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,7,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=Switch_Dataflow_value(self ); FAILTEST(break2);
 rb_ary_store(bind,8,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_4,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,11,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=Switch_Dataflow_value(self ); FAILTEST(break3);
 rb_ary_store(bind,12,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,3,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,13,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto fail;
...
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,15,it); it=CALL(first_Switch_Dataflow_Switch_Dataflowcb_7,1,bind); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Switch_Dataflow_value(self ); FAILTEST(pass5);
 rb_ary_store(bind,16,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos8); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=rb_ary_entry(bind,16);
 rb_ary_store(bind,17,it);   it=Switch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos7); ame_setlen(self,oldlen4);
	if(fail4) goto fail;
it=rb_ary_entry(bind,17);
 rb_ary_store(bind,5,it);  break;case 4:;   it=Switch_Dataflow_fails(self ); FAILTEST(fail); break;}it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
...
return it;
fail: return failobj; }
VALUE ClasSwitch_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(18);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,0,it); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(first_ClasSwitch_Dataflowcb_1,1,bind); FAILTEST(pass1);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(first_ClasSwitch_Dataflowcb_2,1,bind); 
 rb_ary_store(bind,1,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto alt1_2;
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt2_1: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,3,it); int oldpos5=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_value(self ); FAILTEST(pass2);
 rb_ary_store(bind,4,it); it=CALL(first_ClasSwitch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,5,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos5); ame_setlen(self,oldlen2);
	if(fail2) goto alt2_2;
...
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept2;
  alt2_4:  ame_setpos(self,oldpos4); goto fail;
 accept2:;
...
alt3_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos7=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_5,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt4_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_6,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt4_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos7); goto alt3_2;
 accept4:;
int oldpos8=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos9; while(1){oldpos9=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=CALL(first_ClasSwitch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos8); ame_setlen(self,oldlen3);
	if(fail3) goto alt3_2;
...
ISET(cut,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(alt3_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept3;
alt3_3: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt3_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept3;
  alt3_4:  ame_setpos(self,oldpos6); goto fail;
 accept3:;
...
alt5_1: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos11=ame_getpos(self);
alt6_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_5,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt6_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_6,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt6_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept6;
  alt6_3:  ame_setpos(self,oldpos11); goto alt5_2;
 accept6:;
int oldpos12=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos13; while(1){oldpos13=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=CALL(first_ClasSwitch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos12); ame_setlen(self,oldlen4);
	if(fail4) goto alt5_2;
...
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(alt5_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept5;
alt5_3: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept5;
  alt5_4:  ame_setpos(self,oldpos10); goto fail;
 accept5:;
...
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,9,it); int oldpos16=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_spaces(self ); FAILTEST(pass6); it=rb_str_new2("clas"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass6);  it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos16); ame_setlen(self,oldlen6);
	if(fail6) goto pass5;
 it=CALL(first_ClasSwitch_Dataflowcb_5,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(pass5);
 rb_ary_store(bind,10,it); int oldpos17=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass7);
 rb_ary_store(bind,11,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos17); ame_setlen(self,oldlen7);
	if(fail7) goto pass5;
it=CALL(first_ClasSwitch_Dataflowcb_8,1,bind); 
 rb_ary_store(bind,12,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos15); ame_setlen(self,oldlen5);
	if(fail5) goto alt7_2;
...
ISET(cut,Qnil);goto accept7;
alt7_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(alt7_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_3: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
alt7_4: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_5);
 rb_ary_store(bind,13,it); int oldpos18=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass8);
 rb_ary_store(bind,14,it); it=CALL(first_ClasSwitch_Dataflowcb_9,1,bind); FAILTEST(pass8);int oldpos19; while(1){oldpos19=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos19); it=CALL(first_ClasSwitch_Dataflowcb_10,1,bind); 
 rb_ary_store(bind,15,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_7,1,bind); int oldpos20=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_value(self ); FAILTEST(pass9);
 rb_ary_store(bind,16,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
	success9: ame_setsrc(self,oldsrc9); ame_setpos(self,oldpos20); ame_setlen(self,oldlen9);
	if(fail9) goto pass8;
it=rb_ary_entry(bind,16);
 rb_ary_store(bind,17,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos18); ame_setlen(self,oldlen8);
	if(fail8) goto alt7_5;
it=rb_ary_entry(bind,17);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept7;
  alt7_5:  ame_setpos(self,oldpos14); goto fail;
 accept7:;
 break;case 5:; int oldpos21=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 int oldpos22=ame_getpos(self);
alt9_1: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_5,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt9_2);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept9;
alt9_2: ame_setpos(self,oldpos22);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
  it=CALL(first_ClasSwitch_Dataflowcb_6,1,bind);  arg0=it; it=ClasSwitch_Dataflow_clas(self ,arg0); FAILTEST(alt9_3);
 rb_ary_store(bind,6,it);  
ISET(cut,Qnil);goto accept9;
  alt9_3:  ame_setpos(self,oldpos22); goto alt8_2;
 accept9:;
int oldpos23=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos24; while(1){oldpos24=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos24=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos24); it=CALL(first_ClasSwitch_Dataflowcb_7,1,bind); 
 rb_ary_store(bind,7,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
alt8_2: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(self ); FAILTEST(alt8_3);
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept8;
alt8_3: ame_setpos(self,oldpos21);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_4);it=CALL(first_ClasSwitch_Dataflowcb_3,1,bind); 
 rb_ary_store(bind,2,it);  
ISET(cut,Qnil);goto accept8;
...
return it;
fail: return failobj; }
VALUE ClasSwitch_Dataflow_first_ClasSwitch_Dataflow(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(18);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

char chr1=FIX2INT(CALL(switchcbClasSwitch_Dataflow5,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break1);
 rb_ary_store(bind,2,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_2,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,7,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break2);
 rb_ary_store(bind,8,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,3,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_4,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,11,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=ClasSwitch_Dataflow_value(self ); FAILTEST(break3);
 rb_ary_store(bind,12,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,11);
 rb_ary_store(bind,3,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_4,1,bind); 
 rb_ary_store(bind,13,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto fail;
...
ame_setsrc(self,rb_ary_entry(bind,14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,15,it); it=CALL(first_ClasSwitch_Dataflow_ClasSwitch_Dataflowcb_7,1,bind); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_value(self ); FAILTEST(pass5);
 rb_ary_store(bind,16,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos8); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=rb_ary_entry(bind,16);
 rb_ary_store(bind,17,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos7); ame_setlen(self,oldlen4);
	if(fail4) goto fail;
it=rb_ary_entry(bind,17);
 rb_ary_store(bind,5,it);  break;case 4:;   it=ClasSwitch_Dataflow_fails(self ); FAILTEST(fail); break;}it=rb_ary_entry(bind,5);
return it;
fail: return failobj; }
VALUE ClasSwitch_Dataflow_getvalue(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_ary_new2(4); rb_ary_store(bind,0,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

it=CALL(getvalue_ClasSwitch_Dataflowcb_1,1,bind); 
 rb_ary_store(bind,1,it); it=CALL(getvalue_ClasSwitch_Dataflowcb_2,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=ClasSwitch_Dataflow_first(self ); FAILTEST(pass1);
 rb_ary_store(bind,2,it);   it=ClasSwitch_Dataflow_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
...
VALUE Detect_First_clas(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_ary_new2(3); rb_ary_store(bind,1,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

  it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); it=CALL(clas_Detect_Firstcb_1,1,bind); FAILTEST(fail);it=rb_ary_entry(bind,0);
 rb_ary_store(bind,2,it); it=rb_ary_entry(bind,2);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);
 rb_ary_store(bind,0,it); int oldpos1; while(1){oldpos1=ame_getpos(self); char chr1=FIX2INT(CALL(switchcbDetect_First8,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,2,it); it=CALL(itrans_Detect_Firstcb_4,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
ame_setsrc(self,rb_ary_entry(bind,3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=CALL(itrans_Detect_Firstcb_5,1,bind);  arg0=it; it=Detect_First_clas(self ,arg0); FAILTEST(break2);
...
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,6,it);   it=Detect_First_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos7); ame_setlen(self,oldlen4);
	if(fail4) goto break2;
it=rb_ary_entry(bind,6);
 rb_ary_store(bind,7,it); it=CALL(itrans_Detect_Firstcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,4);
 rb_ary_store(bind,8,it);   it=Detect_First_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto pass2;
...
it=CALL(itrans_Detect_Firstcb_7,1,bind); it=CALL(itrans_Detect_Firstcb_8,1,bind); 
 rb_ary_store(bind,9,it);   it=Detect_First_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,10,it);  break;}it=CALL(itrans_Detect_Firstcb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=CALL(traverse_Detect_Firstcb_1,1,bind); 
 rb_ary_store(bind,0,it); it=CALL(itrans_Detect_Firstcb_8,1,bind); 
 rb_ary_store(bind,1,it); it=Qnil;
 rb_ary_store(bind,2,it); it=Qfalse;
 rb_ary_store(bind,3,it); it=CALL(traverse_Detect_Firstcb_2,1,bind); 
 rb_ary_store(bind,4,it); it=CALL(traverse_Detect_Firstcb_3,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,7,it); it=CALL(traverse_Detect_Firstcb_4,1,bind);   it=Detect_First_traverse_item(self ); FAILTEST(pass3);
 rb_ary_store(bind,8,it); it=CALL(traverse_Detect_Firstcb_5,1,bind);   it=Detect_First_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
...
char chr1=FIX2INT(CALL(switchcbDetect_First9,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=CALL(visit,0 ); FAILTEST(alt1_2);
 rb_ary_store(bind,0,it); it=CALL(traverse_item_Detect_Firstcb_1,1,bind); it=rb_ary_entry(bind,0);
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,3,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Detect_First_traverse_item(self ); FAILTEST(break1);
 rb_ary_store(bind,4,it); it=CALL(traverse_item_Detect_Firstcb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,5,it);   it=Detect_First_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,7,it);   it=Detect_First_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos5); ame_setlen(self,oldlen2);
...
char chr1=FIX2INT(CALL(switchcbDetect_Switch10,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 char chr1=FIX2INT(CALL(switchcbDetect_ClasSwitch11,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos2=ame_getpos(self);
...
char chr1=FIX2INT(CALL(switchcbDetect_ClasSwitch12,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('53cb664a0a6391a5f0aa5a8f52faf0ef')");}
