...
cstruct oldpass6=*ptr; int fail6=0;
          ptr->src=bind_aget(bind,23/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass7=*ptr; int fail7=0;
          ptr->src=bind_aget(bind,28/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_First_Dataflow_bind_lb_31_rb_,1,bind); cstruct oldpass8=*ptr; int fail8=0;
          ptr->src=bind_aget(bind,31/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass4=*ptr; int fail4=0;
          ptr->src=bind_aget(bind,20/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass7=*ptr; int fail7=0;
          ptr->src=bind_aget(bind,38/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_Detect_ClasSwitch,"visit",Detect_ClasSwitch_visit,0);
 rb_eval_string("testversiondetect_switch('d69eda3f29c9d50a7b9dfc739c495b8f')");}
