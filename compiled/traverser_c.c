...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Traverser_Clone2__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Visitor__lp_src_dot_ins_a413,1,bind2); var0/*autovar*/=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
                    rb_eval_string("testversiontraverser('14964d6166893e6bfdd6acfb3a877214')");}
