...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_Traverser_Clone2__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
alt3_1:;  it=Traverser_Clone2_traverse_item(self ); FAILTEST(alt3_2); var6/*it*/=it;;
bind_aset(bind2,1,var5/*ar*/);bind_aset(bind2,2,var6/*it*/);it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_1_rb__lt__7b20,1,bind2);var5/*ar*/=bind_aget(bind2,1);;var6/*it*/=bind_aget(bind2,2);;
;goto accept3;
...
alt4_1:;  it=rb_funcall(self,sy_visit,0); FAILTEST(alt4_2); var0/*a*/=it;;
it=rb_funcall(self,sy_Traverser_Clone2__at_changed_5352,1,bind2);it=var0/*a*/; var1/*_result*/=it;;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_Visitor__lp_src_dot_ins_a413,1,bind2); var0/*autovar*/=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int stop2=0; while(!stop2){ int oldpos2=ptr->pos;int cut2=0;
alt2_1:;  it=Visitor_traverse_item(self ); FAILTEST(alt2_2); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_Visitor__append_lp__d113,1,bind2);var2/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);;
;goto accept2;
alt2_2: ptr->pos=oldpos2;stop2=1;
;goto accept2;
alt2_3: ptr->pos=oldpos2;goto pass2;
...
int stop1=0; while(!stop1){ int oldpos3=ptr->pos;int cut3=0;
alt3_1:;  it=Visitor_traverse_item(self ); FAILTEST(alt3_2); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Visitor__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt3_2: ptr->pos=oldpos3;stop1=1;
;goto accept3;
alt3_3: ptr->pos=oldpos3;goto pass2;
...
alt2_4: ptr->pos=oldpos2;goto fail;
 ...
 break;
case 2/*Object*/:; int oldpos4=ptr->pos;int cut4=0;
alt4_1:;  it=rb_funcall(self,sy_visit,0); FAILTEST(alt4_2); var0/*_result*/=it;;
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
                    rb_eval_string("testversiontraverser('698c31d582166398ca534bf7130107dd')");}
