...
static VALUE sy_Traverser_Clone2__append_lp_1;
static VALUE sy_Traverser_Clone2__append_lp_2;
static VALUE sy_Traverser_Clone2__append_lp_3;
static VALUE sy_Traverser_Clone2__at_changed1;
static VALUE sy_Traverser_Clone2__at_changed2;
static VALUE sy_Traverser_Clone2__at_changed3;
static VALUE sy_Traverser_Clone2__lp_bind_lb_4_rb_1;
static VALUE sy_Traverser_Clone2__lp_src_dot_ins1;
static VALUE sy_Traverser_Clone2_bind_lb_5_rb__lt_1;
static VALUE sy_Traverser_Clone2_bind_lb_6_rb__eq_1;
static VALUE sy_Traverser_Clone2_if1;
static VALUE sy_Traverser_Clone2_src1;
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Traverser_Clone2__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Traverser_Clone2__at_changed2,1,bind); 
 bind_aset(bind,2/*oldchanged*/,it); it=rb_funcall(self,sy_Traverser_Clone2_src1,1,bind); 
 bind_aset(bind,3/*this*/,it); it=Qnil;
 bind_aset(bind,4/*clon*/,it); it=Qfalse;
 bind_aset(bind,5/*changed*/,it); it=rb_funcall(self,sy_Traverser_Clone2__lp_src_dot_ins1,1,bind); 
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_6_rb__eq_1,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,10/*key*/,it); it=rb_funcall(self,sy_Traverser_Clone2__at_changed3,1,bind);   it=Traverser_Clone2_traverse_item(self ); FAILTEST(pass3);
 bind_aset(bind,11/*val*/,it); it=rb_funcall(self,sy_Traverser_Clone2__lp_bind_lb_4_rb_1,1,bind); 
...
it=bind_aget(bind,12/*autovar*/);
 bind_aset(bind,13/*autovar*/,it); it=rb_funcall(self,sy_Traverser_Clone2__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,sy_Traverser_Clone2_if1,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=rb_funcall(self,sy_visit,0); FAILTEST(alt1_2);
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Traverser_Clone2__at_changed1,1,bind); it=bind_aget(bind,0/*a*/);
...
alt2_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=rb_funcall(self,sy_visit,0); FAILTEST(alt2_2);
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Traverser_Clone2__at_changed1,1,bind); it=bind_aget(bind,0/*a*/);
 bind_aset(bind,1/*_result*/,it);  
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_5_rb__lt_1,1,bind); 
 bind_aset(bind,8/*autovar*/,it); it=rb_funcall(self,sy_Traverser_Clone2__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/);
...
alt3_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=rb_funcall(self,sy_visit,0); FAILTEST(alt3_2);
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Traverser_Clone2__at_changed1,1,bind); it=bind_aget(bind,0/*a*/);
 bind_aset(bind,1/*_result*/,it);  
...
static VALUE sy_Visitor__append_lp_1;
static VALUE sy_Visitor__append_lp_2;
static VALUE sy_Visitor__lp_src_dot_ins1;
static VALUE sy_Visitor_bind_lb_2_rb__eq_1;
static VALUE sy_size;
static VALUE sy_visit;
...
it=rb_ary_new3(0);
 bind_aset(bind,0/*autovar*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Visitor__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Visitor__lp_src_dot_ins1,1,bind); 
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_Visitor_bind_lb_2_rb__eq_1,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Visitor__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,4/*autovar*/);
...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Visitor__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,4/*autovar*/);
 bind_aset(bind,6/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
...
sy_Traverser_Clone2__append_lp_1=rb_intern("Traverser_Clone2__append_lp_1");
...
sy_Traverser_Clone2__at_changed1=rb_intern("Traverser_Clone2__at_changed1");
...
sy_Traverser_Clone2__lp_bind_lb_4_rb_1=rb_intern("Traverser_Clone2__lp_bind_lb_4_rb_1");
sy_Traverser_Clone2__lp_src_dot_ins1=rb_intern("Traverser_Clone2__lp_src_dot_ins1");
sy_Traverser_Clone2_bind_lb_5_rb__lt_1=rb_intern("Traverser_Clone2_bind_lb_5_rb__lt_1");
sy_Traverser_Clone2_bind_lb_6_rb__eq_1=rb_intern("Traverser_Clone2_bind_lb_6_rb__eq_1");
sy_Traverser_Clone2_if1=rb_intern("Traverser_Clone2_if1");
sy_Traverser_Clone2_src1=rb_intern("Traverser_Clone2_src1");
...
sy_Visitor__append_lp_1=rb_intern("Visitor__append_lp_1");
sy_Visitor__append_lp_2=rb_intern("Visitor__append_lp_2");
sy_Visitor__lp_src_dot_ins1=rb_intern("Visitor__lp_src_dot_ins1");
sy_Visitor_bind_lb_2_rb__eq_1=rb_intern("Visitor_bind_lb_2_rb__eq_1");
sy_size=rb_intern("size");
sy_visit=rb_intern("visit");
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
 rb_eval_string("testversiontraverser('e5b3b17c7c4b56b24c966c4adae4309d')");}
