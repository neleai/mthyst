...
static VALUE sy_Traverser_Clone2__append_lp_bind2;
static VALUE sy_Traverser_Clone2__append_lp_bind3;
static VALUE sy_Traverser_Clone2__append_lp_bind;
static VALUE sy_Traverser_Clone2__at_changed;
static VALUE sy_Traverser_Clone2__at_changed_eq_fal;
static VALUE sy_Traverser_Clone2__at_changed_eq_tru;
static VALUE sy_Traverser_Clone2__lp_bind_lb_4_rb_;
static VALUE sy_Traverser_Clone2__lp_src_dot_instanc;
static VALUE sy_Traverser_Clone2_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Traverser_Clone2_if_sp_bind_lb_5_rb_;
...
it=rb_funcall(self,sy_Traverser_Clone2__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Traverser_Clone2__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Traverser_Clone2__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
...
it=rb_funcall(self,sy_Traverser_Clone2__at_changed_eq_fal,1,bind);   it=Traverser_Clone2_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
...
it=rb_funcall(self,sy_Traverser_Clone2__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,sy_Traverser_Clone2_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
...
it=rb_funcall(self,sy_Traverser_Clone2__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Traverser_Clone2__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
...
static VALUE sy_Visitor__append_lp_bind2;
static VALUE sy_Visitor__append_lp_bind;
static VALUE sy_Visitor__lp_src_dot_instanc;
static VALUE sy_visit;
...
it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Visitor__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Visitor__lp_src_dot_instanc,1,bind);  bind_aset(bind,2/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Visitor__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Visitor__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
sy_Traverser_Clone2__append_lp_bind2=rb_intern("Traverser_Clone2__append_lp_bind2");
sy_Traverser_Clone2__append_lp_bind3=rb_intern("Traverser_Clone2__append_lp_bind3");
sy_Traverser_Clone2__append_lp_bind=rb_intern("Traverser_Clone2__append_lp_bind");
sy_Traverser_Clone2__at_changed=rb_intern("Traverser_Clone2__at_changed");
sy_Traverser_Clone2__at_changed_eq_fal=rb_intern("Traverser_Clone2__at_changed_eq_fal");
sy_Traverser_Clone2__at_changed_eq_tru=rb_intern("Traverser_Clone2__at_changed_eq_tru");
sy_Traverser_Clone2__lp_bind_lb_4_rb_=rb_intern("Traverser_Clone2__lp_bind_lb_4_rb_");
sy_Traverser_Clone2__lp_src_dot_instanc=rb_intern("Traverser_Clone2__lp_src_dot_instanc");
sy_Traverser_Clone2_bind_lb_5_rb__lt__lt_bin=rb_intern("Traverser_Clone2_bind_lb_5_rb__lt__lt_bin");
sy_Traverser_Clone2_if_sp_bind_lb_5_rb_=rb_intern("Traverser_Clone2_if_sp_bind_lb_5_rb_");
...
sy_Visitor__append_lp_bind2=rb_intern("Visitor__append_lp_bind2");
sy_Visitor__append_lp_bind=rb_intern("Visitor__append_lp_bind");
sy_Visitor__lp_src_dot_instanc=rb_intern("Visitor__lp_src_dot_instanc");
sy_visit=rb_intern("visit");
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
 rb_eval_string("testversiontraverser('d36939d0530c326bd9b7eea030ffbf71')");}
