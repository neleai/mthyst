...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeTraverser_Clone2,0)));
 ...
 rb_ary_store(bind,6/*it*/,it); it=rb_funcall(self,s_traverse_item_Traverser_Clone2cb_2Traverser_Clone2,1,bind);  if (rb_ivar_get(self,s__at_stopTraverser_Clone2)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopTraverser_Clone2,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,5/*ar*/);
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopVisitor)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopVisitor,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Visitorcb_1Visitor,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeVisitor,0)));
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=rb_funcall(self,s_traverse_Visitorcb_3Visitor,1,bind);  if (rb_ivar_get(self,s__at_stopVisitor)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopVisitor,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,2/*autovar*/);
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeVisitor,0)));
 ...
 rb_ary_store(bind,5/*autovar*/,it); it=rb_funcall(self,s_traverse_item_Visitorcb_1Visitor,1,bind);  if (rb_ivar_get(self,s__at_stopVisitor)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopVisitor,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,4/*autovar*/);
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
 rb_eval_string("testversiontraverser('eea3a6c5c522bd954c015cd3a9598d7f')");}
