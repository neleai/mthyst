...
static VALUE sy_Traverser_Clone2__append_lp__37c5;
...
static VALUE sy_Traverser_Clone2_bind_lb_5_rb__lt__dccc;
...
it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_5_rb__lt__dccc,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Traverser_Clone2__append_lp__37c5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
...
sy_Traverser_Clone2__append_lp__37c5=rb_intern("Traverser_Clone2__append_lp__37c5");
...
sy_Traverser_Clone2_bind_lb_5_rb__lt__dccc=rb_intern("Traverser_Clone2_bind_lb_5_rb__lt__dccc");
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
 rb_eval_string("testversiontraverser('9383078f067592b8c43bdd9179aa530d')");}
