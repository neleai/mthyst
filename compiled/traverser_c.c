...
it=rb_funcall(self,sy_Traverser_Clone2_bind_lb_6_rb__eq_,1,bind); cstruct oldpass1=*ptr; int fail1=0;
...
it=rb_funcall(self,sy_Visitor_bind_lb_2_rb__eq_,1,bind); cstruct oldpass1=*ptr; int fail1=0;
          ptr->src=bind_aget(bind,2/*autovar*/); ptr->pos=0; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else ptr->len=FIX2LONG(rb_funcall(ptr->src,sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_Visitor,"traverse_item",Visitor_traverse_item,0);
 rb_eval_string("testversiontraverser('cdfcc408107377d548f6fb795ce66b57')");}
