...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_DetectCalls__lp_src_dot_ins_a413,1,bind2); var0/*autovar*/=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt3_3: ptr->pos=oldpos3;goto pass2;
 accept3:;
 } it=var4/*autovar*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt4_3); var0/*_result*/=it;;
...
alt1_3: ptr->pos=oldpos1;goto pass1;
 accept1:;
 } bind_aset(bind2,1,var1/*name*/);it=rb_funcall(self,sy_DetectCalls__at_calls_lb_b_e709,1,bind2);var1/*name*/=bind_aget(bind2,1);; var2/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_Inliner2__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
rb_define_method(cls_Inliner2,"visit",Inliner2_visit,0);
                    rb_eval_string("testversioninliner2('bac502346bb27deaf47c64c47990f1a4')");}
