...
static VALUE c_Rule;
static VALUE sy_DetectCalls__append_lp_bind2;
static VALUE sy_DetectCalls__append_lp_bind3;
static VALUE sy_DetectCalls__append_lp_bind;
static VALUE sy_DetectCalls__at_calls;
static VALUE sy_DetectCalls__at_calls_eq__le__re_;
static VALUE sy_DetectCalls__at_calls_lb_bind_lb_;
static VALUE sy_DetectCalls__lp_src_dot_instanc;
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_DetectCalls__at_calls_eq__le__re_,1,bind);   it=DetectCalls_traverse(self ); FAILTEST(pass1);it=rb_funcall(self,sy_DetectCalls__at_calls,1,bind);  bind_aset(bind,1/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE DetectCalls_traverse(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(9);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_DetectCalls__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_DetectCalls__lp_src_dot_instanc,1,bind);  bind_aset(bind,2/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos2; while(1){oldpos2=ame_getpos(self);   it=DetectCalls_traverse_item(self ); FAILTEST(break2); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_DetectCalls__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*autovar*/,it);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,3/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=DetectCalls_traverse_item(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_DetectCalls__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
return it;
fail: return failobj; }
VALUE DetectCalls_visit(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_DetectCalls__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,2/*autovar*/);it=rb_funcall(self,sy_DetectCalls__at_calls_lb_bind_lb_,1,bind);  bind_aset(bind,4/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
static VALUE c_Apply;
static VALUE c_Rule;
static VALUE sy_Inliner2__append_lp_bind2;
static VALUE sy_Inliner2__append_lp_bind3;
static VALUE sy_Inliner2__append_lp_bind4;
static VALUE sy_Inliner2__append_lp_bind;
static VALUE sy_Inliner2__at_changed;
static VALUE sy_Inliner2__at_changed_eq_fal;
static VALUE sy_Inliner2__at_changed_eq_tru;
static VALUE sy_Inliner2__at_name_eq_bind_lb_4;
static VALUE sy_Inliner2__lp_bind_lb_1_rb__eq__eq__at_n;
static VALUE sy_Inliner2__lp_bind_lb_4_rb_;
static VALUE sy_Inliner2__lp_src_dot_instanc;
static VALUE sy_Inliner2_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Inliner2_body_eq__at_body;
static VALUE sy_Inliner2_if_sp_bind_lb_5_rb_;
static VALUE sy_Inliner2_src;
static VALUE sy_Inliner2_src_dot_args;
static VALUE sy_Inliner2_src_dot_body;
static VALUE sy_Inliner2_src_dot_locals;
...
it=rb_funcall(self,sy_Inliner2_src_dot_locals,1,bind); it=rb_funcall(self,sy_Inliner2_src_dot_body,1,bind);  bind_aset(bind,6/*body*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Inliner2__at_name_eq_bind_lb_4,1,bind); it=bind_aget(bind,1/*to*/); bind_aset(bind,7/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Inliner2_traverse(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(15);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);

it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Inliner2__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Inliner2__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Inliner2__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Inliner2__at_changed_eq_fal,1,bind);   it=Inliner2_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
...
it=rb_funcall(self,sy_Inliner2__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Inliner2_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
VALUE Inliner2_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_Inliner2__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Inliner2_traverse_item(self ); FAILTEST(break1); bind_aset(bind,7/*it*/,it);
it=rb_funcall(self,sy_Inliner2_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Inliner2__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=AmethystCore_anything(self ); FAILTEST(pass1); bind_aset(bind,1/*name*/,it);
it=rb_funcall(self,sy_Inliner2__lp_bind_lb_1_rb__eq__eq__at_n,1,bind); FAILTEST(pass1);it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Inliner2__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*args*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Inliner2_body_eq__at_body,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/);
return it;
...
static VALUE c_Apply;
static VALUE c_Rule;
static VALUE sy_Replace_Super_Apply_lb__ti__lp__lb__at_na;
static VALUE sy_Replace_Super__append_lp_bind2;
static VALUE sy_Replace_Super__append_lp_bind3;
static VALUE sy_Replace_Super__append_lp_bind4;
static VALUE sy_Replace_Super__append_lp_bind;
static VALUE sy_Replace_Super__at_changed;
static VALUE sy_Replace_Super__at_changed_eq_fal;
static VALUE sy_Replace_Super__at_changed_eq_tru;
static VALUE sy_Replace_Super__at_name_eq_bind_lb_0;
static VALUE sy_Replace_Super__lp_bind_lb_1_rb__eq__eq__dq_s;
static VALUE sy_Replace_Super__lp_bind_lb_4_rb_;
static VALUE sy_Replace_Super__lp_src_dot_instanc;
static VALUE sy_Replace_Super_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Replace_Super_if_sp_bind_lb_5_rb_;
...
VALUE Replace_Super_root(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(7);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
  ...
  it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,1/*to*/,it);
it=rb_funcall(self,sy_Replace_Super__at_name_eq_bind_lb_0,1,bind); it=bind_aget(bind,1/*to*/); bind_aset(bind,2/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,2/*autovar*/);ptr->len=1;
  it=c_Rule; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass1); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
return it;
fail: return failobj; }
VALUE Replace_Super_traverse(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(15);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);

it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Replace_Super__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Replace_Super__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
it=rb_funcall(self,sy_Replace_Super_src,1,bind);  bind_aset(bind,3/*this*/,it);
it=Qnil; bind_aset(bind,4/*clon*/,it);
it=Qfalse; bind_aset(bind,5/*changed*/,it);
it=rb_funcall(self,sy_Replace_Super__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,6/*autovar*/);ptr->len=1;
   it=AmethystCore_anything(self ); FAILTEST(pass1); bind_aset(bind,7/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,9/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=AmethystCore_anything(self ); FAILTEST(pass3); bind_aset(bind,10/*key*/,it);
it=rb_funcall(self,sy_Replace_Super__at_changed_eq_fal,1,bind);   it=Replace_Super_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
it=rb_funcall(self,sy_Replace_Super__lp_bind_lb_4_rb_,1,bind);  bind_aset(bind,12/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	...
	if(fail3) goto break2;
it=bind_aget(bind,12/*autovar*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Replace_Super__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Replace_Super_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
VALUE Replace_Super_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);

unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashTraverser_Clone21,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=Replace_Super_visit(self ); FAILTEST(alt1_2); bind_aset(bind,0/*a*/,it);
it=rb_funcall(self,sy_Replace_Super__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,5/*ar*/,it);
it=rb_ary_new3(0); bind_aset(bind,6/*autovar*/,it);
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Replace_Super_traverse_item(self ); FAILTEST(break1); bind_aset(bind,7/*it*/,it);
it=rb_funcall(self,sy_Replace_Super_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Replace_Super__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
   it=AmethystCore_anything(self ); FAILTEST(pass1); bind_aset(bind,1/*name*/,it);
it=rb_funcall(self,sy_Replace_Super__lp_bind_lb_1_rb__eq__eq__dq_s,1,bind); FAILTEST(pass1);it=rb_ary_new3(0); bind_aset(bind,2/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Replace_Super__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,2/*autovar*/); bind_aset(bind,4/*args*/,it);
it=rb_funcall(self,sy_Replace_Super_Apply_lb__ti__lp__lb__at_na,1,bind);  bind_aset(bind,5/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
sy_DetectCalls__append_lp_bind2=rb_intern("DetectCalls__append_lp_bind2");
sy_DetectCalls__append_lp_bind3=rb_intern("DetectCalls__append_lp_bind3");
sy_DetectCalls__append_lp_bind=rb_intern("DetectCalls__append_lp_bind");
sy_DetectCalls__at_calls=rb_intern("DetectCalls__at_calls");
sy_DetectCalls__at_calls_eq__le__re_=rb_intern("DetectCalls__at_calls_eq__le__re_");
sy_DetectCalls__at_calls_lb_bind_lb_=rb_intern("DetectCalls__at_calls_lb_bind_lb_");
sy_DetectCalls__lp_src_dot_instanc=rb_intern("DetectCalls__lp_src_dot_instanc");
...
sy_Inliner2__append_lp_bind2=rb_intern("Inliner2__append_lp_bind2");
sy_Inliner2__append_lp_bind3=rb_intern("Inliner2__append_lp_bind3");
sy_Inliner2__append_lp_bind4=rb_intern("Inliner2__append_lp_bind4");
sy_Inliner2__append_lp_bind=rb_intern("Inliner2__append_lp_bind");
sy_Inliner2__at_changed=rb_intern("Inliner2__at_changed");
sy_Inliner2__at_changed_eq_fal=rb_intern("Inliner2__at_changed_eq_fal");
sy_Inliner2__at_changed_eq_tru=rb_intern("Inliner2__at_changed_eq_tru");
sy_Inliner2__at_name_eq_bind_lb_4=rb_intern("Inliner2__at_name_eq_bind_lb_4");
sy_Inliner2__lp_bind_lb_1_rb__eq__eq__at_n=rb_intern("Inliner2__lp_bind_lb_1_rb__eq__eq__at_n");
sy_Inliner2__lp_bind_lb_4_rb_=rb_intern("Inliner2__lp_bind_lb_4_rb_");
sy_Inliner2__lp_src_dot_instanc=rb_intern("Inliner2__lp_src_dot_instanc");
sy_Inliner2_bind_lb_5_rb__lt__lt_bin=rb_intern("Inliner2_bind_lb_5_rb__lt__lt_bin");
sy_Inliner2_body_eq__at_body=rb_intern("Inliner2_body_eq__at_body");
sy_Inliner2_if_sp_bind_lb_5_rb_=rb_intern("Inliner2_if_sp_bind_lb_5_rb_");
...
sy_Inliner2_src_dot_locals=rb_intern("Inliner2_src_dot_locals");
...
c_Rule=rb_const_get(rb_cObject, rb_intern("Rule"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_Rule);
switchhashTraverser_Clone21=rb_eval_string("Hash.new{|h,k|\nnext h[k]=0 if k<=AmethystAST\nnext h[k]=1 if k<=Array\nnext h[k]=2 if k<=Object\n}\n");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),switchhashTraverser_Clone21);
sy_Replace_Super_Apply_lb__ti__lp__lb__at_na=rb_intern("Replace_Super_Apply_lb__ti__lp__lb__at_na");
sy_Replace_Super__append_lp_bind2=rb_intern("Replace_Super__append_lp_bind2");
sy_Replace_Super__append_lp_bind3=rb_intern("Replace_Super__append_lp_bind3");
sy_Replace_Super__append_lp_bind4=rb_intern("Replace_Super__append_lp_bind4");
sy_Replace_Super__append_lp_bind=rb_intern("Replace_Super__append_lp_bind");
sy_Replace_Super__at_changed=rb_intern("Replace_Super__at_changed");
sy_Replace_Super__at_changed_eq_fal=rb_intern("Replace_Super__at_changed_eq_fal");
sy_Replace_Super__at_changed_eq_tru=rb_intern("Replace_Super__at_changed_eq_tru");
sy_Replace_Super__at_name_eq_bind_lb_0=rb_intern("Replace_Super__at_name_eq_bind_lb_0");
sy_Replace_Super__lp_bind_lb_1_rb__eq__eq__dq_s=rb_intern("Replace_Super__lp_bind_lb_1_rb__eq__eq__dq_s");
sy_Replace_Super__lp_bind_lb_4_rb_=rb_intern("Replace_Super__lp_bind_lb_4_rb_");
sy_Replace_Super__lp_src_dot_instanc=rb_intern("Replace_Super__lp_src_dot_instanc");
sy_Replace_Super_bind_lb_5_rb__lt__lt_bin=rb_intern("Replace_Super_bind_lb_5_rb__lt__lt_bin");
sy_Replace_Super_if_sp_bind_lb_5_rb_=rb_intern("Replace_Super_if_sp_bind_lb_5_rb_");
...
rb_define_method(cls_Replace_Super,"visit",Replace_Super_visit,0);
 rb_eval_string("testversioninliner2('d52bf9304123bebf5e7daad62760e834')");}
