...
VALUE c_313;
VALUE c_315;
VALUE s__at_cutDetectCalls;
VALUE s__at_stopDetectCalls;
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeDetectCalls,0)));
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopDetectCalls)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopDetectCalls,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_DetectCallscb_1DetectCalls,1,bind); 
 rb_ary_store(bind,0/*autovar*/,it); it=rb_funcall(self,s_traverse_DetectCallscb_2DetectCalls,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeDetectCalls,0)));
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeDetectCalls,0)));
 it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,3/*autovar*/,it); it=rb_funcall(self,s_traverse_DetectCallscb_3DetectCalls,1,bind);  if (rb_ivar_get(self,s__at_stopDetectCalls)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopDetectCalls,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,2/*autovar*/);
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
   it=DetectCalls_visit(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,0/*_result*/,it);  
rb_ivar_set(self,s__at_cutDetectCalls,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
...
it=rb_ary_entry(bind,2/*autovar*/);
 rb_ary_store(bind,0/*_result*/,it);  
rb_ivar_set(self,s__at_cutDetectCalls,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
...
alt2_1: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
   it=DetectCalls_visit(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,0/*_result*/,it);  
rb_ivar_set(self,s__at_cutDetectCalls,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeDetectCalls,0)));
 it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,5/*autovar*/,it); it=rb_funcall(self,s_traverse_item_DetectCallscb_1DetectCalls,1,bind);  if (rb_ivar_get(self,s__at_stopDetectCalls)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopDetectCalls,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,4/*autovar*/);
...
it=rb_ary_entry(bind,6/*autovar*/);
 rb_ary_store(bind,0/*_result*/,it);  
rb_ivar_set(self,s__at_cutDetectCalls,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
...
alt3_1: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
   it=DetectCalls_visit(self ); FAILTEST(alt3_2);
 rb_ary_store(bind,0/*_result*/,it);  
rb_ivar_set(self,s__at_cutDetectCalls,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutDetectCalls)!=Qnil) {rb_ivar_set(self,s__at_cutDetectCalls,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeDetectCalls,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,1/*name*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopDetectCalls)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopDetectCalls,Qnil);  ame_setpos(self,oldpos2); it=rb_funcall(self,s_visit_DetectCallscb_1DetectCalls,1,bind); 
 rb_ary_store(bind,2/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
...
VALUE c_320;
VALUE c_321;
VALUE s__at_cutInliner2;
VALUE s__at_stopInliner2;
...
VALUE Inliner2_root(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(12);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,2/*autovar*/,it); it=rb_funcall(self,s_root_Inliner2cb_1Inliner2,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
 it=rb_funcall(self,s_root_Inliner2cb_2Inliner2,1,bind); 
 rb_ary_store(bind,4/*name*/,it); it=rb_funcall(self,s_root_Inliner2cb_3Inliner2,1,bind); 
 rb_ary_store(bind,5/*args*/,it); it=rb_funcall(self,s_root_Inliner2cb_4Inliner2,1,bind); it=rb_funcall(self,s_root_Inliner2cb_5Inliner2,1,bind); 
 rb_ary_store(bind,6/*body*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
it=rb_funcall(self,s_root_Inliner2cb_6Inliner2,1,bind); it=rb_ary_entry(bind,1/*to*/);
 rb_ary_store(bind,7/*autovar*/,it); it=rb_funcall(self,s_root_Inliner2cb_7Inliner2,1,bind); int oldpos3=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
...
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopInliner2)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopInliner2,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Inliner2cb_1Inliner2,1,bind); 
 rb_ary_store(bind,0/*oldchanged*/,it); it=rb_funcall(self,s_traverse_Inliner2cb_2Inliner2,1,bind); 
 rb_ary_store(bind,1/*this*/,it); it=Qnil;
 rb_ary_store(bind,2/*clon*/,it); it=Qfalse;
 rb_ary_store(bind,3/*changed*/,it); it=rb_funcall(self,s_traverse_Inliner2cb_3Inliner2,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it); it=rb_funcall(self,s_traverse_Inliner2cb_4Inliner2,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
...
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,7/*key*/,it); it=rb_funcall(self,s_traverse_Inliner2cb_5Inliner2,1,bind);   it=Inliner2_traverse_item(self ); FAILTEST(pass3);
 rb_ary_store(bind,8/*val*/,it); it=rb_funcall(self,s_traverse_Inliner2cb_6Inliner2,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto break2;
 if (rb_ivar_get(self,s__at_stopInliner2)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopInliner2,Qnil);  ame_setpos(self,oldpos4);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=Inliner2_visit(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Inliner2cb_1Inliner2,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
...
it=rb_ary_entry(bind,3/*autovar*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_4);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 break;case 1:; int oldpos3=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=Inliner2_visit(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Inliner2cb_1Inliner2,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
 ...
 rb_ary_store(bind,6/*it*/,it); it=rb_funcall(self,s_traverse_item_Inliner2cb_2Inliner2,1,bind);  if (rb_ivar_get(self,s__at_stopInliner2)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopInliner2,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,5/*ar*/);
...
it=rb_ary_entry(bind,7/*autovar*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_4);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept2;
  alt2_4:  ame_setpos(self,oldpos3); goto fail;
 accept2:;
 break;case 2:; int oldpos6=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=Inliner2_visit(self ); FAILTEST(alt3_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Inliner2cb_1Inliner2,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutInliner2)!=Qnil) {rb_ivar_set(self,s__at_cutInliner2,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt3_3);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutInliner2,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos6); goto fail;
...
VALUE Inliner2_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(6);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,0/*autovar*/,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeInliner2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,1/*name*/,it); it=rb_funcall(self,s_visit_Inliner2cb_1Inliner2,1,bind); FAILTEST(pass1);it=rb_ary_new3(0);
 rb_ary_store(bind,2/*autovar*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 rb_ary_store(bind,3/*autovar*/,it); it=rb_funcall(self,s_visit_Inliner2cb_2Inliner2,1,bind);  if (rb_ivar_get(self,s__at_stopInliner2)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopInliner2,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2/*autovar*/);
...
VALUE c_324;
VALUE c_327;
VALUE s__at_cutReplace_Super;
VALUE s__at_stopReplace_Super;
...
VALUE Replace_Super_root(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(7);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,1/*to*/,it); it=rb_funcall(self,s_root_Replace_Supercb_1Replace_Super,1,bind); it=rb_ary_entry(bind,1/*to*/);
 rb_ary_store(bind,2/*autovar*/,it); it=rb_funcall(self,s_root_Replace_Supercb_2Replace_Super,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
  it=c_327; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass1);
 rb_ary_store(bind,3/*autovar*/,it); int oldpos2=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopReplace_Super)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopReplace_Super,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Replace_Supercb_1Replace_Super,1,bind); 
 rb_ary_store(bind,0/*oldchanged*/,it); it=rb_funcall(self,s_traverse_Replace_Supercb_2Replace_Super,1,bind); 
 rb_ary_store(bind,1/*this*/,it); it=Qnil;
 rb_ary_store(bind,2/*clon*/,it); it=Qfalse;
 rb_ary_store(bind,3/*changed*/,it); it=rb_funcall(self,s_traverse_Replace_Supercb_3Replace_Super,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it); it=rb_funcall(self,s_traverse_Replace_Supercb_4Replace_Super,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,5/*autovar*/,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
 int oldpos4; while(1){oldpos4=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2);
 rb_ary_store(bind,6/*autovar*/,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,7/*key*/,it); it=rb_funcall(self,s_traverse_Replace_Supercb_5Replace_Super,1,bind);   it=Replace_Super_traverse_item(self ); FAILTEST(pass3);
 rb_ary_store(bind,8/*val*/,it); it=rb_funcall(self,s_traverse_Replace_Supercb_6Replace_Super,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto break2;
 if (rb_ivar_get(self,s__at_stopReplace_Super)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopReplace_Super,Qnil);  ame_setpos(self,oldpos4);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=Replace_Super_visit(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Replace_Supercb_1Replace_Super,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 rb_ary_store(bind,2/*autovar*/,it); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
...
it=rb_ary_entry(bind,3/*autovar*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_4);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 break;case 1:; int oldpos3=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=Replace_Super_visit(self ); FAILTEST(alt2_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Replace_Supercb_1Replace_Super,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
 it=rb_ary_new3(0);
 ...
 rb_ary_store(bind,6/*it*/,it); it=rb_funcall(self,s_traverse_item_Replace_Supercb_2Replace_Super,1,bind);  if (rb_ivar_get(self,s__at_stopReplace_Super)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopReplace_Super,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,5/*ar*/);
 rb_ary_store(bind,7/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
...
it=rb_ary_entry(bind,7/*autovar*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept2;
alt2_3: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_4);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept2;
  alt2_4:  ame_setpos(self,oldpos3); goto fail;
 accept2:;
 break;case 2:; int oldpos6=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=Replace_Super_visit(self ); FAILTEST(alt3_2);
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Replace_Supercb_1Replace_Super,1,bind); it=rb_ary_entry(bind,0/*a*/);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos6);if (rb_ivar_get(self,s__at_cutReplace_Super)!=Qnil) {rb_ivar_set(self,s__at_cutReplace_Super,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt3_3);
 rb_ary_store(bind,1/*_result*/,it);  
rb_ivar_set(self,s__at_cutReplace_Super,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos6); goto fail;
...
VALUE Replace_Super_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(7);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 rb_ary_store(bind,0/*autovar*/,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeReplace_Super,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,1/*name*/,it); it=rb_funcall(self,s_visit_Replace_Supercb_1Replace_Super,1,bind); FAILTEST(pass1);it=rb_ary_new3(0);
 rb_ary_store(bind,2/*autovar*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 rb_ary_store(bind,3/*autovar*/,it); it=rb_funcall(self,s_visit_Replace_Supercb_2Replace_Super,1,bind);  if (rb_ivar_get(self,s__at_stopReplace_Super)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopReplace_Super,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,2/*autovar*/);
 rb_ary_store(bind,4/*args*/,it); it=rb_funcall(self,s_visit_Replace_Supercb_3Replace_Super,1,bind); 
 rb_ary_store(bind,5/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
...
s__at_cutDetectCalls=rb_intern("_at_cut");
s__at_stopDetectCalls=rb_intern("_at_stop");
...
s__at_cutInliner2=rb_intern("_at_cut");
s__at_stopInliner2=rb_intern("_at_stop");
...
s__at_cutReplace_Super=rb_intern("_at_cut");
s__at_stopReplace_Super=rb_intern("_at_stop");
...
rb_define_method(cls_Replace_Super,"visit",Replace_Super_visit,0);
 rb_eval_string("testversioninliner2('96a3aee170e295c23d368133ed267751')");}
