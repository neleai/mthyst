...
it=rb_funcall(self,sy_Constant_Propagator_bind_lb_1_rb__eq_,1,bind); cstruct oldpass1=*ptr; int fail1=0;
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,5/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_Constant,1,bind);  bind_aset(bind,7/*autovar*/,it);
...
cstruct oldpass6=*ptr; int fail6=0;
          ptr->src=bind_aget(bind,19/*autovar*/); ptr->pos=0; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else ptr->len=FIX2LONG(rb_funcall(ptr->src,sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,20/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_src,1,bind);  bind_aset(bind,22/*val*/,it);
...
cstruct oldpass7=*ptr; int fail7=0;
          ptr->src=bind_aget(bind,25/*autovar*/); ptr->pos=0; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else ptr->len=FIX2LONG(rb_funcall(ptr->src,sy_size,0)); ptr->ary=NULL;
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,26/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_a_eq_Consta,1,bind);  bind_aset(bind,28/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser_bind_lb_6_rb__eq_,1,bind); cstruct oldpass1=*ptr; int fail1=0;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind);  bind_aset(bind,3/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,9/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser__lp__at_consts,1,bind);  bind_aset(bind,11/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,13/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind);  bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('d5fbec69b2a11b6e108c2ca28faba121')");}
