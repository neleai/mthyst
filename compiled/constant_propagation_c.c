...
cstruct oldpass5=*ptr; int fail5=0;
          ptr->src=bind_aget(bind,15/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
cstruct oldpass7=*ptr; int fail7=0;
          ptr->src=bind_aget(bind,25/*autovar*/); ptr->pos=0; ptr->len=FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('8145018b1580ef71cdc46e523188188e')");}
