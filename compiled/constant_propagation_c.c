...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 switch(FIX2LONG(rb_hash_aref(switchhash_Constant_Propagator_1,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:; int oldpos1=ame_getpos(self);
...
case 1/*Bind*/:; int oldpos4=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 2/*CAct*/:; int oldpos5=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 3/*Local*/:; int oldpos7=ame_getpos(self);
...
switch(FIX2LONG(rb_hash_aref(switchhash_Constant_Traverser_2,rb_obj_class(ame_curobj(self))))){case 0/*AmethystAST*/:; int oldpos1=ame_getpos(self);
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('06eb8624605ab0c8325b2c1add255cb0')");}
