...
static VALUE sy_Constant_Propagator_ConstantLatt2;
static VALUE sy_Constant_Propagator_ConstantLatt3;
static VALUE sy_Constant_Propagator_ConstantLatt;
static VALUE sy_Constant_Propagator__append_lp_bind2;
static VALUE sy_Constant_Propagator__append_lp_bind3;
static VALUE sy_Constant_Propagator__append_lp_bind4;
static VALUE sy_Constant_Propagator__append_lp_bind;
static VALUE sy_Constant_Propagator__at_depend_eq_bind;
static VALUE sy_Constant_Propagator_a_eq_ConstantLa;
...
it=rb_funcall(self,sy_Constant_Propagator__at_depend_eq_bind,1,bind);  bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,5/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt,1,bind);  bind_aset(bind,7/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,10/*autovar*/); it=rb_funcall(self,sy_Constant_Propagator_src,1,bind);  arg0=it; it=rb_funcall(self,sy_valof,1,arg0); FAILTEST(pass4); bind_aset(bind,12/*autovar*/,it);
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
 it=bind_aget(bind,2/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt2,1,bind);  bind_aset(bind,13/*autovar*/,it);
...
alt2_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
 it=bind_aget(bind,14/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt2,1,bind);  bind_aset(bind,13/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,20/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_src,1,bind);  bind_aset(bind,22/*val*/,it);
it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt3,1,bind);  bind_aset(bind,23/*autovar*/,it);
...
alt3_2: ame_setpos(self,oldpos5);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
 it=bind_aget(bind,18/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt2,1,bind);  bind_aset(bind,13/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Propagator__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,26/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_a_eq_ConstantLa,1,bind);  bind_aset(bind,28/*autovar*/,it);
...
alt4_2: ame_setpos(self,oldpos7);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
 it=bind_aget(bind,24/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt2,1,bind);  bind_aset(bind,13/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos7); goto pass1;
 accept4:;
 break;case 4:;   it=AmethystCore_anything(self ); FAILTEST(pass1);it=rb_funcall(self,sy_Constant_Propagator_ConstantLatt2,1,bind);  bind_aset(bind,13/*autovar*/,it);
...
static VALUE sy_Constant_Traverser_Bind_lb_src_dot_nam;
static VALUE sy_Constant_Traverser__append_lp_bind2;
static VALUE sy_Constant_Traverser__append_lp_bind3;
static VALUE sy_Constant_Traverser__append_lp_bind4;
static VALUE sy_Constant_Traverser__append_lp_bind5;
static VALUE sy_Constant_Traverser__append_lp_bind6;
static VALUE sy_Constant_Traverser__append_lp_bind;
static VALUE sy_Constant_Traverser__at_changed;
static VALUE sy_Constant_Traverser__at_changed_eq_fal;
static VALUE sy_Constant_Traverser__at_changed_eq_tru;
static VALUE sy_Constant_Traverser__at_consts_eq_src_dot_;
static VALUE sy_Constant_Traverser__lp__at_consts_lb_src;
static VALUE sy_Constant_Traverser__lp_bind_lb_4_rb_;
static VALUE sy_Constant_Traverser__lp_src_dot_instanc;
static VALUE sy_Constant_Traverser_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Constant_Traverser_if_sp_bind_lb_5_rb_;
static VALUE sy_Constant_Traverser_src;
static VALUE sy_Constant_Traverser_src_dot_cfg_eq_nil;
...
it=rb_funcall(self,sy_Constant_Traverser__at_consts_eq_src_dot_,1,bind); it=rb_funcall(self,sy_Constant_Traverser_src_dot_cfg_eq_nil,1,bind);   it=Constant_Traverser_traverse(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Constant_Traverser__at_changed_eq_fal,1,bind);   it=Constant_Traverser_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Constant_Traverser_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
VALUE Constant_Traverser_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_Constant_Traverser__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Constant_Traverser_traverse_item(self ); FAILTEST(break1); bind_aset(bind,7/*it*/,it);
it=rb_funcall(self,sy_Constant_Traverser_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind);  bind_aset(bind,3/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
it=rb_funcall(self,sy_Constant_Traverser_Bind_lb_src_dot_nam,1,bind);  bind_aset(bind,7/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,9/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser__lp__at_consts_lb_src,1,bind);  bind_aset(bind,11/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=rb_funcall(self,sy_Constant_Traverser__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,13/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind);  bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: *ptr=oldpass4;
...
sy_Constant_Propagator_ConstantLatt2=rb_intern("Constant_Propagator_ConstantLatt2");
sy_Constant_Propagator_ConstantLatt3=rb_intern("Constant_Propagator_ConstantLatt3");
sy_Constant_Propagator_ConstantLatt=rb_intern("Constant_Propagator_ConstantLatt");
sy_Constant_Propagator__append_lp_bind2=rb_intern("Constant_Propagator__append_lp_bind2");
sy_Constant_Propagator__append_lp_bind3=rb_intern("Constant_Propagator__append_lp_bind3");
sy_Constant_Propagator__append_lp_bind4=rb_intern("Constant_Propagator__append_lp_bind4");
sy_Constant_Propagator__append_lp_bind=rb_intern("Constant_Propagator__append_lp_bind");
sy_Constant_Propagator__at_depend_eq_bind=rb_intern("Constant_Propagator__at_depend_eq_bind");
sy_Constant_Propagator_a_eq_ConstantLa=rb_intern("Constant_Propagator_a_eq_ConstantLa");
...
sy_Constant_Traverser_Bind_lb_src_dot_nam=rb_intern("Constant_Traverser_Bind_lb_src_dot_nam");
sy_Constant_Traverser__append_lp_bind2=rb_intern("Constant_Traverser__append_lp_bind2");
sy_Constant_Traverser__append_lp_bind3=rb_intern("Constant_Traverser__append_lp_bind3");
sy_Constant_Traverser__append_lp_bind4=rb_intern("Constant_Traverser__append_lp_bind4");
sy_Constant_Traverser__append_lp_bind5=rb_intern("Constant_Traverser__append_lp_bind5");
sy_Constant_Traverser__append_lp_bind6=rb_intern("Constant_Traverser__append_lp_bind6");
sy_Constant_Traverser__append_lp_bind=rb_intern("Constant_Traverser__append_lp_bind");
sy_Constant_Traverser__at_changed=rb_intern("Constant_Traverser__at_changed");
sy_Constant_Traverser__at_changed_eq_fal=rb_intern("Constant_Traverser__at_changed_eq_fal");
sy_Constant_Traverser__at_changed_eq_tru=rb_intern("Constant_Traverser__at_changed_eq_tru");
sy_Constant_Traverser__at_consts_eq_src_dot_=rb_intern("Constant_Traverser__at_consts_eq_src_dot_");
sy_Constant_Traverser__lp__at_consts_lb_src=rb_intern("Constant_Traverser__lp__at_consts_lb_src");
sy_Constant_Traverser__lp_bind_lb_4_rb_=rb_intern("Constant_Traverser__lp_bind_lb_4_rb_");
sy_Constant_Traverser__lp_src_dot_instanc=rb_intern("Constant_Traverser__lp_src_dot_instanc");
sy_Constant_Traverser_bind_lb_5_rb__lt__lt_bin=rb_intern("Constant_Traverser_bind_lb_5_rb__lt__lt_bin");
sy_Constant_Traverser_if_sp_bind_lb_5_rb_=rb_intern("Constant_Traverser_if_sp_bind_lb_5_rb_");
sy_Constant_Traverser_src=rb_intern("Constant_Traverser_src");
sy_Constant_Traverser_src_dot_cfg_eq_nil=rb_intern("Constant_Traverser_src_dot_cfg_eq_nil");
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('e5f4fcc860ba070e7752480c96abaaad')");}
