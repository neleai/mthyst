...
VALUE Constant_Propagator_root(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(2);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*it*/,it); it=rb_funcall(self,sy_Constant_Propagator__at_depend_eq_,1,bind); 
...
it=bind_aget(bind,0/*el*/);
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Constant_Propagator_bind_lb_1_rb__eq_,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Constant_Propagator__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,5/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_Constant,1,bind); 
...
ame_setsrc(self,bind_aget(bind,19/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,21/*autovar*/,it); it=rb_funcall(self,sy_Constant_Propagator__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos12=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos12); it=bind_aget(bind,20/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_src,1,bind); 
...
ame_setsrc(self,bind_aget(bind,25/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,27/*autovar*/,it); it=rb_funcall(self,sy_Constant_Propagator__append_lp_4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos15); it=bind_aget(bind,26/*autovar*/);it=rb_funcall(self,sy_Constant_Propagator_a_eq_Consta,1,bind); 
...
it=rb_funcall(self,sy_Constant_Traverser__at_consts_eq_,1,bind); it=rb_funcall(self,sy_Constant_Traverser_src_dot_cfg_eq_,1,bind);   it=Constant_Traverser_traverse(self ); FAILTEST(fail);
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,2/*oldchanged*/,it); it=rb_funcall(self,sy_Constant_Traverser_src,1,bind); 
 bind_aset(bind,3/*this*/,it); it=Qnil;
 bind_aset(bind,4/*clon*/,it); it=Qfalse;
 bind_aset(bind,5/*changed*/,it); it=rb_funcall(self,sy_Constant_Traverser__lp_src_dot_ins,1,bind); 
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Constant_Traverser_bind_lb_6_rb__eq_,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,11/*val*/,it); it=rb_funcall(self,sy_Constant_Traverser__lp_bind_lb_4_rb_,1,bind); 
...
it=bind_aget(bind,12/*autovar*/);
 bind_aset(bind,13/*autovar*/,it); it=rb_funcall(self,sy_Constant_Traverser__append_lp_6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,sy_Constant_Traverser_if_sp_bind_lb_,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Constant_Traverser__at_changed,1,bind); it=bind_aget(bind,0/*a*/);
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_Constant_Traverser_bind_lb_5_rb__lt_,1,bind); 
...
ame_setsrc(self,bind_aget(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_Constant_Traverser__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,1/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind); 
 bind_aset(bind,3/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
...
ame_setsrc(self,bind_aget(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,6/*expr*/,it); it=rb_funcall(self,sy_Constant_Traverser_Bind_lb_src,1,bind); 
...
ame_setsrc(self,bind_aget(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,10/*autovar*/,it); it=rb_funcall(self,sy_Constant_Traverser__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,9/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser__lp__at_consts,1,bind); 
...
ame_setsrc(self,bind_aget(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,14/*autovar*/,it); it=rb_funcall(self,sy_Constant_Traverser__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,13/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser_src,1,bind); 
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('033b649d47e1c746a4dd54f648eb0318')");}
