...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,4/*autovar*/,it);   it=Constant_Propagator_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
it=rb_ary_entry(bind,7/*autovar*/);
 rb_ary_store(bind,5/*autovar*/,it);  break;case 2:;   it=Constant_Propagator_fails(self ); FAILTEST(pass2); break;}  it=Constant_Propagator_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
ame_setsrc(self,rb_ary_entry(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,13/*autovar*/,it);   it=Constant_Propagator_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ISET(cut,Qnil);goto accept4;
 ...
 rb_ary_store(bind,8/*autovar*/,it);  break;}  it=Constant_Propagator_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,8/*val*/,it); it=CALL(traverse_Constant_Traversercb_4,1,bind);   it=Constant_Traverser_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,5/*expr*/,it);   it=Constant_Traverser_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos4); ame_setlen(self,oldlen3);
	if(fail3) goto pass2;
it=CALL(visit_Constant_Traversercb_4,1,bind); 
 rb_ary_store(bind,6/*autovar*/,it);   it=Constant_Traverser_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto fail;
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('39845e5a8248e36ea7a69a45b1616451')");}
