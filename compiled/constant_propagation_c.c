...
VALUE Constant_Propagator_root(VALUE self ){VALUE vals[0];  VALUE var0;VALUE var1; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
  it=AmethystCore_anything(self ); FAILTEST(fail); var0/*it*/=it;;
bind_aset(bind2,1,var0/*it*/);it=rb_funcall(self,sy_Constant_Propagator__at_depend_eq__07a9,1,bind2);var0/*it*/=bind_aget(bind2,1);; var1/*_result*/=it;;

return it;
fail: return failobj; }
VALUE Constant_Propagator_step(VALUE self ,VALUE a0){VALUE vals[1];  VALUE var0;VALUE var1;VALUE var2;VALUE var3;VALUE var4;VALUE var5;VALUE var6;VALUE var7;VALUE var8;VALUE var9;VALUE var10;VALUE var11;VALUE var12;VALUE var13;VALUE var14;VALUE var15;VALUE var16;VALUE var17; ;VALUE bind2=bind_new2(16); var0/*el*/=a0;; int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=var0/*el*/; var1/*autovar*/=it;;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Constant_Propagator_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Lambda*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var3/*autovar*/=it;;
...
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 if (stop1) goto accept2; } break1: goto pass3; accept2:;   it=rb_funcall(self,sy_Constant_Propagator_Constant_8840,1,bind2); var4/*autovar*/=it;;
...
case 1/*Local*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var6/*autovar*/=it;;
...
alt3_3: ptr->pos=oldpos5;goto break2;
 accept5:;
 if (stop2) goto accept4; } break2: goto pass4; accept4:;    it=rb_funcall(self,sy_Constant_Propagator_src_25d9,1,bind2); arg0=it; it=rb_funcall(self,sy_valof,1,arg0); FAILTEST(pass4); var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto pass2;
                   success4: *ptr=oldpass4;
                it=var7/*autovar*/; var5/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
case 2/*Object*/:; goto pass2; break;
                ...
                it=var5/*autovar*/; var8/*autovar*/=it;;

;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_Constant_Propagator_Constant_bf42,1,bind2); var8/*autovar*/=it;;

;goto accept1;
alt1_3: ptr->pos=oldpos1;goto pass1;
 accept1:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 1/*Bind*/:; int oldpos6=ptr->pos;int cut4=0;
alt4_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var9/*autovar*/=it;;
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var9/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass5); var10/*expr*/=it;;
 it=var10/*expr*/; arg0=it; it=rb_funcall(self,sy_valof,1,arg0); FAILTEST(pass5); var11/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
                   pass5: *ptr=oldpass5; goto alt4_2;
                   success5: *ptr=oldpass5;
                it=var11/*autovar*/; var8/*autovar*/=it;;

;goto accept6;
alt4_2: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt4_3);it=rb_funcall(self,sy_Constant_Propagator_Constant_bf42,1,bind2); var8/*autovar*/=it;;

;goto accept6;
alt4_3: ptr->pos=oldpos6;goto pass1;
 accept6:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 2/*CAct*/:; int oldpos7=ptr->pos;int cut5=0;
alt5_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var12/*autovar*/=it;;
...
alt6_3: ptr->pos=oldpos9;goto break3;
 accept9:;
 if (stop3) goto accept8; } break3: goto pass6; accept8:;   it=rb_funcall(self,sy_Constant_Propagator_src_25d9,1,bind2); var13/*val*/=it;;
bind_aset(bind2,1,var13/*val*/);it=rb_funcall(self,sy_Constant_Propagator_Constant_db03,1,bind2);var13/*val*/=bind_aget(bind2,1);; var14/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
                   pass6: *ptr=oldpass6; goto alt5_2;
                   success6: *ptr=oldpass6;
                it=var14/*autovar*/; var8/*autovar*/=it;;

;goto accept7;
alt5_2: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt5_3);it=rb_funcall(self,sy_Constant_Propagator_Constant_bf42,1,bind2); var8/*autovar*/=it;;

;goto accept7;
alt5_3: ptr->pos=oldpos7;goto pass1;
 accept7:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 3/*Local*/:; int oldpos10=ptr->pos;int cut7=0;
alt7_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var15/*autovar*/=it;;
...
alt8_3: ptr->pos=oldpos12;goto break4;
 accept12:;
 if (stop4) goto accept11; } break4: goto pass7; accept11:;   bind_aset(bind2,1,var0/*el*/);it=rb_funcall(self,sy_Constant_Propagator_a_eq_Consta_2e1d,1,bind2);var0/*el*/=bind_aget(bind2,1);; var16/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
                   pass7: *ptr=oldpass7; goto alt7_2;
                   success7: *ptr=oldpass7;
                it=var16/*autovar*/; var8/*autovar*/=it;;

;goto accept10;
alt7_2: ptr->pos=oldpos10;  it=AmethystCore_anything(self ); FAILTEST(alt7_3);it=rb_funcall(self,sy_Constant_Propagator_Constant_bf42,1,bind2); var8/*autovar*/=it;;

;goto accept10;
alt7_3: ptr->pos=oldpos10;goto pass1;
 accept10:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 4/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(pass1);it=rb_funcall(self,sy_Constant_Propagator_Constant_bf42,1,bind2); var8/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
}
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
                it=var8/*autovar*/; var17/*_result*/=it;;
...
VALUE Constant_Traverser_consts(VALUE self ){VALUE vals[0];  VALUE var0;VALUE var1;VALUE var2;VALUE var3; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_ary_new3(0); var0/*ary*/=it;;
int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Constant_Traverser_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Local*/:; int oldpos2=ptr->pos;int cut1=0;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto pass1; accept3:;   it=rb_funcall(self,sy_Constant_Traverser__lp__lp__at_const_463e,1,bind2);FAILTEST(pass1);it=rb_funcall(self,sy_Constant_Traverser_Bind_lb_src_9cb6,1,bind2); var2/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Constant_Traverser__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt1_4: ptr->pos=oldpos2;goto break1;
 accept2:;
 break;
case 1/*Object*/:; int oldpos5=ptr->pos;int cut3=0;
alt3_1:;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);
;goto accept5;
alt3_2: ptr->pos=oldpos5;stop1=1;
;goto accept5;
alt3_3: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=var0/*ary*/; var3/*_result*/=it;;

return it;
fail: return failobj; }
VALUE Constant_Traverser_root(VALUE self ){VALUE vals[0];  VALUE var0; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_funcall(self,sy_Constant_Traverser__at_consts_eq__b621,1,bind2);it=rb_funcall(self,sy_Constant_Traverser_src_dot_cfg_eq__15aa,1,bind2);  it=Constant_Traverser_traverse(self ); FAILTEST(fail); var0/*_result*/=it;;

return it;
fail: return failobj; }
VALUE Constant_Traverser_traverse(VALUE self ){VALUE vals[0];  VALUE var0;VALUE var1;VALUE var2;VALUE var3;VALUE var4;VALUE var5;VALUE var6;VALUE var7;VALUE var8;VALUE var9; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Constant_Traverser__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
it=rb_funcall(self,sy_Constant_Traverser_src_25d9,1,bind2); var1/*this*/=it;;
it=Qnil; var2/*clon*/=it;;
it=Qfalse; var3/*changed*/=it;;
it=rb_funcall(self,sy_Constant_Traverser__lp_src_dot_ins_6a75,1,bind2); var4/*autovar*/=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Constant_Traverser__at_changed_b885,1,bind2);  it=Constant_Traverser_traverse_item(self ); FAILTEST(pass3); var8/*val*/=it;;
bind_aset(bind2,1,var2/*clon*/);bind_aset(bind2,2,var1/*this*/);bind_aset(bind2,3,var3/*changed*/);bind_aset(bind2,4,var7/*key*/);bind_aset(bind2,5,var8/*val*/);it=rb_funcall(self,sy_Constant_Traverser__lp_bind_lb_1_rb__ee3d,1,bind2);var2/*clon*/=bind_aget(bind2,1);;var1/*this*/=bind_aget(bind2,2);;var3/*changed*/=bind_aget(bind2,3);;var7/*key*/=bind_aget(bind2,4);;var8/*val*/=bind_aget(bind2,5);;it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                   goto success3;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 ...
 if (stop2) goto accept3; } break2: goto pass2; accept3:;   it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   ...
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,var3/*changed*/);bind_aset(bind2,2,var2/*clon*/);bind_aset(bind2,3,var0/*oldchanged*/);it=rb_funcall(self,sy_Constant_Traverser_if_sp_bind_lb__8e0b,1,bind2);var3/*changed*/=bind_aget(bind2,1);;var2/*clon*/=bind_aget(bind2,2);;var0/*oldchanged*/=bind_aget(bind2,3);; var9/*_result*/=it;;

return it;
fail: return failobj; }
VALUE Constant_Traverser_traverse_item(VALUE self ){VALUE vals[0];  VALUE var0;VALUE var1;VALUE var2;VALUE var3;VALUE var4;VALUE var5;VALUE var6;VALUE var7; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
switch(FIX2LONG(rb_hash_aref(switchhash_Constant_Traverser_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*AmethystAST*/:; int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=Constant_Traverser_visit(self ); FAILTEST(alt1_2); var0/*a*/=it;;
it=rb_funcall(self,sy_Constant_Traverser__at_changed_5352,1,bind2);it=var0/*a*/; var1/*_result*/=it;;

;goto accept1;
alt1_2: ptr->pos=oldpos1;it=ame_curobj2(ptr)               ;ptr->pos++; var2/*autovar*/=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var2/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Constant_Traverser_traverse(self ); FAILTEST(pass1); var3/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt2_1:;  it=Constant_Traverser_visit(self ); FAILTEST(alt2_2); var0/*a*/=it;;
it=rb_funcall(self,sy_Constant_Traverser__at_changed_5352,1,bind2);it=var0/*a*/; var1/*_result*/=it;;
...
alt3_1:;  it=Constant_Traverser_traverse_item(self ); FAILTEST(alt3_2); var6/*it*/=it;;
bind_aset(bind2,1,var5/*ar*/);bind_aset(bind2,2,var6/*it*/);it=rb_funcall(self,sy_Constant_Traverser_bind_lb_1_rb__lt__7b20,1,bind2);var5/*ar*/=bind_aget(bind2,1);;var6/*it*/=bind_aget(bind2,2);;
;goto accept4;
...
alt4_1:;  it=Constant_Traverser_visit(self ); FAILTEST(alt4_2); var0/*a*/=it;;
it=rb_funcall(self,sy_Constant_Traverser__at_changed_5352,1,bind2);it=var0/*a*/; var1/*_result*/=it;;
...
return it;
fail: return failobj; }
VALUE Constant_Traverser_visit(VALUE self ){VALUE vals[0];  VALUE var0;VALUE var1;VALUE var2;VALUE var3;VALUE var4;VALUE var5;VALUE var6;VALUE var7;VALUE var8;VALUE var9;VALUE var10; ;VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
 ...
 break;
case 1/*Bind*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var4/*autovar*/=it;;
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var4/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Constant_Traverser_traverse_item(self ); FAILTEST(pass2); var5/*expr*/=it;;
bind_aset(bind2,1,var5/*expr*/);it=rb_funcall(self,sy_Constant_Traverser_Bind_lb_src_66c4,1,bind2);var5/*expr*/=bind_aget(bind2,1);; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
                   pass2: *ptr=oldpass2; goto fail;
                   success2: *ptr=oldpass2;
                it=var6/*autovar*/; var3/*_result*/=it;;
 break;
case 2/*Local*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var7/*autovar*/=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass3; accept1:;   it=rb_funcall(self,sy_Constant_Traverser__lp__lp__at_const_5d8f,1,bind2);FAILTEST(pass3);it=rb_funcall(self,sy_Constant_Traverser__at_consts_lb__abf4,1,bind2); var8/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                   goto success3;
                   pass3: *ptr=oldpass3; goto fail;
                   success3: *ptr=oldpass3;
                it=var8/*autovar*/; var3/*_result*/=it;;
 break;
case 3/*Result*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var9/*autovar*/=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var9/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   int oldpos3; int stop2=0; while(1){oldpos3=ptr->pos; int oldpos4=ptr->pos;int cut2=0;
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto pass4; accept3:;   it=rb_funcall(self,sy_Constant_Traverser_src_25d9,1,bind2); var10/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto fail;
                   success4: *ptr=oldpass4;
                it=var10/*autovar*/; var3/*_result*/=it;;
 break;
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
                    rb_eval_string("testversionconstant_propagation('317f6f03e6262ce76bad344c99a02735')");}
