...
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3/*val*/,it); it=CALL(step_Constant_Propagatorcb_3,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it);   it=Constant_Propagator_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
alt2_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 ...
 rb_ary_store(bind,6/*autovar*/,it); int oldpos6=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos7); it=CALL(step_Constant_Propagatorcb_5,1,bind); 
 rb_ary_store(bind,7/*autovar*/,it);   it=Constant_Propagator_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
...
alt3_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 ...
 rb_ary_store(bind,8/*autovar*/,it); int oldpos9=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,8/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 unsigned char chr2=FIX2INT(CALL(switchcbConstant_Propagator1,1,ame_curobj(self)));  switch(chr2){case 0:;   it=AmethystCore_anything(self ); FAILTEST(pass4);
 rb_ary_store(bind,9/*autovar*/,it); int oldpos10=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos11; while(1){oldpos11=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos11=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos11); it=CALL(step_Constant_Propagatorcb_6,1,bind); 
...
it=rb_ary_entry(bind,10/*autovar*/);
 rb_ary_store(bind,11/*autovar*/,it);  break;case 1:;   it=AmethystCore_anything(self ); FAILTEST(pass4);
 rb_ary_store(bind,12/*autovar*/,it); int oldpos12=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos13; while(1){oldpos13=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos13);  it=CALL(step_Constant_Propagatorcb_2,1,bind);  arg0=it; it=CALL(valof,1 ,arg0); FAILTEST(pass6);
...
it=rb_ary_entry(bind,13/*autovar*/);
 rb_ary_store(bind,11/*autovar*/,it);  break;case 2:;   it=Constant_Propagator_fails(self ); FAILTEST(pass4); break;}  it=Constant_Propagator_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
alt4_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_2);
 rb_ary_store(bind,14/*autovar*/,it); int oldpos15=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,14/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=CALL(step_Constant_Propagatorcb_7,1,bind);  arg0=it; it=CALL(valof,1 ,arg0); FAILTEST(pass7);
...
alt4_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_3);it=CALL(step_Constant_Propagatorcb_4,1,bind); 
 rb_ary_store(bind,5/*autovar*/,it);  
ISET(cut,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldpos14); goto pass1;
 accept4:;
 break;case 4:;   it=AmethystCore_anything(self ); FAILTEST(pass1);it=CALL(step_Constant_Propagatorcb_4,1,bind); 
 rb_ary_store(bind,5/*autovar*/,it);  break;}  it=Constant_Propagator_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
rb_define_method(cls_Constant_Traverser,"visit",Constant_Traverser_visit,0);
 rb_eval_string("testversionconstant_propagation('fb52ba624e9eb926db267f969984d2b7')");}
