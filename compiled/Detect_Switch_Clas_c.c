...
static VALUE sy_first;
 ...
 memo_struct *mem_Detect_Switch_Clas=NULL;VALUE memo_val_Detect_Switch_Clas;VALUE profile_report_Detect_Switch_Clas(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr); if(ptr->mem){fprintf(profile_report,"memo Detect_Switch_Clas::traverse  hit: %i miss: %i ticks: %i\n",((memo_struct *)ptr->mem)->hits[119],((memo_struct *)ptr->mem)->miss[119],((memo_struct *)ptr->mem)->ticks[119]);((memo_struct *)ptr->mem)->hits[119]=0;((memo_struct *)ptr->mem)->miss[119]=0;((memo_struct *)ptr->mem)->ticks[119]=0;} return Qnil;}VALUE Detect_Switch_Clas_itrans(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_autovar_10=Qnil,_rules=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,__result=Qnil,_autovar_13=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_2);it=rb_funcall(self,sy_Detect_Switch_Clas__at__contex_5f56,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_2=bind_aget(bind2,2);;it=rb_ary_new3(0); _autovar_3=it;;
int stop1=0; while(!stop1){ switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_10,rb_obj_class(ame_curobj2(ptr))))){case 0/*Grammar*/:; int oldpos1=ptr->pos;int cut1=0;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   bind_aset(bind2,1,_autovar_2);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lb__fa06,1,bind2);_autovar_2=bind_aget(bind2,1);;it=rb_funcall(self,sy_Detect_Switch_Clas__do_rules_eq__le__ab16,1,bind2);it=rb_funcall(self,sy_Detect_Switch_Clas_src_dot_rule_5acf,1,bind2); _autovar_5=it;;
...
int stop2=0; while(!stop2){ switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_11,rb_obj_class(ame_curobj2(ptr))))){case 0/*Rule*/:; int oldpos3=ptr->pos;int cut3=0;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_8);
                     it=Detect_Switch_Clas_root(self ); if (it==failobj){it=failobj;goto pass4;} _autovar_9=it;;
...
case 1/*Object*/:; stop2=1; break;
                ...
                bind_aset(bind2,1,_rules);it=rb_funcall(self,sy_Detect_Switch_Clas_src_dot_rule_a719,1,bind2);_rules=bind_aget(bind2,1);;it=rb_funcall(self,sy_Detect_Switch_Clas_src_25d9,1,bind2); _autovar_11=it;;
...
alt4_3: ptr->pos=oldpos4;ptr->branches-=1;if (1){it=failobj;goto fail;};
 ...
 _autovar_13=it;;
bind_aset(bind2,1,_autovar);bind_aset(bind2,2,_autovar_13);it=rb_funcall(self,sy_Detect_Switch_Clas__at__contex_cdb3,1,bind2);_autovar=bind_aget(bind2,1);;_autovar_13=bind_aget(bind2,2);;
fail: return it;
}
VALUE Detect_Switch_Clas_root(VALUE self ){VALUE vals[0]; VALUE it ,__result=Qnil;VALUE bind2=bind_new2(0);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  it=Detect_Switch_Clas_traverse(self ); if (it==failobj){it=failobj;goto fail;} __result=it;;

fail: return it;
}
VALUE Detect_Switch_Clas_traverse(VALUE self ){VALUE vals[0]; VALUE it ,_nvars=Qnil,_ivars=Qnil,_autovar=Qnil,_autovar_2=Qnil,_it=Qnil,__result=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);if (ptr->mem==NULL){ptr->mem=mem_Detect_Switch_Clas;}time_struct time_old=memo_get(ptr->mem,119,ptr->src,ptr->pos); if (time_old.pos!=-1) {ptr->pos=time_old.pos;return time_old.result;} int oldpos=ptr->pos;ptr->pos=ptr->len;it=rb_ary_new3(0); _nvars=it;;
it=rb_funcall(self,sy_Detect_Switch_Clas__lp_src_dot_cla_2024,1,bind2); _ivars=it;;
...
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_traverse_item(self ); if (it==failobj){it=failobj;goto revert1;} _it=it;;
bind_aset(bind2,1,_nvars);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__sp__6af0,1,bind2);_nvars=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
;goto accept2;revert1:;  goto alt1_2; accept2:;
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto pass2;};
 accept1:;
                   ...
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,_ivars);bind_aset(bind2,2,_nvars);it=rb_funcall(self,sy_Detect_Switch_Clas_if_sp_bind_lb__1bed,1,bind2);_ivars=bind_aget(bind2,1);;_nvars=bind_aget(bind2,2);; __result=it;;
...
VALUE Detect_Switch_Clas_traverse_item(VALUE self ){VALUE vals[0]; VALUE it ,__result=Qnil,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_ar=Qnil,_it=Qnil,_autovar_4=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_6,rb_obj_class(ame_curobj2(ptr))))){case 0/*AmethystAST*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_7,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:case 1/*Or*/:case 2/*Seq*/:; int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3;   it=Detect_Switch_Clas_visit(self ); if (it==failobj){it=failobj;goto revert1;} __result=it;;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Detect_Switch_Clas_traverse(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                     it=Detect_Switch_Clas_traverse(self ); if (it==failobj){it=failobj;goto pass2;} _autovar_2=it;;
...
case 1/*Array*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_8,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:case 1/*Or*/:case 2/*Seq*/:; int oldpos3=ptr->pos;int cut3=0;
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_visit(self ); if (it==failobj){it=failobj;goto revert6;} __result=it;;
...
alt4_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_traverse_item(self ); if (it==failobj){it=failobj;goto revert8;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
alt5_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_traverse_item(self ); if (it==failobj){it=failobj;goto revert10;} _it=it;;
bind_aset(bind2,1,_ar);bind_aset(bind2,2,_it);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lt__7b20,1,bind2);_ar=bind_aget(bind2,1);;_it=bind_aget(bind2,2);;
...
case 2/*Object*/:; switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_9,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:case 1/*Or*/:case 2/*Seq*/:; int oldpos6=ptr->pos;int cut6=0;
alt6_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_visit(self ); if (it==failobj){it=failobj;goto revert12;} __result=it;;
...
VALUE Detect_Switch_Clas_visit(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_clas=Qnil,_autovar_7=Qnil,__result=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_autovar_10=Qnil,_autovar_11=Qnil,_firs=Qnil,_autovar_12=Qnil,_autovar_13=Qnil,_autovar_14=Qnil,_autovar_15=Qnil,_items=Qnil,_aswitch=Qnil,_autovar_16=Qnil,_autovar_17=Qnil,_autovar_18=Qnil,_list=Qnil,_autovar_19=Qnil,_ary=Qnil,_newlist=Qnil,_lat=Qnil,__result_2=Qnil,_n=Qnil,_cls=Qnil,_autovar_20=Qnil,_autovar_21=Qnil,_autovar_22=Qnil,_autovar_23=Qnil,_autovar_24=Qnil,_autovar_25=Qnil,_autovar_26=Qnil,_prefix=Qnil,_s=Qnil,__result_3=Qnil,_autovar_27=Qnil,_ary_2=Qnil,_autovar_28=Qnil,_autovar_29=Qnil,_rest=Qnil,_cls_2=Qnil,_autovar_30=Qnil,_autovar_31=Qnil,_autovar_32=Qnil,_autovar_33=Qnil,_autovar_34=Qnil;VALUE bind2=bind_new2(4);  VALUE arg0;VALUE arg1;VALUE arg2; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar=it;;
it=_autovar; _autovar_2=it;;
it=_autovar_2; _autovar_3=it;;
int oldpos1=ptr->pos;int cut1=0;
alt1_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3; it=_autovar_3; _autovar_4=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_4);
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_5=it;;
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_5);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'b':;case 'd' ... UC(255):; if (1){it=failobj;goto pass2;} break;
case 'c' ... 'c':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='l'&&ame_curstr2(ptr)[1]=='a'&&ame_curstr2(ptr)[2]=='s')  ptr->pos+=3; else if (1){it=failobj;goto pass2;} break;
}
                   goto success2;
                   pass2: *ptr=oldpass2;if (1){it=failobj;goto pass1;}
                   success2: *ptr=oldpass2;
                switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*CAct*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_6=it;;
 break;
case 1/*Object*/:; if (1){it=failobj;goto pass1;} break;
}cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_6);
                   switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Class*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _clas=it;;
 break;
case 1/*Object*/:; if (1){it=failobj;goto pass3;} break;
                   ...
                   success3: *ptr=oldpass3;
                bind_aset(bind2,1,_clas);it=rb_funcall(self,sy_Detect_Switch_Clas_Switch_C_63f7,1,bind2);_clas=bind_aget(bind2,1);; _autovar_7=it;;
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else if (1){it=failobj;goto pass5;} break;
                ...
                it=rb_funcall(self,sy_Detect_Switch_Clas_src_25d9,1,bind2); _autovar_10=it;;
...
;ptr->branches-=2; goto accept1;
alt1_3: ptr->pos=oldpos1;ptr->branches-=1; it=_autovar_3; _autovar_11=it;;
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_11);
                   ptr->pos=ptr->len; it=rb_funcall(self,sy_Detect_Switch_Clas_src_25d9,1,bind2); arg0=it; it=rb_funcall(self,sy_first,1,arg0); if (it==failobj){it=failobj;goto pass6;} _firs=it;;
bind_aset(bind2,1,_firs);it=rb_funcall(self,sy_Detect_Switch_Clas__lp_,1,bind2);_firs=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto pass6;};bind_aset(bind2,1,_firs);it=rb_funcall(self,sy_Detect_Switch_Clas_c_eq_Switch_4e5f,1,bind2);_firs=bind_aget(bind2,1);; _autovar_12=it;;

                   goto success6;
                   pass6: *ptr=oldpass6;if (1){it=failobj;goto revert3;}
...
alt1_4: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto fail;};
 accept1:;
 break;
case 1/*Or*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_13=it;;
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_13);
                   it=rb_ary_new3(0); _autovar_14=it;;
int stop1=0; while(!stop1){ int oldpos2=ptr->pos;int cut2=0;
alt2_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_traverse_item(self ); if (it==failobj){it=failobj;goto revert4;} _autovar_15=it;;
...
;ptr->branches-=1; goto accept5;
alt2_3: ptr->pos=oldpos2;ptr->branches-=1;if (1){it=failobj;goto pass7;};
 accept5:;
 } it=_autovar_14; _items=it;;
it=Qfalse; _aswitch=it;;
bind_aset(bind2,1,_items);bind_aset(bind2,2,_aswitch);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__dot__76da,1,bind2);_items=bind_aget(bind2,1);;_aswitch=bind_aget(bind2,2);;int oldpos3=ptr->pos;int cut3=0;
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2; bind_aset(bind2,1,_aswitch);it=rb_funcall(self,sy_Detect_Switch_Clas__lp_2,1,bind2);_aswitch=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto revert6;};bind_aset(bind2,1,_items);it=rb_funcall(self,sy_Detect_Switch_Clas_Or_lb__ti_bind_d486,1,bind2);_items=bind_aget(bind2,1);; _autovar_16=it;;

;goto accept9;revert6:;  goto alt3_2; accept9:;

;ptr->branches-=2; goto accept8;
alt3_2: ptr->pos=oldpos3;ptr->branches-=1; it=_items; _autovar_17=it;;
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar_17;ptr->len=1;
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass8;} _autovar_18=it;;
cstruct oldpass9=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_18);
                   switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_4,rb_obj_class(ame_curobj2(ptr))))){case 0/*Switch_Clas*/:; it=rb_funcall(self,sy_Detect_Switch_Clas__lb__lb_Lattic_62e5,1,bind2); _list=it;;
int oldpos4=ptr->pos;int cut4=0;
alt4_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=3; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_19=it;;
cstruct oldpass10=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_19);
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Detect_Switch_Clas_src_dot_ary_d5cf,1,bind2); _ary=it;;

                   goto success10;
                   pass10: *ptr=oldpass10;if (1){it=failobj;goto revert8;}
                   success10: *ptr=oldpass10;
                it=rb_ary_new3(0); _newlist=it;;
it=c_Lattice_Clas; _lat=it;;
bind_aset(bind2,1,_list);bind_aset(bind2,2,_ary);bind_aset(bind2,3,_newlist);bind_aset(bind2,4,_lat);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__dot__642a,1,bind2);_list=bind_aget(bind2,1);;_ary=bind_aget(bind2,2);;_newlist=bind_aget(bind2,3);;_lat=bind_aget(bind2,4);; it=c_Switch_Clas; arg0=it;it=_lat; arg1=it;it=_newlist; arg2=it; it=Detect_First_combine_or(self ,arg0,arg1,arg2); if (it==failobj){it=failobj;goto revert8;} __result_2=it;;

;goto accept12;revert8:;  goto alt4_2; accept12:;

;ptr->branches-=3; goto accept11;
alt4_2: ptr->pos=oldpos4;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert9;} _n=it;;
bind_aset(bind2,1,_list);bind_aset(bind2,2,_n);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__dot__a482,1,bind2);_list=bind_aget(bind2,1);;_n=bind_aget(bind2,2);; _newlist=it;;
 it=c_Switch_Clas; arg0=it;it=c_Lattice_Clas; arg1=it;it=_newlist; arg2=it; it=Detect_First_combine_or(self ,arg0,arg1,arg2); if (it==failobj){it=failobj;goto revert9;} __result_2=it;;

;goto accept13;revert9:;  goto alt4_3; accept13:;

;ptr->branches-=2; goto accept11;
alt4_3: ptr->pos=oldpos4;ptr->branches-=1; it=Qnil;if (ptr->pos<ptr->len){it=failobj;goto revert10;}it=c_Switch_Clas; _cls=it;;
bind_aset(bind2,1,_cls);bind_aset(bind2,2,_list);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lb__0f18,1,bind2);_cls=bind_aget(bind2,1);;_list=bind_aget(bind2,2);; __result_2=it;;

;goto accept14;revert10:;  goto alt4_4; accept14:;

;ptr->branches-=1; goto accept11;
alt4_4: ptr->pos=oldpos4;ptr->branches-=1;if (1){it=failobj;goto pass9;};
 accept11:;
it=__result_2; _autovar_20=it;;
 break;
case 1/*Object*/:; it=rb_funcall(self,sy_Detect_Switch_Clas__lb__lb_Lattic_62e5,1,bind2); _list=it;;
int oldpos5=ptr->pos;int cut5=0;
alt5_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert11;} _n=it;;
bind_aset(bind2,1,_list);bind_aset(bind2,2,_n);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__dot__a482,1,bind2);_list=bind_aget(bind2,1);;_n=bind_aget(bind2,2);; _newlist=it;;
 it=c_Switch_Clas; arg0=it;it=c_Lattice_Clas; arg1=it;it=_newlist; arg2=it; it=Detect_First_combine_or(self ,arg0,arg1,arg2); if (it==failobj){it=failobj;goto revert11;} __result_2=it;;

;goto accept16;revert11:;  goto alt5_2; accept16:;

;ptr->branches-=2; goto accept15;
alt5_2: ptr->pos=oldpos5;ptr->branches-=1; it=Qnil;if (ptr->pos<ptr->len){it=failobj;goto revert12;}it=c_Switch_Clas; _cls=it;;
bind_aset(bind2,1,_cls);bind_aset(bind2,2,_list);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lb__0f18,1,bind2);_cls=bind_aget(bind2,1);;_list=bind_aget(bind2,2);; __result_2=it;;

;goto accept17;revert12:;  goto alt5_3; accept17:;

;ptr->branches-=1; goto accept15;
alt5_3: ptr->pos=oldpos5;ptr->branches-=1;if (1){it=failobj;goto pass9;};
 accept15:;
it=__result_2; _autovar_20=it;;
 break;
}
                ...
                it=_autovar_20; _autovar_21=it;;
                   ...
                   goto success8;
                   pass8: *ptr=oldpass8;if (1){it=failobj;goto revert7;}
                   success8: *ptr=oldpass8;
                it=_autovar_21; _autovar_16=it;;
...
alt3_3: ptr->pos=oldpos3;ptr->branches-=1;if (1){it=failobj;goto pass7;};
 ...
 break;
case 2/*Seq*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_22=it;;
...
alt6_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_Switch_Clas_traverse_item(self ); if (it==failobj){it=failobj;goto revert13;} _autovar_24=it;;
...
alt6_3: ptr->pos=oldpos6;ptr->branches-=1;if (1){it=failobj;goto pass11;};
 accept18:;
 } it=_autovar_23; _autovar_25=it;;
cstruct oldpass12=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar_25;ptr->len=1;
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass12;} _autovar_26=it;;
cstruct oldpass13=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_26);
                   switch(FIX2LONG(rb_hash_aref(switchhash_Detect_Switch_Clas_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Switch_Clas*/:; it=rb_ary_new3(0); _prefix=it;;
int oldpos7=ptr->pos;int cut7=0;
alt7_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_First_must_empty(self ); if (it==failobj){it=failobj;goto revert15;} _s=it;;
 it=c_Switch_Clas; arg0=it;bind_aset(bind2,1,_prefix);bind_aset(bind2,2,_s);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__pl__4651,1,bind2);_prefix=bind_aget(bind2,1);;_s=bind_aget(bind2,2);; arg1=it; it=Detect_First_combine_seq(self ,arg0,arg1); __result_3=it;;

;goto accept22;revert15:;  goto alt7_2; accept22:;

;ptr->branches-=2; goto accept21;
alt7_2: ptr->pos=oldpos7;ptr->branches-=1; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_27=it;;
cstruct oldpass14=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_27);
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Detect_Switch_Clas_src_dot_ary_d5cf,1,bind2); _ary_2=it;;

                   goto success14;
                   pass14: *ptr=oldpass14;if (1){it=failobj;goto revert16;}
                   success14: *ptr=oldpass14;
                it=rb_ary_new3(0); _autovar_28=it;;
int stop3=0; while(!stop3){ int oldpos8=ptr->pos;int cut8=0;
alt8_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert17;} _autovar_29=it;;
it=AmethystCore_append(self,_autovar_28,_autovar_29);
;goto accept25;revert17:;  goto alt8_2; accept25:;

;ptr->branches-=2; goto accept24;
alt8_2: ptr->pos=oldpos8;ptr->branches-=1; stop3=1;
;goto accept26;revert18:;  goto alt8_3; accept26:;

;ptr->branches-=1; goto accept24;
alt8_3: ptr->pos=oldpos8;ptr->branches-=1;if (1){it=failobj;goto revert16;};
 accept24:;
 } it=_autovar_28; _rest=it;;
it=c_Switch_Clas; _cls_2=it;;
bind_aset(bind2,1,_cls_2);bind_aset(bind2,2,_ary_2);bind_aset(bind2,3,_prefix);bind_aset(bind2,4,_rest);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__lb__75a5,1,bind2);_cls_2=bind_aget(bind2,1);;_ary_2=bind_aget(bind2,2);;_prefix=bind_aget(bind2,3);;_rest=bind_aget(bind2,4);; __result_3=it;;

;goto accept23;revert16:;  goto alt7_3; accept23:;

;ptr->branches-=1; goto accept21;
alt7_3: ptr->pos=oldpos7;ptr->branches-=1;if (1){it=failobj;goto pass13;};
 accept21:;
it=__result_3; _autovar_30=it;;
 break;
case 1/*Object*/:; it=rb_ary_new3(0); _prefix=it;;
int oldpos9=ptr->pos;int cut9=0;
alt9_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=Detect_First_must_empty(self ); if (it==failobj){it=failobj;goto revert19;} _s=it;;
 it=c_Switch_Clas; arg0=it;bind_aset(bind2,1,_prefix);bind_aset(bind2,2,_s);it=rb_funcall(self,sy_Detect_Switch_Clas_bind_lb_1_rb__pl__4651,1,bind2);_prefix=bind_aget(bind2,1);;_s=bind_aget(bind2,2);; arg1=it; it=Detect_First_combine_seq(self ,arg0,arg1); __result_3=it;;

;goto accept28;revert19:;  goto alt9_2; accept28:;

;ptr->branches-=2; goto accept27;
alt9_2: ptr->pos=oldpos9;ptr->branches-=1; it=rb_ary_new3(0); _autovar_31=it;;
int stop4=0; while(!stop4){ int oldpos10=ptr->pos;int cut10=0;
alt10_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert21;} _autovar_32=it;;
it=AmethystCore_append(self,_autovar_31,_autovar_32);
;goto accept31;revert21:;  goto alt10_2; accept31:;

;ptr->branches-=2; goto accept30;
alt10_2: ptr->pos=oldpos10;ptr->branches-=1; stop4=1;
;goto accept32;revert22:;  goto alt10_3; accept32:;

;ptr->branches-=1; goto accept30;
alt10_3: ptr->pos=oldpos10;ptr->branches-=1;if (1){it=failobj;goto revert20;};
 accept30:;
 } it=_autovar_31; _ary_2=it;;
bind_aset(bind2,1,_prefix);bind_aset(bind2,2,_ary_2);it=rb_funcall(self,sy_Detect_Switch_Clas_Seq_lb__ti__lp_bi_a321,1,bind2);_prefix=bind_aget(bind2,1);;_ary_2=bind_aget(bind2,2);; __result_3=it;;

;goto accept29;revert20:;  goto alt9_3; accept29:;

;ptr->branches-=1; goto accept27;
alt9_3: ptr->pos=oldpos9;ptr->branches-=1;if (1){it=failobj;goto pass13;};
 accept27:;
it=__result_3; _autovar_30=it;;
 break;
}
...
void Init_Detect_Switch_Clas_c(){ 
 cls_Detect_Switch_Clas=rb_define_class("Detect_Switch_Clas",rb_const_get(rb_cObject,rb_intern("Detect_First"))); 
                    ...
                    c_Lattice_Clas=rb_const_get(rb_cObject, rb_intern("Lattice_Clas"));rb_global_variable(&c_Lattice_Clas);
c_Switch_Clas=rb_const_get(rb_cObject, rb_intern("Switch_Clas"));rb_global_variable(&c_Switch_Clas);
mem_Detect_Switch_Clas=memo_init();memo_val_Detect_Switch_Clas=Data_Wrap_Struct(rb_cObject,memo_mark,memo_free,mem_Detect_Switch_Clas);rb_global_variable(&memo_val_Detect_Switch_Clas);
