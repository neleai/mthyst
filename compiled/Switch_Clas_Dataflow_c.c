...
VALUE Switch_Clas_Dataflow_first(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_cls=Qnil,__result=Qnil,_autovar_7=Qnil,_autovar_8=Qnil;
...
alt1_1:
        ...
        VALUE revert1cls=rb_funcall(_cls,rb_intern("dup"),0);
