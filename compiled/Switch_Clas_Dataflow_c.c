...
VALUE profile_report_Switch_Clas_Dataflow(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  return Qnil;}VALUE Switch_Clas_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_cls=Qnil,__result=Qnil,_autovar_7=Qnil,_autovar_8=Qnil;VALUE bind2=bind_new2(1);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Clas_Dataflow_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos1=ptr->pos;int cut1=0;
...
alt2_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2; it=_autovar_3; _autovar_4=it;;
...
case 'c' ... 'c':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='l'&&ame_curstr2(ptr)[1]=='a'&&ame_curstr2(ptr)[2]=='s')  ptr->pos+=3; else if (1){it=failobj;goto pass2;} break;
                ...
                switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Clas_Dataflow_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*CAct*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_6=it;;
 break;
case 1/*Object*/:; if (1){it=failobj;goto pass1;} break;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Clas_Dataflow_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Class*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _cls=it;;
 break;
case 1/*Object*/:; if (1){it=failobj;goto pass3;} break;
                ...
                bind_aset(bind2,1,_cls);it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_lb__becc,1,bind2);_cls=bind_aget(bind2,1);; __result=it;;

;goto accept4;revert2:;  goto alt2_2; accept4:;

;ptr->branches-=2; goto accept3;
alt2_2: ptr->pos=oldpos2;ptr->branches-=1; it=_autovar_3; _autovar_7=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_7);
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass4;} _autovar_8=it;;
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else if (1){it=failobj;goto pass5;} break;
                ...
                it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__3340,1,bind2); __result=it;;
...
alt1_2: ptr->pos=oldpos1;ptr->branches-=1;   it=Switch_Clas_Dataflow_first_Switch_Clas_Dataflow(self ); if (it==failobj){it=failobj;goto revert4;} __result=it;;
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto fail;};
 accept1:;
 break;
case 1/*Object*/:;   it=Switch_Clas_Dataflow_first_Switch_Clas_Dataflow(self ); if (it==failobj){it=failobj;goto fail;} __result=it;;
 break;
}
fail: return it;
}
VALUE Switch_Clas_Dataflow_first_Switch_Clas_Dataflow(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil,_autovar_3=Qnil,_name=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_val=Qnil,_autovar_10=Qnil,_vals=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,_p=Qnil,_v=Qnil,_autovar_13=Qnil,_autovar_14=Qnil,_el=Qnil,_autovar_15=Qnil,_autovar_16=Qnil,_nev=Qnil,_autovar_17=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Clas_Dataflow_4,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*CAct*/:case 2/*Cut*/:case 3/*Local*/:case 4/*Lookahead*/:case 5/*Pass*/:case 6/*Result*/:case 7/*Stop*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__5a9e,1,bind2); _autovar_2=it;;
...
ptr->pos=ptr->len;bind_aset(bind2,1,_name);it=rb_funcall(self,sy_Switch_Clas_Dataflow__lp_Compile_7f7b,1,bind2);_name=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto pass2;};bind_aset(bind2,1,_name);it=rb_funcall(self,sy_Switch_Clas_Dataflow_Compiler_558e,1,bind2);_name=bind_aget(bind2,1);; _autovar_4=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
;ptr->branches-=2; goto accept1;
alt1_2: ptr->pos=oldpos1;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert2;}it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
alt2_2: ptr->pos=oldpos2;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert4;}it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_val);it=rb_funcall(self,sy_Switch_Clas_Dataflow_bind_lb_1_rb_,1,bind2);_val=bind_aget(bind2,1);; _autovar_10=it;;
...
alt3_2: ptr->pos=oldpos3;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert6;}it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_p);bind_aset(bind2,2,_v);it=rb_funcall(self,sy_Switch_Clas_Dataflow_bind_lb_1_rb__dot__c5d5,1,bind2);_p=bind_aget(bind2,1);;_v=bind_aget(bind2,2);; _autovar_13=it;;
...
alt5_3: ptr->pos=oldpos5;ptr->branches-=1;if (1){it=failobj;goto pass6;};
 accept12:;
                ...
                bind_aset(bind2,1,_vals);it=rb_funcall(self,sy_Switch_Clas_Dataflow_bind_lb_1_rb__dot__a37c,1,bind2);_vals=bind_aget(bind2,1);; __result=it;;

;goto accept11;revert7:;  goto alt4_2; accept11:;

;ptr->branches-=2; goto accept10;
alt4_2: ptr->pos=oldpos4;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert10;}it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__5a9e,1,bind2); _val=it;;
...
bind_aset(bind2,1,_val);bind_aset(bind2,2,_nev);it=rb_funcall(self,sy_Switch_Clas_Dataflow_bind_lb_1_rb__dot__159a,1,bind2);_val=bind_aget(bind2,1);;_nev=bind_aget(bind2,2);; _val=it;;
int oldpos7=ptr->pos;int cut7=0;
alt7_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2; bind_aset(bind2,1,_el);it=rb_funcall(self,sy_Switch_Clas_Dataflow__lp_,1,bind2);_el=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto revert12;};ptr->pos=ptr->len;
;goto accept19;revert12:;  goto alt7_2; accept19:;

;ptr->branches-=2; goto accept18;
alt7_2: ptr->pos=oldpos7;ptr->branches-=1; it=rb_funcall(self,sy_Switch_Clas_Dataflow__d41d,1,bind2);
...
alt6_3: ptr->pos=oldpos6;ptr->branches-=1;if (1){it=failobj;goto pass8;};
 ...
 break;
case 15/*Object*/:;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;}it=rb_funcall(self,sy_Switch_Clas_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
 break;
}
fail: return it;
}
VALUE Switch_Clas_Dataflow_getvalue(VALUE self ,VALUE a0){VALUE vals[1]; VALUE it ,_v=Qnil,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil;VALUE bind2=bind_new2(1); _v=a0;;  cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_v);it=rb_funcall(self,sy_Switch_Clas_Dataflow__at_vis_eq_bin_8b89,1,bind2);_v=bind_aget(bind2,1);; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar;ptr->len=1;
                     it=Switch_Clas_Dataflow_first(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
