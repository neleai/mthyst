...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 if (stop1) goto accept1; } break1: goto pass2; accept1:;   it=rb_funcall(self,sy_Normalize_Act_dot_crea_e434,1,bind2); var3/*autovar*/=it;;
...
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ',':;case '.' ... '/':;case ':' ... '@':;case '[' ... UC(255):; int oldpos3=ptr->pos;int cut2=0;
alt2_1:;  it=Amethyst_spaces(self );int oldpos4=ptr->pos;int cut3=0;
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt3_3; break;
...
;goto accept3;
alt2_2: ptr->pos=oldpos3;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt2_3);it=var5/*s*/;int oldpos5; int stop2=0; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos6=ptr->pos;int cut4=0;
...
alt5_3: ptr->pos=oldpos7;goto break2;
 accept7:;
 break;
} if (stop2) goto accept5; } break2: goto alt2_3; accept5:;   
;goto accept3;
alt2_3: ptr->pos=oldpos3;if (cut2) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt2_4);it=var5/*s*/;int oldpos8; int stop3=0; while(1){oldpos8=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos9=ptr->pos;int cut6=0;
alt6_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt6_2;
;goto accept9;
alt6_2: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt6_3);
;goto accept9;
alt6_3: ptr->pos=oldpos9;goto break3;
 accept9:;
 break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut2=1;stop3=1; break;
case UC(92) ... UC(92):; int oldpos10=ptr->pos;int cut7=0;
...
;goto accept10;
alt7_3: ptr->pos=oldpos10;goto break3;
 accept10:;
 break;
} if (stop3) goto accept8; } break3: goto alt2_4; accept8:;   
;goto accept3;
alt2_4: ptr->pos=oldpos3;if (cut2) goto pass3;goto pass3;
 accept3:;
  it=Amethyst_spaces(self );it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
case '-' ... '-':;case '0' ... '9':; int oldpos11=ptr->pos;int cut8=0;
...
;goto accept11;
alt8_2: ptr->pos=oldpos11;  it=Amethyst_number(self ); FAILTEST(alt8_3);
;goto accept11;
alt8_3: ptr->pos=oldpos11;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt8_4; break;
...
;goto accept11;
alt8_4: ptr->pos=oldpos11;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_5);it=var5/*s*/;int oldpos12; int stop4=0; while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos13=ptr->pos;int cut9=0;
...
case UC(92) ... UC(92):; int oldpos14=ptr->pos;int cut10=0;
...
alt10_3: ptr->pos=oldpos14;goto break4;
 accept14:;
 break;
} if (stop4) goto accept12; } break4: goto alt8_5; accept12:;   
;goto accept11;
alt8_5: ptr->pos=oldpos11;if (cut8) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_6);it=var5/*s*/;int oldpos15; int stop5=0; while(1){oldpos15=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos16=ptr->pos;int cut11=0;
...
case UC(92) ... UC(92):; int oldpos17=ptr->pos;int cut12=0;
...
alt12_3: ptr->pos=oldpos17;goto break5;
 accept17:;
 break;
} if (stop5) goto accept15; } break5: goto alt8_6; accept15:;   
;goto accept11;
alt8_6: ptr->pos=oldpos11;if (cut8) goto pass3;goto pass3;
 accept11:;
  it=Amethyst_spaces(self );it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
case 'A' ... 'Z':; int oldpos18=ptr->pos;int cut13=0;
...
;goto accept18;
alt13_2: ptr->pos=oldpos18;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos19; int stop6=0; while(1){oldpos19=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; stop6=1; break;
case '0' ... '9':;case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':; int oldpos20=ptr->pos;int cut14=0;
...
alt14_3: ptr->pos=oldpos20;goto break6;
 accept20:;
 break;
} if (stop6) goto accept19; } break6: goto alt13_3; accept19:;   it=rb_funcall(self,sy_Normalize__lp_eval_lp_sr_3f78,1,bind2);FAILTEST(alt13_3);
;goto accept18;
alt13_3: ptr->pos=oldpos18;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt13_4; break;
...
;goto accept18;
alt13_4: ptr->pos=oldpos18;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt13_5);it=var5/*s*/;int oldpos21; int stop7=0; while(1){oldpos21=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos22=ptr->pos;int cut15=0;
...
alt16_3: ptr->pos=oldpos23;goto break7;
 accept23:;
 break;
} if (stop7) goto accept21; } break7: goto alt13_5; accept21:;   
;goto accept18;
alt13_5: ptr->pos=oldpos18;if (cut13) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt13_6);it=var5/*s*/;int oldpos24; int stop8=0; while(1){oldpos24=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos25=ptr->pos;int cut17=0;
alt17_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt17_2;
;goto accept25;
alt17_2: ptr->pos=oldpos25;  it=AmethystCore_anything(self ); FAILTEST(alt17_3);
;goto accept25;
alt17_3: ptr->pos=oldpos25;goto break8;
 accept25:;
 break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut13=1;stop8=1; break;
case UC(92) ... UC(92):; int oldpos26=ptr->pos;int cut18=0;
...
;goto accept26;
alt18_2: ptr->pos=oldpos26;  it=AmethystCore_anything(self ); FAILTEST(alt18_3);
;goto accept26;
alt18_3: ptr->pos=oldpos26;goto break8;
 accept26:;
 break;
} if (stop8) goto accept24; } break8: goto alt13_6; accept24:;   
;goto accept18;
alt13_6: ptr->pos=oldpos18;if (cut13) goto pass3;goto pass3;
 accept18:;
  it=Amethyst_spaces(self );it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
}
                   goto success3;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;int oldpos7; int stop1=0; while(1){oldpos7=ptr->pos; int oldpos8=ptr->pos;int cut7=0;
...
alt7_3: ptr->pos=oldpos8;goto break1;
 accept8:;
 if (stop1) goto accept7; } break1: goto alt1_3; accept7:;   it=rb_funcall(self,sy_Normalize_src_dot_free_3d49,1,bind2); var8/*autovar*/=it;;
...
alt3_3: ptr->pos=oldpos4;goto break1;
 accept4:;
 if (stop1) goto accept3; } break1: goto pass4; accept3:;   it=var7/*autovar*/; var10/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
...
bind_aset(bind2,1,var12/*autovar*/);bind_aset(bind2,2,var13/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var12/*autovar*/=bind_aget(bind2,1);;var13/*autovar*/=bind_aget(bind2,2);;int oldpos6; int stop2=0; while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;int cut5=0;
...
alt5_3: ptr->pos=oldpos7;goto break2;
 accept7:;
 if (stop2) goto accept6; } break2: goto pass5; accept6:;   it=var12/*autovar*/; var10/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
...
;goto accept5;
alt4_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt4_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); var4/*autovar*/=it;;

;goto accept5;
alt4_3: ptr->pos=oldpos5;goto pass1;
 accept5:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
...
int oldpos9; int stop3=0; while(1){oldpos9=ptr->pos; int oldpos10=ptr->pos;int cut7=0;
...
;goto accept10;
alt7_2: ptr->pos=oldpos10;stop3=1;
;goto accept10;
alt7_3: ptr->pos=oldpos10;goto break3;
 accept10:;
 if (stop3) goto accept9; } break3: goto pass7; accept9:;   bind_aset(bind2,1,var10/*ary*/);it=rb_funcall(self,sy_Normalize_src_dot_clas_68f9,1,bind2);var10/*ary*/=bind_aget(bind2,1);; var23/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
...
;goto accept8;
alt6_2: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt6_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); var4/*autovar*/=it;;

;goto accept8;
alt6_3: ptr->pos=oldpos8;goto pass1;
 accept8:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
...
int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos2=ptr->pos;int cut1=0;
...
;goto accept2;
alt1_4: ptr->pos=oldpos2;stop1=1;
;goto accept2;
alt1_5: ptr->pos=oldpos2;goto break1;
 accept2:;
 break;
...
alt3_3: ptr->pos=oldpos5;goto break2;
 accept5:;
 if (stop2) goto accept4; } break2: goto pass4; accept4:;   it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); var7/*autovar*/=it;;
...
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt2_4: ptr->pos=oldpos3;stop1=1;
;goto accept3;
alt2_5: ptr->pos=oldpos3;goto break1;
 accept3:;
 break;
case 2/*Seq*/:; int oldpos6=ptr->pos;int cut4=0;
alt4_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt4_2);
;goto accept6;
alt4_2: ptr->pos=oldpos6;it=ame_curobj2(ptr)               ;ptr->pos++; var8/*autovar*/=it;;
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos7; int stop3=0; while(1){oldpos7=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Cut*/:; int oldpos8=ptr->pos;int cut5=0;
alt5_1:;it=ame_curobj2(ptr)               ;ptr->pos++;int oldpos9; int stop4=0; while(1){oldpos9=ptr->pos; int oldpos10=ptr->pos;int cut6=0;
...
alt6_3: ptr->pos=oldpos10;goto break4;
 accept10:;
 if (stop4) goto accept9; } break4: goto alt5_2; accept9:;   
;goto accept8;
alt5_2: ptr->pos=oldpos8;  it=Normalize_cant_fail(self ); FAILTEST(alt5_3);
;goto accept8;
alt5_3: ptr->pos=oldpos8;stop3=1;
;goto accept8;
alt5_4: ptr->pos=oldpos8;goto break3;
 accept8:;
 break;
case 1/*Object*/:; int oldpos11=ptr->pos;int cut7=0;
alt7_1:;  it=Normalize_cant_fail(self ); FAILTEST(alt7_2);
;goto accept11;
alt7_2: ptr->pos=oldpos11;stop3=1;
;goto accept11;
alt7_3: ptr->pos=oldpos11;goto break3;
 accept11:;
 break;
} if (stop3) goto accept7; } break3: goto pass5; accept7:;   it=Qnil;if (ptr->pos<ptr->len) goto pass5;it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); var9/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var9/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var9/*autovar*/=bind_aget(bind2,2);;it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   ...
                   success5: *ptr=oldpass5;
                int oldpos12; int stop5=0; while(1){oldpos12=ptr->pos; int oldpos13=ptr->pos;int cut8=0;
alt8_1:;  it=AmethystCore_anything(self ); FAILTEST(alt8_2);
;goto accept13;
alt8_2: ptr->pos=oldpos13;stop5=1;
;goto accept13;
alt8_3: ptr->pos=oldpos13;goto break5;
 accept13:;
 if (stop5) goto accept12; } break5: goto alt4_3; accept12:;   
;goto accept6;
alt4_3: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt4_4); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
alt4_4: ptr->pos=oldpos6;stop1=1;
;goto accept6;
alt4_5: ptr->pos=oldpos6;goto break1;
 accept6:;
 break;
case 3/*Object*/:; int oldpos14=ptr->pos;int cut9=0;
alt9_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt9_2);
;goto accept14;
alt9_2: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt9_3); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept14;
alt9_3: ptr->pos=oldpos14;stop1=1;
;goto accept14;
alt9_4: ptr->pos=oldpos14;goto break1;
 accept14:;
 break;
...
;goto accept15;
alt10_2: ptr->pos=oldpos15;it=var12/*autovar*/; var13/*a*/=it;;
it=i_1; var14/*x*/=it;;
...
;goto accept15;
alt10_3: ptr->pos=oldpos15;it=var12/*autovar*/;bind_aset(bind2,1,var2/*or*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*or*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var15/*autovar*/=it;;

;goto accept15;
alt10_4: ptr->pos=oldpos15;goto pass6;
 accept15:;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
...
int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos2=ptr->pos;int cut1=0;
alt1_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var3/*autovar*/=it;;
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var3/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass2); var4/*autovar*/=it;;
...
alt2_3: ptr->pos=oldpos4;goto break2;
 accept4:;
 if (stop2) goto accept3; } break2: goto alt1_2; accept3:;   
;goto accept2;
alt1_2: ptr->pos=oldpos2; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt1_3);
;goto accept2;
...
alt1_5: ptr->pos=oldpos2;goto break1;
 accept2:;
 break;
case 1/*Seq*/:; int oldpos5=ptr->pos;int cut3=0;
...
alt4_3: ptr->pos=oldpos7;goto break3;
 accept7:;
 if (stop3) goto accept6; } break3: goto pass4; accept6:;   it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); var8/*autovar*/=it;;
...
;goto accept5;
alt3_2: ptr->pos=oldpos5; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt3_3);
;goto accept5;
alt3_3: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt3_4); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt3_4: ptr->pos=oldpos5;stop1=1;
;goto accept5;
alt3_5: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
case 2/*Object*/:; int oldpos8=ptr->pos;int cut5=0;
alt5_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt5_2);
;goto accept8;
alt5_2: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt5_3); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept8;
alt5_3: ptr->pos=oldpos8;stop1=1;
;goto accept8;
...
;goto accept9;
alt6_2: ptr->pos=oldpos9;it=var11/*autovar*/; var12/*a*/=it;;
it=i_1; var13/*x*/=it;;
...
;goto accept9;
alt6_3: ptr->pos=oldpos9;it=var11/*autovar*/;bind_aset(bind2,1,var2/*seq*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*seq*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var14/*autovar*/=it;;

;goto accept9;
alt6_4: ptr->pos=oldpos9;goto pass5;
 accept9:;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
...
rb_define_method(cls_Normalize,"seq2",Normalize_seq2,0);
                    rb_eval_string("testversionnormalize('3a5a7a1f323a5de2c9c610ca9b245cda')");}
