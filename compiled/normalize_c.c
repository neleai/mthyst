...
;goto accept1;
alt1_4: ptr->pos=oldpos1;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_5);it=var5/*s*/;int oldpos2; int stop1=0; while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos3=ptr->pos;int cut2=0;
alt2_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt2_2;
;goto accept3;
...
;goto accept1;
alt1_5: ptr->pos=oldpos1;if (cut1) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_6);it=var5/*s*/;int oldpos5; int stop2=0; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos6=ptr->pos;int cut4=0;
...
;goto accept8;
alt6_5: ptr->pos=oldpos8;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt6_6);it=var5/*s*/;int oldpos10; int stop4=0; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos11=ptr->pos;int cut7=0;
...
;goto accept8;
alt6_6: ptr->pos=oldpos8;if (cut6) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt6_7);it=var5/*s*/;int oldpos13; int stop5=0; while(1){oldpos13=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos14=ptr->pos;int cut9=0;
