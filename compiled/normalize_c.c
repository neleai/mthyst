...
static VALUE sy_Normalize__lp_bind_lb_8_rb__78ed;
...
return it;
fail: return failobj; }
VALUE Normalize_or(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(11);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept1:;
 break;
case 1/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Normalize__append_lp__81ec,1,bind);  break;
...
;goto accept2;
alt2_3: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_4);it=rb_funcall(self,sy_Normalize_bind_lb_2_rb__dot__e24b,1,bind);  bind_aset(bind,9/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Normalize_seq(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(12);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept1:;
 break;
case 1/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Normalize__append_lp__4297,1,bind);  break;
}  } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=Qnil;if (ptr->pos<ptr->len) goto pass1;
	goto success1;
	pass1: *ptr=oldpass1; goto fail;
	success1: *ptr=oldpass1;
it=rb_funcall(self,sy_Normalize_bind_lb_0_rb__dot__263e,1,bind);  bind_aset(bind,7/*autovar*/,it);
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,7/*autovar*/);ptr->len=1;
 int oldpos3=ptr->pos;
alt2_1:;it=rb_funcall(self,sy_Normalize_0_cfcd,1,bind);  bind_aset(bind,8/*x*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,9/*a*/,it);
it=rb_funcall(self,sy_Normalize__lp_bind_lb_8_rb__78ed,1,bind); FAILTEST(alt2_2);it=rb_funcall(self,sy_Normalize_Placehol_a03d,1,bind);  bind_aset(bind,10/*autovar*/,it);

;goto accept2;
alt2_2: ptr->pos=oldpos3;it=rb_funcall(self,sy_Normalize_1_c4ca,1,bind);  bind_aset(bind,8/*x*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,9/*a*/,it);
it=rb_funcall(self,sy_Normalize__lp_bind_lb_8_rb__78ed,1,bind); FAILTEST(alt2_3);it=rb_funcall(self,sy_Normalize_bind_lb_0_rb__lb__1f45,1,bind);  bind_aset(bind,10/*autovar*/,it);

;goto accept2;
alt2_3: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_4);it=rb_funcall(self,sy_Normalize_bind_lb_2_rb__dot__e24b,1,bind);  bind_aset(bind,10/*autovar*/,it);
...
sy_Normalize__lp_bind_lb_8_rb__78ed=rb_intern("Normalize__lp_bind_lb_8_rb__78ed");
...
rb_define_method(cls_Normalize,"word",Normalize_word,0);
 rb_eval_string("testversionnormalize('1ab9311f8e782d1441fa3fcc8438c792')");}
