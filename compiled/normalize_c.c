...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_Act_dot_crea_e434,1,bind2); var3/*autovar*/=it;;
...
alt1_1:;  it=Amethyst_spaces(self ); FAILTEST(alt1_2);int oldpos2=ptr->pos;int cut2=0;
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='l'&&ame_curstr2(ptr)[2]=='s'&&ame_curstr2(ptr)[3]=='e')  ptr->pos+=4; else goto alt2_3; break;
case 'n' ... 'n':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='i'&&ame_curstr2(ptr)[1]=='l')  ptr->pos+=2; else goto alt2_3; break;
case 't' ... 't':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='r'&&ame_curstr2(ptr)[1]=='u'&&ame_curstr2(ptr)[2]=='e')  ptr->pos+=3; else goto alt2_3; break;
}
;goto accept2;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_3);it=var5/*s*/;int oldpos3; int stop1=0; while(1){oldpos3=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos4=ptr->pos;int cut3=0;
alt3_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt3_2;
;goto accept4;
...
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);
;goto accept5;
...
alt4_3: ptr->pos=oldpos5;goto break1;
 accept5:;
 break;
} if (stop1) goto accept3; } break1: goto alt1_3; accept3:;   
;goto accept1;
alt1_3: ptr->pos=oldpos1;if (cut1) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_4);it=var5/*s*/;int oldpos6; int stop2=0; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos7=ptr->pos;int cut5=0;
...
case UC(92) ... UC(92):; int oldpos8=ptr->pos;int cut6=0;
alt6_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);
;goto accept8;
...
alt6_3: ptr->pos=oldpos8;goto break2;
 accept8:;
 break;
} if (stop2) goto accept6; } break2: goto alt1_4; accept6:;   
;goto accept1;
alt1_4: ptr->pos=oldpos1;if (cut1) goto pass3;goto pass3;
 accept1:;
  it=Amethyst_spaces(self ); FAILTEST(pass3);it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
case '-' ... '-':;case '0' ... '9':; int oldpos9=ptr->pos;int cut7=0;
alt7_1:;  it=Amethyst_spaces(self ); FAILTEST(alt7_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; goto alt7_2; break;
case '[' ... '[':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt7_2; break;
}
;goto accept9;
alt7_2: ptr->pos=oldpos9;  it=Amethyst_number(self ); FAILTEST(alt7_3);
;goto accept9;
alt7_3: ptr->pos=oldpos9;  it=Amethyst_spaces(self ); FAILTEST(alt7_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt7_4; break;
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='l'&&ame_curstr2(ptr)[2]=='s'&&ame_curstr2(ptr)[3]=='e')  ptr->pos+=4; else goto alt7_4; break;
case 'n' ... 'n':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='i'&&ame_curstr2(ptr)[1]=='l')  ptr->pos+=2; else goto alt7_4; break;
case 't' ... 't':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='r'&&ame_curstr2(ptr)[1]=='u'&&ame_curstr2(ptr)[2]=='e')  ptr->pos+=3; else goto alt7_4; break;
}
;goto accept9;
alt7_4: ptr->pos=oldpos9;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt7_5);it=var5/*s*/;int oldpos10; int stop3=0; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos11=ptr->pos;int cut8=0;
alt8_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt8_2;
;goto accept11;
alt8_2: ptr->pos=oldpos11;  it=AmethystCore_anything(self ); FAILTEST(alt8_3);
;goto accept11;
alt8_3: ptr->pos=oldpos11;goto break3;
 accept11:;
 break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut7=1;stop3=1; break;
case UC(92) ... UC(92):; int oldpos12=ptr->pos;int cut9=0;
alt9_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt9_2);
;goto accept12;
alt9_2: ptr->pos=oldpos12;  it=AmethystCore_anything(self ); FAILTEST(alt9_3);
;goto accept12;
alt9_3: ptr->pos=oldpos12;goto break3;
 accept12:;
 break;
} if (stop3) goto accept10; } break3: goto alt7_5; accept10:;   
;goto accept9;
alt7_5: ptr->pos=oldpos9;if (cut7) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt7_6);it=var5/*s*/;int oldpos13; int stop4=0; while(1){oldpos13=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos14=ptr->pos;int cut10=0;
alt10_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt10_2;
;goto accept14;
alt10_2: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt10_3);
;goto accept14;
alt10_3: ptr->pos=oldpos14;goto break4;
 accept14:;
 break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut7=1;stop4=1; break;
case UC(92) ... UC(92):; int oldpos15=ptr->pos;int cut11=0;
alt11_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt11_2);
;goto accept15;
...
alt11_3: ptr->pos=oldpos15;goto break4;
 accept15:;
 break;
} if (stop4) goto accept13; } break4: goto alt7_6; accept13:;   
;goto accept9;
alt7_6: ptr->pos=oldpos9;if (cut7) goto pass3;goto pass3;
 accept9:;
  it=Amethyst_spaces(self ); FAILTEST(pass3);it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
case 'A' ... 'Z':; int oldpos16=ptr->pos;int cut12=0;
alt12_1:;  it=Amethyst_spaces(self ); FAILTEST(alt12_2);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; goto alt12_2; break;
case '[' ... '[':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt12_2; break;
}
;goto accept16;
alt12_2: ptr->pos=oldpos16;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos17;  while(1){oldpos17=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; goto break5; break;
case '0' ... '9':;case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; break;
} } break5: ptr->pos=oldpos17;   it=rb_funcall(self,sy_Normalize__lp_eval_lp_sr_3f78,1,bind2);FAILTEST(alt12_3);
;goto accept16;
alt12_3: ptr->pos=oldpos16;  it=Amethyst_spaces(self ); FAILTEST(alt12_4);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt12_4; break;
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='l'&&ame_curstr2(ptr)[2]=='s'&&ame_curstr2(ptr)[3]=='e')  ptr->pos+=4; else goto alt12_4; break;
case 'n' ... 'n':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='i'&&ame_curstr2(ptr)[1]=='l')  ptr->pos+=2; else goto alt12_4; break;
case 't' ... 't':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='r'&&ame_curstr2(ptr)[1]=='u'&&ame_curstr2(ptr)[2]=='e')  ptr->pos+=3; else goto alt12_4; break;
}
;goto accept16;
alt12_4: ptr->pos=oldpos16;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt12_5);it=var5/*s*/;int oldpos18; int stop6=0; while(1){oldpos18=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos19=ptr->pos;int cut13=0;
alt13_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt13_2;
;goto accept19;
alt13_2: ptr->pos=oldpos19;  it=AmethystCore_anything(self ); FAILTEST(alt13_3);
;goto accept19;
alt13_3: ptr->pos=oldpos19;goto break6;
 accept19:;
 break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut12=1;stop6=1; break;
case UC(92) ... UC(92):; int oldpos20=ptr->pos;int cut14=0;
alt14_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt14_2);
;goto accept20;
alt14_2: ptr->pos=oldpos20;  it=AmethystCore_anything(self ); FAILTEST(alt14_3);
;goto accept20;
alt14_3: ptr->pos=oldpos20;goto break6;
 accept20:;
 break;
} if (stop6) goto accept18; } break6: goto alt12_5; accept18:;   
;goto accept16;
alt12_5: ptr->pos=oldpos16;if (cut12) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt12_6);it=var5/*s*/;int oldpos21; int stop7=0; while(1){oldpos21=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos22=ptr->pos;int cut15=0;
alt15_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt15_2;
;goto accept22;
alt15_2: ptr->pos=oldpos22;  it=AmethystCore_anything(self ); FAILTEST(alt15_3);
;goto accept22;
alt15_3: ptr->pos=oldpos22;goto break7;
 accept22:;
 break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut12=1;stop7=1; break;
case UC(92) ... UC(92):; int oldpos23=ptr->pos;int cut16=0;
...
;goto accept23;
alt16_2: ptr->pos=oldpos23;  it=AmethystCore_anything(self ); FAILTEST(alt16_3);
;goto accept23;
alt16_3: ptr->pos=oldpos23;goto break7;
 accept23:;
 break;
} if (stop7) goto accept21; } break7: goto alt12_6; accept21:;   
;goto accept16;
alt12_6: ptr->pos=oldpos16;if (cut12) goto pass3;goto pass3;
 accept16:;
  it=Amethyst_spaces(self ); FAILTEST(pass3);it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
}
                   goto success3;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_free_3d49,1,bind2); var8/*autovar*/=it;;
...
int oldpos3;  while(1){oldpos3=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break1); var8/*it*/=it;;
...
bind_aset(bind2,1,var7/*autovar*/);bind_aset(bind2,2,var9/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var7/*autovar*/=bind_aget(bind2,1);;var9/*autovar*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos3;   it=var7/*autovar*/; var10/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
...
alt3_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var11/*autovar*/=it;;
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
bind_aset(bind2,1,var12/*autovar*/);bind_aset(bind2,2,var13/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var12/*autovar*/=bind_aget(bind2,1);;var13/*autovar*/=bind_aget(bind2,2);;int oldpos5;  while(1){oldpos5=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break2); var14/*autovar*/=it;;
bind_aset(bind2,1,var12/*autovar*/);bind_aset(bind2,2,var14/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var12/*autovar*/=bind_aget(bind2,1);;var14/*autovar*/=bind_aget(bind2,2);; } break2: ptr->pos=oldpos5;   it=var12/*autovar*/; var10/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); var4/*autovar*/=it;;
...
alt4_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var19/*autovar*/=it;;
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos7;  while(1){oldpos7=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break3); var20/*autovar*/=it;;
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
bind_aset(bind2,1,var10/*ary*/);bind_aset(bind2,2,var21/*p*/);bind_aset(bind2,3,var5/*name*/);bind_aset(bind2,4,var22/*a*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lt__f738,1,bind2);var10/*ary*/=bind_aget(bind2,1);;var21/*p*/=bind_aget(bind2,2);;var5/*name*/=bind_aget(bind2,3);;var22/*a*/=bind_aget(bind2,4);;it=Qnil;if (ptr->pos<ptr->len) goto pass8;
                   ...
                   success8: *ptr=oldpass8;
                 } break3: ptr->pos=oldpos7;   bind_aset(bind2,1,var10/*ary*/);it=rb_funcall(self,sy_Normalize_src_dot_clas_68f9,1,bind2);var10/*ary*/=bind_aget(bind2,1);; var23/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
...
;goto accept6;
alt4_2: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt4_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); var4/*autovar*/=it;;
...
;goto accept2;
alt1_3: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_4); var5/*autovar*/=it;;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var6/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); var7/*autovar*/=it;;
...
;goto accept3;
alt2_3: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_4); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
...
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var9/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var9/*autovar*/=bind_aget(bind2,2);;it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                ...
                ptr->pos=ptr->len;
;goto accept4;
alt3_3: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_4); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept4;
...
alt1_2: ptr->pos=oldpos2; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt1_3);
;goto accept2;
alt1_3: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_4); var6/*autovar*/=it;;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); var8/*autovar*/=it;;
...
alt2_2: ptr->pos=oldpos3; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt2_3);
;goto accept3;
alt2_3: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_4); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt2_4: ptr->pos=oldpos3;goto break1;
 accept3:;
...
alt3_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt3_2);
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_3); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept4;
alt3_3: ptr->pos=oldpos4;goto break1;
 accept4:;
...
alt4_1:;it=var11/*autovar*/; var12/*a*/=it;;
it=i_0; var13/*x*/=it;;
bind_aset(bind2,1,var13/*x*/);bind_aset(bind2,2,var12/*a*/);it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);var13/*x*/=bind_aget(bind2,1);;var12/*a*/=bind_aget(bind2,2);;FAILTEST(alt4_2);it=rb_funcall(self,sy_Normalize_Placehol_a03d,1,bind2); var14/*autovar*/=it;;

;goto accept5;
alt4_2: ptr->pos=oldpos5;it=var11/*autovar*/; var12/*a*/=it;;
it=i_1; var13/*x*/=it;;
bind_aset(bind2,1,var13/*x*/);bind_aset(bind2,2,var12/*a*/);it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);var13/*x*/=bind_aget(bind2,1);;var12/*a*/=bind_aget(bind2,2);;FAILTEST(alt4_3);bind_aset(bind2,1,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lb__79d7,1,bind2);var0/*ary*/=bind_aget(bind2,1);; var14/*autovar*/=it;;

;goto accept5;
alt4_3: ptr->pos=oldpos5;it=var11/*autovar*/;bind_aset(bind2,1,var2/*seq*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*seq*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var14/*autovar*/=it;;
...
rb_define_method(cls_Normalize,"seq2",Normalize_seq2,0);
                    rb_eval_string("testversionnormalize('d52fd87fbfbe753b77274f96f32bc141')");}
