...
alt1_1:;  it=Amethyst_spaces(self );int oldpos2=ptr->pos;int cut2=0;
...
alt1_2: ptr->pos=oldpos1;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_3);it=var5/*s*/;int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos3=ptr->pos;int cut3=0;
...
alt1_3: ptr->pos=oldpos1;if (cut1) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_4);it=var5/*s*/;int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos5=ptr->pos;int cut5=0;
alt5_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt5_2;
;goto accept5;
alt5_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt5_3);
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto alt1_4;
 accept5:;
 break;
...
;goto accept6;
alt6_3: ptr->pos=oldpos6;goto alt1_4;
 accept6:;
 break;
} } 
;goto accept1;
...
case '-' ... '-':;case '0' ... '9':; int oldpos7=ptr->pos;int cut7=0;
alt7_1:;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; goto alt7_2; break;
case '[' ... '[':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt7_2; break;
}
;goto accept7;
alt7_2: ptr->pos=oldpos7;  it=Amethyst_number(self ); FAILTEST(alt7_3);
;goto accept7;
alt7_3: ptr->pos=oldpos7;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt7_4; break;
...
;goto accept7;
alt7_4: ptr->pos=oldpos7;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt7_5);it=var5/*s*/;int stop3=0; while(!stop3){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos8=ptr->pos;int cut8=0;
alt8_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt8_2;
;goto accept8;
alt8_2: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt8_3);
;goto accept8;
alt8_3: ptr->pos=oldpos8;goto alt7_5;
 accept8:;
 break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut7=1;stop3=1; break;
case UC(92) ... UC(92):; int oldpos9=ptr->pos;int cut9=0;
...
;goto accept9;
alt9_3: ptr->pos=oldpos9;goto alt7_5;
 accept9:;
 break;
} } 
;goto accept7;
alt7_5: ptr->pos=oldpos7;if (cut7) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt7_6);it=var5/*s*/;int stop4=0; while(!stop4){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos10=ptr->pos;int cut10=0;
alt10_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt10_2;
;goto accept10;
alt10_2: ptr->pos=oldpos10;  it=AmethystCore_anything(self ); FAILTEST(alt10_3);
;goto accept10;
alt10_3: ptr->pos=oldpos10;goto alt7_6;
 accept10:;
 break;
...
;goto accept11;
alt11_3: ptr->pos=oldpos11;goto alt7_6;
 accept11:;
 break;
} } 
;goto accept7;
alt7_6: ptr->pos=oldpos7;if (cut7) goto pass3;goto pass3;
 accept7:;
  it=Amethyst_spaces(self );it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
case 'A' ... 'Z':; int oldpos12=ptr->pos;int cut12=0;
alt12_1:;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'Z':;case UC(92) ... UC(255):; goto alt12_2; break;
case '[' ... '[':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]==']')  ptr->pos+=1; else goto alt12_2; break;
}
;goto accept12;
alt12_2: ptr->pos=oldpos12;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int stop5=0; while(!stop5){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case '[' ... '^':;case '`' ... '`':;case '{' ... UC(255):; stop5=1; break;
case '0' ... '9':;case 'A' ... 'Z':;case '_' ... '_':;case 'a' ... 'z':; int oldpos13=ptr->pos;int cut13=0;
alt13_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;
;goto accept13;
alt13_2: ptr->pos=oldpos13;stop5=1;
;goto accept13;
alt13_3: ptr->pos=oldpos13;goto alt12_3;
 accept13:;
 break;
} } it=rb_funcall(self,sy_Normalize__lp_eval_lp_sr_3f78,1,bind2);FAILTEST(alt12_3);
;goto accept12;
alt12_3: ptr->pos=oldpos12;  it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... 'm':;case 'o' ... 's':;case 'u' ... UC(255):; goto alt12_4; break;
...
;goto accept12;
alt12_4: ptr->pos=oldpos12;it=rb_obj_clone(s__bs__dq__3bd8); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt12_5);it=var5/*s*/;int stop6=0; while(!stop6){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '#' ... '[':;case ']' ... UC(255):; int oldpos14=ptr->pos;int cut14=0;
alt14_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt14_2;
;goto accept14;
alt14_2: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt14_3);
;goto accept14;
alt14_3: ptr->pos=oldpos14;goto alt12_5;
 accept14:;
 break;
case UC(34) ... UC(34):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut12=1;stop6=1; break;
case UC(92) ... UC(92):; int oldpos15=ptr->pos;int cut15=0;
alt15_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt15_2);
;goto accept15;
alt15_2: ptr->pos=oldpos15;  it=AmethystCore_anything(self ); FAILTEST(alt15_3);
;goto accept15;
alt15_3: ptr->pos=oldpos15;goto alt12_5;
 accept15:;
 break;
} } 
;goto accept12;
alt12_5: ptr->pos=oldpos12;if (cut12) goto pass3;it=rb_obj_clone(s__qu__3590); var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt12_6);it=var5/*s*/;int stop7=0; while(!stop7){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos16=ptr->pos;int cut16=0;
alt16_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
goto alt16_2;
;goto accept16;
alt16_2: ptr->pos=oldpos16;  it=AmethystCore_anything(self ); FAILTEST(alt16_3);
;goto accept16;
alt16_3: ptr->pos=oldpos16;goto alt12_6;
 accept16:;
 break;
case UC(39) ... UC(39):; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;cut12=1;stop7=1; break;
case UC(92) ... UC(92):; int oldpos17=ptr->pos;int cut17=0;
alt17_1:;it=rb_obj_clone(s__bs__bs__7f81); var5/*s*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;  it=AmethystCore_anything(self ); FAILTEST(alt17_2);
;goto accept17;
alt17_2: ptr->pos=oldpos17;  it=AmethystCore_anything(self ); FAILTEST(alt17_3);
;goto accept17;
alt17_3: ptr->pos=oldpos17;goto alt12_6;
 accept17:;
 break;
} } 
;goto accept12;
alt12_6: ptr->pos=oldpos12;if (cut12) goto pass3;goto pass3;
 accept12:;
  it=Amethyst_spaces(self );it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
}
                   goto success3;
...
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int stop2=0; while(!stop2){ switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Cut*/:; it=ame_curobj2(ptr)               ;ptr->pos++;ptr->pos=ptr->len; break;
case 1/*Object*/:; int oldpos4=ptr->pos;int cut4=0;
alt4_1:;  it=Normalize_cant_fail(self ); FAILTEST(alt4_2);
;goto accept4;
alt4_2: ptr->pos=oldpos4;stop2=1;
;goto accept4;
alt4_3: ptr->pos=oldpos4;goto pass5;
 accept4:;
 break;
...
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var9/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var9/*autovar*/=bind_aget(bind2,2);;it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                ...
                ptr->pos=ptr->len;
;goto accept3;
alt3_3: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt3_4); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
...
alt3_5: ptr->pos=oldpos3;goto pass1;
 accept3:;
 break;
case 3/*Object*/:; int oldpos5=ptr->pos;int cut5=0;
alt5_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt5_2);
;goto accept5;
alt5_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt5_3); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
...
;goto accept6;
alt6_2: ptr->pos=oldpos6;it=var12/*autovar*/; var13/*a*/=it;;
it=i_1; var14/*x*/=it;;
...
;goto accept6;
alt6_3: ptr->pos=oldpos6;it=var12/*autovar*/;bind_aset(bind2,1,var2/*or*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*or*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var15/*autovar*/=it;;

;goto accept6;
alt6_4: ptr->pos=oldpos6;goto pass6;
 accept6:;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
...
alt2_2: ptr->pos=oldpos2; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt2_3);
;goto accept2;
alt2_3: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt2_4); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept2;
alt2_4: ptr->pos=oldpos2;stop1=1;
;goto accept2;
alt2_5: ptr->pos=oldpos2;goto pass1;
 accept2:;
 break;
case 2/*Object*/:; int oldpos3=ptr->pos;int cut3=0;
alt3_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt3_2);
;goto accept3;
alt3_2: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt3_3); var6/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;it=var11/*autovar*/; var12/*a*/=it;;
it=i_1; var13/*x*/=it;;
...
;goto accept4;
alt4_3: ptr->pos=oldpos4;it=var11/*autovar*/;bind_aset(bind2,1,var2/*seq*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*seq*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var14/*autovar*/=it;;

;goto accept4;
alt4_4: ptr->pos=oldpos4;goto pass5;
 accept4:;
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
