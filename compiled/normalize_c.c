...
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int stop3=0; while(!stop3){ switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Cut*/:; int oldpos5=ptr->pos;int cut5=0;
alt5_1:;it=ame_curobj2(ptr)               ;ptr->pos++;int stop4=0; while(!stop4){ int oldpos6=ptr->pos;int cut6=0;
...
;goto accept5;
alt5_2: ptr->pos=oldpos5;  it=Normalize_cant_fail(self ); FAILTEST(alt5_3);
;goto accept5;
alt5_3: ptr->pos=oldpos5;stop3=1;
;goto accept5;
alt5_4: ptr->pos=oldpos5;goto pass5;
 accept5:;
 break;
case 1/*Object*/:; int oldpos7=ptr->pos;int cut7=0;
alt7_1:;  it=Normalize_cant_fail(self ); FAILTEST(alt7_2);
;goto accept7;
alt7_2: ptr->pos=oldpos7;stop3=1;
;goto accept7;
...
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var9/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var9/*autovar*/=bind_aget(bind2,2);;it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   ...
                   success5: *ptr=oldpass5;
                int stop5=0; while(!stop5){ int oldpos8=ptr->pos;int cut8=0;
alt8_1:;  it=AmethystCore_anything(self ); FAILTEST(alt8_2);
;goto accept8;
alt8_2: ptr->pos=oldpos8;stop5=1;
;goto accept8;
alt8_3: ptr->pos=oldpos8;goto alt4_3;
 accept8:;
 } 
;goto accept4;
...
alt4_5: ptr->pos=oldpos4;goto pass1;
 accept4:;
 break;
case 3/*Object*/:; int oldpos9=ptr->pos;int cut9=0;
alt9_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt9_2);
;goto accept9;
alt9_2: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt9_3); var5/*autovar*/=it;;
bind_aset(bind2,1,var0/*ary*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);var0/*ary*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);;
;goto accept9;
alt9_3: ptr->pos=oldpos9;stop1=1;
;goto accept9;
alt9_4: ptr->pos=oldpos9;goto pass1;
 accept9:;
 break;
} } it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt10_1:;it=var12/*autovar*/; var13/*a*/=it;;
it=i_0; var14/*x*/=it;;
bind_aset(bind2,1,var14/*x*/);bind_aset(bind2,2,var13/*a*/);it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);var14/*x*/=bind_aget(bind2,1);;var13/*a*/=bind_aget(bind2,2);;FAILTEST(alt10_2);it=rb_funcall(self,sy_Normalize_Apply_lb__dq_f_3881,1,bind2); var15/*autovar*/=it;;

;goto accept10;
alt10_2: ptr->pos=oldpos10;it=var12/*autovar*/; var13/*a*/=it;;
it=i_1; var14/*x*/=it;;
bind_aset(bind2,1,var14/*x*/);bind_aset(bind2,2,var13/*a*/);it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);var14/*x*/=bind_aget(bind2,1);;var13/*a*/=bind_aget(bind2,2);;FAILTEST(alt10_3);bind_aset(bind2,1,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lb__79d7,1,bind2);var0/*ary*/=bind_aget(bind2,1);; var15/*autovar*/=it;;

;goto accept10;
alt10_3: ptr->pos=oldpos10;it=var12/*autovar*/;bind_aset(bind2,1,var2/*or*/);bind_aset(bind2,2,var0/*ary*/);it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);var2/*or*/=bind_aget(bind2,1);;var0/*ary*/=bind_aget(bind2,2);; var15/*autovar*/=it;;

;goto accept10;
alt10_4: ptr->pos=oldpos10;goto pass6;
 accept10:;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
...
rb_define_method(cls_Normalize,"seq2",Normalize_seq2,0);
                    rb_eval_string("testversionnormalize('f61505c61ad144dc520a5d611d9c3472')");}
