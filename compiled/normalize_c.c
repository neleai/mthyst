...
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '@':;case '[' ... UC(255):; int oldpos1=ptr->pos;
...
alt1_4: ptr->pos=oldpos1;it=rb_obj_clone(s__bs__dq__3bd8); bind_aset(bind,5/*s*/,it);
 it=bind_aget(bind,5/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_5);it=bind_aget(bind,5/*s*/);int oldpos2; int stop1=0; while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '$' ... '[':;case ']' ... UC(255):; int oldpos3=ptr->pos;
...
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 break;
case UC(34) ... '#':; int oldpos4=ptr->pos;
alt3_1:;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);ame_setcut(self,Qtrue);stop1=1;
ame_setcut(self,Qnil);goto accept4;
alt3_2: ptr->pos=oldpos4;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*s*/,it);
goto alt3_3;
;goto accept4;
...
alt3_4: ptr->pos=oldpos4;goto break1;
 accept4:;
 break;
case UC(92) ... UC(92):; int oldpos5=ptr->pos;
...
alt1_5: ptr->pos=oldpos1;it=rb_obj_clone(s__qu__3590); bind_aset(bind,5/*s*/,it);
 it=bind_aget(bind,5/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt1_6);it=bind_aget(bind,5/*s*/);int oldpos6; int stop2=0; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(34):;case '$' ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos7=ptr->pos;
...
alt5_3: ptr->pos=oldpos7;goto break2;
 accept7:;
 break;
case '#' ... '#':;case UC(39) ... UC(39):; int oldpos8=ptr->pos;
alt6_1:;  it=AmethystCore_anything(self ); FAILTEST(alt6_2);ame_setcut(self,Qtrue);stop2=1;
ame_setcut(self,Qnil);goto accept8;
alt6_2: ptr->pos=oldpos8;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*s*/,it);
goto alt6_3;
;goto accept8;
...
alt6_4: ptr->pos=oldpos8;goto break2;
 accept8:;
 break;
case UC(92) ... UC(92):; int oldpos9=ptr->pos;
...
alt8_5: ptr->pos=oldpos10;it=rb_obj_clone(s__bs__dq__3bd8); bind_aset(bind,5/*s*/,it);
 it=bind_aget(bind,5/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_6);it=bind_aget(bind,5/*s*/);int oldpos12; int stop4=0; while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '!':;case '$' ... '[':;case ']' ... UC(255):; int oldpos13=ptr->pos;
...
alt10_1:;  it=AmethystCore_anything(self ); FAILTEST(alt10_2);ame_setcut(self,Qtrue);stop4=1;
ame_setcut(self,Qnil);goto accept14;
alt10_2: ptr->pos=oldpos14;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break4;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*s*/,it);
goto alt10_3;
;goto accept14;
...
alt8_6: ptr->pos=oldpos10;it=rb_obj_clone(s__qu__3590); bind_aset(bind,5/*s*/,it);
 it=bind_aget(bind,5/*s*/); arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt8_7);it=bind_aget(bind,5/*s*/);int oldpos16; int stop5=0; while(1){oldpos16=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(34):;case '$' ... '&':;case '(' ... '[':;case ']' ... UC(255):; int oldpos17=ptr->pos;
...
alt13_1:;  it=AmethystCore_anything(self ); FAILTEST(alt13_2);ame_setcut(self,Qtrue);stop5=1;
ame_setcut(self,Qnil);goto accept18;
alt13_2: ptr->pos=oldpos18;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break5;}it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,5/*s*/,it);
goto alt13_3;
;goto accept18;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_8,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; it=rb_funcall(self,sy_Normalize_src_dot_name_80f3,1,bind); int oldpos1=ptr->pos;
alt1_1:;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,1/*autovar*/,it);
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_9,rb_obj_class(ame_curobj2(ptr))))){case 0/*Comment*/:case 1/*Cut*/:case 2/*Stop*/:; int oldpos6=ptr->pos;
...
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   int oldpos5;  while(1){oldpos5=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Cut*/:; int oldpos6=ptr->pos;
alt4_1:;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);ame_setcut(self,Qtrue);goto alt4_2;
ame_setcut(self,Qnil);goto accept6;
alt4_2: ptr->pos=oldpos6;if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break2;}  it=Amethyst_empty(self ); FAILTEST(alt4_3);
;goto accept6;
...
alt3_4: ptr->pos=oldpos4;goto break1;
 accept4:;
 break;
case 3/*Object*/:; int oldpos7=ptr->pos;
...
int oldpos1;  while(1){oldpos1=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_6,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos2=ptr->pos;
alt1_1:;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,3/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass2); bind_aset(bind,4/*autovar*/,it);
...
rb_define_method(cls_Normalize,"seq2",Normalize_seq2,0);
                    rb_eval_string("testversionnormalize('1d77f78fc22aafc8ef8087168587d017')");}
