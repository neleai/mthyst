...
;goto accept2;
alt2_2: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Normalize__append_lp__81ec,1,bind); 
;goto accept2;
alt2_3: ptr->pos=oldpos3;goto break1;
 accept2:;
 break;
case 2/*Placeholder*/:; int oldpos4=ptr->pos;
...
alt3_3: ptr->pos=oldpos4;goto break1;
 accept3:;
 break;
case 3/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
...
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 int oldpos5=ptr->pos;
alt4_1:;it=rb_funcall(self,sy_Normalize_0_cfcd,1,bind);  bind_aset(bind,9/*x*/,it);
...
;goto accept4;
alt4_2: ptr->pos=oldpos5;it=rb_funcall(self,sy_Normalize_1_c4ca,1,bind);  bind_aset(bind,9/*x*/,it);
...
return it;
fail: return failobj; }
VALUE Normalize_seq(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(14);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept1:;
 break;
case 1/*Placeholder*/:; int oldpos3=ptr->pos;
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);
;goto accept2;
alt2_2: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Normalize__append_lp__4297,1,bind); 
;goto accept2;
alt2_3: ptr->pos=oldpos3;goto break1;
 accept2:;
...
alt3_1:;  it=AmethystCore_anything(self ); FAILTEST(alt3_2); bind_aset(bind,7/*autovar*/,it);
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt3_3: ptr->pos=oldpos4;goto break1;
 accept3:;
 break;
case 3/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
...
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 int oldpos5=ptr->pos;
alt4_1:;it=rb_funcall(self,sy_Normalize_0_cfcd,1,bind);  bind_aset(bind,10/*x*/,it);
  it=AmethystCore_anything(self ); FAILTEST(alt4_2); bind_aset(bind,11/*a*/,it);
it=rb_funcall(self,sy_Normalize__lp_bind_lb_10_612c,1,bind); FAILTEST(alt4_2);it=c_Placeholder; bind_aset(bind,12/*autovar*/,it);

;goto accept4;
alt4_2: ptr->pos=oldpos5;it=rb_funcall(self,sy_Normalize_1_c4ca,1,bind);  bind_aset(bind,10/*x*/,it);
...
rb_define_method(cls_Normalize,"word",Normalize_word,0);
 rb_eval_string("testversionnormalize('c706b04ba88bbf5d5936312802c676a8')");}
