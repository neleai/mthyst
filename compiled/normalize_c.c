...
VALUE Normalize_act(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(7);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_Act_dot_crea_e434,1,bind2); bind_aset(bind,3/*autovar*/,it);
...
} } break3: ptr->pos=oldpos9;   it=rb_funcall(self,sy_Normalize__lp_eval_lp_sr_3f78,1,bind2);FAILTEST(alt6_4);
;goto accept8;
...
alt6_7: ptr->pos=oldpos8;if (cut6) goto pass3;goto pass3;
 accept8:;
  it=Amethyst_spaces(self ); FAILTEST(pass3);it=Qnil;if (ptr->pos<ptr->len) goto pass3; break;
                ...
                it=rb_funcall(self,sy_Normalize_CAct_lb_eva_559c,1,bind2); bind_aset(bind,1/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
...
return it;
fail: return failobj; }
VALUE Normalize_apply2(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(20);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
case 1/*Object*/:; goto pass3; break;
                   ...
                   success3: *ptr=oldpass3;
                bind_aset(bind2,1,bind_aget(bind,7/*x*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb_,1,bind2);bind_aset(bind,7/*x*/,bind_aget(bind2,1)); bind_aset(bind,8/*autovar*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass9;
                ...
                bind_aset(bind2,1,bind_aget(bind,13/*name*/));it=rb_funcall(self,sy_Normalize_Apply_lb_bi_4b34,1,bind2);bind_aset(bind,13/*name*/,bind_aget(bind2,1)); bind_aset(bind,8/*autovar*/,it);
...
cstruct oldpass12=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                ...
                it=rb_funcall(self,sy_Normalize_Placehol_a03d,1,bind2); bind_aset(bind,8/*autovar*/,it);
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_free_3d49,1,bind2); bind_aset(bind,8/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Normalize_bind(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(25);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else goto pass3; break;
                   ...
                   success3: *ptr=oldpass3;
                it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); bind_aset(bind,3/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); bind_aset(bind,4/*autovar*/,it);

;goto accept1;
alt1_3: ptr->pos=oldpos1;goto pass1;
 accept1:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 1/*Or*/:; it=rb_funcall(self,sy_Normalize_src_dot_name_80f3,1,bind2); bind_aset(bind,5/*name*/,it);
int oldpos2=ptr->pos;int cut2=0;
...
bind_aset(bind2,1,bind_aget(bind,5/*name*/));bind_aset(bind2,2,bind_aget(bind,8/*it*/));it=rb_funcall(self,sy_Normalize_Bind_lb_bin_8a31,1,bind2);bind_aset(bind,5/*name*/,bind_aget(bind2,1));bind_aset(bind,8/*it*/,bind_aget(bind2,2)); bind_aset(bind,9/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,7/*autovar*/));bind_aset(bind2,2,bind_aget(bind,9/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,7/*autovar*/,bind_aget(bind2,1));bind_aset(bind,9/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos3;   it=bind_aget(bind,7/*autovar*/); bind_aset(bind,10/*ary*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto alt2_2;
                   success4: *ptr=oldpass4;
                bind_aset(bind2,1,bind_aget(bind,10/*ary*/));it=rb_funcall(self,sy_Normalize_Or_dot_creat_49b2,1,bind2);bind_aset(bind,10/*ary*/,bind_aget(bind2,1)); bind_aset(bind,4/*autovar*/,it);

;goto accept2;
alt2_2: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); bind_aset(bind,4/*autovar*/,it);

;goto accept2;
alt2_3: ptr->pos=oldpos2;goto pass1;
 accept2:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 2/*Seq*/:; it=rb_funcall(self,sy_Normalize_src_dot_name_80f3,1,bind2); bind_aset(bind,5/*name*/,it);
...
bind_aset(bind2,1,bind_aget(bind,12/*autovar*/));bind_aset(bind2,2,bind_aget(bind,13/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,12/*autovar*/,bind_aget(bind2,1));bind_aset(bind,13/*autovar*/,bind_aget(bind2,2));int oldpos5;  while(1){oldpos5=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,14/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,12/*autovar*/));bind_aset(bind2,2,bind_aget(bind,14/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,12/*autovar*/,bind_aget(bind2,1));bind_aset(bind,14/*autovar*/,bind_aget(bind2,2)); } break2: ptr->pos=oldpos5;   it=bind_aget(bind,12/*autovar*/); bind_aset(bind,10/*ary*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
                   pass5: *ptr=oldpass5; goto alt3_2;
                   success5: *ptr=oldpass5;
                bind_aset(bind2,1,bind_aget(bind,10/*ary*/));it=rb_funcall(self,sy_Normalize_Seq_lb_bind_c98f,1,bind2);bind_aset(bind,10/*ary*/,bind_aget(bind2,1)); bind_aset(bind,15/*first*/,it);
bind_aset(bind2,1,bind_aget(bind,10/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lb__64e3,1,bind2);bind_aset(bind,10/*ary*/,bind_aget(bind2,1)); bind_aset(bind,16/*last*/,it);
...
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Normalize_8,rb_obj_class(ame_curobj2(ptr))))){case 0/*Comment*/:case 1/*Cut*/:case 2/*Stop*/:; it=ame_curobj2(ptr)               ;ptr->pos++;bind_aset(bind2,1,bind_aget(bind,5/*name*/));bind_aset(bind2,2,bind_aget(bind,15/*first*/));bind_aset(bind2,3,bind_aget(bind,16/*last*/));it=rb_funcall(self,sy_Normalize_Seq_lb_Bind_1036,1,bind2);bind_aset(bind,5/*name*/,bind_aget(bind2,1));bind_aset(bind,15/*first*/,bind_aget(bind2,2));bind_aset(bind,16/*last*/,bind_aget(bind2,3)); bind_aset(bind,18/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass6; break;
case 3/*Object*/:;   it=AmethystCore_anything(self ); FAILTEST(pass6);bind_aset(bind2,1,bind_aget(bind,15/*first*/));bind_aset(bind2,2,bind_aget(bind,5/*name*/));bind_aset(bind2,3,bind_aget(bind,16/*last*/));it=rb_funcall(self,sy_Normalize_Seq_lb_bind_b819,1,bind2);bind_aset(bind,15/*first*/,bind_aget(bind2,1));bind_aset(bind,5/*name*/,bind_aget(bind2,2));bind_aset(bind,16/*last*/,bind_aget(bind2,3)); bind_aset(bind,18/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass6; break;
}
                   goto success6;
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); bind_aset(bind,4/*autovar*/,it);

;goto accept4;
alt3_3: ptr->pos=oldpos4;goto pass1;
 accept4:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 3/*Switch*/:; it=rb_funcall(self,sy_Normalize_src_dot_name_80f3,1,bind2); bind_aset(bind,5/*name*/,it);
...
bind_aset(bind2,1,bind_aget(bind,10/*ary*/));bind_aset(bind2,2,bind_aget(bind,21/*p*/));bind_aset(bind2,3,bind_aget(bind,5/*name*/));bind_aset(bind2,4,bind_aget(bind,22/*a*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lt__f738,1,bind2);bind_aset(bind,10/*ary*/,bind_aget(bind2,1));bind_aset(bind,21/*p*/,bind_aget(bind2,2));bind_aset(bind,5/*name*/,bind_aget(bind2,3));bind_aset(bind,22/*a*/,bind_aget(bind2,4));it=Qnil;if (ptr->pos<ptr->len) goto pass8;
                   goto success8;
                   pass8: *ptr=oldpass8; goto break3;
                   success8: *ptr=oldpass8;
                 } break3: ptr->pos=oldpos7;   bind_aset(bind2,1,bind_aget(bind,10/*ary*/));it=rb_funcall(self,sy_Normalize_src_dot_clas_68f9,1,bind2);bind_aset(bind,10/*ary*/,bind_aget(bind2,1)); bind_aset(bind,23/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
...
;goto accept6;
alt4_2: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt4_3);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); bind_aset(bind,4/*autovar*/,it);

;goto accept6;
alt4_3: ptr->pos=oldpos6;goto pass1;
 accept6:;
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
case 4/*Object*/:; it=rb_funcall(self,sy_Normalize_src_dot_name_80f3,1,bind2);  it=AmethystCore_anything(self ); FAILTEST(pass1);it=rb_funcall(self,sy_Normalize_src_dot_free_00b9,1,bind2); bind_aset(bind,4/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass1; break;
}
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
...
return it;
fail: return failobj; }
VALUE Normalize_cant_fail(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(2);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
  it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*e*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*e*/));it=rb_funcall(self,sy_Normalize__lp_cant_fa_17ef,1,bind2);bind_aset(bind,0/*e*/,bind_aget(bind2,1));FAILTEST(fail);it=bind_aget(bind,0/*e*/); bind_aset(bind,1/*_result*/,it);

return it;
fail: return failobj; }
VALUE Normalize_must_empty(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(2);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
  it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*e*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*e*/));it=rb_funcall(self,sy_Normalize__lp_must_em_43e9,1,bind2);bind_aset(bind,0/*e*/,bind_aget(bind2,1));FAILTEST(fail);it=bind_aget(bind,0/*e*/); bind_aset(bind,1/*_result*/,it);

return it;
fail: return failobj; }
VALUE Normalize_or(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(17);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,1/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); bind_aset(bind,2/*or*/,it);
...
;goto accept2;
alt1_2: ptr->pos=oldpos2; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt1_3);
;goto accept2;
alt1_3: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_4); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));
;goto accept2;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,6/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); bind_aset(bind,7/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,7/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,7/*autovar*/,bind_aget(bind2,2));it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto alt2_2;
                   success4: *ptr=oldpass4;
                
;goto accept3;
alt2_2: ptr->pos=oldpos3; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt2_3);
;goto accept3;
...
alt3_1:; it=rb_funcall(self,sy_Normalize_Placehol_6875,1,bind2); arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(alt3_2);
;goto accept4;
...
} } break2: ptr->pos=oldpos5;   it=Qnil;if (ptr->pos<ptr->len) goto pass5;it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); bind_aset(bind,9/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,9/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,9/*autovar*/,bind_aget(bind2,2));it=Qnil;if (ptr->pos<ptr->len) goto pass5;
                   goto success5;
...
alt5_3: ptr->pos=oldpos7;goto break1;
 ...
 break;
                   ...
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__30f4,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1)); bind_aset(bind,10/*autovar*/,it);
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
bind_aset(bind2,1,bind_aget(bind,14/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*a*/));it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);bind_aset(bind,14/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*a*/,bind_aget(bind2,2));FAILTEST(alt6_2);it=rb_funcall(self,sy_Normalize_Apply_lb__dq_f_3881,1,bind2); bind_aset(bind,15/*autovar*/,it);

;goto accept8;
alt6_2: ptr->pos=oldpos8;it=bind_aget(bind,12/*autovar*/); bind_aset(bind,13/*a*/,it);
it=i_1; bind_aset(bind,14/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,14/*x*/));bind_aset(bind2,2,bind_aget(bind,13/*a*/));it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);bind_aset(bind,14/*x*/,bind_aget(bind2,1));bind_aset(bind,13/*a*/,bind_aget(bind2,2));FAILTEST(alt6_3);bind_aset(bind2,1,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lb__79d7,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1)); bind_aset(bind,15/*autovar*/,it);

;goto accept8;
alt6_3: ptr->pos=oldpos8;it=bind_aget(bind,12/*autovar*/);bind_aset(bind2,1,bind_aget(bind,2/*or*/));bind_aset(bind2,2,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);bind_aset(bind,2/*or*/,bind_aget(bind2,1));bind_aset(bind,0/*ary*/,bind_aget(bind2,2)); bind_aset(bind,15/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE Normalize_seq2(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(16);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,1/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); bind_aset(bind,2/*seq*/,it);
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else goto pass3; break;
                   ...
                   pass3: *ptr=oldpass3; goto pass2;
                   success3: *ptr=oldpass3;
                it=rb_funcall(self,sy_Normalize_src_25d9,1,bind2); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
                   pass2: *ptr=oldpass2; goto alt1_2;
                   success2: *ptr=oldpass2;
                ptr->pos=ptr->len;
...
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,6/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,6/*autovar*/,bind_aget(bind2,2));
;goto accept2;
alt1_4: ptr->pos=oldpos2;goto break1;
 accept2:;
 break;
...
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Normalize_src_dot_ary_d5cf,1,bind2); bind_aset(bind,8/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ary*/));bind_aset(bind2,2,bind_aget(bind,8/*autovar*/));it=rb_funcall(self,sy_Normalize__append_lp__d113,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1));bind_aset(bind,8/*autovar*/,bind_aget(bind2,2));it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   goto success4;
                   pass4: *ptr=oldpass4; goto alt2_2;
                   success4: *ptr=oldpass4;
...
alt3_3: ptr->pos=oldpos4;goto break1;
 ...
 break;
                   ...
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__30f4,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1)); bind_aset(bind,9/*autovar*/,it);
cstruct oldpass5=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
bind_aset(bind2,1,bind_aget(bind,13/*x*/));bind_aset(bind2,2,bind_aget(bind,12/*a*/));it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);bind_aset(bind,13/*x*/,bind_aget(bind2,1));bind_aset(bind,12/*a*/,bind_aget(bind2,2));FAILTEST(alt4_2);it=rb_funcall(self,sy_Normalize_Placehol_a03d,1,bind2); bind_aset(bind,14/*autovar*/,it);

;goto accept5;
alt4_2: ptr->pos=oldpos5;it=bind_aget(bind,11/*autovar*/); bind_aset(bind,12/*a*/,it);
it=i_1; bind_aset(bind,13/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,13/*x*/));bind_aset(bind2,2,bind_aget(bind,12/*a*/));it=rb_funcall(self,sy_Normalize__lp_bind_lb_1_rb__abc3,1,bind2);bind_aset(bind,13/*x*/,bind_aget(bind2,1));bind_aset(bind,12/*a*/,bind_aget(bind2,2));FAILTEST(alt4_3);bind_aset(bind2,1,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__lb__79d7,1,bind2);bind_aset(bind,0/*ary*/,bind_aget(bind2,1)); bind_aset(bind,14/*autovar*/,it);

;goto accept5;
alt4_3: ptr->pos=oldpos5;it=bind_aget(bind,11/*autovar*/);bind_aset(bind2,1,bind_aget(bind,2/*seq*/));bind_aset(bind2,2,bind_aget(bind,0/*ary*/));it=rb_funcall(self,sy_Normalize_bind_lb_1_rb__dot__f29b,1,bind2);bind_aset(bind,2/*seq*/,bind_aget(bind2,1));bind_aset(bind,0/*ary*/,bind_aget(bind2,2)); bind_aset(bind,14/*autovar*/,it);
...
rb_define_method(cls_Normalize,"seq2",Normalize_seq2,0);
                    rb_eval_string("testversionnormalize('ac9f7b550622c0cac61cc05196b46a8e')");}
