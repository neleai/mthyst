...
class Lattice_Minsize < FirstLattice
  def size; ary[0];	end
  def self.[](a)
		FirstLattice[Lattice_Minsize,a]
  end
  alias_method :==,:equal?
...
class Lattice_Maxsize < FirstLattice
  def size; ary[0];	end
  def self.[](a)
		a=1.0/0.0 if a>16
		FirstLattice[Lattice_Maxsize,a]
  end
  alias_method :==,:equal?
...
class Lattice_Must_Empty < FirstLattice
	def value; ary[0];	end
  def self.[](value)
		FirstLattice[Lattice_Must_Empty,value]
  end
...
class Lattice_Cant_Fail < FirstLattice
	def value; ary[0];	end
  def self.[](value)
		FirstLattice[Lattice_Cant_Fail,value]
  end
...
'd128501662160b0941c0dc44938b7926'
end
