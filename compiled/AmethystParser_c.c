...
VALUE AmethystParser_cases(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_e=Qnil,_s=Qnil,_s_2=Qnil,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,__result=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,__result_2=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_it=Qnil,_num=Qnil,_clas=Qnil;
    VALUE bind2=bind_new2(2);
    VALUE arg0;
    cstruct *ptr;
    Data_Get_Struct(self,cstruct,ptr);
...
alt1_1:
                ...
                _autovar_2=it;;
                it=AmethystCore_append(self,_e,_autovar_2);
                switch((unsigned char)*ame_curstr2(ptr)) {
                case UC(0) ... '=':
                    ;
                case '?' ... UC(255):
...
accept1:
            ...
            case UC(92) ... UC(92):
                ...
                it=rb_obj_clone(s__bs__bs__7f81);
                _autovar_3=it;;
                it=AmethystCore_append(self,_s,_autovar_3);
                it=AmethystCore_anything(self );
                if (it==failobj) {
                    it=failobj;
                    goto fail;
        ...
        it=rb_funcall(self,sy_AmethystParser_Or_lb_Apply_cdcd,1,bind2);
...
accept8:
        ...
        it=AmethystCore_append(self,_autovar_4,_autovar_7);
        it=_autovar_4;
        _it=it;;
...
VALUE AmethystParser_inline_host_expr(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_r=Qnil,__result=Qnil,_r_2=Qnil,__result_2=Qnil,_neg=Qnil,_expr=Qnil;
    VALUE bind2=bind_new2(2);
    cstruct *ptr;
    Data_Get_Struct(self,cstruct,ptr);
    switch((unsigned char)*ame_curstr2(ptr)) {
...
VALUE AmethystParser_postfixed(VALUE self ) {
    VALUE vals[0];
    VALUE it ,_from=Qnil,_one=Qnil,_concat=Qnil,_autovar=Qnil,_autovar_2=Qnil,_name=Qnil,_e=Qnil,__result=Qnil;
    VALUE bind2=bind_new2(3);
    cstruct *ptr;
    Data_Get_Struct(self,cstruct,ptr);
...
accept8:
                ...
                _name=bind_aget(bind2,1);;
                bind_aset(bind2,1,_name);
                bind_aset(bind2,2,_concat);
                bind_aset(bind2,3,_from);
                it=rb_funcall(self,sy_AmethystParser__at_appends_6209,1,bind2);
                _name=bind_aget(bind2,1);;
                _concat=bind_aget(bind2,2);;
...
VALUE AmethystParser_prefixed(VALUE self ) {
    VALUE vals[0];
    VALUE it ,__result=Qnil,_neg=Qnil,_m=Qnil;
    VALUE bind2=bind_new2(2);
    cstruct *ptr;
    Data_Get_Struct(self,cstruct,ptr);
    switch((unsigned char)*ame_curstr2(ptr)) {
...
void Init_AmethystParser_c() {
    ...
    c_Append_AST=rb_const_get(rb_cObject, rb_intern("Append_AST"));
    rb_global_variable(&c_Append_AST);
    c_Concat_AST=rb_const_get(rb_cObject, rb_intern("Concat_AST"));
    rb_global_variable(&c_Concat_AST);
