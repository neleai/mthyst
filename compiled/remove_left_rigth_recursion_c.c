...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass1);int oldpos2; int stop1=0; while(1){oldpos2=ptr->pos; int oldpos3=ptr->pos;int cut2=0;
...
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 if (stop1) goto accept2; } break1: goto pass1; accept2:;   it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case 1/*Bind*/:; int oldpos4=ptr->pos;int cut3=0;
alt3_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var4/*autovar*/=it;;
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_3); var3/*x*/=it;;
bind_aset(bind2,1,var1/*follow*/);bind_aset(bind2,2,var3/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var1/*follow*/=bind_aget(bind2,1);;var3/*x*/=bind_aget(bind2,2);; var2/*_result*/=it;;
...
alt3_3: ptr->pos=oldpos4;goto fail;
 accept4:;
 break;
case 2/*Or*/:; int oldpos5=ptr->pos;int cut4=0;
...
int oldpos6; int stop2=0; while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;int cut5=0;
alt5_1:; it=var1/*follow*/; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(alt5_2); var11/*autovar*/=it;;
...
alt5_3: ptr->pos=oldpos7;goto break2;
 accept7:;
 if (stop2) goto accept6; } break2: goto pass4; accept6:;   it=var10/*autovar*/; var12/*ary*/=it;;
...
;goto accept5;
alt4_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt4_3); var3/*x*/=it;;
bind_aset(bind2,1,var1/*follow*/);bind_aset(bind2,2,var3/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var1/*follow*/=bind_aget(bind2,1);;var3/*x*/=bind_aget(bind2,2);; var2/*_result*/=it;;
...
int oldpos10; int stop3=0; while(1){oldpos10=ptr->pos; int oldpos11=ptr->pos;int cut8=0;
alt8_1:;  it=AmethystCore_anything(self ); FAILTEST(alt8_2); var18/*autovar*/=it;;
...
alt8_3: ptr->pos=oldpos11;goto break3;
 accept11:;
 if (stop3) goto accept10; } break3: goto pass5; accept10:;   it=var17/*autovar*/; var19/*rest*/=it;;
...
;goto accept9;
alt7_2: ptr->pos=oldpos9;it=var14/*autovar*/; var22/*autovar*/=it;;
...
int oldpos12; int stop4=0; while(1){oldpos12=ptr->pos; int oldpos13=ptr->pos;int cut9=0;
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2); var24/*autovar*/=it;;
...
;goto accept13;
alt9_2: ptr->pos=oldpos13;stop4=1;
;goto accept13;
alt9_3: ptr->pos=oldpos13;goto break4;
 accept13:;
 if (stop4) goto accept12; } break4: goto pass7; accept12:;   it=var23/*autovar*/; var19/*rest*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
                   pass7: *ptr=oldpass7; goto alt7_3;
                   success7: *ptr=oldpass7;
                bind_aset(bind2,1,var16/*first*/);bind_aset(bind2,2,var19/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_f95b,1,bind2);var16/*first*/=bind_aget(bind2,1);;var19/*rest*/=bind_aget(bind2,2);; var2/*_result*/=it;;

;goto accept9;
alt7_3: ptr->pos=oldpos9;goto alt6_2;
 accept9:;

;goto accept8;
alt6_2: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var3/*x*/=it;;
bind_aset(bind2,1,var1/*follow*/);bind_aset(bind2,2,var3/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var1/*follow*/=bind_aget(bind2,1);;var3/*x*/=bind_aget(bind2,2);; var2/*_result*/=it;;

;goto accept8;
alt6_3: ptr->pos=oldpos8;goto fail;
 accept8:;
 break;
...
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass3);int oldpos2; int stop1=0; while(1){oldpos2=ptr->pos; int oldpos3=ptr->pos;int cut2=0;
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);
;goto accept3;
alt2_2: ptr->pos=oldpos3;stop1=1;
;goto accept3;
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 if (stop1) goto accept2; } break1: goto pass3; accept2:;   it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                   goto success3;
...
;goto accept4;
alt3_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_3); var5/*x*/=it;;
it=Qfalse; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept4;
alt3_3: ptr->pos=oldpos4;goto pass2;
 accept4:;
it=var4/*_result*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
case 2/*Or*/:; int oldpos5=ptr->pos;int cut4=0;
alt4_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var12/*autovar*/=it;;
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos6; int stop2=0; while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;int cut5=0;
alt5_1:; it=Qfalse; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(alt5_2); var14/*autovar*/=it;;
...
alt5_3: ptr->pos=oldpos7;goto break2;
 accept7:;
 if (stop2) goto accept6; } break2: goto pass6; accept6:;   it=var13/*autovar*/; var15/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
...
;goto accept5;
alt4_2: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt4_3); var5/*x*/=it;;
it=Qfalse; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
case 3/*Seq*/:; int oldpos8=ptr->pos;int cut6=0;
alt6_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var16/*autovar*/=it;;
it=var16/*autovar*/; var17/*autovar*/=it;;
it=var17/*autovar*/; var18/*autovar*/=it;;
int oldpos9=ptr->pos;int cut7=0;
alt7_1:;it=var18/*autovar*/; var19/*autovar*/=it;;
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos10; int stop3=0; while(1){oldpos10=ptr->pos; int oldpos11=ptr->pos;int cut8=0;
alt8_1:;  it=AmethystCore_anything(self ); FAILTEST(alt8_2); var22/*autovar*/=it;;
...
alt8_3: ptr->pos=oldpos11;goto break3;
 accept11:;
 if (stop3) goto accept10; } break3: goto pass7; accept10:;   it=var21/*autovar*/; var23/*rest*/=it;;
...
;goto accept9;
alt7_2: ptr->pos=oldpos9;it=var18/*autovar*/; var26/*autovar*/=it;;
...
int oldpos12; int stop4=0; while(1){oldpos12=ptr->pos; int oldpos13=ptr->pos;int cut9=0;
alt9_1:;  it=AmethystCore_anything(self ); FAILTEST(alt9_2); var28/*autovar*/=it;;
...
alt9_3: ptr->pos=oldpos13;goto break4;
 accept13:;
 if (stop4) goto accept12; } break4: goto pass9; accept12:;   it=var27/*autovar*/; var23/*rest*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass9;
                   goto success9;
                   pass9: *ptr=oldpass9; goto alt7_3;
...
;goto accept8;
alt6_2: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var5/*x*/=it;;
it=Qfalse; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept8;
alt6_3: ptr->pos=oldpos8;goto pass2;
 accept8:;
it=var4/*_result*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
...
cstruct oldpass10=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Remove_Left_Recursion_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos14=ptr->pos;int cut10=0;
alt10_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var2/*autovar*/=it;;
cstruct oldpass11=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var2/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass11);int oldpos15; int stop5=0; while(1){oldpos15=ptr->pos; int oldpos16=ptr->pos;int cut11=0;
alt11_1:;  it=AmethystCore_anything(self ); FAILTEST(alt11_2);
;goto accept16;
alt11_2: ptr->pos=oldpos16;stop5=1;
;goto accept16;
alt11_3: ptr->pos=oldpos16;goto break5;
 accept16:;
 if (stop5) goto accept15; } break5: goto pass11; accept15:;   it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass11;
                   goto success11;
                   pass11: *ptr=oldpass11; goto alt10_2;
                   success11: *ptr=oldpass11;
                it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__4ee5,1,bind2);var3/*follow*/=bind_aget(bind2,1);; var4/*_result*/=it;;

;goto accept14;
alt10_2: ptr->pos=oldpos14;  it=AmethystCore_anything(self ); FAILTEST(alt10_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept14;
alt10_3: ptr->pos=oldpos14;goto pass10;
 accept14:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
case 1/*Bind*/:; int oldpos17=ptr->pos;int cut12=0;
alt12_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var7/*autovar*/=it;;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass12;
                   goto success12;
                   pass12: *ptr=oldpass12; goto alt12_2;
                   success12: *ptr=oldpass12;
                it=var11/*autovar*/; var4/*_result*/=it;;

;goto accept17;
alt12_2: ptr->pos=oldpos17;  it=AmethystCore_anything(self ); FAILTEST(alt12_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept17;
alt12_3: ptr->pos=oldpos17;goto pass10;
 accept17:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
case 2/*Or*/:; int oldpos18=ptr->pos;int cut13=0;
alt13_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var12/*autovar*/=it;;
cstruct oldpass14=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var12/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_ary_new3(0); var13/*autovar*/=it;;
int oldpos19; int stop6=0; while(1){oldpos19=ptr->pos; int oldpos20=ptr->pos;int cut14=0;
alt14_1:; it=Qtrue; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(alt14_2); var14/*autovar*/=it;;
bind_aset(bind2,1,var13/*autovar*/);bind_aset(bind2,2,var14/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var13/*autovar*/=bind_aget(bind2,1);;var14/*autovar*/=bind_aget(bind2,2);;
;goto accept20;
alt14_2: ptr->pos=oldpos20;stop6=1;
;goto accept20;
alt14_3: ptr->pos=oldpos20;goto break6;
 accept20:;
 if (stop6) goto accept19; } break6: goto pass14; accept19:;   it=var13/*autovar*/; var15/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass14;
                   goto success14;
                   pass14: *ptr=oldpass14; goto alt13_2;
                   success14: *ptr=oldpass14;
                bind_aset(bind2,1,var15/*ary*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Or_lb_bind_lb__3169,1,bind2);var15/*ary*/=bind_aget(bind2,1);; var4/*_result*/=it;;

;goto accept18;
alt13_2: ptr->pos=oldpos18;  it=AmethystCore_anything(self ); FAILTEST(alt13_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept18;
alt13_3: ptr->pos=oldpos18;goto pass10;
 accept18:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
case 3/*Seq*/:; int oldpos21=ptr->pos;int cut15=0;
alt15_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var16/*autovar*/=it;;
it=var16/*autovar*/; var32/*autovar*/=it;;
it=var32/*autovar*/; var33/*autovar*/=it;;
int oldpos22=ptr->pos;int cut16=0;
alt16_1:;it=var33/*autovar*/; var19/*autovar*/=it;;
...
it=rb_ary_new3(0); var21/*autovar*/=it;;
int oldpos23; int stop7=0; while(1){oldpos23=ptr->pos; int oldpos24=ptr->pos;int cut17=0;
alt17_1:;  it=AmethystCore_anything(self ); FAILTEST(alt17_2); var22/*autovar*/=it;;
bind_aset(bind2,1,var21/*autovar*/);bind_aset(bind2,2,var22/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var21/*autovar*/=bind_aget(bind2,1);;var22/*autovar*/=bind_aget(bind2,2);;
;goto accept24;
alt17_2: ptr->pos=oldpos24;stop7=1;
;goto accept24;
alt17_3: ptr->pos=oldpos24;goto break7;
 accept24:;
 if (stop7) goto accept23; } break7: goto pass15; accept23:;   it=var21/*autovar*/; var23/*rest*/=it;;
bind_aset(bind2,1,var23/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_e0fb,1,bind2);var23/*rest*/=bind_aget(bind2,1);; var24/*autovar*/=it;;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass15;
                   goto success15;
                   pass15: *ptr=oldpass15; goto alt16_2;
                   success15: *ptr=oldpass15;
                bind_aset(bind2,1,var20/*first*/);bind_aset(bind2,2,var23/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_f95b,1,bind2);var20/*first*/=bind_aget(bind2,1);;var23/*rest*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept22;
alt16_2: ptr->pos=oldpos22;it=var33/*autovar*/; var26/*autovar*/=it;;
...
it=rb_ary_new3(0); var27/*autovar*/=it;;
int oldpos25; int stop8=0; while(1){oldpos25=ptr->pos; int oldpos26=ptr->pos;int cut18=0;
alt18_1:;  it=AmethystCore_anything(self ); FAILTEST(alt18_2); var28/*autovar*/=it;;
bind_aset(bind2,1,var27/*autovar*/);bind_aset(bind2,2,var28/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var27/*autovar*/=bind_aget(bind2,1);;var28/*autovar*/=bind_aget(bind2,2);;
;goto accept26;
alt18_2: ptr->pos=oldpos26;stop8=1;
;goto accept26;
alt18_3: ptr->pos=oldpos26;goto break8;
 accept26:;
 if (stop8) goto accept25; } break8: goto pass17; accept25:;   it=var27/*autovar*/; var23/*rest*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass17;
                   goto success17;
                   pass17: *ptr=oldpass17; goto alt16_3;
                   success17: *ptr=oldpass17;
                bind_aset(bind2,1,var20/*first*/);bind_aset(bind2,2,var23/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_f95b,1,bind2);var20/*first*/=bind_aget(bind2,1);;var23/*rest*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept22;
alt16_3: ptr->pos=oldpos22;goto alt15_2;
 accept22:;

;goto accept21;
alt15_2: ptr->pos=oldpos21;  it=AmethystCore_anything(self ); FAILTEST(alt15_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept21;
alt15_3: ptr->pos=oldpos21;goto pass10;
 accept21:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
...
rb_define_method(cls_Remove_Left_Recursion,"root",Remove_Left_Recursion_root,0);
                    rb_eval_string("testversionremove_left_rigth_recursion('c2a6fb6225cee35a7799c26db63216b8')");}
