...
int oldpos4;  while(1){oldpos4=ptr->pos;  it=var1/*follow*/; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(break1); var11/*autovar*/=it;;
bind_aset(bind2,1,var10/*autovar*/);bind_aset(bind2,2,var11/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var10/*autovar*/=bind_aget(bind2,1);;var11/*autovar*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos4;   it=var10/*autovar*/; var12/*ary*/=it;;
...
alt4_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var13/*autovar*/=it;;
it=var13/*autovar*/; var14/*autovar*/=it;;
int oldpos6=ptr->pos;int cut5=0;
alt5_1:;it=var14/*autovar*/; var15/*autovar*/=it;;
...
int oldpos7;  while(1){oldpos7=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break2); var18/*autovar*/=it;;
bind_aset(bind2,1,var17/*autovar*/);bind_aset(bind2,2,var18/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var17/*autovar*/=bind_aget(bind2,1);;var18/*autovar*/=bind_aget(bind2,2);; } break2: ptr->pos=oldpos7;   it=var17/*autovar*/; var19/*rest*/=it;;
...
;goto accept6;
alt5_2: ptr->pos=oldpos6;it=var14/*autovar*/; var22/*autovar*/=it;;
...
int oldpos8;  while(1){oldpos8=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break3); var24/*autovar*/=it;;
bind_aset(bind2,1,var23/*autovar*/);bind_aset(bind2,2,var24/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var23/*autovar*/=bind_aget(bind2,1);;var24/*autovar*/=bind_aget(bind2,2);; } break3: ptr->pos=oldpos8;   it=var23/*autovar*/; var19/*rest*/=it;;
...
int oldpos4;  while(1){oldpos4=ptr->pos;  it=Qfalse; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(break1); var14/*autovar*/=it;;
bind_aset(bind2,1,var13/*autovar*/);bind_aset(bind2,2,var14/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var13/*autovar*/=bind_aget(bind2,1);;var14/*autovar*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos4;   it=var13/*autovar*/; var15/*ary*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                   goto success6;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
case 3/*Seq*/:; int oldpos5=ptr->pos;int cut4=0;
alt4_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var16/*autovar*/=it;;
it=var16/*autovar*/; var17/*autovar*/=it;;
it=var17/*autovar*/; var18/*autovar*/=it;;
int oldpos6=ptr->pos;int cut5=0;
alt5_1:;it=var18/*autovar*/; var19/*autovar*/=it;;
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos7;  while(1){oldpos7=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break2); var22/*autovar*/=it;;
bind_aset(bind2,1,var21/*autovar*/);bind_aset(bind2,2,var22/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var21/*autovar*/=bind_aget(bind2,1);;var22/*autovar*/=bind_aget(bind2,2);; } break2: ptr->pos=oldpos7;   it=var21/*autovar*/; var23/*rest*/=it;;
...
;goto accept6;
alt5_2: ptr->pos=oldpos6;it=var18/*autovar*/; var26/*autovar*/=it;;
...
int oldpos8;  while(1){oldpos8=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break3); var28/*autovar*/=it;;
bind_aset(bind2,1,var27/*autovar*/);bind_aset(bind2,2,var28/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var27/*autovar*/=bind_aget(bind2,1);;var28/*autovar*/=bind_aget(bind2,2);; } break3: ptr->pos=oldpos8;   it=var27/*autovar*/; var23/*rest*/=it;;
...
alt6_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var2/*autovar*/=it;;
...
;goto accept9;
alt6_2: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;
...
;goto accept10;
alt7_2: ptr->pos=oldpos10;  it=AmethystCore_anything(self ); FAILTEST(alt7_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;
...
alt8_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var12/*autovar*/=it;;
cstruct oldpass14=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var12/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_ary_new3(0); var13/*autovar*/=it;;
int oldpos12;  while(1){oldpos12=ptr->pos;  it=Qtrue; arg0=it; it=Remove_Left_Recursion_first(self ,arg0); FAILTEST(break4); var14/*autovar*/=it;;
bind_aset(bind2,1,var13/*autovar*/);bind_aset(bind2,2,var14/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var13/*autovar*/=bind_aget(bind2,1);;var14/*autovar*/=bind_aget(bind2,2);; } break4: ptr->pos=oldpos12;   it=var13/*autovar*/; var15/*ary*/=it;;
...
;goto accept11;
alt8_2: ptr->pos=oldpos11;  it=AmethystCore_anything(self ); FAILTEST(alt8_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;
...
it=rb_ary_new3(0); var21/*autovar*/=it;;
int oldpos15;  while(1){oldpos15=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break5); var22/*autovar*/=it;;
bind_aset(bind2,1,var21/*autovar*/);bind_aset(bind2,2,var22/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var21/*autovar*/=bind_aget(bind2,1);;var22/*autovar*/=bind_aget(bind2,2);; } break5: ptr->pos=oldpos15;   it=var21/*autovar*/; var23/*rest*/=it;;
bind_aset(bind2,1,var23/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_e0fb,1,bind2);var23/*rest*/=bind_aget(bind2,1);; var24/*autovar*/=it;;
...
;goto accept14;
alt10_2: ptr->pos=oldpos14;it=var33/*autovar*/; var26/*autovar*/=it;;
...
it=rb_ary_new3(0); var27/*autovar*/=it;;
int oldpos16;  while(1){oldpos16=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break6); var28/*autovar*/=it;;
bind_aset(bind2,1,var27/*autovar*/);bind_aset(bind2,2,var28/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var27/*autovar*/=bind_aget(bind2,1);;var28/*autovar*/=bind_aget(bind2,2);; } break6: ptr->pos=oldpos16;   it=var27/*autovar*/; var23/*rest*/=it;;
...
;goto accept13;
alt9_2: ptr->pos=oldpos13;  it=AmethystCore_anything(self ); FAILTEST(alt9_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;
...
rb_define_method(cls_Remove_Left_Recursion,"root",Remove_Left_Recursion_root,0);
                    rb_eval_string("testversionremove_left_rigth_recursion('a6c4ae98a9b5c771576c949002beb05e')");}
