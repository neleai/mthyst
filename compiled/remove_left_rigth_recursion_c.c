...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass1);int stop1=0; while(!stop1){ int oldpos2=ptr->pos;int cut2=0;
...
alt2_3: ptr->pos=oldpos2;goto pass1;
 accept2:;
 } it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case 1/*Bind*/:; int oldpos3=ptr->pos;int cut3=0;
...
alt3_3: ptr->pos=oldpos3;goto fail;
 accept3:;
 break;
case 2/*Or*/:; int oldpos4=ptr->pos;int cut4=0;
...
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto pass4;
 accept5:;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt4_3); var3/*x*/=it;;
bind_aset(bind2,1,var1/*follow*/);bind_aset(bind2,2,var3/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var1/*follow*/=bind_aget(bind2,1);;var3/*x*/=bind_aget(bind2,2);; var2/*_result*/=it;;
...
alt4_3: ptr->pos=oldpos4;goto fail;
 accept4:;
 break;
case 3/*Seq*/:; int oldpos6=ptr->pos;int cut6=0;
...
;goto accept7;
alt7_2: ptr->pos=oldpos7;it=var14/*autovar*/; var22/*autovar*/=it;;
...
;goto accept6;
alt6_2: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var3/*x*/=it;;
bind_aset(bind2,1,var1/*follow*/);bind_aset(bind2,2,var3/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var1/*follow*/=bind_aget(bind2,1);;var3/*x*/=bind_aget(bind2,2);; var2/*_result*/=it;;
...
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass3);int stop1=0; while(!stop1){ int oldpos2=ptr->pos;int cut2=0;
alt2_1:;  it=AmethystCore_anything(self ); FAILTEST(alt2_2);
;goto accept2;
alt2_2: ptr->pos=oldpos2;stop1=1;
;goto accept2;
alt2_3: ptr->pos=oldpos2;goto pass3;
 accept2:;
 } it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                   goto success3;
...
alt5_2: ptr->pos=oldpos5;stop2=1;
;goto accept5;
alt5_3: ptr->pos=oldpos5;goto pass6;
 accept5:;
...
;goto accept4;
alt4_2: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt4_3); var5/*x*/=it;;
it=Qfalse; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept4;
alt4_3: ptr->pos=oldpos4;goto pass2;
 accept4:;
it=var4/*_result*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
case 3/*Seq*/:; int oldpos6=ptr->pos;int cut6=0;
...
;goto accept7;
alt7_2: ptr->pos=oldpos7;it=var18/*autovar*/; var26/*autovar*/=it;;
...
alt9_2: ptr->pos=oldpos9;stop4=1;
;goto accept9;
alt9_3: ptr->pos=oldpos9;goto pass9;
 accept9:;
...
;goto accept6;
alt6_2: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt6_3); var5/*x*/=it;;
it=Qfalse; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept6;
alt6_3: ptr->pos=oldpos6;goto pass2;
 accept6:;
it=var4/*_result*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2; break;
...
cstruct oldpass10=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_Remove_Left_Recursion_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos10=ptr->pos;int cut10=0;
alt10_1:;it=ame_curobj2(ptr)               ;ptr->pos++; var2/*autovar*/=it;;
cstruct oldpass11=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var2/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_Remove_Left_Recursion__lp__at_name_eq__eq__2784,1,bind2);FAILTEST(pass11);int stop5=0; while(!stop5){ int oldpos11=ptr->pos;int cut11=0;
alt11_1:;  it=AmethystCore_anything(self ); FAILTEST(alt11_2);
;goto accept11;
alt11_2: ptr->pos=oldpos11;stop5=1;
;goto accept11;
alt11_3: ptr->pos=oldpos11;goto pass11;
 accept11:;
 } it=rb_funcall(self,sy_Remove_Left_Recursion__at_left_re_c85d,1,bind2);it=Qnil;if (ptr->pos<ptr->len) goto pass11;
                   goto success11;
...
case 1/*Bind*/:; int oldpos12=ptr->pos;int cut12=0;
...
;goto accept12;
alt12_2: ptr->pos=oldpos12;  it=AmethystCore_anything(self ); FAILTEST(alt12_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept12;
alt12_3: ptr->pos=oldpos12;goto pass10;
 accept12:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
case 2/*Or*/:; int oldpos13=ptr->pos;int cut13=0;
...
;goto accept14;
alt14_3: ptr->pos=oldpos14;goto pass14;
 accept14:;
 } it=var13/*autovar*/; var15/*ary*/=it;;
...
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
case 3/*Seq*/:; int oldpos15=ptr->pos;int cut15=0;
...
it=rb_ary_new3(0); var21/*autovar*/=it;;
int stop7=0; while(!stop7){ int oldpos17=ptr->pos;int cut17=0;
alt17_1:;  it=AmethystCore_anything(self ); FAILTEST(alt17_2); var22/*autovar*/=it;;
bind_aset(bind2,1,var21/*autovar*/);bind_aset(bind2,2,var22/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var21/*autovar*/=bind_aget(bind2,1);;var22/*autovar*/=bind_aget(bind2,2);;
;goto accept17;
alt17_2: ptr->pos=oldpos17;stop7=1;
;goto accept17;
alt17_3: ptr->pos=oldpos17;goto pass15;
 accept17:;
 } it=var21/*autovar*/; var23/*rest*/=it;;
bind_aset(bind2,1,var23/*rest*/);it=rb_funcall(self,sy_Remove_Left_Recursion_Seq_lb_bind_e0fb,1,bind2);var23/*rest*/=bind_aget(bind2,1);; var24/*autovar*/=it;;
...
;goto accept16;
alt16_2: ptr->pos=oldpos16;it=var33/*autovar*/; var26/*autovar*/=it;;
...
it=rb_ary_new3(0); var27/*autovar*/=it;;
int stop8=0; while(!stop8){ int oldpos18=ptr->pos;int cut18=0;
alt18_1:;  it=AmethystCore_anything(self ); FAILTEST(alt18_2); var28/*autovar*/=it;;
bind_aset(bind2,1,var27/*autovar*/);bind_aset(bind2,2,var28/*autovar*/);it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__d113,1,bind2);var27/*autovar*/=bind_aget(bind2,1);;var28/*autovar*/=bind_aget(bind2,2);;
;goto accept18;
alt18_2: ptr->pos=oldpos18;stop8=1;
;goto accept18;
alt18_3: ptr->pos=oldpos18;goto pass17;
 accept18:;
 } it=var27/*autovar*/; var23/*rest*/=it;;
...
;goto accept16;
alt16_3: ptr->pos=oldpos16;goto alt15_2;
 accept16:;

;goto accept15;
alt15_2: ptr->pos=oldpos15;  it=AmethystCore_anything(self ); FAILTEST(alt15_3); var5/*x*/=it;;
it=Qtrue; var3/*follow*/=it;;
bind_aset(bind2,1,var3/*follow*/);bind_aset(bind2,2,var5/*x*/);it=rb_funcall(self,sy_Remove_Left_Recursion_bind_lb_1_rb__sp__c213,1,bind2);var3/*follow*/=bind_aget(bind2,1);;var5/*x*/=bind_aget(bind2,2);; var4/*_result*/=it;;

;goto accept15;
alt15_3: ptr->pos=oldpos15;goto pass10;
 accept15:;
it=var4/*_result*/; var31/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass10; break;
...
rb_define_method(cls_Remove_Left_Recursion,"root",Remove_Left_Recursion_root,0);
                    rb_eval_string("testversionremove_left_rigth_recursion('c45d910c72e1f9b377feeb410723c6b6')");}
