...
it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__b375,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ptr->pos;goto break1;} } } break1: ame_setstop(self,Qnil); ptr->pos=oldpos1; it=bind_aget(bind,8/*autovar*/); bind_aset(bind,10/*init*/,it);
...
it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__05b0,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ptr->pos;goto break3;} } } break3: ame_setstop(self,Qnil); ptr->pos=oldpos4; it=bind_aget(bind,25/*autovar*/); bind_aset(bind,27/*rest*/,it);
...
} if (ame_getstop(self)!=Qnil){{oldpos2=ptr->pos;goto break2;} } } break2: ame_setstop(self,Qnil); ptr->pos=oldpos2; it=Qnil;if (ptr->pos<ptr->len) goto pass4;
	goto success4;
	pass4: fail4=1;
...
it=rb_funcall(self,sy_Remove_Left_Recursion__append_lp__769c,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ptr->pos;goto break4;} } } break4: ame_setstop(self,Qnil); ptr->pos=oldpos5; it=bind_aget(bind,30/*autovar*/); bind_aset(bind,32/*finish*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass3;
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
rb_define_method(cls_Remove_Left_Recursion,"start",Remove_Left_Recursion_start,0);
 rb_eval_string("testversionremove_left_rigth_recursion('944a3086cc329851d5fb8f9b00ad9f24')");}
