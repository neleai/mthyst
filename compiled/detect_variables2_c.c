...
return it;
fail: return failobj; }
VALUE Remap_Acts_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(29);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,20,it); int oldpos10; while(1){oldpos10=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break4);
 rb_ary_store(bind,21,it); it=CALL(visit_Remap_Actscb_10,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,20);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_11,1,bind); 
 rb_ary_store(bind,22,it);   it=Remap_Acts_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
it=rb_ary_entry(bind,22);
 ...
 rb_ary_store(bind,23,it); int oldpos11=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,24,it); int oldpos12; while(1){oldpos12=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break5);
 rb_ary_store(bind,25,it); it=CALL(visit_Remap_Actscb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos12); it=rb_ary_entry(bind,24);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_13,1,bind); 
 rb_ary_store(bind,26,it);   it=Remap_Acts_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
it=rb_ary_entry(bind,26);
 ...
 rb_ary_store(bind,27,it); int oldpos13=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,27)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos14; while(1){oldpos14=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break6); if (IGET(stop)!=Qnil){{oldpos14=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos14); it=CALL(visit_Remap_Actscb_14,1,bind); 
 rb_ary_store(bind,28,it);   it=Remap_Acts_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos13); ame_setlen(self,oldlen8);
	if(fail8) goto fail;
it=rb_ary_entry(bind,28);
 rb_ary_store(bind,5,it);  break;case 7:; int oldpos15=ame_getpos(self);
  alt1_1:  ame_setpos(self,oldpos15); goto fail;
 accept1:;
...
rb_define_method(cls_Remap_Acts,"visit",Remap_Acts_visit,0);
 rb_eval_string("testversiondetect_variables2('a49a31b43b34950e9dca9dafb9ab3870')");}
