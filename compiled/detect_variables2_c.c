...
ame_setsrc(self,rb_ary_entry(bind,16/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Analyze_Variables2_traverse(self ); FAILTEST(pass7);
 rb_ary_store(bind,17/*autovar*/,it); int oldpos10=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos11; while(1){oldpos11=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos11=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos11); it=CALL(visit_Analyze_Variables2cb_8,1,bind); 
 rb_ary_store(bind,18/*autovar*/,it); it=CALL(visit_Analyze_Variables2cb_9,1,bind); int oldpos12=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,rb_ary_entry(bind,18/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,19/*autovar*/,it); int oldpos13=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,19/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=rb_const_get(rb_cObject, rb_intern("Local")); arg0=it; it=Analyze_Variables2_clas(self ,arg0); FAILTEST(pass10);
 rb_ary_store(bind,20/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
it=rb_ary_entry(bind,21/*autovar*/);
 rb_ary_store(bind,22/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos10); ame_setlen(self,oldlen8);
	if(fail8) goto pass7;
it=rb_ary_entry(bind,22/*autovar*/);
 rb_ary_store(bind,23/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,24/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3/*t*/,it); it=CALL(visit_Analyze_Variables2cb_11,1,bind); 
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('d939195beb345855e4f36a715e0d09de')");}
