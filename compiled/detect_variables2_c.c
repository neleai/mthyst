...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_ary_new3(0);
 bind_aset(bind,4/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=c_32; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(break2);
...
ame_setsrc(self,bind_aget(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
  it=c_33; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass1);
...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 int oldpos4; while(1){oldpos4=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=rb_funcall(self,s_root_Analyze_Variables2cb_5Analyze_Variables2,1,bind); it=rb_funcall(self,s_itrans_Analyze_Variables2cb_5Analyze_Variables2,1,bind); 
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Analyze_Variables2cb_1Analyze_Variables2,1,bind); 
 bind_aset(bind,0/*oldchanged*/,it); it=rb_funcall(self,s_itrans_Analyze_Variables2cb_5Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,s_itrans_Analyze_Variables2cb_2Analyze_Variables2,1,bind); int oldpos4=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
  it=c_34; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass4);
...
ame_setsrc(self,bind_aget(bind,10/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 int oldpos8; while(1){oldpos8=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=rb_funcall(self,s_visit_Analyze_Variables2cb_2Analyze_Variables2,1,bind); 
 bind_aset(bind,11/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_3Analyze_Variables2,1,bind); int oldpos9=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
...
it=rb_funcall(self,s_visit_Analyze_Variables2cb_4Analyze_Variables2,1,bind); 
 bind_aset(bind,14/*ary*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_5Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,19/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_6Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos12=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos12); it=bind_aget(bind,18/*autovar*/);
 bind_aset(bind,20/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_7Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,24/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,26/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_9Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos15); it=bind_aget(bind,25/*autovar*/);
 bind_aset(bind,20/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_10Analyze_Variables2,1,bind); 
...
c_32=rb_const_get(rb_cObject, rb_intern("Rule"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_32);
c_33=rb_const_get(rb_cObject, rb_intern("Rule"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_33);
c_34=rb_const_get(rb_cObject, rb_intern("Local"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_34);
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('71fd4ead80a7b95fa3f8043e5d535185')");}
