...
cstruct oldpass13=*ptr; int fail13=0;
          ptr->src=bind_aget(bind,37/*autovar*/); ptr->pos=0; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else ptr->len=FIX2LONG(rb_funcall(ptr->src,sy_size,0)); ptr->ary=NULL;
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('19da685f0601a91907a1e6bf1778a1eb')");}
