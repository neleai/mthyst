...
ame_setsrc(self,rb_ary_entry(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=rb_const_get(rb_cObject, rb_intern("Local")); arg0=it; it=Analyze_Variables2_clas(self ,arg0); FAILTEST(pass8);
...
ame_setsrc(self,rb_ary_entry(bind,19/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,21/*autovar*/,it); it=CALL(visit_Analyze_Variables2cb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,20/*autovar*/);
 rb_ary_store(bind,22/*t*/,it); it=CALL(visit_Analyze_Variables2cb_9,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,24/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,22/*t*/,it); it=CALL(visit_Analyze_Variables2cb_11,1,bind); 
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('c63afcbd49c33f59101efa0db952ece7')");}
