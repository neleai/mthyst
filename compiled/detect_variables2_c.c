...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(i_1,it); it=CALL(flat_Analyze_Variables2cb_3,1,bind); FAILTEST(alt1_2);it=BGET(i_1);
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 it=CALL(flat_Analyze_Variables2cb_4,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_3);
 BSET(i_1,it); it=CALL(flat_Analyze_Variables2cb_5,1,bind); FAILTEST(alt1_3);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(flat_Analyze_Variables2cb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=BGET(autovar_1);
...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_2);
 BSET(i_1,it); it=CALL(itrans_Analyze_Variables2cb_3,1,bind); FAILTEST(alt1_2);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_2,it); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(itrans_Analyze_Variables2cb_4,1,bind); 
 BSET(autovar_3,it); it=CALL(itrans_Analyze_Variables2cb_5,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_5,it); int oldpos6; while(1){oldpos6=ame_getpos(self); it=CALL(itrans_Analyze_Variables2cb_7,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(break2);
 BSET(i_1,it); it=CALL(itrans_Analyze_Variables2cb_8,1,bind); FAILTEST(break2);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
it=CALL(itrans_Analyze_Variables2cb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_5);
 BSET(rules_1,it); 
	...
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos4); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
it=CALL(itrans_Analyze_Variables2cb_10,1,bind); it=CALL(itrans_Analyze_Variables2cb_11,1,bind); 
 BSET(autovar_8,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(itrans_Analyze_Variables2cb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=BGET(autovar_1);
 BSET(_result_2,it); it=BGET(_result_2);
return it;
fail: return failobj; }
...
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(root_Analyze_Variables2cb_5,1,bind); it=CALL(root_Analyze_Variables2cb_6,1,bind); it=CALL(root_Analyze_Variables2cb_7,1,bind);   it=CALL(traverse,0 ); FAILTEST(pass2);it=CALL(root_Analyze_Variables2cb_8,1,bind); it=CALL(root_Analyze_Variables2cb_9,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(traverse,0 ); FAILTEST(pass1);it=CALL(visit_Analyze_Variables2cb_3,1,bind); 
...
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(traverse,0 ); FAILTEST(pass4);it=CALL(visit_Analyze_Variables2cb_9,1,bind); 
