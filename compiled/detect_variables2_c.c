...
ISET(cut,Qnil);goto accept2;
 ...
 rb_ary_store(bind,3,it);  break;}it=CALL(flat_Analyze_Variables2cb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,10,it);  break;}it=CALL(itrans_Analyze_Variables2cb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
...
it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbAnalyze_Variables24,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,3,it); it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break1);
...
it=rb_ary_entry(bind,17);
 rb_ary_store(bind,7,it);  break;case 3:; int oldpos12=ame_getpos(self);
  alt1_1:  ame_setpos(self,oldpos12); goto fail;
 accept1:;
...
it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbRemap_Acts6,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,3,it); it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break1);
...
return it;
fail: return failobj; }
VALUE Remap_Acts_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(21);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbRemap_Acts5,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,1,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break1);
 rb_ary_store(bind,2,it); it=CALL(visit_Remap_Actscb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,3,it); it=CALL(visit_Remap_Actscb_2,1,bind); 
 rb_ary_store(bind,4,it);   it=Remap_Acts_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,7,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break2);
 rb_ary_store(bind,8,it); it=CALL(visit_Remap_Actscb_3,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,7);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_4,1,bind); 
 rb_ary_store(bind,10,it);   it=Remap_Acts_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto fail;
it=rb_ary_entry(bind,10);
 ...
 rb_ary_store(bind,11,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,rb_ary_entry(bind,11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,12,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break3);
 rb_ary_store(bind,13,it); it=CALL(visit_Remap_Actscb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,12);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_6,1,bind); 
 rb_ary_store(bind,14,it);   it=Remap_Acts_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
	if(fail3) goto fail;
it=rb_ary_entry(bind,14);
 ...
 rb_ary_store(bind,15,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break4);
 rb_ary_store(bind,17,it); it=CALL(visit_Remap_Actscb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_8,1,bind); 
 rb_ary_store(bind,18,it);   it=Remap_Acts_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
	success4: ame_setsrc(self,oldsrc4); ame_setpos(self,oldpos7); ame_setlen(self,oldlen4);
	if(fail4) goto fail;
it=rb_ary_entry(bind,18);
 rb_ary_store(bind,5,it);  break;case 4:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,19,it); int oldpos9=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos10; while(1){oldpos10=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=CALL(visit_Remap_Actscb_9,1,bind); 
 rb_ary_store(bind,20,it);   it=Remap_Acts_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos9); ame_setlen(self,oldlen5);
	if(fail5) goto fail;
it=rb_ary_entry(bind,20);
 rb_ary_store(bind,5,it);  break;case 5:; int oldpos11=ame_getpos(self);
  alt1_1:  ame_setpos(self,oldpos11); goto fail;
 accept1:;
...
rb_define_method(cls_Remap_Acts,"visit",Remap_Acts_visit,0);
 rb_eval_string("testversiondetect_variables2('0616a57926d93377448c6efc036e59d9')");}
