...
static VALUE sy_Analyze_Variables2__append_lp__37c5;
...
static VALUE sy_Analyze_Variables2_bind_lb_5_rb__lt__dccc;
...
it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_5_rb__lt__dccc,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Analyze_Variables2__append_lp__37c5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
sy_Analyze_Variables2__append_lp__37c5=rb_intern("Analyze_Variables2__append_lp__37c5");
...
sy_Analyze_Variables2_bind_lb_5_rb__lt__dccc=rb_intern("Analyze_Variables2_bind_lb_5_rb__lt__dccc");
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('bf90d2a9c7cc5feed1041004366d6521')");}
