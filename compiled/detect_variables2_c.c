...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,4/*autovar*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  it=CALL(itrans_Analyze_Variables2cb_2,1,bind);  arg0=it; it=Analyze_Variables2_clas(self ,arg0); FAILTEST(break2);
...
ame_setsrc(self,rb_ary_entry(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=CALL(itrans_Analyze_Variables2cb_2,1,bind);  arg0=it; it=Analyze_Variables2_clas(self ,arg0); FAILTEST(pass1);
...
ame_setsrc(self,rb_ary_entry(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,4/*a*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
it=CALL(visit_Analyze_Variables2cb_3,1,bind); 
 rb_ary_store(bind,5/*ary*/,it); it=CALL(visit_Analyze_Variables2cb_4,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,10/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,11/*autovar*/,it); it=CALL(visit_Analyze_Variables2cb_6,1,bind); int oldpos9=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
...
ame_setsrc(self,rb_ary_entry(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,13/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos10); ame_setlen(self,oldlen8);
	if(fail8) goto pass7;
it=rb_ary_entry(bind,13/*autovar*/);
 rb_ary_store(bind,14/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
ame_setsrc(self,rb_ary_entry(bind,17/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,18/*autovar*/,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
it=rb_ary_entry(bind,18/*autovar*/);
 ...
 rb_ary_store(bind,19/*autovar*/,it); int oldpos12=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,19/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,20/*autovar*/,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break3);
 rb_ary_store(bind,21/*autovar*/,it); it=CALL(visit_Analyze_Variables2cb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,20/*autovar*/);
 rb_ary_store(bind,22/*t*/,it); it=CALL(visit_Analyze_Variables2cb_10,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,24/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,26/*autovar*/,it); it=CALL(visit_Analyze_Variables2cb_11,1,bind);  if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos15); it=rb_ary_entry(bind,25/*autovar*/);
 rb_ary_store(bind,22/*t*/,it); it=CALL(visit_Analyze_Variables2cb_12,1,bind); 
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('161a205e8d9f212ee112255bc3961cc9')");}
