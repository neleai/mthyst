...
static VALUE s_visit_Analyze_Variables2cb_17Analyze_Variables2;
static VALUE s_visit_Analyze_Variables2cb_18Analyze_Variables2;
...
it=bind_aget(bind,11/*autovar*/);
 bind_aset(bind,12/*autovar*/,it);  break;case 1:; it=rb_funcall(self,s_visit_Analyze_Variables2cb_6Analyze_Variables2,1,bind); FAILTEST(pass4); it=c_44; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass4);
...
ame_setsrc(self,bind_aget(bind,26/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,28/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_12Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos14=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos14); it=bind_aget(bind,27/*autovar*/);it=rb_funcall(self,s_visit_Analyze_Variables2cb_13Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,30/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,32/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_14Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos16=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos16); it=bind_aget(bind,31/*autovar*/);
 bind_aset(bind,33/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_15Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,35/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_funcall(self,s_visit_Analyze_Variables2cb_16Analyze_Variables2,1,bind); 
...
ame_setsrc(self,bind_aget(bind,37/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,39/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_17Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos19=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos19); it=bind_aget(bind,38/*autovar*/);
 bind_aset(bind,33/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_18Analyze_Variables2,1,bind); 
...
s_visit_Analyze_Variables2cb_17Analyze_Variables2=rb_intern("visit_Analyze_Variables2cb_17");
s_visit_Analyze_Variables2cb_18Analyze_Variables2=rb_intern("visit_Analyze_Variables2cb_18");
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('ecede126e03121253fdf95216cc6e636')");}
