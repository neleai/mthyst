...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_2,1,bind); it=Analyze_Variables2_clas(self ,arg0); FAILTEST(alt1_2);
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_3,1,bind); it=Analyze_Variables2_clas(self ,arg0); FAILTEST(alt1_3);
...
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(itrans_Analyze_Variables2cb_4,1,bind); it=Analyze_Variables2_clas(self ,arg0); FAILTEST(alt2_2);
...
alt4_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
 ...
 BSET(autovar_1,it); int oldpos9; while(1){oldpos9=ame_getpos(self);  arg0=CALL(itrans_Analyze_Variables2cb_10,1,bind); it=Analyze_Variables2_clas(self ,arg0); FAILTEST(break2);
...
alt5_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass4;}
   it=Analyze_Variables2_root(self ); FAILTEST(alt5_2); 
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=CALL(traverse_Analyze_Variables2cb_1,1,bind); 
...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(traverse_item_Analyze_Variables2cb_4,1,bind); 
 BSET(autovar_2,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(traverse_item_Analyze_Variables2cb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=BGET(autovar_2);
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(traverse_item_Analyze_Variables2cb_6,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_4);
 BSET(i_1,it); it=CALL(traverse_item_Analyze_Variables2cb_7,1,bind); FAILTEST(alt1_4);it=BGET(i_1);
 BSET(_result_2,it); it=BGET(_result_2);
 BSET(autovar_4,it); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(pass6);
