...
return it;
fail: return failobj; }
VALUE Analyze_Variables2_visit(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(32);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashAnalyze_Variables22,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
ame_setsrc(self,bind_aget(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_ary_new3(0);
 bind_aset(bind,2/*autovar*/,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 bind_aset(bind,3/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_1Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,2/*autovar*/);it=rb_funcall(self,s_visit_Analyze_Variables2cb_2Analyze_Variables2,1,bind); 
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_3Analyze_Variables2,1,bind); int oldpos4=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 bind_aset(bind,5/*autovar*/,it); int oldpos5=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,bind_aget(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
  it=c_40; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass4);
 bind_aset(bind,6/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
it=bind_aget(bind,9/*autovar*/);
 ...
 bind_aset(bind,11/*autovar*/,it); int oldpos6=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,bind_aget(bind,11/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,12/*autovar*/,it); int oldpos7=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,bind_aget(bind,12/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,14/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_4Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,13/*autovar*/);it=rb_funcall(self,s_visit_Analyze_Variables2cb_5Analyze_Variables2,1,bind); 
 bind_aset(bind,15/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_6Analyze_Variables2,1,bind); int oldpos9=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,bind_aget(bind,15/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass7);
 bind_aset(bind,16/*autovar*/,it); int oldpos10=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,bind_aget(bind,16/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 ...
 bind_aset(bind,17/*a*/,it);   it=Amethyst_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass7);
	...
	if(fail7) goto pass6;
it=rb_funcall(self,s_visit_Analyze_Variables2cb_7Analyze_Variables2,1,bind); 
 bind_aset(bind,18/*ary*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_8Analyze_Variables2,1,bind); 
...
it=bind_aget(bind,20/*autovar*/);
 ...
 bind_aset(bind,21/*autovar*/,it); int oldpos11=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,bind_aget(bind,21/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_ary_new3(0);
 bind_aset(bind,22/*autovar*/,it); int oldpos12; while(1){oldpos12=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break3);
 bind_aset(bind,23/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_9Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos12=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos12); it=bind_aget(bind,22/*autovar*/);
 bind_aset(bind,24/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_10Analyze_Variables2,1,bind); 
 bind_aset(bind,25/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
...
ame_setsrc(self,bind_aget(bind,26/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_funcall(self,s_visit_Analyze_Variables2cb_11Analyze_Variables2,1,bind); 
...
it=bind_aget(bind,27/*autovar*/);
 ...
 bind_aset(bind,28/*autovar*/,it); int oldpos14=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,bind_aget(bind,28/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeAnalyze_Variables2,0)));
 it=rb_ary_new3(0);
 bind_aset(bind,29/*autovar*/,it); int oldpos15; while(1){oldpos15=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break4);
 bind_aset(bind,30/*autovar*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_12Analyze_Variables2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos15); it=bind_aget(bind,29/*autovar*/);
 bind_aset(bind,24/*t*/,it); it=rb_funcall(self,s_visit_Analyze_Variables2cb_13Analyze_Variables2,1,bind); 
 bind_aset(bind,31/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
	success11: ame_setsrc(self,oldsrc11); ame_setpos(self,oldpos14); ame_setlen(self,oldlen11);
	if(fail11) goto fail;
it=bind_aget(bind,31/*autovar*/);
 bind_aset(bind,10/*_result*/,it);  break;case 5:;   it=Amethyst_fails(self ); FAILTEST(fail); break;}it=bind_aget(bind,10/*_result*/);
return it;
fail: return failobj; }
...
c_40=rb_const_get(rb_cObject, rb_intern("Local"));rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),c_40);
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('21ce5588c7d1de2e3862fd97aa700729')");}
