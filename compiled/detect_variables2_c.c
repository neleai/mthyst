...
cstruct oldpass13=*ptr; int fail13=0;
          ptr->src=bind_aget(bind,37/*autovar*/); ptr->pos=0; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} ptr->ary=NULL;
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('69c9d5313d9d0c55cdb4344f1e5da7e5')");}
