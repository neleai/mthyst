...
static VALUE c_Rule;
static VALUE sy_Analyze_Variables2_Act_lb_bind_lb_10_rb_;
static VALUE sy_Analyze_Variables2_Or_lb__ti_bind_lb_33_rb_;
static VALUE sy_Analyze_Variables2_Placeholder;
static VALUE sy_Analyze_Variables2_Seq_lb__ti_bind_lb_33;
static VALUE sy_Analyze_Variables2__append_lp_bind10;
static VALUE sy_Analyze_Variables2__append_lp_bind11;
static VALUE sy_Analyze_Variables2__append_lp_bind12;
static VALUE sy_Analyze_Variables2__append_lp_bind2;
static VALUE sy_Analyze_Variables2__append_lp_bind3;
static VALUE sy_Analyze_Variables2__append_lp_bind4;
static VALUE sy_Analyze_Variables2__append_lp_bind5;
static VALUE sy_Analyze_Variables2__append_lp_bind6;
static VALUE sy_Analyze_Variables2__append_lp_bind7;
static VALUE sy_Analyze_Variables2__append_lp_bind8;
static VALUE sy_Analyze_Variables2__append_lp_bind9;
static VALUE sy_Analyze_Variables2__append_lp_bind;
static VALUE sy_Analyze_Variables2__at_bnding_eq_src_dot_;
static VALUE sy_Analyze_Variables2__at_changed;
static VALUE sy_Analyze_Variables2__at_changed_eq_fal;
static VALUE sy_Analyze_Variables2__at_changed_eq_tru;
static VALUE sy_Analyze_Variables2__at_locals_eq_src_dot_;
static VALUE sy_Analyze_Variables2__at_variables_eq_H;
static VALUE sy_Analyze_Variables2__lp_;
static VALUE sy_Analyze_Variables2__lp_bind_lb_10_rb__dot_si;
static VALUE sy_Analyze_Variables2__lp_bind_lb_4_rb_;
static VALUE sy_Analyze_Variables2__lp_src_dot_instanc;
static VALUE sy_Analyze_Variables2_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Analyze_Variables2_connectstrin;
static VALUE sy_Analyze_Variables2_if_sp_bind_lb_5_rb_;
static VALUE sy_Analyze_Variables2_src;
static VALUE sy_Analyze_Variables2_src_dot_ary;
static VALUE sy_Analyze_Variables2_src_dot_ary_dot_map_le_;
static VALUE sy_Analyze_Variables2_src_dot_locals_eq_n;
static VALUE sy_Analyze_Variables2_src_dot_pred;
static VALUE sy_Analyze_Variables2_src_dot_rules;
static VALUE sy_Analyze_Variables2_src_dot_rules_eq_bi;
static VALUE sy_Analyze_Variables2_vars_eq__at_locals;
...
ame_setcut(self,Qnil);goto accept2;
 ...
 break;}it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind9,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/); bind_aset(bind,8/*_result*/,it);
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,2/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_Analyze_Variables2_src_dot_rules,1,bind);  bind_aset(bind,3/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,5/*autovar*/); bind_aset(bind,9/*rules*/,it);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass2);
	...
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
it=rb_funcall(self,sy_Analyze_Variables2_src_dot_rules_eq_bi,1,bind); it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind);  bind_aset(bind,10/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
ame_setcut(self,Qnil);goto accept1;
 ...
 break;}it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/); bind_aset(bind,12/*_result*/,it);
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_Analyze_Variables2__at_bnding_eq_src_dot_,1,bind); it=rb_funcall(self,sy_Analyze_Variables2__at_variables_eq_H,1,bind); it=rb_funcall(self,sy_Analyze_Variables2__at_locals_eq_src_dot_,1,bind);   it=Analyze_Variables2_traverse(self ); FAILTEST(pass2); bind_aset(bind,2/*autovar*/,it);
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,2/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_locals_eq_n,1,bind); it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind);  bind_aset(bind,5/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind11,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Analyze_Variables2__at_changed_eq_fal,1,bind);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind12,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Analyze_Variables2_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind10,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,3/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_ary,1,bind);  bind_aset(bind,5/*autovar*/,it);
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,8/*autovar*/,it);
int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/); bind_aset(bind,10/*ary*/,it);
it=rb_funcall(self,sy_Analyze_Variables2_Act_lb_bind_lb_10_rb_,1,bind);  bind_aset(bind,11/*autovar*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,19/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_ary_dot_map_le_,1,bind);  bind_aset(bind,21/*autovar*/,it);
...
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass8);
	...
	if(fail8) goto pass7;
it=rb_funcall(self,sy_Analyze_Variables2_connectstrin,1,bind);  bind_aset(bind,10/*ary*/,it);
it=rb_funcall(self,sy_Analyze_Variables2__lp_bind_lb_10_rb__dot_si,1,bind);  bind_aset(bind,24/*autovar*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,27/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_Placeholder,1,bind);  bind_aset(bind,29/*autovar*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,31/*autovar*/); bind_aset(bind,33/*t*/,it);
it=rb_funcall(self,sy_Analyze_Variables2_Or_lb__ti_bind_lb_33_rb_,1,bind);  bind_aset(bind,34/*autovar*/,it);
...
cstruct oldpass12=*ptr; int fail12=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_Analyze_Variables2_vars_eq__at_locals,1,bind);  bind_aset(bind,36/*autovar*/,it);
...
it=rb_funcall(self,sy_Analyze_Variables2__append_lp_bind8,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,38/*autovar*/); bind_aset(bind,33/*t*/,it);
it=rb_funcall(self,sy_Analyze_Variables2_Seq_lb__ti_bind_lb_33,1,bind);  bind_aset(bind,40/*autovar*/,it);
...
sy_Analyze_Variables2_Act_lb_bind_lb_10_rb_=rb_intern("Analyze_Variables2_Act_lb_bind_lb_10_rb_");
sy_Analyze_Variables2_Or_lb__ti_bind_lb_33_rb_=rb_intern("Analyze_Variables2_Or_lb__ti_bind_lb_33_rb_");
sy_Analyze_Variables2_Placeholder=rb_intern("Analyze_Variables2_Placeholder");
sy_Analyze_Variables2_Seq_lb__ti_bind_lb_33=rb_intern("Analyze_Variables2_Seq_lb__ti_bind_lb_33");
sy_Analyze_Variables2__append_lp_bind10=rb_intern("Analyze_Variables2__append_lp_bind10");
sy_Analyze_Variables2__append_lp_bind11=rb_intern("Analyze_Variables2__append_lp_bind11");
sy_Analyze_Variables2__append_lp_bind12=rb_intern("Analyze_Variables2__append_lp_bind12");
sy_Analyze_Variables2__append_lp_bind2=rb_intern("Analyze_Variables2__append_lp_bind2");
sy_Analyze_Variables2__append_lp_bind3=rb_intern("Analyze_Variables2__append_lp_bind3");
sy_Analyze_Variables2__append_lp_bind4=rb_intern("Analyze_Variables2__append_lp_bind4");
sy_Analyze_Variables2__append_lp_bind5=rb_intern("Analyze_Variables2__append_lp_bind5");
sy_Analyze_Variables2__append_lp_bind6=rb_intern("Analyze_Variables2__append_lp_bind6");
sy_Analyze_Variables2__append_lp_bind7=rb_intern("Analyze_Variables2__append_lp_bind7");
sy_Analyze_Variables2__append_lp_bind8=rb_intern("Analyze_Variables2__append_lp_bind8");
sy_Analyze_Variables2__append_lp_bind9=rb_intern("Analyze_Variables2__append_lp_bind9");
sy_Analyze_Variables2__append_lp_bind=rb_intern("Analyze_Variables2__append_lp_bind");
sy_Analyze_Variables2__at_bnding_eq_src_dot_=rb_intern("Analyze_Variables2__at_bnding_eq_src_dot_");
sy_Analyze_Variables2__at_changed=rb_intern("Analyze_Variables2__at_changed");
sy_Analyze_Variables2__at_changed_eq_fal=rb_intern("Analyze_Variables2__at_changed_eq_fal");
sy_Analyze_Variables2__at_changed_eq_tru=rb_intern("Analyze_Variables2__at_changed_eq_tru");
sy_Analyze_Variables2__at_locals_eq_src_dot_=rb_intern("Analyze_Variables2__at_locals_eq_src_dot_");
sy_Analyze_Variables2__at_variables_eq_H=rb_intern("Analyze_Variables2__at_variables_eq_H");
sy_Analyze_Variables2__lp_=rb_intern("Analyze_Variables2__lp_");
sy_Analyze_Variables2__lp_bind_lb_10_rb__dot_si=rb_intern("Analyze_Variables2__lp_bind_lb_10_rb__dot_si");
sy_Analyze_Variables2__lp_bind_lb_4_rb_=rb_intern("Analyze_Variables2__lp_bind_lb_4_rb_");
sy_Analyze_Variables2__lp_src_dot_instanc=rb_intern("Analyze_Variables2__lp_src_dot_instanc");
sy_Analyze_Variables2_bind_lb_5_rb__lt__lt_bin=rb_intern("Analyze_Variables2_bind_lb_5_rb__lt__lt_bin");
sy_Analyze_Variables2_connectstrin=rb_intern("Analyze_Variables2_connectstrin");
sy_Analyze_Variables2_if_sp_bind_lb_5_rb_=rb_intern("Analyze_Variables2_if_sp_bind_lb_5_rb_");
...
sy_Analyze_Variables2_src_dot_ary_dot_map_le_=rb_intern("Analyze_Variables2_src_dot_ary_dot_map_le_");
sy_Analyze_Variables2_src_dot_locals_eq_n=rb_intern("Analyze_Variables2_src_dot_locals_eq_n");
sy_Analyze_Variables2_src_dot_pred=rb_intern("Analyze_Variables2_src_dot_pred");
sy_Analyze_Variables2_src_dot_rules=rb_intern("Analyze_Variables2_src_dot_rules");
sy_Analyze_Variables2_src_dot_rules_eq_bi=rb_intern("Analyze_Variables2_src_dot_rules_eq_bi");
sy_Analyze_Variables2_vars_eq__at_locals=rb_intern("Analyze_Variables2_vars_eq__at_locals");
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('4bb084b6be7fe039c42870bb8892c4d3')");}
