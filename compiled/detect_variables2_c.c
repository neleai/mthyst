...
return it;
fail: return failobj; }
VALUE Analyze_Variables2_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(27);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbAnalyze_Variables21,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,1,it); int oldpos2=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(visit_Analyze_Variables2cb_1,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos8; while(1){oldpos8=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=CALL(visit_Analyze_Variables2cb_5,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Analyze_Variables2cb_8,1,bind); 
...
it=rb_ary_entry(bind,17);
 ...
 rb_ary_store(bind,18,it); int oldpos12=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,18)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,19,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break3);
 rb_ary_store(bind,20,it); it=CALL(visit_Analyze_Variables2cb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,19);
 rb_ary_store(bind,21,it); it=CALL(visit_Analyze_Variables2cb_10,1,bind); 
 rb_ary_store(bind,22,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
...
it=rb_ary_entry(bind,22);
 ...
 rb_ary_store(bind,23,it); int oldpos14=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,rb_ary_entry(bind,23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,24,it); int oldpos15; while(1){oldpos15=ame_getpos(self);   it=Analyze_Variables2_traverse_item(self ); FAILTEST(break4);
 rb_ary_store(bind,25,it); it=CALL(visit_Analyze_Variables2cb_11,1,bind);  if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos15); it=rb_ary_entry(bind,24);
 rb_ary_store(bind,21,it); it=CALL(visit_Analyze_Variables2cb_12,1,bind); 
 rb_ary_store(bind,26,it);   it=Analyze_Variables2_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
...
it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbRemap_Acts7,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
return it;
fail: return failobj; }
VALUE Remap_Acts_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(39);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;

it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbRemap_Acts6,1,ame_curobj(self)));  switch(chr1){case 0:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,0,it); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
...
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Remap_Actscb_7,1,bind); 
 rb_ary_store(bind,16,it); it=CALL(visit_Remap_Actscb_8,1,bind); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Remap_Acts_traverse_item(self ); FAILTEST(pass5);
 rb_ary_store(bind,17,it);   it=Remap_Acts_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: ame_setsrc(self,oldsrc5); ame_setpos(self,oldpos8); ame_setlen(self,oldlen5);
	if(fail5) goto pass4;
it=CALL(visit_Remap_Actscb_9,1,bind); 
...
ame_setsrc(self,rb_ary_entry(bind,19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Remap_Actscb_10,1,bind); 
 rb_ary_store(bind,20,it); it=CALL(visit_Remap_Actscb_11,1,bind); int oldpos10=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Remap_Acts_traverse_item(self ); FAILTEST(pass7);
 rb_ary_store(bind,21,it);   it=Remap_Acts_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: ame_setsrc(self,oldsrc7); ame_setpos(self,oldpos10); ame_setlen(self,oldlen7);
	if(fail7) goto pass6;
it=CALL(visit_Remap_Actscb_12,1,bind); 
 rb_ary_store(bind,22,it); it=CALL(visit_Remap_Actscb_13,1,bind); int oldpos11=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Remap_Acts_traverse_item(self ); FAILTEST(pass8);
 rb_ary_store(bind,23,it);   it=Remap_Acts_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
	success8: ame_setsrc(self,oldsrc8); ame_setpos(self,oldpos11); ame_setlen(self,oldlen8);
	if(fail8) goto pass6;
it=CALL(visit_Remap_Actscb_14,1,bind); 
 rb_ary_store(bind,24,it);   it=Remap_Acts_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos9); ame_setlen(self,oldlen6);
	if(fail6) goto fail;
it=rb_ary_entry(bind,24);
 rb_ary_store(bind,5,it);  break;case 5:;   it=AmethystCore_anything(self ); FAILTEST(fail);
...
ame_setsrc(self,rb_ary_entry(bind,25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,26,it); int oldpos13; while(1){oldpos13=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break4);
 rb_ary_store(bind,27,it); it=CALL(visit_Remap_Actscb_15,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=rb_ary_entry(bind,26);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_16,1,bind); 
 rb_ary_store(bind,28,it);   it=Remap_Acts_eof(self ); FAILTEST(pass9);
	goto success9;
	pass9: fail9=1;
	success9: ame_setsrc(self,oldsrc9); ame_setpos(self,oldpos12); ame_setlen(self,oldlen9);
	if(fail9) goto fail;
it=rb_ary_entry(bind,28);
 rb_ary_store(bind,5,it);  break;case 6:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,29,it); int oldpos14=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,rb_ary_entry(bind,29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,30,it); int oldpos15; while(1){oldpos15=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break5);
 rb_ary_store(bind,31,it); it=CALL(visit_Remap_Actscb_17,1,bind);  if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos15); it=rb_ary_entry(bind,30);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_18,1,bind); 
 rb_ary_store(bind,32,it);   it=Remap_Acts_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
	success10: ame_setsrc(self,oldsrc10); ame_setpos(self,oldpos14); ame_setlen(self,oldlen10);
	if(fail10) goto fail;
it=rb_ary_entry(bind,32);
 rb_ary_store(bind,5,it);  break;case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail);
 rb_ary_store(bind,33,it); int oldpos16=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,rb_ary_entry(bind,33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,34,it); int oldpos17; while(1){oldpos17=ame_getpos(self);   it=Remap_Acts_traverse_item(self ); FAILTEST(break6);
 rb_ary_store(bind,35,it); it=CALL(visit_Remap_Actscb_19,1,bind);  if (IGET(stop)!=Qnil){{oldpos17=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos17); it=rb_ary_entry(bind,34);
 rb_ary_store(bind,9,it); it=CALL(visit_Remap_Actscb_20,1,bind); 
 rb_ary_store(bind,36,it);   it=Remap_Acts_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
...
alt1_1: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Remap_Actscb_21,1,bind);  arg0=it; it=Remap_Acts_clas(self ,arg0); FAILTEST(alt1_2);
 rb_ary_store(bind,37,it);  
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Remap_Actscb_22,1,bind);  arg0=it; it=Remap_Acts_clas(self ,arg0); FAILTEST(alt1_3);
 rb_ary_store(bind,37,it);  
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Remap_Actscb_23,1,bind);  arg0=it; it=Remap_Acts_clas(self ,arg0); FAILTEST(alt1_4);
 rb_ary_store(bind,37,it);  
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Remap_Actscb_24,1,bind);  arg0=it; it=Remap_Acts_clas(self ,arg0); FAILTEST(alt1_5);
 rb_ary_store(bind,37,it);  
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldpos18);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(visit_Remap_Actscb_25,1,bind);  arg0=it; it=Remap_Acts_clas(self ,arg0); FAILTEST(alt1_6);
 rb_ary_store(bind,37,it);  
ISET(cut,Qnil);goto accept1;
  alt1_6:  ame_setpos(self,oldpos18); goto fail;
 accept1:;
...
ame_setsrc(self,rb_ary_entry(bind,37)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos20; while(1){oldpos20=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=CALL(visit_Remap_Actscb_26,1,bind); 
 rb_ary_store(bind,38,it);   it=Remap_Acts_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
...
rb_define_method(cls_Remap_Acts,"visit",Remap_Acts_visit,0);
 rb_eval_string("testversiondetect_variables2('413ec2f609396dafaeac81c2169f2d50')");}
