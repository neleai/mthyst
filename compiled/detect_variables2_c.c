...
alt1_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto break1;}
 ...
 bind_aset(bind,2/*autovar*/,it); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_Analyze_Variables2_src_dot_rule,1,bind); 
 bind_aset(bind,3/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_3_rb__eq_,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
it=bind_aget(bind,7/*autovar*/);
 bind_aset(bind,8/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,5/*autovar*/);
 bind_aset(bind,9/*rules*/,it);   it=Amethyst_eof(self ); FAILTEST(pass3);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass2);
	...
	if(fail2) goto pass1;
it=rb_funcall(self,sy_Analyze_Variables2_src_dot_rule2,1,bind); it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind); 
...
it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind); 
 bind_aset(bind,0/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_0_rb__eq_,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_Analyze_Variables2__at_bnding_eq_,1,bind); it=rb_funcall(self,sy_Analyze_Variables2__at_variabl,1,bind); it=rb_funcall(self,sy_Analyze_Variables2__at_locals_eq_,1,bind);   it=Analyze_Variables2_traverse(self ); FAILTEST(pass2);
...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_loca,1,bind); it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind); 
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,2/*oldchanged*/,it); it=rb_funcall(self,sy_Analyze_Variables2_src,1,bind); 
 bind_aset(bind,3/*this*/,it); it=Qnil;
 bind_aset(bind,4/*clon*/,it); it=Qfalse;
 bind_aset(bind,5/*changed*/,it); it=rb_funcall(self,sy_Analyze_Variables2__lp_src_dot_ins,1,bind); 
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_6_rb__eq_,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,bind_aget(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
...
ame_setsrc(self,bind_aget(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,11/*val*/,it); it=rb_funcall(self,sy_Analyze_Variables2__lp_bind_lb_4_rb_,1,bind); 
...
it=bind_aget(bind,12/*autovar*/);
 bind_aset(bind,13/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_12,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,sy_Analyze_Variables2_if_sp_bind_lb_,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Analyze_Variables2__at_changed,1,bind); it=bind_aget(bind,0/*a*/);
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_5_rb__lt_,1,bind); 
...
ame_setsrc(self,bind_aget(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_Analyze_Variables2_src_dot_pred,1,bind); 
...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_ary,1,bind); 
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_5_rb__eq_,1,bind); int oldpos4=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
ame_setsrc(self,bind_aget(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,10/*ary*/,it); it=rb_funcall(self,sy_Analyze_Variables2_Act_lb_bind,1,bind); 
...
it=bind_aget(bind,11/*autovar*/);
 bind_aset(bind,12/*autovar*/,it);  break;case 1:; it=rb_funcall(self,sy_Analyze_Variables2__lp_,1,bind); FAILTEST(pass4); it=c_Local; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass4);
...
ame_setsrc(self,bind_aget(bind,18/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,20/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=bind_aget(bind,19/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_src_dot_ary_dot_,1,bind); 
 bind_aset(bind,21/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2_bind_lb_21_rb_,1,bind); int oldpos11=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
...
ame_setsrc(self,bind_aget(bind,22/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,23/*a*/,it);   it=Amethyst_eof(self ); FAILTEST(pass9);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass8);
	...
	if(fail8) goto pass7;
it=rb_funcall(self,sy_Analyze_Variables2_connects,1,bind); 
 bind_aset(bind,10/*ary*/,it); it=rb_funcall(self,sy_Analyze_Variables2__lp_bind_lb_10,1,bind); 
...
ame_setsrc(self,bind_aget(bind,26/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,28/*autovar*/,it); it=rb_funcall(self,sy_Analyze_Variables2__append_lp_6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos14=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos14); it=bind_aget(bind,27/*autovar*/);it=rb_funcall(self,sy_Analyze_Variables2_Placehol,1,bind); 
...
ame_setsrc(self,bind_aget(bind,30/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,33/*t*/,it); it=rb_funcall(self,sy_Analyze_Variables2_Or_lb__ti_bind,1,bind); 
...
ame_setsrc(self,bind_aget(bind,35/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_Analyze_Variables2_vars_eq__at_lo,1,bind); 
...
ame_setsrc(self,bind_aget(bind,37/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,33/*t*/,it); it=rb_funcall(self,sy_Analyze_Variables2_Seq_lb__ti_bin,1,bind); 
...
rb_define_method(cls_Analyze_Variables2,"visit",Analyze_Variables2_visit,0);
 rb_eval_string("testversiondetect_variables2('7e7781aa181c7b1d849973b0db0f2251')");}
