...
VALUE profile_report_First_Dataflow(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  return Qnil;}VALUE First_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil,_autovar_3=Qnil,_name=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_val=Qnil,_autovar_10=Qnil,_vals=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,_p=Qnil,_v=Qnil,_autovar_13=Qnil,_autovar_14=Qnil,_el=Qnil,_autovar_15=Qnil,_autovar_16=Qnil,_nev=Qnil,_autovar_17=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_First_Dataflow_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*CAct*/:case 2/*Cut*/:case 3/*Local*/:case 4/*Lookahead*/:case 5/*Pass*/:case 6/*Result*/:case 7/*Stop*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_First_Dataflow_lattice_dot__5a9e,1,bind2); _autovar_2=it;;
...
ptr->pos=ptr->len;bind_aset(bind2,1,_name);it=rb_funcall(self,sy_First_Dataflow__lp_Compile_7f7b,1,bind2);_name=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto pass2;};bind_aset(bind2,1,_name);it=rb_funcall(self,sy_First_Dataflow_Compiler_558e,1,bind2);_name=bind_aget(bind2,1);; _autovar_4=it;;
...
alt1_2: ptr->pos=oldpos1;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert2;}it=rb_funcall(self,sy_First_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
alt2_2: ptr->pos=oldpos2;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert4;}it=rb_funcall(self,sy_First_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_val);it=rb_funcall(self,sy_First_Dataflow_bind_lb_1_rb_,1,bind2);_val=bind_aget(bind2,1);; _autovar_10=it;;
...
alt3_2: ptr->pos=oldpos3;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert6;}it=rb_funcall(self,sy_First_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_p);bind_aset(bind2,2,_v);it=rb_funcall(self,sy_First_Dataflow_bind_lb_1_rb__dot__c5d5,1,bind2);_p=bind_aget(bind2,1);;_v=bind_aget(bind2,2);; _autovar_13=it;;
...
alt5_3: ptr->pos=oldpos5;ptr->branches-=1;if (1){it=failobj;goto pass6;};
 accept12:;
                ...
                bind_aset(bind2,1,_vals);it=rb_funcall(self,sy_First_Dataflow_bind_lb_1_rb__dot__a37c,1,bind2);_vals=bind_aget(bind2,1);; __result=it;;

;goto accept11;revert7:;  goto alt4_2; accept11:;

;ptr->branches-=2; goto accept10;
alt4_2: ptr->pos=oldpos4;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert10;}it=rb_funcall(self,sy_First_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_First_Dataflow_lattice_dot__5a9e,1,bind2); _val=it;;
...
bind_aset(bind2,1,_val);bind_aset(bind2,2,_nev);it=rb_funcall(self,sy_First_Dataflow_bind_lb_1_rb__dot__159a,1,bind2);_val=bind_aget(bind2,1);;_nev=bind_aget(bind2,2);; _val=it;;
int oldpos7=ptr->pos;int cut7=0;
alt7_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2; bind_aset(bind2,1,_el);it=rb_funcall(self,sy_First_Dataflow__lp_,1,bind2);_el=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto revert12;};ptr->pos=ptr->len;
;goto accept19;revert12:;  goto alt7_2; accept19:;

;ptr->branches-=2; goto accept18;
alt7_2: ptr->pos=oldpos7;ptr->branches-=1; it=rb_funcall(self,sy_First_Dataflow__d41d,1,bind2);
...
alt6_3: ptr->pos=oldpos6;ptr->branches-=1;if (1){it=failobj;goto pass8;};
 ...
 break;
case 15/*Object*/:;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;}it=rb_funcall(self,sy_First_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
 break;
}
fail: return it;
}
VALUE First_Dataflow_getvalue(VALUE self ,VALUE a0){VALUE vals[1]; VALUE it ,_v=Qnil,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil;VALUE bind2=bind_new2(1); _v=a0;;  cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_v);it=rb_funcall(self,sy_First_Dataflow__at_vis_eq_bin_8b89,1,bind2);_v=bind_aget(bind2,1);; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar;ptr->len=1;
                     it=First_Dataflow_first(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
...
VALUE First_Dataflow_root(VALUE self ){VALUE vals[0]; VALUE it ,_x=Qnil,__result=Qnil;VALUE bind2=bind_new2(0);  VALUE arg0; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;} _x=it;;
 it=_x; arg0=it; it=rb_funcall(self,sy_analyze,1,arg0); if (it==failobj){it=failobj;goto fail;} __result=it;;

fail: return it;
}
VALUE First_Dataflow_switch(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_ary=Qnil,__result=Qnil;VALUE bind2=bind_new2(1);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_First_Dataflow_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Or*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
...
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto pass1;};
 accept1:;
                   ...
                   pass1: *ptr=oldpass1;if (1){it=failobj;goto fail;}
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,_ary);it=rb_funcall(self,sy_First_Dataflow_Switch_O_5445,1,bind2);_ary=bind_aget(bind2,1);; __result=it;;
 break;
...
VALUE First_Dataflow_value(VALUE self ){VALUE vals[0]; VALUE it ,_x=Qnil,__result=Qnil;VALUE bind2=bind_new2(1);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;} _x=it;;
bind_aset(bind2,1,_x);it=rb_funcall(self,sy_First_Dataflow_depends_lp__7463,1,bind2);_x=bind_aget(bind2,1);; __result=it;;
