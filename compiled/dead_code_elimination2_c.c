...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,4,it); it=CALL(move_Move_Assignments2cb_1,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,5,it); it=CALL(move_Move_Assignments2cb_2,1,bind); 
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); it=CALL(move_Move_Assignments2cb_3,1,bind); 
 rb_ary_store(bind,7,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt3_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 ...
 rb_ary_store(bind,12,it); it=CALL(move_Move_Assignments2cb_4,1,bind); int oldpos9=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
it=CALL(move_Move_Assignments2cb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=rb_ary_entry(bind,10);
 rb_ary_store(bind,5,it); it=CALL(move_Move_Assignments2cb_6,1,bind); 
...
alt2_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); it=CALL(move_Move_Assignments2cb_7,1,bind); 
 rb_ary_store(bind,7,it);  
ISET(cut,Qnil);goto accept2;
...
ame_setsrc(self,rb_ary_entry(bind,16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,17,it); it=CALL(move_Move_Assignments2cb_9,1,bind); 
 rb_ary_store(bind,18,it); it=CALL(move_Move_Assignments2cb_10,1,bind); int oldpos12=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
alt4_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 rb_ary_store(bind,8,it); it=CALL(move_Move_Assignments2cb_13,1,bind); 
 rb_ary_store(bind,7,it);  
ISET(cut,Qnil);goto accept5;
...
char chr1=FIX2INT(CALL(switchcbMove_Assignments22,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,3,it); it=CALL(visit_Move_Assignments2cb_4,1,bind); 
 rb_ary_store(bind,4,it); it=rb_ary_entry(bind,3);
 rb_ary_store(bind,5,it); it=CALL(visit_Move_Assignments2cb_5,1,bind); int oldpos4=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
ame_setsrc(self,rb_ary_entry(bind,8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,9,it); int oldpos7; while(1){oldpos7=ame_getpos(self);  it=rb_ary_entry(bind,7); arg0=it;it=rb_ary_entry(bind,6); arg1=it; it=Move_Assignments2_move(self ,arg0,arg1); FAILTEST(break2);
 rb_ary_store(bind,10,it); it=CALL(visit_Move_Assignments2cb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos7); it=rb_ary_entry(bind,9);
 rb_ary_store(bind,11,it); it=CALL(visit_Move_Assignments2cb_7,1,bind); 
 rb_ary_store(bind,12,it);   it=Move_Assignments2_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
alt1_2: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 rb_ary_store(bind,14,it); it=CALL(visit_Move_Assignments2cb_8,1,bind); 
 rb_ary_store(bind,13,it);  
ISET(cut,Qnil);goto accept1;
...
ame_setsrc(self,rb_ary_entry(bind,15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,16,it); int oldpos10; while(1){oldpos10=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3);
 rb_ary_store(bind,17,it); int oldpos11=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
 int oldpos12=ame_getpos(self);
   it=Move_Assignments2_eof(self ); FAILTEST(reject1); x=1; goto accept4;  reject1: x=0; accept4: it=Qnil; ame_setpos(self,oldpos12); if (x==0) goto alt3_2;it=rb_ary_entry(bind,17);
 rb_ary_store(bind,18,it); it=CALL(visit_Move_Assignments2cb_9,1,bind); int oldpos13=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,18)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=rb_ary_entry(bind,7); arg0=it;it=rb_ary_entry(bind,6); arg1=it; it=Move_Assignments2_move(self ,arg0,arg1); FAILTEST(pass6);
 rb_ary_store(bind,19,it);   it=Move_Assignments2_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
it=CALL(visit_Move_Assignments2cb_10,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=rb_ary_entry(bind,16);
 rb_ary_store(bind,11,it); it=CALL(visit_Move_Assignments2cb_11,1,bind); 
 rb_ary_store(bind,21,it);   it=Move_Assignments2_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
alt2_2: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
 rb_ary_store(bind,14,it); it=CALL(visit_Move_Assignments2cb_12,1,bind); 
 rb_ary_store(bind,13,it);  
ISET(cut,Qnil);goto accept2;
...
alt4_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_2);
 rb_ary_store(bind,22,it); int oldpos15=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,rb_ary_entry(bind,22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,23,it); it=CALL(visit_Move_Assignments2cb_14,1,bind); 
 rb_ary_store(bind,24,it); it=CALL(visit_Move_Assignments2cb_15,1,bind); int oldpos16=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_entry(bind,24)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=rb_ary_entry(bind,7); arg0=it;it=rb_ary_entry(bind,6); arg1=it; it=Move_Assignments2_move(self ,arg0,arg1); FAILTEST(pass8);
 rb_ary_store(bind,25,it);   it=Move_Assignments2_eof(self ); FAILTEST(pass8);
	goto success8;
	pass8: fail8=1;
...
it=CALL(visit_Move_Assignments2cb_16,1,bind); 
 rb_ary_store(bind,26,it);   it=Move_Assignments2_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
...
alt4_2: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_3);
 rb_ary_store(bind,14,it); it=CALL(visit_Move_Assignments2cb_18,1,bind); 
 rb_ary_store(bind,13,it);  
ISET(cut,Qnil);goto accept5;
