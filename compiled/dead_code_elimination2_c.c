...
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_4,it); it=CALL(vars_in_Dead_Code_Detector2cb_8,1,bind); int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos7); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt5_1: ame_setpos(self,oldpos13);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_9,it); int oldpos14=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
alt6_1: ame_setpos(self,oldpos15);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_11,it); int oldpos16=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
...
ame_setsrc(self,BGET(autovar_13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_14,it); it=CALL(vars_in_Dead_Code_Detector2cb_22,1,bind); int oldpos19=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
...
alt8_1: ame_setpos(self,oldpos20);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_16,it); int oldpos21=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
...
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Dead_Code_Detector2_traverse(self ); FAILTEST(pass2);
 BSET(this_1,it); it=CALL(visit_Dead_Code_Detector2cb_4,1,bind); it=CALL(visit_Dead_Code_Detector2cb_5,1,bind); 
 BSET(autovar_3,it); it=CALL(visit_Dead_Code_Detector2cb_6,1,bind); int oldpos3=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
...
it=CALL(visit_Dead_Code_Detector2cb_7,1,bind); 
 BSET(_result_1,it);  break;case 2:;  it=CALL(visit_Dead_Code_Detector2cb_8,1,bind);  arg0=it; it=Dead_Code_Detector2_clas(self ,arg0); FAILTEST(fail);
...
it=CALL(visit_Dead_Code_Detector2cb_18,1,bind); 
 BSET(_result_1,it);  break;case 4:;  it=CALL(visit_Dead_Code_Detector2cb_19,1,bind);  arg0=it; it=Dead_Code_Detector2_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_11,it); int oldpos11=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Dead_Code_Detector2cb_20,1,bind); 
 BSET(autovar_12,it); it=CALL(visit_Dead_Code_Detector2cb_21,1,bind); int oldpos12=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
...
it=CALL(visit_Dead_Code_Detector2cb_22,1,bind);   it=Dead_Code_Detector2_traverse(self ); FAILTEST(pass11);
 ...
 BSET(autovar_13,it); int oldpos13=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,BGET(autovar_13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Dead_Code_Detector2cb_24,1,bind); 
 BSET(autovar_14,it); it=CALL(visit_Dead_Code_Detector2cb_25,1,bind); int oldpos14=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=CALL(visit_Dead_Code_Deleter2cb_6,1,bind); 
 BSET(_result_1,it);  break;case 2:;  it=CALL(visit_Dead_Code_Deleter2cb_7,1,bind);  arg0=it; it=Dead_Code_Deleter2_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_3,it); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Dead_Code_Deleter2cb_8,1,bind); 
 BSET(name_1,it);   it=Dead_Code_Deleter2_traverse(self ); FAILTEST(pass3);it=CALL(visit_Dead_Code_Deleter2cb_9,1,bind); 
 BSET(expr_1,it); it=CALL(visit_Dead_Code_Deleter2cb_10,1,bind); 
 BSET(this_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 BSET(it_1,it); it=CALL(move_Move_Assignments2cb_4,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_5,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2);
 BSET(el_1,it); int oldpos7=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 int oldpos8=ame_getpos(self);
   it=Move_Assignments2_eof(self ); FAILTEST(reject1); x=1; goto accept4;  reject1: x=0; accept4: it=Qnil; ame_setpos(self,oldpos8); if (x==0) goto alt3_2;it=BGET(el_1);
 BSET(autovar_6,it); it=CALL(move_Move_Assignments2cb_6,1,bind); int oldpos9=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
it=CALL(move_Move_Assignments2cb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_5);
 BSET(ary_1,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt2_2: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
 BSET(it_1,it); it=CALL(move_Move_Assignments2cb_9,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept2;
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(var_1,it); it=CALL(move_Move_Assignments2cb_12,1,bind); 
 BSET(autovar_9,it); it=CALL(move_Move_Assignments2cb_13,1,bind); int oldpos12=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt4_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_3);
 BSET(it_1,it); it=CALL(move_Move_Assignments2cb_16,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept5;
...
alt1_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 BSET(it_1,it); it=CALL(visit_Move_Assignments2cb_9,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_7,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2);
 BSET(el_1,it); int oldpos9=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 int oldpos10=ame_getpos(self);
   it=Move_Assignments2_eof(self ); FAILTEST(reject1); x=1; goto accept4;  reject1: x=0; accept4: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto alt3_2;it=BGET(el_1);
 BSET(autovar_8,it); it=CALL(visit_Move_Assignments2cb_11,1,bind); int oldpos11=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
it=CALL(visit_Move_Assignments2cb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=BGET(autovar_7);
 BSET(ary_1,it); 
	if (CALL(eof,0)==failobj) goto pass4;
	goto success4;
	pass4: fail4=1;
...
alt2_2: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
 BSET(it_1,it); it=CALL(visit_Move_Assignments2cb_14,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept2;
...
alt4_1: ame_setpos(self,oldpos12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
 ...
 BSET(autovar_10,it); int oldpos13=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(visit_Move_Assignments2cb_16,1,bind); 
 BSET(var_1,it); it=CALL(visit_Move_Assignments2cb_17,1,bind); 
 BSET(autovar_11,it); it=CALL(visit_Move_Assignments2cb_18,1,bind); int oldpos14=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt4_2: ame_setpos(self,oldpos12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
   it=AmethystCore_anything(self ); FAILTEST(alt4_3);
 BSET(it_1,it); it=CALL(visit_Move_Assignments2cb_21,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept5;
