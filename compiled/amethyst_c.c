...
static VALUE sy_Amethyst__append_lp__159c;
static VALUE sy_Amethyst__append_lp__19cb;
static VALUE sy_Amethyst__append_lp__29a3;
static VALUE sy_Amethyst__append_lp__2c07;
static VALUE sy_Amethyst__append_lp__3042;
static VALUE sy_Amethyst__append_lp__37c5;
static VALUE sy_Amethyst__append_lp__43a2;
static VALUE sy_Amethyst__append_lp__54e8;
static VALUE sy_Amethyst__append_lp__6106;
static VALUE sy_Amethyst__append_lp__68be;
...
static VALUE sy_Amethyst__append_lp__9546;
static VALUE sy_Amethyst__append_lp__b068;
static VALUE sy_Amethyst__append_lp__bab9;
static VALUE sy_Amethyst__append_lp__be78;
static VALUE sy_Amethyst__append_lp__cbd1;
static VALUE sy_Amethyst__append_lp__d472;
static VALUE sy_Amethyst__append_lp__ed94;
...
static VALUE sy_Amethyst__lp_bind_lb_0_rb__bbdf;
...
return it;
fail: return failobj; }
VALUE Amethyst_int(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(30);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ',':;case '.' ... UC(255):; it=rb_obj_clone(s__d41d); bind_aset(bind,0/*m*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos1=ptr->pos;int cut1=0;
alt1_1:;it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt1_2;
;goto accept1;
alt1_2: ptr->pos=oldpos1;it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt1_3;
;goto accept1;
alt1_3: ptr->pos=oldpos1;it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt1_4;
;goto accept1;
alt1_4: ptr->pos=oldpos1;it=bind_aget(bind,1/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt1_5;
;goto accept1;
alt1_5: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case '0' ... '0':; it=rb_ary_new3(0); bind_aset(bind,3/*autovar*/,it);
int oldpos2=ptr->pos;int cut2=0;
alt2_1:;it=bind_aget(bind,3/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt2_2;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__bab9,1,bind); it=rb_ary_new3(0); bind_aset(bind,6/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto alt2_2; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,7/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__d472,1,bind); int oldpos3;  while(1){oldpos3=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto break1; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__37c5,1,bind);  break;
} } break1: ptr->pos=oldpos3;   it=bind_aget(bind,6/*autovar*/); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__3042,1,bind); 
;goto accept2;
alt2_2: ptr->pos=oldpos2;it=bind_aget(bind,3/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt2_3;it=rb_obj_clone(s_0b_3470); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2c07,1,bind); it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto alt2_3; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,12/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__be78,1,bind); int oldpos4;  while(1){oldpos4=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto break2; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__68be,1,bind);  break;
} } break2: ptr->pos=oldpos4;   it=bind_aget(bind,11/*autovar*/); bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__6106,1,bind); 
;goto accept2;
alt2_3: ptr->pos=oldpos2;it=bind_aget(bind,3/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='o')  ptr->pos+=1; else goto alt2_4;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__43a2,1,bind); it=rb_ary_new3(0); bind_aset(bind,16/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt2_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,17/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__54e8,1,bind); int oldpos5;  while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto break3; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b068,1,bind);  break;
} } break3: ptr->pos=oldpos5;   it=bind_aget(bind,16/*autovar*/); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__159c,1,bind); 
;goto accept2;
alt2_4: ptr->pos=oldpos2;it=bind_aget(bind,3/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_ary_new3(0); bind_aset(bind,20/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__19cb,1,bind); int oldpos6;  while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break4; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,22/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__9546,1,bind);  break;
} } break4: ptr->pos=oldpos6;   it=bind_aget(bind,20/*autovar*/); bind_aset(bind,23/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__ed94,1,bind); 
;goto accept2;
alt2_5: ptr->pos=oldpos2;goto fail;
 accept2:;
 break;
case '1' ... '9':; it=rb_ary_new3(0); bind_aset(bind,24/*autovar*/,it);
int oldpos7=ptr->pos;int cut3=0;
alt3_1:;it=bind_aget(bind,24/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt3_2;
;goto accept7;
alt3_2: ptr->pos=oldpos7;it=bind_aget(bind,24/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt3_3;
;goto accept7;
alt3_3: ptr->pos=oldpos7;it=bind_aget(bind,24/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt3_4;
;goto accept7;
alt3_4: ptr->pos=oldpos7;it=bind_aget(bind,24/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_ary_new3(0); bind_aset(bind,20/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__19cb,1,bind); int oldpos8;  while(1){oldpos8=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break5; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,22/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__9546,1,bind);  break;
} } break5: ptr->pos=oldpos8;   it=bind_aget(bind,20/*autovar*/); bind_aset(bind,23/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__ed94,1,bind); 
;goto accept7;
alt3_5: ptr->pos=oldpos7;goto fail;
 accept7:;
 break;
}it=bind_aget(bind,2/*autovar*/); bind_aset(bind,25/*n*/,it);
it=rb_funcall(self,sy_Amethyst__lp_bind_lb_0_rb__bbdf,1,bind);  bind_aset(bind,26/*_result*/,it);
 break;
case '-' ... '-':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__mi__336d); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,0/*m*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,27/*autovar*/,it);
int oldpos9=ptr->pos;int cut4=0;
alt4_1:;it=bind_aget(bind,27/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt4_2;
;goto accept9;
alt4_2: ptr->pos=oldpos9;it=bind_aget(bind,27/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt4_3;
;goto accept9;
alt4_3: ptr->pos=oldpos9;it=bind_aget(bind,27/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt4_4;
;goto accept9;
alt4_4: ptr->pos=oldpos9;it=bind_aget(bind,27/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt4_5;
;goto accept9;
alt4_5: ptr->pos=oldpos9;goto fail;
 accept9:;
 break;
case '0' ... '0':; it=rb_ary_new3(0); bind_aset(bind,28/*autovar*/,it);
int oldpos10=ptr->pos;int cut5=0;
alt5_1:;it=bind_aget(bind,28/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt5_2;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__bab9,1,bind); it=rb_ary_new3(0); bind_aset(bind,6/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto alt5_2; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,7/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__d472,1,bind); int oldpos11;  while(1){oldpos11=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto break6; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__37c5,1,bind);  break;
} } break6: ptr->pos=oldpos11;   it=bind_aget(bind,6/*autovar*/); bind_aset(bind,9/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__3042,1,bind); 
;goto accept10;
alt5_2: ptr->pos=oldpos10;it=bind_aget(bind,28/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt5_3;it=rb_obj_clone(s_0b_3470); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,10/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2c07,1,bind); it=rb_ary_new3(0); bind_aset(bind,11/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto alt5_3; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,12/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__be78,1,bind); int oldpos12;  while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto break7; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__68be,1,bind);  break;
} } break7: ptr->pos=oldpos12;   it=bind_aget(bind,11/*autovar*/); bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__6106,1,bind); 
;goto accept10;
alt5_3: ptr->pos=oldpos10;it=bind_aget(bind,28/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='o')  ptr->pos+=1; else goto alt5_4;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,15/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__43a2,1,bind); it=rb_ary_new3(0); bind_aset(bind,16/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt5_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,17/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__54e8,1,bind); int oldpos13;  while(1){oldpos13=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto break8; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,18/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b068,1,bind);  break;
} } break8: ptr->pos=oldpos13;   it=bind_aget(bind,16/*autovar*/); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__159c,1,bind); 
;goto accept10;
alt5_4: ptr->pos=oldpos10;it=bind_aget(bind,28/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_ary_new3(0); bind_aset(bind,20/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__19cb,1,bind); int oldpos14;  while(1){oldpos14=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break9; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,22/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__9546,1,bind);  break;
} } break9: ptr->pos=oldpos14;   it=bind_aget(bind,20/*autovar*/); bind_aset(bind,23/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__ed94,1,bind); 
;goto accept10;
alt5_5: ptr->pos=oldpos10;goto fail;
 accept10:;
 break;
case '1' ... '9':; it=rb_ary_new3(0); bind_aset(bind,29/*autovar*/,it);
int oldpos15=ptr->pos;int cut6=0;
alt6_1:;it=bind_aget(bind,29/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt6_2;
;goto accept15;
alt6_2: ptr->pos=oldpos15;it=bind_aget(bind,29/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt6_3;
;goto accept15;
alt6_3: ptr->pos=oldpos15;it=bind_aget(bind,29/*autovar*/); bind_aset(bind,2/*autovar*/,it);
goto alt6_4;
;goto accept15;
alt6_4: ptr->pos=oldpos15;it=bind_aget(bind,29/*autovar*/); bind_aset(bind,2/*autovar*/,it);
it=rb_ary_new3(0); bind_aset(bind,20/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__19cb,1,bind); int oldpos16;  while(1){oldpos16=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break10; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,22/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__9546,1,bind);  break;
} } break10: ptr->pos=oldpos16;   it=bind_aget(bind,20/*autovar*/); bind_aset(bind,23/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__ed94,1,bind); 
;goto accept15;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
it=rb_funcall(self,sy_Amethyst__append_lp__cbd1,1,bind);  if (stop1) goto accept1; } break1: goto fail; accept1:;   it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*it*/,it);
...
it=rb_funcall(self,sy_Amethyst__append_lp__6948,1,bind);  } break1: ptr->pos=oldpos2;   it=bind_aget(bind,3/*autovar*/); bind_aset(bind,7/*autovar*/,it);
...
;goto accept3;
alt2_2: ptr->pos=oldpos3;if (cut2) goto break1;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__81ec,1,bind);   it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f8f8,1,bind); 
;goto accept3;
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=rb_funcall(self,sy_Amethyst_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,6/*_result*/,it);
...
sy_Amethyst__append_lp__159c=rb_intern("Amethyst__append_lp__159c");
sy_Amethyst__append_lp__19cb=rb_intern("Amethyst__append_lp__19cb");
sy_Amethyst__append_lp__29a3=rb_intern("Amethyst__append_lp__29a3");
sy_Amethyst__append_lp__2c07=rb_intern("Amethyst__append_lp__2c07");
sy_Amethyst__append_lp__3042=rb_intern("Amethyst__append_lp__3042");
sy_Amethyst__append_lp__37c5=rb_intern("Amethyst__append_lp__37c5");
sy_Amethyst__append_lp__43a2=rb_intern("Amethyst__append_lp__43a2");
sy_Amethyst__append_lp__54e8=rb_intern("Amethyst__append_lp__54e8");
sy_Amethyst__append_lp__6106=rb_intern("Amethyst__append_lp__6106");
sy_Amethyst__append_lp__68be=rb_intern("Amethyst__append_lp__68be");
...
sy_Amethyst__append_lp__9546=rb_intern("Amethyst__append_lp__9546");
sy_Amethyst__append_lp__b068=rb_intern("Amethyst__append_lp__b068");
sy_Amethyst__append_lp__bab9=rb_intern("Amethyst__append_lp__bab9");
sy_Amethyst__append_lp__be78=rb_intern("Amethyst__append_lp__be78");
sy_Amethyst__append_lp__cbd1=rb_intern("Amethyst__append_lp__cbd1");
sy_Amethyst__append_lp__d472=rb_intern("Amethyst__append_lp__d472");
sy_Amethyst__append_lp__ed94=rb_intern("Amethyst__append_lp__ed94");
...
sy_Amethyst__lp_bind_lb_0_rb__bbdf=rb_intern("Amethyst__lp_bind_lb_0_rb__bbdf");
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
                    rb_eval_string("testversionamethyst('7643c5a2d654b928bfcc5c75474f39a2')");}
