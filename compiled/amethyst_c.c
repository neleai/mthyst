...
it=bind_aget(bind,1/*_result*/); break;case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case UC(33) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(65) ... UC(90):;case UC(97) ... UC(122):;   it=Amethyst_alpha(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(48) ... UC(57):;   it=Amethyst_digit(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(97) ... UC(122):;   it=Amethyst_lower(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(65) ... UC(90):;   it=Amethyst_upper(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(45) ... UC(45):; it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC(48) ... UC(48):; int oldpos2=ame_getpos(self);
...
unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,5/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto alt2_2; break;}it=rb_funcall(self,sy_Amethyst__append_lp__088f,1,bind); int oldpos3; while(1){oldpos3=ame_getpos(self); unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b9cb,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto break1; break;} if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,7/*autovar*/,it);
...
unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,10/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto alt2_3; break;}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); unsigned char chr6=*ame_curstr(self);  switch(chr6){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__c354,1,bind);  break;case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto break2; break;} if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,9/*autovar*/); bind_aset(bind,12/*autovar*/,it);
...
unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt2_4); bind_aset(bind,15/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto alt2_4; break;}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos5; while(1){oldpos5=ame_getpos(self); unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__50ed,1,bind);  break;case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto break3; break;} if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,14/*autovar*/); bind_aset(bind,17/*autovar*/,it);
...
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos6; while(1){oldpos6=ame_getpos(self); unsigned char chr9=*ame_curstr(self);  switch(chr9){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break4; break;} if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  
ame_setcut(self,Qnil);goto accept2;
  alt2_5:  ame_setpos(self,oldpos2); goto fail;
 accept2:;
 break;case UC(49) ... UC(57):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
  it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos7; while(1){oldpos7=ame_getpos(self); unsigned char chr10=*ame_curstr(self);  switch(chr10){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break5); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break5; break;} if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
goto fail; break;}it=bind_aget(bind,0/*autovar*/); bind_aset(bind,22/*n*/,it);
it=rb_funcall(self,sy_Amethyst__lp_bind_lb_2_rb__2af3,1,bind);  bind_aset(bind,23/*_result*/,it);
it=bind_aget(bind,23/*_result*/); break;case UC(0) ... UC(44):;case UC(46) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,2/*m*/,it);
unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(48) ... UC(48):; int oldpos8=ame_getpos(self);
...
it=bind_aget(bind,1/*_result*/); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f8f8,1,bind); it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
unsigned char chr12=*ame_curstr(self);  switch(chr12){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(alt3_2); bind_aset(bind,5/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto alt3_2; break;}it=rb_funcall(self,sy_Amethyst__append_lp__088f,1,bind); int oldpos9; while(1){oldpos9=ame_getpos(self); unsigned char chr13=*ame_curstr(self);  switch(chr13){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b9cb,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto break6; break;} if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__6ac6,1,bind);  
...
it=bind_aget(bind,1/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__0eeb,1,bind); it=rb_ary_new3(0); bind_aset(bind,9/*autovar*/,it);
unsigned char chr14=*ame_curstr(self);  switch(chr14){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(alt3_3); bind_aset(bind,10/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto alt3_3; break;}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos10; while(1){oldpos10=ame_getpos(self); unsigned char chr15=*ame_curstr(self);  switch(chr15){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__c354,1,bind);  break;case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto break7; break;} if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=bind_aget(bind,9/*autovar*/); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__66a2,1,bind);  
ame_setcut(self,Qnil);goto accept3;
...
it=bind_aget(bind,1/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__73f1,1,bind); it=rb_ary_new3(0); bind_aset(bind,14/*autovar*/,it);
unsigned char chr16=*ame_curstr(self);  switch(chr16){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt3_4); bind_aset(bind,15/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto alt3_4; break;}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos11; while(1){oldpos11=ame_getpos(self); unsigned char chr17=*ame_curstr(self);  switch(chr17){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break8); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__50ed,1,bind);  break;case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto break8; break;} if (ame_getstop(self)!=Qnil){{oldpos11=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos11); it=bind_aget(bind,14/*autovar*/); bind_aset(bind,17/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__3aef,1,bind);  
ame_setcut(self,Qnil);goto accept3;
...
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos12; while(1){oldpos12=ame_getpos(self); unsigned char chr18=*ame_curstr(self);  switch(chr18){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break9); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break9; break;} if (ame_getstop(self)!=Qnil){{oldpos12=ame_getpos(self);goto break9;} } } break9: ame_setstop(self,Qnil);  ame_setpos(self,oldpos12); it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  
ame_setcut(self,Qnil);goto accept3;
 ...
 break;case UC(49) ... UC(57):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
  it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos13; while(1){oldpos13=ame_getpos(self); unsigned char chr19=*ame_curstr(self);  switch(chr19){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break10); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break10; break;} if (ame_getstop(self)!=Qnil){{oldpos13=ame_getpos(self);goto break10;} } } break10: ame_setstop(self,Qnil);  ame_setpos(self,oldpos13); it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
goto fail; break;}it=bind_aget(bind,0/*autovar*/); bind_aset(bind,22/*n*/,it);
it=rb_funcall(self,sy_Amethyst__lp_bind_lb_2_rb__2af3,1,bind);  bind_aset(bind,23/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
it=rb_funcall(self,sy_Amethyst__append_lp__cbd1,1,bind);  break;case UC(0) ... UC(9):;case UC(11) ... UC(12):;case UC(14) ... UC(255):;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__cbd1,1,bind);  break;} if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*it*/,it);
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
it=bind_aget(bind,1/*_result*/); break;case UC(10) ... UC(10):;   it=AmethystCore_anything(self ); FAILTEST(fail);it=rb_obj_clone(s__bs_n_1d78); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); bind_aset(bind,1/*_result*/,it);
it=bind_aget(bind,1/*_result*/); break;case UC(0) ... UC(9):;case UC(11) ... UC(12):;case UC(14) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(45) ... UC(45):;case UC(48) ... UC(57):;   it=Amethyst_int(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(44):;case UC(46) ... UC(47):;case UC(58) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(32) ... UC(32):;case UC(9) ... UC(9):;case UC(13) ... UC(13):;case UC(10) ... UC(10):;case UC(12) ... UC(12):;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case UC(33) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
it=rb_funcall(self,sy_Amethyst__append_lp__29a3,1,bind);  break;case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case UC(33) ... UC(255):; goto break1; break;} if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/); bind_aset(bind,3/*_result*/,it);
it=bind_aget(bind,3/*_result*/);
return it;
fail: return failobj; }
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
 break;} if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,sy_Amethyst_bind_lb_0_rb__dot__206f,1,bind);  bind_aset(bind,6/*_result*/,it);
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(64):;case UC(91) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(65) ... UC(90):;case UC(97) ... UC(122):;   it=Amethyst_alpha(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(95) ... UC(95):;   it=AmethystCore_anything(self ); FAILTEST(fail);it=rb_obj_clone(s___b14a); bind_aset(bind,1/*_result*/,it);
it=bind_aget(bind,1/*_result*/); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(64):;case UC(91) ... UC(94):;case UC(96) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto fail; break;}
return it;
fail: return failobj; }
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('7b835cb0b5f1b37cd2144a7c510107be')");}
