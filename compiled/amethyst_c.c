...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos2; int stop1=0; while(1){oldpos2=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop1=1; break;
...
} if (stop1) goto accept2; } break1: goto alt1_4; accept2:;   it=var3/*autovar*/; var6/*autovar*/=it;;
...
int oldpos3=ptr->pos;int cut2=0;
...
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var10/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var10/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var10/*autovar*/=bind_aget(bind2,2);;int oldpos4; int stop2=0; while(1){oldpos4=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; stop2=1; break;
...
} if (stop2) goto accept4; } break2: goto alt2_2; accept4:;   it=var9/*autovar*/; var12/*autovar*/=it;;
...
;goto accept3;
alt2_2: ptr->pos=oldpos3;it=var7/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var15/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var15/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var15/*autovar*/=bind_aget(bind2,2);;int oldpos5; int stop3=0; while(1){oldpos5=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; stop3=1; break;
...
} if (stop3) goto accept5; } break3: goto alt2_3; accept5:;   it=var14/*autovar*/; var17/*autovar*/=it;;
...
;goto accept3;
alt2_3: ptr->pos=oldpos3;it=var7/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos6; int stop4=0; while(1){oldpos6=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop4=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} if (stop4) goto accept6; } break4: goto alt2_4; accept6:;   it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt2_4: ptr->pos=oldpos3;it=var7/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int oldpos7; int stop5=0; while(1){oldpos7=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop5=1; break;
...
} if (stop5) goto accept7; } break5: goto alt2_5; accept7:;   it=var18/*autovar*/; var21/*autovar*/=it;;
...
goto alt3_2;
;goto accept8;
alt3_2: ptr->pos=oldpos8;it=var22/*autovar*/; var1/*autovar*/=it;;
goto alt3_3;
;goto accept8;
alt3_3: ptr->pos=oldpos8;it=var22/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos9; int stop6=0; while(1){oldpos9=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop6=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} if (stop6) goto accept9; } break6: goto alt3_4; accept9:;   it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept8;
alt3_4: ptr->pos=oldpos8;it=var22/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int oldpos10; int stop7=0; while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop7=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} if (stop7) goto accept10; } break7: goto alt3_5; accept10:;   it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept8;
alt3_5: ptr->pos=oldpos8;goto fail;
 accept8:;
 break;
...
int oldpos11=ptr->pos;int cut4=0;
alt4_1:;it=var26/*autovar*/; var1/*autovar*/=it;;
goto alt4_2;
;goto accept11;
alt4_2: ptr->pos=oldpos11;it=var26/*autovar*/; var1/*autovar*/=it;;
goto alt4_3;
;goto accept11;
alt4_3: ptr->pos=oldpos11;it=var26/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos12; int stop8=0; while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop8=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} if (stop8) goto accept12; } break8: goto alt4_4; accept12:;   it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept11;
alt4_4: ptr->pos=oldpos11;it=var26/*autovar*/; var1/*autovar*/=it;;
goto alt4_5;
;goto accept11;
alt4_5: ptr->pos=oldpos11;goto fail;
 accept11:;
 break;
case '0' ... '0':; it=rb_ary_new3(0); var27/*autovar*/=it;;
int oldpos13=ptr->pos;int cut5=0;
...
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var10/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var10/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var10/*autovar*/=bind_aget(bind2,2);;int oldpos14; int stop9=0; while(1){oldpos14=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; stop9=1; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var11/*autovar*/=it;;
bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var11/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var11/*autovar*/=bind_aget(bind2,2);; break;
} if (stop9) goto accept14; } break9: goto alt5_2; accept14:;   it=var9/*autovar*/; var12/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var12/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var12/*autovar*/=bind_aget(bind2,2);;
;goto accept13;
alt5_2: ptr->pos=oldpos13;it=var27/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var15/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var15/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var15/*autovar*/=bind_aget(bind2,2);;int oldpos15; int stop10=0; while(1){oldpos15=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; stop10=1; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var16/*autovar*/=it;;
bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var16/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var16/*autovar*/=bind_aget(bind2,2);; break;
} if (stop10) goto accept15; } break10: goto alt5_3; accept15:;   it=var14/*autovar*/; var17/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var17/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var17/*autovar*/=bind_aget(bind2,2);;
;goto accept13;
alt5_3: ptr->pos=oldpos13;it=var27/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos16; int stop11=0; while(1){oldpos16=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop11=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} if (stop11) goto accept16; } break11: goto alt5_4; accept16:;   it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept13;
alt5_4: ptr->pos=oldpos13;it=var27/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int oldpos17; int stop12=0; while(1){oldpos17=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop12=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} if (stop12) goto accept17; } break12: goto alt5_5; accept17:;   it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept13;
alt5_5: ptr->pos=oldpos13;goto fail;
 accept13:;
 break;
case '1' ... '9':; it=rb_ary_new3(0); var28/*autovar*/=it;;
int oldpos18=ptr->pos;int cut6=0;
alt6_1:;it=var28/*autovar*/; var1/*autovar*/=it;;
goto alt6_2;
;goto accept18;
alt6_2: ptr->pos=oldpos18;it=var28/*autovar*/; var1/*autovar*/=it;;
goto alt6_3;
;goto accept18;
alt6_3: ptr->pos=oldpos18;it=var28/*autovar*/; var1/*autovar*/=it;;
...
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int oldpos19; int stop13=0; while(1){oldpos19=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop13=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} if (stop13) goto accept19; } break13: goto alt6_4; accept19:;   it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept18;
alt6_4: ptr->pos=oldpos18;it=var28/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int oldpos20; int stop14=0; while(1){oldpos20=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop14=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} if (stop14) goto accept20; } break14: goto alt6_5; accept20:;   it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept18;
alt6_5: ptr->pos=oldpos18;goto fail;
 accept18:;
 break;
}it=var1/*autovar*/; var23/*n*/=it;;
...
int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(9):;case UC(11) ... UC(12):;case UC(14) ... UC(255):;   it=AmethystCore_anything(self ); FAILTEST(break1); var1/*autovar*/=it;;
...
case UC(10) ... UC(10):;case UC(13) ... UC(13):; int oldpos2=ptr->pos;int cut1=0;
...
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);; break;
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=var0/*autovar*/; var2/*it*/=it;;
...
alt2_3: ptr->pos=oldpos3;goto break1;
 accept3:;
 if (stop1) goto accept2; } break1: goto alt1_2; accept2:;   it=var3/*autovar*/; var7/*autovar*/=it;;
...
it=rb_ary_new3(0); var0/*autovar*/=it;;
int oldpos1; int stop1=0; while(1){oldpos1=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case '!' ... UC(255):; stop1=1; break;
...
} if (stop1) goto accept1; } break1: goto fail; accept1:;   it=var0/*autovar*/; var3/*_result*/=it;;
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
                    rb_eval_string("testversionamethyst('1db751978e241857a814465d22600232')");}
