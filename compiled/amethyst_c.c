...
alt1_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos2=ptr->pos;int cut2=0;
alt2_1:;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt2_2;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,2/*_result*/,it);
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt2_3;it=rb_obj_clone(s_0b_3470); bind_aset(bind,2/*_result*/,it);
...
;goto accept2;
alt2_3: ptr->pos=oldpos2;if (ame_curstr2(ptr)[0]=='o')  ptr->pos+=1; else goto alt2_4;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,2/*_result*/,it);
...
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
} } break5: ptr->pos=oldpos7;   it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
...
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__mi__336d); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,1/*m*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto fail; break;
case '0' ... '0':; int oldpos8=ptr->pos;int cut3=0;
alt3_1:;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;int oldpos9=ptr->pos;int cut4=0;
alt4_1:;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt4_2;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f8f8,1,bind); it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto alt4_2; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,5/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__088f,1,bind); int oldpos10;  while(1){oldpos10=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto break6; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b9cb,1,bind);  break;
} } break6: ptr->pos=oldpos10;   it=bind_aget(bind,4/*autovar*/); bind_aset(bind,7/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__6ac6,1,bind); 
;goto accept9;
alt4_2: ptr->pos=oldpos9;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt4_3;it=rb_obj_clone(s_0b_3470); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__0eeb,1,bind); it=rb_ary_new3(0); bind_aset(bind,9/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto alt4_3; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,10/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos11;  while(1){oldpos11=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto break7; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__c354,1,bind);  break;
} } break7: ptr->pos=oldpos11;   it=bind_aget(bind,9/*autovar*/); bind_aset(bind,12/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__66a2,1,bind); 
;goto accept9;
alt4_3: ptr->pos=oldpos9;if (ame_curstr2(ptr)[0]=='o')  ptr->pos+=1; else goto alt4_4;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__73f1,1,bind); it=rb_ary_new3(0); bind_aset(bind,14/*autovar*/,it);
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt4_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,15/*autovar*/,it);
 break;
}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos12;  while(1){oldpos12=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto break8; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__50ed,1,bind);  break;
} } break8: ptr->pos=oldpos12;   it=bind_aget(bind,14/*autovar*/); bind_aset(bind,17/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__3aef,1,bind); 
;goto accept9;
alt4_4: ptr->pos=oldpos9;goto alt3_2;
 accept9:;

;goto accept8;
alt3_2: ptr->pos=oldpos8;it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos13;  while(1){oldpos13=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break9; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
} } break9: ptr->pos=oldpos13;   it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind); 
;goto accept8;
...
case '1' ... '9':; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,19/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos14;  while(1){oldpos14=ptr->pos; switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; goto break10; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
} } break10: ptr->pos=oldpos14;   it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  break;
}it=bind_aget(bind,0/*autovar*/); bind_aset(bind,22/*n*/,it);
it=rb_funcall(self,sy_Amethyst__lp_bind_lb_1_rb__5a69,1,bind);  bind_aset(bind,23/*_result*/,it);
 break;
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
                    rb_eval_string("testversionamethyst('840b946d5aa2f1ffb05126d885b7551e')");}
