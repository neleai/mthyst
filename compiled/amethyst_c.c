...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(fail); break;}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(fail); break;}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(45) ... UC(45):; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
...
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
 break;case UC(0) ... UC(44):;case UC(46) ... UC(255):; it=rb_obj_clone(s__d41d); bind_aset(bind,2/*m*/,it);
 break;}unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC(48) ... UC(48):; int oldpos2=ame_getpos(self);
...
unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt2_4); bind_aset(bind,15/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(56) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt2_4); break;}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos5; while(1){oldpos5=ame_getpos(self); unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,16/*autovar*/,it);
...
unsigned char chr9=*ame_curstr(self);  switch(chr9){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(alt2_5); bind_aset(bind,19/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(58) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(alt2_5); break;}it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos6; while(1){oldpos6=ame_getpos(self); unsigned char chr10=*ame_curstr(self);  switch(chr10){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;case UC(0) ... UC(47):;case UC(49) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
unsigned char chr11=*ame_curstr(self);  switch(chr11){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,19/*autovar*/,it);
 break;case UC(0) ... UC(47):;case UC(58) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(fail); break;}it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos7; while(1){oldpos7=ame_getpos(self); unsigned char chr12=*ame_curstr(self);  switch(chr12){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break5); bind_aset(bind,20/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;case UC(0) ... UC(47):;case UC(58) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(break5); break;} if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,18/*autovar*/); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__2bc4,1,bind);  break;}it=bind_aget(bind,0/*autovar*/); bind_aset(bind,22/*n*/,it);
...
it=bind_aget(bind,0/*_result*/); bind_aset(bind,1/*_result*/,it);
it=bind_aget(bind,1/*_result*/); break;case UC(0) ... UC(9):;case UC(11) ... UC(12):;case UC(14) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(fail); break;}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;case UC(0) ... UC(64):;case UC(91) ... UC(94):;case UC(96) ... UC(96):;case UC(123) ... UC(255):;   it=Amethyst_fails(self ); FAILTEST(fail); break;}
return it;
fail: return failobj; }
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('5f1bbeb640039929e9350fb500d1118f')");}
