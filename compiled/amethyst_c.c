...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_2);ame_setcut(self,Qtrue);goto alt1_2;
...
alt1_1: ptr->pos=oldpos1;  it=AmethystCore_anything(self ); FAILTEST(alt1_2);int oldpos2=ptr->pos;
alt2_1: ptr->pos=oldpos2;if (strncmp(ame_curstr(self),"x",1)) goto alt2_2; else ptr->pos+=1;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,2/*_result*/,it);
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;if (strncmp(ame_curstr(self),"b",1)) goto alt2_3; else ptr->pos+=1;it=rb_obj_clone(s_0b_3470); bind_aset(bind,2/*_result*/,it);
...
;goto accept2;
alt2_3: ptr->pos=oldpos2;if (strncmp(ame_curstr(self),"o",1)) goto alt2_4; else ptr->pos+=1;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,2/*_result*/,it);
...
int oldpos8=ptr->pos;
alt3_1: ptr->pos=oldpos8;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);it=rb_obj_clone(s__mi__336d); bind_aset(bind,2/*_result*/,it);
...
alt4_1: ptr->pos=oldpos9;  it=AmethystCore_anything(self ); FAILTEST(alt4_2);int oldpos10=ptr->pos;
alt5_1: ptr->pos=oldpos10;if (strncmp(ame_curstr(self),"x",1)) goto alt5_2; else ptr->pos+=1;it=rb_obj_clone(s_0x_f6f8); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,3/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__f8f8,1,bind); it=rb_ary_new3(0); bind_aset(bind,4/*autovar*/,it);
...
it=rb_funcall(self,sy_Amethyst__append_lp__6ac6,1,bind); 
;goto accept5;
alt5_2: ptr->pos=oldpos10;if (strncmp(ame_curstr(self),"b",1)) goto alt5_3; else ptr->pos+=1;it=rb_obj_clone(s_0b_3470); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__0eeb,1,bind); it=rb_ary_new3(0); bind_aset(bind,9/*autovar*/,it);
...
it=rb_funcall(self,sy_Amethyst__append_lp__66a2,1,bind); 
;goto accept5;
alt5_3: ptr->pos=oldpos10;if (strncmp(ame_curstr(self),"o",1)) goto alt5_4; else ptr->pos+=1;it=rb_obj_clone(s_0o_6f57); bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/); bind_aset(bind,13/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__73f1,1,bind); it=rb_ary_new3(0); bind_aset(bind,14/*autovar*/,it);
...
alt1_1: ptr->pos=oldpos2;  it=Amethyst_newline(self ); FAILTEST(alt1_2);ame_setcut(self,Qtrue); bind_aset(bind,1/*autovar*/,it);
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1; it=bind_aget(bind,1/*rule*/); arg0=it; it=rb_funcall(self,sy_apply,1,arg0); FAILTEST(alt1_2); bind_aset(bind,2/*autovar*/,it);
...
int oldpos1=ptr->pos;
alt1_1: ptr->pos=oldpos1; it=bind_aget(bind,0/*exp*/); arg0=it; it=rb_funcall(self,sy_apply,1,arg0); FAILTEST(alt1_2); bind_aset(bind,1/*it*/,it);
...
alt1_1: ptr->pos=oldpos2;it=bind_aget(bind,1/*e*/); bind_aset(bind,2/*s*/,it);
...
alt2_1: ptr->pos=oldpos3;it=bind_aget(bind,1/*e*/); bind_aset(bind,2/*s*/,it);
...
alt3_1: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt3_2);it=rb_obj_clone(s__bs__bs__7f81); bind_aset(bind,4/*_result*/,it);
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('ba973d1633297ca1212dd8e0bfa5e351')");}
