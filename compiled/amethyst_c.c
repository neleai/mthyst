...
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt1_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt1_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop1=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept1;
...
alt1_5: ptr->pos=oldpos1;goto fail;
 accept1:;
 break;
case '0' ... '0':; it=rb_ary_new3(0); var7/*autovar*/=it;;
int oldpos2=ptr->pos;int cut2=0;
alt2_1:;it=var7/*autovar*/; var1/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt2_2;it=rb_obj_clone(s_0x_f6f8); var8/*autovar*/=it;;
...
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var10/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var10/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var10/*autovar*/=bind_aget(bind2,2);;int stop2=0; while(!stop2){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; stop2=1; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var11/*autovar*/=it;;
...
} } it=var9/*autovar*/; var12/*autovar*/=it;;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;it=var7/*autovar*/; var1/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt2_3;it=rb_obj_clone(s_0b_3470); var13/*autovar*/=it;;
...
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var15/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var15/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var15/*autovar*/=bind_aget(bind2,2);;int stop3=0; while(!stop3){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; stop3=1; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var16/*autovar*/=it;;
...
} } it=var14/*autovar*/; var17/*autovar*/=it;;
...
;goto accept2;
alt2_3: ptr->pos=oldpos2;it=var7/*autovar*/; var1/*autovar*/=it;;
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt2_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt2_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop4=0; while(!stop4){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop4=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept2;
alt2_4: ptr->pos=oldpos2;it=var7/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int stop5=0; while(!stop5){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop5=1; break;
...
} } it=var18/*autovar*/; var21/*autovar*/=it;;
...
goto alt3_2;
;goto accept3;
alt3_2: ptr->pos=oldpos3;it=var22/*autovar*/; var1/*autovar*/=it;;
goto alt3_3;
;goto accept3;
alt3_3: ptr->pos=oldpos3;it=var22/*autovar*/; var1/*autovar*/=it;;
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt3_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt3_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop6=0; while(!stop6){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop6=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt3_4: ptr->pos=oldpos3;it=var22/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int stop7=0; while(!stop7){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop7=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} } it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt3_5: ptr->pos=oldpos3;goto fail;
 accept3:;
 break;
...
goto alt4_2;
;goto accept4;
alt4_2: ptr->pos=oldpos4;it=var26/*autovar*/; var1/*autovar*/=it;;
goto alt4_3;
;goto accept4;
alt4_3: ptr->pos=oldpos4;it=var26/*autovar*/; var1/*autovar*/=it;;
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt4_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt4_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop8=0; while(!stop8){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop8=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept4;
alt4_4: ptr->pos=oldpos4;it=var26/*autovar*/; var1/*autovar*/=it;;
goto alt4_5;
;goto accept4;
alt4_5: ptr->pos=oldpos4;goto fail;
 accept4:;
 break;
case '0' ... '0':; it=rb_ary_new3(0); var27/*autovar*/=it;;
int oldpos5=ptr->pos;int cut5=0;
alt5_1:;it=var27/*autovar*/; var1/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='x')  ptr->pos+=1; else goto alt5_2;it=rb_obj_clone(s_0x_f6f8); var8/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var8/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var8/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var9/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; goto alt5_2; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var10/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var10/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var10/*autovar*/=bind_aget(bind2,2);;int stop9=0; while(!stop9){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... '@':;case 'G' ... '`':;case 'g' ... UC(255):; stop9=1; break;
case '0' ... '9':;case 'A' ... 'F':;case 'a' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var11/*autovar*/=it;;
bind_aset(bind2,1,var9/*autovar*/);bind_aset(bind2,2,var11/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var9/*autovar*/=bind_aget(bind2,1);;var11/*autovar*/=bind_aget(bind2,2);; break;
} } it=var9/*autovar*/; var12/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var12/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var12/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt5_2: ptr->pos=oldpos5;it=var27/*autovar*/; var1/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='b')  ptr->pos+=1; else goto alt5_3;it=rb_obj_clone(s_0b_3470); var13/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var13/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var13/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var14/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; goto alt5_3; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var15/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var15/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var15/*autovar*/=bind_aget(bind2,2);;int stop10=0; while(!stop10){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '2' ... UC(255):; stop10=1; break;
case '0' ... '1':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var16/*autovar*/=it;;
bind_aset(bind2,1,var14/*autovar*/);bind_aset(bind2,2,var16/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var14/*autovar*/=bind_aget(bind2,1);;var16/*autovar*/=bind_aget(bind2,2);; break;
} } it=var14/*autovar*/; var17/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var17/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var17/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt5_3: ptr->pos=oldpos5;it=var27/*autovar*/; var1/*autovar*/=it;;
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt5_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt5_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop11=0; while(!stop11){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop11=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt5_4: ptr->pos=oldpos5;it=var27/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int stop12=0; while(!stop12){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop12=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} } it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept5;
alt5_5: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
...
goto alt6_2;
;goto accept6;
alt6_2: ptr->pos=oldpos6;it=var28/*autovar*/; var1/*autovar*/=it;;
goto alt6_3;
;goto accept6;
alt6_3: ptr->pos=oldpos6;it=var28/*autovar*/; var1/*autovar*/=it;;
if (ame_curstr2(ptr)[0]=='0'&&ame_curstr2(ptr)[1]=='o')  ptr->pos+=2; else goto alt6_4;it=rb_obj_clone(s_0o_6f57); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;it=rb_ary_new3(0); var3/*autovar*/=it;;
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; goto alt6_4; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var4/*autovar*/=it;;
 break;
}bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var4/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var4/*autovar*/=bind_aget(bind2,2);;int stop13=0; while(!stop13){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case '8' ... UC(255):; stop13=1; break;
case '0' ... '7':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var5/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; break;
} } it=var3/*autovar*/; var6/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
alt6_4: ptr->pos=oldpos6;it=var28/*autovar*/; var1/*autovar*/=it;;
it=rb_ary_new3(0); var18/*autovar*/=it;;
it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var19/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var19/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var19/*autovar*/=bind_aget(bind2,2);;int stop14=0; while(!stop14){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '/':;case ':' ... UC(255):; stop14=1; break;
case '0' ... '9':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++; var20/*autovar*/=it;;
bind_aset(bind2,1,var18/*autovar*/);bind_aset(bind2,2,var20/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var18/*autovar*/=bind_aget(bind2,1);;var20/*autovar*/=bind_aget(bind2,2);; break;
} } it=var18/*autovar*/; var21/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var21/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var21/*autovar*/=bind_aget(bind2,2);;
;goto accept6;
alt6_5: ptr->pos=oldpos6;goto fail;
 accept6:;
 break;
}it=var1/*autovar*/; var23/*n*/=it;;
...
int stop1=0; while(!stop1){ switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... UC(9):;case UC(11) ... UC(12):;case UC(14) ... UC(255):;   it=AmethystCore_anything(self ); FAILTEST(fail); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);; break;
case UC(10) ... UC(10):;case UC(13) ... UC(13):; int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=Amethyst_newline(self ); FAILTEST(alt1_2); var1/*autovar*/=it;;
cut1=1;stop1=1;
;goto accept1;
alt1_2: ptr->pos=oldpos1;if (cut1) goto fail;  it=AmethystCore_anything(self ); FAILTEST(alt1_3); var1/*autovar*/=it;;
...
alt2_1:;it=var4/*delim*/; var5/*s*/=it;;
 it=var5/*s*/; arg0=it; it=AmethystCore__seq(self ,arg0); FAILTEST(alt2_2);it=var5/*s*/; it=var1/*rule*/; arg0=it; it=rb_funcall(self,sy_apply,1,arg0); FAILTEST(alt2_2); var6/*autovar*/=it;;
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var6/*autovar*/);it=rb_funcall(self,sy_Amethyst__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var6/*autovar*/=bind_aget(bind2,2);;
;goto accept2;
alt2_2: ptr->pos=oldpos2;stop1=1;
;goto accept2;
alt2_3: ptr->pos=oldpos2;goto alt1_2;
 accept2:;
 } it=var3/*autovar*/; var7/*autovar*/=it;;
...
switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... ',':;case '.' ... '/':;case ':' ... UC(255):; goto fail; break;
case '-' ... '-':;case '0' ... '9':;   it=Amethyst_int(self ); FAILTEST(fail); var0/*_result*/=it;;
 break;
}
return it;
fail: return failobj; }
...
} } it=var0/*autovar*/; var3/*_result*/=it;;
...
VALUE Amethyst_token(VALUE self ,VALUE a0){VALUE vals[1];  VALUE var0;VALUE var1;VALUE var2;VALUE var3; ;VALUE bind2=bind_new2(16); var0/*s*/=a0;; int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
  ...
  it=Amethyst_spaces(self );it=var0/*s*/; var1/*s*/=it;;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;if (cut1) goto fail;it=Qnil;  it=AmethystCore_anything(self ); FAILTEST(alt1_3); var3/*autovar*/=it;;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;if (cut2) goto fail;it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;it=rb_obj_clone(s__bs__bs__7f81); var4/*autovar*/=it;;
...
alt2_3: ptr->pos=oldpos2;goto fail;
 accept2:;
 break;
} } bind_aset(bind2,1,var0/*x*/);it=rb_funcall(self,sy_Amethyst_bind_lb_1_rb__dot__e879,1,bind2);var0/*x*/=bind_aget(bind2,1);; var5/*_result*/=it;;
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
                    rb_eval_string("testversionamethyst('e525f63f2c0c78368053c6e2eda40733')");}
