...
case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case UC(33) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
case UC(48) ... UC(57):;   it=Amethyst_digit(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;
case UC(65) ... UC(90):;   it=Amethyst_upper(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(64):;case UC(91) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,5/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto alt2_2; break;
}it=rb_funcall(self,sy_Amethyst__append_lp__088f,1,bind); int oldpos3; while(1){oldpos3=ame_getpos(self); unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__b9cb,1,bind);  break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto break1; break;
...
unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,10/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto alt2_3; break;
}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); unsigned char chr6=*ame_curstr(self);  switch(chr6){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__c354,1,bind);  break;
case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto break2; break;
...
unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt2_4); bind_aset(bind,15/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto alt2_4; break;
}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos5; while(1){oldpos5=ame_getpos(self); unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__50ed,1,bind);  break;
case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto break3; break;
...
case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break4; break;
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;
case UC(49) ... UC(57):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
...
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break5; break;
...
case UC(0) ... UC(47):;case UC(58) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,18/*autovar*/,it);
goto fail; break;
...
case UC(0) ... UC(44):;case UC(46) ... UC(255):; it=rb_ary_new3(0); bind_aset(bind,0/*autovar*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,2/*m*/,it);
...
unsigned char chr12=*ame_curstr(self);  switch(chr12){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(alt3_2); bind_aset(bind,5/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto alt3_2; break;
...
it=rb_funcall(self,sy_Amethyst__append_lp__b9cb,1,bind);  break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto break6; break;
...
unsigned char chr14=*ame_curstr(self);  switch(chr14){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(alt3_3); bind_aset(bind,10/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto alt3_3; break;
}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos10; while(1){oldpos10=ame_getpos(self); unsigned char chr15=*ame_curstr(self);  switch(chr15){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,11/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__c354,1,bind);  break;
case UC(0) ... UC(47):;case UC(50) ... UC(255):; goto break7; break;
...
unsigned char chr16=*ame_curstr(self);  switch(chr16){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt3_4); bind_aset(bind,15/*autovar*/,it);
 break;
case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto alt3_4; break;
}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos11; while(1){oldpos11=ame_getpos(self); unsigned char chr17=*ame_curstr(self);  switch(chr17){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break8); bind_aset(bind,16/*autovar*/,it);
it=rb_funcall(self,sy_Amethyst__append_lp__50ed,1,bind);  break;
case UC(0) ... UC(47):;case UC(56) ... UC(255):; goto break8; break;
...
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break9; break;
...
it=rb_funcall(self,sy_Amethyst__append_lp__f960,1,bind);  break;
case UC(0) ... UC(47):;case UC(58) ... UC(255):; goto break10; break;
...
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(96):;case UC(123) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(44):;case UC(46) ... UC(47):;case UC(58) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
case UC(0) ... UC(8):;case UC(11) ... UC(11):;case UC(14) ... UC(31):;case UC(33) ... UC(255):; goto break1; break;
...
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(64):;case UC(91) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(65) ... UC(90):;case UC(97) ... UC(122):;   it=Amethyst_alpha(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
it=bind_aget(bind,0/*_result*/); break;
case UC(95) ... UC(95):;   it=AmethystCore_anything(self ); FAILTEST(fail);it=rb_obj_clone(s___b14a); bind_aset(bind,1/*_result*/,it);
...
it=bind_aget(bind,0/*_result*/); break;
case UC(0) ... UC(47):;case UC(58) ... UC(64):;case UC(71) ... UC(96):;case UC(103) ... UC(255):; goto fail; break;
}
return it;
fail: return failobj; }
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('d879386468b732d2e8abbceaadde2bfa')");}
