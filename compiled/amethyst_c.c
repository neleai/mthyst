...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(32) ... UC(32):;case UC(9) ... UC(9):;case UC(13) ... UC(13):;case UC(10) ... UC(10):;case UC(12) ... UC(12):;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(fail); bind_aset(bind,0/*_result*/,it);
...
unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,5/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(alt2_2); bind_aset(bind,5/*autovar*/,it);
 break;}it=rb_funcall(self,sy_Amethyst__append_lp__088f,1,bind); int oldpos3; while(1){oldpos3=ame_getpos(self); unsigned char chr2=*ame_curstr(self);  switch(chr2){case UC(48) ... UC(57):;case UC(97) ... UC(102):;case UC(65) ... UC(70):;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(break1); bind_aset(bind,6/*autovar*/,it);
...
unsigned char chr3=*ame_curstr(self);  switch(chr3){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(alt2_3); bind_aset(bind,10/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(alt2_3); bind_aset(bind,10/*autovar*/,it);
 break;}it=rb_funcall(self,sy_Amethyst__append_lp__0d86,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self); unsigned char chr4=*ame_curstr(self);  switch(chr4){case UC(48) ... UC(48):;case UC(49) ... UC(49):;   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,11/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(break2); bind_aset(bind,11/*autovar*/,it);
...
unsigned char chr5=*ame_curstr(self);  switch(chr5){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(alt2_4); bind_aset(bind,15/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(alt2_4); bind_aset(bind,15/*autovar*/,it);
 break;}it=rb_funcall(self,sy_Amethyst__append_lp__a474,1,bind); int oldpos5; while(1){oldpos5=ame_getpos(self); unsigned char chr6=*ame_curstr(self);  switch(chr6){case UC(48) ... UC(55):;   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,16/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(break3); bind_aset(bind,16/*autovar*/,it);
...
unsigned char chr7=*ame_curstr(self);  switch(chr7){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(alt2_5); bind_aset(bind,19/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(alt2_5); bind_aset(bind,19/*autovar*/,it);
 break;}it=rb_funcall(self,sy_Amethyst__append_lp__26c5,1,bind); int oldpos6; while(1){oldpos6=ame_getpos(self); unsigned char chr8=*ame_curstr(self);  switch(chr8){case UC(48) ... UC(57):;   it=AmethystCore_anything(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(break4); bind_aset(bind,20/*autovar*/,it);
...
int oldpos1; while(1){oldpos1=ame_getpos(self); unsigned char chr1=*ame_curstr(self);  switch(chr1){case UC(32) ... UC(32):;case UC(9) ... UC(9):;case UC(13) ... UC(13):;case UC(10) ... UC(10):;case UC(12) ... UC(12):;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,1/*_result*/,it);
 break;default:;   it=Amethyst_fails(self ); FAILTEST(break1); bind_aset(bind,1/*_result*/,it);
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('484772a94eefb1f9b0e18eb6580c1be2')");}
