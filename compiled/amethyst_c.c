...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,0,it);  break;default:;   it=Amethyst_fails(self ); FAILTEST(fail); break;}it=rb_ary_entry(bind,0);
return it;
fail: return failobj; }
...
rb_define_method(cls_Amethyst,"xdigit",Amethyst_xdigit,0);
 rb_eval_string("testversionamethyst('4617619eb7397e9aef730ddc9522ff36')");}
