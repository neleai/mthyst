...
char chr1=RSTRING(ame_getsrc(self))->ptr[ame_getpos(self)];  switch(chr1){case 13:; int oldpos1=ame_getpos(self);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
case 10:;  it=rb_str_new2("\n"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(fail);
 BSET(_result_1,it); default: goto fail;}it=BGET(_result_1);
return it;
fail: return failobj; }
