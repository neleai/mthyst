...
static VALUE sy_Add_Implicit_Variables__append_lp__984f;
...
static VALUE sy_Add_Implicit_Variables_bind_lb_11_rb__a30c;
...
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Add_Implicit_Variables_traverse_item(self ); FAILTEST(break1); bind_aset(bind,13/*it*/,it);
it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_11_rb__a30c,1,bind);  bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp__984f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,12/*autovar*/);it=bind_aget(bind,11/*ar*/); bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
sy_Add_Implicit_Variables__append_lp__984f=rb_intern("Add_Implicit_Variables__append_lp__984f");
...
sy_Add_Implicit_Variables_bind_lb_11_rb__a30c=rb_intern("Add_Implicit_Variables_bind_lb_11_rb__a30c");
...
rb_define_method(cls_Add_Implicit_Variables,"visit",Add_Implicit_Variables_visit,0);
 rb_eval_string("testversionimplicit_variables('871e9c88b0696e636d12a217fdc7b974')");}
