...
ptr->pos=ptr->len;it=rb_funcall(self,sy_Detect_Implicit_Variables__lp_src_dot_ins_a413,1,bind2); var0/*autovar*/=it;;
...
int oldpos1;  while(1){oldpos1=ptr->pos;   it=Detect_Implicit_Variables_traverse_item(self ); FAILTEST(break1); var3/*autovar*/=it;;
bind_aset(bind2,1,var2/*autovar*/);bind_aset(bind2,2,var3/*autovar*/);it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp__d113,1,bind2);var2/*autovar*/=bind_aget(bind2,1);;var3/*autovar*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos1;   it=var2/*autovar*/; var4/*autovar*/=it;;
...
int oldpos3;  while(1){oldpos3=ptr->pos;   it=Detect_Implicit_Variables_traverse_item(self ); FAILTEST(break1); var5/*autovar*/=it;;
bind_aset(bind2,1,var4/*autovar*/);bind_aset(bind2,2,var5/*autovar*/);it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp__d113,1,bind2);var4/*autovar*/=bind_aget(bind2,1);;var5/*autovar*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos3;   it=var4/*autovar*/; var6/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
alt3_1:;  it=Detect_Implicit_Variables_visit(self ); FAILTEST(alt3_2); var0/*_result*/=it;;
...
ptr->pos=ptr->len;it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
int oldpos3;  while(1){oldpos3=ptr->pos;   it=Add_Implicit_Variables_traverse_item(self ); FAILTEST(break1); var6/*it*/=it;;
bind_aset(bind2,1,var5/*ar*/);bind_aset(bind2,2,var6/*it*/);it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_1_rb__lt__7b20,1,bind2);var5/*ar*/=bind_aget(bind2,1);;var6/*it*/=bind_aget(bind2,2);; } break1: ptr->pos=oldpos3;   it=var5/*ar*/; var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
                   pass2: *ptr=oldpass2; goto alt2_3;
                   success2: *ptr=oldpass2;
...
alt2_4: ptr->pos=oldpos2;goto fail;
 ...
 break;
case 2/*Object*/:; int oldpos4=ptr->pos;int cut3=0;
alt3_1:;  it=Add_Implicit_Variables_visit(self ); FAILTEST(alt3_2); var0/*a*/=it;;
it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed_5352,1,bind2);it=var0/*a*/; var1/*_result*/=it;;
...
ptr->pos=ptr->len;bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables__lp__at_vars_lb_b_160d,1,bind2);var3/*name*/=bind_aget(bind2,1);;FAILTEST(pass1);bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables_l_eq_Local_lb__a11b,1,bind2);var3/*name*/=bind_aget(bind2,1);; var4/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
ptr->pos=ptr->len;bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables__lp__at_vars_lb_b_5cb3,1,bind2);var3/*name*/=bind_aget(bind2,1);;FAILTEST(pass2);bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables_l_eq_Local_lb__2887,1,bind2);var3/*name*/=bind_aget(bind2,1);; var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
rb_define_method(cls_Add_Implicit_Variables,"visit",Add_Implicit_Variables_visit,0);
                    rb_eval_string("testversionimplicit_variables('8413334914f0bd9bb7eb2f934993940a')");}
