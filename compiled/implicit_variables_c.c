...
it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars_eq_Ha,1,bind);   it=Detect_Implicit_Variables_traverse(self ); FAILTEST(fail);it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars,1,bind); 
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Detect_Implicit_Variables__lp_src_dot_ins,1,bind); 
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables_bind_lb_2_rb__eq_,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 bind_aset(bind,1/*name*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars_lb_bi,1,bind); it=rb_ary_new3(0);
 bind_aset(bind,2/*autovar*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 bind_aset(bind,3/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,2/*autovar*/);
...
VALUE Add_Implicit_Variables_root(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__at_vars_eq_bi,1,bind);  it=c_Rule; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(fail);
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,2/*oldchanged*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_src,1,bind); 
 bind_aset(bind,3/*this*/,it); it=Qnil;
 bind_aset(bind,4/*clon*/,it); it=Qfalse;
 bind_aset(bind,5/*changed*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__lp_src_dot_ins,1,bind); 
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_6_rb__eq_,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,11/*val*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__lp_bind_lb_4_rb_,1,bind); 
...
it=bind_aget(bind,12/*autovar*/);
 bind_aset(bind,13/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp_5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
it=rb_funcall(self,sy_Add_Implicit_Variables_if_sp_bind_lb_,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed,1,bind); it=bind_aget(bind,0/*a*/);
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_5_rb__lt_,1,bind); 
...
rb_define_method(cls_Add_Implicit_Variables,"visit",Add_Implicit_Variables_visit,0);
 rb_eval_string("testversionimplicit_variables('f55ecef4b746d4985ddaa361d4145979')");}
