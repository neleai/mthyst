...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_Detect_Implicit_Variables__lp_src_dot_ins_a413,1,bind2); var0/*autovar*/=it;;
...
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed_c681,1,bind2); var0/*oldchanged*/=it;;
...
alt2_3: ptr->pos=oldpos2;goto pass1;
 accept2:;
 } bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables__lp__at_vars_lb_b_160d,1,bind2);var3/*name*/=bind_aget(bind2,1);;FAILTEST(pass1);bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables_l_eq_Local_lb__a11b,1,bind2);var3/*name*/=bind_aget(bind2,1);; var4/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
alt3_3: ptr->pos=oldpos3;goto pass2;
 accept3:;
 } bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables__lp__at_vars_lb_b_5cb3,1,bind2);var3/*name*/=bind_aget(bind2,1);;FAILTEST(pass2);bind_aset(bind2,1,var3/*name*/);it=rb_funcall(self,sy_Add_Implicit_Variables_l_eq_Local_lb__2887,1,bind2);var3/*name*/=bind_aget(bind2,1);; var7/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
rb_define_method(cls_Add_Implicit_Variables,"visit",Add_Implicit_Variables_visit,0);
                    rb_eval_string("testversionimplicit_variables('dadf61e187507b002d3500447ea94202')");}
