...
static VALUE sy_Detect_Implicit_Variables__append_lp_1;
static VALUE sy_Detect_Implicit_Variables__append_lp_2;
static VALUE sy_Detect_Implicit_Variables__append_lp_3;
static VALUE sy_Detect_Implicit_Variables__at_vars1;
static VALUE sy_Detect_Implicit_Variables__at_vars_eq_Ha1;
static VALUE sy_Detect_Implicit_Variables__at_vars_lb_bi1;
static VALUE sy_Detect_Implicit_Variables__lp_src_dot_ins1;
static VALUE sy_Detect_Implicit_Variables_bind_lb_2_rb__eq_1;
...
it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars_eq_Ha1,1,bind);   it=Detect_Implicit_Variables_traverse(self ); FAILTEST(fail);it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars1,1,bind); 
...
it=rb_ary_new3(0);
 ...
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Detect_Implicit_Variables__lp_src_dot_ins1,1,bind); 
 bind_aset(bind,2/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables_bind_lb_2_rb__eq_1,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,4/*autovar*/);
...
ame_setsrc(self,bind_aget(bind,3/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_2,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,4/*autovar*/);
 bind_aset(bind,6/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
ame_setsrc(self,bind_aget(bind,0/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass1);
 bind_aset(bind,1/*name*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__at_vars_lb_bi1,1,bind); it=rb_ary_new3(0);
 bind_aset(bind,2/*autovar*/,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 bind_aset(bind,3/*autovar*/,it); it=rb_funcall(self,sy_Detect_Implicit_Variables__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,2/*autovar*/);
...
static VALUE c_Apply;
static VALUE c_Rule;
static VALUE sy_Add_Implicit_Variables_Append_lb_b1;
static VALUE sy_Add_Implicit_Variables__Bind_lp_bi1;
static VALUE sy_Add_Implicit_Variables__append_lp_1;
...
static VALUE sy_Add_Implicit_Variables__at_changed1;
static VALUE sy_Add_Implicit_Variables__at_changed2;
static VALUE sy_Add_Implicit_Variables__at_changed3;
static VALUE sy_Add_Implicit_Variables__at_vars_eq_bi1;
static VALUE sy_Add_Implicit_Variables__lp__at_vars_lb_b1;
static VALUE sy_Add_Implicit_Variables__lp__at_vars_lb_b2;
static VALUE sy_Add_Implicit_Variables__lp_bind_lb_4_rb_1;
static VALUE sy_Add_Implicit_Variables__lp_src_dot_ins1;
static VALUE sy_Add_Implicit_Variables_bind_lb_5_rb__lt_1;
static VALUE sy_Add_Implicit_Variables_bind_lb_6_rb__eq_1;
static VALUE sy_Add_Implicit_Variables_if1;
static VALUE sy_Add_Implicit_Variables_src1;
static VALUE sy_size;
VALUE Add_Implicit_Variables_root(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 bind_aset(bind,0/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__at_vars_eq_bi1,1,bind);  it=c_Rule; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(fail);
...
it=rb_ary_new3(0);
 bind_aset(bind,0/*autovar*/,it); int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1);
 bind_aset(bind,1/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp_4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed2,1,bind); 
 bind_aset(bind,2/*oldchanged*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_src1,1,bind); 
 bind_aset(bind,3/*this*/,it); it=Qnil;
 bind_aset(bind,4/*clon*/,it); it=Qfalse;
 bind_aset(bind,5/*changed*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__lp_src_dot_ins1,1,bind); 
 bind_aset(bind,6/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_6_rb__eq_1,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,9/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,10/*key*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed3,1,bind);   it=Add_Implicit_Variables_traverse_item(self ); FAILTEST(pass3);
 bind_aset(bind,11/*val*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__lp_bind_lb_4_rb_1,1,bind); 
...
it=bind_aget(bind,12/*autovar*/);
 bind_aset(bind,13/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp_5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos4); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos3); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos2); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
it=rb_funcall(self,sy_Add_Implicit_Variables_if1,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 ...
 bind_aset(bind,0/*a*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__at_changed1,1,bind); it=bind_aget(bind,0/*a*/);
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,7/*it*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables_bind_lb_5_rb__lt_1,1,bind); 
 bind_aset(bind,8/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp_3,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/);
...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 ...
 bind_aset(bind,5/*autovar*/,it); it=rb_funcall(self,sy_Add_Implicit_Variables__append_lp_1,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,4/*autovar*/);it=rb_funcall(self,sy_Add_Implicit_Variables__lp__at_vars_lb_b1,1,bind); FAILTEST(pass1);it=rb_funcall(self,sy_Add_Implicit_Variables__Bind_lp_bi1,1,bind); 
...
sy_Detect_Implicit_Variables__append_lp_1=rb_intern("Detect_Implicit_Variables__append_lp_1");
...
sy_Detect_Implicit_Variables__at_vars1=rb_intern("Detect_Implicit_Variables__at_vars1");
sy_Detect_Implicit_Variables__at_vars_eq_Ha1=rb_intern("Detect_Implicit_Variables__at_vars_eq_Ha1");
sy_Detect_Implicit_Variables__at_vars_lb_bi1=rb_intern("Detect_Implicit_Variables__at_vars_lb_bi1");
sy_Detect_Implicit_Variables__lp_src_dot_ins1=rb_intern("Detect_Implicit_Variables__lp_src_dot_ins1");
sy_Detect_Implicit_Variables_bind_lb_2_rb__eq_1=rb_intern("Detect_Implicit_Variables_bind_lb_2_rb__eq_1");
...
sy_Add_Implicit_Variables_Append_lb_b1=rb_intern("Add_Implicit_Variables_Append_lb_b1");
sy_Add_Implicit_Variables__Bind_lp_bi1=rb_intern("Add_Implicit_Variables__Bind_lp_bi1");
sy_Add_Implicit_Variables__append_lp_1=rb_intern("Add_Implicit_Variables__append_lp_1");
...
sy_Add_Implicit_Variables__at_changed1=rb_intern("Add_Implicit_Variables__at_changed1");
...
sy_Add_Implicit_Variables__at_vars_eq_bi1=rb_intern("Add_Implicit_Variables__at_vars_eq_bi1");
sy_Add_Implicit_Variables__lp__at_vars_lb_b1=rb_intern("Add_Implicit_Variables__lp__at_vars_lb_b1");
sy_Add_Implicit_Variables__lp__at_vars_lb_b2=rb_intern("Add_Implicit_Variables__lp__at_vars_lb_b2");
sy_Add_Implicit_Variables__lp_bind_lb_4_rb_1=rb_intern("Add_Implicit_Variables__lp_bind_lb_4_rb_1");
sy_Add_Implicit_Variables__lp_src_dot_ins1=rb_intern("Add_Implicit_Variables__lp_src_dot_ins1");
sy_Add_Implicit_Variables_bind_lb_5_rb__lt_1=rb_intern("Add_Implicit_Variables_bind_lb_5_rb__lt_1");
sy_Add_Implicit_Variables_bind_lb_6_rb__eq_1=rb_intern("Add_Implicit_Variables_bind_lb_6_rb__eq_1");
sy_Add_Implicit_Variables_if1=rb_intern("Add_Implicit_Variables_if1");
sy_Add_Implicit_Variables_src1=rb_intern("Add_Implicit_Variables_src1");
sy_size=rb_intern("size");
...
rb_define_method(cls_Add_Implicit_Variables,"visit",Add_Implicit_Variables_visit,0);
 rb_eval_string("testversionimplicit_variables('39b3fd8d0d86bfb95d04e7f022a6df8c')");}
