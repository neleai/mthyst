...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(arg_AmethystOptimizercb_5,1,bind); it=AmethystOptimizer_clas(self ,arg0); FAILTEST(alt1_3);
...
alt2_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 ...
 BSET(c_1,it); it=CALL(arg_AmethystOptimizercb_6,1,bind); FAILTEST(alt2_2);it=BGET(c_1);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(arg_AmethystOptimizercb_9,1,bind); it=AmethystOptimizer_clas(self ,arg0); FAILTEST(alt1_4);
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(arg_AmethystOptimizercb_12,1,bind); it=AmethystOptimizer_clas(self ,arg0); FAILTEST(alt1_5);
...
ame_setsrc(self,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_10,it); it=CALL(arg_AmethystOptimizercb_15,1,bind); int oldpos9=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
it=CALL(arg_AmethystOptimizercb_16,1,bind); 
 BSET(autovar_11,it); it=CALL(arg_AmethystOptimizercb_17,1,bind); int oldpos10=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
...
ISET(cut,Qnil);goto accept2;
 ...
 BSET(autovar_2,it); it=CALL(itrans_AmethystOptimizercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_1);
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_8,it); it=CALL(trans_AmethystOptimizercb_21,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=BGET(autovar_7);
 BSET(ary_1,it); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_24,1,bind); FAILTEST(alt1_5);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_11,it); it=CALL(trans_AmethystOptimizercb_25,1,bind);  if (IGET(stop)!=Qnil){{oldpos10=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos10); it=BGET(autovar_10);
 BSET(ary_1,it); 
...
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystOptimizercb_27,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_6);
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_28,1,bind); FAILTEST(alt1_6);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_13,it); it=CALL(trans_AmethystOptimizercb_29,1,bind); it=CALL(trans_AmethystOptimizercb_30,1,bind); 
 BSET(neg_1,it); 
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_33,1,bind); FAILTEST(alt1_7);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_16,it); it=CALL(trans_AmethystOptimizercb_34,1,bind);  if (IGET(stop)!=Qnil){{oldpos13=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos13); it=BGET(autovar_15);
 BSET(ary_1,it); 
...
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_37,1,bind); FAILTEST(alt1_8);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_18,it); it=CALL(trans_AmethystOptimizercb_38,1,bind); it=CALL(trans_AmethystOptimizercb_39,1,bind); 
 BSET(o_1,it); 
...
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_42,1,bind); FAILTEST(alt1_9);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_20,it); it=CALL(trans_AmethystOptimizercb_43,1,bind);   it=AmethystOptimizer_args(self ); FAILTEST(pass11);
 BSET(autovar_21,it); it=CALL(trans_AmethystOptimizercb_44,1,bind); 
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_47,1,bind); FAILTEST(alt1_10);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_23,it); it=CALL(trans_AmethystOptimizercb_49,1,bind); int oldpos17=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
...
it=CALL(trans_AmethystOptimizercb_50,1,bind); 
 BSET(autovar_24,it); it=CALL(trans_AmethystOptimizercb_51,1,bind); int oldpos18=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_54,1,bind); FAILTEST(alt1_11);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(ary_1,it); it=CALL(trans_AmethystOptimizercb_55,1,bind); 
 BSET(pred_1,it); it=CALL(trans_AmethystOptimizercb_56,1,bind); 
 BSET(pure_1,it); 
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_59,1,bind); FAILTEST(alt1_12);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_26)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystOptimizercb_61,1,bind); 
 BSET(autovar_27,it); it=CALL(trans_AmethystOptimizercb_62,1,bind); int oldpos21=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
...
it=CALL(trans_AmethystOptimizercb_63,1,bind); 
 BSET(autovar_28,it); it=CALL(trans_AmethystOptimizercb_64,1,bind); int oldpos22=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_67,1,bind); FAILTEST(alt1_13);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_31,it); it=CALL(trans_AmethystOptimizercb_68,1,bind);  if (IGET(stop)!=Qnil){{oldpos24=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos24); it=BGET(autovar_30);
 BSET(ary_1,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_71,1,bind); FAILTEST(alt1_14);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_33,it); it=CALL(trans_AmethystOptimizercb_73,1,bind); int oldpos26=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=ame_getsrc(self); int fail21=0;
...
it=CALL(trans_AmethystOptimizercb_74,1,bind); 
 BSET(autovar_34,it); it=CALL(trans_AmethystOptimizercb_75,1,bind); int oldpos27=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_78,1,bind); FAILTEST(alt1_15);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_81,1,bind); FAILTEST(alt1_16);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystOptimizercb_84,1,bind); FAILTEST(alt1_17);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_37)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos31; while(1){oldpos31=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos31=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos31); it=CALL(trans_AmethystOptimizercb_85,1,bind); 
 BSET(_result_2,it); 
