...
ISET(cut,Qnil);goto accept1;
 ...
 rb_ary_store(bind,10,it);  break;}it=CALL(itrans_Seq_Or_Optimizercb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=rb_ary_entry(bind,0);
...
return it;
fail: return failobj; }
VALUE Seq_Or_Optimizer_traverse(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=CALL(traverse_Seq_Or_Optimizercb_1,1,bind); 
 ...
 rb_ary_store(bind,3,it); it=CALL(traverse_Seq_Or_Optimizercb_3,1,bind); 
 rb_ary_store(bind,4,it); it=CALL(traverse_Seq_Or_Optimizercb_4,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,7,it); it=CALL(traverse_Seq_Or_Optimizercb_5,1,bind);   it=Seq_Or_Optimizer_traverse_item(self ); FAILTEST(pass3);
 rb_ary_store(bind,8,it); it=CALL(traverse_Seq_Or_Optimizercb_6,1,bind);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
 ...
 if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass2);
  ...
  it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=CALL(traverse_Seq_Or_Optimizercb_7,1,bind); 
...
it=rb_ary_new3(0);char chr1=FIX2INT(CALL(switchcbSeq_Or_Optimizer3,1,ame_curobj(self)));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,rb_ary_entry(bind,2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 rb_ary_store(bind,3,it); it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=Seq_Or_Optimizer_traverse_item(self ); FAILTEST(break1);
...
return it;
fail: return failobj; }
VALUE Seq_Or_Optimizer_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(15);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Seq_Or_Optimizer_traverse(self ); FAILTEST(pass1);
 rb_ary_store(bind,1,it); int oldpos2=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(visit_Seq_Or_Optimizercb_1,1,bind); 
 rb_ary_store(bind,2,it);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: ame_setsrc(self,oldsrc2); ame_setpos(self,oldpos2); ame_setlen(self,oldlen2);
	if(fail2) goto pass1;
it=rb_ary_entry(bind,2);
 rb_ary_store(bind,3,it);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,rb_ary_entry(bind,5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Seq_Or_Optimizer_traverse(self ); FAILTEST(pass3);
 rb_ary_store(bind,6,it); int oldpos5=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_entry(bind,6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=CALL(visit_Seq_Or_Optimizercb_2,1,bind); 
 rb_ary_store(bind,7,it);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass4);
	goto success4;
	pass4: fail4=1;
...
it=rb_ary_entry(bind,8);
 rb_ary_store(bind,4,it);  break;case 2:; int oldpos7=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_2);
 rb_ary_store(bind,9,it); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_entry(bind,9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,10,it); it=CALL(visit_Seq_Or_Optimizercb_3,1,bind); FAILTEST(pass5);it=CALL(visit_Seq_Or_Optimizercb_4,1,bind);   it=AmethystCore_anything(self ); FAILTEST(pass5);
 rb_ary_store(bind,11,it); it=CALL(visit_Seq_Or_Optimizercb_5,1,bind); FAILTEST(pass5);it=CALL(visit_Seq_Or_Optimizercb_6,1,bind); 
 rb_ary_store(bind,12,it);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 rb_ary_store(bind,13,it); int oldpos9=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,rb_ary_entry(bind,13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 rb_ary_store(bind,10,it); it=CALL(visit_Seq_Or_Optimizercb_7,1,bind); FAILTEST(pass6);  it=AmethystCore_anything(self ); FAILTEST(pass6);
 rb_ary_store(bind,11,it); it=CALL(visit_Seq_Or_Optimizercb_8,1,bind); FAILTEST(pass6);it=CALL(visit_Seq_Or_Optimizercb_9,1,bind); 
 rb_ary_store(bind,14,it);   it=Seq_Or_Optimizer_eof(self ); FAILTEST(pass6);
	goto success6;
	pass6: fail6=1;
	success6: ame_setsrc(self,oldsrc6); ame_setpos(self,oldpos9); ame_setlen(self,oldlen6);
	if(fail6) goto alt1_3;
it=rb_ary_entry(bind,14);
 rb_ary_store(bind,4,it);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos7); goto fail;
 accept1:;
 break;case 3:; int oldpos10=ame_getpos(self);
  alt2_1:  ame_setpos(self,oldpos10); goto fail;
 accept2:;
 break;}it=rb_ary_entry(bind,4);
return it;
fail: return failobj; }
void Init_optimizer_and_or_c(){ 
 cls_Seq_Or_Optimizer=rb_define_class("Seq_Or_Optimizer",rb_const_get(rb_cObject,rb_intern("Traverser_Clone2"))); 
...
rb_define_method(cls_Seq_Or_Optimizer,"visit",Seq_Or_Optimizer_visit,0);
 rb_eval_string("testversionoptimizer_and_or('836ac4c731c326819fd3d23fdb7f1cb1')");}
