...
(it=(_pass(true,autovar_2){_result_2 = ((it=(procargs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
autovar_3 = ((_result_2))
_result_1 = ((autovar_3))
(_result_1)  
end
...
r_2 = ((nil))
_result_2 = ((nil))
(it=(seq(o_2));return FAIL if it==FAIL;it)
...
r_2 = ((autovar_1))
(it=(seq(c_2));return FAIL if it==FAIL;it)
_result_2 = ((r_2))
autovar_3 = ((_result_2))
r_1 = ((autovar_3))
autovar_4 = ((r_1+[',']))
(it=(_pass(false,autovar_4){autovar_5 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){_result_1 = ((it=(procargs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
def grammar()
 name_1 = ((nil))
...
r_2 = ((nil))
_result_3 = ((nil))
(it=(seq(o_3));next FAIL if it==FAIL;it)
...
r_2 = ((autovar_1))
(it=(seq(c_3));next FAIL if it==FAIL;it)
_result_3 = ((r_2))
autovar_3 = ((_result_3))
r_1 = ((autovar_3))
autovar_4 = ((r_1+[',']))
(it=(_pass(false,autovar_4){autovar_5 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){_result_2 = ((it=(procargs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
autovar_6 = ((_result_2))
_result_1 = ((autovar_6)) },proc{(it=(empty());next FAIL if it==FAIL;it)
...
autovar_4 = ((r_1+[',']))
(it=(_pass(false,autovar_4){autovar_5 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){(it=(procargs());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{(it=(empty());next FAIL if it==FAIL;it)}));next FAIL if it==FAIL;it)
s_1 = (("="))
(it=(spaces());next FAIL if it==FAIL;it)
...
autovar_1 = ((_result_2))
c_1 = ((autovar_1))
_result_1 = (("\\#{c_1}")) },proc{o_1 = (('#{','}'))
r_1 = ((nil))
_result_3 = ((nil))
r_1 = ((it=(__args(o_1,c_3));next FAIL if it==FAIL;it))
_result_3 = ((Args[{:ary=>([o_1]+r_1+[c_3])}]))
autovar_2 = ((_result_3))
_result_1 = ((autovar_2)) },proc{c_2 = ((nil))
_result_2 = ((nil))
c_2 = ((it=(anything());next FAIL if it==FAIL;it))
(it=((c_2.is_a? String )||FAIL);next FAIL if it==FAIL;it)
_result_2 = ((c_2))
...
autovar_4 = ((r_1+[',']))
(it=(_pass(false,autovar_4){autovar_5 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){(it=(procargs());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_2 = (()) },proc{(it=(empty());next FAIL if it==FAIL;it)
_result_2 = (()) }));return FAIL if it==FAIL;it)
autovar_6 = ((_result_2))
arg_1 = ((autovar_6))
...
(it=(seq("`"));next FAIL if it==FAIL;it)
_result_1 = ((Exp[_body(e_1)])) },proc{c_1 = ((')'))
o_1 = (('('))
r_1 = ((nil))
_result_2 = ((nil))
c_2 = ((c_1))
...
r_2 = ((nil))
_result_3 = ((nil))
(it=(seq(o_2));next FAIL if it==FAIL;it)
(it=(token(""));next FAIL if it==FAIL;it)
autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(rubyarg());break FAIL if it==FAIL;it))
...
r_2 = ((autovar_1))
(it=(seq(c_2));next FAIL if it==FAIL;it)
_result_3 = ((r_2))
autovar_3 = ((_result_3))
r_1 = ((autovar_3))
_result_2 = ((Args[{:ary=>([o_1]+r_1+[c_1])}]))
autovar_4 = ((_result_2))
_result_1 = ((autovar_4)) },proc{c_1 = ((']'))
o_1 = (('['))
r_1 = ((nil))
_result_2 = ((nil))
c_2 = ((c_1))
...
_result_2 = ((Args[{:ary=>([o_1]+r_1+[c_1])}]))
autovar_4 = ((_result_2))
_result_1 = ((autovar_4)) },proc{it=((it=(seq("\""));next FAIL if it==FAIL;it))
 s_1||=[];_append(s_1,it)
autovar_5 = (([]))
while true
...
@cut=true;it
it=(@stop=true;it)
 autovar_5||=[];_append(autovar_5,it) },proc{it=((it=(eChar());next FAIL if it==FAIL;it))
...
autovar_7 = (([]))
while true
autovar_8=@input;r=(it=(_or(proc{(it=(seq("\'"));next FAIL if it==FAIL;it)
@cut=true;it
it=(@stop=true;it)
 autovar_7||=[];_append(autovar_7,it) },proc{it=((it=(eChar());next FAIL if it==FAIL;it))
...
_result_4 = (())
(it=(spaces());next FAIL if it==FAIL;it)
_result_4 = ((it=(seq(s_2));next FAIL if it==FAIL;it))
autovar_9 = ((_result_4))
n_1 = ((autovar_9)) },proc{regex_1 = ((/[$.:]/))
c_3 = ((nil))
_result_5 = ((nil))
c_4 = ((nil))
_result_6 = ((nil))
c_4 = ((it=(anything());next FAIL if it==FAIL;it))
(it=((c_4.is_a? String )||FAIL);next FAIL if it==FAIL;it)
_result_6 = ((c_4))
autovar_10 = ((_result_6))
c_3 = ((autovar_10))
(it=((regex_1.match(c_3))||FAIL);next FAIL if it==FAIL;it)
_result_5 = ((c_3))
autovar_11 = ((_result_5))
n_1 = ((autovar_11)) },proc{(it=(empty());next FAIL if it==FAIL;it)}));next FAIL if it==FAIL;it)
...
_result_5 = ((c_3))
autovar_11 = ((_result_5))
_result_1 = ((autovar_11)) }));return FAIL if it==FAIL;it)
(_result_1)  
end
def addargs()
 name_1 = ((nil))
...
autovar_6 = ((_result_2))
autovar_7 = ((autovar_6))
(it=(_pass(false,autovar_7){autovar_8 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){_result_1 = ((it=(addargs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
def key()
 name_1 = ((nil))
...
(it=(_pass(true,autovar_5){(it=(procargs());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_2 = (()) },proc{(it=(empty());next FAIL if it==FAIL;it)
_result_2 = (()) }));next FAIL if it==FAIL;it)
autovar_6 = ((_result_2))
args_1 = ((autovar_6))
