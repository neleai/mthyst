...
_Bind(bind[15],bind[6],bind[16])
end
def prefixed_AmethystParsercb_12(bind)
Seq[_Bind("it",bind[6]) , Act[bind[17]] ]
end
...
def parser_version
'4579e6f9d2071c99ad3c9303d199e3df'
end
