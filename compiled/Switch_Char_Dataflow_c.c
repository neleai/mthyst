...
VALUE profile_report_Switch_Char_Dataflow(VALUE self){cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);  return Qnil;}VALUE Switch_Char_Dataflow_first(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,_autovar_3=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_str=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_autovar_10=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,_autovar_13=Qnil,__result=Qnil;VALUE bind2=bind_new2(1);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Char_Dataflow_1,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; int oldpos1=ptr->pos;int cut1=0;
...
switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Char_Dataflow_2,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:; it=_autovar_3; _autovar_4=it;;
int oldpos2=ptr->pos;int cut2=0;
alt2_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=4; it=_autovar_4; _autovar_5=it;;
...
case '_' ... '_':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='s'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='q')  ptr->pos+=3; else if (1){it=failobj;goto pass2;} break;
                ...
                if (1){it=failobj;goto revert2;}
;goto accept4;revert2:;  goto alt2_2; accept4:;

;ptr->branches-=4; goto accept3;
alt2_2: ptr->pos=oldpos2;ptr->branches-=1; it=_autovar_4; _autovar_6=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_6);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'q':;case 's' ... UC(255):; if (1){it=failobj;goto pass3;} break;
case 'r' ... 'r':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='e'&&ame_curstr2(ptr)[1]=='g'&&ame_curstr2(ptr)[2]=='c'&&ame_curstr2(ptr)[3]=='h')  ptr->pos+=4; else if (1){it=failobj;goto pass3;} break;
}
                   goto success3;
                   pass3: *ptr=oldpass3;if (1){it=failobj;goto revert3;}
                   success3: *ptr=oldpass3;
                it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar_7=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                ...
                bind_aset(bind2,1,_str);it=rb_funcall(self,sy_Switch_Char_Dataflow_regchar_lp__90af,1,bind2);_str=bind_aget(bind2,1);; _autovar_8=it;;
...
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else if (1){it=failobj;goto pass5;} break;
}
                   goto success5;
                   pass5: *ptr=oldpass5;if (1){it=failobj;goto revert4;}
                   success5: *ptr=oldpass5;
                it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__e0e5,1,bind2); _autovar_8=it;;

;goto accept6;revert4:;  goto alt2_4; accept6:;

;ptr->branches-=2; goto accept3;
alt2_4: ptr->pos=oldpos2;ptr->branches-=1; it=_autovar_4; _autovar_10=it;;
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_10);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... UC(255):; if (1){it=failobj;goto pass6;} break;
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else if (1){it=failobj;goto pass6;} break;
}
                   goto success6;
                   pass6: *ptr=oldpass6;if (1){it=failobj;goto revert5;}
                   success6: *ptr=oldpass6;
                it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__5a9e,1,bind2); _autovar_8=it;;

;goto accept7;revert5:;  goto alt2_5; accept7:;
...
alt3_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=4; it=_autovar_11; _autovar_5=it;;
...
case '_' ... '_':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='s'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='q')  ptr->pos+=3; else if (1){it=failobj;goto pass7;} break;
                   ...
                   goto success7;
                   pass7: *ptr=oldpass7;if (1){it=failobj;goto revert6;}
...
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_12);
                     it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto pass8;} _str=it;;

                   goto success8;
                   pass8: *ptr=oldpass8;if (1){it=failobj;goto revert6;}
                   success8: *ptr=oldpass8;
                bind_aset(bind2,1,_str);it=rb_funcall(self,sy_Switch_Char_Dataflow_firstcha_f284,1,bind2);_str=bind_aget(bind2,1);; _autovar_8=it;;

;goto accept9;revert6:;  goto alt3_2; accept9:;

;ptr->branches-=4; goto accept8;
alt3_2: ptr->pos=oldpos3;ptr->branches-=1; it=_autovar_11; _autovar_6=it;;
cstruct oldpass9=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_6);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'q':;case 's' ... UC(255):; if (1){it=failobj;goto pass9;} break;
case 'r' ... 'r':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='e'&&ame_curstr2(ptr)[1]=='g'&&ame_curstr2(ptr)[2]=='c'&&ame_curstr2(ptr)[3]=='h')  ptr->pos+=4; else if (1){it=failobj;goto pass9;} break;
}
                   goto success9;
                   pass9: *ptr=oldpass9;if (1){it=failobj;goto revert7;}
                   success9: *ptr=oldpass9;
                if (1){it=failobj;goto revert7;}
;goto accept10;revert7:;  goto alt3_3; accept10:;

;ptr->branches-=3; goto accept8;
alt3_3: ptr->pos=oldpos3;ptr->branches-=1; it=_autovar_11; _autovar_9=it;;
cstruct oldpass10=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_9);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; if (1){it=failobj;goto pass10;} break;
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else if (1){it=failobj;goto pass10;} break;
}
                   goto success10;
...
;goto accept11;revert8:;  goto alt3_4; accept11:;

;ptr->branches-=2; goto accept8;
alt3_4: ptr->pos=oldpos3;ptr->branches-=1; it=_autovar_11; _autovar_10=it;;
cstruct oldpass11=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_10);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... UC(255):; if (1){it=failobj;goto pass11;} break;
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else if (1){it=failobj;goto pass11;} break;
}
                   goto success11;
...
;goto accept12;revert9:;  goto alt3_5; accept12:;

;ptr->branches-=1; goto accept8;
alt3_5: ptr->pos=oldpos3;ptr->branches-=1;if (1){it=failobj;goto pass1;};
 accept8:;
 break;
case 2/*Object*/:; it=_autovar_3; _autovar_13=it;;
int oldpos4=ptr->pos;int cut4=0;
alt4_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=4; it=_autovar_13; _autovar_5=it;;
cstruct oldpass12=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_5);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '^':;case '`' ... UC(255):; if (1){it=failobj;goto pass12;} break;
case '_' ... '_':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='s'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='q')  ptr->pos+=3; else if (1){it=failobj;goto pass12;} break;
}
                   goto success12;
                   pass12: *ptr=oldpass12;if (1){it=failobj;goto revert10;}
                   success12: *ptr=oldpass12;
                if (1){it=failobj;goto revert10;}
;goto accept14;revert10:;  goto alt4_2; accept14:;

;ptr->branches-=4; goto accept13;
alt4_2: ptr->pos=oldpos4;ptr->branches-=1; it=_autovar_13; _autovar_6=it;;
cstruct oldpass13=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_6);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'q':;case 's' ... UC(255):; if (1){it=failobj;goto pass13;} break;
case 'r' ... 'r':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='e'&&ame_curstr2(ptr)[1]=='g'&&ame_curstr2(ptr)[2]=='c'&&ame_curstr2(ptr)[3]=='h')  ptr->pos+=4; else if (1){it=failobj;goto pass13;} break;
}
                   goto success13;
                   pass13: *ptr=oldpass13;if (1){it=failobj;goto revert11;}
                   success13: *ptr=oldpass13;
                if (1){it=failobj;goto revert11;}
;goto accept15;revert11:;  goto alt4_3; accept15:;

;ptr->branches-=3; goto accept13;
alt4_3: ptr->pos=oldpos4;ptr->branches-=1; it=_autovar_13; _autovar_9=it;;
...
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else if (1){it=failobj;goto pass14;} break;
}
                   goto success14;
                   pass14: *ptr=oldpass14;if (1){it=failobj;goto revert12;}
                   success14: *ptr=oldpass14;
                it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__e0e5,1,bind2); _autovar_8=it;;

;goto accept16;revert12:;  goto alt4_4; accept16:;

;ptr->branches-=2; goto accept13;
alt4_4: ptr->pos=oldpos4;ptr->branches-=1; it=_autovar_13; _autovar_10=it;;
cstruct oldpass15=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar_10);
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'e':;case 'g' ... UC(255):; if (1){it=failobj;goto pass15;} break;
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else if (1){it=failobj;goto pass15;} break;
}
                   goto success15;
                   pass15: *ptr=oldpass15;if (1){it=failobj;goto revert13;}
                   success15: *ptr=oldpass15;
                it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__5a9e,1,bind2); _autovar_8=it;;

;goto accept17;revert13:;  goto alt4_5; accept17:;

;ptr->branches-=1; goto accept13;
alt4_5: ptr->pos=oldpos4;ptr->branches-=1;if (1){it=failobj;goto pass1;};
 accept13:;
 break;
}
                   goto success1;
...
alt1_2: ptr->pos=oldpos1;ptr->branches-=1;   it=Switch_Char_Dataflow_first_Switch_Char_Dataflow(self ); if (it==failobj){it=failobj;goto revert14;} __result=it;;

;goto accept18;revert14:;  goto alt1_3; accept18:;

;ptr->branches-=1; goto accept1;
alt1_3: ptr->pos=oldpos1;ptr->branches-=1;if (1){it=failobj;goto fail;};
 accept1:;
 break;
case 1/*Object*/:;   it=Switch_Char_Dataflow_first_Switch_Char_Dataflow(self ); if (it==failobj){it=failobj;goto fail;} __result=it;;
 break;
}
fail: return it;
}
VALUE Switch_Char_Dataflow_first_Switch_Char_Dataflow(VALUE self ){VALUE vals[0]; VALUE it ,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil,_autovar_3=Qnil,_name=Qnil,_autovar_4=Qnil,_autovar_5=Qnil,_autovar_6=Qnil,_autovar_7=Qnil,_autovar_8=Qnil,_autovar_9=Qnil,_val=Qnil,_autovar_10=Qnil,_vals=Qnil,_autovar_11=Qnil,_autovar_12=Qnil,_p=Qnil,_v=Qnil,_autovar_13=Qnil,_autovar_14=Qnil,_el=Qnil,_autovar_15=Qnil,_autovar_16=Qnil,_nev=Qnil,_autovar_17=Qnil;VALUE bind2=bind_new2(2);   cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);switch(FIX2LONG(rb_hash_aref(switchhash_Switch_Char_Dataflow_3,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*CAct*/:case 2/*Cut*/:case 3/*Local*/:case 4/*Lookahead*/:case 5/*Pass*/:case 6/*Result*/:case 7/*Stop*/:; it=ptr->ary[ptr->pos];            ;ptr->pos++; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ame_setsrc2(self,_autovar);
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__5a9e,1,bind2); _autovar_2=it;;
...
ptr->pos=ptr->len;bind_aset(bind2,1,_name);it=rb_funcall(self,sy_Switch_Char_Dataflow__lp_Compile_7f7b,1,bind2);_name=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto pass2;};bind_aset(bind2,1,_name);it=rb_funcall(self,sy_Switch_Char_Dataflow_Compiler_558e,1,bind2);_name=bind_aget(bind2,1);; _autovar_4=it;;
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
;ptr->branches-=2; goto accept1;
alt1_2: ptr->pos=oldpos1;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert2;}it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
alt2_2: ptr->pos=oldpos2;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert4;}it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_val);it=rb_funcall(self,sy_Switch_Char_Dataflow_bind_lb_1_rb_,1,bind2);_val=bind_aget(bind2,1);; _autovar_10=it;;
...
alt3_2: ptr->pos=oldpos3;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert6;}it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
bind_aset(bind2,1,_p);bind_aset(bind2,2,_v);it=rb_funcall(self,sy_Switch_Char_Dataflow_bind_lb_1_rb__dot__c5d5,1,bind2);_p=bind_aget(bind2,1);;_v=bind_aget(bind2,2);; _autovar_13=it;;
...
alt5_3: ptr->pos=oldpos5;ptr->branches-=1;if (1){it=failobj;goto pass6;};
 accept12:;
                   ...
                   success6: *ptr=oldpass6;
                bind_aset(bind2,1,_vals);it=rb_funcall(self,sy_Switch_Char_Dataflow_bind_lb_1_rb__dot__a37c,1,bind2);_vals=bind_aget(bind2,1);; __result=it;;

;goto accept11;revert7:;  goto alt4_2; accept11:;

;ptr->branches-=2; goto accept10;
alt4_2: ptr->pos=oldpos4;ptr->branches-=1;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto revert10;}it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
...
cstruct oldpass8=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__5a9e,1,bind2); _val=it;;
...
bind_aset(bind2,1,_val);bind_aset(bind2,2,_nev);it=rb_funcall(self,sy_Switch_Char_Dataflow_bind_lb_1_rb__dot__159a,1,bind2);_val=bind_aget(bind2,1);;_nev=bind_aget(bind2,2);; _val=it;;
int oldpos7=ptr->pos;int cut7=0;
alt7_1:if(!ptr->branches)ptr->discard=ptr->pos; ptr->branches+=2; bind_aset(bind2,1,_el);it=rb_funcall(self,sy_Switch_Char_Dataflow__lp_,1,bind2);_el=bind_aget(bind2,1);;if (it==failobj){it=failobj;goto revert12;};ptr->pos=ptr->len;
;goto accept19;revert12:;  goto alt7_2; accept19:;

;ptr->branches-=2; goto accept18;
alt7_2: ptr->pos=oldpos7;ptr->branches-=1; it=rb_funcall(self,sy_Switch_Char_Dataflow__d41d,1,bind2);
...
alt6_3: ptr->pos=oldpos6;ptr->branches-=1;if (1){it=failobj;goto pass8;};
 ...
 break;
case 15/*Object*/:;   it=AmethystCore_anything(self ); if (it==failobj){it=failobj;goto fail;}it=rb_funcall(self,sy_Switch_Char_Dataflow_lattice_dot__b0f6,1,bind2); __result=it;;
 break;
}
fail: return it;
}
VALUE Switch_Char_Dataflow_getvalue(VALUE self ,VALUE a0){VALUE vals[1]; VALUE it ,_v=Qnil,_autovar=Qnil,_autovar_2=Qnil,__result=Qnil;VALUE bind2=bind_new2(1); _v=a0;;  cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);bind_aset(bind2,1,_v);it=rb_funcall(self,sy_Switch_Char_Dataflow__at_vis_eq_bin_8b89,1,bind2);_v=bind_aget(bind2,1);; _autovar=it;;
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=_autovar;ptr->len=1;
                     it=Switch_Char_Dataflow_first(self ); if (it==failobj){it=failobj;goto pass1;} _autovar_2=it;;
