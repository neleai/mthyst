...
bind[:autovar_31]=[bind[:autovar_31]]
end
...
def trans_AmethystCTranslatorcb_120(bind)
@faillabel=bind[:word_1] 
end
def trans_AmethystCTranslatorcb_121(bind)
bind[:prc_1]
end
def trans_AmethystCTranslatorcb_122(bind)
@faillabel=bind[:rwo_1]; bind[:x_1] 
end
def trans_AmethystCTranslatorcb_123(bind)
...
_append(bind[:autovar_23],bind[:autovar_24])
end
