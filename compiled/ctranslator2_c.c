...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_73e4;
...
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_73e4,1,bind);  bind_aset(bind,103/*autovar*/,it);
...
sy_AmethystCTranslator_h_eq__dq_VALUE_73e4=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_73e4");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('48507d1d0a09cb82a84fe7533af8e612')");}
