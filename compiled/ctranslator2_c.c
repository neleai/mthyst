...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_9dc3;
...
success40:
        *ptr=oldpass40;
        ...
        it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_9dc3,1,bind2);
        _name=bind_aget(bind2,1);;
...
void Init_ctranslator2_c() {
    ...
    switchhash_AmethystCTranslator_10=rb_eval_string("Hash.new{|h,k|next h[k]=0 if k<=Or\nnext h[k]=1 if k<=Object\n}");
    rb_global_variable(&switchhash_AmethystCTranslator_10);;
    switchhash_AmethystCTranslator_11=rb_eval_string("Hash.new{|h,k|next h[k]=0 if k<=Apply\nnext h[k]=1 if k<=Object\n}");
    rb_global_variable(&switchhash_AmethystCTranslator_11);;
    switchhash_AmethystCTranslator_12=rb_eval_string("Hash.new{|h,k|next h[k]=0 if k<=Stop\nnext h[k]=1 if k<=Object\n}");
    ...
    sy_AmethystCTranslator_h_eq__dq_VALUE_9dc3=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_9dc3");
    ...
    rb_eval_string("testversionctranslator2('be2cb3c6b3fe3057fddb80ffd1bde64a')");
}
