...
static VALUE sy_AmethystCTranslator__append_lp__d83e;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__3a51;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__95c6;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_01e6;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_5ca3;
...
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__8e5a;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__cc64;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__cd3e;
...
unsigned char chr1=FIX2LONG(rb_hash_aref(switchhashAmethystCTranslator2,rb_obj_class(ame_curobj(self))));  switch(chr1){case 0:; int oldpos1=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;case 2:; int oldpos3=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
 break;case 3:; int oldpos4=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
 break;case 4:; int oldpos5=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 break;case 5:; int oldpos6=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept6;
 ...
 accept6:;
 break;case 6:; int oldpos8=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept7;
 ...
 accept7:;
 break;case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,2/*_result*/,it);
...
it=bind_aget(bind,68/*autovar*/); bind_aset(bind,31/*t*/,it);
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass20); bind_aset(bind,69/*rbcode*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq_VALUE_sp_c_8bbf,1,bind);  bind_aset(bind,20/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__8e5a,1,bind);  bind_aset(bind,70/*autovar*/,it);
...
it=bind_aget(bind,70/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 6:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,71/*autovar*/,it);
...
it=bind_aget(bind,72/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,73/*autovar*/,it);
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,74/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind);  bind_aset(bind,75/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,76/*oldpos*/,it);
it=bind_aget(bind,75/*reject*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass24); bind_aset(bind,31/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_01e6,1,bind);  bind_aset(bind,77/*autovar*/,it);
...
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b_6df7,1,bind);  bind_aset(bind,79/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,76/*oldpos*/,it);
it=bind_aget(bind,79/*brk*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,31/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_5ca3,1,bind);  bind_aset(bind,80/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,76/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,82/*alt*/,it);
...
int oldpos9; while(1){oldpos9=ame_getpos(self); int oldpos10=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_83_rb__7cae,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__3a51,1,bind);  bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind);  bind_aset(bind,85/*_result*/,it);
it=bind_aget(bind,85/*_result*/); bind_aset(bind,86/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d83e,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,84/*autovar*/); bind_aset(bind,31/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__cd3e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__cc64,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__95c6,1,bind);  bind_aset(bind,87/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__d83e=rb_intern("AmethystCTranslator__append_lp__d83e");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__3a51=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__3a51");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__95c6=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__95c6");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_01e6=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_01e6");
sy_AmethystCTranslator__dq_int_sp__sh__le_b_5ca3=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_5ca3");
...
sy_AmethystCTranslator_bind_lb_20_rb__8e5a=rb_intern("AmethystCTranslator_bind_lb_20_rb__8e5a");
sy_AmethystCTranslator_bind_lb_20_rb__cc64=rb_intern("AmethystCTranslator_bind_lb_20_rb__cc64");
sy_AmethystCTranslator_bind_lb_20_rb__cd3e=rb_intern("AmethystCTranslator_bind_lb_20_rb__cd3e");
