...
static VALUE sy_AmethystCTranslator_bind_lb_50_rb_;
static VALUE sy_AmethystCTranslator_bind_lb_67_rb_;
static VALUE sy_AmethystCTranslator_bind_lb_87_rb_;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(92);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
int oldpos18=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
...
int oldpos19=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
ame_setsrc(self,bind_aget(bind,47/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass15); bind_aset(bind,22/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_8,1,bind);  bind_aset(bind,48/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos14);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,42/*autovar*/); bind_aset(bind,49/*autovar*/,it);
int oldpos20=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=ame_getsrc(self); int fail16=0;
ame_setsrc(self,bind_aget(bind,49/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass16); bind_aset(bind,25/*name*/,it);
it=i_0; bind_aset(bind,50/*ii*/,it);
it=rb_ary_new3(0); bind_aset(bind,51/*autovar*/,it);
int oldpos21; while(1){oldpos21=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,52/*aa*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_50_rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_9,1,bind);  bind_aset(bind,53/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_8,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos21=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos21); it=bind_aget(bind,51/*autovar*/); bind_aset(bind,54/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_10,1,bind);  bind_aset(bind,55/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_11,1,bind);  bind_aset(bind,56/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldpos14); goto fail;
 accept1:;
 break;case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,58/*autovar*/,it);
int oldpos22=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
ame_setsrc(self,bind_aget(bind,58/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCTranslator_trans(self ); FAILTEST(pass17); bind_aset(bind,59/*e*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_12,1,bind);  bind_aset(bind,60/*autovar*/,it);
...
int oldpos23=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
...
int oldpos24; while(1){oldpos24=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); bind_aset(bind,63/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_9,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos24=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos24); it=bind_aget(bind,62/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_ar_eq__ti_src_dot_,1,bind);  bind_aset(bind,64/*autovar*/,it);
...
ame_setsrc(self,bind_aget(bind,65/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
...
int oldpos26=ame_getpos(self); int oldlen20=ame_getlen(self); VALUE oldsrc20=ame_getsrc(self); int fail20=0;
ame_setsrc(self,bind_aget(bind,66/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_AmethystCTranslator__at_grammar,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_lambdas,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_defs_eq__lb__rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_defmeth,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_faillab4,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_callbac2,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_mktable_lp_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_header_eq_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_init_eq__lb__rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_rule,1,bind);  bind_aset(bind,67/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_67_rb_,1,bind); int oldpos27=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=ame_getsrc(self); int fail21=0;
ame_setsrc(self,bind_aget(bind,67/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass21); bind_aset(bind,68/*autovar*/,it);
int oldpos28=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
ame_setsrc(self,bind_aget(bind,68/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_ary_new3(0); bind_aset(bind,69/*autovar*/,it);
int oldpos29; while(1){oldpos29=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,70/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_10,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos29=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos29); it=bind_aget(bind,69/*autovar*/); bind_aset(bind,71/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass22);
	goto success22;
	pass22: fail22=1;
	success22: ame_setsrc(self,oldsrc22); ame_setpos(self,oldpos28); ame_setlen(self,oldlen22);
	if(fail22) goto pass21;
it=bind_aget(bind,71/*autovar*/); bind_aset(bind,32/*t*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass21);
	goto success21;
	pass21: fail21=1;
	success21: ame_setsrc(self,oldsrc21); ame_setpos(self,oldpos27); ame_setlen(self,oldlen21);
	if(fail21) goto pass20;
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass20); bind_aset(bind,72/*rbcode*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_13,1,bind);  bind_aset(bind,22/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_22_rb_4,1,bind);  bind_aset(bind,73/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass20);
	goto success20;
	pass20: fail20=1;
	success20: ame_setsrc(self,oldsrc20); ame_setpos(self,oldpos26); ame_setlen(self,oldlen20);
	if(fail20) goto fail;
...
int oldpos30=ame_getpos(self); int oldlen23=ame_getlen(self); VALUE oldsrc23=ame_getsrc(self); int fail23=0;
...
int oldpos31; while(1){oldpos31=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,76/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_11,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos31=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos31); it=bind_aget(bind,75/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_14,1,bind);  bind_aset(bind,77/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass23);
	goto success23;
	pass23: fail23=1;
	success23: ame_setsrc(self,oldsrc23); ame_setpos(self,oldpos30); ame_setlen(self,oldlen23);
	if(fail23) goto fail;
...
int oldpos32=ame_getpos(self); int oldlen24=ame_getlen(self); VALUE oldsrc24=ame_getsrc(self); int fail24=0;
ame_setsrc(self,bind_aget(bind,78/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp_,1,bind);  bind_aset(bind,79/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp_2,1,bind);  bind_aset(bind,80/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp_3,1,bind);  bind_aset(bind,9/*oldpos*/,it);
it=bind_aget(bind,80/*reject*/); bind_aset(bind,14/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab,1,bind);  bind_aset(bind,15/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab2,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass24); bind_aset(bind,32/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_15,1,bind);  bind_aset(bind,81/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass24);
	goto success24;
	pass24: fail24=1;
	success24: ame_setsrc(self,oldsrc24); ame_setpos(self,oldpos32); ame_setlen(self,oldlen24);
	if(fail24) goto fail;
it=bind_aget(bind,81/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 8:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,82/*autovar*/,it);
int oldpos33=ame_getpos(self); int oldlen25=ame_getlen(self); VALUE oldsrc25=ame_getsrc(self); int fail25=0;
ame_setsrc(self,bind_aget(bind,82/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp_4,1,bind);  bind_aset(bind,83/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp_3,1,bind);  bind_aset(bind,9/*oldpos*/,it);
it=bind_aget(bind,83/*brk*/); bind_aset(bind,14/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab,1,bind);  bind_aset(bind,15/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab2,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,32/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_16,1,bind);  bind_aset(bind,84/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass25);
	goto success25;
	pass25: fail25=1;
	success25: ame_setsrc(self,oldsrc25); ame_setpos(self,oldpos33); ame_setlen(self,oldlen25);
	if(fail25) goto fail;
it=bind_aget(bind,84/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 9:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,85/*autovar*/,it);
int oldpos34=ame_getpos(self); int oldlen26=ame_getlen(self); VALUE oldsrc26=ame_getsrc(self); int fail26=0;
ame_setsrc(self,bind_aget(bind,85/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),sy_size,0)));
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp_,1,bind);  bind_aset(bind,79/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab,1,bind);  bind_aset(bind,13/*fail*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp_3,1,bind);  bind_aset(bind,9/*oldpos*/,it);
 it=rb_obj_clone(s_alt); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,86/*alt*/,it);
it=i_0; bind_aset(bind,87/*altno*/,it);
it=rb_ary_new3(0); bind_aset(bind,88/*autovar*/,it);
int oldpos35; while(1){oldpos35=ame_getpos(self); int oldpos36=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos36); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_87_rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_17,1,bind);  bind_aset(bind,14/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab,1,bind);  bind_aset(bind,15/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,19/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind);  bind_aset(bind,89/*_result*/,it);
it=bind_aget(bind,89/*_result*/); bind_aset(bind,90/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_12,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos35=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos35); it=bind_aget(bind,88/*autovar*/); bind_aset(bind,32/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_22_rb_5,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_22_rb_6,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_18,1,bind);  bind_aset(bind,91/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass26);
	goto success26;
	pass26: fail26=1;
	success26: ame_setsrc(self,oldsrc26); ame_setpos(self,oldpos34); ame_setlen(self,oldlen26);
	if(fail26) goto fail;
...
sy_AmethystCTranslator_bind_lb_50_rb_=rb_intern("AmethystCTranslator_bind_lb_50_rb_");
sy_AmethystCTranslator_bind_lb_67_rb_=rb_intern("AmethystCTranslator_bind_lb_67_rb_");
sy_AmethystCTranslator_bind_lb_87_rb_=rb_intern("AmethystCTranslator_bind_lb_87_rb_");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('2baf0b8e2d203d9076d01ae4ff5297ae')");}
