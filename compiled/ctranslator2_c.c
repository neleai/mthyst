...
it=CALL(addlambda_AmethystCTranslatorcb_1,1,bind); 
 BSET(lambd_1,it); it=CALL(addlambda_AmethystCTranslatorcb_2,1,bind); 
 BSET(prc_1,it); it=CALL(addlambda_AmethystCTranslatorcb_3,1,bind); 
 BSET(word_1,it); it=CALL(addlambda_AmethystCTranslatorcb_4,1,bind); 
 BSET(rwo_1,it); it=CALL(addlambda_AmethystCTranslatorcb_5,1,bind);  arg0=CALL(addlambda_AmethystCTranslatorcb_6,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos3; while(1){oldpos3=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(rbtrans_AmethystCTranslatorcb_3,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_3,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break2);
 BSET(autovar_4,it); it=CALL(rbtrans_AmethystCTranslatorcb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=BGET(autovar_3);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(rbtrans_AmethystCTranslatorcb_10,1,bind); FAILTEST(alt1_4);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_6,it); int oldpos7; while(1){oldpos7=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break3);
 BSET(autovar_7,it); it=CALL(rbtrans_AmethystCTranslatorcb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos7); it=BGET(autovar_6);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(rbtrans_AmethystCTranslatorcb_15,1,bind); FAILTEST(alt1_5);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_9,it); int oldpos9; while(1){oldpos9=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break4);
 BSET(autovar_10,it); it=CALL(rbtrans_AmethystCTranslatorcb_17,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_9);
 BSET(a_1,it); 
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(rbtrans_AmethystCTranslatorcb_20,1,bind); FAILTEST(alt1_6);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(rbtrans_AmethystCTranslatorcb_21,1,bind); 
 BSET(name_1,it); 
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(rbtrans_AmethystCTranslatorcb_24,1,bind); FAILTEST(alt1_7);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
it=CALL(rbtrans_AmethystCTranslatorcb_25,1,bind); 
 BSET(_result_2,it);  
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(rbtrans_AmethystCTranslatorcb_26,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_8);
 BSET(i_1,it); it=CALL(rbtrans_AmethystCTranslatorcb_27,1,bind); FAILTEST(alt1_8);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_12,1,bind); 
 BSET(autovar_4,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break1);
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_10,it); it=CALL(trans_AmethystCTranslatorcb_26,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_9);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_27,1,bind); 
 BSET(cbno_1,it); it=CALL(trans_AmethystCTranslatorcb_28,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it); int oldpos10=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_5;}
   it=CALL(anything,0 ); FAILTEST(alt2_2);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_30,1,bind); FAILTEST(alt2_2);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_12,it); it=CALL(trans_AmethystCTranslatorcb_31,1,bind); int oldpos12=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,BGET(autovar_12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(s_2,it);   it=CALL(spaces,0 ); FAILTEST(pass9); arg0=CALL(trans_AmethystCTranslatorcb_33,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(pass9);
...
it=CALL(trans_AmethystCTranslatorcb_34,1,bind); 
 BSET(_result_2,it); 
	...
	if(fail7) goto alt2_2;
 
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_5;}
   it=CALL(anything,0 ); FAILTEST(alt2_3);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind); FAILTEST(alt2_3);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_14,it); int oldpos14=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystCTranslatorcb_36,1,bind); 
 BSET(autovar_15,it); int oldpos15; while(1){oldpos15=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_37,1,bind); 
 BSET(autovar_16,it); it=CALL(trans_AmethystCTranslatorcb_38,1,bind);  if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos15); it=BGET(autovar_15);
 BSET(args_1,it); it=CALL(trans_AmethystCTranslatorcb_39,1,bind); 
 BSET(s_3,it); it=CALL(trans_AmethystCTranslatorcb_40,1,bind); 
...
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos10); goto alt1_5;
 accept2:;
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_6);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_42,1,bind); FAILTEST(alt1_6);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_18,it); int oldpos17; while(1){oldpos17=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break4);
 BSET(autovar_19,it); it=CALL(trans_AmethystCTranslatorcb_44,1,bind);  if (IGET(stop)!=Qnil){{oldpos17=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos17); it=BGET(autovar_18);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_45,1,bind); 
 BSET(_result_2,it); 
...
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_46,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_7);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_47,1,bind); FAILTEST(alt1_7);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_21,it); it=CALL(trans_AmethystCTranslatorcb_49,1,bind); int oldpos19=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
...
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_8);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_52,1,bind); FAILTEST(alt1_8);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_22,it); int oldpos20=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,BGET(autovar_22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_54,1,bind); 
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_55,1,bind); 
 BSET(oldpos_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_56,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass14);
 BSET(alt_1,it); it=CALL(trans_AmethystCTranslatorcb_57,1,bind); 
 BSET(altno_1,it); it=CALL(trans_AmethystCTranslatorcb_58,1,bind); 
 BSET(autovar_23,it); int oldpos21; while(1){oldpos21=ame_getpos(self); int oldpos22=ame_getpos(self);
   it=CALL(anything,0 ); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos22); if (x==0) goto break5;it=CALL(trans_AmethystCTranslatorcb_59,1,bind); it=CALL(trans_AmethystCTranslatorcb_60,1,bind); 
 BSET(prc_1,it); it=CALL(trans_AmethystCTranslatorcb_61,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_62,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_63,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_64,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(break5);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_65,1,bind); 
 BSET(_result_4,it); it=BGET(_result_4);
 BSET(autovar_24,it); it=CALL(trans_AmethystCTranslatorcb_66,1,bind);  if (IGET(stop)!=Qnil){{oldpos21=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos21); it=BGET(autovar_23);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_67,1,bind); it=CALL(trans_AmethystCTranslatorcb_68,1,bind); it=CALL(trans_AmethystCTranslatorcb_69,1,bind); 
 BSET(_result_2,it); 
...
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_71,1,bind); FAILTEST(alt1_9);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_25,it); int oldpos23=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_74,1,bind); FAILTEST(alt1_10);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_26,it); int oldpos24=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=ame_getsrc(self); int fail16=0;
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_76,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_11);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_77,1,bind); FAILTEST(alt1_11);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_27)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(brk_1,it); it=CALL(trans_AmethystCTranslatorcb_79,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_80,1,bind); 
 BSET(prc_1,it); it=CALL(trans_AmethystCTranslatorcb_81,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_82,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_83,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_84,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(pass17);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_85,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_86,1,bind); 
 BSET(_result_2,it); 
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_87,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_12);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_88,1,bind); FAILTEST(alt1_12);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_28,it); int oldpos26=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
ame_setsrc(self,BGET(autovar_28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_90,1,bind); 
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_91,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_92,1,bind); 
 BSET(prc_1,it); it=CALL(trans_AmethystCTranslatorcb_93,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_94,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_95,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_96,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(pass18);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_97,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_98,1,bind); 
 BSET(_result_2,it); 
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_100,1,bind); FAILTEST(alt1_13);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos28; while(1){oldpos28=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break6); if (IGET(stop)!=Qnil){{oldpos28=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos28); it=CALL(trans_AmethystCTranslatorcb_101,1,bind); 
 BSET(_result_2,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_103,1,bind); FAILTEST(alt1_14);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_30,it); int oldpos29=ame_getpos(self); int oldlen20=ame_getlen(self); VALUE oldsrc20=ame_getsrc(self); int fail20=0;
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_31,it); it=CALL(trans_AmethystCTranslatorcb_105,1,bind); int oldpos30=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=ame_getsrc(self); int fail21=0;
...
it=CALL(trans_AmethystCTranslatorcb_106,1,bind); 
 BSET(_result_2,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_107,1,bind); 
 BSET(cls_1,it);   it=CALL(anything,0 ); FAILTEST(alt1_15);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_108,1,bind); FAILTEST(alt1_15);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_32,it); int oldpos31=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  arg0=CALL(trans_AmethystCTranslatorcb_109,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(pass_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_110,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(oldpos_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_111,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(oldlen_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_112,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(oldsrc_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_113,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(success_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_114,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass22);
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_117,1,bind); 
 BSET(prc_1,it); it=CALL(trans_AmethystCTranslatorcb_118,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_119,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_120,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_121,1,bind); it=CALL(apply,1 ,arg0); FAILTEST(pass22);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_122,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_123,1,bind); 
 BSET(_result_2,it); 
...
it=CALL(trans_AmethystCTranslatorcb_115,1,bind); 
 BSET(autovar_33,it); it=CALL(trans_AmethystCTranslatorcb_116,1,bind); int oldpos32=ame_getpos(self); int oldlen23=ame_getlen(self); VALUE oldsrc23=ame_getsrc(self); int fail23=0;
