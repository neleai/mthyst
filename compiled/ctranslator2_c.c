...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_6);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_32,1,bind); FAILTEST(alt1_6);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_15,it); it=CALL(trans_AmethystCTranslatorcb_33,1,bind); int oldpos13=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_7);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_36,1,bind); FAILTEST(alt1_7);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(aa_1,it); it=CALL(trans_AmethystCTranslatorcb_37,1,bind); it=CALL(trans_AmethystCTranslatorcb_38,1,bind); 
 BSET(autovar_19,it); it=CALL(trans_AmethystCTranslatorcb_39,1,bind);  if (IGET(stop)!=Qnil){{oldpos16=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos16); it=BGET(autovar_18);
 BSET(args_1,it); it=CALL(trans_AmethystCTranslatorcb_40,1,bind); 
 BSET(s_2,it); it=CALL(trans_AmethystCTranslatorcb_41,1,bind); 
 BSET(_result_3,it); it=BGET(_result_3);
 BSET(_result_2,it); 
...
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_8);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_43,1,bind); FAILTEST(alt1_8);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_22,it); it=CALL(trans_AmethystCTranslatorcb_44,1,bind);  if (IGET(stop)!=Qnil){{oldpos18=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos18); it=BGET(autovar_21);
...
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_47,1,bind); FAILTEST(alt1_9);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_24,it); it=CALL(trans_AmethystCTranslatorcb_49,1,bind); int oldpos20=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_52,1,bind); FAILTEST(alt1_10);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(oldpos_1,it);  it=CALL(trans_AmethystCTranslatorcb_56,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass15);
 ...
 BSET(autovar_26,it); int oldpos22; while(1){oldpos22=ame_getpos(self); int oldpos23=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos23); if (x==0) goto break6;it=CALL(trans_AmethystCTranslatorcb_57,1,bind); it=CALL(trans_AmethystCTranslatorcb_58,1,bind); it=CALL(trans_AmethystCTranslatorcb_59,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_60,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_61,1,bind);  it=CALL(trans_AmethystCTranslatorcb_62,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(break6);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_63,1,bind); 
 BSET(_result_4,it); it=BGET(_result_4);
 BSET(autovar_27,it); it=CALL(trans_AmethystCTranslatorcb_64,1,bind);  if (IGET(stop)!=Qnil){{oldpos22=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos22); it=BGET(autovar_26);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_65,1,bind); it=CALL(trans_AmethystCTranslatorcb_66,1,bind); it=CALL(trans_AmethystCTranslatorcb_67,1,bind); 
 BSET(_result_2,it); 
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_69,1,bind); FAILTEST(alt1_11);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_72,1,bind); FAILTEST(alt1_12);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_75,1,bind); FAILTEST(alt1_13);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(brk_1,it); it=CALL(trans_AmethystCTranslatorcb_77,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_78,1,bind); it=BGET(brk_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_79,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_80,1,bind);  it=CALL(trans_AmethystCTranslatorcb_81,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass18);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_82,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_83,1,bind); 
 BSET(_result_2,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_85,1,bind); FAILTEST(alt1_14);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_31)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_86,1,bind); 
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_87,1,bind); 
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_88,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_89,1,bind); it=BGET(reject_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_90,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_91,1,bind);  it=CALL(trans_AmethystCTranslatorcb_92,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass19);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_93,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_94,1,bind); 
 BSET(_result_2,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_95,1,bind); 
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_15);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_96,1,bind); FAILTEST(alt1_15);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos29; while(1){oldpos29=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos29=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos29); it=CALL(trans_AmethystCTranslatorcb_97,1,bind); 
 BSET(_result_2,it); 
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_99,1,bind); FAILTEST(alt1_16);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_100,1,bind); 
 BSET(autovar_34,it); it=CALL(trans_AmethystCTranslatorcb_101,1,bind); int oldpos31=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_104,1,bind); FAILTEST(alt1_17);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_35)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=CALL(trans_AmethystCTranslatorcb_105,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(pass_1,it);  it=CALL(trans_AmethystCTranslatorcb_106,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldpos_1,it);  it=CALL(trans_AmethystCTranslatorcb_107,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldlen_1,it);  it=CALL(trans_AmethystCTranslatorcb_108,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldsrc_1,it);  it=CALL(trans_AmethystCTranslatorcb_109,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(success_1,it);  it=CALL(trans_AmethystCTranslatorcb_110,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_113,1,bind); it=BGET(pass_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_114,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_115,1,bind);  it=CALL(trans_AmethystCTranslatorcb_118,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass23);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_119,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_120,1,bind); 
 BSET(_result_2,it); 
...
it=CALL(trans_AmethystCTranslatorcb_111,1,bind); 
 BSET(autovar_36,it); it=CALL(trans_AmethystCTranslatorcb_112,1,bind); int oldpos33=ame_getpos(self); int oldlen24=ame_getlen(self); VALUE oldsrc24=ame_getsrc(self); int fail24=0;
...
it=CALL(trans_AmethystCTranslatorcb_116,1,bind); 
 BSET(autovar_36,it); it=CALL(trans_AmethystCTranslatorcb_117,1,bind); int oldpos34=ame_getpos(self); int oldlen25=ame_getlen(self); VALUE oldsrc25=ame_getsrc(self); int fail25=0;
ame_setsrc(self,BGET(autovar_36)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
