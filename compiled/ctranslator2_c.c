...
static VALUE sy_AmethystCTranslator__append_lp__02a1;
...
static VALUE sy_AmethystCTranslator__at_header_lt__54b0;
...
static VALUE sy_AmethystCTranslator__at_init_sp__sp__lt__2dc1;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__7fbe;
...
static VALUE sy_AmethystCTranslator__dq_cstruct_77a2;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_ee79;
...
static VALUE sy_AmethystCTranslator__dq_switch_lp__3e9e;
...
static VALUE sy_AmethystCTranslator_bind_lb_21_rb__3df3;
static VALUE sy_AmethystCTranslator_bind_lb_21_rb__8dfe;
...
static VALUE sy_AmethystCTranslator_bind_lb_96_rb__815a;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_394b;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_e4ca;
...
alt1_1: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); bind_aset(bind,3/*c*/,it);
...
alt2_1: ptr->pos=oldpos2;  it=AmethystCore_anything(self ); FAILTEST(alt2_2); bind_aset(bind,3/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt3_1: ptr->pos=oldpos3;  it=AmethystCore_anything(self ); FAILTEST(alt3_2); bind_aset(bind,5/*autovar*/,it);
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
alt4_1: ptr->pos=oldpos4;  it=AmethystCore_anything(self ); FAILTEST(alt4_2); bind_aset(bind,7/*autovar*/,it);
...
alt5_1: ptr->pos=oldpos5;  it=AmethystCore_anything(self ); FAILTEST(alt5_2); bind_aset(bind,9/*autovar*/,it);
...
alt6_1: ptr->pos=oldpos6;  it=AmethystCore_anything(self ); FAILTEST(alt6_2); bind_aset(bind,11/*autovar*/,it);
...
alt7_1: ptr->pos=oldpos7;  it=AmethystCore_anything(self ); FAILTEST(alt7_2); bind_aset(bind,13/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(102);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
int oldpos2=ptr->pos;
alt1_1: ptr->pos=oldpos2;it=bind_aget(bind,9/*autovar*/); bind_aset(bind,10/*autovar*/,it);
cstruct oldpass2=*ptr; int fail2=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos5=ptr->pos;
alt2_1: ptr->pos=oldpos5;it=bind_aget(bind,62/*autovar*/); bind_aset(bind,63/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_ee79,1,bind);  bind_aset(bind,21/*s*/,it);
int oldpos6; while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ptr->pos=oldpos7; if (x==0) goto break4;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_73_rb__70c5,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__8dfe,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__f2d2,1,bind);  bind_aset(bind,56/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
...
it=bind_aget(bind,74/*_result*/); bind_aset(bind,46/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__1b3d,1,bind);   } break4: ame_setstop(self,Qnil); ptr->pos=oldpos6; it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__7fbe,1,bind);  bind_aset(bind,75/*autovar*/,it);
...
it=bind_aget(bind,75/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 11/*Pass*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,76/*autovar*/,it);
cstruct oldpass26=*ptr; int fail26=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=rb_obj_clone(s_pass_1a1d); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,77/*pass*/,it);
 it=rb_obj_clone(s_oldpass_6559); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,78/*oldpass*/,it);
 it=rb_obj_clone(s_success_260c); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,79/*success*/,it);
 it=rb_obj_clone(s_fail_e111); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,71/*fail*/,it);
it=bind_aget(bind,77/*pass*/); bind_aset(bind,56/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_to_5e99,1,bind);  bind_aset(bind,80/*autovar*/,it);
...
it=bind_aget(bind,81/*autovar*/); bind_aset(bind,82/*to*/,it);
 bind_aset(bind,58/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_4794,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_77a2,1,bind);  bind_aset(bind,83/*autovar*/,it);
...
it=bind_aget(bind,83/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 12/*Rule*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,84/*autovar*/,it);
...
it=bind_aget(bind,86/*autovar*/); bind_aset(bind,87/*body*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_e4ca,1,bind);  bind_aset(bind,88/*autovar*/,it);
...
it=bind_aget(bind,88/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 13/*Seq*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,89/*autovar*/,it);
cstruct oldpass30=*ptr; int fail30=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,90/*autovar*/,it);
int oldpos8; while(1){oldpos8=ptr->pos; switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_13,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(break5); bind_aset(bind,91/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__02a1,1,bind);  break;
case 17/*Object*/:; goto break5; break;
}  } break5: ame_setstop(self,Qnil); ptr->pos=oldpos8; it=bind_aget(bind,90/*autovar*/); bind_aset(bind,46/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_46_rb__44d9,1,bind);  bind_aset(bind,92/*autovar*/,it);
...
it=bind_aget(bind,92/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 14/*Stop*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,93/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_t_70dd,1,bind);  bind_aset(bind,6/*_result*/,it);
 break;
case 15/*Switch_Char*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,94/*autovar*/,it);
...
int oldpos9; while(1){oldpos9=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,95/*autovar*/,it);
cstruct oldpass33=*ptr; int fail33=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass33); bind_aset(bind,96/*c*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__3df3,1,bind);   } break6: ame_setstop(self,Qnil); ptr->pos=oldpos9; it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bcd2,1,bind);  bind_aset(bind,97/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass32;
	goto success32;
	pass32: fail32=1;
	success32: *ptr=oldpass32;
	if(fail32) goto fail;
it=bind_aget(bind,97/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 16/*Switch_Clas*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,98/*autovar*/,it);
cstruct oldpass34=*ptr; int fail34=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,98/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind);  bind_aset(bind,99/*sh*/,it);
it=i_0; bind_aset(bind,25/*ii*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,48/*init*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__54b0,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__3e9e,1,bind);  bind_aset(bind,21/*s*/,it);
int oldpos10; while(1){oldpos10=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,100/*autovar*/,it);
cstruct oldpass35=*ptr; int fail35=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass35); bind_aset(bind,96/*c*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_96_rb__815a,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__d329,1,bind);   } break7: ame_setstop(self,Qnil); ptr->pos=oldpos10; it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__2dc1,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bcd2,1,bind);  bind_aset(bind,101/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__02a1=rb_intern("AmethystCTranslator__append_lp__02a1");
...
sy_AmethystCTranslator__at_header_lt__54b0=rb_intern("AmethystCTranslator__at_header_lt__54b0");
...
sy_AmethystCTranslator__at_init_sp__sp__lt__2dc1=rb_intern("AmethystCTranslator__at_init_sp__sp__lt__2dc1");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__7fbe=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__7fbe");
...
sy_AmethystCTranslator__dq_cstruct_77a2=rb_intern("AmethystCTranslator__dq_cstruct_77a2");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_ee79=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_ee79");
...
sy_AmethystCTranslator__dq_switch_lp__3e9e=rb_intern("AmethystCTranslator__dq_switch_lp__3e9e");
...
sy_AmethystCTranslator_bind_lb_21_rb__3df3=rb_intern("AmethystCTranslator_bind_lb_21_rb__3df3");
sy_AmethystCTranslator_bind_lb_21_rb__8dfe=rb_intern("AmethystCTranslator_bind_lb_21_rb__8dfe");
...
sy_AmethystCTranslator_bind_lb_96_rb__815a=rb_intern("AmethystCTranslator_bind_lb_96_rb__815a");
sy_AmethystCTranslator_h_eq__dq_VALUE_394b=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_394b");
sy_AmethystCTranslator_h_eq__dq_VALUE_e4ca=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_e4ca");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('89887a03f093bf3e7cec80e6332b28ac')");}
