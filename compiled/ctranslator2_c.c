...
VALUE AmethystCTranslator_addlambda_lambda2(VALUE self,VALUE bind);
...
VALUE AmethystCTranslator_trans_lambda5(VALUE self,VALUE bind);
VALUE AmethystCTranslator_trans_lambda6(VALUE self,VALUE bind);
VALUE AmethystCTranslator_trans_lambda7(VALUE self,VALUE bind);
VALUE AmethystCTranslator_trans_lambda8(VALUE self,VALUE bind);
...
it=CALL(addlambda_AmethystCTranslatorcb_1,1,bind); 
 BSET(lambd_1,it); it=CALL(addlambda_AmethystCTranslatorcb_2,1,bind); it=CALL(addlambda_AmethystCTranslatorcb_3,1,bind); 
 BSET(word_1,it); it=CALL(addlambda_AmethystCTranslatorcb_4,1,bind); 
 BSET(rwo_1,it); it=CALL(addlambda_AmethystCTranslatorcb_5,1,bind);  it=CALL(addlambda_AmethystCTranslatorcb_6,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(fail);
 BSET(x_1,it); it=CALL(addlambda_AmethystCTranslatorcb_7,1,bind); it=CALL(addlambda_AmethystCTranslatorcb_8,1,bind); it=CALL(addlambda_AmethystCTranslatorcb_9,1,bind); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(c_2,it); it=CALL(itrans_AmethystCTranslatorcb_4,1,bind); FAILTEST(alt1_2);it=BGET(c_2);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_1,it); it=CALL(itrans_AmethystCTranslatorcb_5,1,bind);  
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(it_1,it); it=CALL(itrans_AmethystCTranslatorcb_6,1,bind);  
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
 if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=CALL(itrans_AmethystCTranslatorcb_7,1,bind); 
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_1,it); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_3,1,bind); it=CALL(trans_AmethystCTranslatorcb_4,1,bind); it=CALL(trans_AmethystCTranslatorcb_5,1,bind); it=CALL(trans_AmethystCTranslatorcb_6,1,bind); it=CALL(trans_AmethystCTranslatorcb_7,1,bind); it=CALL(trans_AmethystCTranslatorcb_8,1,bind); it=CALL(trans_AmethystCTranslatorcb_9,1,bind); it=CALL(trans_AmethystCTranslatorcb_10,1,bind); 
 BSET(autovar_2,it); it=CALL(trans_AmethystCTranslatorcb_11,1,bind); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_3);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_16,1,bind); FAILTEST(alt1_3);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystCTranslatorcb_18,1,bind); it=CALL(trans_AmethystCTranslatorcb_19,1,bind); 
 BSET(autovar_7,it); it=CALL(trans_AmethystCTranslatorcb_20,1,bind); int oldpos7=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_4);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_23,1,bind); FAILTEST(alt1_4);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_10,it); it=CALL(trans_AmethystCTranslatorcb_24,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_9);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_25,1,bind); 
 BSET(cbno_1,it); it=CALL(trans_AmethystCTranslatorcb_26,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_5);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_28,1,bind); FAILTEST(alt1_5);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_13,it); it=CALL(trans_AmethystCTranslatorcb_29,1,bind);  if (IGET(stop)!=Qnil){{oldpos11=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos11); it=BGET(autovar_12);
 BSET(c_1,it); 
	if (CALL(eof,0)==failobj) goto pass7;
	goto success7;
	pass7: fail7=1;
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it); int oldpos12=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_6;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_2);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_32,1,bind); FAILTEST(alt2_2);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_15,it); it=CALL(trans_AmethystCTranslatorcb_33,1,bind); int oldpos14=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,BGET(autovar_15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_16,it); int oldpos15=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,BGET(autovar_16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCTranslator_spaces(self ); FAILTEST(pass10); it=rb_str_new2("super"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass10);
	...
	if(fail9) goto pass8;
it=CALL(trans_AmethystCTranslatorcb_34,1,bind); 
 BSET(_result_2,it); 
...
alt2_2: ame_setpos(self,oldpos12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_6;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind); FAILTEST(alt2_3);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_17,it); int oldpos16=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_18,it); int oldpos17; while(1){oldpos17=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4);
 BSET(aa_1,it); it=CALL(trans_AmethystCTranslatorcb_36,1,bind); it=CALL(trans_AmethystCTranslatorcb_37,1,bind); 
 BSET(autovar_19,it); it=CALL(trans_AmethystCTranslatorcb_38,1,bind);  if (IGET(stop)!=Qnil){{oldpos17=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos17); it=BGET(autovar_18);
 BSET(args_1,it); it=CALL(trans_AmethystCTranslatorcb_39,1,bind); 
 BSET(s_2,it); it=CALL(trans_AmethystCTranslatorcb_40,1,bind); 
 BSET(_result_3,it); it=BGET(_result_3);
 BSET(_result_2,it); 
	...
	if(fail11) goto alt2_3;
 
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos12); goto alt1_6;
 accept2:;
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_7);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_42,1,bind); FAILTEST(alt1_7);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_20,it); int oldpos18=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,BGET(autovar_20)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_21,it); int oldpos19; while(1){oldpos19=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break5);
 BSET(autovar_22,it); it=CALL(trans_AmethystCTranslatorcb_43,1,bind);  if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos19); it=BGET(autovar_21);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_44,1,bind); 
 BSET(_result_2,it); 
...
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_45,1,bind); 
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_8);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_46,1,bind); FAILTEST(alt1_8);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_23,it); int oldpos20=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,BGET(autovar_23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_24,it); it=CALL(trans_AmethystCTranslatorcb_48,1,bind); int oldpos21=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
...
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_51,1,bind); FAILTEST(alt1_9);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_53,1,bind); 
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_54,1,bind); 
 BSET(oldpos_1,it);  it=CALL(trans_AmethystCTranslatorcb_55,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass15);
 BSET(alt_1,it); it=INT2FIX(0);
 BSET(altno_1,it); it=rb_ary_new3(0);
 BSET(autovar_26,it); int oldpos23; while(1){oldpos23=ame_getpos(self); int oldpos24=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos24); if (x==0) goto break6;it=CALL(trans_AmethystCTranslatorcb_56,1,bind); it=CALL(trans_AmethystCTranslatorcb_57,1,bind); it=CALL(trans_AmethystCTranslatorcb_58,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_59,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_60,1,bind);  it=CALL(trans_AmethystCTranslatorcb_61,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(break6);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_62,1,bind); 
 BSET(_result_4,it); it=BGET(_result_4);
 BSET(autovar_27,it); it=CALL(trans_AmethystCTranslatorcb_63,1,bind);  if (IGET(stop)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos23); it=BGET(autovar_26);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_64,1,bind); it=CALL(trans_AmethystCTranslatorcb_65,1,bind); it=CALL(trans_AmethystCTranslatorcb_66,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass15;
	goto success15;
	pass15: fail15=1;
	success15: ame_setsrc(self,oldsrc15); ame_setpos(self,oldpos22); ame_setlen(self,oldlen15);
	if(fail15) goto alt1_9;
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_68,1,bind); FAILTEST(alt1_10);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_28,it); int oldpos25=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=ame_getsrc(self); int fail16=0;
ame_setsrc(self,BGET(autovar_28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
	...
	goto success16;
	pass16: fail16=1;
	success16: ame_setsrc(self,oldsrc16); ame_setpos(self,oldpos25); ame_setlen(self,oldlen16);
	if(fail16) goto alt1_10;
it=CALL(trans_AmethystCTranslatorcb_69,1,bind); 
 BSET(_result_2,it);  
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_70,1,bind); 
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_11);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_71,1,bind); FAILTEST(alt1_11);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_29,it); int oldpos26=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
ame_setsrc(self,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
	...
	goto success17;
	pass17: fail17=1;
	success17: ame_setsrc(self,oldsrc17); ame_setpos(self,oldpos26); ame_setlen(self,oldlen17);
	if(fail17) goto alt1_11;
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_74,1,bind); FAILTEST(alt1_12);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_30,it); int oldpos27=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(brk_1,it); it=CALL(trans_AmethystCTranslatorcb_76,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_77,1,bind); it=BGET(brk_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_78,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_79,1,bind);  it=CALL(trans_AmethystCTranslatorcb_80,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass18);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_81,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_82,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass18;
	goto success18;
	pass18: fail18=1;
	success18: ame_setsrc(self,oldsrc18); ame_setpos(self,oldpos27); ame_setlen(self,oldlen18);
	if(fail18) goto alt1_12;
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_84,1,bind); FAILTEST(alt1_13);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_31,it); int oldpos28=ame_getpos(self); int oldlen19=ame_getlen(self); VALUE oldsrc19=ame_getsrc(self); int fail19=0;
ame_setsrc(self,BGET(autovar_31)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_85,1,bind); 
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_86,1,bind); 
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_87,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_88,1,bind); it=BGET(reject_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_89,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_90,1,bind);  it=CALL(trans_AmethystCTranslatorcb_91,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass19);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_92,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_93,1,bind); 
 BSET(_result_2,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_95,1,bind); FAILTEST(alt1_14);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_32,it); int oldpos29=ame_getpos(self); int oldlen20=ame_getlen(self); VALUE oldsrc20=ame_getsrc(self); int fail20=0;
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos30; while(1){oldpos30=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos30=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos30); it=CALL(trans_AmethystCTranslatorcb_96,1,bind); 
 BSET(_result_2,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_98,1,bind); FAILTEST(alt1_15);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_33,it); int oldpos31=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=ame_getsrc(self); int fail21=0;
ame_setsrc(self,BGET(autovar_33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_99,1,bind); 
 BSET(autovar_34,it); it=CALL(trans_AmethystCTranslatorcb_100,1,bind); int oldpos32=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
ame_setsrc(self,BGET(autovar_34)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(argss_1,it); 
	...
	goto success22;
	pass22: fail22=1;
	success22: ame_setsrc(self,oldsrc22); ame_setpos(self,oldpos32); ame_setlen(self,oldlen22);
...
it=CALL(trans_AmethystCTranslatorcb_101,1,bind); 
 BSET(_result_2,it); 
	...
	goto success21;
	pass21: fail21=1;
	success21: ame_setsrc(self,oldsrc21); ame_setpos(self,oldpos31); ame_setlen(self,oldlen21);
	if(fail21) goto alt1_15;
 
ISET(cut,Qnil);goto accept1;
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_102,1,bind); 
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_16);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_103,1,bind); FAILTEST(alt1_16);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(autovar_35,it); int oldpos33=ame_getpos(self); int oldlen23=ame_getlen(self); VALUE oldsrc23=ame_getsrc(self); int fail23=0;
ame_setsrc(self,BGET(autovar_35)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=CALL(trans_AmethystCTranslatorcb_104,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(pass_1,it);  it=CALL(trans_AmethystCTranslatorcb_105,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldpos_1,it);  it=CALL(trans_AmethystCTranslatorcb_106,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldlen_1,it);  it=CALL(trans_AmethystCTranslatorcb_107,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldsrc_1,it);  it=CALL(trans_AmethystCTranslatorcb_108,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(success_1,it);  it=CALL(trans_AmethystCTranslatorcb_109,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_112,1,bind); it=BGET(pass_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_113,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_114,1,bind);  it=CALL(trans_AmethystCTranslatorcb_117,1,bind);  arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass23);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_118,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_119,1,bind); 
 BSET(_result_2,it); 
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_addlambda_lambda2(VALUE self,VALUE bind){VALUE vals[0]; /*todo unify with rule and get args*/  int x;VALUE it;VALUE arg0,arg1,arg2,arg3;
  it=AmethystCTranslator_trans(self ); FAILTEST(fail);
 BSET(body_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans_lambda5(VALUE self,VALUE bind){VALUE vals[0]; /*todo unify with rule and get args*/  int x;VALUE it;VALUE arg0,arg1,arg2,arg3;
  it=AmethystCTranslator_trans(self ); FAILTEST(fail);
 BSET(t_1,it); 
 BSET(_result_2,it); it=BGET(_result_2);
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans_lambda6(VALUE self,VALUE bind){VALUE vals[0]; /*todo unify with rule and get args*/  int x;VALUE it;VALUE arg0,arg1,arg2,arg3;
  it=AmethystCTranslator_trans(self ); FAILTEST(fail);
 BSET(t_1,it); 
 BSET(_result_2,it); it=BGET(_result_2);
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans_lambda7(VALUE self,VALUE bind){VALUE vals[0]; /*todo unify with rule and get args*/  int x;VALUE it;VALUE arg0,arg1,arg2,arg3;
it=CALL(trans_AmethystCTranslatorcb_110,1,bind); 
 BSET(autovar_36,it); it=CALL(trans_AmethystCTranslatorcb_111,1,bind); int oldpos34=ame_getpos(self); int oldlen24=ame_getlen(self); VALUE oldsrc24=ame_getsrc(self); int fail24=0;
ame_setsrc(self,BGET(autovar_36)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(_result_2,it); 
	...
	goto success24;
	pass24: fail24=1;
	success24: ame_setsrc(self,oldsrc24); ame_setpos(self,oldpos34); ame_setlen(self,oldlen24);
	if(fail24) goto fail;
it=BGET(_result_2);
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans_lambda8(VALUE self,VALUE bind){VALUE vals[0]; /*todo unify with rule and get args*/  int x;VALUE it;VALUE arg0,arg1,arg2,arg3;
it=CALL(trans_AmethystCTranslatorcb_115,1,bind); 
 BSET(autovar_36,it); it=CALL(trans_AmethystCTranslatorcb_116,1,bind); int oldpos35=ame_getpos(self); int oldlen25=ame_getlen(self); VALUE oldsrc25=ame_getsrc(self); int fail25=0;
ame_setsrc(self,BGET(autovar_36)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCTranslator_trans(self ); FAILTEST(pass25);
 BSET(to_1,it); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass25;
	goto success25;
	pass25: fail25=1;
	success25: ame_setsrc(self,oldsrc25); ame_setpos(self,oldpos35); ame_setlen(self,oldlen25);
	if(fail25) goto fail;
it=BGET(_result_2);
return it;
fail: return failobj; }
...
rb_define_method(cls_AmethystCTranslator,"AmethystCTranslator_addlambda_lambda2",AmethystCTranslator_addlambda_lambda2,1);
...
rb_define_method(cls_AmethystCTranslator,"AmethystCTranslator_trans_lambda5",AmethystCTranslator_trans_lambda5,1);
rb_define_method(cls_AmethystCTranslator,"AmethystCTranslator_trans_lambda6",AmethystCTranslator_trans_lambda6,1);
rb_define_method(cls_AmethystCTranslator,"AmethystCTranslator_trans_lambda7",AmethystCTranslator_trans_lambda7,1);
rb_define_method(cls_AmethystCTranslator,"AmethystCTranslator_trans_lambda8",AmethystCTranslator_trans_lambda8,1);
