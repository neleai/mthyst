...
static VALUE sy_AmethystCTranslator__dq_cstruct_ff58;
...
it=bind_aget(bind,80/*autovar*/); bind_aset(bind,81/*to*/,it);
 bind_aset(bind,58/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_4794,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_ff58,1,bind);  bind_aset(bind,82/*autovar*/,it);
...
sy_AmethystCTranslator__dq_cstruct_ff58=rb_intern("AmethystCTranslator__dq_cstruct_ff58");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('f5082a918d5f386590c344b5998ec86d')");}
