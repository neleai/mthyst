...
it=CALL(addlambda_AmethystCTranslatorcb_1,1,bind); 
 ...
 BSET(rwo_1,it); it=CALL(addlambda_AmethystCTranslatorcb_5,1,bind);  it=BGET(prc_1); arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(fail);
 BSET(x_1,it); it=CALL(addlambda_AmethystCTranslatorcb_6,1,bind); it=CALL(addlambda_AmethystCTranslatorcb_7,1,bind); it=CALL(addlambda_AmethystCTranslatorcb_8,1,bind); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
it=rb_ary_new3(0);it=rb_ary_new3(0);it=CALL(itrans_AmethystCTranslatorcb_1,1,bind); 
 BSET(ruby_1,it); it=CALL(itrans_AmethystCTranslatorcb_2,1,bind); 
 BSET(c_1,it); it=CALL(itrans_AmethystCTranslatorcb_3,1,bind); 
 BSET(init_1,it); it=rb_ary_new3(0);int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
...
it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);int oldpos1=ame_getpos(self);
...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=CALL(rbtrans_AmethystCTranslatorcb_3,1,bind); 
 BSET(_result_2,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);it=rb_ary_new3(0);int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ame_setsrc(self,BGET(autovar_16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_str_new2("super");
 BSET(s_2,it);   it=AmethystCTranslator_spaces(self ); FAILTEST(pass10); it=BGET(s_2); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass10);
...
ame_setsrc(self,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_26,it); int oldpos23; while(1){oldpos23=ame_getpos(self); int oldpos24=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept3;  reject1: x=0; accept3: it=Qnil; ame_setpos(self,oldpos24); if (x==0) goto break6;it=CALL(trans_AmethystCTranslatorcb_56,1,bind); it=CALL(trans_AmethystCTranslatorcb_57,1,bind); 
 BSET(prc_1,it); it=CALL(trans_AmethystCTranslatorcb_58,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_59,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_60,1,bind);  it=BGET(prc_1); arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(break6);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_61,1,bind); 
 BSET(_result_4,it); it=BGET(_result_4);
 BSET(autovar_27,it); it=CALL(trans_AmethystCTranslatorcb_62,1,bind);  if (IGET(stop)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos23); it=BGET(autovar_26);
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_67,1,bind); FAILTEST(alt1_10);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_70,1,bind); FAILTEST(alt1_11);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_73,1,bind); FAILTEST(alt1_12);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_76,1,bind); 
 BSET(prc_1,it); it=BGET(brk_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_77,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_78,1,bind);  it=BGET(prc_1); arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass18);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_79,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_80,1,bind); 
 BSET(_result_2,it); 
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_82,1,bind); FAILTEST(alt1_13);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_31)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_84,1,bind); 
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_85,1,bind); 
 BSET(oldpos_1,it); it=CALL(trans_AmethystCTranslatorcb_86,1,bind); 
 BSET(prc_1,it); it=BGET(reject_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_87,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_88,1,bind);  it=BGET(prc_1); arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass19);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_89,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_90,1,bind); 
 BSET(_result_2,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(trans_AmethystCTranslatorcb_91,1,bind); 
 BSET(cls_1,it);   it=AmethystCore_anything(self ); FAILTEST(alt1_14);
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_92,1,bind); FAILTEST(alt1_14);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);int oldpos30; while(1){oldpos30=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos30=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos30); it=CALL(trans_AmethystCTranslatorcb_93,1,bind); 
 BSET(_result_2,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_95,1,bind); FAILTEST(alt1_15);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_34,it); it=CALL(trans_AmethystCTranslatorcb_97,1,bind); int oldpos32=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
...
it=CALL(trans_AmethystCTranslatorcb_98,1,bind); 
 BSET(_result_2,it); 
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(i_1,it); it=CALL(trans_AmethystCTranslatorcb_100,1,bind); FAILTEST(alt1_16);it=BGET(i_1);
 BSET(_result_1,it); it=BGET(_result_1);
...
ame_setsrc(self,BGET(autovar_35)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=CALL(trans_AmethystCTranslatorcb_101,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(pass_1,it);  it=CALL(trans_AmethystCTranslatorcb_102,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldpos_1,it);  it=CALL(trans_AmethystCTranslatorcb_103,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldlen_1,it);  it=CALL(trans_AmethystCTranslatorcb_104,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(oldsrc_1,it);  it=CALL(trans_AmethystCTranslatorcb_105,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(success_1,it);  it=CALL(trans_AmethystCTranslatorcb_106,1,bind);  arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass23);
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_109,1,bind); 
 BSET(prc_1,it); it=BGET(pass_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_110,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_111,1,bind);  it=BGET(prc_1); arg0=it; it=CALL(apply,1 ,arg0); FAILTEST(pass23);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_112,1,bind); it=BGET(_result_4);it=CALL(trans_AmethystCTranslatorcb_113,1,bind); 
 BSET(_result_2,it); 
...
it=CALL(trans_AmethystCTranslatorcb_107,1,bind); 
 BSET(autovar_36,it); it=CALL(trans_AmethystCTranslatorcb_108,1,bind); int oldpos34=ame_getpos(self); int oldlen24=ame_getlen(self); VALUE oldsrc24=ame_getsrc(self); int fail24=0;
