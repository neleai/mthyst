...
static VALUE sy_AmethystCTranslator__lp_bind_lb_34_6f5d;
...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_b60f;
...
it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_34_6f5d,1,bind); FAILTEST(pass37);it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_d72e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind);  bind_aset(bind,100/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_b60f,1,bind);  bind_aset(bind,103/*autovar*/,it);
...
sy_AmethystCTranslator__lp_bind_lb_34_6f5d=rb_intern("AmethystCTranslator__lp_bind_lb_34_6f5d");
...
sy_AmethystCTranslator_h_eq__dq_VALUE_b60f=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_b60f");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('621cd160f4267e929dd81ce3414d85d3')");}
