...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__257d,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ptr->pos;goto break4;} } } break4: ame_setstop(self,Qnil); ptr->pos=oldpos6; it=bind_aget(bind,74/*autovar*/); bind_aset(bind,46/*t*/,it);
...
it=rb_obj_clone(s_ame_sets_fef4); bind_aset(bind,6/*_result*/,it);
 break;
case 15/*Switch*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,96/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bd53,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ptr->pos;goto break6;} } } break6: ame_setstop(self,Qnil); ptr->pos=oldpos9; it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bcd2,1,bind);  bind_aset(bind,99/*autovar*/,it);
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('2c13706820f16577b445198c221bb15b')");}
