...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_15,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_3);
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_21,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_4);
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_10,it); it=CALL(trans_AmethystCTranslatorcb_22,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_9);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_23,1,bind); 
 BSET(cbno_1,it); it=CALL(trans_AmethystCTranslatorcb_24,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
...
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_25,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_5);
...
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_13,it); it=CALL(trans_AmethystCTranslatorcb_26,1,bind);  if (IGET(stop)!=Qnil){{oldpos11=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos11); it=BGET(autovar_12);
 BSET(c_1,it); 
	if (CALL(eof,0)==failobj) goto pass7;
	goto success7;
	pass7: fail7=1;
...
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_28,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_6);
...
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_15,it); it=CALL(trans_AmethystCTranslatorcb_29,1,bind); int oldpos13=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
...
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(args_1,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind); 
 BSET(s_2,it); it=CALL(trans_AmethystCTranslatorcb_36,1,bind); 
 BSET(_result_2,it); it=BGET(_result_2);
 BSET(_result_1,it); 
...
ame_setsrc(self,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_26,it); int oldpos22; while(1){oldpos22=ame_getpos(self); int oldpos23=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos23); if (x==0) goto break6;it=CALL(trans_AmethystCTranslatorcb_48,1,bind); it=CALL(trans_AmethystCTranslatorcb_49,1,bind); 
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_50,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_51,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(break6);
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_52,1,bind); 
 BSET(_result_3,it); it=BGET(_result_3);
...
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_64,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_65,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass18);
 BSET(t_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_66,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_67,1,bind); 
 BSET(_result_1,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_68,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_14);
...
ame_setsrc(self,BGET(autovar_31)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_72,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_73,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass19);
 BSET(t_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_74,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_75,1,bind); 
 BSET(_result_1,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_76,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_15);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos29; while(1){oldpos29=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (IGET(stop)!=Qnil){{oldpos29=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos29); it=CALL(trans_AmethystCTranslatorcb_77,1,bind); 
 BSET(_result_1,it); 
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_78,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_16);
...
ame_setsrc(self,BGET(autovar_33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_34,it); it=CALL(trans_AmethystCTranslatorcb_80,1,bind); int oldpos31=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_82,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_17);
...
ame_setsrc(self,BGET(autovar_35)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_83,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_84,1,bind); it=CALL(trans_AmethystCTranslatorcb_85,1,bind); 
...
it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_87,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_88,1,bind); 
 BSET(_result_1,it); 
...
alt1_17: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_89,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_18);
...
rb_define_method(cls_AmethystCTranslator,"transfn",AmethystCTranslator_transfn,0);
 rb_eval_string("testversion('5564e6a382834573a25d0c7f8c656d32')");}
