...
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break2); bind_aset(bind,27/*aa*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__5934,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,26/*autovar*/); bind_aset(bind,29/*args*/,it);
...
cstruct oldpass12=*ptr; int fail12=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_trans(self ); FAILTEST(pass12); bind_aset(bind,34/*e*/,it);
...
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,43/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__5f76,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,42/*autovar*/); bind_aset(bind,44/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass19); bind_aset(bind,46/*t*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass20); bind_aset(bind,46/*t*/,it);
 bind_aset(bind,58/*x*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,6/*_result*/,it);
 bind_aset(bind,58/*x*/,it);
...
cstruct oldpass23=*ptr; int fail23=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_trans(self ); FAILTEST(pass23); bind_aset(bind,76/*autovar*/,it);
...
int oldpos9; while(1){oldpos9=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break7); bind_aset(bind,88/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__be60,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,87/*autovar*/); bind_aset(bind,46/*t*/,it);
...
cstruct oldpass30=*ptr; int fail30=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=AmethystCTranslator_trans(self ); FAILTEST(pass30); bind_aset(bind,46/*t*/,it);
...
cstruct oldpass32=*ptr; int fail32=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=AmethystCTranslator_trans(self ); FAILTEST(pass32); bind_aset(bind,46/*t*/,it);
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('26a3b70425d1d207098c28ffd1841313')");}
