...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_2653;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_3d5e;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_ae61;
...
VALUE AmethystCTranslator_addcallback(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=bind_new2(4);VALUE bind2=bind_new2(16); bind_aset(bind,0/*s*/,a0); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_addcallb_2cf7,1,bind2);bind_aset(bind,0/*s*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_addlambda(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(6);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le__at_gram_5de9,1,bind2); bind_aset(bind,0/*lambd*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,1/*rwo*/,it);
it=rb_obj_clone(s_fail_e111); bind_aset(bind,2/*word*/,it);
bind_aset(bind2,1,bind_aget(bind,2/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,2/*word*/,bind_aget(bind2,1));  it=AmethystCTranslator_trans(self ); FAILTEST(fail); bind_aset(bind,3/*body*/,it);
 bind_aset(bind,4/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*rwo*/));bind_aset(bind2,2,bind_aget(bind,4/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,1/*rwo*/,bind_aget(bind2,1));bind_aset(bind,4/*x*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*lambd*/));bind_aset(bind2,2,bind_aget(bind,3/*body*/));it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_3d5e,1,bind2);bind_aset(bind,0/*lambd*/,bind_aget(bind2,1));bind_aset(bind,3/*body*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*lambd*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_Amethys_2ed8,1,bind2);bind_aset(bind,0/*lambd*/,bind_aget(bind2,1)); bind_aset(bind,5/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_itrans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(8);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,3/*c*/));it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_1_rb__a948,1,bind2);bind_aset(bind,3/*c*/,bind_aget(bind2,1));FAILTEST(alt1_2);bind_aset(bind2,1,bind_aget(bind,3/*c*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb_,1,bind2);bind_aset(bind,3/*c*/,bind_aget(bind2,1)); bind_aset(bind,4/*_result*/,it);
it=bind_aget(bind,4/*_result*/); bind_aset(bind,5/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*ruby*/));bind_aset(bind2,2,bind_aget(bind,5/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,0/*ruby*/,bind_aget(bind2,1));bind_aset(bind,5/*autovar*/,bind_aget(bind2,2));
;goto accept2;
alt1_2: ptr->pos=oldpos2;  it=AmethystCTranslator_trans(self ); FAILTEST(alt1_3); bind_aset(bind,6/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*c*/));bind_aset(bind2,2,bind_aget(bind,6/*it*/));bind_aset(bind2,3,bind_aget(bind,2/*init*/));bind_aset(bind2,4,bind_aget(bind,0/*ruby*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__lt__98f3,1,bind2);bind_aset(bind,1/*c*/,bind_aget(bind2,1));bind_aset(bind,6/*it*/,bind_aget(bind2,2));bind_aset(bind,2/*init*/,bind_aget(bind2,3));bind_aset(bind,0/*ruby*/,bind_aget(bind2,4));
;goto accept2;
alt1_3: ptr->pos=oldpos2;goto break1;
 accept2:;
 } break1: ptr->pos=oldpos1;   bind_aset(bind2,1,bind_aget(bind,1/*c*/));bind_aset(bind2,2,bind_aget(bind,2/*init*/));bind_aset(bind2,3,bind_aget(bind,0/*ruby*/));it=rb_funcall(self,sy_AmethystCTranslator__lb_bind_lb_1_rb__8fa4,1,bind2);bind_aset(bind,1/*c*/,bind_aget(bind2,1));bind_aset(bind,2/*init*/,bind_aget(bind2,2));bind_aset(bind,0/*ruby*/,bind_aget(bind2,3)); bind_aset(bind,7/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_rbcode(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_funcall(self,sy_AmethystCTranslator__dq_class_sp__sh__0b62,1,bind2); bind_aset(bind,0/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__lt__acb7,1,bind2);bind_aset(bind,0/*s*/,bind_aget(bind2,1));it=rb_funcall(self,sy_AmethystCTranslator__at_callbac_2d11,1,bind2); bind_aset(bind,1/*autovar*/,it);
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,1/*autovar*/);ptr->len=1;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                ...
                bind_aset(bind2,1,bind_aget(bind,5/*k*/));bind_aset(bind2,2,bind_aget(bind,6/*v*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_def_sp__sh__le_b_b73d,1,bind2);bind_aset(bind,5/*k*/,bind_aget(bind2,1));bind_aset(bind,6/*v*/,bind_aget(bind2,2)); bind_aset(bind,7/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*autovar*/));bind_aset(bind2,2,bind_aget(bind,7/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,3/*autovar*/,bind_aget(bind2,1));bind_aset(bind,7/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,3/*autovar*/); bind_aset(bind,8/*x*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   ...
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
                bind_aset(bind2,1,bind_aget(bind,0/*s*/));bind_aset(bind2,2,bind_aget(bind,8/*x*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__1b5e,1,bind2);bind_aset(bind,0/*s*/,bind_aget(bind2,1));bind_aset(bind,8/*x*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,0/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__916b,1,bind2);bind_aset(bind,0/*s*/,bind_aget(bind2,1)); bind_aset(bind,9/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_rbtrans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(15);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass3;
                   ...
                   success3: *ptr=oldpass3;
                bind_aset(bind2,1,bind_aget(bind,6/*name*/));it=rb_funcall(self,sy_AmethystCTranslator__dq__at__sh__le_bind_3d2b,1,bind2);bind_aset(bind,6/*name*/,bind_aget(bind2,1)); bind_aset(bind,2/*_result*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                ...
                bind_aset(bind2,1,bind_aget(bind,6/*name*/));bind_aset(bind2,2,bind_aget(bind,8/*args*/));it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_1_rb__d1fd,1,bind2);bind_aset(bind,6/*name*/,bind_aget(bind2,1));bind_aset(bind,8/*args*/,bind_aget(bind2,2)); bind_aset(bind,2/*_result*/,it);
...
cstruct oldpass6=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator_rbbget_lp_s_68a8,1,bind2); bind_aset(bind,12/*autovar*/,it);
...
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf,1,bind2); bind_aset(bind,14/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_rbtrans2(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(4);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
bind_aset(bind2,1,bind_aget(bind,0/*autovar*/));bind_aset(bind2,2,bind_aget(bind,1/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,0/*autovar*/,bind_aget(bind2,1));bind_aset(bind,1/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,0/*autovar*/); bind_aset(bind,2/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,2/*it*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__ti__cfcb,1,bind2);bind_aset(bind,2/*it*/,bind_aget(bind2,1)); bind_aset(bind,3/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_rw(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=bind_new2(5);VALUE bind2=bind_new2(16); bind_aset(bind,1/*word*/,a0);bind_aset(bind,2/*prc*/,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
            
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,0/*rwo*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,1/*word*/,bind_aget(bind2,1)); it=bind_aget(bind,2/*prc*/); arg0=it; it=rb_funcall(self,sy_apply,1,arg0); FAILTEST(fail); bind_aset(bind,3/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,0/*rwo*/));bind_aset(bind2,2,bind_aget(bind,3/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,0/*rwo*/,bind_aget(bind2,1));bind_aset(bind,3/*x*/,bind_aget(bind2,2)); bind_aset(bind,4/*_result*/,it);

return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(121);VALUE bind2=bind_new2(16);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator__at_bindno_eq__e294,1,bind2);it=rb_ary_new3(0); bind_aset(bind,1/*autovar*/,it);
int oldpos1;  while(1){oldpos1=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,2/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,1/*autovar*/));bind_aset(bind2,2,bind_aget(bind,2/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,1/*autovar*/,bind_aget(bind2,1));bind_aset(bind,2/*autovar*/,bind_aget(bind2,2)); } break1: ptr->pos=oldpos1;   it=bind_aget(bind,1/*autovar*/); bind_aset(bind,3/*it*/,it);
bind_aset(bind2,1,bind_aget(bind,3/*it*/));it=rb_funcall(self,sy_AmethystCTranslator_addcallb_0461,1,bind2);bind_aset(bind,3/*it*/,bind_aget(bind2,1)); bind_aset(bind,4/*cbno*/,it);
bind_aset(bind2,1,bind_aget(bind,4/*cbno*/));it=rb_funcall(self,sy_AmethystCTranslator__at_binds_dot_m_4c7b,1,bind2);bind_aset(bind,4/*cbno*/,bind_aget(bind2,1)); bind_aset(bind,5/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
                   pass1: *ptr=oldpass1; goto fail;
                   success1: *ptr=oldpass1;
...
case '_' ... '_':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='f'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='n'&&ame_curstr2(ptr)[3]=='d')  ptr->pos+=4; else goto pass3; break;
                   ...
                   success3: *ptr=oldpass3;
                it=rb_funcall(self,sy_AmethystCTranslator_raise_sp__dq_T_0ab1,1,bind2); bind_aset(bind,12/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass6;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass4;
                   ...
                   success4: *ptr=oldpass4;
                bind_aset(bind2,1,bind_aget(bind,16/*s*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_if_lp_ptr_mi__033b,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1)); bind_aset(bind,6/*_result*/,it);
...
case 'f' ... 'f':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='a'&&ame_curstr2(ptr)[1]=='i'&&ame_curstr2(ptr)[2]=='l'&&ame_curstr2(ptr)[3]=='s')  ptr->pos+=4; else goto pass8; break;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator__dq_goto_sp__sh__le__f772,1,bind2); bind_aset(bind,19/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass7;
                   goto success7;
...
case 'e' ... 'e':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='o'&&ame_curstr2(ptr)[1]=='f')  ptr->pos+=2; else goto pass10; break;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq_Qnil_8464,1,bind2); bind_aset(bind,22/*autovar*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass19;
                ...
                bind_aset(bind2,1,bind_aget(bind,16/*s*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp__sh__le_a_0233,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1)); bind_aset(bind,32/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,35/*ii*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__891b,1,bind2);bind_aset(bind,35/*ii*/,bind_aget(bind2,1));bind_aset(bind2,1,bind_aget(bind,37/*aa*/));bind_aset(bind2,2,bind_aget(bind,35/*ii*/));it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__3bec,1,bind2);bind_aset(bind,37/*aa*/,bind_aget(bind2,1));bind_aset(bind,35/*ii*/,bind_aget(bind2,2)); bind_aset(bind,38/*autovar*/,it);
bind_aset(bind2,1,bind_aget(bind,36/*autovar*/));bind_aset(bind2,2,bind_aget(bind,38/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,36/*autovar*/,bind_aget(bind2,1));bind_aset(bind,38/*autovar*/,bind_aget(bind2,2)); } break2: ptr->pos=oldpos3;   it=bind_aget(bind,36/*autovar*/); bind_aset(bind,39/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_src_25d9,1,bind2); bind_aset(bind,40/*app*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass20;
                   goto success20;
                   pass20: *ptr=oldpass20; goto alt1_10;
                   success20: *ptr=oldpass20;
                bind_aset(bind2,1,bind_aget(bind,39/*args*/));bind_aset(bind2,2,bind_aget(bind,34/*name*/));bind_aset(bind2,3,bind_aget(bind,35/*ii*/));bind_aset(bind2,4,bind_aget(bind,40/*app*/));it=rb_funcall(self,sy_AmethystCTranslator_r_eq__dq__sp__sh__le_bi_10a8,1,bind2);bind_aset(bind,39/*args*/,bind_aget(bind2,1));bind_aset(bind,34/*name*/,bind_aget(bind2,2));bind_aset(bind,35/*ii*/,bind_aget(bind2,3));bind_aset(bind,40/*app*/,bind_aget(bind2,4)); bind_aset(bind,6/*_result*/,it);
...
bind_aset(bind2,1,bind_aget(bind,42/*e*/));it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__9cfd,1,bind2);bind_aset(bind,42/*e*/,bind_aget(bind2,1)); bind_aset(bind,43/*autovar*/,it);
...
cstruct oldpass22=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator_ar_eq__ti_src_dot__efea,1,bind2); bind_aset(bind,45/*autovar*/,it);
...
cstruct oldpass23=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_eq_tr_13c6,1,bind2); bind_aset(bind,6/*_result*/,it);
 break;
...
bind_aset(bind2,1,bind_aget(bind,50/*autovar*/));bind_aset(bind2,2,bind_aget(bind,51/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,50/*autovar*/,bind_aget(bind2,1));bind_aset(bind,51/*autovar*/,bind_aget(bind2,2)); } break3: ptr->pos=oldpos4;   it=bind_aget(bind,50/*autovar*/); bind_aset(bind,52/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_VALUE_sp_c_8bbf,1,bind2); bind_aset(bind,16/*s*/,it);
bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,54/*t*/));bind_aset(bind2,3,bind_aget(bind,56/*init*/));bind_aset(bind2,4,bind_aget(bind,55/*rbcode*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__lt__c72d,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,54/*t*/,bind_aget(bind2,2));bind_aset(bind,56/*init*/,bind_aget(bind2,3));bind_aset(bind,55/*rbcode*/,bind_aget(bind2,4)); bind_aset(bind,57/*autovar*/,it);
...
cstruct oldpass27=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_bg_281f,1,bind2); bind_aset(bind,59/*autovar*/,it);
...
cstruct oldpass28=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind2); bind_aset(bind,61/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind2); bind_aset(bind,62/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind2); bind_aset(bind,63/*oldpos*/,it);
it=bind_aget(bind,62/*reject*/); bind_aset(bind,64/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,65/*rwo*/,it);
bind_aset(bind2,1,bind_aget(bind,64/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,64/*word*/,bind_aget(bind2,1));  it=AmethystCTranslator_trans(self ); FAILTEST(pass28); bind_aset(bind,54/*t*/,it);
 bind_aset(bind,66/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,65/*rwo*/));bind_aset(bind2,2,bind_aget(bind,66/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,65/*rwo*/,bind_aget(bind2,1));bind_aset(bind,66/*x*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,63/*oldpos*/));bind_aset(bind2,2,bind_aget(bind,54/*t*/));bind_aset(bind2,3,bind_aget(bind,61/*accept*/));bind_aset(bind2,4,bind_aget(bind,62/*reject*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_0a35,1,bind2);bind_aset(bind,63/*oldpos*/,bind_aget(bind2,1));bind_aset(bind,54/*t*/,bind_aget(bind2,2));bind_aset(bind,61/*accept*/,bind_aget(bind2,3));bind_aset(bind,62/*reject*/,bind_aget(bind2,4)); bind_aset(bind,67/*autovar*/,it);
...
cstruct oldpass32=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b_6df7,1,bind2); bind_aset(bind,75/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind2); bind_aset(bind,63/*oldpos*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind2); bind_aset(bind,61/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_e2b4,1,bind2); bind_aset(bind,76/*oldstops*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_2ba4,1,bind2); bind_aset(bind,77/*oldstoplabel*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_n_588d,1,bind2);it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_a14e,1,bind2);it=bind_aget(bind,75/*brk*/); bind_aset(bind,64/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,65/*rwo*/,it);
bind_aset(bind2,1,bind_aget(bind,64/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,64/*word*/,bind_aget(bind2,1));  it=AmethystCTranslator_trans(self ); FAILTEST(pass32); bind_aset(bind,54/*t*/,it);
 bind_aset(bind,66/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,65/*rwo*/));bind_aset(bind2,2,bind_aget(bind,66/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,65/*rwo*/,bind_aget(bind2,1));bind_aset(bind,66/*x*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,63/*oldpos*/));bind_aset(bind2,3,bind_aget(bind,54/*t*/));bind_aset(bind2,4,bind_aget(bind,61/*accept*/));bind_aset(bind2,5,bind_aget(bind,75/*brk*/));bind_aset(bind2,6,bind_aget(bind,76/*oldstops*/));bind_aset(bind2,7,bind_aget(bind,77/*oldstoplabel*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__eq__2d82,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,63/*oldpos*/,bind_aget(bind2,2));bind_aset(bind,54/*t*/,bind_aget(bind2,3));bind_aset(bind,61/*accept*/,bind_aget(bind2,4));bind_aset(bind,75/*brk*/,bind_aget(bind2,5));bind_aset(bind,76/*oldstops*/,bind_aget(bind2,6));bind_aset(bind,77/*oldstoplabel*/,bind_aget(bind2,7)); bind_aset(bind,78/*autovar*/,it);
...
cstruct oldpass33=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator_raise_sp__dq_T_0ab1,1,bind2); bind_aset(bind,80/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_7393,1,bind2); bind_aset(bind,84/*oldcutlabel*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_7bbc,1,bind2); bind_aset(bind,85/*oldcuts*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_eq_ni_f875,1,bind2);bind_aset(bind2,1,bind_aget(bind,63/*oldpos*/));bind_aset(bind2,2,bind_aget(bind,82/*alt*/));bind_aset(bind2,3,bind_aget(bind,83/*altno*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_0b60,1,bind2);bind_aset(bind,63/*oldpos*/,bind_aget(bind2,1));bind_aset(bind,82/*alt*/,bind_aget(bind2,2));bind_aset(bind,83/*altno*/,bind_aget(bind2,3)); bind_aset(bind,16/*s*/,it);
int oldpos6;  while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept7;  reject1: x=0; accept7: it=Qnil; ptr->pos=oldpos7; if (x==0) goto break4;bind_aset(bind2,1,bind_aget(bind,83/*altno*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__891b,1,bind2);bind_aset(bind,83/*altno*/,bind_aget(bind2,1));bind_aset(bind2,1,bind_aget(bind,82/*alt*/));bind_aset(bind2,2,bind_aget(bind,83/*altno*/));it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__9630,1,bind2);bind_aset(bind,82/*alt*/,bind_aget(bind2,1));bind_aset(bind,83/*altno*/,bind_aget(bind2,2)); bind_aset(bind,64/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,65/*rwo*/,it);
bind_aset(bind2,1,bind_aget(bind,64/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,64/*word*/,bind_aget(bind2,1));  it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,6/*_result*/,it);
 bind_aset(bind,66/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,65/*rwo*/));bind_aset(bind2,2,bind_aget(bind,66/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,65/*rwo*/,bind_aget(bind2,1));bind_aset(bind,66/*x*/,bind_aget(bind2,2)); bind_aset(bind,86/*_result*/,it);
it=bind_aget(bind,86/*_result*/); bind_aset(bind,54/*t*/,it);
bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,54/*t*/));bind_aset(bind2,3,bind_aget(bind,61/*accept*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4da1,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,54/*t*/,bind_aget(bind2,2));bind_aset(bind,61/*accept*/,bind_aget(bind2,3));bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,82/*alt*/));bind_aset(bind2,3,bind_aget(bind,83/*altno*/));bind_aset(bind2,4,bind_aget(bind,63/*oldpos*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__22c0,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,82/*alt*/,bind_aget(bind2,2));bind_aset(bind,83/*altno*/,bind_aget(bind2,3));bind_aset(bind,63/*oldpos*/,bind_aget(bind2,4)); } break4: ptr->pos=oldpos6;   bind_aset(bind2,1,bind_aget(bind,84/*oldcutlabel*/));bind_aset(bind2,2,bind_aget(bind,85/*oldcuts*/));bind_aset(bind2,3,bind_aget(bind,16/*s*/));bind_aset(bind2,4,bind_aget(bind,61/*accept*/));it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_d8d6,1,bind2);bind_aset(bind,84/*oldcutlabel*/,bind_aget(bind2,1));bind_aset(bind,85/*oldcuts*/,bind_aget(bind2,2));bind_aset(bind,16/*s*/,bind_aget(bind2,3));bind_aset(bind,61/*accept*/,bind_aget(bind2,4)); bind_aset(bind,87/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); bind_aset(bind,65/*rwo*/,it);
bind_aset(bind2,1,bind_aget(bind,64/*word*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);bind_aset(bind,64/*word*/,bind_aget(bind2,1));it=rb_funcall(self,sy_AmethystCTranslator_src_dot_to_5e99,1,bind2); bind_aset(bind,92/*autovar*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass36;
 ...
 bind_aset(bind,66/*x*/,it);
bind_aset(bind2,1,bind_aget(bind,65/*rwo*/));bind_aset(bind2,2,bind_aget(bind,66/*x*/));it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);bind_aset(bind,65/*rwo*/,bind_aget(bind2,1));bind_aset(bind,66/*x*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,90/*oldpass*/));bind_aset(bind2,2,bind_aget(bind,94/*to*/));bind_aset(bind2,3,bind_aget(bind,91/*success*/));bind_aset(bind2,4,bind_aget(bind,89/*pass*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_0673,1,bind2);bind_aset(bind,90/*oldpass*/,bind_aget(bind2,1));bind_aset(bind,94/*to*/,bind_aget(bind2,2));bind_aset(bind,91/*success*/,bind_aget(bind2,3));bind_aset(bind,89/*pass*/,bind_aget(bind2,4)); bind_aset(bind,95/*autovar*/,it);
...
cstruct oldpass37=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_src_dot_name_80f3,1,bind2); bind_aset(bind,34/*name*/,it);
bind_aset(bind2,1,bind_aget(bind,34/*name*/));it=rb_funcall(self,sy_AmethystCTranslator__lp_Current_bc00,1,bind2);bind_aset(bind,34/*name*/,bind_aget(bind2,1));FAILTEST(pass37);bind_aset(bind2,1,bind_aget(bind,34/*name*/));it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_f912,1,bind2);bind_aset(bind,34/*name*/,bind_aget(bind2,1));it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind2); bind_aset(bind,100/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,34/*name*/));bind_aset(bind2,2,bind_aget(bind,16/*s*/));bind_aset(bind2,3,bind_aget(bind,102/*body*/));it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_2653,1,bind2);bind_aset(bind,34/*name*/,bind_aget(bind2,1));bind_aset(bind,16/*s*/,bind_aget(bind2,2));bind_aset(bind,102/*body*/,bind_aget(bind2,3)); bind_aset(bind,103/*autovar*/,it);
...
cstruct oldpass39=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_src_dot_name_80f3,1,bind2); bind_aset(bind,34/*name*/,it);
bind_aset(bind2,1,bind_aget(bind,34/*name*/));it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_f912,1,bind2);bind_aset(bind,34/*name*/,bind_aget(bind2,1));it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind2); bind_aset(bind,105/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,34/*name*/));bind_aset(bind2,2,bind_aget(bind,102/*body*/));it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_ae61,1,bind2);bind_aset(bind,34/*name*/,bind_aget(bind2,1));bind_aset(bind,102/*body*/,bind_aget(bind2,2)); bind_aset(bind,107/*autovar*/,it);
...
bind_aset(bind2,1,bind_aget(bind,109/*autovar*/));bind_aset(bind2,2,bind_aget(bind,110/*autovar*/));it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);bind_aset(bind,109/*autovar*/,bind_aget(bind2,1));bind_aset(bind,110/*autovar*/,bind_aget(bind2,2)); } break5: ptr->pos=oldpos9;   it=bind_aget(bind,109/*autovar*/); bind_aset(bind,54/*t*/,it);
bind_aset(bind2,1,bind_aget(bind,54/*t*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__ti__cfcb,1,bind2);bind_aset(bind,54/*t*/,bind_aget(bind2,1)); bind_aset(bind,111/*autovar*/,it);
...
cstruct oldpass42=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_t_c6ab,1,bind2); bind_aset(bind,6/*_result*/,it);
 break;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass44;
                ...
                bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,115/*c*/));bind_aset(bind2,3,bind_aget(bind,54/*t*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__252c,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,115/*c*/,bind_aget(bind2,2));bind_aset(bind,54/*t*/,bind_aget(bind2,3)); } break6: ptr->pos=oldpos10;   bind_aset(bind2,1,bind_aget(bind,16/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4db9,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1)); bind_aset(bind,116/*autovar*/,it);
...
cstruct oldpass45=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind2); bind_aset(bind,118/*sh*/,it);
it=i_0; bind_aset(bind,35/*ii*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,56/*init*/,it);
bind_aset(bind2,1,bind_aget(bind,118/*sh*/));it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__92e2,1,bind2);bind_aset(bind,118/*sh*/,bind_aget(bind2,1));bind_aset(bind2,1,bind_aget(bind,118/*sh*/));it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__f722,1,bind2);bind_aset(bind,118/*sh*/,bind_aget(bind2,1)); bind_aset(bind,16/*s*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass46;
                ...
                bind_aset(bind2,1,bind_aget(bind,115/*c*/));bind_aset(bind2,2,bind_aget(bind,56/*init*/));bind_aset(bind2,3,bind_aget(bind,35/*ii*/));bind_aset(bind2,4,bind_aget(bind,16/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__dot__1364,1,bind2);bind_aset(bind,115/*c*/,bind_aget(bind2,1));bind_aset(bind,56/*init*/,bind_aget(bind2,2));bind_aset(bind,35/*ii*/,bind_aget(bind2,3));bind_aset(bind,16/*s*/,bind_aget(bind2,4));bind_aset(bind2,1,bind_aget(bind,16/*s*/));bind_aset(bind2,2,bind_aget(bind,54/*t*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__1dcb,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1));bind_aset(bind,54/*t*/,bind_aget(bind2,2)); } break7: ptr->pos=oldpos11;   bind_aset(bind2,1,bind_aget(bind,118/*sh*/));bind_aset(bind2,2,bind_aget(bind,56/*init*/));it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__aac8,1,bind2);bind_aset(bind,118/*sh*/,bind_aget(bind2,1));bind_aset(bind,56/*init*/,bind_aget(bind2,2));bind_aset(bind2,1,bind_aget(bind,16/*s*/));it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4db9,1,bind2);bind_aset(bind,16/*s*/,bind_aget(bind2,1)); bind_aset(bind,120/*autovar*/,it);
...
sy_AmethystCTranslator_h_eq__dq_VALUE_2653=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_2653");
sy_AmethystCTranslator_h_eq__dq_VALUE_3d5e=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_3d5e");
sy_AmethystCTranslator_h_eq__dq_VALUE_ae61=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_ae61");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('5a8ea1620bbd1fe0926be5ded99b72b7')");}
