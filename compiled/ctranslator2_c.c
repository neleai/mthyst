...
static VALUE sy_AmethystCTranslator__append_lp__be60;
...
static VALUE sy_AmethystCTranslator__at_header_lt__89fd;
...
static VALUE sy_AmethystCTranslator__at_init_sp__sp__lt__e3a0;
...
static VALUE sy_AmethystCTranslator__dq_switch_lp__26e3;
...
static VALUE sy_AmethystCTranslator_bind_lb_21_rb__7f4a;
static VALUE sy_AmethystCTranslator_bind_lb_21_rb__8364;
...
static VALUE sy_AmethystCTranslator_bind_lb_93_rb__90e7;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_394b;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_a42c;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(99);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
int oldpos3; while(1){oldpos3=ame_getpos(self); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_4,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(break2); bind_aset(bind,27/*aa*/,it);
...
cstruct oldpass12=*ptr; int fail12=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_5,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass12); bind_aset(bind,34/*e*/,it);
...
int oldpos5; while(1){oldpos5=ame_getpos(self); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_6,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,43/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_7,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass19); bind_aset(bind,46/*t*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_8,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass20); bind_aset(bind,46/*t*/,it);
 bind_aset(bind,58/*x*/,it);
 break;
case 17/*Object*/:; goto pass20; break;
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_aec4,1,bind); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_9,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,6/*_result*/,it);
 bind_aset(bind,58/*x*/,it);
 break;
case 17/*Object*/:; goto break6; break;
...
cstruct oldpass23=*ptr; int fail23=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_10,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass23); bind_aset(bind,76/*autovar*/,it);
...
it=bind_aget(bind,78/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 11/*Result*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,79/*autovar*/,it);
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__7f4a,1,bind);  bind_aset(bind,80/*autovar*/,it);
...
it=bind_aget(bind,80/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 12/*Rule*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,81/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_295d,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind);  bind_aset(bind,82/*autovar*/,it);
cstruct oldpass26=*ptr; int fail26=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_11,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass26); bind_aset(bind,83/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass26; break;
case 17/*Object*/:; goto pass26; break;
}
	goto success26;
	pass26: fail26=1;
	success26: *ptr=oldpass26;
	if(fail26) goto pass25;
it=bind_aget(bind,83/*autovar*/); bind_aset(bind,84/*body*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_a42c,1,bind);  bind_aset(bind,85/*autovar*/,it);
...
it=bind_aget(bind,85/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 13/*Seq*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,86/*autovar*/,it);
...
int oldpos9; while(1){oldpos9=ame_getpos(self); switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_12,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(break7); bind_aset(bind,88/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__be60,1,bind);  break;
case 17/*Object*/:; goto break7; break;
} if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,87/*autovar*/); bind_aset(bind,46/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_46_rb__44d9,1,bind);  bind_aset(bind,89/*autovar*/,it);
...
it=bind_aget(bind,89/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 14/*Stop*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,90/*autovar*/,it);
...
it=rb_obj_clone(s_ame_sets_fef4); bind_aset(bind,6/*_result*/,it);
 break;
case 15/*Switch*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,91/*autovar*/,it);
...
int oldpos10; while(1){oldpos10=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break8); bind_aset(bind,92/*autovar*/,it);
cstruct oldpass30=*ptr; int fail30=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass30); bind_aset(bind,93/*c*/,it);
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_13,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass30); bind_aset(bind,46/*t*/,it);
 break;
case 17/*Object*/:; goto pass30; break;
}it=Qnil;if (ptr->pos<ptr->len) goto pass30;
	goto success30;
	pass30: fail30=1;
	success30: *ptr=oldpass30;
	if(fail30) goto break8;
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__8364,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bcd2,1,bind);  bind_aset(bind,94/*autovar*/,it);
...
it=bind_aget(bind,94/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 16/*Switch_Clas*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,95/*autovar*/,it);
cstruct oldpass31=*ptr; int fail31=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind);  bind_aset(bind,96/*sh*/,it);
it=i_0; bind_aset(bind,25/*ii*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,48/*init*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__89fd,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__26e3,1,bind);  bind_aset(bind,21/*s*/,it);
int oldpos11; while(1){oldpos11=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break9); bind_aset(bind,97/*autovar*/,it);
cstruct oldpass32=*ptr; int fail32=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass32); bind_aset(bind,93/*c*/,it);
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_14,rb_obj_class(ame_curobj(self))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Or*/:case 10/*Pass*/:case 11/*Result*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass32); bind_aset(bind,46/*t*/,it);
 break;
case 17/*Object*/:; goto pass32; break;
}it=Qnil;if (ptr->pos<ptr->len) goto pass32;
	goto success32;
	pass32: fail32=1;
	success32: *ptr=oldpass32;
	if(fail32) goto break9;
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_93_rb__90e7,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__d329,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos11=ame_getpos(self);goto break9;} } } break9: ame_setstop(self,Qnil);  ame_setpos(self,oldpos11); it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__e3a0,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_21_rb__bcd2,1,bind);  bind_aset(bind,98/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__be60=rb_intern("AmethystCTranslator__append_lp__be60");
...
sy_AmethystCTranslator__at_header_lt__89fd=rb_intern("AmethystCTranslator__at_header_lt__89fd");
...
sy_AmethystCTranslator__at_init_sp__sp__lt__e3a0=rb_intern("AmethystCTranslator__at_init_sp__sp__lt__e3a0");
...
sy_AmethystCTranslator__dq_switch_lp__26e3=rb_intern("AmethystCTranslator__dq_switch_lp__26e3");
...
sy_AmethystCTranslator_bind_lb_21_rb__7f4a=rb_intern("AmethystCTranslator_bind_lb_21_rb__7f4a");
sy_AmethystCTranslator_bind_lb_21_rb__8364=rb_intern("AmethystCTranslator_bind_lb_21_rb__8364");
...
sy_AmethystCTranslator_bind_lb_93_rb__90e7=rb_intern("AmethystCTranslator_bind_lb_93_rb__90e7");
sy_AmethystCTranslator_h_eq__dq_VALUE_394b=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_394b");
sy_AmethystCTranslator_h_eq__dq_VALUE_a42c=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_a42c");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('0e5a351cbe01aab5cf7c3a253a528d0f')");}
