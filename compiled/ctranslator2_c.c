...
static VALUE sy_AmethystCTranslator__append_lp__15a7;
static VALUE sy_AmethystCTranslator__append_lp__36fe;
static VALUE sy_AmethystCTranslator__append_lp__3c16;
static VALUE sy_AmethystCTranslator__append_lp__4297;
static VALUE sy_AmethystCTranslator__append_lp__4a9b;
static VALUE sy_AmethystCTranslator__append_lp__5e3c;
static VALUE sy_AmethystCTranslator__append_lp__835a;
static VALUE sy_AmethystCTranslator__append_lp__c289;
static VALUE sy_AmethystCTranslator__append_lp__c554;
static VALUE sy_AmethystCTranslator__append_lp__cbd1;
static VALUE sy_AmethystCTranslator__append_lp__d078;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__15b7;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__2471;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__3afd;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__457b;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__6bda;
static VALUE sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf;
static VALUE sy_AmethystCTranslator__dq__sp__sh__le_bind_ed1b;
static VALUE sy_AmethystCTranslator__dq_class_sp__sh__0b62;
static VALUE sy_AmethystCTranslator__dq_cstruct_faf6;
static VALUE sy_AmethystCTranslator__dq_def_sp__sh__le_b_5b6b;
static VALUE sy_AmethystCTranslator__dq_if_sp__lp_str_8e6c;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_b684;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_db6b;
...
static VALUE sy_AmethystCTranslator__dq_unsigne_9a12;
static VALUE sy_AmethystCTranslator__lb_bind_lb_1_rb__8404;
static VALUE sy_AmethystCTranslator__lp_bind_lb_4_rb__f922;
static VALUE sy_AmethystCTranslator__lp_bind_lb_9_rb__6818;
...
static VALUE sy_AmethystCTranslator_bind_lb_1_rb__lt__f2e1;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__1f87;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__4d72;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__4f8e;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__8231;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__af80;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__d84a;
static VALUE sy_AmethystCTranslator_bind_lb_2_rb__ti__e7b8;
static VALUE sy_AmethystCTranslator_bind_lb_30_rb__7d61;
static VALUE sy_AmethystCTranslator_bind_lb_4_rb_;
static VALUE sy_AmethystCTranslator_bind_lb_50_rb__1f5a;
static VALUE sy_AmethystCTranslator_bind_lb_88_rb__0ada;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_6920;
...
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,sy_AmethystCTranslator_addcallb_dcd7,1,bind);  bind_aset(bind,2/*_result*/,it);
it=bind_aget(bind,2/*_result*/);
return it;
fail: return failobj; }
...
it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_4_rb__f922,1,bind); FAILTEST(alt1_2);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_4_rb_,1,bind);  bind_aset(bind,5/*_result*/,it);
it=bind_aget(bind,5/*_result*/); bind_aset(bind,6/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__4297,1,bind); it=bind_aget(bind,6/*autovar*/); bind_aset(bind,7/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__lt__f2e1,1,bind);  bind_aset(bind,7/*autovar*/,it);
 
ame_setcut(self,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos2); goto break1;
 accept1:;
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__5e3c,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__lb_bind_lb_1_rb__8404,1,bind);  bind_aset(bind,9/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_9_rb__6818,1,bind);  bind_aset(bind,3/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
 break;case 4:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,12/*autovar*/,it);
...
cstruct oldpass5=*ptr; int fail5=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_addlambda(self ); FAILTEST(pass5); bind_aset(bind,14/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__835a,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,17/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_rbbget_lp_s_68a8,1,bind);  bind_aset(bind,19/*autovar*/,it);
...
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf,1,bind);  bind_aset(bind,22/*autovar*/,it);
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(93);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_faf6,1,bind);  bind_aset(bind,18/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass6);
	...
	success6: *ptr=oldpass6;
	if(fail6) goto pass5;
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_6920,1,bind);  bind_aset(bind,26/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__3c16,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,28/*autovar*/); bind_aset(bind,30/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_30_rb__7d61,1,bind);  bind_aset(bind,31/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
...
cstruct oldpass9=*ptr; int fail9=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=rb_obj_clone(s_chr_599e); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass9); bind_aset(bind,34/*chr*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_defs_lt__lt_s_1286,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__fff4,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_init_lt__lt_s_a51d,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_unsigne_9a12,1,bind);  bind_aset(bind,20/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__4f8e,1,bind);  bind_aset(bind,38/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__c554,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,35/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__1f87,1,bind);  bind_aset(bind,39/*autovar*/,it);
...
cstruct oldpass13=*ptr; int fail13=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass13); bind_aset(bind,46/*autovar*/,it);
cstruct oldpass14=*ptr; int fail14=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=c_CAct; arg0=it; it=Amethyst_clas(self ,arg0); FAILTEST(pass13); bind_aset(bind,47/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp_str_8e6c,1,bind);  bind_aset(bind,48/*autovar*/,it);
...
alt1_3: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,42/*autovar*/); bind_aset(bind,49/*autovar*/,it);
...
it=i_0; bind_aset(bind,50/*ii*/,it);
it=rb_ary_new3(0); bind_aset(bind,51/*autovar*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,52/*aa*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_50_rb__1f5a,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__3afd,1,bind);  bind_aset(bind,53/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__c289,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,51/*autovar*/); bind_aset(bind,54/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sp__sh__le_bind_ed1b,1,bind);  bind_aset(bind,55/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__6bda,1,bind);  bind_aset(bind,56/*_result*/,it);
it=bind_aget(bind,56/*_result*/); bind_aset(bind,57/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;case 2:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,58/*autovar*/,it);
cstruct oldpass17=*ptr; int fail17=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_trans(self ); FAILTEST(pass17); bind_aset(bind,59/*e*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__457b,1,bind);  bind_aset(bind,60/*autovar*/,it);
...
it=bind_aget(bind,60/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 3:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,61/*autovar*/,it);
cstruct oldpass18=*ptr; int fail18=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,61/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,62/*autovar*/,it);
int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); bind_aset(bind,63/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d078,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,62/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_ar_eq__ti_src_dot__efea,1,bind);  bind_aset(bind,64/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass18);
	goto success18;
	pass18: fail18=1;
	success18: *ptr=oldpass18;
	if(fail18) goto fail;
it=bind_aget(bind,64/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 4:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,65/*autovar*/,it);
...
it=rb_obj_clone(s_ame_setc_af44); bind_aset(bind,6/*_result*/,it);
 break;case 5:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,66/*autovar*/,it);
...
cstruct oldpass22=*ptr; int fail22=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,69/*autovar*/,it);
int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,70/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__4a9b,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,69/*autovar*/); bind_aset(bind,71/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass22);
	goto success22;
	pass22: fail22=1;
	success22: *ptr=oldpass22;
	if(fail22) goto pass21;
it=bind_aget(bind,71/*autovar*/); bind_aset(bind,30/*t*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass21);
	goto success21;
	pass21: fail21=1;
	success21: *ptr=oldpass21;
	if(fail21) goto pass20;
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass20); bind_aset(bind,72/*rbcode*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq_VALUE_sp_c_8bbf,1,bind);  bind_aset(bind,20/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__8231,1,bind);  bind_aset(bind,73/*autovar*/,it);
...
it=bind_aget(bind,73/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 6:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,74/*autovar*/,it);
cstruct oldpass23=*ptr; int fail23=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_ary_new3(0); bind_aset(bind,75/*autovar*/,it);
int oldpos8; while(1){oldpos8=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,76/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__15a7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,75/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_bg_281f,1,bind);  bind_aset(bind,77/*autovar*/,it);
...
it=bind_aget(bind,77/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,78/*autovar*/,it);
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,79/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind);  bind_aset(bind,80/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,81/*oldpos*/,it);
it=bind_aget(bind,80/*reject*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass24); bind_aset(bind,30/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_db6b,1,bind);  bind_aset(bind,82/*autovar*/,it);
...
it=bind_aget(bind,82/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 8:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,83/*autovar*/,it);
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b_6df7,1,bind);  bind_aset(bind,84/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,81/*oldpos*/,it);
it=bind_aget(bind,84/*brk*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,30/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_b684,1,bind);  bind_aset(bind,85/*autovar*/,it);
...
it=bind_aget(bind,85/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 9:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,86/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,81/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,87/*alt*/,it);
it=i_0; bind_aset(bind,88/*altno*/,it);
it=rb_ary_new3(0); bind_aset(bind,89/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self); int oldpos10=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_88_rb__0ada,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__2471,1,bind);  bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind);  bind_aset(bind,90/*_result*/,it);
it=bind_aget(bind,90/*_result*/); bind_aset(bind,91/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__36fe,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,89/*autovar*/); bind_aset(bind,30/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__d84a,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__af80,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__15b7,1,bind);  bind_aset(bind,92/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__15a7=rb_intern("AmethystCTranslator__append_lp__15a7");
sy_AmethystCTranslator__append_lp__36fe=rb_intern("AmethystCTranslator__append_lp__36fe");
sy_AmethystCTranslator__append_lp__3c16=rb_intern("AmethystCTranslator__append_lp__3c16");
sy_AmethystCTranslator__append_lp__4297=rb_intern("AmethystCTranslator__append_lp__4297");
sy_AmethystCTranslator__append_lp__4a9b=rb_intern("AmethystCTranslator__append_lp__4a9b");
sy_AmethystCTranslator__append_lp__5e3c=rb_intern("AmethystCTranslator__append_lp__5e3c");
sy_AmethystCTranslator__append_lp__835a=rb_intern("AmethystCTranslator__append_lp__835a");
sy_AmethystCTranslator__append_lp__c289=rb_intern("AmethystCTranslator__append_lp__c289");
sy_AmethystCTranslator__append_lp__c554=rb_intern("AmethystCTranslator__append_lp__c554");
sy_AmethystCTranslator__append_lp__cbd1=rb_intern("AmethystCTranslator__append_lp__cbd1");
sy_AmethystCTranslator__append_lp__d078=rb_intern("AmethystCTranslator__append_lp__d078");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__15b7=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__15b7");
sy_AmethystCTranslator__dq__sh__le_bind_lb__2471=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__2471");
sy_AmethystCTranslator__dq__sh__le_bind_lb__3afd=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__3afd");
sy_AmethystCTranslator__dq__sh__le_bind_lb__457b=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__457b");
sy_AmethystCTranslator__dq__sh__le_bind_lb__6bda=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__6bda");
sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf=rb_intern("AmethystCTranslator__dq__sh__le_src_dot_n_9acf");
sy_AmethystCTranslator__dq__sp__sh__le_bind_ed1b=rb_intern("AmethystCTranslator__dq__sp__sh__le_bind_ed1b");
sy_AmethystCTranslator__dq_class_sp__sh__0b62=rb_intern("AmethystCTranslator__dq_class_sp__sh__0b62");
sy_AmethystCTranslator__dq_cstruct_faf6=rb_intern("AmethystCTranslator__dq_cstruct_faf6");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_b684=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_b684");
sy_AmethystCTranslator__dq_int_sp__sh__le_b_db6b=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_db6b");
...
sy_AmethystCTranslator__dq_unsigne_9a12=rb_intern("AmethystCTranslator__dq_unsigne_9a12");
sy_AmethystCTranslator__lb_bind_lb_1_rb__8404=rb_intern("AmethystCTranslator__lb_bind_lb_1_rb__8404");
sy_AmethystCTranslator__lp_bind_lb_4_rb__f922=rb_intern("AmethystCTranslator__lp_bind_lb_4_rb__f922");
sy_AmethystCTranslator__lp_bind_lb_9_rb__6818=rb_intern("AmethystCTranslator__lp_bind_lb_9_rb__6818");
...
sy_AmethystCTranslator_bind_lb_1_rb__lt__f2e1=rb_intern("AmethystCTranslator_bind_lb_1_rb__lt__f2e1");
...
sy_AmethystCTranslator_bind_lb_20_rb__4f8e=rb_intern("AmethystCTranslator_bind_lb_20_rb__4f8e");
sy_AmethystCTranslator_bind_lb_20_rb__8231=rb_intern("AmethystCTranslator_bind_lb_20_rb__8231");
sy_AmethystCTranslator_bind_lb_20_rb__af80=rb_intern("AmethystCTranslator_bind_lb_20_rb__af80");
sy_AmethystCTranslator_bind_lb_20_rb__d84a=rb_intern("AmethystCTranslator_bind_lb_20_rb__d84a");
sy_AmethystCTranslator_bind_lb_2_rb__ti__e7b8=rb_intern("AmethystCTranslator_bind_lb_2_rb__ti__e7b8");
sy_AmethystCTranslator_bind_lb_30_rb__7d61=rb_intern("AmethystCTranslator_bind_lb_30_rb__7d61");
sy_AmethystCTranslator_bind_lb_4_rb_=rb_intern("AmethystCTranslator_bind_lb_4_rb_");
sy_AmethystCTranslator_bind_lb_50_rb__1f5a=rb_intern("AmethystCTranslator_bind_lb_50_rb__1f5a");
sy_AmethystCTranslator_bind_lb_88_rb__0ada=rb_intern("AmethystCTranslator_bind_lb_88_rb__0ada");
sy_AmethystCTranslator_h_eq__dq_VALUE_6920=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_6920");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('c6091d5f351fdba0bd98ba1958baed35')");}
