...
static VALUE sy_AmethystCTranslator__append_lp__47be;
static VALUE sy_AmethystCTranslator__append_lp__5e3c;
static VALUE sy_AmethystCTranslator__append_lp__8043;
...
static VALUE sy_AmethystCTranslator__append_lp__f794;
...
static VALUE sy_AmethystCTranslator__at_init_sp__sp__lt__6c47;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__0eb5;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__321f;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__67bb;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__7f3b;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__f3f8;
static VALUE sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf;
static VALUE sy_AmethystCTranslator__dq__sp__sh__le_bind_4c85;
static VALUE sy_AmethystCTranslator__dq_class_sp__sh__0b62;
static VALUE sy_AmethystCTranslator__dq_cstruct_d31d;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_a011;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_db9f;
...
static VALUE sy_AmethystCTranslator_bind_lb_40_rb__b31f;
static VALUE sy_AmethystCTranslator_bind_lb_60_rb__9241;
static VALUE sy_AmethystCTranslator_bind_lb_7_rb__ti__a05a;
static VALUE sy_AmethystCTranslator_bind_lb_90_rb__d376;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__eq__1a30;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__eq__587e;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__lt__4c8f;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__pl__1059;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__pl__7bc9;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__pl__9cee;
static VALUE sy_AmethystCTranslator_bind_lb_9_rb__pl__dbc8;
...
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_1,rb_obj_class(ame_curobj(self))))){case 0/*Local*/:; int oldpos1=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
 break;
case 1/*Args*/:; int oldpos3=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 accept2:;
 break;
case 2/*Array*/:; int oldpos4=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
 break;
case 3/*Key*/:; int oldpos5=ame_getpos(self);
...
ame_setcut(self,Qnil);goto accept4;
 ...
 accept4:;
 break;
case 4/*Global*/:; int oldpos6=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos6);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt5_2); bind_aset(bind,10/*autovar*/,it);
...
ame_setcut(self,Qnil);goto accept5;
 ...
 accept5:;
 break;
case 5/*Lambda*/:; int oldpos7=ame_getpos(self);
...
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_2,rb_obj_class(ame_curobj(self))))){case 0/*Grammar*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,0/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,0/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
cstruct oldpass3=*ptr; int fail3=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,2/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_ary_new3(0); bind_aset(bind,3/*autovar*/,it);
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break1); bind_aset(bind,4/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__dd73,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,3/*autovar*/); bind_aset(bind,5/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=bind_aget(bind,11/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 1/*Rule*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,13/*autovar*/,it);
cstruct oldpass4=*ptr; int fail4=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,13/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
...
it=bind_aget(bind,18/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 2/*Act*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,19/*autovar*/,it);
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break2); bind_aset(bind,21/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__19cb,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,20/*autovar*/); bind_aset(bind,22/*it*/,it);
...
it=bind_aget(bind,24/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 3/*CAct*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,25/*autovar*/,it);
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,25/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=rb_funcall(self,sy_AmethystCTranslator_ar_eq__ti_src_dot__efea,1,bind);  bind_aset(bind,26/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass7);
	goto success7;
	pass7: fail7=1;
	success7: *ptr=oldpass7;
...
it=bind_aget(bind,26/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 4/*Apply*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,27/*autovar*/,it);
...
cstruct oldpass8=*ptr; int fail8=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass8); bind_aset(bind,31/*autovar*/,it);
...
case '_' ... '_':;   it=AmethystCore_anything(self ); FAILTEST(pass9);if (strncmp(ame_curstr(self),"find",4)) goto pass9; else ame_setpos(self,ame_getpos(self)+4); break;
...
alt1_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,29/*autovar*/); bind_aset(bind,32/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass10); bind_aset(bind,33/*autovar*/,it);
cstruct oldpass11=*ptr; int fail11=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=Amethyst_spaces(self ); FAILTEST(pass11);switch((unsigned char)*ame_curstr(self)){case UC(0) ... 'e':;case 'g' ... UC(255):; goto pass11; break;
case 'f' ... 'f':;   it=AmethystCore_anything(self ); FAILTEST(pass11);if (strncmp(ame_curstr(self),"ails",4)) goto pass11; else ame_setpos(self,ame_getpos(self)+4); break;
}  it=Amethyst_eof(self ); FAILTEST(pass11);
	goto success11;
	pass11: fail11=1;
	success11: *ptr=oldpass11;
	if(fail11) goto pass10;
it=rb_funcall(self,sy_AmethystCTranslator__dq_goto_sp__sh__le__f772,1,bind);  bind_aset(bind,34/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass10);
	goto success10;
	pass10: fail10=1;
	success10: *ptr=oldpass10;
	if(fail10) goto alt1_3;
it=bind_aget(bind,34/*autovar*/); bind_aset(bind,12/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,29/*autovar*/); bind_aset(bind,35/*autovar*/,it);
cstruct oldpass12=*ptr; int fail12=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass12); bind_aset(bind,36/*autovar*/,it);
cstruct oldpass13=*ptr; int fail13=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=Amethyst_spaces(self ); FAILTEST(pass13);switch((unsigned char)*ame_curstr(self)){case UC(0) ... '^':;case '`' ... UC(255):; goto pass13; break;
case '_' ... '_':;   it=AmethystCore_anything(self ); FAILTEST(pass13);if (strncmp(ame_curstr(self),"seq",3)) goto pass13; else ame_setpos(self,ame_getpos(self)+3); break;
}  it=Amethyst_eof(self ); FAILTEST(pass13);
	goto success13;
	pass13: fail13=1;
	success13: *ptr=oldpass13;
	if(fail13) goto pass12;
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_3,rb_obj_class(ame_curobj(self))))){case 0/*CAct*/:;   it=AmethystCore_anything(self ); FAILTEST(pass12); bind_aset(bind,37/*autovar*/,it);
 break;
case 1/*Object*/:; goto pass12; break;
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp_str_1ff2,1,bind);  bind_aset(bind,38/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass12);
	goto success12;
	pass12: fail12=1;
	success12: *ptr=oldpass12;
	if(fail12) goto alt1_4;
it=bind_aget(bind,38/*autovar*/); bind_aset(bind,12/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
 it=bind_aget(bind,29/*autovar*/); bind_aset(bind,39/*autovar*/,it);
...
it=i_0; bind_aset(bind,40/*ii*/,it);
it=rb_ary_new3(0); bind_aset(bind,41/*autovar*/,it);
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,42/*aa*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_40_rb__b31f,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__0eb5,1,bind);  bind_aset(bind,43/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__8043,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,41/*autovar*/); bind_aset(bind,44/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sp__sh__le_bind_4c85,1,bind);  bind_aset(bind,45/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__321f,1,bind);  bind_aset(bind,46/*_result*/,it);
it=bind_aget(bind,46/*_result*/); bind_aset(bind,47/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass15);
	goto success15;
	pass15: fail15=1;
	success15: *ptr=oldpass15;
	if(fail15) goto alt1_5;
it=bind_aget(bind,47/*autovar*/); bind_aset(bind,12/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept1;
  alt1_5:  ame_setpos(self,oldpos4); goto fail;
 accept1:;
 break;
case 5/*Seq*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,48/*autovar*/,it);
...
int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break5); bind_aset(bind,50/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__f794,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,49/*autovar*/); bind_aset(bind,7/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_7_rb__ti__a05a,1,bind);  bind_aset(bind,51/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass16);
	goto success16;
	pass16: fail16=1;
	success16: *ptr=oldpass16;
	if(fail16) goto fail;
it=bind_aget(bind,51/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 6/*Bind*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,52/*autovar*/,it);
cstruct oldpass17=*ptr; int fail17=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_trans(self ); FAILTEST(pass17); bind_aset(bind,53/*e*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__67bb,1,bind);  bind_aset(bind,54/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass17);
	goto success17;
	pass17: fail17=1;
	success17: *ptr=oldpass17;
	if(fail17) goto fail;
it=bind_aget(bind,54/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 7/*Or*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,55/*autovar*/,it);
cstruct oldpass18=*ptr; int fail18=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,56/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,57/*fail*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,58/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass18); bind_aset(bind,59/*alt*/,it);
it=i_0; bind_aset(bind,60/*altno*/,it);
it=rb_ary_new3(0); bind_aset(bind,61/*autovar*/,it);
int oldpos7; while(1){oldpos7=ame_getpos(self); int oldpos8=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos8); if (x==0) goto break6;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_60_rb__9241,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__7f3b,1,bind);  bind_aset(bind,62/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,63/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,12/*_result*/,it);
 bind_aset(bind,64/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1470,1,bind);  bind_aset(bind,65/*_result*/,it);
it=bind_aget(bind,65/*_result*/); bind_aset(bind,66/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__47be,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,61/*autovar*/); bind_aset(bind,7/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__eq__587e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__pl__1059,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__f3f8,1,bind);  bind_aset(bind,67/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass18);
	goto success18;
	pass18: fail18=1;
	success18: *ptr=oldpass18;
	if(fail18) goto fail;
it=bind_aget(bind,67/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 8/*Cut*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,68/*autovar*/,it);
...
it=rb_obj_clone(s_ame_setc_af44); bind_aset(bind,12/*_result*/,it);
 break;
case 9/*Stop*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,69/*autovar*/,it);
...
it=rb_obj_clone(s_ame_sets_fef4); bind_aset(bind,12/*_result*/,it);
 break;
case 10/*Many*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,70/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,58/*oldpos*/,it);
it=bind_aget(bind,71/*brk*/); bind_aset(bind,62/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,63/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass21); bind_aset(bind,7/*t*/,it);
 bind_aset(bind,64/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1470,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_db9f,1,bind);  bind_aset(bind,72/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass21);
	goto success21;
	pass21: fail21=1;
	success21: *ptr=oldpass21;
	if(fail21) goto fail;
it=bind_aget(bind,72/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 11/*Lookahead*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,73/*autovar*/,it);
cstruct oldpass22=*ptr; int fail22=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,73/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,56/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind);  bind_aset(bind,74/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,58/*oldpos*/,it);
it=bind_aget(bind,74/*reject*/); bind_aset(bind,62/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,63/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass22); bind_aset(bind,7/*t*/,it);
 bind_aset(bind,64/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1470,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_a011,1,bind);  bind_aset(bind,75/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass22);
	goto success22;
	pass22: fail22=1;
	success22: *ptr=oldpass22;
	if(fail22) goto fail;
it=bind_aget(bind,75/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 12/*Local*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,76/*autovar*/,it);
cstruct oldpass23=*ptr; int fail23=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 int oldpos9; while(1){oldpos9=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break7); if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_bg_281f,1,bind);  bind_aset(bind,77/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass23);
	goto success23;
	pass23: fail23=1;
	success23: *ptr=oldpass23;
	if(fail23) goto fail;
it=bind_aget(bind,77/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 13/*Result*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,78/*autovar*/,it);
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__eq__1a30,1,bind);  bind_aset(bind,79/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass24);
	goto success24;
	pass24: fail24=1;
	success24: *ptr=oldpass24;
	if(fail24) goto fail;
it=bind_aget(bind,79/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
case 14/*Pass*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,80/*autovar*/,it);
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
          ptr->src=bind_aget(bind,80/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);}
  it=rb_obj_clone(s_pass_1a1d); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass25); bind_aset(bind,81/*pass*/,it);
 it=rb_obj_clone(s_oldpass_6559); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass25); bind_aset(bind,82/*oldpass*/,it);
 it=rb_obj_clone(s_success_260c); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass25); bind_aset(bind,83/*success*/,it);
 it=rb_obj_clone(s_fail_e111); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass25); bind_aset(bind,57/*fail*/,it);
it=bind_aget(bind,81/*pass*/); bind_aset(bind,62/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,63/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_to_5e99,1,bind);  bind_aset(bind,84/*autovar*/,it);
cstruct oldpass26=*ptr; int fail26=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCTranslator_trans(self ); FAILTEST(pass26); bind_aset(bind,85/*autovar*/,it);
...
it=bind_aget(bind,85/*autovar*/); bind_aset(bind,86/*to*/,it);
 bind_aset(bind,64/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1470,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_d31d,1,bind);  bind_aset(bind,87/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass25);
	goto success25;
	pass25: fail25=1;
	success25: *ptr=oldpass25;
	if(fail25) goto fail;
it=bind_aget(bind,87/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
...
cstruct oldpass27=*ptr; int fail27=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator__at_defs_lt__lt_s_1286,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__fff4,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_init_lt__lt_s_a51d,1,bind); it=rb_obj_clone(s_switch_lp__lp__8d89); bind_aset(bind,9/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__pl__7bc9,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos10=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos10); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__pl__9cee,1,bind);  bind_aset(bind,91/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass27);
	goto success27;
	pass27: fail27=1;
	success27: *ptr=oldpass27;
	if(fail27) goto fail;
it=bind_aget(bind,91/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
...
it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__26bb,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__b8f1,1,bind);  bind_aset(bind,9/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_90_rb__d376,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__pl__dbc8,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos11=ame_getpos(self);goto break9;} } } break9: ame_setstop(self,Qnil);  ame_setpos(self,oldpos11); it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__6c47,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_9_rb__pl__9cee,1,bind);  bind_aset(bind,95/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass29);
	goto success29;
	pass29: fail29=1;
	success29: *ptr=oldpass29;
	if(fail29) goto fail;
it=bind_aget(bind,95/*autovar*/); bind_aset(bind,12/*_result*/,it);
 break;
...
sy_AmethystCTranslator__append_lp__47be=rb_intern("AmethystCTranslator__append_lp__47be");
sy_AmethystCTranslator__append_lp__5e3c=rb_intern("AmethystCTranslator__append_lp__5e3c");
sy_AmethystCTranslator__append_lp__8043=rb_intern("AmethystCTranslator__append_lp__8043");
...
sy_AmethystCTranslator__append_lp__f794=rb_intern("AmethystCTranslator__append_lp__f794");
...
sy_AmethystCTranslator__at_init_sp__sp__lt__6c47=rb_intern("AmethystCTranslator__at_init_sp__sp__lt__6c47");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__0eb5=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__0eb5");
sy_AmethystCTranslator__dq__sh__le_bind_lb__321f=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__321f");
sy_AmethystCTranslator__dq__sh__le_bind_lb__67bb=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__67bb");
sy_AmethystCTranslator__dq__sh__le_bind_lb__7f3b=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__7f3b");
sy_AmethystCTranslator__dq__sh__le_bind_lb__f3f8=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__f3f8");
sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf=rb_intern("AmethystCTranslator__dq__sh__le_src_dot_n_9acf");
sy_AmethystCTranslator__dq__sp__sh__le_bind_4c85=rb_intern("AmethystCTranslator__dq__sp__sh__le_bind_4c85");
sy_AmethystCTranslator__dq_class_sp__sh__0b62=rb_intern("AmethystCTranslator__dq_class_sp__sh__0b62");
sy_AmethystCTranslator__dq_cstruct_d31d=rb_intern("AmethystCTranslator__dq_cstruct_d31d");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_a011=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_a011");
sy_AmethystCTranslator__dq_int_sp__sh__le_b_db9f=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_db9f");
...
sy_AmethystCTranslator_bind_lb_40_rb__b31f=rb_intern("AmethystCTranslator_bind_lb_40_rb__b31f");
sy_AmethystCTranslator_bind_lb_60_rb__9241=rb_intern("AmethystCTranslator_bind_lb_60_rb__9241");
sy_AmethystCTranslator_bind_lb_7_rb__ti__a05a=rb_intern("AmethystCTranslator_bind_lb_7_rb__ti__a05a");
sy_AmethystCTranslator_bind_lb_90_rb__d376=rb_intern("AmethystCTranslator_bind_lb_90_rb__d376");
sy_AmethystCTranslator_bind_lb_9_rb__eq__1a30=rb_intern("AmethystCTranslator_bind_lb_9_rb__eq__1a30");
sy_AmethystCTranslator_bind_lb_9_rb__eq__587e=rb_intern("AmethystCTranslator_bind_lb_9_rb__eq__587e");
sy_AmethystCTranslator_bind_lb_9_rb__lt__4c8f=rb_intern("AmethystCTranslator_bind_lb_9_rb__lt__4c8f");
sy_AmethystCTranslator_bind_lb_9_rb__pl__1059=rb_intern("AmethystCTranslator_bind_lb_9_rb__pl__1059");
sy_AmethystCTranslator_bind_lb_9_rb__pl__7bc9=rb_intern("AmethystCTranslator_bind_lb_9_rb__pl__7bc9");
sy_AmethystCTranslator_bind_lb_9_rb__pl__9cee=rb_intern("AmethystCTranslator_bind_lb_9_rb__pl__9cee");
sy_AmethystCTranslator_bind_lb_9_rb__pl__dbc8=rb_intern("AmethystCTranslator_bind_lb_9_rb__pl__dbc8");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('97b39aaaca11092dc6347f17f4ce529d')");}
