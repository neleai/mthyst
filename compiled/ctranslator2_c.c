...
static VALUE sy_AmethystCTranslator__append_lp__778d;
...
static VALUE sy_AmethystCTranslator__at_cutlabe_cd6a;
...
static VALUE sy_AmethystCTranslator__at_header_lt__a05b;
static VALUE sy_AmethystCTranslator__at_init_eq__lb__rb__47da;
static VALUE sy_AmethystCTranslator__at_init_sp__sp__lt__aba0;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__8bb4;
...
static VALUE sy_AmethystCTranslator__dq_cstruct_9a12;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_9b10;
...
static VALUE sy_AmethystCTranslator__dq_switch_lp__d3b2;
...
static VALUE sy_AmethystCTranslator_bind_lb_104_697b;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__016a;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__1922;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__223e;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__271e;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__3c10;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__d438;
...
static VALUE sy_AmethystCTranslator_bind_lb_79_rb__1823;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_2e47;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(110);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass13;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp__sh__le_a_11e0,1,bind);  bind_aset(bind,26/*autovar*/,it);
...
case 'a' ... 'a':;   it=AmethystCore_anything(self ); FAILTEST(pass25);if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else goto pass25; break;
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,59/*oldpos*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,57/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_e2b4,1,bind);  bind_aset(bind,72/*oldstops*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_2ba4,1,bind);  bind_aset(bind,73/*oldstoplabel*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_n_588d,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_a14e,1,bind); it=bind_aget(bind,71/*brk*/); bind_aset(bind,60/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,61/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ddf8,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass26); bind_aset(bind,50/*t*/,it);
 bind_aset(bind,62/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_5015,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__d438,1,bind);  bind_aset(bind,74/*autovar*/,it);
...
alt2_3: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
case 9/*Memo*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,75/*autovar*/,it);
cstruct oldpass27=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator_raise_sp__dq_T_0ab1,1,bind);  bind_aset(bind,76/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass27;
 ...
 break;
case 10/*Or*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,77/*autovar*/,it);
cstruct oldpass28=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,57/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,59/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass28); bind_aset(bind,78/*alt*/,it);
it=i_1; bind_aset(bind,79/*altno*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_7393,1,bind);  bind_aset(bind,80/*oldcutlabel*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_7bbc,1,bind);  bind_aset(bind,81/*oldcuts*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_eq_ni_f875,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_9b10,1,bind);  bind_aset(bind,16/*s*/,it);
int oldpos6;  while(1){oldpos6=ptr->pos; int oldpos7=ptr->pos;
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept7;  reject1: x=0; accept7: it=Qnil; ptr->pos=oldpos7; if (x==0) goto break4;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_79_rb__1823,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__8bb4,1,bind);  bind_aset(bind,60/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,61/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ddf8,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(break4); bind_aset(bind,6/*_result*/,it);
 bind_aset(bind,62/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_5015,1,bind);  bind_aset(bind,82/*_result*/,it);
it=bind_aget(bind,82/*_result*/); bind_aset(bind,50/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__3c10,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__016a,1,bind);  } break4: ptr->pos=oldpos6;   it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_cd6a,1,bind);  bind_aset(bind,83/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass28;
 ...
 break;
case 11/*Pass*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,84/*autovar*/,it);
cstruct oldpass29=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,84/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                    it=rb_obj_clone(s_pass_1a1d); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass29); bind_aset(bind,85/*pass*/,it);
 it=rb_obj_clone(s_oldpass_6559); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass29); bind_aset(bind,86/*oldpass*/,it);
 it=rb_obj_clone(s_success_260c); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass29); bind_aset(bind,87/*success*/,it);
it=bind_aget(bind,85/*pass*/); bind_aset(bind,60/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,61/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ddf8,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_to_5e99,1,bind);  bind_aset(bind,88/*autovar*/,it);
cstruct oldpass30=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,88/*autovar*/);ptr->len=1;
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass30); bind_aset(bind,89/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass30;
                   goto success30;
                   pass30: *ptr=oldpass30; goto pass29;
                   success30: *ptr=oldpass30;
                it=bind_aget(bind,89/*autovar*/); bind_aset(bind,90/*to*/,it);
 bind_aset(bind,62/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_5015,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_9a12,1,bind);  bind_aset(bind,91/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass29;
 ...
 break;
case 12/*Rule*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,92/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_a2c3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind);  bind_aset(bind,93/*autovar*/,it);
cstruct oldpass32=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,93/*autovar*/);ptr->len=1;
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass32); bind_aset(bind,94/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass32;
                   goto success32;
                   pass32: *ptr=oldpass32; goto pass31;
                   success32: *ptr=oldpass32;
                it=bind_aget(bind,94/*autovar*/); bind_aset(bind,95/*body*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_2e47,1,bind);  bind_aset(bind,96/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass31;
 ...
 break;
case 13/*Seq*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,97/*autovar*/,it);
cstruct oldpass33=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_ary_new3(0); bind_aset(bind,98/*autovar*/,it);
int oldpos8;  while(1){oldpos8=ptr->pos;   it=AmethystCTranslator_trans(self ); FAILTEST(break5); bind_aset(bind,99/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__778d,1,bind);  } break5: ptr->pos=oldpos8;   it=bind_aget(bind,98/*autovar*/); bind_aset(bind,50/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_50_rb__0695,1,bind);  bind_aset(bind,100/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass33;
 ...
 break;
case 14/*Stop*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,101/*autovar*/,it);
cstruct oldpass34=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 break;
case 15/*Switch_Char*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,102/*autovar*/,it);
...
int oldpos9;  while(1){oldpos9=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,103/*autovar*/,it);
cstruct oldpass36=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,103/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass36); bind_aset(bind,104/*c*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass36;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__223e,1,bind);  } break6: ptr->pos=oldpos9;   it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__1922,1,bind);  bind_aset(bind,105/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass35;
 ...
 break;
case 16/*Switch_Clas*/:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,106/*autovar*/,it);
cstruct oldpass37=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,106/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind);  bind_aset(bind,107/*sh*/,it);
it=i_0; bind_aset(bind,29/*ii*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,52/*init*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__a05b,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__d3b2,1,bind);  bind_aset(bind,16/*s*/,it);
int oldpos10;  while(1){oldpos10=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,108/*autovar*/,it);
cstruct oldpass38=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,108/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass38); bind_aset(bind,104/*c*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass38;
                ...
                it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_104_697b,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__ffae,1,bind);  } break7: ptr->pos=oldpos10;   it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__aba0,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__1922,1,bind);  bind_aset(bind,109/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass37;
                   goto success37;
                   pass37: *ptr=oldpass37; goto fail;
                   success37: *ptr=oldpass37;
                it=bind_aget(bind,109/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
...
sy_AmethystCTranslator__append_lp__778d=rb_intern("AmethystCTranslator__append_lp__778d");
...
sy_AmethystCTranslator__at_cutlabe_cd6a=rb_intern("AmethystCTranslator__at_cutlabe_cd6a");
...
sy_AmethystCTranslator__at_header_lt__a05b=rb_intern("AmethystCTranslator__at_header_lt__a05b");
sy_AmethystCTranslator__at_init_eq__lb__rb__47da=rb_intern("AmethystCTranslator__at_init_eq__lb__rb__47da");
sy_AmethystCTranslator__at_init_sp__sp__lt__aba0=rb_intern("AmethystCTranslator__at_init_sp__sp__lt__aba0");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__8bb4=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__8bb4");
...
sy_AmethystCTranslator__dq_cstruct_9a12=rb_intern("AmethystCTranslator__dq_cstruct_9a12");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_9b10=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_9b10");
...
sy_AmethystCTranslator__dq_switch_lp__d3b2=rb_intern("AmethystCTranslator__dq_switch_lp__d3b2");
...
sy_AmethystCTranslator_bind_lb_104_697b=rb_intern("AmethystCTranslator_bind_lb_104_697b");
sy_AmethystCTranslator_bind_lb_16_rb__016a=rb_intern("AmethystCTranslator_bind_lb_16_rb__016a");
sy_AmethystCTranslator_bind_lb_16_rb__1922=rb_intern("AmethystCTranslator_bind_lb_16_rb__1922");
sy_AmethystCTranslator_bind_lb_16_rb__223e=rb_intern("AmethystCTranslator_bind_lb_16_rb__223e");
...
sy_AmethystCTranslator_bind_lb_16_rb__d438=rb_intern("AmethystCTranslator_bind_lb_16_rb__d438");
...
sy_AmethystCTranslator_bind_lb_79_rb__1823=rb_intern("AmethystCTranslator_bind_lb_79_rb__1823");
sy_AmethystCTranslator_h_eq__dq_VALUE_2e47=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_2e47");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('a31ba27b9a6373221f62b636be8c9830')");}
