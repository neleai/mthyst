...
static VALUE sy__bind_lb_1_rb__eq__07c2;
...
success36:
        *ptr=oldpass36;
        ...
        it=rb_funcall(self,sy__bind_lb_1_rb__eq__07c2,1,bind2);
        _s=bind_aget(bind2,1);;
        _autovar=bind_aget(bind2,2);;
...
void Init_ctranslator2_c() {
    ...
    sy__bind_lb_1_rb__eq__07c2=rb_intern("_bind_lb_1_rb__eq__07c2");
    ...
    rb_eval_string("testversionctranslator2('8b4c18a7f599611796a8503422351f8b')");
}
