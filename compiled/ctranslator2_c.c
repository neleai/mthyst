...
static VALUE sy_AmethystCTranslator__append_lp__68c6;
static VALUE sy_AmethystCTranslator__append_lp__6f53;
static VALUE sy_AmethystCTranslator__append_lp__835a;
static VALUE sy_AmethystCTranslator__append_lp__8a10;
static VALUE sy_AmethystCTranslator__append_lp__c046;
static VALUE sy_AmethystCTranslator__append_lp__c554;
static VALUE sy_AmethystCTranslator__append_lp__c9ea;
...
static VALUE sy_AmethystCTranslator__dq__at__sh__le_bind_e609;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__60d4;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__82a1;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__ab4c;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__d378;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__e11c;
static VALUE sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf;
static VALUE sy_AmethystCTranslator__dq__sp__sh__le_bind_2d9b;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_e9a2;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_eee9;
...
static VALUE sy_AmethystCTranslator__lb_bind_lb_1_rb__dce6;
static VALUE sy_AmethystCTranslator__lp_bind_lb_12_6a46;
...
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__47ed;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__4d72;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__4f8e;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__50a1;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__93fe;
static VALUE sy_AmethystCTranslator_bind_lb_2_rb__ti__e7b8;
static VALUE sy_AmethystCTranslator_bind_lb_30_rb__7d61;
static VALUE sy_AmethystCTranslator_bind_lb_48_rb__a323;
static VALUE sy_AmethystCTranslator_bind_lb_86_rb__7e96;
...
it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_4_rb__f922,1,bind); FAILTEST(alt1_2);it=bind_aget(bind,4/*c*/); bind_aset(bind,5/*_result*/,it);
...
ame_setcut(self,Qnil);goto accept1;
 ...
 accept1:;
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__5e3c,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,3/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__lb_bind_lb_1_rb__dce6,1,bind);  bind_aset(bind,9/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__at__sh__le_bind_e609,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__lp_bind_lb_12_6a46,1,bind);  bind_aset(bind,3/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp_str_8e6c,1,bind);  bind_aset(bind,46/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_48_rb__a323,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__82a1,1,bind);  bind_aset(bind,51/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__68c6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break4;} } } break4: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,49/*autovar*/); bind_aset(bind,52/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sp__sh__le_bind_2d9b,1,bind);  bind_aset(bind,53/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__ab4c,1,bind);  bind_aset(bind,54/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__60d4,1,bind);  bind_aset(bind,58/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__8a10,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break5;} } } break5: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6); it=bind_aget(bind,60/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator_ar_eq__ti_src_dot__efea,1,bind);  bind_aset(bind,62/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__6f53,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,67/*autovar*/); bind_aset(bind,69/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__93fe,1,bind);  bind_aset(bind,71/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__c046,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,73/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_bg_281f,1,bind);  bind_aset(bind,75/*autovar*/,it);
...
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,77/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind);  bind_aset(bind,78/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,79/*oldpos*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_e9a2,1,bind);  bind_aset(bind,80/*autovar*/,it);
...
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b_6df7,1,bind);  bind_aset(bind,82/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,79/*oldpos*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,30/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_eee9,1,bind);  bind_aset(bind,83/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,79/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,85/*alt*/,it);
...
int oldpos9; while(1){oldpos9=ame_getpos(self); int oldpos10=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_86_rb__7e96,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__e11c,1,bind);  bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind);  bind_aset(bind,88/*_result*/,it);
it=bind_aget(bind,88/*_result*/); bind_aset(bind,89/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__c9ea,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,87/*autovar*/); bind_aset(bind,30/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__50a1,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__47ed,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__d378,1,bind);  bind_aset(bind,90/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__68c6=rb_intern("AmethystCTranslator__append_lp__68c6");
sy_AmethystCTranslator__append_lp__6f53=rb_intern("AmethystCTranslator__append_lp__6f53");
sy_AmethystCTranslator__append_lp__835a=rb_intern("AmethystCTranslator__append_lp__835a");
sy_AmethystCTranslator__append_lp__8a10=rb_intern("AmethystCTranslator__append_lp__8a10");
sy_AmethystCTranslator__append_lp__c046=rb_intern("AmethystCTranslator__append_lp__c046");
sy_AmethystCTranslator__append_lp__c554=rb_intern("AmethystCTranslator__append_lp__c554");
sy_AmethystCTranslator__append_lp__c9ea=rb_intern("AmethystCTranslator__append_lp__c9ea");
...
sy_AmethystCTranslator__dq__at__sh__le_bind_e609=rb_intern("AmethystCTranslator__dq__at__sh__le_bind_e609");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__60d4=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__60d4");
sy_AmethystCTranslator__dq__sh__le_bind_lb__82a1=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__82a1");
sy_AmethystCTranslator__dq__sh__le_bind_lb__ab4c=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__ab4c");
sy_AmethystCTranslator__dq__sh__le_bind_lb__d378=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__d378");
sy_AmethystCTranslator__dq__sh__le_bind_lb__e11c=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__e11c");
sy_AmethystCTranslator__dq__sh__le_src_dot_n_9acf=rb_intern("AmethystCTranslator__dq__sh__le_src_dot_n_9acf");
sy_AmethystCTranslator__dq__sp__sh__le_bind_2d9b=rb_intern("AmethystCTranslator__dq__sp__sh__le_bind_2d9b");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_e9a2=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_e9a2");
sy_AmethystCTranslator__dq_int_sp__sh__le_b_eee9=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_eee9");
...
sy_AmethystCTranslator__lb_bind_lb_1_rb__dce6=rb_intern("AmethystCTranslator__lb_bind_lb_1_rb__dce6");
sy_AmethystCTranslator__lp_bind_lb_12_6a46=rb_intern("AmethystCTranslator__lp_bind_lb_12_6a46");
...
sy_AmethystCTranslator_bind_lb_20_rb__47ed=rb_intern("AmethystCTranslator_bind_lb_20_rb__47ed");
...
sy_AmethystCTranslator_bind_lb_20_rb__50a1=rb_intern("AmethystCTranslator_bind_lb_20_rb__50a1");
sy_AmethystCTranslator_bind_lb_20_rb__93fe=rb_intern("AmethystCTranslator_bind_lb_20_rb__93fe");
...
sy_AmethystCTranslator_bind_lb_48_rb__a323=rb_intern("AmethystCTranslator_bind_lb_48_rb__a323");
sy_AmethystCTranslator_bind_lb_86_rb__7e96=rb_intern("AmethystCTranslator_bind_lb_86_rb__7e96");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('f98fa27fe9c35dcf824bbfc8da3e3d92')");}
