...
static VALUE sy_AmethystCTranslator__append_lp__5c27;
static VALUE sy_AmethystCTranslator__append_lp__5e3c;
static VALUE sy_AmethystCTranslator__append_lp__68c6;
static VALUE sy_AmethystCTranslator__append_lp__7ee7;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__16d6;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__f4b6;
...
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_0424;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b_c17c;
...
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__2520;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__4d72;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__71c6;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__d60e;
static VALUE sy_AmethystCTranslator_bind_lb_20_rb__ed7d;
...
static VALUE sy_AmethystCTranslator_bind_lb_82_rb__d97e;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(87);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); bind_aset(bind,35/*autovar*/,it);
cstruct oldpass10=*ptr; int fail10=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
   ...
   it=AmethystCore_anything(self ); FAILTEST(pass10); bind_aset(bind,36/*c*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__2520,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break3;} } } break3: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__1f87,1,bind);  bind_aset(bind,37/*autovar*/,it);
...
it=bind_aget(bind,37/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 16:;   it=Amethyst_fails(self ); FAILTEST(fail); break;case 1:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,38/*autovar*/,it);
...
int oldpos7; while(1){oldpos7=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break6); bind_aset(bind,66/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__7ee7,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos7=ame_getpos(self);goto break6;} } } break6: ame_setstop(self,Qnil);  ame_setpos(self,oldpos7); it=bind_aget(bind,65/*autovar*/); bind_aset(bind,67/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass22);
	goto success22;
	pass22: fail22=1;
	success22: *ptr=oldpass22;
	if(fail22) goto pass21;
it=bind_aget(bind,67/*autovar*/); bind_aset(bind,30/*t*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass21);
	goto success21;
	pass21: fail21=1;
	success21: *ptr=oldpass21;
	if(fail21) goto pass20;
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass20); bind_aset(bind,68/*rbcode*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq_VALUE_sp_c_8bbf,1,bind);  bind_aset(bind,20/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__ed7d,1,bind);  bind_aset(bind,69/*autovar*/,it);
...
it=bind_aget(bind,71/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 7:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,72/*autovar*/,it);
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,73/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r_95b2,1,bind);  bind_aset(bind,74/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,75/*oldpos*/,it);
it=bind_aget(bind,74/*reject*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_c17c,1,bind);  bind_aset(bind,76/*autovar*/,it);
...
it=bind_aget(bind,76/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 8:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,77/*autovar*/,it);
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b_6df7,1,bind);  bind_aset(bind,78/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,75/*oldpos*/,it);
it=bind_aget(bind,78/*brk*/); bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ea72,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,30/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_0424,1,bind);  bind_aset(bind,79/*autovar*/,it);
...
it=bind_aget(bind,79/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;case 9:;   it=AmethystCore_anything(self ); FAILTEST(fail); bind_aset(bind,80/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,75/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass26); bind_aset(bind,81/*alt*/,it);
it=i_0; bind_aset(bind,82/*altno*/,it);
it=rb_ary_new3(0); bind_aset(bind,83/*autovar*/,it);
int oldpos9; while(1){oldpos9=ame_getpos(self); int oldpos10=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_82_rb__d97e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__f4b6,1,bind);  bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_ecff,1,bind);  bind_aset(bind,84/*_result*/,it);
it=bind_aget(bind,84/*_result*/); bind_aset(bind,85/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__5c27,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos9=ame_getpos(self);goto break8;} } } break8: ame_setstop(self,Qnil);  ame_setpos(self,oldpos9); it=bind_aget(bind,83/*autovar*/); bind_aset(bind,30/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__71c6,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb__d60e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__16d6,1,bind);  bind_aset(bind,86/*autovar*/,it);
...
sy_AmethystCTranslator__append_lp__5c27=rb_intern("AmethystCTranslator__append_lp__5c27");
...
sy_AmethystCTranslator__append_lp__7ee7=rb_intern("AmethystCTranslator__append_lp__7ee7");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__16d6=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__16d6");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__f4b6=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__f4b6");
...
sy_AmethystCTranslator__dq_int_sp__sh__le_b_0424=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_0424");
sy_AmethystCTranslator__dq_int_sp__sh__le_b_c17c=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b_c17c");
...
sy_AmethystCTranslator_bind_lb_20_rb__2520=rb_intern("AmethystCTranslator_bind_lb_20_rb__2520");
sy_AmethystCTranslator_bind_lb_20_rb__4d72=rb_intern("AmethystCTranslator_bind_lb_20_rb__4d72");
sy_AmethystCTranslator_bind_lb_20_rb__71c6=rb_intern("AmethystCTranslator_bind_lb_20_rb__71c6");
sy_AmethystCTranslator_bind_lb_20_rb__d60e=rb_intern("AmethystCTranslator_bind_lb_20_rb__d60e");
sy_AmethystCTranslator_bind_lb_20_rb__ed7d=rb_intern("AmethystCTranslator_bind_lb_20_rb__ed7d");
...
sy_AmethystCTranslator_bind_lb_82_rb__d97e=rb_intern("AmethystCTranslator_bind_lb_82_rb__d97e");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('32f146a0c7951d35fcc6c10fb3995fb2')");}
