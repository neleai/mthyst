...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=var1/*autovar*/;ptr->len=1;
                     it=AmethystCTranslator_rbtrans2(self ); var2/*autovar*/=it;;
...
;goto accept1;
alt1_2: ptr->pos=oldpos1;  it=AmethystCTranslator_trans(self ); FAILTEST(alt1_3); var6/*it*/=it;;
...
alt1_4: ptr->pos=oldpos1;goto fail;
 accept1:;
 } bind_aset(bind2,1,var1/*c*/);bind_aset(bind2,2,var2/*init*/);bind_aset(bind2,3,var0/*ruby*/);it=rb_funcall(self,sy_AmethystCTranslator__lb_bind_lb_1_rb__8fa4,1,bind2);var1/*c*/=bind_aget(bind2,1);;var2/*init*/=bind_aget(bind2,2);;var0/*ruby*/=bind_aget(bind2,3);; var7/*_result*/=it;;
...
int stop1=0; while(!stop1){ int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); var4/*autovar*/=it;;
...
bind_aset(bind2,1,var3/*autovar*/);bind_aset(bind2,2,var7/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var3/*autovar*/=bind_aget(bind2,1);;var7/*autovar*/=bind_aget(bind2,2);;
;goto accept1;
alt1_2: ptr->pos=oldpos1;stop1=1;
;goto accept1;
alt1_3: ptr->pos=oldpos1;goto pass2;
 accept1:;
 } it=var3/*autovar*/; var8/*x*/=it;;
...
cstruct oldpass1=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var0/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCTranslator_rbtrans2(self ); var1/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass1;
                   goto success1;
...
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var3/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCTranslator_rbtrans2(self ); var4/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass2;
                   goto success2;
...
int stop1=0; while(!stop1){ int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=AmethystCTranslator_rbtrans(self ); FAILTEST(alt1_2); var1/*autovar*/=it;;
bind_aset(bind2,1,var0/*autovar*/);bind_aset(bind2,2,var1/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var0/*autovar*/=bind_aget(bind2,1);;var1/*autovar*/=bind_aget(bind2,2);;
;goto accept1;
alt1_2: ptr->pos=oldpos1;stop1=1;
;goto accept1;
alt1_3: ptr->pos=oldpos1;goto fail;
 accept1:;
 } it=var0/*autovar*/; var2/*it*/=it;;
...
int stop1=0; while(!stop1){ int oldpos1=ptr->pos;int cut1=0;
alt1_1:;  it=AmethystCore_anything(self ); FAILTEST(alt1_2); var2/*autovar*/=it;;
bind_aset(bind2,1,var1/*autovar*/);bind_aset(bind2,2,var2/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var1/*autovar*/=bind_aget(bind2,1);;var2/*autovar*/=bind_aget(bind2,2);;
;goto accept1;
alt1_2: ptr->pos=oldpos1;stop1=1;
;goto accept1;
alt1_3: ptr->pos=oldpos1;goto pass1;
 accept1:;
 } it=var1/*autovar*/; var3/*it*/=it;;
...
alt2_1:;it=var9/*autovar*/; var10/*autovar*/=it;;
cstruct oldpass2=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
cstruct oldpass3=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var11/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '^':;case '`' ... UC(255):; goto pass3; break;
...
;goto accept2;
alt2_2: ptr->pos=oldpos2;it=var9/*autovar*/; var13/*autovar*/=it;;
cstruct oldpass4=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var13/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
...
;goto accept2;
alt2_3: ptr->pos=oldpos2;it=var9/*autovar*/; var17/*autovar*/=it;;
cstruct oldpass7=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
;goto accept2;
alt2_4: ptr->pos=oldpos2;it=var9/*autovar*/; var20/*autovar*/=it;;
...
cstruct oldpass10=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var21/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'd':;case 'f' ... UC(255):; goto pass10; break;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass9;
                   goto success9;
                   pass9: *ptr=oldpass9; goto alt2_5;
                   success9: *ptr=oldpass9;
                it=var22/*autovar*/; var6/*_result*/=it;;

;goto accept2;
alt2_5: ptr->pos=oldpos2;it=var9/*autovar*/; var23/*autovar*/=it;;
...
cstruct oldpass12=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var24/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... 'd':;case 'f' ... UC(255):; goto pass12; break;
case 'e' ... 'e':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='m'&&ame_curstr2(ptr)[1]=='p'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='y')  ptr->pos+=4; else goto pass12; break;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass11;
                   goto success11;
                   pass11: *ptr=oldpass11; goto alt2_6;
                   success11: *ptr=oldpass11;
                it=rb_obj_clone(s_it_eq_Qnil); var6/*_result*/=it;;

;goto accept2;
alt2_6: ptr->pos=oldpos2;it=var9/*autovar*/; var25/*autovar*/=it;;
...
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='d'&&ame_curstr2(ptr)[1]=='v'&&ame_curstr2(ptr)[2]=='a'&&ame_curstr2(ptr)[3]=='n'&&ame_curstr2(ptr)[4]=='c'&&ame_curstr2(ptr)[5]=='e'&&ame_curstr2(ptr)[6]=='_'&&ame_curstr2(ptr)[7]=='c'&&ame_curstr2(ptr)[8]=='h'&&ame_curstr2(ptr)[9]=='a'&&ame_curstr2(ptr)[10]=='r')  ptr->pos+=11; else goto pass14; break;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass13;
                   goto success13;
                   pass13: *ptr=oldpass13; goto alt2_7;
                   success13: *ptr=oldpass13;
                it=rb_obj_clone(s_it_eq_rb_st_ee66); var6/*_result*/=it;;

;goto accept2;
alt2_7: ptr->pos=oldpos2;it=var9/*autovar*/; var27/*autovar*/=it;;
...
cstruct oldpass16=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var28/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; goto pass16; break;
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='d'&&ame_curstr2(ptr)[1]=='v'&&ame_curstr2(ptr)[2]=='a'&&ame_curstr2(ptr)[3]=='n'&&ame_curstr2(ptr)[4]=='c'&&ame_curstr2(ptr)[5]=='e'&&ame_curstr2(ptr)[6]=='_'&&ame_curstr2(ptr)[7]=='c'&&ame_curstr2(ptr)[8]=='l'&&ame_curstr2(ptr)[9]=='a'&&ame_curstr2(ptr)[10]=='s')  ptr->pos+=11; else goto pass16; break;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass15;
                   goto success15;
                   pass15: *ptr=oldpass15; goto alt2_8;
                   success15: *ptr=oldpass15;
                it=rb_obj_clone(s_it_eq_ame_c_4b8d); var6/*_result*/=it;;

;goto accept2;
alt2_8: ptr->pos=oldpos2;it=var9/*autovar*/; var29/*autovar*/=it;;
...
cstruct oldpass18=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var30/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '^':;case '`' ... UC(255):; goto pass18; break;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass17;
                   goto success17;
                   pass17: *ptr=oldpass17; goto alt2_9;
                   success17: *ptr=oldpass17;
                it=var32/*autovar*/; var6/*_result*/=it;;

;goto accept2;
alt2_9: ptr->pos=oldpos2;it=var9/*autovar*/; var33/*autovar*/=it;;
...
int stop2=0; while(!stop2){ switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:; int oldpos3=ptr->pos;int cut3=0;
alt3_1:;  it=AmethystCTranslator_trans(self ); FAILTEST(alt3_2); var37/*aa*/=it;;
...
bind_aset(bind2,1,var36/*autovar*/);bind_aset(bind2,2,var38/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var36/*autovar*/=bind_aget(bind2,1);;var38/*autovar*/=bind_aget(bind2,2);;
;goto accept3;
alt3_2: ptr->pos=oldpos3;stop2=1;
;goto accept3;
alt3_3: ptr->pos=oldpos3;goto pass20;
 accept3:;
 break;
case 17/*Object*/:; stop2=1; break;
} } it=var36/*autovar*/; var39/*args*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator_src_25d9,1,bind2); var40/*app*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass20;
                   goto success20;
                   pass20: *ptr=oldpass20; goto alt2_10;
...
;goto accept2;
alt2_10: ptr->pos=oldpos2;goto fail;
 accept2:;
 break;
...
cstruct oldpass21=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_6,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass21); var42/*e*/=it;;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass21; break;
case 17/*Object*/:; goto pass21; break;
}
                   goto success21;
...
int stop3=0; while(!stop3){ switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_7,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:; int oldpos4=ptr->pos;int cut4=0;
alt4_1:;  it=AmethystCTranslator_trans(self ); FAILTEST(alt4_2); var51/*autovar*/=it;;
bind_aset(bind2,1,var50/*autovar*/);bind_aset(bind2,2,var51/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var50/*autovar*/=bind_aget(bind2,1);;var51/*autovar*/=bind_aget(bind2,2);;
;goto accept4;
alt4_2: ptr->pos=oldpos4;stop3=1;
;goto accept4;
alt4_3: ptr->pos=oldpos4;goto pass26;
 accept4:;
 break;
case 17/*Object*/:; stop3=1; break;
} } it=var50/*autovar*/; var52/*autovar*/=it;;
...
bind_aset(bind2,1,var64/*word*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);var64/*word*/=bind_aget(bind2,1);;switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_8,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass28); var54/*t*/=it;;
 var66/*x*/=it;;
 break;
case 17/*Object*/:; goto pass28; break;
...
alt5_1:;it=var70/*autovar*/; var71/*autovar*/=it;;
cstruct oldpass29=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_9,rb_obj_class(ame_curobj2(ptr))))){case 0/*Or*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var72/*autovar*/=it;;
cstruct oldpass30=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_10,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var73/*autovar*/=it;;
cstruct oldpass31=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var73/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass31); var74/*autovar*/=it;;
cstruct oldpass32=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var74/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self );switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; goto pass32; break;
case 'a' ... 'a':; it=rb_str_new(ptr->str+ptr->pos,1);ptr->pos++;if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else goto pass32; break;
                ...
                switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_11,rb_obj_class(ame_curobj2(ptr))))){case 0/*Stop*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var75/*autovar*/=it;;
 break;
case 1/*Object*/:; goto pass30; break;
}cstruct oldpass33=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var75/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=Qnil;if (ptr->pos<ptr->len) goto pass33;
                   goto success33;
                   pass33: *ptr=oldpass33; goto pass30;
                   success33: *ptr=oldpass33;
                it=Qnil;if (ptr->pos<ptr->len) goto pass30; break;
case 1/*Object*/:; goto pass30; break;
}
                   goto success30;
...
case 1/*Object*/:; goto pass29; break;
                   ...
                   goto success29;
                   pass29: *ptr=oldpass29; goto alt5_2;
                   success29: *ptr=oldpass29;
                it=rb_obj_clone(s_ptr_mi__gt_pos_db4c); var6/*_result*/=it;;

;goto accept5;
alt5_2: ptr->pos=oldpos5;it=var70/*autovar*/; var76/*autovar*/=it;;
cstruct oldpass34=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var76/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_12,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:; it=rb_funcall(self,sy_AmethystCTranslator__at_stops_e2b4,1,bind2); var77/*oldstops*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_2ba4,1,bind2); var78/*oldstoplabel*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_n_588d,1,bind2);it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_a14e,1,bind2);  it=AmethystCTranslator_trans(self ); FAILTEST(pass34); var54/*t*/=it;;
bind_aset(bind2,1,var16/*s*/);bind_aset(bind2,2,var54/*t*/);bind_aset(bind2,3,var77/*oldstops*/);bind_aset(bind2,4,var78/*oldstoplabel*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__eq__7d1a,1,bind2);var16/*s*/=bind_aget(bind2,1);;var54/*t*/=bind_aget(bind2,2);;var77/*oldstops*/=bind_aget(bind2,3);;var78/*oldstoplabel*/=bind_aget(bind2,4);; var79/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass34; break;
case 17/*Object*/:; it=rb_funcall(self,sy_AmethystCTranslator__at_stops_e2b4,1,bind2);it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_2ba4,1,bind2);it=rb_funcall(self,sy_AmethystCTranslator__at_stops_eq_n_588d,1,bind2);it=rb_funcall(self,sy_AmethystCTranslator__at_stoplab_a14e,1,bind2);goto pass34; break;
}
                   goto success34;
                   pass34: *ptr=oldpass34; goto alt5_3;
                   success34: *ptr=oldpass34;
                it=var79/*autovar*/; var6/*_result*/=it;;

;goto accept5;
alt5_3: ptr->pos=oldpos5;goto fail;
 accept5:;
 break;
case 9/*Memo*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var80/*autovar*/=it;;
cstruct oldpass35=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var80/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   ptr->pos=ptr->len;it=rb_funcall(self,sy_AmethystCTranslator_raise_sp__dq_T_0ab1,1,bind2); var81/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass35;
                   goto success35;
                   pass35: *ptr=oldpass35; goto fail;
                   success35: *ptr=oldpass35;
                it=var81/*autovar*/; var6/*_result*/=it;;
 break;
case 10/*Or*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var82/*autovar*/=it;;
cstruct oldpass36=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var82/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind2); var61/*accept*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind2); var63/*oldpos*/=it;;
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass36); var83/*alt*/=it;;
it=i_1; var84/*altno*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_7393,1,bind2); var85/*oldcutlabel*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_7bbc,1,bind2); var86/*oldcuts*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_cuts_eq_ni_f875,1,bind2);bind_aset(bind2,1,var63/*oldpos*/);bind_aset(bind2,2,var83/*alt*/);bind_aset(bind2,3,var84/*altno*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b_0b60,1,bind2);var63/*oldpos*/=bind_aget(bind2,1);;var83/*alt*/=bind_aget(bind2,2);;var84/*altno*/=bind_aget(bind2,3);; var16/*s*/=it;;
int stop4=0; while(!stop4){ switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_13,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:; int oldpos6=ptr->pos;int cut6=0;
alt6_1:;int oldpos7=ptr->pos;
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept7;  reject1: x=0; accept7: it=Qnil; ptr->pos=oldpos7; if (x==0) goto alt6_2;bind_aset(bind2,1,var84/*altno*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__891b,1,bind2);var84/*altno*/=bind_aget(bind2,1);;bind_aset(bind2,1,var83/*alt*/);bind_aset(bind2,2,var84/*altno*/);it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__9630,1,bind2);var83/*alt*/=bind_aget(bind2,1);;var84/*altno*/=bind_aget(bind2,2);; var64/*word*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); var65/*rwo*/=it;;
bind_aset(bind2,1,var64/*word*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);var64/*word*/=bind_aget(bind2,1);;  it=AmethystCTranslator_trans(self ); FAILTEST(alt6_2); var6/*_result*/=it;;
 var66/*x*/=it;;
bind_aset(bind2,1,var65/*rwo*/);bind_aset(bind2,2,var66/*x*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);var65/*rwo*/=bind_aget(bind2,1);;var66/*x*/=bind_aget(bind2,2);; var87/*_result*/=it;;
it=var87/*_result*/; var54/*t*/=it;;
bind_aset(bind2,1,var16/*s*/);bind_aset(bind2,2,var54/*t*/);bind_aset(bind2,3,var61/*accept*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4da1,1,bind2);var16/*s*/=bind_aget(bind2,1);;var54/*t*/=bind_aget(bind2,2);;var61/*accept*/=bind_aget(bind2,3);;bind_aset(bind2,1,var16/*s*/);bind_aset(bind2,2,var83/*alt*/);bind_aset(bind2,3,var84/*altno*/);bind_aset(bind2,4,var63/*oldpos*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__22c0,1,bind2);var16/*s*/=bind_aget(bind2,1);;var83/*alt*/=bind_aget(bind2,2);;var84/*altno*/=bind_aget(bind2,3);;var63/*oldpos*/=bind_aget(bind2,4);;
;goto accept6;
alt6_2: ptr->pos=oldpos6;stop4=1;
;goto accept6;
alt6_3: ptr->pos=oldpos6;goto pass36;
 accept6:;
 break;
case 17/*Object*/:; int oldpos8=ptr->pos;int cut7=0;
alt7_1:;int oldpos9=ptr->pos;
   it=AmethystCore_anything(self ); FAILTEST(reject2); x=1; goto accept9;  reject2: x=0; accept9: it=Qnil; ptr->pos=oldpos9; if (x==0) goto alt7_2;bind_aset(bind2,1,var84/*altno*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__891b,1,bind2);var84/*altno*/=bind_aget(bind2,1);;bind_aset(bind2,1,var83/*alt*/);bind_aset(bind2,2,var84/*altno*/);it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__9630,1,bind2);var83/*alt*/=bind_aget(bind2,1);;var84/*altno*/=bind_aget(bind2,2);; var64/*word*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2);bind_aset(bind2,1,var64/*word*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);var64/*word*/=bind_aget(bind2,1);;goto alt7_2;
;goto accept8;
alt7_2: ptr->pos=oldpos8;stop4=1;
;goto accept8;
alt7_3: ptr->pos=oldpos8;goto pass36;
 accept8:;
 break;
} } bind_aset(bind2,1,var85/*oldcutlabel*/);bind_aset(bind2,2,var86/*oldcuts*/);bind_aset(bind2,3,var16/*s*/);bind_aset(bind2,4,var61/*accept*/);it=rb_funcall(self,sy_AmethystCTranslator__at_cutlabe_d8d6,1,bind2);var85/*oldcutlabel*/=bind_aget(bind2,1);;var86/*oldcuts*/=bind_aget(bind2,2);;var16/*s*/=bind_aget(bind2,3);;var61/*accept*/=bind_aget(bind2,4);; var88/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass36;
                   goto success36;
                   pass36: *ptr=oldpass36; goto fail;
                   success36: *ptr=oldpass36;
                it=var88/*autovar*/; var6/*_result*/=it;;
 break;
case 11/*Pass*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var89/*autovar*/=it;;
cstruct oldpass37=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var89/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                    it=rb_obj_clone(s_pass_1a1d); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass37); var90/*pass*/=it;;
 it=rb_obj_clone(s_oldpass_6559); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass37); var91/*oldpass*/=it;;
 it=rb_obj_clone(s_success_260c); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass37); var92/*success*/=it;;
it=var90/*pass*/; var64/*word*/=it;;
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind2); var65/*rwo*/=it;;
bind_aset(bind2,1,var64/*word*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e643,1,bind2);var64/*word*/=bind_aget(bind2,1);;it=rb_funcall(self,sy_AmethystCTranslator_src_dot_to_5e99,1,bind2); var93/*autovar*/=it;;
cstruct oldpass38=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=var93/*autovar*/;ptr->len=1;
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_14,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass38); var94/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass38; break;
case 17/*Object*/:; goto pass38; break;
}
                   goto success38;
                   pass38: *ptr=oldpass38; goto pass37;
                   success38: *ptr=oldpass38;
                it=var94/*autovar*/; var95/*to*/=it;;
 var66/*x*/=it;;
bind_aset(bind2,1,var65/*rwo*/);bind_aset(bind2,2,var66/*x*/);it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_e174,1,bind2);var65/*rwo*/=bind_aget(bind2,1);;var66/*x*/=bind_aget(bind2,2);;bind_aset(bind2,1,var91/*oldpass*/);bind_aset(bind2,2,var95/*to*/);bind_aset(bind2,3,var92/*success*/);bind_aset(bind2,4,var90/*pass*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct_0673,1,bind2);var91/*oldpass*/=bind_aget(bind2,1);;var95/*to*/=bind_aget(bind2,2);;var92/*success*/=bind_aget(bind2,3);;var90/*pass*/=bind_aget(bind2,4);; var96/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass37;
                   goto success37;
                   pass37: *ptr=oldpass37; goto fail;
                   success37: *ptr=oldpass37;
                it=var96/*autovar*/; var6/*_result*/=it;;
 break;
case 12/*Rule*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var97/*autovar*/=it;;
it=var97/*autovar*/; var98/*autovar*/=it;;
it=var98/*autovar*/; var99/*autovar*/=it;;
int oldpos10=ptr->pos;int cut8=0;
alt8_1:;it=var99/*autovar*/; var100/*autovar*/=it;;
cstruct oldpass39=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var100/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator_src_dot_name_80f3,1,bind2); var34/*name*/=it;;
bind_aset(bind2,1,var34/*name*/);it=rb_funcall(self,sy_AmethystCTranslator__lp_Current_bc00,1,bind2);var34/*name*/=bind_aget(bind2,1);;FAILTEST(pass39);bind_aset(bind2,1,var34/*name*/);it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_f912,1,bind2);var34/*name*/=bind_aget(bind2,1);;it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind2); var101/*autovar*/=it;;
cstruct oldpass40=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=var101/*autovar*/;ptr->len=1;
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_15,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass40); var102/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass40; break;
case 17/*Object*/:; goto pass40; break;
}
                   goto success40;
                   pass40: *ptr=oldpass40; goto pass39;
                   success40: *ptr=oldpass40;
                it=var102/*autovar*/; var103/*body*/=it;;
bind_aset(bind2,1,var34/*name*/);bind_aset(bind2,2,var16/*s*/);bind_aset(bind2,3,var103/*body*/);it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_c6bd,1,bind2);var34/*name*/=bind_aget(bind2,1);;var16/*s*/=bind_aget(bind2,2);;var103/*body*/=bind_aget(bind2,3);; var104/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass39;
                   goto success39;
                   pass39: *ptr=oldpass39; goto alt8_2;
                   success39: *ptr=oldpass39;
                it=var104/*autovar*/; var6/*_result*/=it;;

;goto accept10;
alt8_2: ptr->pos=oldpos10;it=var99/*autovar*/; var105/*autovar*/=it;;
cstruct oldpass41=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var105/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator_src_dot_name_80f3,1,bind2); var34/*name*/=it;;
bind_aset(bind2,1,var34/*name*/);it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_f912,1,bind2);var34/*name*/=bind_aget(bind2,1);;it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind2); var106/*autovar*/=it;;
cstruct oldpass42=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=var106/*autovar*/;ptr->len=1;
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_16,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass42); var107/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass42; break;
case 17/*Object*/:; goto pass42; break;
}
                   goto success42;
                   pass42: *ptr=oldpass42; goto pass41;
                   success42: *ptr=oldpass42;
                it=var107/*autovar*/; var103/*body*/=it;;
bind_aset(bind2,1,var34/*name*/);bind_aset(bind2,2,var103/*body*/);it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_c505,1,bind2);var34/*name*/=bind_aget(bind2,1);;var103/*body*/=bind_aget(bind2,2);; var108/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass41;
                   goto success41;
                   pass41: *ptr=oldpass41; goto alt8_3;
                   success41: *ptr=oldpass41;
                it=var108/*autovar*/; var6/*_result*/=it;;

;goto accept10;
alt8_3: ptr->pos=oldpos10;goto fail;
 accept10:;
 break;
case 13/*Seq*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var109/*autovar*/=it;;
cstruct oldpass43=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var109/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_ary_new3(0); var110/*autovar*/=it;;
int stop5=0; while(!stop5){ switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_17,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:; int oldpos11=ptr->pos;int cut9=0;
alt9_1:;  it=AmethystCTranslator_trans(self ); FAILTEST(alt9_2); var111/*autovar*/=it;;
bind_aset(bind2,1,var110/*autovar*/);bind_aset(bind2,2,var111/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__append_lp__d113,1,bind2);var110/*autovar*/=bind_aget(bind2,1);;var111/*autovar*/=bind_aget(bind2,2);;
;goto accept11;
alt9_2: ptr->pos=oldpos11;stop5=1;
;goto accept11;
alt9_3: ptr->pos=oldpos11;goto pass43;
 accept11:;
 break;
case 17/*Object*/:; stop5=1; break;
} } it=var110/*autovar*/; var54/*t*/=it;;
bind_aset(bind2,1,var54/*t*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__ti__cfcb,1,bind2);var54/*t*/=bind_aget(bind2,1);; var112/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass43;
                   goto success43;
                   pass43: *ptr=oldpass43; goto fail;
                   success43: *ptr=oldpass43;
                it=var112/*autovar*/; var6/*_result*/=it;;
 break;
case 14/*Stop*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var113/*autovar*/=it;;
...
int stop6=0; while(!stop6){ int oldpos12=ptr->pos;int cut10=0;
alt10_1:;  it=AmethystCore_anything(self ); FAILTEST(alt10_2); var115/*autovar*/=it;;
cstruct oldpass46=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var115/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass46); var116/*c*/=it;;
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_18,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass46); var54/*t*/=it;;
 break;
case 17/*Object*/:; goto pass46; break;
}it=Qnil;if (ptr->pos<ptr->len) goto pass46;
                   goto success46;
                   pass46: *ptr=oldpass46; goto alt10_2;
                   success46: *ptr=oldpass46;
                bind_aset(bind2,1,var16/*s*/);bind_aset(bind2,2,var116/*c*/);bind_aset(bind2,3,var54/*t*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__252c,1,bind2);var16/*s*/=bind_aget(bind2,1);;var116/*c*/=bind_aget(bind2,2);;var54/*t*/=bind_aget(bind2,3);;
;goto accept12;
alt10_2: ptr->pos=oldpos12;stop6=1;
;goto accept12;
alt10_3: ptr->pos=oldpos12;goto pass45;
 accept12:;
 } bind_aset(bind2,1,var16/*s*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4db9,1,bind2);var16/*s*/=bind_aget(bind2,1);; var117/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass45;
                   goto success45;
                   pass45: *ptr=oldpass45; goto fail;
                   success45: *ptr=oldpass45;
                it=var117/*autovar*/; var6/*_result*/=it;;
 break;
case 16/*Switch_Clas*/:; it=ame_curobj2(ptr)               ;ptr->pos++; var118/*autovar*/=it;;
cstruct oldpass47=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var118/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                   it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind2); var119/*sh*/=it;;
it=i_0; var35/*ii*/=it;;
it=rb_obj_clone(s__d41d); var56/*init*/=it;;
bind_aset(bind2,1,var119/*sh*/);it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__92e2,1,bind2);var119/*sh*/=bind_aget(bind2,1);;bind_aset(bind2,1,var119/*sh*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__f722,1,bind2);var119/*sh*/=bind_aget(bind2,1);; var16/*s*/=it;;
int stop7=0; while(!stop7){ int oldpos13=ptr->pos;int cut11=0;
alt11_1:;  it=AmethystCore_anything(self ); FAILTEST(alt11_2); var120/*autovar*/=it;;
cstruct oldpass48=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=var120/*autovar*/; if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass48); var116/*c*/=it;;
switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_19,rb_obj_class(ame_curobj2(ptr))))){case 0/*Act*/:case 1/*Apply*/:case 2/*Bind*/:case 3/*CAct*/:case 4/*Cut*/:case 5/*Grammar*/:case 6/*Local*/:case 7/*Lookahead*/:case 8/*Many*/:case 9/*Memo*/:case 10/*Or*/:case 11/*Pass*/:case 12/*Rule*/:case 13/*Seq*/:case 14/*Stop*/:case 15/*Switch_Char*/:case 16/*Switch_Clas*/:;   it=AmethystCTranslator_trans(self ); FAILTEST(pass48); var54/*t*/=it;;
 break;
case 17/*Object*/:; goto pass48; break;
}it=Qnil;if (ptr->pos<ptr->len) goto pass48;
                   goto success48;
                   pass48: *ptr=oldpass48; goto alt11_2;
                   success48: *ptr=oldpass48;
                bind_aset(bind2,1,var116/*c*/);bind_aset(bind2,2,var56/*init*/);bind_aset(bind2,3,var35/*ii*/);bind_aset(bind2,4,var16/*s*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__dot__1364,1,bind2);var116/*c*/=bind_aget(bind2,1);;var56/*init*/=bind_aget(bind2,2);;var35/*ii*/=bind_aget(bind2,3);;var16/*s*/=bind_aget(bind2,4);;bind_aset(bind2,1,var16/*s*/);bind_aset(bind2,2,var54/*t*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__1dcb,1,bind2);var16/*s*/=bind_aget(bind2,1);;var54/*t*/=bind_aget(bind2,2);;
;goto accept13;
alt11_2: ptr->pos=oldpos13;stop7=1;
;goto accept13;
alt11_3: ptr->pos=oldpos13;goto pass47;
 accept13:;
 } bind_aset(bind2,1,var119/*sh*/);bind_aset(bind2,2,var56/*init*/);it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__aac8,1,bind2);var119/*sh*/=bind_aget(bind2,1);;var56/*init*/=bind_aget(bind2,2);;bind_aset(bind2,1,var16/*s*/);it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_1_rb__pl__4db9,1,bind2);var16/*s*/=bind_aget(bind2,1);; var121/*autovar*/=it;;
it=Qnil;if (ptr->pos<ptr->len) goto pass47;
                   goto success47;
                   pass47: *ptr=oldpass47; goto fail;
                   success47: *ptr=oldpass47;
                it=var121/*autovar*/; var6/*_result*/=it;;
 break;
