...
static VALUE sy_AmethystCTranslator__dq_Amethys;
static VALUE sy_AmethystCTranslator__dq_VALUE_sp_c;
static VALUE sy_AmethystCTranslator__dq__at__sh__le_bind;
static VALUE sy_AmethystCTranslator__dq__sh__le__at_gram;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_2;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_3;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_4;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_5;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_6;
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb_;
static VALUE sy_AmethystCTranslator__dq__sh__le_src_dot_n;
static VALUE sy_AmethystCTranslator__dq__sp__sh__le_bind;
static VALUE sy_AmethystCTranslator__dq_class_sp__sh_;
static VALUE sy_AmethystCTranslator__dq_cstruct;
static VALUE sy_AmethystCTranslator__dq_def_sp__sh__le_b;
static VALUE sy_AmethystCTranslator__dq_if_sp__lp_str;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b2;
static VALUE sy_AmethystCTranslator__dq_int_sp__sh__le_b;
static VALUE sy_AmethystCTranslator__dq_it_eq__sh__le_bg;
static VALUE sy_AmethystCTranslator__dq_it_eq__sh__le_rb;
static VALUE sy_AmethystCTranslator__dq_unsigne;
...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE2;
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE;
static VALUE sy_AmethystCTranslator_label_lp__dq_a;
static VALUE sy_AmethystCTranslator_label_lp__dq_b;
static VALUE sy_AmethystCTranslator_label_lp__dq_o;
static VALUE sy_AmethystCTranslator_label_lp__dq_r;
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le__at_gram,1,bind);  bind_aset(bind,0/*lambd*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab6,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE2,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_Amethys,1,bind);  bind_aset(bind,4/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_6,1,bind);  bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_class_sp__sh_,1,bind);  bind_aset(bind,0/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_def_sp__sh__le_b,1,bind);  bind_aset(bind,7/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__at__sh__le_bind,1,bind);  bind_aset(bind,3/*_result*/,it);
...
cstruct oldpass7=*ptr; int fail7=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_src_dot_n,1,bind);  bind_aset(bind,22/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_rb,1,bind);  bind_aset(bind,5/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: *ptr=oldpass1;
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_cstruct,1,bind);  bind_aset(bind,18/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
cstruct oldpass6=*ptr; int fail6=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
  ...
  it=Amethyst_eof(self ); FAILTEST(pass6);
	...
	success6: *ptr=oldpass6;
	if(fail6) goto pass5;
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE,1,bind);  bind_aset(bind,26/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass5);
	goto success5;
	pass5: fail5=1;
	success5: *ptr=oldpass5;
...
it=rb_funcall(self,sy_AmethystCTranslator__at_defs_lt__lt_s,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__at_init_lt__lt_s,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_unsigne,1,bind);  bind_aset(bind,20/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp_str,1,bind);  bind_aset(bind,46/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_48_rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_,1,bind);  bind_aset(bind,51/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__sp__sh__le_bind,1,bind);  bind_aset(bind,53/*s*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_2,1,bind);  bind_aset(bind,54/*_result*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_3,1,bind);  bind_aset(bind,58/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__dq_VALUE_sp_c,1,bind);  bind_aset(bind,20/*s*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__append_lp_11,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos8=ame_getpos(self);goto break7;} } } break7: ame_setstop(self,Qnil);  ame_setpos(self,oldpos8); it=bind_aget(bind,73/*autovar*/);it=rb_funcall(self,sy_AmethystCTranslator__dq_it_eq__sh__le_bg,1,bind);  bind_aset(bind,75/*autovar*/,it);
...
cstruct oldpass24=*ptr; int fail24=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a,1,bind);  bind_aset(bind,77/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_r,1,bind);  bind_aset(bind,78/*reject*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o,1,bind);  bind_aset(bind,79/*oldpos*/,it);
...
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b,1,bind);  bind_aset(bind,80/*autovar*/,it);
...
cstruct oldpass25=*ptr; int fail25=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
 ...
 it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_b,1,bind);  bind_aset(bind,82/*brk*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o,1,bind);  bind_aset(bind,79/*oldpos*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab2,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass25); bind_aset(bind,30/*t*/,it);
 bind_aset(bind,6/*_result*/,it);
it=bind_aget(bind,6/*_result*/); bind_aset(bind,17/*x*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab3,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_int_sp__sh__le_b2,1,bind);  bind_aset(bind,83/*autovar*/,it);
...
int oldpos9; while(1){oldpos9=ame_getpos(self); int oldpos10=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos10); if (x==0) goto break8;it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_86_rb_,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_4,1,bind);  bind_aset(bind,12/*word*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab,1,bind);  bind_aset(bind,13/*rwo*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb_5,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_20_rb_6,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb_5,1,bind);  bind_aset(bind,90/*autovar*/,it);
...
sy_AmethystCTranslator__dq_Amethys=rb_intern("AmethystCTranslator__dq_Amethys");
sy_AmethystCTranslator__dq_VALUE_sp_c=rb_intern("AmethystCTranslator__dq_VALUE_sp_c");
sy_AmethystCTranslator__dq__at__sh__le_bind=rb_intern("AmethystCTranslator__dq__at__sh__le_bind");
sy_AmethystCTranslator__dq__sh__le__at_gram=rb_intern("AmethystCTranslator__dq__sh__le__at_gram");
sy_AmethystCTranslator__dq__sh__le_bind_lb_2=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_2");
sy_AmethystCTranslator__dq__sh__le_bind_lb_3=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_3");
sy_AmethystCTranslator__dq__sh__le_bind_lb_4=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_4");
sy_AmethystCTranslator__dq__sh__le_bind_lb_5=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_5");
sy_AmethystCTranslator__dq__sh__le_bind_lb_6=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_6");
sy_AmethystCTranslator__dq__sh__le_bind_lb_=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb_");
sy_AmethystCTranslator__dq__sh__le_src_dot_n=rb_intern("AmethystCTranslator__dq__sh__le_src_dot_n");
sy_AmethystCTranslator__dq__sp__sh__le_bind=rb_intern("AmethystCTranslator__dq__sp__sh__le_bind");
sy_AmethystCTranslator__dq_class_sp__sh_=rb_intern("AmethystCTranslator__dq_class_sp__sh_");
sy_AmethystCTranslator__dq_cstruct=rb_intern("AmethystCTranslator__dq_cstruct");
sy_AmethystCTranslator__dq_def_sp__sh__le_b=rb_intern("AmethystCTranslator__dq_def_sp__sh__le_b");
sy_AmethystCTranslator__dq_if_sp__lp_str=rb_intern("AmethystCTranslator__dq_if_sp__lp_str");
sy_AmethystCTranslator__dq_int_sp__sh__le_b2=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b2");
sy_AmethystCTranslator__dq_int_sp__sh__le_b=rb_intern("AmethystCTranslator__dq_int_sp__sh__le_b");
sy_AmethystCTranslator__dq_it_eq__sh__le_bg=rb_intern("AmethystCTranslator__dq_it_eq__sh__le_bg");
sy_AmethystCTranslator__dq_it_eq__sh__le_rb=rb_intern("AmethystCTranslator__dq_it_eq__sh__le_rb");
sy_AmethystCTranslator__dq_unsigne=rb_intern("AmethystCTranslator__dq_unsigne");
...
sy_AmethystCTranslator_h_eq__dq_VALUE2=rb_intern("AmethystCTranslator_h_eq__dq_VALUE2");
sy_AmethystCTranslator_h_eq__dq_VALUE=rb_intern("AmethystCTranslator_h_eq__dq_VALUE");
sy_AmethystCTranslator_label_lp__dq_a=rb_intern("AmethystCTranslator_label_lp__dq_a");
sy_AmethystCTranslator_label_lp__dq_b=rb_intern("AmethystCTranslator_label_lp__dq_b");
sy_AmethystCTranslator_label_lp__dq_o=rb_intern("AmethystCTranslator_label_lp__dq_o");
sy_AmethystCTranslator_label_lp__dq_r=rb_intern("AmethystCTranslator_label_lp__dq_r");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
 rb_eval_string("testversionctranslator2('dc0093e504ab33b1681eb1c4008695c8')");}
