...
static VALUE s_it_eq_Ameth_919e;
...
static VALUE sy_AmethystCTranslator__append_lp__4b93;
...
static VALUE sy_AmethystCTranslator__at_rulenam_edf9;
...
static VALUE sy_AmethystCTranslator__dq__sh__le_bind_lb__3ed0;
...
static VALUE sy_AmethystCTranslator_bind_lb_106_ea23;
...
static VALUE sy_AmethystCTranslator_bind_lb_33_rb__a402;
...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_e653;
...
static VALUE sy_AmethystCTranslator_r_eq__dq__sp__sh__le_bi_f9fa;
...
case 'a' ... 'a':;   it=AmethystCore_anything(self ); FAILTEST(pass14);if (ame_curstr2(ptr)[0]=='d'&&ame_curstr2(ptr)[1]=='v'&&ame_curstr2(ptr)[2]=='a'&&ame_curstr2(ptr)[3]=='n'&&ame_curstr2(ptr)[4]=='c'&&ame_curstr2(ptr)[5]=='e')  ptr->pos+=6; else goto pass14; break;
                ...
                it=rb_obj_clone(s_it_eq_Ameth_919e); bind_aset(bind,6/*_result*/,it);
...
case '_' ... '_':;   it=AmethystCore_anything(self ); FAILTEST(pass16);if (ame_curstr2(ptr)[0]=='s'&&ame_curstr2(ptr)[1]=='e'&&ame_curstr2(ptr)[2]=='q')  ptr->pos+=3; else goto pass16; break;
}it=Qnil;if (ptr->pos<ptr->len) goto pass16;
                   goto success16;
                   pass16: *ptr=oldpass16; goto pass15;
                   success16: *ptr=oldpass16;
                switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_4,rb_obj_class(ame_curobj2(ptr))))){case 0/*CAct*/:;   it=AmethystCore_anything(self ); FAILTEST(pass15); bind_aset(bind,29/*autovar*/,it);
 break;
case 1/*Object*/:; goto pass15; break;
                   ...
                   ptr->src=bind_aget(bind,29/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass17); bind_aset(bind,16/*s*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass17;
                   goto success17;
                   pass17: *ptr=oldpass17; goto pass15;
                   success17: *ptr=oldpass17;
                it=rb_funcall(self,sy_AmethystCTranslator__dq_if_sp__lp__sh__le_a_11e0,1,bind);  bind_aset(bind,30/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass15;
                   goto success15;
                   pass15: *ptr=oldpass15; goto alt1_8;
                   success15: *ptr=oldpass15;
                it=bind_aget(bind,30/*autovar*/); bind_aset(bind,6/*_result*/,it);

;goto accept2;
alt1_8: ptr->pos=oldpos2;it=bind_aget(bind,9/*autovar*/); bind_aset(bind,31/*autovar*/,it);
cstruct oldpass18=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,31/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass18); bind_aset(bind,32/*name*/,it);
it=i_0; bind_aset(bind,33/*ii*/,it);
it=rb_ary_new3(0); bind_aset(bind,34/*autovar*/,it);
int oldpos3;  while(1){oldpos3=ptr->pos;   it=AmethystCTranslator_trans(self ); FAILTEST(break2); bind_aset(bind,35/*aa*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_33_rb__a402,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq__sh__le_bind_lb__3ed0,1,bind);  bind_aset(bind,36/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__4b93,1,bind);  } break2: ptr->pos=oldpos3;   it=bind_aget(bind,34/*autovar*/); bind_aset(bind,37/*args*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_src_25d9,1,bind);  bind_aset(bind,38/*app*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass18;
                   goto success18;
                   pass18: *ptr=oldpass18; goto alt1_9;
                   success18: *ptr=oldpass18;
                it=rb_funcall(self,sy_AmethystCTranslator_r_eq__dq__sp__sh__le_bi_f9fa,1,bind);  bind_aset(bind,6/*_result*/,it);

;goto accept2;
alt1_9: ptr->pos=oldpos2;goto fail;
 accept2:;
 break;
...
cstruct oldpass19=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,39/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass19); bind_aset(bind,40/*e*/,it);
...
cstruct oldpass23=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,46/*autovar*/);ptr->len=1;
                     it=AmethystCore_anything(self ); FAILTEST(pass23); bind_aset(bind,47/*autovar*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass23;
                   goto success23;
                   pass23: *ptr=oldpass23; goto pass22;
                   success23: *ptr=oldpass23;
                it=bind_aget(bind,51/*autovar*/); bind_aset(bind,52/*t*/,it);
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass22); bind_aset(bind,53/*rbcode*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass26); bind_aset(bind,52/*t*/,it);
...
cstruct oldpass27=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   switch(FIX2LONG(rb_hash_aref(switchhash_AmethystCTranslator_5,rb_obj_class(ame_curobj2(ptr))))){case 0/*Apply*/:;   it=AmethystCore_anything(self ); FAILTEST(pass27); bind_aset(bind,70/*autovar*/,it);
cstruct oldpass28=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,70/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass28); bind_aset(bind,71/*autovar*/,it);
cstruct oldpass29=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,71/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=Amethyst_spaces(self ); FAILTEST(pass29);switch((unsigned char)*ame_curstr2(ptr)){case UC(0) ... '`':;case 'b' ... UC(255):; goto pass29; break;
case 'a' ... 'a':;   it=AmethystCore_anything(self ); FAILTEST(pass29);if (ame_curstr2(ptr)[0]=='n'&&ame_curstr2(ptr)[1]=='y'&&ame_curstr2(ptr)[2]=='t'&&ame_curstr2(ptr)[3]=='h'&&ame_curstr2(ptr)[4]=='i'&&ame_curstr2(ptr)[5]=='n'&&ame_curstr2(ptr)[6]=='g')  ptr->pos+=7; else goto pass29; break;
                ...
                it=Qnil;if (ptr->pos<ptr->len) goto pass28;
                   goto success28;
                   pass28: *ptr=oldpass28; goto pass27;
                   success28: *ptr=oldpass28;
                it=Qnil;if (ptr->pos<ptr->len) goto pass27; break;
case 1/*Object*/:; goto pass27; break;
}
                   goto success27;
                   pass27: *ptr=oldpass27; goto alt2_2;
...
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_1610,1,bind);  bind_aset(bind,63/*rwo*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_faillab_7559,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass30); bind_aset(bind,52/*t*/,it);
 bind_aset(bind,64/*x*/,it);
...
it=Qnil;if (ptr->pos<ptr->len) goto pass30;
                   goto success30;
                   pass30: *ptr=oldpass30; goto alt2_3;
...
cstruct oldpass32=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_a_f49c,1,bind);  bind_aset(bind,59/*accept*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_label_lp__dq_o_c187,1,bind);  bind_aset(bind,61/*oldpos*/,it);
 it=rb_obj_clone(s_alt_3482); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass32); bind_aset(bind,80/*alt*/,it);
...
cstruct oldpass33=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,86/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                    it=rb_obj_clone(s_pass_1a1d); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass33); bind_aset(bind,87/*pass*/,it);
 it=rb_obj_clone(s_oldpass_6559); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass33); bind_aset(bind,88/*oldpass*/,it);
 it=rb_obj_clone(s_success_260c); arg0=it; it=rb_funcall(self,sy_label,1,arg0); FAILTEST(pass33); bind_aset(bind,89/*success*/,it);
...
cstruct oldpass34=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,90/*autovar*/);ptr->len=1;
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass34); bind_aset(bind,91/*autovar*/,it);
...
cstruct oldpass35=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator_src_dot_name_80f3,1,bind);  bind_aset(bind,32/*name*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_edf9,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind);  bind_aset(bind,95/*autovar*/,it);
cstruct oldpass36=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,95/*autovar*/);ptr->len=1;
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass36); bind_aset(bind,96/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_e653,1,bind);  bind_aset(bind,98/*autovar*/,it);
...
cstruct oldpass38=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   goto success38;
                   pass38: *ptr=oldpass38; goto fail;
...
it=Qnil;if (ptr->pos<ptr->len) goto pass40;
                   goto success40;
                   pass40: *ptr=oldpass40; goto break6;
...
cstruct oldpass42=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,110/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass42); bind_aset(bind,106/*c*/,it);
  it=AmethystCTranslator_trans(self ); FAILTEST(pass42); bind_aset(bind,52/*t*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass42;
                   goto success42;
                   pass42: *ptr=oldpass42; goto break7;
                   success42: *ptr=oldpass42;
                it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_106_ea23,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__9e00,1,bind);  } break7: ptr->pos=oldpos10;   it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__b856,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__1922,1,bind);  bind_aset(bind,111/*autovar*/,it);
...
s_it_eq_Ameth_919e=rb_str_new2("it=AmethystCore_anything(self);");rb_ary_push(rb_const_get(rb_cObject,rb_intern("GC_mark")),s_it_eq_Ameth_919e);
...
sy_AmethystCTranslator__append_lp__4b93=rb_intern("AmethystCTranslator__append_lp__4b93");
...
sy_AmethystCTranslator__at_rulenam_edf9=rb_intern("AmethystCTranslator__at_rulenam_edf9");
...
sy_AmethystCTranslator__dq__sh__le_bind_lb__3ed0=rb_intern("AmethystCTranslator__dq__sh__le_bind_lb__3ed0");
...
sy_AmethystCTranslator_bind_lb_106_ea23=rb_intern("AmethystCTranslator_bind_lb_106_ea23");
...
sy_AmethystCTranslator_bind_lb_33_rb__a402=rb_intern("AmethystCTranslator_bind_lb_33_rb__a402");
...
sy_AmethystCTranslator_h_eq__dq_VALUE_e653=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_e653");
...
sy_AmethystCTranslator_r_eq__dq__sp__sh__le_bi_f9fa=rb_intern("AmethystCTranslator_r_eq__dq__sp__sh__le_bi_f9fa");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('487f6ccee4dc6c7b81e886825759ff33')");}
