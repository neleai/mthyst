...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_4a29;
...
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_4a29,1,bind);  bind_aset(bind,103/*autovar*/,it);
...
sy_AmethystCTranslator_h_eq__dq_VALUE_4a29=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_4a29");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('c04e118a0137f394c498ffbac93ce9e3')");}
