...
static VALUE sy_AmethystCTranslator__append_lp__b64d;
...
static VALUE sy_AmethystCTranslator__at_header_lt__d1b4;
static VALUE sy_AmethystCTranslator__at_init_eq__lb__rb__47da;
static VALUE sy_AmethystCTranslator__at_init_sp__sp__lt__9a42;
...
static VALUE sy_AmethystCTranslator__dq_switch_lp__4f01;
...
static VALUE sy_AmethystCTranslator_bind_lb_108_564f;
...
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__4e8b;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__6742;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__878f;
static VALUE sy_AmethystCTranslator_bind_lb_16_rb__b085;
...
static VALUE sy_AmethystCTranslator_h_eq__dq_VALUE_4d8c;
...
return it;
fail: return failobj; }
VALUE AmethystCTranslator_trans(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(114);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it; cstruct *ptr; Data_Get_Struct(self,cstruct,ptr);
...
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__4e8b,1,bind);  bind_aset(bind,57/*autovar*/,it);
...
it=rb_funcall(self,sy_AmethystCTranslator__at_rulenam_d72e,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_src_dot_body_519e,1,bind);  bind_aset(bind,97/*autovar*/,it);
cstruct oldpass38=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=failobj;ptr->ary=alloca(sizeof(VALUE));ptr->ary[0]=bind_aget(bind,97/*autovar*/);ptr->len=1;
                     it=AmethystCTranslator_trans(self ); FAILTEST(pass38); bind_aset(bind,98/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass38;
                   goto success38;
                   pass38: *ptr=oldpass38; goto pass37;
                   success38: *ptr=oldpass38;
                it=bind_aget(bind,98/*autovar*/); bind_aset(bind,99/*body*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_h_eq__dq_VALUE_4d8c,1,bind);  bind_aset(bind,100/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass37;
 ...
 break;
case 13/*Seq*/:; it=ame_curobj2(ptr)               ;ptr->pos++; bind_aset(bind,101/*autovar*/,it);
cstruct oldpass39=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_ary_new3(0); bind_aset(bind,102/*autovar*/,it);
int oldpos8;  while(1){oldpos8=ptr->pos;   it=AmethystCTranslator_trans(self ); FAILTEST(break5); bind_aset(bind,103/*autovar*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__append_lp__b64d,1,bind);  } break5: ptr->pos=oldpos8;   it=bind_aget(bind,102/*autovar*/); bind_aset(bind,54/*t*/,it);
it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_54_rb__06ed,1,bind);  bind_aset(bind,104/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass39;
                   goto success39;
                   pass39: *ptr=oldpass39; goto fail;
                   success39: *ptr=oldpass39;
                it=bind_aget(bind,104/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
case 14/*Stop*/:; it=ame_curobj2(ptr)               ;ptr->pos++; bind_aset(bind,105/*autovar*/,it);
...
int oldpos9;  while(1){oldpos9=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break6); bind_aset(bind,107/*autovar*/,it);
cstruct oldpass42=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,107/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass42); bind_aset(bind,108/*c*/,it);
  it=AmethystCTranslator_trans(self ); FAILTEST(pass42); bind_aset(bind,54/*t*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass42;
                   goto success42;
                   pass42: *ptr=oldpass42; goto break6;
                   success42: *ptr=oldpass42;
                it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__b085,1,bind);  } break6: ptr->pos=oldpos9;   it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__1922,1,bind);  bind_aset(bind,109/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass41;
 ...
 break;
case 16/*Switch_Clas*/:; it=ame_curobj2(ptr)               ;ptr->pos++; bind_aset(bind,110/*autovar*/,it);
cstruct oldpass43=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ...
                   it=rb_funcall(self,sy_AmethystCTranslator__dq_switchh_f207,1,bind);  bind_aset(bind,111/*sh*/,it);
it=i_0; bind_aset(bind,35/*ii*/,it);
it=rb_obj_clone(s__d41d); bind_aset(bind,56/*init*/,it);
it=rb_funcall(self,sy_AmethystCTranslator__at_header_lt__d1b4,1,bind); it=rb_funcall(self,sy_AmethystCTranslator__dq_switch_lp__4f01,1,bind);  bind_aset(bind,16/*s*/,it);
int oldpos10;  while(1){oldpos10=ptr->pos;   it=AmethystCore_anything(self ); FAILTEST(break7); bind_aset(bind,112/*autovar*/,it);
cstruct oldpass44=*ptr; ptr->pos=ptr->len=0; ptr->ary=NULL;
                   ptr->src=bind_aget(bind,112/*autovar*/); if(TYPE(ptr->src)==T_STRING) {ptr->str=RSTRING_PTR(ptr->src);ptr->len=RSTRING_LEN(ptr->src);} else { VALUE ary;    if (TYPE(ptr->src)==T_ARRAY) ary=ptr->src;    else  ary=rb_funcall(ptr->src,s_to_a,0);    ptr->ary=RARRAY_PTR(ary);    ptr->len=RARRAY_LEN(ary);}
                     it=AmethystCore_anything(self ); FAILTEST(pass44); bind_aset(bind,108/*c*/,it);
  it=AmethystCTranslator_trans(self ); FAILTEST(pass44); bind_aset(bind,54/*t*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass44;
                   goto success44;
                   pass44: *ptr=oldpass44; goto break7;
                   success44: *ptr=oldpass44;
                it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_108_564f,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__24cb,1,bind);  } break7: ptr->pos=oldpos10;   it=rb_funcall(self,sy_AmethystCTranslator__at_init_sp__sp__lt__9a42,1,bind); it=rb_funcall(self,sy_AmethystCTranslator_bind_lb_16_rb__1922,1,bind);  bind_aset(bind,113/*autovar*/,it);
it=Qnil;if (ptr->pos<ptr->len) goto pass43;
                   goto success43;
                   pass43: *ptr=oldpass43; goto fail;
                   success43: *ptr=oldpass43;
                it=bind_aget(bind,113/*autovar*/); bind_aset(bind,6/*_result*/,it);
 break;
...
sy_AmethystCTranslator__append_lp__b64d=rb_intern("AmethystCTranslator__append_lp__b64d");
...
sy_AmethystCTranslator__at_header_lt__d1b4=rb_intern("AmethystCTranslator__at_header_lt__d1b4");
sy_AmethystCTranslator__at_init_eq__lb__rb__47da=rb_intern("AmethystCTranslator__at_init_eq__lb__rb__47da");
sy_AmethystCTranslator__at_init_sp__sp__lt__9a42=rb_intern("AmethystCTranslator__at_init_sp__sp__lt__9a42");
...
sy_AmethystCTranslator__dq_switch_lp__4f01=rb_intern("AmethystCTranslator__dq_switch_lp__4f01");
...
sy_AmethystCTranslator_bind_lb_108_564f=rb_intern("AmethystCTranslator_bind_lb_108_564f");
...
sy_AmethystCTranslator_bind_lb_16_rb__4e8b=rb_intern("AmethystCTranslator_bind_lb_16_rb__4e8b");
...
sy_AmethystCTranslator_bind_lb_16_rb__b085=rb_intern("AmethystCTranslator_bind_lb_16_rb__b085");
...
sy_AmethystCTranslator_h_eq__dq_VALUE_4d8c=rb_intern("AmethystCTranslator_h_eq__dq_VALUE_4d8c");
...
rb_define_method(cls_AmethystCTranslator,"trans",AmethystCTranslator_trans,0);
                    rb_eval_string("testversionctranslator2('7fb5b37ca1b48ad2c88d1073732cca4c')");}
