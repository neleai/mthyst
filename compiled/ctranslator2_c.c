...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_2,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(rbtrans_AmethystCTranslatorcb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=BGET(autovar_2);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt2_1: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_4,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt2_2);
 BSET(autovar_4,it); int oldpos5=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_5,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break2);
 BSET(autovar_6,it); it=CALL(rbtrans_AmethystCTranslatorcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_5);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt3_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_7,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt3_2);
 BSET(autovar_7,it); int oldpos8=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
alt4_1: ame_setpos(self,oldpos9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_8,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt4_2);
 BSET(autovar_8,it); int oldpos10=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
...
alt5_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_10,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt5_2);
 BSET(autovar_9,it); int oldpos12=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
alt6_1: ame_setpos(self,oldpos13);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_13,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt6_2);
...
ame_setsrc(self,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos15; while(1){oldpos15=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos15=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos15); it=CALL(rbtrans_AmethystCTranslatorcb_14,1,bind); 
 BSET(_result_1,it); 
...
alt7_1: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_15,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_2);
 BSET(autovar_10,it); int oldpos17=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos18; while(1){oldpos18=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos18=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos18); it=CALL(rbtrans_AmethystCTranslatorcb_16,1,bind); 
 BSET(_result_1,it); 
...
alt7_2: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_17,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_3);
 BSET(autovar_1,it); int oldpos19=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_2,it); int oldpos20; while(1){oldpos20=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break5);
 BSET(autovar_3,it); it=CALL(rbtrans_AmethystCTranslatorcb_18,1,bind);  if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=BGET(autovar_2);
 BSET(a_1,it); 
...
it=CALL(rbtrans_AmethystCTranslatorcb_19,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
alt7_3: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_20,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_4);
 BSET(autovar_4,it); int oldpos21=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_5,it); int oldpos22; while(1){oldpos22=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break6);
 BSET(autovar_6,it); it=CALL(rbtrans_AmethystCTranslatorcb_21,1,bind);  if (IGET(stop)!=Qnil){{oldpos22=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos22); it=BGET(autovar_5);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass9;
	goto success9;
	pass9: fail9=1;
	success9: ame_setsrc(self,oldsrc9); ame_setpos(self,oldpos21); ame_setlen(self,oldlen9);
	if(fail9) goto alt7_4;
it=CALL(rbtrans_AmethystCTranslatorcb_22,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
alt7_4: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_23,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_5);
 BSET(autovar_11,it); int oldpos23=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=ame_getsrc(self); int fail10=0;
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_12,it); int oldpos24; while(1){oldpos24=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break7);
 BSET(autovar_13,it); it=CALL(rbtrans_AmethystCTranslatorcb_24,1,bind);  if (IGET(stop)!=Qnil){{oldpos24=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos24); it=BGET(autovar_12);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass10;
	goto success10;
	pass10: fail10=1;
	success10: ame_setsrc(self,oldsrc10); ame_setpos(self,oldpos23); ame_setlen(self,oldlen10);
	if(fail10) goto alt7_5;
it=CALL(rbtrans_AmethystCTranslatorcb_25,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
alt7_5: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_26,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_6);
 BSET(autovar_9,it); int oldpos25=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); 
	...
	if(fail11) goto alt7_6;
it=CALL(rbtrans_AmethystCTranslatorcb_28,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
alt7_6: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_29,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_7);
 BSET(autovar_8,it); int oldpos26=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); 
	...
	if(fail12) goto alt7_7;
it=CALL(rbtrans_AmethystCTranslatorcb_30,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
alt7_7: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_31,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt7_8);
 BSET(autovar_7,it); int oldpos27=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,BGET(autovar_7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCTranslator_addlambda(self ); FAILTEST(pass13);
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass13;
	goto success13;
	pass13: fail13=1;
	success13: ame_setsrc(self,oldsrc13); ame_setpos(self,oldpos27); ame_setlen(self,oldlen13);
	if(fail13) goto alt7_8;
 
ISET(cut,Qnil);goto accept7;
alt7_8: ame_setpos(self,oldpos16);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt7_9);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept7;
  alt7_9:  ame_setpos(self,oldpos16); goto fail;
 accept7:;
 break;case 7:; int oldpos28=ame_getpos(self);
alt8_1: ame_setpos(self,oldpos28);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(rbtrans_AmethystCTranslatorcb_32,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt8_2);
 BSET(autovar_11,it); int oldpos29=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_12,it); int oldpos30; while(1){oldpos30=ame_getpos(self);   it=AmethystCTranslator_rbtrans(self ); FAILTEST(break8);
 BSET(autovar_13,it); it=CALL(rbtrans_AmethystCTranslatorcb_33,1,bind);  if (IGET(stop)!=Qnil){{oldpos30=ame_getpos(self);goto break8;} } } break8: ISET(stop,Qnil);  ame_setpos(self,oldpos30); it=BGET(autovar_12);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass14;
	goto success14;
	pass14: fail14=1;
	success14: ame_setsrc(self,oldsrc14); ame_setpos(self,oldpos29); ame_setlen(self,oldlen14);
	if(fail14) goto alt8_2;
it=CALL(rbtrans_AmethystCTranslatorcb_34,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept8;
alt8_2: ame_setpos(self,oldpos28);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=AmethystCore_anything(self ); FAILTEST(alt8_3);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept8;
  alt8_3:  ame_setpos(self,oldpos28); goto fail;
 accept8:;
...
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_3,it); it=CALL(trans_AmethystCTranslatorcb_2,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_2);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_3,1,bind); 
 BSET(cbno_1,it); it=CALL(trans_AmethystCTranslatorcb_4,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_5,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_2);
...
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_5,it); it=CALL(trans_AmethystCTranslatorcb_6,1,bind); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=AmethystCTranslator_spaces(self ); FAILTEST(pass4); it=rb_str_new2("super"); arg0=it; it=AmethystCore_seq(self ,arg0); FAILTEST(pass4);
	if (CALL(eof,0)==failobj) goto pass4;
	goto success4;
	pass4: fail4=1;
	...
	if(fail3) goto pass2;
it=CALL(trans_AmethystCTranslatorcb_7,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(trans_AmethystCTranslatorcb_8,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(alt1_3);
...
ame_setsrc(self,BGET(autovar_7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_8,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break2);
 BSET(aa_1,it); it=CALL(trans_AmethystCTranslatorcb_9,1,bind); it=CALL(trans_AmethystCTranslatorcb_10,1,bind); 
 BSET(autovar_9,it); it=CALL(trans_AmethystCTranslatorcb_11,1,bind);  if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos8); it=BGET(autovar_8);
 BSET(args_1,it); it=CALL(trans_AmethystCTranslatorcb_12,1,bind); 
...
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldpos3); goto fail;
 accept1:;
 break;case 2:;  it=CALL(trans_AmethystCTranslatorcb_14,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_10,it); int oldpos9=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_15,1,bind); 
 BSET(autovar_11,it); it=CALL(trans_AmethystCTranslatorcb_16,1,bind); int oldpos10=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
ame_setsrc(self,BGET(autovar_11)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_13,it); int oldpos12; while(1){oldpos12=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break3);
 BSET(autovar_14,it); it=CALL(trans_AmethystCTranslatorcb_19,1,bind);  if (IGET(stop)!=Qnil){{oldpos12=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos12); it=BGET(autovar_13);
 BSET(c_1,it); 
	if (CALL(eof,0)==failobj) goto pass8;
	goto success8;
	pass8: fail8=1;
...
it=CALL(trans_AmethystCTranslatorcb_20,1,bind); 
 BSET(_result_1,it);  break;case 4:;  it=CALL(trans_AmethystCTranslatorcb_21,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_15,it); int oldpos13=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=ame_getsrc(self); int fail9=0;
...
it=CALL(trans_AmethystCTranslatorcb_22,1,bind); 
 BSET(_result_1,it);  break;case 5:;  it=CALL(trans_AmethystCTranslatorcb_23,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystCTranslatorcb_24,1,bind); it=CALL(trans_AmethystCTranslatorcb_25,1,bind); it=CALL(trans_AmethystCTranslatorcb_26,1,bind); it=CALL(trans_AmethystCTranslatorcb_27,1,bind); it=CALL(trans_AmethystCTranslatorcb_28,1,bind); it=CALL(trans_AmethystCTranslatorcb_29,1,bind); it=CALL(trans_AmethystCTranslatorcb_30,1,bind); it=CALL(trans_AmethystCTranslatorcb_31,1,bind); it=CALL(trans_AmethystCTranslatorcb_32,1,bind); 
 BSET(autovar_17,it); it=CALL(trans_AmethystCTranslatorcb_33,1,bind); int oldpos15=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=ame_getsrc(self); int fail11=0;
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_18,it); int oldpos16=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=ame_getsrc(self); int fail12=0;
ame_setsrc(self,BGET(autovar_18)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=rb_ary_new3(0);
 BSET(autovar_19,it); int oldpos17; while(1){oldpos17=ame_getpos(self);   it=AmethystCTranslator_trans(self ); FAILTEST(break4);
 BSET(autovar_20,it); it=CALL(trans_AmethystCTranslatorcb_34,1,bind);  if (IGET(stop)!=Qnil){{oldpos17=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos17); it=BGET(autovar_19);
 BSET(t_1,it); 
	if (CALL(eof,0)==failobj) goto pass12;
	goto success12;
	pass12: fail12=1;
  ...
  it=AmethystCTranslator_rbcode(self ); FAILTEST(pass10);
 BSET(rbcode_1,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind); 
 ...
 BSET(_result_1,it); 
	...
	if(fail10) goto fail;
 break;case 6:;  it=CALL(trans_AmethystCTranslatorcb_37,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_21)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos19; while(1){oldpos19=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos19=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos19); it=CALL(trans_AmethystCTranslatorcb_38,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass13;
	goto success13;
	pass13: fail13=1;
	...
	if(fail13) goto fail;
 break;case 7:;  it=CALL(trans_AmethystCTranslatorcb_39,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_42,1,bind); 
 BSET(oldpos_1,it); it=BGET(reject_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_43,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_44,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass14);
 BSET(t_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_45,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_46,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass14;
	goto success14;
	pass14: fail14=1;
	...
	if(fail14) goto fail;
 break;case 8:;  it=CALL(trans_AmethystCTranslatorcb_47,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_23,it); int oldpos21=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=ame_getsrc(self); int fail15=0;
ame_setsrc(self,BGET(autovar_23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(brk_1,it); it=CALL(trans_AmethystCTranslatorcb_49,1,bind); 
 BSET(oldpos_1,it); it=BGET(brk_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_50,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_51,1,bind);   it=AmethystCTranslator_trans(self ); FAILTEST(pass15);
 BSET(t_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_52,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_53,1,bind); 
 BSET(_result_1,it); 
	...
	if(fail15) goto fail;
 break;case 9:;  it=CALL(trans_AmethystCTranslatorcb_54,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
 BSET(autovar_24,it); int oldpos22=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=ame_getsrc(self); int fail16=0;
ame_setsrc(self,BGET(autovar_24)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_56,1,bind); 
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_57,1,bind); 
 BSET(oldpos_1,it);  it=rb_str_new2("alt"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass16);
 BSET(alt_1,it); it=INT2FIX(0);
 BSET(altno_1,it); it=rb_ary_new3(0);
 BSET(autovar_25,it); int oldpos23; while(1){oldpos23=ame_getpos(self); int oldpos24=ame_getpos(self);
   it=AmethystCore_anything(self ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos24); if (x==0) goto break6;it=CALL(trans_AmethystCTranslatorcb_58,1,bind); it=CALL(trans_AmethystCTranslatorcb_59,1,bind); 
 ...
 BSET(_result_3,it); it=BGET(_result_3);
 BSET(autovar_26,it); it=CALL(trans_AmethystCTranslatorcb_63,1,bind);  if (IGET(stop)!=Qnil){{oldpos23=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos23); it=BGET(autovar_25);
 ...
 BSET(_result_1,it); 
	...
	if(fail16) goto fail;
 break;case 10:;  it=CALL(trans_AmethystCTranslatorcb_67,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_27)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  it=rb_str_new2("pass"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(pass_1,it);  it=rb_str_new2("oldpos"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(oldpos_1,it);  it=rb_str_new2("oldlen"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(oldlen_1,it);  it=rb_str_new2("oldsrc"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(oldsrc_1,it);  it=rb_str_new2("success"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(success_1,it);  it=rb_str_new2("fail"); arg0=it; it=CALL(label,1 ,arg0); FAILTEST(pass17);
 BSET(fail_1,it); it=BGET(pass_1);
 BSET(word_1,it); it=CALL(trans_AmethystCTranslatorcb_68,1,bind); 
 BSET(rwo_1,it); it=CALL(trans_AmethystCTranslatorcb_69,1,bind); it=CALL(trans_AmethystCTranslatorcb_70,1,bind); 
 BSET(autovar_28,it); it=CALL(trans_AmethystCTranslatorcb_71,1,bind); int oldpos26=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
...
it=BGET(_result_1);
 BSET(x_1,it); it=CALL(trans_AmethystCTranslatorcb_72,1,bind); it=BGET(_result_3);it=CALL(trans_AmethystCTranslatorcb_73,1,bind); 
 BSET(_result_1,it); 
	...
	if(fail17) goto fail;
 break;case 11:;  it=CALL(trans_AmethystCTranslatorcb_74,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_30,it); it=CALL(trans_AmethystCTranslatorcb_76,1,bind); int oldpos28=ame_getpos(self); int oldlen20=ame_getlen(self); VALUE oldsrc20=ame_getsrc(self); int fail20=0;
...
it=CALL(trans_AmethystCTranslatorcb_77,1,bind); 
 BSET(_result_1,it); 
	...
	if(fail19) goto fail;
 break;case 12:;  it=CALL(trans_AmethystCTranslatorcb_78,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_31)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystCTranslatorcb_80,1,bind); it=CALL(trans_AmethystCTranslatorcb_81,1,bind); 
 BSET(autovar_32,it); it=CALL(trans_AmethystCTranslatorcb_82,1,bind); int oldpos30=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
...
it=CALL(trans_AmethystCTranslatorcb_83,1,bind); 
 BSET(_result_1,it); 
	...
	if(fail21) goto fail;
 break;case 13:;  it=CALL(trans_AmethystCTranslatorcb_84,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
ame_setsrc(self,BGET(autovar_33)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_35,it); it=CALL(trans_AmethystCTranslatorcb_85,1,bind);  if (IGET(stop)!=Qnil){{oldpos32=ame_getpos(self);goto break7;} } } break7: ISET(stop,Qnil);  ame_setpos(self,oldpos32); it=BGET(autovar_34);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_86,1,bind); 
 BSET(_result_1,it); 
	...
	if(fail23) goto fail;
 break;case 14:;  it=CALL(trans_AmethystCTranslatorcb_87,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
...
it=CALL(trans_AmethystCTranslatorcb_88,1,bind); 
 BSET(_result_1,it);  break;case 15:;  it=CALL(trans_AmethystCTranslatorcb_89,1,bind);  arg0=it; it=AmethystCTranslator_clas(self ,arg0); FAILTEST(fail);
