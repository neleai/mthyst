...
static VALUE c_Or;
static VALUE sy_Left_Factor_Bind_lb_src_dot_nam;
static VALUE sy_Left_Factor_Or_lb__ti__lp_bind_lb_2_rb_;
static VALUE sy_Left_Factor_Or_lb__ti__lp_bind_lb_5_rb_;
static VALUE sy_Left_Factor_Seq_lb__lb_bind_lb_7_rb_;
static VALUE sy_Left_Factor__append_lp_bind2;
static VALUE sy_Left_Factor__append_lp_bind3;
static VALUE sy_Left_Factor__append_lp_bind4;
static VALUE sy_Left_Factor__append_lp_bind5;
static VALUE sy_Left_Factor__append_lp_bind6;
static VALUE sy_Left_Factor__append_lp_bind;
static VALUE sy_Left_Factor__at_changed;
static VALUE sy_Left_Factor__at_changed_eq_fal;
static VALUE sy_Left_Factor__at_changed_eq_tru;
static VALUE sy_Left_Factor__lb_bind_lb_0_rb__rb_;
static VALUE sy_Left_Factor__lb_bind_lb_2_rb__rb_;
static VALUE sy_Left_Factor__lb_bind_lb_6_rb__rb_;
static VALUE sy_Left_Factor__lp_bind_lb_1_rb__eq__eq_fi;
static VALUE sy_Left_Factor__lp_bind_lb_4_rb_;
static VALUE sy_Left_Factor__lp_bind_lb_4_rb__eq__eq_fi;
static VALUE sy_Left_Factor__lp_src_dot_instanc;
static VALUE sy_Left_Factor_bind_lb_1_rb__eq__eq_fir;
static VALUE sy_Left_Factor_bind_lb_2_rb__pl_merg;
static VALUE sy_Left_Factor_bind_lb_3_rb__pl__lb_bin2;
static VALUE sy_Left_Factor_bind_lb_3_rb__pl__lb_bin;
static VALUE sy_Left_Factor_bind_lb_4_rb__eq__eq_fir;
static VALUE sy_Left_Factor_bind_lb_5_rb__lt__lt_bin;
static VALUE sy_Left_Factor_bind_lb_5_rb__pl_merg;
static VALUE sy_Left_Factor_first_lp_bind_lb_0;
static VALUE sy_Left_Factor_first_lp_bind_lb_2;
static VALUE sy_Left_Factor_first_lp_bind_lb_6;
static VALUE sy_Left_Factor_if_sp_bind_lb_5_rb_;
...
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 it=rb_funcall(self,sy_Left_Factor__lp_bind_lb_1_rb__eq__eq_fi,1,bind); FAILTEST(alt2_2); it=bind_aget(bind,2/*prev*/); arg0=it;it=bind_aget(bind,1/*start*/); arg1=it;it=rb_funcall(self,sy_Left_Factor_bind_lb_3_rb__pl__lb_bin2,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_2); bind_aset(bind,4/*_result*/,it);
...
alt3_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_3;}
 it=rb_funcall(self,sy_Left_Factor_bind_lb_1_rb__eq__eq_fir,1,bind); ame_setcut(self,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt3_2); 
...
ame_setcut(self,Qnil);goto accept3;
 ...
 accept3:;
 it=rb_funcall(self,sy_Left_Factor_bind_lb_2_rb__pl_merg,1,bind);  arg0=it;it=rb_funcall(self,sy_Left_Factor_first_lp_bind_lb_0,1,bind);  arg1=it;it=rb_funcall(self,sy_Left_Factor__lb_bind_lb_0_rb__rb_,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_3); bind_aset(bind,4/*_result*/,it);
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto fail;}
   it=Amethyst_eof(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_Left_Factor_Or_lb__ti__lp_bind_lb_2_rb_,1,bind);  bind_aset(bind,4/*_result*/,it);
...
int oldpos2; while(1){oldpos2=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); bind_aset(bind,5/*autovar*/,it);
it=rb_funcall(self,sy_Left_Factor__append_lp_bind,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,4/*autovar*/); bind_aset(bind,6/*it*/,it);
it=rb_funcall(self,sy_Left_Factor_Seq_lb__lb_bind_lb_7_rb_,1,bind);  bind_aset(bind,8/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Left_Factor__append_lp_bind5,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=bind_aget(bind,0/*autovar*/);it=rb_funcall(self,sy_Left_Factor__at_changed,1,bind);  bind_aset(bind,2/*oldchanged*/,it);
...
it=rb_funcall(self,sy_Left_Factor__lp_src_dot_instanc,1,bind);  bind_aset(bind,6/*autovar*/,it);
cstruct oldpass1=*ptr; int fail1=0; ptr->pos=ptr->len=0; ptr->ary=NULL;
...
it=rb_funcall(self,sy_Left_Factor__at_changed_eq_fal,1,bind);   it=Left_Factor_traverse_item(self ); FAILTEST(pass3); bind_aset(bind,11/*val*/,it);
it=rb_funcall(self,sy_Left_Factor__lp_bind_lb_4_rb_,1,bind);  bind_aset(bind,12/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: *ptr=oldpass3;
...
it=rb_funcall(self,sy_Left_Factor__append_lp_bind6,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos2=ame_getpos(self);goto break2;} } } break2: ame_setstop(self,Qnil);  ame_setpos(self,oldpos2); it=bind_aget(bind,8/*autovar*/);  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
	if(fail2) goto pass1;
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	success1: *ptr=oldpass1;
	if(fail1) goto fail;
it=rb_funcall(self,sy_Left_Factor_if_sp_bind_lb_5_rb_,1,bind);  bind_aset(bind,14/*_result*/,it);
it=bind_aget(bind,14/*_result*/);
return it;
fail: return failobj; }
...
it=rb_funcall(self,sy_Left_Factor__at_changed_eq_tru,1,bind); it=bind_aget(bind,0/*a*/); bind_aset(bind,1/*_result*/,it);
...
it=rb_funcall(self,sy_Left_Factor_bind_lb_5_rb__lt__lt_bin,1,bind);  bind_aset(bind,8/*autovar*/,it);
it=rb_funcall(self,sy_Left_Factor__append_lp_bind4,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos3); it=bind_aget(bind,6/*autovar*/);it=bind_aget(bind,5/*ar*/); bind_aset(bind,9/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
it=rb_funcall(self,sy_Left_Factor__lb_bind_lb_2_rb__rb_,1,bind);  bind_aset(bind,3/*cur*/,it);
it=rb_funcall(self,sy_Left_Factor_first_lp_bind_lb_2,1,bind);  bind_aset(bind,4/*start*/,it);
...
int oldpos2=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 it=rb_funcall(self,sy_Left_Factor__lp_bind_lb_4_rb__eq__eq_fi,1,bind); FAILTEST(alt2_2); it=rb_ary_new3(0); arg0=it;it=bind_aget(bind,4/*start*/); arg1=it;it=rb_funcall(self,sy_Left_Factor_bind_lb_3_rb__pl__lb_bin,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_2); bind_aset(bind,7/*_result*/,it);
 
ame_setcut(self,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt1_2;}
 int oldpos3=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_3;}
 it=rb_funcall(self,sy_Left_Factor_bind_lb_4_rb__eq__eq_fir,1,bind); ame_setcut(self,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt3_2); 
ame_setcut(self,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldpos3);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto alt2_3;}
   it=Amethyst_empty(self ); FAILTEST(alt3_3); 
ame_setcut(self,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldpos3); goto alt2_3;
 accept3:;
 it=rb_funcall(self,sy_Left_Factor_bind_lb_5_rb__pl_merg,1,bind);  arg0=it;it=rb_funcall(self,sy_Left_Factor_first_lp_bind_lb_6,1,bind);  arg1=it;it=rb_funcall(self,sy_Left_Factor__lb_bind_lb_6_rb__rb_,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_3); bind_aset(bind,7/*_result*/,it);
...
alt1_2: ame_setpos(self,oldpos1);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass2;}
   it=Amethyst_eof(self ); FAILTEST(alt1_3);it=rb_funcall(self,sy_Left_Factor_Or_lb__ti__lp_bind_lb_5_rb_,1,bind);  bind_aset(bind,7/*_result*/,it);
...
sy_Left_Factor_Bind_lb_src_dot_nam=rb_intern("Left_Factor_Bind_lb_src_dot_nam");
sy_Left_Factor_Or_lb__ti__lp_bind_lb_2_rb_=rb_intern("Left_Factor_Or_lb__ti__lp_bind_lb_2_rb_");
sy_Left_Factor_Or_lb__ti__lp_bind_lb_5_rb_=rb_intern("Left_Factor_Or_lb__ti__lp_bind_lb_5_rb_");
sy_Left_Factor_Seq_lb__lb_bind_lb_7_rb_=rb_intern("Left_Factor_Seq_lb__lb_bind_lb_7_rb_");
sy_Left_Factor__append_lp_bind2=rb_intern("Left_Factor__append_lp_bind2");
sy_Left_Factor__append_lp_bind3=rb_intern("Left_Factor__append_lp_bind3");
sy_Left_Factor__append_lp_bind4=rb_intern("Left_Factor__append_lp_bind4");
sy_Left_Factor__append_lp_bind5=rb_intern("Left_Factor__append_lp_bind5");
sy_Left_Factor__append_lp_bind6=rb_intern("Left_Factor__append_lp_bind6");
sy_Left_Factor__append_lp_bind=rb_intern("Left_Factor__append_lp_bind");
sy_Left_Factor__at_changed=rb_intern("Left_Factor__at_changed");
sy_Left_Factor__at_changed_eq_fal=rb_intern("Left_Factor__at_changed_eq_fal");
sy_Left_Factor__at_changed_eq_tru=rb_intern("Left_Factor__at_changed_eq_tru");
sy_Left_Factor__lb_bind_lb_0_rb__rb_=rb_intern("Left_Factor__lb_bind_lb_0_rb__rb_");
sy_Left_Factor__lb_bind_lb_2_rb__rb_=rb_intern("Left_Factor__lb_bind_lb_2_rb__rb_");
sy_Left_Factor__lb_bind_lb_6_rb__rb_=rb_intern("Left_Factor__lb_bind_lb_6_rb__rb_");
sy_Left_Factor__lp_bind_lb_1_rb__eq__eq_fi=rb_intern("Left_Factor__lp_bind_lb_1_rb__eq__eq_fi");
sy_Left_Factor__lp_bind_lb_4_rb_=rb_intern("Left_Factor__lp_bind_lb_4_rb_");
sy_Left_Factor__lp_bind_lb_4_rb__eq__eq_fi=rb_intern("Left_Factor__lp_bind_lb_4_rb__eq__eq_fi");
sy_Left_Factor__lp_src_dot_instanc=rb_intern("Left_Factor__lp_src_dot_instanc");
sy_Left_Factor_bind_lb_1_rb__eq__eq_fir=rb_intern("Left_Factor_bind_lb_1_rb__eq__eq_fir");
sy_Left_Factor_bind_lb_2_rb__pl_merg=rb_intern("Left_Factor_bind_lb_2_rb__pl_merg");
sy_Left_Factor_bind_lb_3_rb__pl__lb_bin2=rb_intern("Left_Factor_bind_lb_3_rb__pl__lb_bin2");
sy_Left_Factor_bind_lb_3_rb__pl__lb_bin=rb_intern("Left_Factor_bind_lb_3_rb__pl__lb_bin");
sy_Left_Factor_bind_lb_4_rb__eq__eq_fir=rb_intern("Left_Factor_bind_lb_4_rb__eq__eq_fir");
sy_Left_Factor_bind_lb_5_rb__lt__lt_bin=rb_intern("Left_Factor_bind_lb_5_rb__lt__lt_bin");
sy_Left_Factor_bind_lb_5_rb__pl_merg=rb_intern("Left_Factor_bind_lb_5_rb__pl_merg");
sy_Left_Factor_first_lp_bind_lb_0=rb_intern("Left_Factor_first_lp_bind_lb_0");
sy_Left_Factor_first_lp_bind_lb_2=rb_intern("Left_Factor_first_lp_bind_lb_2");
sy_Left_Factor_first_lp_bind_lb_6=rb_intern("Left_Factor_first_lp_bind_lb_6");
sy_Left_Factor_if_sp_bind_lb_5_rb_=rb_intern("Left_Factor_if_sp_bind_lb_5_rb_");
...
rb_define_method(cls_Left_Factor,"visit",Left_Factor_visit,0);
 rb_eval_string("testversionleft_factor('1933fa455dee1d33ad15d562c91554d8')");}
