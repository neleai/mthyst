...
static VALUE sy_Left_Factor__append_lp__984f;
...
static VALUE sy_Left_Factor_bind_lb_11_rb__a30c;
...
int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Left_Factor_traverse_item(self ); FAILTEST(break1); bind_aset(bind,13/*it*/,it);
it=rb_funcall(self,sy_Left_Factor_bind_lb_11_rb__a30c,1,bind);  bind_aset(bind,14/*autovar*/,it);
it=rb_funcall(self,sy_Left_Factor__append_lp__984f,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,12/*autovar*/);it=bind_aget(bind,11/*ar*/); bind_aset(bind,15/*autovar*/,it);
  it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
	success2: *ptr=oldpass2;
...
sy_Left_Factor__append_lp__984f=rb_intern("Left_Factor__append_lp__984f");
...
sy_Left_Factor_bind_lb_11_rb__a30c=rb_intern("Left_Factor_bind_lb_11_rb__a30c");
...
rb_define_method(cls_Left_Factor,"visit",Left_Factor_visit,0);
 rb_eval_string("testversionleft_factor('061fd17201bb91dbb14b04b5ab86f0c1')");}
