...
ame_setsrc(self,bind_aget(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
  it=rb_funcall(self,s_binds_Left_Factorcb_2Left_Factor,1,bind);  arg0=it;it=bind_aget(bind,3/*a*/); arg1=it; it=Left_Factor_binds(self ,arg0,arg1); FAILTEST(pass2);
...
alt1_2: ame_setpos(self,oldpos2);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt1_3);it=bind_aget(bind,3/*a*/);
 bind_aset(bind,6/*autovar*/,it);  
ame_setcut(self,Qnil);goto accept1;
...
ame_setsrc(self,bind_aget(bind,7/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
 ...
 bind_aset(bind,8/*f*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6);  it=bind_aget(bind,8/*f*/); arg0=it;it=bind_aget(bind,3/*a*/); arg1=it; it=Left_Factor_binds(self ,arg0,arg1); FAILTEST(pass3);
...
alt2_2: ame_setpos(self,oldpos4);if (ame_getcut(self)!=Qnil) {ame_setcut(self,Qnil); goto pass1;}
   it=AmethystCore_anything(self ); FAILTEST(alt2_3);it=bind_aget(bind,3/*a*/);
 bind_aset(bind,6/*autovar*/,it);  
ame_setcut(self,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldpos4); goto pass1;
 accept2:;
 break;case 2:;   it=AmethystCore_anything(self ); FAILTEST(pass1);it=bind_aget(bind,3/*a*/);
...
ame_setsrc(self,bind_aget(bind,5/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 bind_aset(bind,6/*f*/,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (ame_getstop(self)!=Qnil){{oldpos6=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos6);  it=bind_aget(bind,6/*f*/); arg0=it; it=Left_Factor_first(self ,arg0); FAILTEST(pass3);
...
ame_setcut(self,Qnil);goto accept2;
 ...
 bind_aset(bind,4/*autovar*/,it);  break;}  it=Amethyst_eof(self ); FAILTEST(pass1);
	goto success1;
	pass1: fail1=1;
	success1: ame_setsrc(self,oldsrc1); ame_setpos(self,oldpos1); ame_setlen(self,oldlen1);
	if(fail1) goto fail;
...
return it;
fail: return failobj; }
VALUE Left_Factor_traverse(VALUE self ){VALUE vals[0]; VALUE bind=bind_new2(10);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (ame_getstop(self)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Left_Factorcb_1Left_Factor,1,bind); 
 bind_aset(bind,0/*oldchanged*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_2Left_Factor,1,bind); 
 bind_aset(bind,1/*this*/,it); it=Qnil;
 bind_aset(bind,2/*clon*/,it); it=Qfalse;
 bind_aset(bind,3/*changed*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_3Left_Factor,1,bind); 
 bind_aset(bind,4/*autovar*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_4Left_Factor,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,bind_aget(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 bind_aset(bind,7/*key*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_5Left_Factor,1,bind);   it=Left_Factor_traverse_item(self ); FAILTEST(pass3);
 bind_aset(bind,8/*val*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_6Left_Factor,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
...
ame_setsrc(self,bind_aget(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
 it=rb_ary_new3(0);
 bind_aset(bind,5/*ar*/,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=Left_Factor_traverse_item(self ); FAILTEST(break1);
 bind_aset(bind,6/*it*/,it); it=rb_funcall(self,s_traverse_item_Left_Factorcb_2Left_Factor,1,bind);  if (ame_getstop(self)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ame_setstop(self,Qnil);  ame_setpos(self,oldpos5); it=bind_aget(bind,5/*ar*/);
 bind_aset(bind,7/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
rb_define_method(cls_Left_Factor,"visit",Left_Factor_visit,0);
 rb_eval_string("testversionleft_factor('a3a07d815086a21122bf7cca8903811c')");}
