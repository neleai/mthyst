...
return it;
fail: return failobj; }
VALUE Left_Factor_traverse_item(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(6);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(traverse_item_Left_Factorcb_2,1,bind);  arg0=it; it=Left_Factor_clas(self ,arg0); FAILTEST(alt1_3);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  it=CALL(traverse_item_Left_Factorcb_4,1,bind);  arg0=it; it=Left_Factor_clas(self ,arg0); FAILTEST(alt1_4);
...
return it;
fail: return failobj; }
VALUE Left_Factor_visit(VALUE self ){VALUE vals[0]; VALUE bind=rb_ary_new2(7);  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
...
ame_setsrc(self,rb_ary_entry(bind,0)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=Left_Factor_traverse(self ); FAILTEST(pass1);  it=AmethystCore_anything(self ); FAILTEST(pass1);
 rb_ary_store(bind,1,it); it=rb_ary_entry(bind,1);
 rb_ary_store(bind,2,it); it=rb_ary_new3(0);
 rb_ary_store(bind,3,it); int oldpos2=ame_getpos(self);
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
 it=CALL(visit_Left_Factorcb_5,1,bind);  arg0=it;it=rb_ary_entry(bind,4); arg1=it; it=Left_Factor_factor(self ,arg0,arg1); FAILTEST(alt2_3);
 rb_ary_store(bind,5,it);  
ISET(cut,Qnil);goto accept2;
...
rb_define_method(cls_Left_Factor,"visit",Left_Factor_visit,0);
 rb_eval_string("testversion('26f32bc547bceb5f1ec87a6fb1419308')");}
