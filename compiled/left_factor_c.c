...
VALUE s_binds_Left_Factorcb_1Left_Factor;
VALUE s_binds_Left_Factorcb_2Left_Factor;
VALUE s_binds_Left_Factorcb_3Left_Factor;
VALUE s_factor_Left_Factorcb_1Left_Factor;
VALUE s_factor_Left_Factorcb_2Left_Factor;
VALUE s_factor_Left_Factorcb_3Left_Factor;
VALUE s_factor_Left_Factorcb_4Left_Factor;
VALUE s_factor_Left_Factorcb_5Left_Factor;
VALUE s_factor_Left_Factorcb_6Left_Factor;
VALUE s_factor_Left_Factorcb_7Left_Factor;
VALUE s_rest_Left_Factorcb_1Left_Factor;
VALUE s_rest_Left_Factorcb_2Left_Factor;
VALUE s_sizeLeft_Factor;
VALUE s_traverse_Left_Factorcb_1Left_Factor;
VALUE s_traverse_Left_Factorcb_2Left_Factor;
VALUE s_traverse_Left_Factorcb_3Left_Factor;
VALUE s_traverse_Left_Factorcb_4Left_Factor;
VALUE s_traverse_Left_Factorcb_5Left_Factor;
VALUE s_traverse_Left_Factorcb_6Left_Factor;
VALUE s_traverse_Left_Factorcb_7Left_Factor;
VALUE s_traverse_item_Left_Factorcb_1Left_Factor;
VALUE s_traverse_item_Left_Factorcb_2Left_Factor;
VALUE s_visit_Left_Factorcb_1Left_Factor;
VALUE s_visit_Left_Factorcb_2Left_Factor;
VALUE s_visit_Left_Factorcb_3Left_Factor;
VALUE s_visit_Left_Factorcb_4Left_Factor;
VALUE s_visit_Left_Factorcb_5Left_Factor;
VALUE s_visit_Left_Factorcb_6Left_Factor;
VALUE s_visit_Left_Factorcb_7Left_Factor;
VALUE s_visit_Left_Factorcb_8Left_Factor;
VALUE s_visit_Left_Factorcb_9Left_Factor;
...
it=rb_ary_entry(bind,0/*s*/);
 rb_ary_store(bind,1/*autovar*/,it); it=rb_funcall(self,s_binds_Left_Factorcb_1Left_Factor,1,bind); int oldpos1=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
  it=rb_funcall(self,s_binds_Left_Factorcb_2Left_Factor,1,bind);  arg0=it;it=rb_ary_entry(bind,3/*a*/); arg1=it; it=Left_Factor_binds(self ,arg0,arg1); FAILTEST(pass2);
 rb_ary_store(bind,4/*nexp*/,it); it=rb_funcall(self,s_binds_Left_Factorcb_3Left_Factor,1,bind); 
...
alt2_1: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto alt1_2;}
 it=rb_funcall(self,s_factor_Left_Factorcb_1Left_Factor,1,bind); FAILTEST(alt2_2); it=rb_ary_entry(bind,2/*prev*/); arg0=it;it=rb_ary_entry(bind,1/*start*/); arg1=it;it=rb_funcall(self,s_factor_Left_Factorcb_2Left_Factor,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_2);
...
alt3_1: ame_setpos(self,oldpos3);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto alt2_3;}
 it=rb_funcall(self,s_factor_Left_Factorcb_3Left_Factor,1,bind); rb_ivar_set(self,s__at_cutLeft_Factor,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt3_2); 
...
alt1_1: ame_setpos(self,oldpos2);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto pass1;}
 ...
 rb_ary_store(bind,2/*autovar*/,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
  it=rb_funcall(self,s_binds_Left_Factorcb_2Left_Factor,1,bind);  arg0=it; it=Left_Factor_first(self ,arg0); FAILTEST(pass2);
...
ame_setsrc(self,rb_ary_entry(bind,2/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
 ...
 rb_ary_store(bind,4/*autovar*/,it); it=rb_funcall(self,s_rest_Left_Factorcb_1Left_Factor,1,bind);  if (rb_ivar_get(self,s__at_stopLeft_Factor)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopLeft_Factor,Qnil);  ame_setpos(self,oldpos4); it=rb_ary_entry(bind,3/*autovar*/);
 rb_ary_store(bind,5/*it*/,it); it=rb_funcall(self,s_rest_Left_Factorcb_2Left_Factor,1,bind); 
...
int oldpos1; while(1){oldpos1=ame_getpos(self);   it=AmethystCore_anything(self ); FAILTEST(break1); if (rb_ivar_get(self,s__at_stopLeft_Factor)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopLeft_Factor,Qnil);  ame_setpos(self,oldpos1); it=rb_funcall(self,s_traverse_Left_Factorcb_1Left_Factor,1,bind); 
 rb_ary_store(bind,0/*oldchanged*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_2Left_Factor,1,bind); 
 rb_ary_store(bind,1/*this*/,it); it=Qnil;
 rb_ary_store(bind,2/*clon*/,it); it=Qfalse;
 rb_ary_store(bind,3/*changed*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_3Left_Factor,1,bind); 
 rb_ary_store(bind,4/*autovar*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_4Left_Factor,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
ame_setsrc(self,rb_ary_entry(bind,6/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
   it=AmethystCore_anything(self ); FAILTEST(pass3);
 rb_ary_store(bind,7/*key*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_5Left_Factor,1,bind);   it=Left_Factor_traverse_item(self ); FAILTEST(pass3);
 rb_ary_store(bind,8/*val*/,it); it=rb_funcall(self,s_traverse_Left_Factorcb_6Left_Factor,1,bind);   it=Amethyst_eof(self ); FAILTEST(pass3);
	goto success3;
	pass3: fail3=1;
	success3: ame_setsrc(self,oldsrc3); ame_setpos(self,oldpos5); ame_setlen(self,oldlen3);
 ...
 if (rb_ivar_get(self,s__at_stopLeft_Factor)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: rb_ivar_set(self,s__at_stopLeft_Factor,Qnil);  ame_setpos(self,oldpos4);   it=Amethyst_eof(self ); FAILTEST(pass2);
  ...
  it=Amethyst_eof(self ); FAILTEST(pass1);
	...
	if(fail1) goto fail;
it=rb_funcall(self,s_traverse_Left_Factorcb_7Left_Factor,1,bind); 
 rb_ary_store(bind,9/*_result*/,it); it=rb_ary_entry(bind,9/*_result*/);
return it;
fail: return failobj; }
...
alt1_1: ame_setpos(self,oldpos1);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto fail;}
 ...
 rb_ary_store(bind,0/*a*/,it); it=rb_funcall(self,s_traverse_item_Left_Factorcb_1Left_Factor,1,bind); it=rb_ary_entry(bind,0/*a*/);
...
ame_setsrc(self,rb_ary_entry(bind,4/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
 ...
 rb_ary_store(bind,6/*it*/,it); it=rb_funcall(self,s_traverse_item_Left_Factorcb_2Left_Factor,1,bind);  if (rb_ivar_get(self,s__at_stopLeft_Factor)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: rb_ivar_set(self,s__at_stopLeft_Factor,Qnil);  ame_setpos(self,oldpos5); it=rb_ary_entry(bind,5/*ar*/);
 rb_ary_store(bind,7/*autovar*/,it);   it=Amethyst_eof(self ); FAILTEST(pass2);
	goto success2;
	pass2: fail2=1;
...
ame_setsrc(self,rb_ary_entry(bind,1/*autovar*/)); ame_setpos(self,0); ame_setlen(self,FIX2LONG(rb_funcall(ame_getsrc(self),s_sizeLeft_Factor,0)));
 ...
 rb_ary_store(bind,2/*x*/,it); it=rb_funcall(self,s_visit_Left_Factorcb_1Left_Factor,1,bind); 
 rb_ary_store(bind,3/*cur*/,it); it=rb_funcall(self,s_visit_Left_Factorcb_2Left_Factor,1,bind); 
...
alt2_1: ame_setpos(self,oldpos4);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto alt1_2;}
 it=rb_funcall(self,s_visit_Left_Factorcb_3Left_Factor,1,bind); FAILTEST(alt2_2); it=rb_ary_new3(0); arg0=it;it=rb_ary_entry(bind,4/*start*/); arg1=it;it=rb_funcall(self,s_visit_Left_Factorcb_4Left_Factor,1,bind);  arg2=it; it=Left_Factor_factor(self ,arg0,arg1,arg2); FAILTEST(alt2_2);
...
alt3_1: ame_setpos(self,oldpos5);if (rb_ivar_get(self,s__at_cutLeft_Factor)!=Qnil) {rb_ivar_set(self,s__at_cutLeft_Factor,Qnil); goto alt2_3;}
 it=rb_funcall(self,s_visit_Left_Factorcb_5Left_Factor,1,bind); rb_ivar_set(self,s__at_cutLeft_Factor,Qtrue);  it=Amethyst_fails(self ); FAILTEST(alt3_2); 
rb_ivar_set(self,s__at_cutLeft_Factor,Qnil);goto accept3;
...
rb_define_method(cls_Left_Factor,"visit",Left_Factor_visit,0);
 rb_eval_string("testversionleft_factor('4e28e61a205f61619070d03fbcd6dc65')");}
