...
VALUE normalize_el(VALUE el){
  VALUE el2; int len, len2; VALUE *els, *els2; int i;
  if (TYPE(el) == T_ARRAY) {
...
VALUE normalize_Act(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@pred", normalize_el(rb_iv_get(obj, "@pred"))); hash = 11 * hash + rb_iv_get(obj, "@pred");
  rb_iv_set(obj, "@pure", normalize_el(rb_iv_get(obj, "@pure"))); hash = 11 * hash + rb_iv_get(obj, "@pure");
  ...
  while (obj2 = cache_Act->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@pred"), rb_iv_get(obj2, "@pred"))) goto next; if (!els_equal(rb_iv_get(obj, "@pure"), rb_iv_get(obj2, "@pure"))) goto next;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      rb_iv_set(obj3, "@pred", normalize_el(rb_iv_get(obj3, "@pred"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@pred");
      rb_iv_set(obj3, "@pure", normalize_el(rb_iv_get(obj3, "@pure"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@pure");
      ...
      while (obj2 = cache_Act->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@pred"), rb_iv_get(obj2, "@pred"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@pure"), rb_iv_get(obj2, "@pure"))) goto next2;
...
VALUE normalize_Apply(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@name", normalize_el(rb_iv_get(obj, "@name"))); hash = 11 * hash + rb_iv_get(obj, "@name");
  rb_iv_set(obj, "@clas", normalize_el(rb_iv_get(obj, "@clas"))); hash = 11 * hash + rb_iv_get(obj, "@clas");
  rb_iv_set(obj, "@bound", normalize_el(rb_iv_get(obj, "@bound"))); hash = 11 * hash + rb_iv_get(obj, "@bound");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
  while (obj2 = cache_Apply->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@name"), rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(rb_iv_get(obj, "@clas"), rb_iv_get(obj2, "@clas"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@bound"), rb_iv_get(obj2, "@bound"))) goto next; if (!els_equal(rb_iv_get(obj, "@ary"), rb_iv_get(obj2, "@ary"))) goto next;
      hits_Apply++;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@name", normalize_el(rb_iv_get(obj3, "@name"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@name");
      rb_iv_set(obj3, "@clas", normalize_el(rb_iv_get(obj3, "@clas"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@clas");
      rb_iv_set(obj3, "@bound", normalize_el(rb_iv_get(obj3, "@bound"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@bound");
      rb_iv_set(obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
      while (obj2 = cache_Apply->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@name"), rb_iv_get(obj2, "@name"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@clas"), rb_iv_get(obj2, "@clas"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@bound"), rb_iv_get(obj2, "@bound"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@ary"), rb_iv_get(obj2, "@ary"))) goto next2;
          break;
next2:;
          hash3 = (hash3 + 1) & ((1 << 20) - 1);
        }
...
VALUE create2_Apply(VALUE self, VALUE name, VALUE clas, VALUE bound, VALUE ary){
  int hash = 0;
  name = normalize_el(name); hash = 11 * hash + name; clas = normalize_el(clas); hash = 11 * hash + clas; bound = normalize_el(bound); hash = 11 * hash + bound; ary = normalize_el(ary); hash =
    11 * hash + ary;
  hash = hash & ((1 << 20) - 1);
  VALUE obj2 = cache_Apply->ary[hash];
  if ((int) obj2) {
      if (!els_equal(name, rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(clas, rb_iv_get(obj2, "@clas"))) goto next; if (!els_equal(bound, rb_iv_get(obj2, "@bound"))) goto next;
...
VALUE normalize_Append_AST(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@name", normalize_el(rb_iv_get(obj, "@name"))); hash = 11 * hash + rb_iv_get(obj, "@name");
  rb_iv_set(obj, "@exp", normalize_el(rb_iv_get(obj, "@exp"))); hash = 11 * hash + rb_iv_get(obj, "@exp");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
  while (obj2 = cache_Append_AST->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@name"), rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(rb_iv_get(obj, "@exp"), rb_iv_get(obj2, "@exp"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@ary"), rb_iv_get(obj2, "@ary"))) goto next;
      hits_Append_AST++;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@name", normalize_el(rb_iv_get(obj3, "@name"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@name");
      rb_iv_set(obj3, "@exp", normalize_el(rb_iv_get(obj3, "@exp"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@exp");
      rb_iv_set(obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
      while (obj2 = cache_Append_AST->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@name"), rb_iv_get(obj2, "@name"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@exp"), rb_iv_get(obj2, "@exp"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@ary"), rb_iv_get(obj2, "@ary"))) goto next2;
          break;
next2:;
          hash3 = (hash3 + 1) & ((1 << 20) - 1);
...
VALUE normalize_Args(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Bind(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Bnding(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_CAct(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Comment(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Lambda(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Global(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Local(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@ssano", normalize_el(rb_iv_get(obj, "@ssano"))); hash = 11 * hash + rb_iv_get(obj, "@ssano");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@ssano", normalize_el(rb_iv_get(obj3, "@ssano"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ssano"); rb_iv_set(obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary")));
      hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
...
VALUE normalize_Lookahead(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Many(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Or(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@has_cut", normalize_el(rb_iv_get(obj, "@has_cut"))); hash = 11 * hash + rb_iv_get(obj, "@has_cut");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@has_cut", normalize_el(rb_iv_get(obj3, "@has_cut"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@has_cut"); rb_iv_set(obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary")));
      hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
...
VALUE normalize_Pass(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@var", normalize_el(rb_iv_get(obj, "@var"))); hash = 11 * hash + rb_iv_get(obj, "@var");
  rb_iv_set(obj, "@to", normalize_el(rb_iv_get(obj, "@to"))); hash = 11 * hash + rb_iv_get(obj, "@to");
  rb_iv_set(obj, "@enter", normalize_el(rb_iv_get(obj, "@enter"))); hash = 11 * hash + rb_iv_get(obj, "@enter");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
  while (obj2 = cache_Pass->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@var"), rb_iv_get(obj2, "@var"))) goto next; if (!els_equal(rb_iv_get(obj, "@to"), rb_iv_get(obj2, "@to"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@enter"), rb_iv_get(obj2, "@enter"))) goto next; if (!els_equal(rb_iv_get(obj, "@ary"), rb_iv_get(obj2, "@ary"))) goto next;
      hits_Pass++;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@var", normalize_el(rb_iv_get(obj3, "@var"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@var");
      rb_iv_set(obj3, "@to", normalize_el(rb_iv_get(obj3, "@to"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@to");
      rb_iv_set(obj3, "@enter", normalize_el(rb_iv_get(obj3, "@enter"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@enter");
      rb_iv_set(obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
      while (obj2 = cache_Pass->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@var"), rb_iv_get(obj2, "@var"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@to"), rb_iv_get(obj2, "@to"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@enter"), rb_iv_get(obj2, "@enter"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@ary"), rb_iv_get(obj2, "@ary"))) goto next2;
          break;
next2:;
          hash3 = (hash3 + 1) & ((1 << 20) - 1);
        }
...
VALUE create2_Pass(VALUE self, VALUE var, VALUE to, VALUE enter, VALUE ary){
  int hash = 0;
  var = normalize_el(var); hash = 11 * hash + var; to = normalize_el(to); hash = 11 * hash + to; enter = normalize_el(enter); hash = 11 * hash + enter; ary = normalize_el(ary); hash = 11 * hash +
                                                                                                                                                                                        ary;
  hash = hash & ((1 << 20) - 1);
  VALUE obj2 = cache_Pass->ary[hash];
  if ((int) obj2) {
      if (!els_equal(var, rb_iv_get(obj2, "@var"))) goto next; if (!els_equal(to, rb_iv_get(obj2, "@to"))) goto next; if (!els_equal(enter, rb_iv_get(obj2, "@enter"))) goto next;
      if (!els_equal(ary, rb_iv_get(obj2, "@ary"))) goto next;
      hits_Pass++;
      return cache_Pass->ret[hash];
next:;
...
VALUE normalize_Result(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@name", normalize_el(rb_iv_get(obj, "@name"))); hash = 11 * hash + rb_iv_get(obj, "@name");
  rb_iv_set(obj, "@varnames", normalize_el(rb_iv_get(obj, "@varnames"))); hash = 11 * hash + rb_iv_get(obj, "@varnames");
  rb_iv_set(obj, "@vars", normalize_el(rb_iv_get(obj, "@vars"))); hash = 11 * hash + rb_iv_get(obj, "@vars");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
  while (obj2 = cache_Result->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@name"), rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(rb_iv_get(obj, "@varnames"), rb_iv_get(obj2, "@varnames"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@vars"), rb_iv_get(obj2, "@vars"))) goto next; if (!els_equal(rb_iv_get(obj, "@ary"), rb_iv_get(obj2, "@ary"))) goto next;
      hits_Result++;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@name", normalize_el(rb_iv_get(obj3, "@name"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@name"); rb_iv_set(obj3, "@varnames", normalize_el(rb_iv_get(obj3, "@varnames")));
      hash3 = 11 * hash3 + rb_iv_get(obj3, "@varnames"); rb_iv_set(obj3, "@vars", normalize_el(rb_iv_get(obj3, "@vars"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@vars"); rb_iv_set(
        obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
      while (obj2 = cache_Result->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@name"), rb_iv_get(obj2, "@name"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@varnames"), rb_iv_get(obj2, "@varnames"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@vars"), rb_iv_get(obj2, "@vars"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@ary"), rb_iv_get(obj2, "@ary"))) goto next2;
          break;
next2:;
          hash3 = (hash3 + 1) & ((1 << 20) - 1);
        }
...
VALUE create2_Result(VALUE self, VALUE name, VALUE varnames, VALUE vars, VALUE ary){
  int hash = 0;
  name = normalize_el(name); hash = 11 * hash + name; varnames = normalize_el(varnames); hash = 11 * hash + varnames; vars = normalize_el(vars); hash = 11 * hash + vars; ary = normalize_el(ary);
  hash = 11 * hash + ary;
  hash = hash & ((1 << 20) - 1);
  VALUE obj2 = cache_Result->ary[hash];
  if ((int) obj2) {
      if (!els_equal(name, rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(varnames, rb_iv_get(obj2, "@varnames"))) goto next; if (!els_equal(vars, rb_iv_get(obj2, "@vars"))) goto next;
      if (!els_equal(ary, rb_iv_get(obj2, "@ary"))) goto next;
      hits_Result++;
      return cache_Result->ret[hash];
next:;
...
VALUE normalize_Rule(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
    obj = rb_obj_dup(obj);
  rb_iv_set(obj, "@name", normalize_el(rb_iv_get(obj, "@name"))); hash = 11 * hash + rb_iv_get(obj, "@name");
  rb_iv_set(obj, "@args", normalize_el(rb_iv_get(obj, "@args"))); hash = 11 * hash + rb_iv_get(obj, "@args");
  rb_iv_set(obj, "@locals", normalize_el(rb_iv_get(obj, "@locals"))); hash = 11 * hash + rb_iv_get(obj, "@locals");
  rb_iv_set(obj, "@body", normalize_el(rb_iv_get(obj, "@body"))); hash = 11 * hash + rb_iv_get(obj, "@body");
  rb_iv_set(obj, "@cfg", normalize_el(rb_iv_get(obj, "@cfg"))); hash = 11 * hash + rb_iv_get(obj, "@cfg");
  rb_iv_set(obj, "@reachable", normalize_el(rb_iv_get(obj, "@reachable"))); hash = 11 * hash + rb_iv_get(obj, "@reachable"); rb_iv_set(obj, "@bnding", normalize_el(rb_iv_get(obj, "@bnding")));
  hash = 11 * hash + rb_iv_get(obj, "@bnding"); rb_iv_set(obj, "@consts", normalize_el(rb_iv_get(obj, "@consts"))); hash = 11 * hash + rb_iv_get(obj, "@consts"); rb_iv_set(
    obj, "@varargs", normalize_el(rb_iv_get(obj, "@varargs"))); hash = 11 * hash + rb_iv_get(obj, "@varargs");
  rb_iv_set(obj, "@ary", normalize_el(rb_iv_get(obj, "@ary"))); hash = 11 * hash + rb_iv_get(obj, "@ary");
  rb_iv_set(obj, "@hash", LONG2FIX(hash));
  rb_obj_freeze(obj);
  hash = hash & ((1 << 20) - 1);
  while (obj2 = cache_Rule->ary[hash]) {
      if (!els_equal(rb_iv_get(obj, "@name"), rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(rb_iv_get(obj, "@args"), rb_iv_get(obj2, "@args"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@locals"), rb_iv_get(obj2, "@locals"))) goto next; if (!els_equal(rb_iv_get(obj, "@body"), rb_iv_get(obj2, "@body"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@cfg"), rb_iv_get(obj2, "@cfg"))) goto next; if (!els_equal(rb_iv_get(obj, "@reachable"), rb_iv_get(obj2, "@reachable"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@bnding"), rb_iv_get(obj2, "@bnding"))) goto next; if (!els_equal(rb_iv_get(obj, "@consts"), rb_iv_get(obj2, "@consts"))) goto next;
      if (!els_equal(rb_iv_get(obj, "@varargs"), rb_iv_get(obj2, "@varargs"))) goto next; if (!els_equal(rb_iv_get(obj, "@ary"), rb_iv_get(obj2, "@ary"))) goto next;
      hits_Rule++;
...
next:;
  ...
  if (rb_obj_is_kind_of(obj3, rb_obj_class(obj))) {
      ...
      if (rb_obj_frozen_p(obj3) == Qtrue)
        obj3 = rb_obj_dup(obj3);
      rb_iv_set(obj3, "@name", normalize_el(rb_iv_get(obj3, "@name"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@name");
      rb_iv_set(obj3, "@args", normalize_el(rb_iv_get(obj3, "@args"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@args"); rb_iv_set(obj3, "@locals", normalize_el(rb_iv_get(obj3, "@locals")));
      hash3 = 11 * hash3 + rb_iv_get(obj3, "@locals"); rb_iv_set(obj3, "@body", normalize_el(rb_iv_get(obj3, "@body"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@body"); rb_iv_set(
        obj3, "@cfg", normalize_el(rb_iv_get(obj3, "@cfg"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@cfg");
      rb_iv_set(obj3, "@reachable", normalize_el(rb_iv_get(obj3, "@reachable"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@reachable");
      rb_iv_set(obj3, "@bnding", normalize_el(rb_iv_get(obj3, "@bnding"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@bnding"); rb_iv_set(obj3, "@consts", normalize_el(rb_iv_get(obj3, "@consts")));
      hash3 = 11 * hash3 + rb_iv_get(obj3, "@consts"); rb_iv_set(obj3, "@varargs", normalize_el(rb_iv_get(obj3, "@varargs"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@varargs"); rb_iv_set(
        obj3, "@ary", normalize_el(rb_iv_get(obj3, "@ary"))); hash3 = 11 * hash3 + rb_iv_get(obj3, "@ary");
      rb_iv_set(obj3, "@hash", LONG2FIX(hash3));
      rb_obj_freeze(obj3);
      hash3 = hash3 & ((1 << 20) - 1);
      while (obj2 = cache_Rule->ary[hash3]) {
          if (!els_equal(rb_iv_get(obj3, "@name"), rb_iv_get(obj2, "@name"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@args"), rb_iv_get(obj2, "@args"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@locals"), rb_iv_get(obj2, "@locals"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@body"), rb_iv_get(obj2, "@body"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@cfg"), rb_iv_get(obj2, "@cfg"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@reachable"), rb_iv_get(obj2, "@reachable"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@bnding"), rb_iv_get(obj2, "@bnding"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@consts"), rb_iv_get(obj2, "@consts"))) goto next2;
          if (!els_equal(rb_iv_get(obj3, "@varargs"), rb_iv_get(obj2, "@varargs"))) goto next2; if (!els_equal(rb_iv_get(obj3, "@ary"), rb_iv_get(obj2, "@ary"))) goto next2;
          break;
next2:;
          hash3 = (hash3 + 1) & ((1 << 20) - 1);
        }
...
VALUE create2_Rule(VALUE self, VALUE name, VALUE args, VALUE locals, VALUE body, VALUE cfg, VALUE reachable, VALUE bnding, VALUE consts, VALUE varargs, VALUE ary){
  int hash = 0;
  name = normalize_el(name); hash = 11 * hash + name; args = normalize_el(args); hash = 11 * hash + args; locals = normalize_el(locals); hash = 11 * hash + locals; body = normalize_el(body);
  hash = 11 * hash + body; cfg = normalize_el(cfg); hash = 11 * hash + cfg; reachable = normalize_el(reachable); hash = 11 * hash + reachable; bnding = normalize_el(bnding); hash = 11 * hash +
                                                                                                                                                                                     bnding;
  consts = normalize_el(consts); hash = 11 * hash + consts; varargs = normalize_el(varargs); hash = 11 * hash + varargs; ary = normalize_el(ary); hash = 11 * hash + ary;
  hash = hash & ((1 << 20) - 1);
  VALUE obj2 = cache_Rule->ary[hash];
  if ((int) obj2) {
      if (!els_equal(name, rb_iv_get(obj2, "@name"))) goto next; if (!els_equal(args, rb_iv_get(obj2, "@args"))) goto next; if (!els_equal(locals, rb_iv_get(obj2, "@locals"))) goto next;
      if (!els_equal(body, rb_iv_get(obj2, "@body"))) goto next; if (!els_equal(cfg, rb_iv_get(obj2, "@cfg"))) goto next; if (!els_equal(reachable, rb_iv_get(obj2, "@reachable"))) goto next;
      if (!els_equal(bnding, rb_iv_get(obj2, "@bnding"))) goto next; if (!els_equal(consts, rb_iv_get(obj2, "@consts"))) goto next;
      if (!els_equal(varargs, rb_iv_get(obj2, "@varargs"))) goto next;
      if (!els_equal(ary, rb_iv_get(obj2, "@ary"))) goto next;
      hits_Rule++;
      return cache_Rule->ret[hash];
next:;
  ...
  rb_iv_set(obj3, "@name", name); rb_iv_set(obj3, "@args", args); rb_iv_set(obj3, "@locals", locals); rb_iv_set(obj3, "@body", body); rb_iv_set(obj3, "@cfg", cfg); rb_iv_set(obj3, "@reachable",
                                                                                                                                                                              reachable);
  rb_iv_set(obj3, "@bnding", bnding); rb_iv_set(obj3, "@consts", consts); rb_iv_set(obj3, "@varargs", varargs); rb_iv_set(obj3, "@ary", ary);
  return normalize_Rule(obj3);
}
int hits_Seq = 0; int miss_Seq = 0; normalize_cache *cache_Seq;
VALUE normalize_Seq(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Stop(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Strin(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Switch_Char(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Switch_Clas(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
VALUE normalize_Switch_Or(VALUE obj){
  int i;
  int hash = 0; int len, len2, len3; VALUE *els, *els2, *els3; VALUE obj2;
  VALUE ary = rb_iv_get(obj, "@ary");
  if (rb_obj_frozen_p(obj) == Qtrue)
...
void normalize_cache_mark(normalize_cache *b){
  int i;
