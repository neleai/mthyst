...
a_1 = ((nil))
_result_1 = ((nil))
_result_1 = (a_1 = (autovar_2 = (([]))
while true
autovar_4=@input;r=it=((it=(_or(proc{it_1 = (autovar_1 = (([]))
it=((it=(_not{(it=(seq("amethyst"));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
(it=(_dot_());next FAIL if it==FAIL;it) )
 autovar_1||=[];_append(autovar_1,it)
while true
autovar_3=@input;r=it=((it=(_not{(it=(seq("amethyst"));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
autovar_2 = (([]))
while true
autovar_3=@input;r=it=((it=(_not{(it=(space());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
c_1 = (autovar_1 = (([]))
while true
autovar_4=@input;r=it=((it=(_not{(it=(endline());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
(it=(_dot_());break FAIL if it==FAIL;it) )
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_4
...
s_1 = (autovar_3 = (([]))
while true
autovar_4=@input;r=it=((it=(_not{(it=(seq("\""));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
s_1 = (autovar_2 = (([]))
while true
autovar_5=@input;r=it=((it=(_not{(it=(seq("\'"));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
(it=(eChar());break FAIL if it==FAIL;it) )
 autovar_2||=[];_append(autovar_2,it)
 break FAIL if r==FAIL
end;@input=autovar_5
...
(it=(eChar());next FAIL if it==FAIL;it) )
 autovar_1||=[];_append(autovar_1,it)
while true
autovar_6=@input;r=it=((it=(_not{(it=(token(">"));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
(it=(eChar());break FAIL if it==FAIL;it) )
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_6
...
s_1 = (autovar_3 = (([]))
while true
autovar_6=@input;r=it=((it=(_not{(it=(seq("\'"));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
(it=(eChar());break FAIL if it==FAIL;it) )
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
end;@input=autovar_6
(autovar_3) )
(it=(seq("\'"));next FAIL if it==FAIL;it)
(Strin[['\'']+s_1+['\'']]) },proc{(it=(_or(proc{it=((it=(regch(/[$.:]/));next FAIL if it==FAIL;it))
...
(autovar_2) )
 n_1||=[];_append(n_1,it)
(n_1*"") },proc{(it=(seq("@@"));next FAIL if it==FAIL;it)
it=(autovar_1 = (([]))
it=((it=(regch(/[a-zA-Z_]/));next FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
while true
...
(autovar_1) )
 n_1||=[];_append(n_1,it)
(Local[n_1*""]) },proc{k_1 = ((it=(key());next FAIL if it==FAIL;it))
...
_result_1 = (autovar_3 = (([]))
while true
autovar_4=@input;r=it=((it=(_());break FAIL if it==FAIL;it))
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
end;@input=autovar_4
(autovar_3)
...
it=(autovar_1 = (([]))
while true
autovar_5=@input;r=it=((it=(nameRest());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_5
(autovar_1) )
...
s_1 = ((nil))
_result_1 = ((nil))
_result_1 = (s_1 = (autovar_2 = (([]))
while true
autovar_3=@input;r=it=((it=(_not{(it=(endline());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
(it=(_dot_());break FAIL if it==FAIL;it) )
 autovar_2||=[];_append(autovar_2,it)
 break FAIL if r==FAIL
end;@input=autovar_3
...
r_1 = ((nil))
_result_1 = ((nil))
_result_1 = (r_1 = (autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(_or(proc{(it=(char());next FAIL if it==FAIL;it)},proc{(it=(trans());next FAIL if it==FAIL;it)}));break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_2
(autovar_1) )
...
(it=(_enter{t_1 = (autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_2
(autovar_1) )});return FAIL if it==FAIL;it)
(t_1) )
(_result_1)  
end
def args()
...
(it=(_enter{a_1 = (autovar_2 = (([]))
while true
autovar_3=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_2||=[];_append(autovar_2,it)
 break FAIL if r==FAIL
end;@input=autovar_3
(autovar_2) )});next FAIL if it==FAIL;it)
(a_1) },proc{autovar_1 = (([]))
while true
...
(it=(_enter{ary_1 = (autovar_1 = (([]))
while true
autovar_4=@input;r=it=((it=(_or(proc{(it=(char());next FAIL if it==FAIL;it)},proc{(it=(arg());next FAIL if it==FAIL;it)}));break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_4
(autovar_1) )});next FAIL if it==FAIL;it)
...
name_1 = ( _key(:name))
autovar_5 = ( _key(:args))
(it=(_pass(autovar_5){args_1 = ((it=(clas(Object));next FAIL if it==FAIL;it)
...
autovar_3 = (([]))
while true
autovar_6=@input;r=it=((@locals=l_1.clone)
...
Or[ {:l=>l_1,:r=>r_1,:ary=>ary_1 }] },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_2 = ( _key(:args))
...
autovar_6 = ( _key(:args))
(it=(_pass(autovar_6){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_5 = ( _key(:body))
(it=(_pass(autovar_5){(it=(trans());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
body_1 = ( _key(:body))
locals_1 = ( _key(:locals))
reachable_1 = ((@edges.reachable(@marked))) });next FAIL if it==FAIL;it)
Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:reachable=>reachable_1 }] },proc{(it=(clas(Apply));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ((it=(anything());next FAIL if it==FAIL;it))
var_1 = ((it=(vars_in());next FAIL if it==FAIL;it)) });next FAIL if it==FAIL;it)
(@marked +=var_1) },proc{(it=(clas(Pass));next FAIL if it==FAIL;it)
(it=(_enter{autovar_4 = ( _key(:var))
(it=(_pass(autovar_4){var_1 = ((it=(vars_in());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
(it=(_pass(autovar_1){var_1 = ((it=(clas(Object));next FAIL if it==FAIL;it)
(it=(_enter{(it=(vars_in());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) )});next FAIL if it==FAIL;it)
...
autovar_4 = (([]))
while true
autovar_7=@input;r=it=((it=(_or(proc{(it=(clas(Variable));next FAIL if it==FAIL;it)
...
(autovar_3) });next FAIL if it==FAIL;it) },proc{(it=(clas(Act));next FAIL if it==FAIL;it)
(it=(_enter{it=( _key(:this))
 ary_1||=[];_append(ary_1,it)
autovar_2 = (([]))
while true
...
(autovar_2) });next FAIL if it==FAIL;it) },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{it=( _key(:this))
...
(it=(_enter{name_1 = ( _key(:name))
it_1 = ( _key(:reachable))
(@reachable=it_1;puts @reachable)
autovar_4 = ( _key(:args))
(it=(_pass(autovar_4){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_3 = ( _key(:body))
(it=(_pass(autovar_3){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
locals_1 = ( _key(:locals)) });next FAIL if it==FAIL;it)
Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1 }] },proc{(it=(clas(Act));next FAIL if it==FAIL;it)
(it=(_enter{this_1 = ( _key(:this))
autovar_2 = (([]))
while true
autovar_5=@input;r=it=((it=(_dot_());break FAIL if it==FAIL;it))
...
(autovar_2) });next FAIL if it==FAIL;it)
(@reachable[this_1] ? this_1 : Act[]) },proc{(it=(clas(Set));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_1 = ( _key(:expr))
(it=(_pass(autovar_1){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
(@reachable[name_1] ? _Set(name_1,expr_1,append_1) : expr_1) },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{this_1 = ( _key(:this))});next FAIL if it==FAIL;it)
(@reachable[this_1] ? this_1 : Act[]) },proc{(it=(super());next FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
(_result_1)  
end
...
autovar_2 = (([]))
while true
autovar_6=@input;r=it=((it=(clas(And));break FAIL if it==FAIL;it)
...
autovar_1 = ((expr_1))
(it=(_pass(autovar_1){(it=(move(append_1,name_1));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{(it=(super());next FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
(_result_1)  
end
...
(it=(_enter{ary_1 = (autovar_3 = (([]))
while true
autovar_6=@input;r=it=(el_1 = ((it=(anything());break FAIL if it==FAIL;it))
(it=(_or(proc{(it=(_lookahead{(it=(eof());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
autovar_2 = ((el_1))
(it=(_pass(autovar_2){(it=(move(append_1,name_1));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) },proc{(el_1)}));break FAIL if it==FAIL;it) )
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
end;@input=autovar_6
(autovar_3) )});next FAIL if it==FAIL;it)
...
(it=(_enter{it=((it=(move(append_1,name_1));next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
Enter[ {:ary=>ary_1 }] },proc{(it=(clas(Pass));next FAIL if it==FAIL;it)
...
Pass[ {:var=>var_1,:to=>to_1,:enter=>enter_1 }] },proc{it_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
autovar_4 = ((nil))
_result_1 = ((nil))
_result_1 = (autovar_4 = ((grammar_1))
(it=(_pass(autovar_4){(it=(clas(Object));return FAIL if it==FAIL;it)
(it=(_enter{autovar_3 = (([]))
while true
autovar_6=@input;r=it=((it=(_or(proc{(it=(clas(Grammar));next FAIL if it==FAIL;it)
(it=(_enter{autovar_2 = ( _key(:rules))
(it=(_pass(autovar_2){(it=(clas(Object));next FAIL if it==FAIL;it)
(it=(_enter{autovar_1 = (([]))
while true
autovar_5=@input;r=it=((it=(clas(Rule));break FAIL if it==FAIL;it)
...
(autovar_1) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{(it=(anything());next FAIL if it==FAIL;it)}));break FAIL if it==FAIL;it))
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
end;@input=autovar_6
(autovar_3) });return FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(rule_1) )
(_result_1)  
end
...
(it=(_pass(autovar_13){body_1 = ((it=(transs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
...
(@varhash[name_1][number_1]=@varhash[name_1].size+1 if !@varhash[name_1][number_1]  ; "#{name_1}_#{@varhash[name_1][number_1]}") },proc{(it=(clas(Local));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ((it=(anything());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
("@#{name_1}") },proc{(it=(anything());next FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
(_result_1)  
end
def rw(word_1,prc_1)
 x_1 = ((nil))
