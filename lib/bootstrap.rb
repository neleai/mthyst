...
_result_4 = ((nil))
_result_5 = ((nil))
_result_5 = ((it=(anything());return FAIL if it==FAIL;it))
autovar_1 = ((_result_5))
c_2 = ((autovar_1))
...
_result_2 = ((nil))
_result_3 = ((nil))
_result_3 = ((it=(anything());return FAIL if it==FAIL;it))
autovar_1 = ((_result_3))
c_2 = ((autovar_1))
(it=((c_2.is_a? String )||FAIL);return FAIL if it==FAIL;it)
_result_2 = ((c_2))
...
_result_1 = ((nil))
_result_2 = ((nil))
_result_2 = ((it=(anything());return FAIL if it==FAIL;it))
autovar_1 = ((_result_2))
c_1 = ((autovar_1))
...
_result_3 = ((nil))
_result_4 = ((nil))
_result_4 = ((it=(anything());return FAIL if it==FAIL;it))
autovar_1 = ((_result_4))
c_2 = ((autovar_1))
(it=((c_2.is_a? String )||FAIL);return FAIL if it==FAIL;it)
_result_3 = ((c_2))
...
autovar_1 = (([]))
while true
autovar_6=@input;r=_result_2 = ((nil))
regex_1 = ((/[\s\t\r\n\f]/))
c_1 = ((nil))
_result_3 = ((nil))
c_2 = ((nil))
_result_4 = ((nil))
_result_5 = ((nil))
_result_5 = ((it=(anything());break FAIL if it==FAIL;it))
autovar_2 = ((_result_5))
c_2 = ((autovar_2))
...
_result_2 = ((nil))
_result_3 = ((nil))
_result_3 = ((it=(anything());break FAIL if it==FAIL;it))
autovar_1 = ((_result_3))
c_2 = ((autovar_1))
(it=((c_2.is_a? String )||FAIL);break FAIL if it==FAIL;it)
_result_2 = ((c_2))
...
autovar_1 = (([]))
while true
autovar_2=@input;r=(it=(_foreign(:r ,));break FAIL if it==FAIL;it)
...
(it=(token("]"));next FAIL if it==FAIL;it)
_result_1 = ((_Enter(expr_1,Apply["clas",cls_1]))) },proc{cls_1 = ((it=(className());next FAIL if it==FAIL;it))
...
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));return FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){_result_1 = ((it=(addargs());return FAIL if it==FAIL;it))});return FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
def addargs()
 result_1 = ((nil))
...
(it=(_pass(true,autovar_1){name_1 = ((it=(anything());break FAIL if it==FAIL;it))
it=((_Variable(name_1) ))
...
autovar_2 = (("{#{s_1*""}}"))
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));return FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){_result_1 = ((it=(inlineHostExpr());return FAIL if it==FAIL;it))});return FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
...
autovar_28 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_28 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_27 = ( _key(:rules))
(it=(_pass(false,autovar_27){rules_1 = ((it=(transs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (Grammar[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1 }]) },proc{autovar_26 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_26){name_1 = ( _key(:name))
autovar_25 = ( _key(:args))
(it=(_pass(false,autovar_25){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_24 = ( _key(:body))
(it=(_pass(false,autovar_24){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
locals_1 = ( _key(:locals)) });next FAIL if it==FAIL;it)
_result_1 = (Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1 }]) },proc{autovar_23 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){autovar_22 = (([]))
while true
autovar_29=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_22||=[];_append(autovar_22,it)
 break FAIL if r==FAIL
end;@input=autovar_29
ary_1 = ((autovar_22)) });next FAIL if it==FAIL;it)
_result_1 = (Or[ {:ary=>ary_1 }]) },proc{autovar_21 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){autovar_20 = (([]))
while true
...
_result_1 = (And[ {:ary=>ary_1 }]) },proc{autovar_19 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_19){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (Not[ {:ary=>ary_1 }]) },proc{autovar_18 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (Lookahead[ {:ary=>ary_1 }]) },proc{autovar_17 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_17){autovar_16 = (([]))
while true
...
_result_1 = (Comment[ {:ary=>ary_1 }]) },proc{autovar_15 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
o_1 = ( _key(:o)) });next FAIL if it==FAIL;it)
_result_1 = (Many[ {:ary=>ary_1,:o=>o_1 }]) },proc{autovar_14 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){it=((it=(anything());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
it=((it=(args());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it) });next FAIL if it==FAIL;it)
_result_1 = (Apply[ {:ary=>ary_1 }]) },proc{autovar_13 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_13){autovar_12 = ( _key(:name))
(it=(_pass(false,autovar_12){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_11 = ( _key(:expr))
(it=(_pass(false,autovar_11){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = (Set[ {:name=>name_1,:expr=>expr_1,:append=>append_1 }]) },proc{autovar_10 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_10){ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
_result_1 = (Act[ {:ary=>ary_1,:pred=>pred_1 }]) },proc{autovar_9 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){name_1 = ( _key(:name))
autovar_8 = ( _key(:args))
(it=(_pass(false,autovar_8){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_7 = ( _key(:vars))
(it=(_pass(false,autovar_7){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (Result[ {:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{autovar_6 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_5 = (([]))
while true
...
_result_1 = (Args[ {:ary=>ary_1 }]) },proc{autovar_4 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){name_1 = ( _key(:name))});next FAIL if it==FAIL;it)
_result_1 = (Key[ {:name=>name_1 }]) },proc{autovar_3 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = ( _key(:to))
(it=(_pass(false,autovar_2){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_1 = ( _key(:var))
(it=(_pass(false,autovar_1){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
enter_1 = ( _key(:enter)) });next FAIL if it==FAIL;it)
_result_1 = (Pass[ {:to=>to_1,:var=>var_1,:enter=>enter_1 }]) }));return FAIL if it==FAIL;it)
(_result_1)  
end
def transfn()
 _result_1 = ((nil))
...
autovar_2 = ((nil))
_result_1 = ((nil))
autovar_2 = ((it=(clas(Object));return FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_3){autovar_2 = (([]))
while true
...
autovar_5 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_5 = ((it=(clas(Args));next FAIL if it==FAIL;it))
...
_result_1 = (Args[ {:ary=>ary_1 }]) },proc{autovar_3 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = (([]))
while true
...
_result_1 = (Strin[ {:ary=>ary_1 }]) },proc{autovar_1 = ((it=(clas(Exp));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){it=((it=(transfn());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
...
(it=(_pass(false,autovar_1){(it=(modify());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
...
v_1 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_30 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_30){name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_29 = ( _key(:rules))
(it=(_pass(false,autovar_29){autovar_28 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){autovar_27 = (([]))
while true
autovar_31=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_27||=[];_append(autovar_27,it)
 break FAIL if r==FAIL
end;@input=autovar_31
rules_1 = ((autovar_27)) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
v_1 = (Grammar[ {:v=>v_1,:name=>name_1,:parent=>parent_1,:rules=>rules_1 }]) },proc{autovar_26 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_26){name_1 = ( _key(:name))
autovar_25 = ( _key(:args))
(it=(_pass(false,autovar_25){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_24 = ( _key(:body))
(it=(_pass(false,autovar_24){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
locals_1 = ( _key(:locals)) });next FAIL if it==FAIL;it)
v_1 = (Rule[ {:v=>v_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1 }]) },proc{autovar_23 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){autovar_22 = (([]))
while true
autovar_32=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_22||=[];_append(autovar_22,it)
 break FAIL if r==FAIL
end;@input=autovar_32
ary_1 = ((autovar_22)) });next FAIL if it==FAIL;it)
v_1 = (Or[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_21 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){autovar_20 = (([]))
while true
autovar_33=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_20||=[];_append(autovar_20,it)
 break FAIL if r==FAIL
end;@input=autovar_33
ary_1 = ((autovar_20)) });next FAIL if it==FAIL;it)
v_1 = (And[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_19 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_19){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
v_1 = (Not[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_18 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
v_1 = (Lookahead[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_17 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_17){autovar_16 = (([]))
while true
...
ary_1 = ((autovar_16)) });next FAIL if it==FAIL;it)
v_1 = (Comment[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_15 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
o_1 = ( _key(:o)) });next FAIL if it==FAIL;it)
v_1 = (Many[ {:v=>v_1,:ary=>ary_1,:o=>o_1 }]) },proc{autovar_14 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){it=((it=(anything());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
it=((it=(args());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it) });next FAIL if it==FAIL;it)
v_1 = (Apply[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_13 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_13){autovar_12 = ( _key(:name))
(it=(_pass(false,autovar_12){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_11 = ( _key(:expr))
(it=(_pass(false,autovar_11){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
v_1 = (Set[ {:v=>v_1,:name=>name_1,:expr=>expr_1,:append=>append_1 }]) },proc{autovar_10 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_10){ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
v_1 = (Act[ {:v=>v_1,:ary=>ary_1,:pred=>pred_1 }]) },proc{autovar_9 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){name_1 = ( _key(:name))
autovar_8 = ( _key(:args))
(it=(_pass(false,autovar_8){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_7 = ( _key(:vars))
(it=(_pass(false,autovar_7){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
v_1 = (Result[ {:v=>v_1,:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{autovar_6 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_5 = (([]))
while true
autovar_35=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_5||=[];_append(autovar_5,it)
 break FAIL if r==FAIL
end;@input=autovar_35
ary_1 = ((autovar_5)) });next FAIL if it==FAIL;it)
v_1 = (Args[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_4 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){name_1 = ( _key(:name))});next FAIL if it==FAIL;it)
v_1 = (Key[ {:v=>v_1,:name=>name_1 }]) },proc{autovar_3 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = ( _key(:to))
(it=(_pass(false,autovar_2){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_1 = ( _key(:var))
(it=(_pass(false,autovar_1){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
enter_1 = ( _key(:enter)) });next FAIL if it==FAIL;it)
v_1 = (Pass[ {:v=>v_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) }));return FAIL if it==FAIL;it)
_result_1 = ((it=(avisit(v_1));return FAIL if it==FAIL;it))
(_result_1)  
end
def args()
 autovar_1 = ((nil))
...
v_1 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{(it=(_or(proc{autovar_5 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){autovar_4 = (([]))
while true
autovar_6=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_4||=[];_append(autovar_4,it)
...
ary_1 = ((autovar_4)) });next FAIL if it==FAIL;it)
v_1 = (Args[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_3 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = (([]))
while true
autovar_7=@input;r=(it=(_or(proc{it=((it=(char());next FAIL if it==FAIL;it))
 autovar_2||=[];_append(autovar_2,it)},proc{it=((it=(arg());next FAIL if it==FAIL;it))
...
ary_1 = ((autovar_2)) });next FAIL if it==FAIL;it)
v_1 = (Strin[ {:v=>v_1,:ary=>ary_1 }]) },proc{autovar_1 = ((it=(clas(Exp));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
v_1 = (Exp[ {:v=>v_1,:ary=>ary_1 }]) }));next FAIL if it==FAIL;it)
_result_1 = ((it=(avisit(v_1));next FAIL if it==FAIL;it)) },proc{_result_1 = ((it=(anything());next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
...
_result_1 = ((ary_1[0])) },proc{_result_1 = (Or[ {:ary=>ary_1 }])}));next FAIL if it==FAIL;it) },proc{autovar_2 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){autovar_1 = (([]))
while true
...
(it=(_pass(true,autovar_4){autovar_3 = (([]))
while true
autovar_5=@input;r=it=((it=(_dot_());break FAIL if it==FAIL;it))
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
end;@input=autovar_5
ary_1 = ((autovar_3)) });next FAIL if it==FAIL;it)
...
(it=(_pass(true,autovar_2){autovar_1 = (([]))
while true
autovar_6=@input;r=it=((it=(_dot_());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_6
ary_1 = ((autovar_1)) });next FAIL if it==FAIL;it)
...
autovar_7 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_7 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){argnames_1 = ((@argnames=[]))
(@locals=[])
name_1 = ( _key(:name))
args_1 = ( _key(:args))
(args_1.each{|v| @argnames<<v[0]})
autovar_6 = ( _key(:body))
(it=(_pass(false,autovar_6){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
locals_1 = ((@locals.uniq))
((locals_1-argnames_1).each{|l_1| body_1=And[Set[{:name=>l_1,:expr=>Act["nil"] }],body_1] };) });next FAIL if it==FAIL;it)
_result_1 = (Rule[ {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1 }]) },proc{autovar_5 = ((it=(clas(Or));next FAIL if it==FAIL;it))
...
_result_1 = (Or[ {:l=>l_1,:r=>r_1,:ary=>ary_1 }]) },proc{autovar_4 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){name_1 = ( _key(:name))
autovar_3 = ( _key(:args))
...
_result_1 = (Result[ {:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{autovar_2 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){name_1 = ( _key(:name))
(@locals<<name_1)
autovar_1 = ( _key(:expr))
...
args_1 = ( _key(:args))
autovar_1 = ( _key(:body))
(it=(_pass(false,autovar_1){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
autovar_14 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_14 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){name_1 = ( _key(:name))
(@edges=Oriented_Graph.new ; @marked=[_Variable("_result")])
autovar_13 = ( _key(:args))
(it=(_pass(false,autovar_13){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_12 = ( _key(:body))
(it=(_pass(false,autovar_12){(it=(trans());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
body_1 = ( _key(:body))
locals_1 = ( _key(:locals))
reachable_1 = ((@edges.reachable(@marked))) });next FAIL if it==FAIL;it)
_result_1 = (Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:reachable=>reachable_1 }]) },proc{autovar_11 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_11){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_10){autovar_9 = ( _key(:var))
(it=(_pass(false,autovar_9){var_1 = ((it=(vars_in());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
(@marked+=var_1)
autovar_8 = ( _key(:to))
(it=(_pass(false,autovar_8){_result_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{autovar_7 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){this_1 = ( _key(:this))
(@marked<<this_1 if _key(:pred))
var_1 = ((it=(vars_in());next FAIL if it==FAIL;it)) });next FAIL if it==FAIL;it)
_result_1 = ((var_1.each{|v_1| @edges.add(v_1,this_1); @edges.add(this_1,v_1); @marked<<this_1 if v_1.is_a? Local})) },proc{autovar_6 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){v_1 = ( _key(:name))
autovar_5 = ( _key(:expr))
(it=(_pass(false,autovar_5){(it=(trans());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
autovar_4 = ( _key(:expr))
(it=(_pass(false,autovar_4){var_1 = ((it=(vars_in());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = ((var_1.each{|w| @edges.add(v_1,w)})) },proc{autovar_3 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = ( _key(:vars))
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){var_1 = ((it=(vars_in());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
()
while true
autovar_12=@input;r=(it=(_or(proc{autovar_9 = ((it=(clas(Variable));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){it=( _key(:this))
 ary_1||=[];_append(ary_1,it)
()
while true
autovar_10=@input;r=(it=(_dot_());break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_10
() });next FAIL if it==FAIL;it) },proc{autovar_8 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){it=( _key(:this))
 ary_1||=[];_append(ary_1,it)
()
while true
autovar_11=@input;r=(it=(_dot_());break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_11
() });next FAIL if it==FAIL;it) },proc{autovar_7 = ((it=(clas(Exp));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){(it=(trans());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) },proc{autovar_6 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){it=( _key(:this))
...
(it=(_pass(true,autovar_5){it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it) },proc{autovar_4 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it) },proc{autovar_3 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = ( _key(:name))
(it=(_pass(false,autovar_2){it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{autovar_1 = ((it=(clas(Local));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){(it=(anything());next FAIL if it==FAIL;it)
it=( _key(:this))
...
_result_1 = ((nil))
(it=(_or(proc{autovar_7 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){name_1 = ( _key(:name))
it_1 = ( _key(:reachable))
(@reachable=it_1)
autovar_6 = ( _key(:args))
...
locals_1 = ( _key(:locals)) });next FAIL if it==FAIL;it)
_result_1 = (Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1 }]) },proc{autovar_4 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){this_1 = ( _key(:this))
()
while true
autovar_8=@input;r=(it=(_dot_());break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_8
() });next FAIL if it==FAIL;it)
_result_1 = ((@reachable[this_1] ? this_1 : Act[])) },proc{autovar_3 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){name_1 = ( _key(:name))
autovar_2 = ( _key(:expr))
(it=(_pass(false,autovar_2){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((@reachable[name_1] ? _Set(name_1,expr_1,append_1) : expr_1)) },proc{autovar_1 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){this_1 = ( _key(:this))});next FAIL if it==FAIL;it)
...
_result_1 = ((nil))
(it=(_or(proc{autovar_4 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){(it=(_lookahead{autovar_3 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){first_1 = ((it=(trans());next FAIL if it==FAIL;it))
()
while true
autovar_5=@input;r=(it=(_dot_());break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_5
() });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
()
while true
autovar_7=@input;r=autovar_2 = ((it=(clas(And));break FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){fst_1 = ((it=(trans());break FAIL if it==FAIL;it))
...
autovar_1 = ((expr_1))
(it=(_pass(false,autovar_1){_result_1 = ((it=(move(append_1,name_1));next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{_result_1 = ((it=(super());next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
...
autovar_7 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_7 = ((it=(clas(Or));next FAIL if it==FAIL;it))
...
_result_1 = (Or[ {:ary=>ary_1 }]) },proc{autovar_5 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){autovar_4 = (([]))
while true
...
ary_1 = ((autovar_4)) });next FAIL if it==FAIL;it)
_result_1 = (And[ {:ary=>ary_1,:el=>el_1 }]) },proc{autovar_2 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){var_1 = ( _key(:var))
autovar_1 = ( _key(:to))
(it=(_pass(false,autovar_1){to_1 = ((it=(move(append_1,name_1));next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
enter_1 = ( _key(:enter)) });next FAIL if it==FAIL;it)
...
_result_1 = ((nil))
autovar_4 = ((rule_1))
(it=(_pass(false,autovar_4){autovar_3 = ((it=(clas(Rule));return FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){name_1 = ( _key(:name))
args_1 = ( _key(:args))
 _key(:locals)
...
autovar_2 = ((grammar_1))
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));return FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){_result_1 = ((it=(itrans());return FAIL if it==FAIL;it))});return FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
def trans()
 autovar_1 = ((nil))
...
_result_1 = ((nil))
autovar_6 = ((grammar_1))
(it=(_pass(false,autovar_6){autovar_5 = ((it=(clas(Object));return FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){()
while true
autovar_8=@input;r=(it=(_or(proc{autovar_4 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){autovar_3 = ( _key(:rules))
(it=(_pass(false,autovar_3){autovar_2 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){()
while true
autovar_7=@input;r=autovar_1 = ((it=(clas(Rule));break FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){n_1 = ( _key(:name))
...
autovar_27 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_27 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_27){(it=(_foreign(:w ,'return',proc{name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_26 = ( _key(:rules))
(it=(_pass(false,autovar_26){_result_1 = (body_1 = ((it=(transs());next FAIL if it==FAIL;it)))});next FAIL if it==FAIL;it)
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = (("class #{name_1} < #{parent_1}\n#{body_1}\nend\n")) },proc{autovar_25 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){(@varhash=Hash.new{|h,k| h[k]={}}  )
name_1 = ( _key(:name))
autovar_24 = ( _key(:args))
(it=(_pass(false,autovar_24){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_23 = ( _key(:body))
(it=(_pass(false,autovar_23){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("def #{name_1}(#{argss_1})\n #{body_1} \nend\n")) },proc{autovar_22 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_22){(it=(_foreign(:w ,'next', proc{autovar_21 = (([]))
while true
autovar_28=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_21||=[];_append(autovar_21,it)
 break FAIL if r==FAIL
end;@input=autovar_28
_result_1 = (ors_1 = ((autovar_21)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_or(#{ors_1*","})"));next FAIL if it==FAIL;it)) },proc{autovar_20 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_20){autovar_19 = (([]))
while true
autovar_29=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_19||=[];_append(autovar_19,it)
 break FAIL if r==FAIL
end;@input=autovar_29
t_1 = ((autovar_19)) });next FAIL if it==FAIL;it)
_result_1 = (("#{t_1*"\n"} ")) },proc{autovar_18 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){(it=(_foreign(:w ,'next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_not{#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_17 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_17){t_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
_result_1 = ((pred_1 ?  failwrap("(#{t_1})||FAIL") : "(#{t_1})")) },proc{autovar_16 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_16){(it=(_foreign(:w ,'next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_lookahead{#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_15 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){(it=(anything());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = (("")) },proc{autovar_14 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){(it=(_foreign(:w ,'break', proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) } ));next FAIL if it==FAIL;it)
autovar_13 = ( _key(:o))
(it=(_pass(false,autovar_13){o_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("while true\n#{o_1}=@input;r=#{t_1}\n break FAIL if r==FAIL\nend;@input=#{o_1}")) },proc{autovar_12 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_12){autovar_11 = ((it=(clas(Object));next FAIL if it==FAIL;it))
...
_result_1 = ((it=(failwrap("_foreign(:#{name_1 } #{argss_1!=[] ? ",#{argss_1}" : "" })"));next FAIL if it==FAIL;it)) },proc{autovar_10 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_10){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
argss_1 = ((it=(args());next FAIL if it==FAIL;it)) });next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("#{name_1}(#{argss_1})"));next FAIL if it==FAIL;it)) },proc{autovar_9 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){autovar_8 = ( _key(:name))
(it=(_pass(false,autovar_8){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_7 = ( _key(:expr))
(it=(_pass(false,autovar_7){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((append_1 ? "it=(#{expr_1})\n #{name_1}||=[];_append(#{name_1},it)" : "#{name_1} = (#{expr_1})")) },proc{autovar_6 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){name_1 = ( _key(:name))
autovar_5 = ( _key(:args))
(it=(_pass(false,autovar_5){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_1 = ( _key(:vars)) });next FAIL if it==FAIL;it)
_result_1 = (("#{name_1}[#{argss_1} {#{vars_1.map{|l| ":#{l[0]}=>#{l[0]}_#{l.number}" }*","} }]")) },proc{autovar_4 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){name_1 = ( _key(:name))});next FAIL if it==FAIL;it)
_result_1 = ((" _key(:#{name_1})")) },proc{autovar_3 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){autovar_2 = ( _key(:to))
(it=(_pass(false,autovar_2){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_1 = ( _key(:var))
(it=(_pass(false,autovar_1){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
...
autovar_8 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_8 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){autovar_7 = (([]))
while true
autovar_9=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_7||=[];_append(autovar_7,it)
 break FAIL if r==FAIL
end;@input=autovar_9
a_1 = ((autovar_7)) });next FAIL if it==FAIL;it)
_result_1 = ((a_1*"")) },proc{autovar_6 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_5 = (([]))
while true
...
_result_1 = ((a_1*"")) },proc{autovar_4 = ((it=(clas(Exp));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){t_1 = ((it=(transfn());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
_result_1 = ((t_1)) },proc{autovar_3 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){t_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
_result_1 = ((t_1)) },proc{autovar_2 = ((it=(clas(Variable));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_2){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
number_1 = ( _key(:number)) });next FAIL if it==FAIL;it)
_result_1 = ((@varhash[name_1][number_1]=@varhash[name_1].size+1 if !@varhash[name_1][number_1]  ; "#{name_1}_#{@varhash[name_1][number_1]}")) },proc{autovar_1 = ((it=(clas(Local));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){name_1 = ((it=(anything());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
