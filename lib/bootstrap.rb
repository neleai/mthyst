...
name_ = ((it=(name());next FAIL if it==FAIL;it))
Key[ {:_result=>_result_,:name=>name_ }] }));return FAIL if it==FAIL;it))
_result_  
end
def collect(ors_)
 _result_ = (nil)
...
Rule[ {:_result=>_result_,:name=>name_,:it=>it_,:args=>args_,:body=>body_,:locals=>locals_ }] },proc{(it=(clas(Enter));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)});next FAIL if it==FAIL;it)
Enter[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Or));next FAIL if it==FAIL;it)
...
And[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Not));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)});next FAIL if it==FAIL;it)
Not[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Lookahead));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)});next FAIL if it==FAIL;it)
Lookahead[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Comment));next FAIL if it==FAIL;it)
...
Comment[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Many));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)
o_ = (_key(:o)) });next FAIL if it==FAIL;it)
Many[ {:_result=>_result_,:ary=>ary_,:o=>o_ }] },proc{(it=(clas(Apply));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(anything());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)
it=((it=(args());next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it) });next FAIL if it==FAIL;it)
Apply[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Set));next FAIL if it==FAIL;it)
...
Set[ {:_result=>_result_,:it=>it_,:name=>name_,:expr=>expr_,:append=>append_ }] },proc{(it=(clas(Act));next FAIL if it==FAIL;it)
(it=(_enter{ary_ = ((it=(args());next FAIL if it==FAIL;it))
pred_ = (_key(:pred)) });next FAIL if it==FAIL;it)
Act[ {:_result=>_result_,:ary=>ary_,:pred=>pred_ }] },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{name_ = (_key(:name))
it_ = (_key(:args))
(it=(_pass(it_){args_ = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
it_ = (_key(:vars))
(it=(_pass(it_){vars_ = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
Resul[ {:_result=>_result_,:name=>name_,:it=>it_,:args=>args_,:vars=>vars_ }] },proc{(it=(clas(Foreign));next FAIL if it==FAIL;it)
...
Foreign[ {:_result=>_result_,:klas=>klas_,:it=>it_,:args=>args_ }] },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
...
Args[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Key));next FAIL if it==FAIL;it)
(it=(_enter{name_ = (_key(:name))});next FAIL if it==FAIL;it)
Key[ {:_result=>_result_,:name=>name_ }] },proc{(it=(clas(Pass));next FAIL if it==FAIL;it)
...
Pass[ {:_result=>_result_,:it=>it_,:to=>to_,:var=>var_ }] }));return FAIL if it==FAIL;it))
_result_  
end
def transfn()
 _result_ = (nil)
...
Rule[ {:_result=>_result_,:argnames=>argnames_,:name=>name_,:it=>it_,:args=>args_,:body=>body_,:locals=>locals_ }] },proc{(it=(clas(Or));next FAIL if it==FAIL;it)
(it=(_enter{l=@locals;r=[] 
avar1 = ([])
while true
avar2=@input;r=it=(@locals=l.clone
...
Or[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{name_ = (_key(:name))
it_ = (_key(:args))
(it=(_pass(it_){args_ = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_ = (@locals.select{|a| !a.is_a? Autovar}.uniq) });next FAIL if it==FAIL;it)
Resul[ {:_result=>_result_,:name=>name_,:it=>it_,:args=>args_,:vars=>vars_ }] },proc{(it=(clas(Set));next FAIL if it==FAIL;it)
(it=(_enter{name_ = (_key(:name))
@locals<<name_
it_ = (_key(:expr))
(it=(_pass(it_){expr_ = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_ = (_key(:append)) });next FAIL if it==FAIL;it)
Set[ {:_result=>_result_,:name=>name_,:it=>it_,:expr=>expr_,:append=>append_ }] },proc{(it=(super());next FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
_result_  
end
def addargs()
 result_ = (nil)
...
append_ = (_key(:append))
it_ = (_key(:expr))
(it=(_pass(it_){(it=(move(append_,name_));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{(it=(super());next FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
_result_  
end
def move(tp_,name_)
 to_ = (nil)
...
(it=(_enter{it=((it=(move(tp_,name_));next FAIL if it==FAIL;it))
 ary_||=[];_append(ary_,it)});next FAIL if it==FAIL;it)
Enter[ {:_result=>_result_,:ary=>ary_ }] },proc{(it=(clas(Pass));next FAIL if it==FAIL;it)
...
Pass[ {:_result=>_result_,:var=>var_,:it=>it_,:to=>to_ }] },proc{it_ = ((it=(anything());next FAIL if it==FAIL;it))
