...
autovar_2 = (([]))
while true
autovar_7=@input;r=(it=(_or(proc{autovar_3 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
...
(@variables; self['body']=Seq[{:ary=>(( self['locals']- self['args']).map{|v| Set[{:name=>v,:expr=>Act["nil"],:append=>false}]}+[ self['body']]) }])
