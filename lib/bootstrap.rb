...
autovar_6 = (([]))
while true
autovar_7=@input;r=(@locals=l_1.clone)
...
_result_1 = (Or.create( {:ary=>ary_1 })) },proc{autovar_8 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){name_1 = ( self['name'])
autovar_2 = ( self['args'])
(it=(_pass(false,autovar_2){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_1 = ((@locals.select{|a| a[0]!= "autovar"&&a!="_result"&&a!="it"}.uniq)) });next FAIL if it==FAIL;it)
_result_1 = (Result.create( {:name=>name_1,:args=>args_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1 })) },proc{autovar_9 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){name_1 = ( self['name'])
(@locals<<name_1)
autovar_3 = ( self['expr'])
...
(it=(_pass(true,autovar_6){it=(it=((it=(root());next FAIL if it==FAIL;it))
 rules_1||=[];_append(rules_1,it))
 autovar_5||=[];_append(autovar_5,it)});break FAIL if it==FAIL;it) 
 break FAIL if r==FAIL
end;@input=autovar_7
(autovar_5) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
( self['rules']=rules_1)
it=( self['this'])
...
autovar_11 = ((nil))
autovar_12 = ((nil))
(it=(_or(proc{autovar_13 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_13){(it=(rw('return',proc{name_1 = ( self['name'])
parent_1 = ( self['parent'])
...
_result_1 = (("class #{name_1} < #{parent_1}\n#{body_1}\nend\n")) },proc{autovar_14 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){(@varhash=Hash.new{|h,k| h[k]={}}  )
name_1 = ( self['name'])
autovar_3 = ( self['args'])
...
_result_1 = (("def #{name_1}(#{argss_1})\n #{body_1} \nend\n")) },proc{autovar_15 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){(it=(rw('next', proc{autovar_16 = (([]))
while true
autovar_17=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_16||=[];_append(autovar_16,it)
 break FAIL if r==FAIL
end;@input=autovar_17
_result_1 = (ors_1 = ((autovar_16)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_or(#{ors_1*","})"));next FAIL if it==FAIL;it)) },proc{autovar_18 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){autovar_19 = (([]))
while true
...
_result_1 = (("#{t_1*"\n"} ")) },proc{autovar_21 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){t_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( self['pred']) });next FAIL if it==FAIL;it)
_result_1 = ((pred_1 ?  failwrap("(#{t_1})||FAIL") : "(#{t_1})")) },proc{autovar_22 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_22){neg_1 = ( self['neg'])
(it=(rw('next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_lookahead(#{neg_1}){#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_23 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){c_1 = ((it=(anything());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
_result_1 = (("")) },proc{autovar_24 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_24){(it=(rw('break', proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) } ));next FAIL if it==FAIL;it)
autovar_5 = ( self['o'])
(it=(_pass(false,autovar_5){o_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("while true\n#{o_1}=@input;r=#{t_1}\n break FAIL if r==FAIL\nend;@input=#{o_1}")) },proc{autovar_25 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){autovar_26 = ((it=(clas(Array));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_26){klas_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
_result_1 = ((it=(failwrap("_foreign(:#{name_1 } #{argss_1!=[] ? ",#{argss_1}" : "" })"));next FAIL if it==FAIL;it)) },proc{autovar_27 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_27){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
argss_1 = ((it=(args());next FAIL if it==FAIL;it)) });next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("#{name_1}(#{argss_1})"));next FAIL if it==FAIL;it)) },proc{autovar_28 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){autovar_6 = ( self['name'])
(it=(_pass(false,autovar_6){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_7 = ( self['expr'])
(it=(_pass(false,autovar_7){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( self['append']) });next FAIL if it==FAIL;it)
_result_1 = ((append_1 ? "it=(#{expr_1})\n #{name_1}||=[];_append(#{name_1},it)" : "#{name_1} = (#{expr_1})")) },proc{autovar_29 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_29){name_1 = ( self['name'])
autovar_8 = ( self['args'])
(it=(_pass(false,autovar_8){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_1 = ( self['vars']) });next FAIL if it==FAIL;it)
_result_1 = (("#{name_1}.create(#{argss_1} {#{vars_1.map{|l| ":#{l[0]}=>#{l[0]}_#{l.number}" }*","} })")) },proc{autovar_30 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_30){name_1 = ( self['name'])});next FAIL if it==FAIL;it)
_result_1 = ((" self['#{name_1}']")) },proc{autovar_31 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_31){(it=(rw('next',proc{autovar_11 = ( self['to'])
(it=(_pass(false,autovar_11){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_12 = ( self['var'])
(it=(_pass(false,autovar_12){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
