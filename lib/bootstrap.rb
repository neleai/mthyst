...
(it=(_pass(autovar_13){rules_1 = ((it=(transs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
(it=(_pass(autovar_12){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_11 = ( _key(:body))
(it=(_pass(autovar_11){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
...
(it=(_enter{autovar_8 = (([]))
while true
autovar_16=@input;r=it=((it=(anything());break FAIL if it==FAIL;it))
...
(it=(_enter{autovar_7 = ( _key(:name))
(it=(_pass(autovar_7){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_6 = ( _key(:expr))
(it=(_pass(autovar_6){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
...
_result_1 = (Act[ {:ary=>ary_1,:pred=>pred_1 }]) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_5 = ( _key(:args))
(it=(_pass(autovar_5){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_4 = ( _key(:vars))
(it=(_pass(autovar_4){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (Result[ {:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{autovar_3 = (([]))
while true
autovar_17=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_3||=[];_append(autovar_3,it)
 break FAIL if r==FAIL
...
(it=(_enter{name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_14 = ( _key(:rules))
(it=(_pass(autovar_14){(it=(clas(Object));next FAIL if it==FAIL;it)
(it=(_enter{autovar_13 = (([]))
while true
autovar_15=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_13||=[];_append(autovar_13,it)
 break FAIL if r==FAIL
end;@input=autovar_15
rules_1 = ((autovar_13)) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
(it=(_enter{ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
v_1 = (Act[ {:v=>v_1,:ary=>ary_1,:pred=>pred_1 }]) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_5 = ( _key(:args))
(it=(_pass(autovar_5){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_4 = ( _key(:vars))
(it=(_pass(autovar_4){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
v_1 = (Result[ {:v=>v_1,:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{autovar_3 = (([]))
while true
...
v_1 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{(it=(_or(proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{autovar_2 = (([]))
while true
autovar_3=@input;r=it=((it=(arg());break FAIL if it==FAIL;it))
 autovar_2||=[];_append(autovar_2,it)
...
ary_1 = ((autovar_2)) });next FAIL if it==FAIL;it)
v_1 = (Args[ {:v=>v_1,:ary=>ary_1 }]) },proc{(it=(clas(Strin));next FAIL if it==FAIL;it)
(it=(_enter{autovar_1 = (([]))
while true
autovar_4=@input;r=(it=(_or(proc{it=((it=(char());next FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)},proc{it=((it=(arg());next FAIL if it==FAIL;it))
...
ary_1 = ((autovar_1)) });next FAIL if it==FAIL;it)
v_1 = (Strin[ {:v=>v_1,:ary=>ary_1 }]) },proc{(it=(clas(Exp));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
...
_result_1 = (Or[ {:l=>l_1,:r=>r_1,:ary=>ary_1 }]) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_2 = ( _key(:args))
...
_result_1 = ((var_1.each{|w| @edges.add(v_1,w)})) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
...
(it=(_enter{(it=(trans());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
(it=(_enter{it=( _key(:this))
...
(it=(_pass(autovar_1){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((@reachable[name_1] ? _Set(name_1,expr_1,append_1) : expr_1)) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
...
parent_1 = ( _key(:parent))
autovar_11 = ( _key(:rules))
(it=(_pass(autovar_11){_result_1 = (body_1 = ((it=(transs());next FAIL if it==FAIL;it)))});next FAIL if it==FAIL;it)
...
name_1 = ( _key(:name))
autovar_10 = ( _key(:args))
(it=(_pass(autovar_10){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_9 = ( _key(:body))
(it=(_pass(autovar_9){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
t_1 = ((autovar_7)) });next FAIL if it==FAIL;it)
...
autovar_6 = ( _key(:o))
(it=(_pass(autovar_6){o_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
...
_result_1 = ((it=(failwrap("#{name_1}(#{argss_1})"));next FAIL if it==FAIL;it)) },proc{(it=(clas(Set));next FAIL if it==FAIL;it)
...
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((append_1 ? "it=(#{expr_1})\n #{name_1}||=[];_append(#{name_1},it)" : "#{name_1} = (#{expr_1})")) },proc{(it=(clas(Result));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ( _key(:name))
autovar_3 = ( _key(:args))
