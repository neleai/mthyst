...
_result_1 = ((_Pred(expr_1))) },proc{(it=(_or(proc{neg_1 = ((it=(token("&"));next FAIL if it==FAIL;it))},proc{neg_1 = ((it=(token("~"));next FAIL if it==FAIL;it))}));next FAIL if it==FAIL;it)
m_1 = ((it=(prefixed());next FAIL if it==FAIL;it))
_result_1 = ((Lookahead[m_1,neg_1=="~"])) },proc{from_1 = ((it=(modifier());next FAIL if it==FAIL;it))
()
while true
...
_result_1 = (Result.create( {:name=>name_1,:args=>args_1 })) },proc{(it=(token("@"));next FAIL if it==FAIL;it)
name_1 = ((it=(name());next FAIL if it==FAIL;it))
...
_result_1 = (Grammar.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_15 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
...
_result_1 = (Rule.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_16 = ((it=(clas(Or));next FAIL if it==FAIL;it))
...
_result_1 = (Or.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_18 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
...
_result_1 = (Seq.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_20 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_20){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
neg_1 = ( self['neg']) });next FAIL if it==FAIL;it)
_result_1 = (Lookahead.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_21 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){autovar_6 = (([]))
while true
autovar_22=@input;r=it=((it=(anything());break FAIL if it==FAIL;it))
 autovar_6||=[];_append(autovar_6,it)
 break FAIL if r==FAIL
end;@input=autovar_22
ary_1 = ((autovar_6)) });next FAIL if it==FAIL;it)
_result_1 = (Comment.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_23 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
o_1 = ( self['o']) });next FAIL if it==FAIL;it)
_result_1 = (Many.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_24 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_24){it=((it=(anything());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
it=((it=(args());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it) });next FAIL if it==FAIL;it)
_result_1 = (Apply.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_25 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){autovar_7 = ( self['name'])
...
_result_1 = (Set.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_26 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_26){ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( self['pred']) });next FAIL if it==FAIL;it)
_result_1 = (Act.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_27 = ((it=(clas(Result));next FAIL if it==FAIL;it))
...
_result_1 = (Result.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_28 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){autovar_11 = (([]))
while true
...
_result_1 = (Args.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_30 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_30){name_1 = ( self['name'])});next FAIL if it==FAIL;it)
_result_1 = (Key.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_31 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_31){autovar_12 = ( self['to'])
...
_result_1 = (Pass.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) }));return FAIL if it==FAIL;it)
(_result_1)  
end
def transfn()
 _result_1 = ((nil))
...
_result_1 = (Args.create( {:ary=>ary_1 })) },proc{autovar_5 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
...
_result_1 = ((ary_1[0])) },proc{_result_1 = (Or.create( {:ary=>ary_1 }))}));next FAIL if it==FAIL;it) },proc{autovar_5 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_5){autovar_2 = (([]))
while true
...
_result_1 = (Rule.create( {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:l=>l_1,:r=>r_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1,:append=>append_1 })) },proc{autovar_5 = ((it=(clas(Or));next FAIL if it==FAIL;it))
...
_result_1 = (Or.create( {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:l=>l_1,:r=>r_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1,:append=>append_1 })) },proc{autovar_7 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){name_1 = ( self['name'])
autovar_2 = ( self['args'])
(it=(_pass(false,autovar_2){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_1 = ((@locals.select{|a| a[0]!= "autovar"&&a!="_result"&&a!="it"}.uniq)) });next FAIL if it==FAIL;it)
_result_1 = (Result.create( {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:l=>l_1,:r=>r_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1,:append=>append_1 })) },proc{autovar_8 = ((it=(clas(Set));next FAIL if it==FAIL;it))
...
append_1 = ( self['append']) });next FAIL if it==FAIL;it)
_result_1 = (Set.create( {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:l=>l_1,:r=>r_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1,:append=>append_1 })) },proc{_result_1 = ((it=(super());next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
...
_result_1 = (Rule.create( {:name=>name_1,:locals=>locals_1,:args=>args_1,:body=>body_1,:vars=>vars_1 })) },proc{autovar_4 = ((it=(clas(Result));next FAIL if it==FAIL;it))
...
_result_1 = (Result.create( {:name=>name_1,:locals=>locals_1,:args=>args_1,:body=>body_1,:vars=>vars_1 })) },proc{_result_1 = ((it=(super());next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
def arg()
 name_1 = ((nil))
...
_result_1 = (Rule.create( {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:reachable=>reachable_1,:var=>var_1,:this=>this_1,:v=>v_1 })) },proc{autovar_9 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
...
locals_1 = ( self['locals']) });next FAIL if it==FAIL;it)
_result_1 = (Rule.create( {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:this=>this_1,:expr=>expr_1,:append=>append_1 })) },proc{autovar_5 = ((it=(clas(Act));next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_2){(it=(_lookahead(false){autovar_3 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
...
ary_1 = ((autovar_1)) });next FAIL if it==FAIL;it)
_result_1 = (Or.create( {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 })) },proc{autovar_7 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
...
_result_1 = (Seq.create( {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 })) },proc{autovar_9 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
...
enter_1 = ( self['enter']) });next FAIL if it==FAIL;it)
_result_1 = (Pass.create( {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 })) },proc{it_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_28){(it=(rw('next',proc{autovar_10 = ( self['to'])
