...
autovar_2 = (("{#{s_1*""}}"))
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){_result_1 = ((it=(inlineHostExpr());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
...
(it=(_pass(true,autovar_2){fst_1 = ((it=(trans());next FAIL if it==FAIL;it))
...
_result_1 = ((nil))
autovar_4 = ((rule_1))
(it=(_pass(false,autovar_4){autovar_3 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){name_1 = ( _key(:name))
args_1 = ( _key(:args))
 _key(:locals)
body_1 = ( _key(:body)) });next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(@result=autovar;@name=name_1;@args=args_1;@body=Set[{:name=>@result ,:expr=>body_1}] )
autovar_2 = ((grammar_1))
(it=(_pass(false,autovar_2){autovar_1 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){_result_1 = ((it=(itrans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
def trans()
 autovar_1 = ((nil))
...
_result_1 = ((nil))
autovar_6 = ((grammar_1))
(it=(_pass(false,autovar_6){autovar_5 = ((it=(clas(Object));next FAIL if it==FAIL;it))
...
rule_1 = ( _key(:this)) },proc{(it=(empty());next FAIL if it==FAIL;it)}));next FAIL if it==FAIL;it) });break FAIL if it==FAIL;it) 
 break FAIL if r==FAIL
end;@input=autovar_7
...
(it=(_pass(true,autovar_27){(it=(rw('return',proc{name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
...
(it=(_pass(true,autovar_22){(it=(rw('next', proc{autovar_21 = (([]))
while true
...
(it=(_pass(true,autovar_14){(it=(rw('break', proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
...
(it=(_pass(true,autovar_12){autovar_11 = ((it=(clas(Array));next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_3){(it=(rw('next',proc{autovar_2 = ( _key(:to))
(it=(_pass(false,autovar_2){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_1 = ( _key(:var))
(it=(_pass(false,autovar_1){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
_result_1 = (enter_1 = ( _key(:enter)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
