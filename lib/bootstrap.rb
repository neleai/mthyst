...
_result_1 = (Resul[ {:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{autovar_3 = (([]))
while true
...
autovar_4 = ( _key(:vars))
(it=(_pass(autovar_4){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
v_1 = (Resul[ {:v=>v_1,:name=>name_1,:args=>args_1,:vars=>vars_1 }]) },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{autovar_3 = (([]))
while true
