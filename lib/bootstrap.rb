...
( self['body']=Seq[{:ary=>(( self['locals']- self['args']).map{|v| Set[{:name=>v,:expr=>Act["nil"],:append=>false}]}+[ self['body']]) }])
...
(@result=autovar_2;@name=name_1;@args=args_1;@body=Set[{:name=>@result ,:expr=>body_1}] )
autovar_2 = ((grammar_1))
