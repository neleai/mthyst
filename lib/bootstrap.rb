...
def _body(body)
	And[_Set("_result",body), _Act(_Variable("_result"))]
end
...
it=((it=(anything());next FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
while true
autovar_2=@input;r=(it=(_not{(it=(seq("amethyst"));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
it_1 = ((autovar_1))
it=((it_1*""))
 autovar_3||=[];_append(autovar_3,it) },proc{it=((it=(grammar());next FAIL if it==FAIL;it))
...
autovar_5 = (([]))
while true
autovar_6=@input;r=(it=(_or(proc{(it=(seq("=>"));next FAIL if it==FAIL;it)
...
it=(from_1 = ((it=(binding(from_1));break FAIL if it==FAIL;it)))
 autovar_1||=[];_append(autovar_1,it) 
 break FAIL if r==FAIL
end;@input=autovar_2
it=((autovar_1))
 autovar_5||=[];_append(autovar_5,it) },proc{(it=(seq("["));next FAIL if it==FAIL;it)
...
autovar_3 = (([]))
while true
autovar_4=@input;r=(it=(_not{(it=(space());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
it=(from_1 = ((it=(binding(from_1));break FAIL if it==FAIL;it)))
...
while true
autovar_2=@input;r=(it=(_not{(it=(space());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
it=(t_1 = ((it=(binding(t_1));break FAIL if it==FAIL;it)))
 autovar_1||=[];_append(autovar_1,it) 
 break FAIL if r==FAIL
end;@input=autovar_2
(autovar_1)
...
autovar_1 = (([]))
while true
autovar_2=@input;r=(it=(_not{(it=(seq("\""));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
autovar_2 = (([]))
while true
autovar_3=@input;r=autovar_1 = ((it=(clas(Args));break FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
it=(it=((_Variable(name_1) ))
...
it=((it=(regch(/[a-zA-Z_]/));next FAIL if it==FAIL;it))
 autovar_5||=[];_append(autovar_5,it)
while true
autovar_6=@input;r=it=((it=(regch(/[a-zA-Z_]/));break FAIL if it==FAIL;it))
 autovar_5||=[];_append(autovar_5,it)
 break FAIL if r==FAIL
end;@input=autovar_6
it=((autovar_5))
...
autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(_());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_2
(autovar_1)
...
autovar_1 = (([]))
while true
autovar_2=@input;r=(it=(_not{(it=(endline());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
it=((it=(anything());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it) 
 break FAIL if r==FAIL
end;@input=autovar_2
...
(it=(_pass(true,autovar_3){_result_1 = ((it=(inlineHostExpr());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
(_result_1)  
end
...
(it=(_pass(true,autovar_5){name_1 = ( _key(:name))
autovar_3 = ( _key(:args))
...
_result_1 = (Rule[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_8 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){autovar_6 = (([]))
while true
autovar_7=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_6||=[];_append(autovar_6,it)
 break FAIL if r==FAIL
end;@input=autovar_7
ary_1 = ((autovar_6)) });next FAIL if it==FAIL;it)
_result_1 = (Or[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_11 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_11){autovar_9 = (([]))
while true
autovar_10=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_9||=[];_append(autovar_9,it)
 break FAIL if r==FAIL
end;@input=autovar_10
ary_1 = ((autovar_9)) });next FAIL if it==FAIL;it)
_result_1 = (And[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_12 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_12){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (Not[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_13 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_13){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (Lookahead[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_16 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_16){autovar_14 = (([]))
while true
...
_result_1 = (Comment[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_17 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_17){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
o_1 = ( _key(:o)) });next FAIL if it==FAIL;it)
_result_1 = (Many[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_18 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){it=((it=(anything());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
it=((it=(args());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it) });next FAIL if it==FAIL;it)
_result_1 = (Apply[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_21 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){autovar_19 = ( _key(:name))
(it=(_pass(false,autovar_19){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_20 = ( _key(:expr))
...
_result_1 = (Set[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_22 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_22){ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
_result_1 = (Act[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_25 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){name_1 = ( _key(:name))
autovar_23 = ( _key(:args))
(it=(_pass(false,autovar_23){args_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_24 = ( _key(:vars))
(it=(_pass(false,autovar_24){vars_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (Result[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_28 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){autovar_26 = (([]))
while true
...
_result_1 = (Args[ {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 }]) },proc{autovar_29 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_29){name_1 = ( _key(:name))});next FAIL if it==FAIL;it)
...
(it=(_pass(true,autovar_32){autovar_30 = ( _key(:to))
...
autovar_3 = ((nil))
_result_1 = ((nil))
autovar_3 = ((it=(anything());return FAIL if it==FAIL;it))
...
_result_1 = (Args[ {:ary=>ary_1 }]) },proc{autovar_6 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_4 = (([]))
while true
autovar_5=@input;r=(it=(_or(proc{it=((it=(char());next FAIL if it==FAIL;it))
 autovar_4||=[];_append(autovar_4,it)},proc{it=((it=(arg());next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_3){autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_2
ary_1 = ((autovar_1)) });next FAIL if it==FAIL;it)
...
_result_1 = ((ary_1[0])) },proc{_result_1 = (Or[ {:ary=>ary_1 }])}));next FAIL if it==FAIL;it) },proc{autovar_6 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_4 = (([]))
while true
autovar_5=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_4||=[];_append(autovar_4,it)
 break FAIL if r==FAIL
end;@input=autovar_5
ary_1 = ((autovar_4)) });next FAIL if it==FAIL;it)
...
autovar_3 = (([]))
while true
autovar_4=@input;r=(@locals=l_1.clone)
it=((it=(trans());break FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
it=((r_1=(r_1+@locals).uniq))
 autovar_3||=[];_append(autovar_3,it) 
 break FAIL if r==FAIL
end;@input=autovar_4
(autovar_3)
...
_result_1 = (Result[ {:argnames=>argnames_1,:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:l=>l_1,:r=>r_1,:ary=>ary_1,:vars=>vars_1,:expr=>expr_1,:append=>append_1 }]) },proc{autovar_9 = ((it=(clas(Set));next FAIL if it==FAIL;it))
...
(@variables={}; @locals=locals_1 ;(locals_1+ _key(:args)).each{|v| @variables[v[0]]=true})
args_1 = ( _key(:args))
autovar_1 = ( _key(:body))
(it=(_pass(false,autovar_1){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
(body_1=And[{:ary=>(( _key(:locals)- _key(:args)).uniq.map{|v| Set[{:name=>v,:expr=>Act["nil"],:append=>false}]}+[body_1]) }]) });next FAIL if it==FAIL;it)
...
(it=(_pass(true,autovar_7){autovar_5 = ( _key(:var))
...
(it=(_pass(true,autovar_8){this_1 = ( _key(:this))
...
(it=(_pass(true,autovar_14){autovar_13 = ( _key(:vars))
...
autovar_14 = (([]))
while true
autovar_15=@input;r=(it=(_or(proc{autovar_3 = ((it=(clas(Variable));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){it=( _key(:this))
 ary_1||=[];_append(ary_1,it)
autovar_1 = (([]))
while true
...
it=((autovar_1))
 autovar_14||=[];_append(autovar_14,it) });next FAIL if it==FAIL;it) },proc{autovar_6 = ((it=(clas(Act));next FAIL if it==FAIL;it))
...
it=((autovar_4))
 autovar_14||=[];_append(autovar_14,it) });next FAIL if it==FAIL;it) },proc{autovar_7 = ((it=(clas(Exp));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){it=((it=(trans());next FAIL if it==FAIL;it))
 autovar_14||=[];_append(autovar_14,it)});next FAIL if it==FAIL;it) },proc{autovar_8 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){it=(it=( _key(:this))
 ary_1||=[];_append(ary_1,it))
 autovar_14||=[];_append(autovar_14,it)});next FAIL if it==FAIL;it) },proc{autovar_9 = ((it=(clas(Strin));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_14||=[];_append(autovar_14,it)});next FAIL if it==FAIL;it) },proc{autovar_10 = ((it=(clas(Args));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_10){it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_14||=[];_append(autovar_14,it)});next FAIL if it==FAIL;it) },proc{autovar_12 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_12){autovar_11 = ( _key(:name))
(it=(_pass(false,autovar_11){it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_14||=[];_append(autovar_14,it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{autovar_13 = ((it=(clas(Local));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_13){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
it=(it=( _key(:this))
 ary_1||=[];_append(ary_1,it))
 autovar_14||=[];_append(autovar_14,it) });next FAIL if it==FAIL;it) },proc{it=((it=(anything());next FAIL if it==FAIL;it))
 autovar_14||=[];_append(autovar_14,it)}));break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_15
(autovar_14)
_result_1 = ((ary_1))
...
locals_1 = ( _key(:locals)) });next FAIL if it==FAIL;it)
_result_1 = (Rule[ {:name=>name_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:this=>this_1,:expr=>expr_1,:append=>append_1 }]) },proc{autovar_6 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){this_1 = ( _key(:this))
autovar_4 = (([]))
while true
autovar_5=@input;r=it=((it=(anything());break FAIL if it==FAIL;it))
 autovar_4||=[];_append(autovar_4,it)
...
(autovar_4) });next FAIL if it==FAIL;it)
_result_1 = ((@reachable[this_1] ? this_1 : Act[])) },proc{autovar_8 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_8){name_1 = ( _key(:name))
autovar_7 = ( _key(:expr))
(it=(_pass(false,autovar_7){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((@reachable[name_1] ? _Set(name_1,expr_1,append_1) : expr_1)) },proc{autovar_9 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){this_1 = ( _key(:this))});next FAIL if it==FAIL;it)
...
autovar_9 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_9 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){(it=(_lookahead{autovar_3 = ((it=(clas(And));next FAIL if it==FAIL;it))
...
(autovar_1) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
autovar_7 = (([]))
while true
autovar_8=@input;r=autovar_6 = ((it=(clas(And));break FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){fst_1 = ((it=(trans());next FAIL if it==FAIL;it))
...
(it=(_pass(true,autovar_3){autovar_1 = (([]))
while true
autovar_2=@input;r=it=((it=(move(append_1,name_1));break FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)
 break FAIL if r==FAIL
end;@input=autovar_2
ary_1 = ((autovar_1)) });next FAIL if it==FAIL;it)
_result_1 = (Or[ {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 }]) },proc{autovar_7 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){autovar_5 = (([]))
while true
...
autovar_4 = ((el_1))
(it=(_pass(false,autovar_4){it=((it=(move(append_1,name_1));next FAIL if it==FAIL;it))
 autovar_5||=[];_append(autovar_5,it)});next FAIL if it==FAIL;it) },proc{it=((el_1))
 autovar_5||=[];_append(autovar_5,it)}));break FAIL if it==FAIL;it) 
 break FAIL if r==FAIL
end;@input=autovar_6
ary_1 = ((autovar_5)) });next FAIL if it==FAIL;it)
_result_1 = (And[ {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 }]) },proc{autovar_9 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){var_1 = ( _key(:var))
autovar_8 = ( _key(:to))
(it=(_pass(false,autovar_8){to_1 = ((it=(move(append_1,name_1));next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
enter_1 = ( _key(:enter)) });next FAIL if it==FAIL;it)
...
autovar_3 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_3 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
autovar_10 = ((nil))
_result_1 = ((nil))
autovar_10 = ((grammar_1))
(it=(_pass(false,autovar_10){autovar_9 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){autovar_7 = (([]))
while true
autovar_8=@input;r=(it=(_or(proc{autovar_6 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){autovar_5 = ( _key(:rules))
(it=(_pass(false,autovar_5){autovar_4 = ((it=(anything());next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_4){autovar_2 = (([]))
while true
autovar_3=@input;r=autovar_1 = ((it=(clas(Rule));break FAIL if it==FAIL;it))
(it=(_pass(true,autovar_1){n_1 = ( _key(:name))
(it=(_or(proc{(it=((n_1==name_1)||FAIL);next FAIL if it==FAIL;it)
it=(rule_1 = ( _key(:this)))
 autovar_2||=[];_append(autovar_2,it) },proc{it=((it=(empty());next FAIL if it==FAIL;it))
 autovar_2||=[];_append(autovar_2,it)}));next FAIL if it==FAIL;it) });break FAIL if it==FAIL;it) 
 break FAIL if r==FAIL
end;@input=autovar_3
it=((autovar_2))
 autovar_7||=[];_append(autovar_7,it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{it=((it=(anything());next FAIL if it==FAIL;it))
 autovar_7||=[];_append(autovar_7,it)}));break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_8
(autovar_7) });next FAIL if it==FAIL;it) });return FAIL if it==FAIL;it)
...
autovar_33 = ((nil))
autovar_34 = ((nil))
(it=(_or(proc{autovar_3 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_3){(it=(rw('return',proc{name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_2 = ( _key(:rules))
(it=(_pass(false,autovar_2){_result_1 = (body_1 = ((it=(transs());next FAIL if it==FAIL;it)))});next FAIL if it==FAIL;it)
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = (("class #{name_1} < #{parent_1}\n#{body_1}\nend\n")) },proc{autovar_6 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_6){(@varhash=Hash.new{|h,k| h[k]={}}  )
name_1 = ( _key(:name))
autovar_4 = ( _key(:args))
(it=(_pass(false,autovar_4){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_5 = ( _key(:body))
(it=(_pass(false,autovar_5){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("def #{name_1}(#{argss_1})\n #{body_1} \nend\n")) },proc{autovar_11 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_11){(it=(rw('next', proc{autovar_9 = (([]))
while true
autovar_10=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_9||=[];_append(autovar_9,it)
 break FAIL if r==FAIL
end;@input=autovar_10
_result_1 = (ors_1 = ((autovar_9)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_or(#{ors_1*","})"));next FAIL if it==FAIL;it)) },proc{autovar_14 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){autovar_12 = (([]))
while true
autovar_13=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_12||=[];_append(autovar_12,it)
 break FAIL if r==FAIL
end;@input=autovar_13
t_1 = ((autovar_12)) });next FAIL if it==FAIL;it)
_result_1 = (("#{t_1*"\n"} ")) },proc{autovar_15 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){(it=(rw('next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_not{#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_16 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_16){t_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
_result_1 = ((pred_1 ?  failwrap("(#{t_1})||FAIL") : "(#{t_1})")) },proc{autovar_17 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_17){(it=(rw('next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_lookahead{#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_18 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){c_1 = ((it=(anything());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
_result_1 = (("")) },proc{autovar_20 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_20){(it=(rw('break', proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) } ));next FAIL if it==FAIL;it)
autovar_19 = ( _key(:o))
(it=(_pass(false,autovar_19){o_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("while true\n#{o_1}=@input;r=#{t_1}\n break FAIL if r==FAIL\nend;@input=#{o_1}")) },proc{autovar_22 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_22){autovar_21 = ((it=(clas(Array));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_21){klas_1 = ((it=(anything());next FAIL if it==FAIL;it))
...
_result_1 = ((it=(failwrap("_foreign(:#{name_1 } #{argss_1!=[] ? ",#{argss}" : "" })"));next FAIL if it==FAIL;it)) },proc{autovar_23 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
argss_1 = ((it=(args());next FAIL if it==FAIL;it)) });next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("#{name_1}(#{argss_1})"));next FAIL if it==FAIL;it)) },proc{autovar_26 = ((it=(clas(Set));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_26){autovar_24 = ( _key(:name))
(it=(_pass(false,autovar_24){name_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_25 = ( _key(:expr))
(it=(_pass(false,autovar_25){expr_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
append_1 = ( _key(:append)) });next FAIL if it==FAIL;it)
_result_1 = ((append_1 ? "it=(#{expr_1})\n #{name_1}||=[];_append(#{name_1},it)" : "#{name_1} = (#{expr_1})")) },proc{autovar_28 = ((it=(clas(Result));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_28){name_1 = ( _key(:name))
autovar_27 = ( _key(:args))
(it=(_pass(false,autovar_27){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
vars_1 = ( _key(:vars)) });next FAIL if it==FAIL;it)
_result_1 = (("#{name_1}[#{argss_1} {#{vars_1.map{|l| ":#{l[0]}=>#{l[0]}_#{l.number}" }*","} }]")) },proc{autovar_29 = ((it=(clas(Key));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_29){name_1 = ( _key(:name))});next FAIL if it==FAIL;it)
_result_1 = ((" _key(:#{name_1})")) },proc{autovar_34 = ((it=(clas(Pass));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_34){(it=(rw('next',proc{autovar_32 = ( _key(:to))
(it=(_pass(false,autovar_32){to_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_33 = ( _key(:var))
(it=(_pass(false,autovar_33){var_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
...
a_1 = ((autovar_4)) });next FAIL if it==FAIL;it)
...
_result_1 = ((t_1)) },proc{autovar_9 = ((it=(clas(Variable));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){name_1 = ((it=(anything());next FAIL if it==FAIL;it))
number_1 = ( _key(:number)) });next FAIL if it==FAIL;it)
_result_1 = ((@varhash[name_1][number_1]=@varhash[name_1].size+1 if !@varhash[name_1][number_1]  ; "#{name_1}_#{@varhash[name_1][number_1]}")) },proc{autovar_10 = ((it=(clas(Local));next FAIL if it==FAIL;it))
