...
_result_1 = ((Lookahead[m_1,neg_1=="~"])) },proc{(it=(_or(proc{from_1 = ((it=(modifier());next FAIL if it==FAIL;it))},proc{(it=(_lookahead(false){(it=(_or(proc{(it=(token(":"));next FAIL if it==FAIL;it)},proc{(it=(token("["));next FAIL if it==FAIL;it)}));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
...
from_1 = ((_Set(name_1,from_1,append_1))) },proc{(it=(_lookahead(true){(it=(space());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
(it=(token(":"));next FAIL if it==FAIL;it)
