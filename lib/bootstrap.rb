...
def choice()
 ary_1 = ((nil))
_result_1 = ((nil))
ary_1 = ((it=(listOf('sequence',proc{(it=(token("|"));return FAIL if it==FAIL;it)}));return FAIL if it==FAIL;it))
...
autovar_2 = (([]))
while true
autovar_3=@input;r=(it=(_not{(it=(space());next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
...
(it=(seq("`"));next FAIL if it==FAIL;it)
_result_1 = ((Exp[e_1])) },proc{_result_1 = ((it=(_args('(',')'));next FAIL if it==FAIL;it))},proc{_result_1 = ((it=(_args('[',']'));next FAIL if it==FAIL;it))},proc{_result_1 = ((it=(_args('{','}'));next FAIL if it==FAIL;it))},proc{(it=(seq("\""));next FAIL if it==FAIL;it)
autovar_4 = (([]))
while true
autovar_5=@input;r=(it=(_not{(it=(seq("\""));next FAIL if it==FAIL;it)});break FAIL if it==FAIL;it)
it=((it=(eChar());break FAIL if it==FAIL;it))
...
_result_1 = ((ExpKey[k_1] )) },proc{_result_1 = ((it=(regch(/[^`{}()'"\[\]]/));next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
def nameFirst()
 _result_1 = ((nil))
...
(it=(_enter{it=((it=(transfn());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (Exp[ {:ary=>ary_1 }]) },proc{(it=(clas(ExpKey));next FAIL if it==FAIL;it)
(it=(_enter{it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)});next FAIL if it==FAIL;it)
_result_1 = (ExpKey[ {:ary=>ary_1 }]) },proc{_result_1 = ((it=(anything());next FAIL if it==FAIL;it))}));return FAIL if it==FAIL;it)
(_result_1)  
end
...
name_1 = ( _key(:name))
autovar_5 = ( _key(:args))
(it=(_pass(autovar_5){(it=(clas(Object));next FAIL if it==FAIL;it)
...
it=(it=((@argnames<<name_1;_Variable(name_1) ))
...
_result_1 = ((@marked += var_1)) },proc{(it=(clas(Act));next FAIL if it==FAIL;it)
...
autovar_4 = (([]))
while true
autovar_7=@input;r=(it=(_or(proc{(it=(clas(Variable));next FAIL if it==FAIL;it)
...
it=((autovar_3))
 autovar_4||=[];_append(autovar_4,it) });next FAIL if it==FAIL;it) },proc{(it=(clas(Act));next FAIL if it==FAIL;it)
(it=(_enter{it=( _key(:this))
 ary_1||=[];_append(ary_1,it)
autovar_2 = (([]))
while true
...
it=((autovar_2))
 autovar_4||=[];_append(autovar_4,it) });next FAIL if it==FAIL;it) },proc{(it=(clas(Resul));next FAIL if it==FAIL;it)
(it=(_enter{it=(it=( _key(:this))
 ary_1||=[];_append(ary_1,it))
 autovar_4||=[];_append(autovar_4,it)});next FAIL if it==FAIL;it) },proc{(it=(clas(Strin));next FAIL if it==FAIL;it)
(it=(_enter{it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_4||=[];_append(autovar_4,it)});next FAIL if it==FAIL;it) },proc{(it=(clas(Args));next FAIL if it==FAIL;it)
(it=(_enter{it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_4||=[];_append(autovar_4,it)});next FAIL if it==FAIL;it) },proc{(it=(clas(Set));next FAIL if it==FAIL;it)
(it=(_enter{autovar_1 = ( _key(:name))
(it=(_pass(autovar_1){it=(it=((it=(vars_in());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it))
 autovar_4||=[];_append(autovar_4,it)});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{(it=(clas(Local));next FAIL if it==FAIL;it)
(it=(_enter{name_1 = ((it=(anything());next FAIL if it==FAIL;it))
it=(it=( _key(:this))
 ary_1||=[];_append(ary_1,it))
 autovar_4||=[];_append(autovar_4,it) });next FAIL if it==FAIL;it) },proc{it=((it=(anything());next FAIL if it==FAIL;it))
...
autovar_2 = (([]))
while true
autovar_6=@input;r=(it=(clas(And));break FAIL if it==FAIL;it)
...
(it=(_enter{autovar_3 = (([]))
while true
autovar_6=@input;r=(it=(_or(proc{(it=(clas(Grammar));next FAIL if it==FAIL;it)
(it=(_enter{autovar_2 = ( _key(:rules))
(it=(_pass(autovar_2){(it=(clas(Object));next FAIL if it==FAIL;it)
(it=(_enter{autovar_1 = (([]))
while true
autovar_5=@input;r=(it=(clas(Rule));break FAIL if it==FAIL;it)
(it=(_enter{n_1 = ( _key(:name))
(it=(_or(proc{(it=((n_1==name_1)||FAIL);next FAIL if it==FAIL;it)
it=(rule_1 = ( _key(:this)))
 autovar_1||=[];_append(autovar_1,it) },proc{it=((it=(empty());next FAIL if it==FAIL;it))
 autovar_1||=[];_append(autovar_1,it)}));break FAIL if it==FAIL;it) });break FAIL if it==FAIL;it) 
 break FAIL if r==FAIL
end;@input=autovar_5
it=((autovar_1))
 autovar_3||=[];_append(autovar_3,it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it) },proc{it=((it=(anything());next FAIL if it==FAIL;it))
 autovar_3||=[];_append(autovar_3,it)}));break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_6
...
ors_1 = ((autovar_10)) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
...
_result_1 = ((t_1)) },proc{(it=(clas(ExpKey));next FAIL if it==FAIL;it)
