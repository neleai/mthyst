...
(it=(_pass(false,autovar_29){autovar_28 = ((it=(anything());next FAIL if it==FAIL;it))
...
_result_1 = ((nil))
autovar_3 = ((rule_1))
(it=(_pass(false,autovar_3){autovar_4 = ((it=(clas(Rule));next FAIL if it==FAIL;it))});return FAIL if it==FAIL;it)
(it=(_pass(true,autovar_4){name_1 = ( _key(:name))
args_1 = ( _key(:args))
 _key(:locals)
body_1 = ( _key(:body)) });return FAIL if it==FAIL;it)
