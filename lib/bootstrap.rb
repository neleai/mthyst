...
(from_1=_Pass(from_1,it_1)) },proc{(it=(seq("["));next FAIL if it==FAIL;it)
it_1 = ((it=(expression());next FAIL if it==FAIL;it))
(from_1=Enter[from_1,it_1])
(it=(token("]"));next FAIL if it==FAIL;it) },proc{from_1 = ((it=(optIter(from_1));next FAIL if it==FAIL;it))},proc{(it=(_lookahead(true){(it=(space());next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
from_1 = ((it=(binding(from_1));next FAIL if it==FAIL;it)) }));break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_1
()
...
def modifier()
 c_1 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{_result_1 = ((it=(term());next FAIL if it==FAIL;it))},proc{_result_1 = ((it=(binding(Apply["anything"]));next FAIL if it==FAIL;it))},proc{(it=(token("#"));next FAIL if it==FAIL;it)
autovar_1 = (([]))
while true
...
def optIter(t_1)
 s_1 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{(it=(_or(proc{s_1 = ((it=(token("*"));next FAIL if it==FAIL;it))},proc{s_1 = ((it=(token("+"));next FAIL if it==FAIL;it))}));next FAIL if it==FAIL;it)
_result_1 = ((Many[t_1,s_1=="+"])) },proc{(it=(token("?"));next FAIL if it==FAIL;it)
_result_1 = ((Or[t_1,Apply["empty"]])) }));return FAIL if it==FAIL;it)
(_result_1)  
end
def binding(exp_1)
 expr_1 = ((nil))
...
_result_1 = ((Seq[_Set("it",exp_1) , Act[e_1] ])) }));return FAIL if it==FAIL;it)
(_result_1)  
end
def term()
 cls_1 = ((nil))
...
()
while true
autovar_2=@input;r=(it=(_());break FAIL if it==FAIL;it)
 break FAIL if r==FAIL
end;@input=autovar_2
()
...
_result_1 = (Grammar.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_11 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
...
_result_1 = (Rule.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_12 = ((it=(clas(Or));next FAIL if it==FAIL;it))
...
_result_1 = (Or.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_15 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
...
_result_1 = (Seq.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_18 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
neg_1 = ( self['neg']) });next FAIL if it==FAIL;it)
_result_1 = (Lookahead.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_19 = ((it=(clas(Comment));next FAIL if it==FAIL;it))
...
_result_1 = (Comment.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_22 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_22){it=((it=(trans());next FAIL if it==FAIL;it))
 ary_1||=[];_append(ary_1,it)
o_1 = ( self['o']) });next FAIL if it==FAIL;it)
_result_1 = (Many.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_23 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
...
_result_1 = (Apply.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_24 = ((it=(clas(Set));next FAIL if it==FAIL;it))
...
_result_1 = (Set.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_25 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){ary_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( self['pred']) });next FAIL if it==FAIL;it)
_result_1 = (Act.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_26 = ((it=(clas(Result));next FAIL if it==FAIL;it))
...
_result_1 = (Result.create( {:name=>name_1,:parent=>parent_1,:rules=>rules_1,:args=>args_1,:body=>body_1,:locals=>locals_1,:ary=>ary_1,:neg=>neg_1,:o=>o_1,:expr=>expr_1,:append=>append_1,:pred=>pred_1,:vars=>vars_1,:to=>to_1,:var=>var_1,:enter=>enter_1 })) },proc{autovar_27 = ((it=(clas(Args));next FAIL if it==FAIL;it))
...
_result_1 = (Or.create( {:append=>append_1,:name=>name_1,:ary=>ary_1,:el=>el_1,:var=>var_1,:to=>to_1,:enter=>enter_1 })) },proc{autovar_6 = ((it=(clas(Seq));next FAIL if it==FAIL;it))
