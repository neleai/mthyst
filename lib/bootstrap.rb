...
_result_1 = ((vars_1=Object.const_get(name_1).intersect(vars_1); "#{name_1}.create(#{argss_1} {#{vars_1.map{|l| ":#{l[0]}=>#{l[0]}_#{l.number}" }*","} })")) },proc{autovar_27 = ((it=(clas(Key));next FAIL if it==FAIL;it))
