...
autovar_9 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_9 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_9){argnames_1 = ((@argnames=[]))
(@locals=[])
name_1 = ( _key(:name))
autovar_8 = ( _key(:args))
(it=(_pass(false,autovar_8){autovar_7 = ((it=(clas(Object));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_7){args_1 = ((it=(addargs());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
autovar_6 = ( _key(:body))
...
()
while true
autovar_10=@input;r=(@locals=l_1.clone)
...
autovar_25 = ((nil))
_result_1 = ((nil))
(it=(_or(proc{autovar_25 = ((it=(clas(Grammar));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_25){(it=(rw('return',proc{name_1 = ( _key(:name))
parent_1 = ( _key(:parent))
autovar_24 = ( _key(:rules))
(it=(_pass(false,autovar_24){_result_1 = (body_1 = ((it=(transs());next FAIL if it==FAIL;it)))});next FAIL if it==FAIL;it)
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = (("class #{name_1} < #{parent_1}\n#{body_1}\nend\n")) },proc{autovar_23 = ((it=(clas(Rule));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_23){(@varhash=Hash.new{|h,k| h[k]={}}  )
name_1 = ( _key(:name))
autovar_22 = ( _key(:args))
(it=(_pass(false,autovar_22){argss_1 = ((it=(args());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it)
autovar_21 = ( _key(:body))
(it=(_pass(false,autovar_21){body_1 = ((it=(trans());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("def #{name_1}(#{argss_1})\n #{body_1} \nend\n")) },proc{autovar_20 = ((it=(clas(Or));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_20){(it=(rw('next', proc{autovar_19 = (([]))
while true
autovar_26=@input;r=it=((it=(transfn());break FAIL if it==FAIL;it))
 autovar_19||=[];_append(autovar_19,it)
 break FAIL if r==FAIL
end;@input=autovar_26
_result_1 = (ors_1 = ((autovar_19)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_or(#{ors_1*","})"));next FAIL if it==FAIL;it)) },proc{autovar_18 = ((it=(clas(And));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_18){autovar_17 = (([]))
while true
autovar_27=@input;r=it=((it=(trans());break FAIL if it==FAIL;it))
 autovar_17||=[];_append(autovar_17,it)
 break FAIL if r==FAIL
end;@input=autovar_27
t_1 = ((autovar_17)) });next FAIL if it==FAIL;it)
_result_1 = (("#{t_1*"\n"} ")) },proc{autovar_16 = ((it=(clas(Not));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_16){(it=(rw('next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
_result_1 = ((it=(failwrap("_not{#{t_1}}"));next FAIL if it==FAIL;it)) },proc{autovar_15 = ((it=(clas(Act));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_15){t_1 = ((it=(args());next FAIL if it==FAIL;it))
pred_1 = ( _key(:pred)) });next FAIL if it==FAIL;it)
_result_1 = ((pred_1 ?  failwrap("(#{t_1})||FAIL") : "(#{t_1})")) },proc{autovar_14 = ((it=(clas(Lookahead));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_14){(it=(rw('next',proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) }));next FAIL if it==FAIL;it)});next FAIL if it==FAIL;it)
...
_result_1 = (("")) },proc{autovar_12 = ((it=(clas(Many));next FAIL if it==FAIL;it))
(it=(_pass(true,autovar_12){(it=(rw('break', proc{_result_1 = (t_1 = ((it=(trans());next FAIL if it==FAIL;it)))
(_result_1) } ));next FAIL if it==FAIL;it)
autovar_11 = ( _key(:o))
(it=(_pass(false,autovar_11){o_1 = ((it=(arg());next FAIL if it==FAIL;it))});next FAIL if it==FAIL;it) });next FAIL if it==FAIL;it)
_result_1 = (("while true\n#{o_1}=@input;r=#{t_1}\n break FAIL if r==FAIL\nend;@input=#{o_1}")) },proc{autovar_10 = ((it=(clas(Apply));next FAIL if it==FAIL;it))
