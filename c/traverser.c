...
ISET(src,BGET(autovar_6)); ISET(input,INT2FIX(0));
 ...
 BSET(key_1,BGET(it));   BSET(it,Traverser_traverse_item(self)); FAILTEST(pass34);
...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_2,BGET(it)); VALUE oldinput12; while(1){oldinput12=IGET(input);   BSET(it,Traverser_traverse_item(self)); FAILTEST(break11);
