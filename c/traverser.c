...
BSET(it,CALL(traverse_Traversercb6,1,bind)); 
 BSET(autovar_1,BGET(it)); VALUE oldinput21; while(1){oldinput21=IGET(input);   BSET(it,CALL(anything,0 )); FAILTEST(break20);
 BSET(autovar_2,BGET(it)); BSET(it,CALL(traverse_Traversercb7,1,bind));  } break20: ISET(input,oldinput21); BSET(it,BGET(autovar_1));BSET(it,CALL(traverse_Traversercb8,1,bind)); 
 BSET(this_1,BGET(it)); BSET(it,CALL(traverse_Traversercb9,1,bind)); 
...
ISET(src,BGET(autovar_4)); ISET(input,INT2FIX(0));
 BSET(it,CALL(traverse_Traversercb10,1,bind)); 
...
ISET(src,BGET(autovar_6)); ISET(input,INT2FIX(0));
 ...
 BSET(it_1,BGET(it)); BSET(it,CALL(traverse_Traversercb11,1,bind)); 
...
BSET(it,CALL(traverse_Traversercb12,1,bind));  } break32: ISET(input,oldinput33); BSET(it,BGET(autovar_5));
	...
	if(fail26) goto fail;
BSET(it,CALL(traverse_Traversercb13,1,bind)); 
...
alt3: ISET(input,oldinput2);if (IGET(cut)!=Qnil) goto fail;
 ...
 BSET(a_1,BGET(it)); BSET(it,CALL(traverse_item_Traversercb1,1,bind)); BSET(it,BGET(a_1));
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept1;
alt4: ISET(input,oldinput2);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(traverse_item_Traversercb2,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt5);
...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
 BSET(it,CALL(traverse_item_Traversercb3,1,bind)); 
 BSET(autovar_2,BGET(it)); VALUE oldinput12; while(1){oldinput12=IGET(input);   BSET(it,CALL(traverse_item,0 )); FAILTEST(break11);
 BSET(autovar_3,BGET(it)); BSET(it,CALL(traverse_item_Traversercb4,1,bind));  } break11: ISET(input,oldinput12); BSET(it,BGET(autovar_2));
 BSET(_result_1,BGET(it)); 
...
alt5: ISET(input,oldinput2);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(traverse_item_Traversercb5,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt13);
...
rb_eval_string("class Traverser < Amethyst\ndef traverse_Traversercb10(bind)\n[]\nend\ndef traverse_Traversercb11(bind)\n@x; bind[:this_1].instance_variable_set(bind[:key_1],bind[:it_1])\nend\ndef traverse_Traversercb12(bind)\nbind[:autovar_5]||=[];_append(bind[:autovar_5],bind[:autovar_7])\nend\ndef traverse_Traversercb13(bind)\n@src.self\nend\ndef traverse_Traversercb6(bind)\n[]\nend\ndef traverse_Traversercb7(bind)\nbind[:autovar_1]||=[];_append(bind[:autovar_1],bind[:autovar_2])\nend\ndef traverse_Traversercb8(bind)\n@src.self\nend\ndef traverse_Traversercb9(bind)\n(@src.self.instance_variables).map{|v| [v,@src.self.instance_variable_get(v)] }\nend\ndef traverse_item_Traversercb1(bind)\n@changed=true\nend\ndef traverse_item_Traversercb2(bind)\nArray\nend\ndef traverse_item_Traversercb3(bind)\n[]\nend\ndef traverse_item_Traversercb4(bind)\nbind[:autovar_2]||=[];_append(bind[:autovar_2],bind[:autovar_3])\nend\ndef traverse_item_Traversercb5(bind)\nAmethystAST\nend\n\nend");
}
