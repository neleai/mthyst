...
ISET(src,rb_ary_new3(1,BGET(autovar_166))); ISET(input,INT2FIX(0));
...
ISET(src,BGET(autovar_165)); ISET(input,INT2FIX(0));
...
ISET(src,BGET(autovar_161)); ISET(input,INT2FIX(0));
...
ISET(src,BGET(autovar_156)); ISET(input,INT2FIX(0));
...
ISET(src,BGET(autovar_157)); ISET(input,INT2FIX(0));
