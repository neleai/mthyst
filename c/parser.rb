...
def addargs_AmethystParsercb_7(bind)
_append(bind[:result_1],bind[:autovar_3])
end
def addargs_AmethystParsercb_8(bind)
_append(bind[:autovar_1],bind[:autovar_4])
end
def addargs_AmethystParsercb_9(bind)
bind[:result_1] || []
end
...
def args_AmethystParsercb_5(bind)
...
def atomicHostExpr_AmethystParsercb_6(bind)
...
def procargs_AmethystParsercb_7(bind)
@ary
end
...
_append(bind[:x_1],bind[:autovar_8])
end
def term_AmethystParsercb_34(bind)
_append(bind[:autovar_3],bind[:autovar_9])
end
