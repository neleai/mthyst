...
bind[:result_1]||=[];_append(bind[:result_1],bind[:autovar_3])
end
def addargs_AmethystParsercb_5(bind)
bind[:autovar_1]||=[];_append(bind[:autovar_1],bind[:autovar_4])
end
...
bind[:autovar_2]||=[];_append(bind[:autovar_2],bind[:autovar_1])
end
...
bind[:autovar_2]||=[];_append(bind[:autovar_2],bind[:autovar_5])
end
...
bind[:autovar_2]||=[];_append(bind[:autovar_2],bind[:autovar_4])
end
def igrammar_AmethystParsercb_7(bind)
bind[:it_1]*""
end
def igrammar_AmethystParsercb_8(bind)
bind[:autovar_1]||=[];_append(bind[:autovar_1],bind[:autovar_5])
end
...
def procargs_AmethystParsercb_6(bind)
@ary
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_1])
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_4])
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_5])
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_8])
end
...
bind[:n_1]||=[];_append(bind[:n_1],bind[:autovar_9])
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_3])
end
...
bind[:s_1]||=[];_append(bind[:s_1],bind[:autovar_6])
end
...
bind[:x_1]||=[];_append(bind[:x_1],bind[:autovar_9])
end
