...
ISET(src,BGET(autovar_5)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_6,it); VALUE oldpos7=ame_getpos(self); VALUE oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_Dead_Code_Detectorcb_14,1,bind); it=CALL(trans_Dead_Code_Detectorcb_15,1,bind); 
 BSET(autovar_7,it); VALUE oldpos8=ame_getpos(self); VALUE oldlen7=ame_getlen(self); VALUE oldsrc7=IGET(src); int fail7=0;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldpos9=ame_getpos(self); VALUE oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_9,it); VALUE oldpos10=ame_getpos(self); VALUE oldlen9=ame_getlen(self); VALUE oldsrc9=IGET(src); int fail9=0;
ISET(src,BGET(autovar_9)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_10,it); VALUE oldpos11=ame_getpos(self); VALUE oldlen10=ame_getlen(self); VALUE oldsrc10=IGET(src); int fail10=0;
ISET(src,rb_ary_new3(1,BGET(autovar_10))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_Dead_Code_Detectorcb_22,1,bind); it=CALL(trans_Dead_Code_Detectorcb_23,1,bind); 
 BSET(autovar_11,it); VALUE oldpos12=ame_getpos(self); VALUE oldlen11=ame_getlen(self); VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,rb_ary_new3(1,BGET(autovar_11))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_Dead_Code_Detectorcb_24,1,bind); 
 BSET(autovar_12,it); VALUE oldpos13=ame_getpos(self); VALUE oldlen12=ame_getlen(self); VALUE oldsrc12=IGET(src); int fail12=0;
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_13,it); VALUE oldpos14=ame_getpos(self); VALUE oldlen13=ame_getlen(self); VALUE oldsrc13=IGET(src); int fail13=0;
ISET(src,BGET(autovar_13)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_14,it); VALUE oldpos15=ame_getpos(self); VALUE oldlen14=ame_getlen(self); VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,rb_ary_new3(1,BGET(autovar_14))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
   it=CALL(anything,0 ); FAILTEST(pass14);
 BSET(autovar_15,it); VALUE oldpos16=ame_getpos(self); VALUE oldlen15=ame_getlen(self); VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_15)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_1,it); VALUE oldpos3=ame_getpos(self); VALUE oldlen1=ame_getlen(self); VALUE oldsrc1=IGET(src); int fail1=0;
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_3,it); VALUE oldpos5=ame_getpos(self); VALUE oldlen2=ame_getlen(self); VALUE oldsrc2=IGET(src); int fail2=0;
...
alt1_3: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_5,it); VALUE oldpos7=ame_getpos(self); VALUE oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_5)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_4: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_7,it); VALUE oldpos9=ame_getpos(self); VALUE oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
...
alt1_5: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_8,it); VALUE oldpos10=ame_getpos(self); VALUE oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_6: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_10,it); VALUE oldpos11=ame_getpos(self); VALUE oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
...
alt1_7: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_12,it); VALUE oldpos12=ame_getpos(self); VALUE oldlen7=ame_getlen(self); VALUE oldsrc7=IGET(src); int fail7=0;
...
alt1_8: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_14,it); VALUE oldpos13=ame_getpos(self); VALUE oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,BGET(autovar_14)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_15,it); VALUE oldpos14=ame_getpos(self); VALUE oldlen9=ame_getlen(self); VALUE oldsrc9=IGET(src); int fail9=0;
...
alt1_9: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_17,it); VALUE oldpos15=ame_getpos(self); VALUE oldlen10=ame_getlen(self); VALUE oldsrc10=IGET(src); int fail10=0;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_5,it); VALUE oldpos7=ame_getpos(self); VALUE oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_5)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 it=CALL(trans_Dead_Code_Deletercb_13,1,bind); 
 BSET(name_1,it); it=CALL(trans_Dead_Code_Deletercb_14,1,bind); 
 BSET(autovar_6,it); VALUE oldpos8=ame_getpos(self); VALUE oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_7,it); VALUE oldpos9=ame_getpos(self); VALUE oldlen7=ame_getlen(self); VALUE oldsrc7=IGET(src); int fail7=0;
ISET(src,BGET(autovar_7)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldpos10=ame_getpos(self); VALUE oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
ISET(src,BGET(autovar_2)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_3,it); VALUE oldpos7=ame_getpos(self); VALUE oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_3)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
   it=CALL(trans,0 ); FAILTEST(pass3);
...
alt2_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 ...
 BSET(autovar_6,it); VALUE oldpos8=ame_getpos(self); VALUE oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldpos9=ame_getpos(self); VALUE oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 it=CALL(move_Move_Assignmentscb_14,1,bind); 
 BSET(var_1,it); it=CALL(move_Move_Assignmentscb_15,1,bind); 
 BSET(autovar_9,it); VALUE oldpos10=ame_getpos(self); VALUE oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,rb_ary_new3(1,BGET(autovar_9))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
