...
ISET(src,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
...
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
...
ISET(src,rb_ary_new3(1,BGET(autovar_7))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); int oldpos9=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(var_1,it); 
	...
	goto success8;
	pass8: fail8=1;
	success8: ISET(src,oldsrc8); ame_setpos(self,oldpos9); ame_setlen(self,oldlen8);
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_9,it); int oldpos10=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=IGET(src); int fail9=0;
ISET(src,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(trans_Dead_Code_Detectorcb_21,1,bind); 
 BSET(autovar_10,it); int oldpos11=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=IGET(src); int fail10=0;
ISET(src,rb_ary_new3(1,BGET(autovar_10))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass10);
 BSET(v_1,it); 
	if (CALL(eof,0)==failobj) goto pass10;
	goto success10;
	pass10: fail10=1;
	success10: ISET(src,oldsrc10); ame_setpos(self,oldpos11); ame_setlen(self,oldlen10);
	if(fail10) goto pass9;
it=CALL(trans_Dead_Code_Detectorcb_22,1,bind); it=CALL(trans_Dead_Code_Detectorcb_23,1,bind); 
 BSET(autovar_11,it); int oldpos12=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,rb_ary_new3(1,BGET(autovar_11))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(trans,0 ); FAILTEST(pass11);
	if (CALL(eof,0)==failobj) goto pass11;
	goto success11;
	pass11: fail11=1;
	success11: ISET(src,oldsrc11); ame_setpos(self,oldpos12); ame_setlen(self,oldlen11);
	if(fail11) goto pass9;
it=CALL(trans_Dead_Code_Detectorcb_24,1,bind); 
 BSET(autovar_12,it); int oldpos13=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=IGET(src); int fail12=0;
ISET(src,rb_ary_new3(1,BGET(autovar_12))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass12);
 BSET(var_1,it); 
	if (CALL(eof,0)==failobj) goto pass12;
	goto success12;
	pass12: fail12=1;
	success12: ISET(src,oldsrc12); ame_setpos(self,oldpos13); ame_setlen(self,oldlen12);
	if(fail12) goto pass9;

	if (CALL(eof,0)==failobj) goto pass9;
	goto success9;
	pass9: fail9=1;
	success9: ISET(src,oldsrc9); ame_setpos(self,oldpos10); ame_setlen(self,oldlen9);
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_13,it); int oldpos14=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=IGET(src); int fail13=0;
ISET(src,BGET(autovar_13)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(trans_Dead_Code_Detectorcb_27,1,bind); 
 BSET(autovar_14,it); int oldpos15=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,rb_ary_new3(1,BGET(autovar_14))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(anything,0 ); FAILTEST(pass14);
 BSET(autovar_15,it); int oldpos16=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_15)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass15);
 BSET(var_1,it); 
	if (CALL(eof,0)==failobj) goto pass15;
	goto success15;
	pass15: fail15=1;
	success15: ISET(src,oldsrc15); ame_setpos(self,oldpos16); ame_setlen(self,oldlen15);
	if(fail15) goto pass14;

	if (CALL(eof,0)==failobj) goto pass14;
	goto success14;
	pass14: fail14=1;
	success14: ISET(src,oldsrc14); ame_setpos(self,oldpos15); ame_setlen(self,oldlen14);
...
it=CALL(trans_Dead_Code_Detectorcb_28,1,bind); 
 BSET(v_1,it); 
	...
	goto success13;
	pass13: fail13=1;
	success13: ISET(src,oldsrc13); ame_setpos(self,oldpos14); ame_setlen(self,oldlen13);
...
it=CALL(vars_in_Dead_Code_Detectorcb_1,1,bind); int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_1,it); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=IGET(src); int fail1=0;
ISET(src,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(vars_in_Dead_Code_Detectorcb_3,1,bind); 
 BSET(autovar_2,it); it=CALL(vars_in_Dead_Code_Detectorcb_4,1,bind); it=CALL(vars_in_Dead_Code_Detectorcb_5,1,bind); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos4); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_3,it); int oldpos5=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=IGET(src); int fail2=0;
ISET(src,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_4,it); it=CALL(vars_in_Dead_Code_Detectorcb_8,1,bind); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos6); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt1_3: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_5,it); int oldpos7=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(vars_in_Dead_Code_Detectorcb_10,1,bind); 
 BSET(autovar_6,it); it=CALL(vars_in_Dead_Code_Detectorcb_11,1,bind); it=CALL(vars_in_Dead_Code_Detectorcb_12,1,bind); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break4); if (IGET(stop)!=Qnil){{oldpos8=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos8); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
	success3: ISET(src,oldsrc3); ame_setpos(self,oldpos7); ame_setlen(self,oldlen3);
...
alt1_4: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_7,it); int oldpos9=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(trans,0 ); FAILTEST(pass4);
	...
	goto success4;
	pass4: fail4=1;
	success4: ISET(src,oldsrc4); ame_setpos(self,oldpos9); ame_setlen(self,oldlen4);
...
alt1_5: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_8,it); int oldpos10=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_9,it); it=CALL(vars_in_Dead_Code_Detectorcb_16,1,bind); 
	...
	goto success5;
	pass5: fail5=1;
	success5: ISET(src,oldsrc5); ame_setpos(self,oldpos10); ame_setlen(self,oldlen5);
...
alt1_6: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_10,it); int oldpos11=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass6);
 BSET(autovar_11,it); it=CALL(vars_in_Dead_Code_Detectorcb_18,1,bind); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
	success6: ISET(src,oldsrc6); ame_setpos(self,oldpos11); ame_setlen(self,oldlen6);
...
alt1_7: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_12,it); int oldpos12=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=IGET(src); int fail7=0;
ISET(src,BGET(autovar_12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass7);
 BSET(autovar_13,it); it=CALL(vars_in_Dead_Code_Detectorcb_20,1,bind); 
	if (CALL(eof,0)==failobj) goto pass7;
	goto success7;
	pass7: fail7=1;
	success7: ISET(src,oldsrc7); ame_setpos(self,oldpos12); ame_setlen(self,oldlen7);
...
alt1_8: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_14,it); int oldpos13=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(vars_in_Dead_Code_Detectorcb_22,1,bind); 
 BSET(autovar_15,it); int oldpos14=ame_getpos(self); int oldlen9=ame_getlen(self); VALUE oldsrc9=IGET(src); int fail9=0;
ISET(src,rb_ary_new3(1,BGET(autovar_15))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(vars_in,0 ); FAILTEST(pass9);
 BSET(autovar_16,it); it=CALL(vars_in_Dead_Code_Detectorcb_23,1,bind); 
	if (CALL(eof,0)==failobj) goto pass9;
	goto success9;
	pass9: fail9=1;
	success9: ISET(src,oldsrc9); ame_setpos(self,oldpos14); ame_setlen(self,oldlen9);
	if(fail9) goto pass8;

	if (CALL(eof,0)==failobj) goto pass8;
	goto success8;
	pass8: fail8=1;
	success8: ISET(src,oldsrc8); ame_setpos(self,oldpos13); ame_setlen(self,oldlen8);
...
alt1_9: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_17,it); int oldpos15=ame_getpos(self); int oldlen10=ame_getlen(self); VALUE oldsrc10=IGET(src); int fail10=0;
ISET(src,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_18,it); it=CALL(vars_in_Dead_Code_Detectorcb_27,1,bind); 
	...
	goto success10;
	pass10: fail10=1;
	success10: ISET(src,oldsrc10); ame_setpos(self,oldpos15); ame_setlen(self,oldlen10);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_5,it); int oldpos7=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(trans_Dead_Code_Deletercb_13,1,bind); 
 BSET(name_1,it); it=CALL(trans_Dead_Code_Deletercb_14,1,bind); 
 BSET(autovar_6,it); int oldpos8=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(expr_1,it); 
	...
	goto success6;
	pass6: fail6=1;
	success6: ISET(src,oldsrc6); ame_setpos(self,oldpos8); ame_setlen(self,oldlen6);
	if(fail6) goto pass5;
it=CALL(trans_Dead_Code_Deletercb_15,1,bind); 
 BSET(append_1,it); 
	...
	goto success5;
	pass5: fail5=1;
	success5: ISET(src,oldsrc5); ame_setpos(self,oldpos7); ame_setlen(self,oldlen5);
	if(fail5) goto alt1_4;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_7,it); int oldpos9=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=IGET(src); int fail7=0;
ISET(src,BGET(autovar_7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(this_1,it); 
	...
	goto success7;
	pass7: fail7=1;
	success7: ISET(src,oldsrc7); ame_setpos(self,oldpos9); ame_setlen(self,oldlen7);
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); int oldpos10=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 int oldpos11; while(1){oldpos11=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break2); if (IGET(stop)!=Qnil){{oldpos11=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos11); it=CALL(trans_Dead_Code_Deletercb_21,1,bind); 
 BSET(this_1,it); 
	if (CALL(eof,0)==failobj) goto pass8;
	goto success8;
	pass8: fail8=1;
	success8: ISET(src,oldsrc8); ame_setpos(self,oldpos10); ame_setlen(self,oldlen8);
...
ISET(src,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_2,it); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=IGET(src); int fail2=0;
ISET(src,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos3); if (x==0) goto pass1;int oldpos6; while(1){oldpos6=ame_getpos(self);  arg0=CALL(trans_Communize_Orcb_3,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break2);
 BSET(autovar_3,it); int oldpos7=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(trans,0 ); FAILTEST(pass3);
 BSET(fst_1,it); it=CALL(trans_Communize_Orcb_4,1,bind); FAILTEST(pass3);it=CALL(trans_Communize_Orcb_5,1,bind); 
 BSET(autovar_4,it); int oldpos8; while(1){oldpos8=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break3);
...
ISET(src,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_2,it); int oldpos3; while(1){oldpos3=ame_getpos(self);  arg0=CALL(move_Move_Assignmentscb_3,1,bind);arg1=CALL(move_Move_Assignmentscb_4,1,bind); it=CALL(move,2 ,arg0,arg1); FAILTEST(break1);
...
alt2_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
 ...
 BSET(autovar_6,it); int oldpos8=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,rb_ary_new3(1,BGET(autovar_6))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_7,it); 
	...
	goto success3;
	pass3: fail3=1;
	success3: ISET(src,oldsrc3); ame_setpos(self,oldpos8); ame_setlen(self,oldlen3);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); int oldpos9=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(move_Move_Assignmentscb_14,1,bind); 
 BSET(var_1,it); it=CALL(move_Move_Assignmentscb_15,1,bind); 
 BSET(autovar_9,it); int oldpos10=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,rb_ary_new3(1,BGET(autovar_9))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
