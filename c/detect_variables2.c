...
alt85: ISET(input,oldinput84);if (IGET(cut)!=Qnil) goto break81;
  arg0=CALL(flat_cb27,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt86);
...
alt86: ISET(input,oldinput84);if (IGET(cut)!=Qnil) goto break81;
  arg0=CALL(flat_cb28,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt92);
...
ISET(cut,Qnil);goto accept83;
 ...
 accept83:;
BSET(it,CALL(flat_cb29,1,bind));  } break81: ISET(input,oldinput82); BSET(it,BGET(autovar_1));
...
alt5: ISET(input,oldinput4);if (IGET(cut)!=Qnil) goto break1;
  arg0=CALL(itrans_cb2,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt6);
 BSET(autovar_2,BGET(it)); VALUE oldinput8=IGET(input);  VALUE oldsrc9=IGET(src); int fail11=0;
ISET(src,BGET(autovar_2)); ISET(input,INT2FIX(0));
 BSET(it,CALL(itrans_cb3,1,bind)); 
...
ISET(src,BGET(autovar_4)); ISET(input,INT2FIX(0));
 BSET(it,CALL(itrans_cb4,1,bind)); 
 BSET(autovar_5,BGET(it)); VALUE oldinput23; while(1){oldinput23=IGET(input);  arg0=CALL(itrans_cb5,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(break22);
...
BSET(it,CALL(itrans_cb6,1,bind));  } break22: ISET(input,oldinput23); BSET(it,BGET(autovar_5));
...
BSET(it,CALL(itrans_cb7,1,bind)); BSET(it,CALL(itrans_cb8,1,bind)); 
...
ISET(cut,Qnil);goto accept3;
 ...
 accept3:;
BSET(it,CALL(itrans_cb9,1,bind));  } break1: ISET(input,oldinput2); BSET(it,BGET(autovar_1));
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
ISET(src,rb_ary_new3(1,BGET(autovar_1))); ISET(input,INT2FIX(0));
  arg0=CALL(root_cb11,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(pass30);
 BSET(autovar_2,BGET(it)); VALUE oldinput36=IGET(input);  VALUE oldsrc37=IGET(src); int fail39=0;
ISET(src,BGET(autovar_2)); ISET(input,INT2FIX(0));
 BSET(it,CALL(root_cb12,1,bind)); BSET(it,CALL(root_cb13,1,bind));   BSET(it,CALL(traverse,0 )); FAILTEST(pass35);BSET(it,CALL(root_cb14,1,bind)); BSET(it,CALL(root_cb15,1,bind)); 
...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
   BSET(it,CALL(traverse,0 )); FAILTEST(pass44);BSET(it,CALL(visit_cb17,1,bind)); 
...
BSET(it,CALL(visit_cb18,1,bind)); BSET(it,CALL(visit_cb19,1,bind)); 
 BSET(_result_1,BGET(it)); 
...
alt43: ISET(input,oldinput41);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(visit_cb20,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt59);
 BSET(autovar_4,BGET(it)); VALUE oldinput61=IGET(input);  VALUE oldsrc62=IGET(src); int fail64=0;
ISET(src,BGET(autovar_4)); ISET(input,INT2FIX(0));
   BSET(it,CALL(traverse,0 )); FAILTEST(pass60);BSET(it,CALL(visit_cb21,1,bind)); 
...
ISET(src,BGET(autovar_6)); ISET(input,INT2FIX(0));
  arg0=CALL(visit_cb22,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(pass70);
 BSET(_result_1,BGET(it)); 
...
alt59: ISET(input,oldinput41);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(visit_cb23,1,bind); BSET(it,CALL(clas,1 ,arg0)); FAILTEST(alt75);
...
ISET(src,BGET(autovar_7)); ISET(input,INT2FIX(0));
 BSET(it,CALL(visit_cb24,1,bind)); BSET(it,CALL(visit_cb25,1,bind)); 
 BSET(_result_1,BGET(it)); 
