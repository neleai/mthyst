...
VALUE Amethyst__false(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(_false_Amethystcb25,1,bind); BSET(it,CALL(exactly,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst__true(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(_true_Amethystcb24,1,bind); BSET(it,CALL(exactly,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
VALUE Amethyst_char(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 ...
 BSET(c_1,BGET(it)); BSET(it,CALL(char_Amethystcb3,1,bind)); FAILTEST(fail);BSET(it,BGET(c_1));
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
alt6: ISET(input,oldinput5);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(endline_Amethystcb4,1,bind); BSET(it,CALL(seq,1 ,arg0)); FAILTEST(alt7);
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept4;
alt7: ISET(input,oldinput5);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(endline_Amethystcb5,1,bind); BSET(it,CALL(seq,1 ,arg0)); FAILTEST(alt8);
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept4;
alt8: ISET(input,oldinput5);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(endline_Amethystcb6,1,bind); BSET(it,CALL(seq,1 ,arg0)); FAILTEST(alt9);
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept4;
...
VALUE Amethyst_exactly(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_hash_new(); BSET(wanted_1,a0); vals[0]=a0; int x;VALUE arg0,arg1,arg2,arg3;
  BSET(it,CALL(anything,0 )); FAILTEST(fail);
 BSET(got_1,BGET(it)); BSET(it,CALL(exactly_Amethystcb23,1,bind)); FAILTEST(fail);BSET(it,BGET(wanted_1));
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
alt29: ISET(input,oldinput28);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(listOf_Amethystcb15,1,bind); BSET(it,CALL(apply,1 ,arg0)); FAILTEST(alt30);
 BSET(autovar_1,BGET(it)); BSET(it,CALL(listOf_Amethystcb16,1,bind)); BSET(it,CALL(listOf_Amethystcb17,1,bind)); 
 BSET(autovar_2,BGET(it)); VALUE oldinput32; while(1){oldinput32=IGET(input);  arg0=CALL(listOf_Amethystcb18,1,bind); BSET(it,CALL(apply,1 ,arg0)); FAILTEST(break31); arg0=CALL(listOf_Amethystcb19,1,bind); BSET(it,CALL(apply,1 ,arg0)); FAILTEST(break31);
 BSET(autovar_3,BGET(it)); BSET(it,CALL(listOf_Amethystcb20,1,bind));  } break31: ISET(input,oldinput32); BSET(it,BGET(autovar_2));
 BSET(autovar_4,BGET(it)); BSET(it,CALL(listOf_Amethystcb21,1,bind)); BSET(it,BGET(f_1));
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept27;
alt30: ISET(input,oldinput28);if (IGET(cut)!=Qnil) goto fail;
   BSET(it,CALL(empty,0 )); FAILTEST(alt33);BSET(it,CALL(listOf_Amethystcb22,1,bind)); 
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept27;
...
VALUE Amethyst_lower(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(lower_Amethystcb11,1,bind); BSET(it,CALL(regch,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst_regch(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_hash_new(); BSET(regex_1,a0); vals[0]=a0; int x;VALUE arg0,arg1,arg2,arg3;
 ...
 BSET(c_1,BGET(it)); BSET(it,CALL(regch_Amethystcb1,1,bind)); FAILTEST(fail);BSET(it,BGET(c_1));
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst_space(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(space_Amethystcb7,1,bind); BSET(it,CALL(regch,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst_spaces(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
BSET(it,CALL(spaces_Amethystcb8,1,bind)); 
 BSET(autovar_1,BGET(it)); VALUE oldinput11; while(1){oldinput11=IGET(input);   BSET(it,CALL(space,0 )); FAILTEST(break10);
 BSET(autovar_2,BGET(it)); BSET(it,CALL(spaces_Amethystcb9,1,bind));  } break10: ISET(input,oldinput11); BSET(it,BGET(autovar_1));
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst_token(VALUE self ,VALUE a0){VALUE vals[1]; VALUE bind=rb_hash_new(); BSET(s_1,a0); vals[0]=a0; int x;VALUE arg0,arg1,arg2,arg3;
  BSET(it,CALL(spaces,0 )); FAILTEST(fail); arg0=CALL(token_Amethystcb27,1,bind); BSET(it,CALL(seq,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
VALUE Amethyst_upper(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(upper_Amethystcb12,1,bind); BSET(it,CALL(regch,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
alt25: ISET(input,oldinput23);if (IGET(cut)!=Qnil) goto fail;
  arg0=CALL(word_Amethystcb14,1,bind); BSET(it,CALL(seq,1 ,arg0)); FAILTEST(alt26);
 BSET(_result_1,BGET(it));  
ISET(cut,Qnil);goto accept22;
...
VALUE Amethyst_xdigit(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;
 arg0=CALL(xdigit_Amethystcb13,1,bind); BSET(it,CALL(regch,1 ,arg0)); FAILTEST(fail);
 BSET(_result_1,BGET(it)); BSET(it,BGET(_result_1));
return BGET(_result_1);
fail: return failobj; }
...
rb_eval_string("class Amethyst < AmethystCore\ndef _false_Amethystcb25(bind)\nfalse\nend\ndef _true_Amethystcb24(bind)\ntrue\nend\ndef char_Amethystcb3(bind)\n(bind[:c_1].is_a? String ) || FAIL\nend\ndef clas_Amethystcb26(bind)\n(bind[:i_1].is_a?(bind[:cls_1])) || FAIL\nend\ndef digit_Amethystcb10(bind)\n/[0-9]/\nend\ndef empty_Amethystcb2(bind)\nnil\nend\ndef endline_Amethystcb4(bind)\n\"\\r\\n\"\nend\ndef endline_Amethystcb5(bind)\n\"\\r\"\nend\ndef endline_Amethystcb6(bind)\n\"\\n\"\nend\ndef exactly_Amethystcb23(bind)\n(bind[:wanted_1] == bind[:got_1]) || FAIL\nend\ndef listOf_Amethystcb15(bind)\nbind[:rule_1]\nend\ndef listOf_Amethystcb16(bind)\nbind[:f_1]||=[];_append(bind[:f_1],bind[:autovar_1])\nend\ndef listOf_Amethystcb17(bind)\n[]\nend\ndef listOf_Amethystcb18(bind)\nbind[:delim_1]\nend\ndef listOf_Amethystcb19(bind)\nbind[:rule_1]\nend\ndef listOf_Amethystcb20(bind)\nbind[:autovar_2]||=[];_append(bind[:autovar_2],bind[:autovar_3])\nend\ndef listOf_Amethystcb21(bind)\nbind[:f_1]||=[];_append(bind[:f_1],bind[:autovar_4])\nend\ndef listOf_Amethystcb22(bind)\n[]\nend\ndef lower_Amethystcb11(bind)\n/[a-z]/\nend\ndef regch_Amethystcb1(bind)\n(bind[:regex_1].match(bind[:c_1])) || FAIL\nend\ndef space_Amethystcb7(bind)\n/[\\s\\t\\r\\n\\f]/\nend\ndef spaces_Amethystcb8(bind)\n[]\nend\ndef spaces_Amethystcb9(bind)\nbind[:autovar_1]||=[];_append(bind[:autovar_1],bind[:autovar_2])\nend\ndef token_Amethystcb27(bind)\nbind[:s_1]\nend\ndef upper_Amethystcb12(bind)\n/[A-Z]/\nend\ndef word_Amethystcb14(bind)\n\"_\"\nend\ndef xdigit_Amethystcb13(bind)\n/[0-9a-fA-F]/\nend\n\nend");
}
