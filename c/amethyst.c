...
VALUE Amethyst_token(VALUE self ,VALUE a0);VALUE Amethyst_regch(VALUE self ,VALUE a0){VALUE bind=rb_hash_new(); BSET(regex_9,a0); int x;VALUE arg0,arg1,arg2,arg3;
