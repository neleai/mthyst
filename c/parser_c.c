...
VALUE AmethystParser___args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=rb_hash_new(); BSET(o_1,a0);BSET(c_1,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 BSET(autovar_1,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self);   it=CALL(rubyarg,0 ); FAILTEST(break1);
 BSET(autovar_2,it); it=CALL(__args_AmethystParsercb_4,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
...
VALUE oldinput1; while(1){oldinput1=ame_getpos(self);  arg0=CALL(addargs_AmethystParsercb_1,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break1);
...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 ...
 if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=CALL(addargs_AmethystParsercb_4,1,bind); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
VALUE AmethystParser_args(VALUE self ,VALUE a0,VALUE a1){VALUE vals[2]; VALUE bind=rb_hash_new(); BSET(o_1,a0);BSET(c_1,a1); int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 BSET(autovar_1,it); VALUE oldinput1=ame_getpos(self);  VALUE oldsrc1=IGET(src); int fail1=0;
ISET(src,rb_ary_new3(1,BGET(autovar_1))); ame_setpos(self,INT2FIX(0));
   it=CALL(anything,0 ); FAILTEST(pass1);
 BSET(autovar_2,it); VALUE oldinput2=ame_getpos(self);  VALUE oldsrc2=IGET(src); int fail2=0;
ISET(src,BGET(autovar_2)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success2;
	pass2: fail2=1;
	success2: ISET(src,oldsrc2); ame_setpos(self,oldinput2);
	if(fail2) goto pass1;

	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
	success1: ISET(src,oldsrc1); ame_setpos(self,oldinput1);
	if(fail1) goto fail;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
it=CALL(atomicHostExpr_AmethystParsercb_1,1,bind); 
 BSET(autovar_1,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self); VALUE oldinput2=ame_getpos(self);
alt1_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(endline,0 ); FAILTEST(alt1_2);ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt1_2); 
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(empty,0 ); FAILTEST(alt1_3); 
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldinput2); goto break1;
 accept1:;
  it=CALL(anything,0 ); FAILTEST(break1);
 BSET(autovar_2,it); it=CALL(atomicHostExpr_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
 BSET(s_1,it); it=CALL(atomicHostExpr_AmethystParsercb_3,1,bind); 
 BSET(autovar_3,it); VALUE oldinput3=ame_getpos(self);  VALUE oldsrc1=IGET(src); int fail1=0;
ISET(src,rb_ary_new3(1,BGET(autovar_3))); ame_setpos(self,INT2FIX(0));
   it=CALL(anything,0 ); FAILTEST(pass1);
 BSET(autovar_4,it); VALUE oldinput4=ame_getpos(self);  VALUE oldsrc2=IGET(src); int fail2=0;
ISET(src,BGET(autovar_4)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success2;
	pass2: fail2=1;
	success2: ISET(src,oldsrc2); ame_setpos(self,oldinput4);
	if(fail2) goto pass1;

	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
	success1: ISET(src,oldsrc1); ame_setpos(self,oldinput3);
	if(fail1) goto fail;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
VALUE AmethystParser_className(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 BSET(autovar_3,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self);   it=CALL(nameRest,0 ); FAILTEST(break1);
 BSET(autovar_4,it); it=CALL(className_AmethystParsercb_4,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_3);
...
VALUE AmethystParser_grammar(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 BSET(name_1,it); VALUE oldinput1=ame_getpos(self);
alt1_1: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ISET(cut,Qnil);goto accept1;
 ...
 BSET(autovar_1,it); VALUE oldinput2; while(1){oldinput2=ame_getpos(self);   it=CALL(rule,0 ); FAILTEST(break1);
 BSET(autovar_2,it); it=CALL(grammar_AmethystParsercb_6,1,bind);  if (IGET(stop)!=Qnil){{oldinput2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput2); it=BGET(autovar_1);
...
alt1_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_2,it); VALUE oldinput3=ame_getpos(self);
alt2_1: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_2;}
...
alt2_2: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_2;}
   it=CALL(empty,0 ); FAILTEST(alt2_3); 
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldinput3); goto alt1_2;
 accept2:;
  it=CALL(anything,0 ); FAILTEST(alt1_2);
 BSET(autovar_3,it); it=CALL(igrammar_AmethystParsercb_4,1,bind); VALUE oldinput4; while(1){oldinput4=ame_getpos(self); VALUE oldinput5=ame_getpos(self);
alt3_1: ame_setpos(self,oldinput5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
...
alt3_2: ame_setpos(self,oldinput5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
   it=CALL(empty,0 ); FAILTEST(alt3_3); 
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldinput5); goto break2;
 accept3:;
  it=CALL(anything,0 ); FAILTEST(break2);
 BSET(autovar_4,it); it=CALL(igrammar_AmethystParsercb_6,1,bind);  if (IGET(stop)!=Qnil){{oldinput4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput4); it=BGET(autovar_2);
...
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldinput2); goto break1;
 accept1:;
it=CALL(igrammar_AmethystParsercb_8,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
...
alt1_2: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_1,it); VALUE oldinput2; while(1){oldinput2=ame_getpos(self); VALUE oldinput3=ame_getpos(self);
alt2_1: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(endline,0 ); FAILTEST(alt2_2);ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt2_2); 
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(empty,0 ); FAILTEST(alt2_3); 
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldinput3); goto break1;
 accept2:;
  it=CALL(anything,0 ); FAILTEST(break1);
 BSET(autovar_2,it); it=CALL(modifier_AmethystParsercb_3,1,bind);  if (IGET(stop)!=Qnil){{oldinput2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput2); it=BGET(autovar_1);
...
VALUE AmethystParser_name(VALUE self ){VALUE vals[0]; VALUE bind=rb_hash_new();  int x;VALUE arg0,arg1,arg2,arg3;VALUE it;
 ...
 BSET(autovar_3,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self);   it=CALL(nameRest,0 ); FAILTEST(break1);
 BSET(autovar_4,it); it=CALL(name_AmethystParsercb_4,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_3);
...
it=CALL(number_AmethystParsercb_1,1,bind); 
 ...
 BSET(autovar_2,it); it=CALL(number_AmethystParsercb_3,1,bind); VALUE oldinput1; while(1){oldinput1=ame_getpos(self);  arg0=CALL(number_AmethystParsercb_4,1,bind); it=CALL(regch,1 ,arg0); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(number_AmethystParsercb_5,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 VALUE oldinput2=ame_getpos(self);
alt2_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
  arg0=CALL(prefixed_AmethystParsercb_3,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt2_2);
 BSET(neg_1,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_3;}
  arg0=CALL(prefixed_AmethystParsercb_4,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt2_3);
 BSET(neg_1,it);  
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldinput2); goto alt1_3;
 accept2:;
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 VALUE oldinput3=ame_getpos(self);
alt3_1: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_4;}
   it=CALL(modifier,0 ); FAILTEST(alt3_2);
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_4;}
  arg0=CALL(prefixed_AmethystParsercb_6,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt3_3);VALUE oldinput4=ame_getpos(self);
  arg0=CALL(prefixed_AmethystParsercb_7,1,bind); it=CALL(regch,1 ,arg0); FAILTEST(reject1); x=1; goto accept4;  reject1: x=0; accept4: it=Qnil; ame_setpos(self,oldinput4); if (x==0) goto alt3_3;VALUE oldinput5=ame_getpos(self);
alt4_1: ame_setpos(self,oldinput5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_3;}
  arg0=CALL(prefixed_AmethystParsercb_8,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt4_2); 
ISET(cut,Qnil);goto accept5;
alt4_2: ame_setpos(self,oldinput5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt3_3;}
   it=CALL(empty,0 ); FAILTEST(alt4_3); 
ISET(cut,Qnil);goto accept5;
  alt4_3:  ame_setpos(self,oldinput5); goto alt3_3;
 accept5:;
it=CALL(prefixed_AmethystParsercb_9,1,bind); 
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldinput3); goto alt1_4;
 accept3:;
VALUE oldinput6; while(1){oldinput6=ame_getpos(self); VALUE oldinput7=ame_getpos(self);
alt5_1: ame_setpos(self,oldinput7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(_,0 ); FAILTEST(alt5_2);ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt5_2); 
ISET(cut,Qnil);goto accept6;
alt5_2: ame_setpos(self,oldinput7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(empty,0 ); FAILTEST(alt5_3); 
ISET(cut,Qnil);goto accept6;
  alt5_3:  ame_setpos(self,oldinput7); goto break1;
 accept6:;
VALUE oldinput8=ame_getpos(self);
alt6_1: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
...
alt6_2: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
...
ISET(cut,Qnil);goto accept7;
alt6_3: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 VALUE oldinput9=ame_getpos(self);
alt7_1: ame_setpos(self,oldinput9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
  arg0=CALL(prefixed_AmethystParsercb_15,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt7_2);
 BSET(one_1,it);  
ISET(cut,Qnil);goto accept8;
alt7_2: ame_setpos(self,oldinput9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_4;}
  arg0=CALL(prefixed_AmethystParsercb_16,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt7_3);
 BSET(one_1,it);  
ISET(cut,Qnil);goto accept8;
  alt7_3:  ame_setpos(self,oldinput9); goto alt6_4;
 accept8:;
it=CALL(prefixed_AmethystParsercb_17,1,bind); 
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept7;
alt6_4: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept7;
alt6_5: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(prefixed_AmethystParsercb_20,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt6_6);VALUE oldinput10=ame_getpos(self);
alt8_1: ame_setpos(self,oldinput10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_6;}
 VALUE oldinput11=ame_getpos(self);
alt9_1: ame_setpos(self,oldinput11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
   it=CALL(key,0 ); FAILTEST(alt9_2);
 BSET(name_1,it);  
ISET(cut,Qnil);goto accept10;
alt9_2: ame_setpos(self,oldinput11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
   it=CALL(name,0 ); FAILTEST(alt9_3);
 BSET(name_1,it);  
ISET(cut,Qnil);goto accept10;
  alt9_3:  ame_setpos(self,oldinput11); goto alt8_2;
 accept10:;
VALUE oldinput12=ame_getpos(self);
alt10_1: ame_setpos(self,oldinput12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
...
alt10_2: ame_setpos(self,oldinput12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt8_2;}
   it=CALL(empty,0 ); FAILTEST(alt10_3);it=CALL(prefixed_AmethystParsercb_23,1,bind); 
 BSET(append_1,it);  
ISET(cut,Qnil);goto accept11;
  alt10_3:  ame_setpos(self,oldinput12); goto alt8_2;
 accept11:;
it=CALL(prefixed_AmethystParsercb_24,1,bind); 
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept9;
alt8_2: ame_setpos(self,oldinput10);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt6_6;}
   it=CALL(inlineHostExpr,0 ); FAILTEST(alt8_3);
 BSET(e_1,it); it=CALL(prefixed_AmethystParsercb_25,1,bind); 
 BSET(from_1,it);  
ISET(cut,Qnil);goto accept9;
  alt8_3:  ame_setpos(self,oldinput10); goto alt6_6;
 accept9:;
 
ISET(cut,Qnil);goto accept7;
  alt6_6:  ame_setpos(self,oldinput8); goto break1;
 accept7:;
 if (IGET(stop)!=Qnil){{oldinput6=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput6); it=BGET(from_1);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldinput1); goto fail;
 accept1:;
...
it=CALL(procargs_AmethystParsercb_1,1,bind); VALUE oldinput1; while(1){oldinput1=ame_getpos(self); VALUE oldinput2=ame_getpos(self);
alt1_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(anything,0 ); FAILTEST(alt1_2);
...
ISET(cut,Qnil);goto accept1;
  alt1_3:  ame_setpos(self,oldinput2); goto break1;
 accept1:;
 if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=CALL(procargs_AmethystParsercb_4,1,bind); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_2,it); VALUE oldinput3; while(1){oldinput3=ame_getpos(self);   it=CALL(procargs2,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(procargs2_AmethystParsercb_3,1,bind);  if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=BGET(autovar_2);
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_3: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_2,it); VALUE oldinput2; while(1){oldinput2=ame_getpos(self); VALUE oldinput3=ame_getpos(self);
alt2_1: ame_setpos(self,oldinput3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
...
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldinput3); goto break1;
 accept2:;
it=CALL(rubyarg_AmethystParsercb_14,1,bind);  if (IGET(stop)!=Qnil){{oldinput2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput2); it=BGET(autovar_2);
 BSET(autovar_4,it); it=CALL(rubyarg_AmethystParsercb_15,1,bind); it=CALL(rubyarg_AmethystParsercb_16,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_6,it); VALUE oldinput4; while(1){oldinput4=ame_getpos(self); VALUE oldinput5=ame_getpos(self);
alt3_1: ame_setpos(self,oldinput5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
...
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldinput5); goto break2;
 accept3:;
it=CALL(rubyarg_AmethystParsercb_21,1,bind);  if (IGET(stop)!=Qnil){{oldinput4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput4); it=BGET(autovar_6);
 BSET(autovar_8,it); it=CALL(rubyarg_AmethystParsercb_22,1,bind); it=CALL(rubyarg_AmethystParsercb_23,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(rubyarg_AmethystParsercb_24,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_8);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(rubyarg_AmethystParsercb_25,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt1_9);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_9: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 VALUE oldinput6=ame_getpos(self);
alt4_1: ame_setpos(self,oldinput6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
  arg0=CALL(rubyarg_AmethystParsercb_26,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt4_2);
 BSET(n_1,it);  
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldinput6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
  arg0=CALL(rubyarg_AmethystParsercb_27,1,bind); it=CALL(regch,1 ,arg0); FAILTEST(alt4_3);
 BSET(n_1,it);  
ISET(cut,Qnil);goto accept4;
alt4_3: ame_setpos(self,oldinput6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
   it=CALL(empty,0 ); FAILTEST(alt4_4); 
ISET(cut,Qnil);goto accept4;
  alt4_4:  ame_setpos(self,oldinput6); goto alt1_10;
 accept4:;
VALUE oldinput7=ame_getpos(self);
alt5_1: ame_setpos(self,oldinput7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
   it=CALL(_,0 ); FAILTEST(alt5_2);ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt5_2); 
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldinput7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_10;}
   it=CALL(empty,0 ); FAILTEST(alt5_3); 
ISET(cut,Qnil);goto accept5;
  alt5_3:  ame_setpos(self,oldinput7); goto alt1_10;
 accept5:;
  it=CALL(name,0 ); FAILTEST(alt1_10);
 BSET(autovar_9,it); it=CALL(rubyarg_AmethystParsercb_28,1,bind); it=BGET(n_1);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 VALUE oldinput8=ame_getpos(self);
alt6_1: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_11;}
   it=CALL(_,0 ); FAILTEST(alt6_2);ISET(cut,Qtrue);  it=CALL(fails,0 ); FAILTEST(alt6_2); 
ISET(cut,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_11;}
   it=CALL(empty,0 ); FAILTEST(alt6_3); 
ISET(cut,Qnil);goto accept6;
  alt6_3:  ame_setpos(self,oldinput8); goto alt1_11;
 accept6:;
  it=CALL(key,0 ); FAILTEST(alt1_11);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_11: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(rubyarg_AmethystParsercb_29,1,bind); it=CALL(regch,1 ,arg0); FAILTEST(alt1_12);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_12:  ame_setpos(self,oldinput1); goto fail;
 accept1:;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
it=CALL(sequence_AmethystParsercb_1,1,bind); 
 BSET(autovar_1,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self);   it=CALL(nr,0 ); FAILTEST(break1);  it=CALL(prefixed,0 ); FAILTEST(break1);
 BSET(autovar_2,it); it=CALL(sequence_AmethystParsercb_2,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
...
alt1_6: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 VALUE oldinput2=ame_getpos(self);
alt2_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
  arg0=CALL(term_AmethystParsercb_9,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt2_2);  it=CALL(atomicHostExpr,0 ); FAILTEST(alt2_2);
 BSET(x_1,it);  
ISET(cut,Qnil);goto accept2;
alt2_2: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_7;}
  arg0=CALL(term_AmethystParsercb_10,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt2_3);  it=CALL(inlineHostExpr,0 ); FAILTEST(alt2_3);
 BSET(x_1,it);  
ISET(cut,Qnil);goto accept2;
  alt2_3:  ame_setpos(self,oldinput2); goto alt1_7;
 accept2:;
it=CALL(term_AmethystParsercb_11,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(term_AmethystParsercb_12,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt1_8);VALUE oldinput3; while(1){oldinput3=ame_getpos(self); VALUE oldinput4=ame_getpos(self);
alt3_1: ame_setpos(self,oldinput4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(term_AmethystParsercb_13,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt3_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept3;
alt3_2: ame_setpos(self,oldinput4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(eChar,0 ); FAILTEST(alt3_3);
 BSET(autovar_1,it); it=CALL(term_AmethystParsercb_14,1,bind);  
ISET(cut,Qnil);goto accept3;
  alt3_3:  ame_setpos(self,oldinput4); goto break1;
 accept3:;
 if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=CALL(term_AmethystParsercb_15,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(term_AmethystParsercb_16,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt1_9);VALUE oldinput5; while(1){oldinput5=ame_getpos(self); VALUE oldinput6=ame_getpos(self);
alt4_1: ame_setpos(self,oldinput6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
  arg0=CALL(term_AmethystParsercb_17,1,bind); it=CALL(seq,1 ,arg0); FAILTEST(alt4_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept4;
alt4_2: ame_setpos(self,oldinput6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break2;}
   it=CALL(eChar,0 ); FAILTEST(alt4_3);
 BSET(autovar_2,it); it=CALL(term_AmethystParsercb_18,1,bind);  
ISET(cut,Qnil);goto accept4;
  alt4_3:  ame_setpos(self,oldinput6); goto break2;
 accept4:;
 if (IGET(stop)!=Qnil){{oldinput5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput5); it=CALL(term_AmethystParsercb_19,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_9: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
...
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(term_AmethystParsercb_21,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt1_11);VALUE oldinput7; while(1){oldinput7=ame_getpos(self); VALUE oldinput8=ame_getpos(self);
alt5_1: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
  arg0=CALL(term_AmethystParsercb_22,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt5_2);ISET(cut,Qtrue);ISET(stop,Qtrue); 
ISET(cut,Qnil);goto accept5;
alt5_2: ame_setpos(self,oldinput8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break3;}
   it=CALL(eChar,0 ); FAILTEST(alt5_3);
 BSET(autovar_3,it); it=CALL(term_AmethystParsercb_23,1,bind);  
ISET(cut,Qnil);goto accept5;
  alt5_3:  ame_setpos(self,oldinput8); goto break3;
 accept5:;
 if (IGET(stop)!=Qnil){{oldinput7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldinput7); it=CALL(term_AmethystParsercb_24,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_11: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(term_AmethystParsercb_25,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt1_12);  it=CALL(expression,0 ); FAILTEST(alt1_12);
 BSET(x_1,it);  arg0=CALL(term_AmethystParsercb_26,1,bind); it=CALL(token,1 ,arg0); FAILTEST(alt1_12);VALUE oldinput9=ame_getpos(self);
alt6_1: ame_setpos(self,oldinput9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_12;}
 ...
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept6;
alt6_2: ame_setpos(self,oldinput9);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt1_12;}
   it=CALL(empty,0 ); FAILTEST(alt6_3);it=BGET(x_1);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept6;
  alt6_3:  ame_setpos(self,oldinput9); goto alt1_12;
 accept6:;
