...
ame_setsrc(self,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_1,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  arg0=CALL(itrans_Analyze_Variables2cb_7,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break2);
...
it=CALL(itrans_Analyze_Variables2cb_8,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_1);
 BSET(rules_1,it); 
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(itrans_Analyze_Variables2cb_11,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=BGET(autovar_2);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_5))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
