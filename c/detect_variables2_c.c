...
it=CALL(flat_Analyze_Variables2cb_1,1,bind); 
 BSET(autovar_1,it); it=CALL(flat_Analyze_Variables2cb_2,1,bind); 
...
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_3,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_2);
...
alt1_2: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_4,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_3);
...
it=CALL(itrans_Analyze_Variables2cb_1,1,bind); 
 ...
 BSET(autovar_2,it); it=CALL(itrans_Analyze_Variables2cb_3,1,bind); 
 BSET(autovar_2,it); int oldpos1; while(1){oldpos1=ame_getpos(self); int oldpos2=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(itrans_Analyze_Variables2cb_4,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_2);
...
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_4,it); it=CALL(itrans_Analyze_Variables2cb_6,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(itrans_Analyze_Variables2cb_7,1,bind); 
 BSET(autovar_1,it); int oldpos6; while(1){oldpos6=ame_getpos(self);  arg0=CALL(itrans_Analyze_Variables2cb_8,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break2);
...
it=CALL(itrans_Analyze_Variables2cb_9,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_1);
 BSET(rules_1,it); 
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(itrans_Analyze_Variables2cb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos1); it=BGET(autovar_2);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(visit_Analyze_Variables2cb_6,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_3);
 BSET(autovar_4,it); int oldpos5=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(traverse,0 ); FAILTEST(pass4);it=CALL(visit_Analyze_Variables2cb_7,1,bind); 
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  arg0=CALL(visit_Analyze_Variables2cb_9,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(pass6);
 BSET(_result_1,it); 
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(visit_Analyze_Variables2cb_10,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_4);
