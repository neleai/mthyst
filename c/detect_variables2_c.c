...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(flat_Analyze_Variables2cb_2,1,bind); 
...
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_3,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt2_2);
 BSET(autovar_2,it); it=CALL(flat_Analyze_Variables2cb_4,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
alt3_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
   it=CALL(flat,0 ); FAILTEST(alt3_2); 
...
alt2_2: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(flat_Analyze_Variables2cb_5,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt2_3);
 BSET(autovar_3,it); it=CALL(flat_Analyze_Variables2cb_6,1,bind); int oldpos6=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
alt4_1: ame_setpos(self,oldpos7);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
   it=CALL(flat,0 ); FAILTEST(alt4_2); 
...
alt2_3: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
   it=CALL(anything,0 ); FAILTEST(alt2_4); 
ISET(cut,Qnil);goto accept2;
  alt2_4:  ame_setpos(self,oldpos3); goto break1;
 accept2:;

 BSET(autovar_4,it); it=CALL(flat_Analyze_Variables2cb_7,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_1); 
...
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
  arg0=CALL(itrans_Analyze_Variables2cb_4,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt2_2);
 BSET(autovar_3,it); it=CALL(itrans_Analyze_Variables2cb_5,1,bind); int oldpos4=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos5=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 it=CALL(itrans_Analyze_Variables2cb_6,1,bind); 
 BSET(autovar_4,it); it=CALL(itrans_Analyze_Variables2cb_7,1,bind); int oldpos6=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_5,it); it=CALL(itrans_Analyze_Variables2cb_8,1,bind); int oldpos7=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
alt4_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
 it=CALL(itrans_Analyze_Variables2cb_9,1,bind); 
 BSET(autovar_1,it); int oldpos9; while(1){oldpos9=ame_getpos(self);  arg0=CALL(itrans_Analyze_Variables2cb_10,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break2);
 BSET(autovar_6,it); it=CALL(itrans_Analyze_Variables2cb_11,1,bind); int oldpos10=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
...
alt5_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass4;}
   it=CALL(root,0 ); FAILTEST(alt5_2); 
ISET(cut,Qnil);goto accept5;
 ...
 BSET(autovar_7,it); it=CALL(itrans_Analyze_Variables2cb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_1);
 BSET(rules_1,it);  
ISET(cut,Qnil);goto accept4;
...
it=CALL(itrans_Analyze_Variables2cb_13,1,bind); it=CALL(itrans_Analyze_Variables2cb_14,1,bind);  
ISET(cut,Qnil);goto accept3;
  alt3_2:  ame_setpos(self,oldpos5); goto pass1;
 accept3:;
...
ISET(cut,Qnil);goto accept2;
 ...
 BSET(autovar_8,it); it=CALL(itrans_Analyze_Variables2cb_15,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_2); 
ISET(cut,Qnil);goto accept1;
  alt1_2:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_1,it); it=CALL(root_Analyze_Variables2cb_2,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_2,it); it=CALL(root_Analyze_Variables2cb_4,1,bind); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos4=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos4);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
 it=CALL(root_Analyze_Variables2cb_5,1,bind); it=CALL(root_Analyze_Variables2cb_6,1,bind); it=CALL(root_Analyze_Variables2cb_7,1,bind);   it=CALL(traverse,0 ); FAILTEST(alt2_2);it=CALL(root_Analyze_Variables2cb_8,1,bind); it=CALL(root_Analyze_Variables2cb_9,1,bind);  
ISET(cut,Qnil);goto accept2;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_1,it); it=CALL(visit_Analyze_Variables2cb_2,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos3=ame_getpos(self);
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
   it=CALL(traverse,0 ); FAILTEST(alt2_2);it=CALL(visit_Analyze_Variables2cb_3,1,bind); 
 BSET(autovar_2,it); it=CALL(visit_Analyze_Variables2cb_4,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_2)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(anything,0 ); FAILTEST(pass2);
 BSET(autovar_3,it); it=CALL(visit_Analyze_Variables2cb_5,1,bind); int oldpos5=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
ame_setsrc(self,BGET(autovar_3)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=CALL(visit_Analyze_Variables2cb_6,1,bind); it=CALL(visit_Analyze_Variables2cb_7,1,bind);  
ISET(cut,Qnil);goto accept2;
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(visit_Analyze_Variables2cb_8,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_3);
 BSET(autovar_4,it); it=CALL(visit_Analyze_Variables2cb_9,1,bind); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos8=ame_getpos(self);
alt4_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass4;}
   it=CALL(traverse,0 ); FAILTEST(alt4_2);it=CALL(visit_Analyze_Variables2cb_10,1,bind); 
 BSET(autovar_5,it); it=CALL(visit_Analyze_Variables2cb_11,1,bind); int oldpos9=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
   it=CALL(anything,0 ); FAILTEST(pass5);
 BSET(autovar_6,it); it=CALL(visit_Analyze_Variables2cb_12,1,bind); int oldpos10=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos11=ame_getpos(self);
alt5_1: ame_setpos(self,oldpos11);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass6;}
 int oldpos12=ame_getpos(self);
alt6_1: ame_setpos(self,oldpos12);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto alt5_2;}
  arg0=CALL(visit_Analyze_Variables2cb_13,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt6_2); 
ISET(cut,Qnil);goto accept6;
  alt6_2:  ame_setpos(self,oldpos12); goto alt5_2;
 accept6:;
 
ISET(cut,Qnil);goto accept5;
  alt5_2:  ame_setpos(self,oldpos11); goto pass6;
 accept5:;
...
ISET(cut,Qnil);goto accept4;
  alt4_2:  ame_setpos(self,oldpos8); goto pass4;
 accept4:;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(visit_Analyze_Variables2cb_14,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_4);
 BSET(autovar_7,it); it=CALL(visit_Analyze_Variables2cb_15,1,bind); int oldpos13=ame_getpos(self); int oldlen7=ame_getlen(self); VALUE oldsrc7=ame_getsrc(self); int fail7=0;
...
alt7_1: ame_setpos(self,oldpos14);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass7;}
 it=CALL(visit_Analyze_Variables2cb_16,1,bind); it=CALL(visit_Analyze_Variables2cb_17,1,bind);  
ISET(cut,Qnil);goto accept7;
  alt7_2:  ame_setpos(self,oldpos14); goto pass7;
 accept7:;
