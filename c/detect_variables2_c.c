...
alt1_1: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_2,it); VALUE oldinput3=ame_getpos(self);  VALUE oldsrc1=IGET(src); int fail1=0;
...
alt1_3: ame_setpos(self,oldinput2);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto break1;}
 ...
 BSET(autovar_3,it);  
ISET(cut,Qnil);goto accept1;
  alt1_4:  ame_setpos(self,oldinput2); goto break1;
 accept1:;
it=CALL(flat_Analyze_Variables2cb_4,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
...
ISET(src,BGET(autovar_2)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_3,it); VALUE oldinput4=ame_getpos(self);  VALUE oldsrc2=IGET(src); int fail2=0;
ISET(src,rb_ary_new3(1,BGET(autovar_3))); ame_setpos(self,INT2FIX(0));
   it=CALL(anything,0 ); FAILTEST(pass2);
 BSET(autovar_4,it); VALUE oldinput5=ame_getpos(self);  VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_4)); ame_setpos(self,INT2FIX(0));
 it=CALL(itrans_Analyze_Variables2cb_4,1,bind); 
 BSET(autovar_5,it); VALUE oldinput6; while(1){oldinput6=ame_getpos(self);  arg0=CALL(itrans_Analyze_Variables2cb_5,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(break2);
 BSET(autovar_6,it); VALUE oldinput7=ame_getpos(self);  VALUE oldsrc4=IGET(src); int fail4=0;
...
it=CALL(itrans_Analyze_Variables2cb_6,1,bind);  if (IGET(stop)!=Qnil){{oldinput6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput6); it=BGET(autovar_5);
 BSET(rules_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
	success3: ISET(src,oldsrc3); ame_setpos(self,oldinput5);
	if(fail3) goto pass2;
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(itrans_Analyze_Variables2cb_9,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
