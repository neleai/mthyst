...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_2,it); VALUE oldinput3; while(1){oldinput3=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(arg_AmethystTranslatorcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=BGET(autovar_2);
 BSET(a_1,it); 
...
ISET(src,BGET(autovar_4)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_5,it); VALUE oldinput5; while(1){oldinput5=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break2);
 BSET(autovar_6,it); it=CALL(arg_AmethystTranslatorcb_7,1,bind);  if (IGET(stop)!=Qnil){{oldinput5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput5); it=BGET(autovar_5);
 BSET(a_1,it); 
...
alt1_3: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_7,it); VALUE oldinput6=ame_getpos(self);  VALUE oldsrc3=IGET(src); int fail3=0;
...
alt1_4: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldinput7=ame_getpos(self);  VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(name_1,it); 
	...
	goto success4;
	pass4: fail4=1;
	success4: ISET(src,oldsrc4); ame_setpos(self,oldinput7);
...
alt1_5: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_9,it); VALUE oldinput8=ame_getpos(self);  VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_9)); ame_setpos(self,INT2FIX(0));
 VALUE oldinput9; while(1){oldinput9=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldinput9=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldinput9); it=CALL(arg_AmethystTranslatorcb_14,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass5;
	goto success5;
	pass5: fail5=1;
	success5: ISET(src,oldsrc5); ame_setpos(self,oldinput8);
...
alt1_6: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_10,it); VALUE oldinput10=ame_getpos(self);  VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,BGET(autovar_10)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(name_1,it); 
	...
	goto success6;
	pass6: fail6=1;
	success6: ISET(src,oldsrc6); ame_setpos(self,oldinput10);
...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_2,it); VALUE oldinput3; while(1){oldinput3=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(args_AmethystTranslatorcb_3,1,bind);  if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=BGET(autovar_2);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
alt1_2: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_4,it); VALUE oldinput4; while(1){oldinput4=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break2);
 BSET(autovar_5,it); it=CALL(args_AmethystTranslatorcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldinput4=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput4); it=BGET(autovar_4);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
it=CALL(itrans_AmethystTranslatorcb_2,1,bind);  if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=BGET(autovar_1);
...
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_9,it); VALUE oldinput9; while(1){oldinput9=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break2);
 BSET(autovar_10,it); it=CALL(trans_AmethystTranslatorcb_21,1,bind);  if (IGET(stop)!=Qnil){{oldinput9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput9); it=BGET(autovar_9);
 BSET(t_1,it); 
	if (CALL(eof,0)==failobj) goto pass6;
	goto success6;
	pass6: fail6=1;
...
ISET(src,BGET(autovar_14)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_15,it); VALUE oldinput14=ame_getpos(self);  VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,rb_ary_new3(1,BGET(autovar_15))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(o_1,it); 
	...
	goto success11;
	pass11: fail11=1;
	success11: ISET(src,oldsrc11); ame_setpos(self,oldinput14);
...
alt1_9: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_16,it); VALUE oldinput15=ame_getpos(self);  VALUE oldsrc12=IGET(src); int fail12=0;
ISET(src,BGET(autovar_16)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_17,it); VALUE oldinput16=ame_getpos(self);  VALUE oldsrc13=IGET(src); int fail13=0;
ISET(src,BGET(autovar_17)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(name_1,it); 
	...
	goto success13;
	pass13: fail13=1;
	success13: ISET(src,oldsrc13); ame_setpos(self,oldinput16);
 ...
 BSET(argss_1,it); 
	...
	goto success12;
	pass12: fail12=1;
	success12: ISET(src,oldsrc12); ame_setpos(self,oldinput15);
...
alt1_10: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_18,it); VALUE oldinput17=ame_getpos(self);  VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,BGET(autovar_18)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(argss_1,it); 
	...
	goto success14;
	pass14: fail14=1;
	success14: ISET(src,oldsrc14); ame_setpos(self,oldinput17);
...
alt1_11: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_19,it); VALUE oldinput18=ame_getpos(self);  VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_19)); ame_setpos(self,INT2FIX(0));
 it=CALL(trans_AmethystTranslatorcb_44,1,bind); 
 BSET(autovar_20,it); VALUE oldinput19=ame_getpos(self);  VALUE oldsrc16=IGET(src); int fail16=0;
ISET(src,rb_ary_new3(1,BGET(autovar_20))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(name_1,it); 
	...
	goto success16;
	pass16: fail16=1;
	success16: ISET(src,oldsrc16); ame_setpos(self,oldinput19);
	if(fail16) goto pass15;
it=CALL(trans_AmethystTranslatorcb_45,1,bind); 
 BSET(autovar_21,it); VALUE oldinput20=ame_getpos(self);  VALUE oldsrc17=IGET(src); int fail17=0;
ISET(src,rb_ary_new3(1,BGET(autovar_21))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(expr_1,it); 
	...
	goto success17;
	pass17: fail17=1;
	success17: ISET(src,oldsrc17); ame_setpos(self,oldinput20);
...
it=CALL(trans_AmethystTranslatorcb_46,1,bind); 
 BSET(append_1,it); 
	...
	goto success15;
	pass15: fail15=1;
	success15: ISET(src,oldsrc15); ame_setpos(self,oldinput18);
...
alt1_12: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_22,it); VALUE oldinput21=ame_getpos(self);  VALUE oldsrc18=IGET(src); int fail18=0;
ISET(src,BGET(autovar_22)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_23,it); VALUE oldinput22=ame_getpos(self);  VALUE oldsrc19=IGET(src); int fail19=0;
ISET(src,rb_ary_new3(1,BGET(autovar_23))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(argss_1,it); 
	...
	goto success19;
	pass19: fail19=1;
	success19: ISET(src,oldsrc19); ame_setpos(self,oldinput22);
...
it=CALL(trans_AmethystTranslatorcb_51,1,bind); 
 BSET(vars_1,it); 
	...
	goto success18;
	pass18: fail18=1;
	success18: ISET(src,oldsrc18); ame_setpos(self,oldinput21);
...
alt1_13: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_24,it); VALUE oldinput23=ame_getpos(self);  VALUE oldsrc20=IGET(src); int fail20=0;
ISET(src,BGET(autovar_24)); ame_setpos(self,INT2FIX(0));
 VALUE oldinput24; while(1){oldinput24=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldinput24=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldinput24); it=CALL(trans_AmethystTranslatorcb_54,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass20;
	goto success20;
	pass20: fail20=1;
	success20: ISET(src,oldsrc20); ame_setpos(self,oldinput23);
...
alt1_14: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_25,it); VALUE oldinput25=ame_getpos(self);  VALUE oldsrc21=IGET(src); int fail21=0;
ISET(src,BGET(autovar_25)); ame_setpos(self,INT2FIX(0));
  arg0=CALL(trans_AmethystTranslatorcb_56,1,bind);arg1=CALL(trans_AmethystTranslatorcb_60,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(pass21);
	...
	goto success21;
	pass21: fail21=1;
	success21: ISET(src,oldsrc21); ame_setpos(self,oldinput25);
...
alt1_15: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_28,it); VALUE oldinput28=ame_getpos(self);  VALUE oldsrc24=IGET(src); int fail24=0;
ISET(src,BGET(autovar_28)); ame_setpos(self,INT2FIX(0));
 
	if (CALL(eof,0)==failobj) goto pass24;
	goto success24;
	pass24: fail24=1;
	success24: ISET(src,oldsrc24); ame_setpos(self,oldinput28);
	if(fail24) goto alt1_16;
it=CALL(trans_AmethystTranslatorcb_63,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_16: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystTranslatorcb_64,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_17);
 BSET(autovar_29,it); VALUE oldinput29=ame_getpos(self);  VALUE oldsrc25=IGET(src); int fail25=0;
ISET(src,BGET(autovar_29)); ame_setpos(self,INT2FIX(0));
 
	if (CALL(eof,0)==failobj) goto pass25;
	goto success25;
	pass25: fail25=1;
	success25: ISET(src,oldsrc25); ame_setpos(self,oldinput29);
	if(fail25) goto alt1_17;
it=CALL(trans_AmethystTranslatorcb_65,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_17:  ame_setpos(self,oldinput1); goto fail;
 accept1:;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_2,it); VALUE oldinput2; while(1){oldinput2=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(transs_AmethystTranslatorcb_2,1,bind);  if (IGET(stop)!=Qnil){{oldinput2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput2); it=BGET(autovar_2);
 BSET(t_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
it=CALL(trans_AmethystTranslatorcb_15,1,bind); 
 BSET(autovar_6,it); VALUE oldinput7; while(1){oldinput7=ame_getpos(self);   it=CALL(transfn,0 ); FAILTEST(break1);
 BSET(autovar_7,it); it=CALL(trans_AmethystTranslatorcb_16,1,bind);  if (IGET(stop)!=Qnil){{oldinput7=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput7); it=BGET(autovar_6);
 BSET(ors_1,it); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
it=CALL(trans_AmethystTranslatorcb_57,1,bind); 
 BSET(autovar_26,it); VALUE oldinput26=ame_getpos(self);  VALUE oldsrc22=IGET(src); int fail22=0;
ISET(src,rb_ary_new3(1,BGET(autovar_26))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(to_1,it); 
	...
	goto success22;
	pass22: fail22=1;
	success22: ISET(src,oldsrc22); ame_setpos(self,oldinput26);
	if(fail22) goto fail;
it=CALL(trans_AmethystTranslatorcb_58,1,bind); 
 BSET(autovar_27,it); VALUE oldinput27=ame_getpos(self);  VALUE oldsrc23=IGET(src); int fail23=0;
ISET(src,rb_ary_new3(1,BGET(autovar_27))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(var_1,it); 
	...
	goto success23;
	pass23: fail23=1;
	success23: ISET(src,oldsrc23); ame_setpos(self,oldinput27);
	if(fail23) goto fail;
