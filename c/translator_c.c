...
ISET(src,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_2,it); int oldpos3; while(1){oldpos3=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break1);
...
ISET(src,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_5,it); int oldpos5; while(1){oldpos5=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break2);
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_7,it); int oldpos6=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); int oldpos7=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_9,it); int oldpos8=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 int oldpos9; while(1){oldpos9=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=CALL(arg_AmethystTranslatorcb_14,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass5;
	goto success5;
	pass5: fail5=1;
	success5: ISET(src,oldsrc5); ame_setpos(self,oldpos8); ame_setlen(self,oldlen5);
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_10,it); int oldpos10=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(name_1,it); 
	...
	goto success6;
	pass6: fail6=1;
	success6: ISET(src,oldsrc6); ame_setpos(self,oldpos10); ame_setlen(self,oldlen6);
...
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_4,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break2);
...
ISET(src,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_9,it); int oldpos9; while(1){oldpos9=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break2);
...
ISET(src,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_15,it); int oldpos14=ame_getpos(self); int oldlen11=ame_getlen(self); VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,rb_ary_new3(1,BGET(autovar_15))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(o_1,it); 
	...
	goto success11;
	pass11: fail11=1;
	success11: ISET(src,oldsrc11); ame_setpos(self,oldpos14); ame_setlen(self,oldlen11);
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_16,it); int oldpos15=ame_getpos(self); int oldlen12=ame_getlen(self); VALUE oldsrc12=IGET(src); int fail12=0;
ISET(src,BGET(autovar_16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
  arg0=CALL(trans_AmethystTranslatorcb_39,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(pass12);
 BSET(autovar_17,it); int oldpos16=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=IGET(src); int fail13=0;
ISET(src,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(name_1,it); 
	...
	goto success13;
	pass13: fail13=1;
	success13: ISET(src,oldsrc13); ame_setpos(self,oldpos16); ame_setlen(self,oldlen13);
 ...
 BSET(argss_1,it); 
	...
	goto success12;
	pass12: fail12=1;
	success12: ISET(src,oldsrc12); ame_setpos(self,oldpos15); ame_setlen(self,oldlen12);
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_18,it); int oldpos17=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,BGET(autovar_18)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(argss_1,it); 
	...
	goto success14;
	pass14: fail14=1;
	success14: ISET(src,oldsrc14); ame_setpos(self,oldpos17); ame_setlen(self,oldlen14);
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_19,it); int oldpos18=ame_getpos(self); int oldlen15=ame_getlen(self); VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 it=CALL(trans_AmethystTranslatorcb_44,1,bind); 
 BSET(autovar_20,it); int oldpos19=ame_getpos(self); int oldlen16=ame_getlen(self); VALUE oldsrc16=IGET(src); int fail16=0;
ISET(src,rb_ary_new3(1,BGET(autovar_20))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(arg,0 ); FAILTEST(pass16);
 BSET(name_1,it); 
	if (CALL(eof,0)==failobj) goto pass16;
	goto success16;
	pass16: fail16=1;
	success16: ISET(src,oldsrc16); ame_setpos(self,oldpos19); ame_setlen(self,oldlen16);
	if(fail16) goto pass15;
it=CALL(trans_AmethystTranslatorcb_45,1,bind); 
 BSET(autovar_21,it); int oldpos20=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=IGET(src); int fail17=0;
ISET(src,rb_ary_new3(1,BGET(autovar_21))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(expr_1,it); 
	...
	goto success17;
	pass17: fail17=1;
	success17: ISET(src,oldsrc17); ame_setpos(self,oldpos20); ame_setlen(self,oldlen17);
...
it=CALL(trans_AmethystTranslatorcb_46,1,bind); 
 BSET(append_1,it); 
	...
	goto success15;
	pass15: fail15=1;
	success15: ISET(src,oldsrc15); ame_setpos(self,oldpos18); ame_setlen(self,oldlen15);
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_22,it); int oldpos21=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=IGET(src); int fail18=0;
ISET(src,BGET(autovar_22)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_23,it); int oldpos22=ame_getpos(self); int oldlen19=ame_getlen(self); VALUE oldsrc19=IGET(src); int fail19=0;
ISET(src,rb_ary_new3(1,BGET(autovar_23))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(args,0 ); FAILTEST(pass19);
 BSET(argss_1,it); 
	if (CALL(eof,0)==failobj) goto pass19;
	goto success19;
	pass19: fail19=1;
	success19: ISET(src,oldsrc19); ame_setpos(self,oldpos22); ame_setlen(self,oldlen19);
...
it=CALL(trans_AmethystTranslatorcb_51,1,bind); 
 BSET(vars_1,it); 
	...
	goto success18;
	pass18: fail18=1;
	success18: ISET(src,oldsrc18); ame_setpos(self,oldpos21); ame_setlen(self,oldlen18);
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_24,it); int oldpos23=ame_getpos(self); int oldlen20=ame_getlen(self); VALUE oldsrc20=IGET(src); int fail20=0;
ISET(src,BGET(autovar_24)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 int oldpos24; while(1){oldpos24=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3); if (IGET(stop)!=Qnil){{oldpos24=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos24); it=CALL(trans_AmethystTranslatorcb_54,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass20;
	goto success20;
	pass20: fail20=1;
	success20: ISET(src,oldsrc20); ame_setpos(self,oldpos23); ame_setlen(self,oldlen20);
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_25,it); int oldpos25=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=IGET(src); int fail21=0;
ISET(src,BGET(autovar_25)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
  arg0=CALL(trans_AmethystTranslatorcb_56,1,bind);arg1=CALL(trans_AmethystTranslatorcb_60,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(pass21);
	...
	goto success21;
	pass21: fail21=1;
	success21: ISET(src,oldsrc21); ame_setpos(self,oldpos25); ame_setlen(self,oldlen21);
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_28,it); int oldpos28=ame_getpos(self); int oldlen24=ame_getlen(self); VALUE oldsrc24=IGET(src); int fail24=0;
ISET(src,BGET(autovar_28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
	...
	goto success24;
	pass24: fail24=1;
	success24: ISET(src,oldsrc24); ame_setpos(self,oldpos28); ame_setlen(self,oldlen24);
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_29,it); int oldpos29=ame_getpos(self); int oldlen25=ame_getlen(self); VALUE oldsrc25=IGET(src); int fail25=0;
ISET(src,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
	...
	goto success25;
	pass25: fail25=1;
	success25: ISET(src,oldsrc25); ame_setpos(self,oldpos29); ame_setlen(self,oldlen25);
...
ISET(src,BGET(autovar_1)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
 ...
 BSET(autovar_2,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break1);
...
ISET(src,rb_ary_new3(1,BGET(autovar_4))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
...
it=CALL(trans_AmethystTranslatorcb_15,1,bind); 
 BSET(autovar_6,it); int oldpos7; while(1){oldpos7=ame_getpos(self);   it=CALL(transfn,0 ); FAILTEST(break1);
...
it=CALL(trans_AmethystTranslatorcb_57,1,bind); 
 BSET(autovar_26,it); int oldpos26=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=IGET(src); int fail22=0;
ISET(src,rb_ary_new3(1,BGET(autovar_26))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(trans,0 ); FAILTEST(pass22);
 BSET(to_1,it); 
	if (CALL(eof,0)==failobj) goto pass22;
	goto success22;
	pass22: fail22=1;
	success22: ISET(src,oldsrc22); ame_setpos(self,oldpos26); ame_setlen(self,oldlen22);
	if(fail22) goto fail;
it=CALL(trans_AmethystTranslatorcb_58,1,bind); 
 BSET(autovar_27,it); int oldpos27=ame_getpos(self); int oldlen23=ame_getlen(self); VALUE oldsrc23=IGET(src); int fail23=0;
ISET(src,rb_ary_new3(1,BGET(autovar_27))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(IGET(src),rb_intern("size"),0)));
   it=CALL(arg,0 ); FAILTEST(pass23);
 BSET(var_1,it); 
	if (CALL(eof,0)==failobj) goto pass23;
	goto success23;
	pass23: fail23=1;
	success23: ISET(src,oldsrc23); ame_setpos(self,oldpos27); ame_setlen(self,oldlen23);
	if(fail23) goto fail;
