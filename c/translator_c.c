...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_7,it); VALUE oldpos6=ame_getpos(self); VALUE oldlen3=ame_getlen(self); VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_7)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldpos7=ame_getpos(self); VALUE oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
...
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_9,it); VALUE oldpos8=ame_getpos(self); VALUE oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
ISET(src,BGET(autovar_9)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_10,it); VALUE oldpos10=ame_getpos(self); VALUE oldlen6=ame_getlen(self); VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,BGET(autovar_10)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_5,it); VALUE oldpos6=ame_getpos(self); VALUE oldlen5=ame_getlen(self); VALUE oldsrc5=IGET(src); int fail5=0;
...
ISET(src,BGET(autovar_14)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_15,it); VALUE oldpos14=ame_getpos(self); VALUE oldlen11=ame_getlen(self); VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,rb_ary_new3(1,BGET(autovar_15))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_16,it); VALUE oldpos15=ame_getpos(self); VALUE oldlen12=ame_getlen(self); VALUE oldsrc12=IGET(src); int fail12=0;
ISET(src,BGET(autovar_16)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
  arg0=CALL(trans_AmethystTranslatorcb_39,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(pass12);
 BSET(autovar_17,it); VALUE oldpos16=ame_getpos(self); VALUE oldlen13=ame_getlen(self); VALUE oldsrc13=IGET(src); int fail13=0;
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_18,it); VALUE oldpos17=ame_getpos(self); VALUE oldlen14=ame_getlen(self); VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,BGET(autovar_18)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_19,it); VALUE oldpos18=ame_getpos(self); VALUE oldlen15=ame_getlen(self); VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_19)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 it=CALL(trans_AmethystTranslatorcb_44,1,bind); 
 BSET(autovar_20,it); VALUE oldpos19=ame_getpos(self); VALUE oldlen16=ame_getlen(self); VALUE oldsrc16=IGET(src); int fail16=0;
ISET(src,rb_ary_new3(1,BGET(autovar_20))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_AmethystTranslatorcb_45,1,bind); 
 BSET(autovar_21,it); VALUE oldpos20=ame_getpos(self); VALUE oldlen17=ame_getlen(self); VALUE oldsrc17=IGET(src); int fail17=0;
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_22,it); VALUE oldpos21=ame_getpos(self); VALUE oldlen18=ame_getlen(self); VALUE oldsrc18=IGET(src); int fail18=0;
ISET(src,BGET(autovar_22)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
 ...
 BSET(autovar_23,it); VALUE oldpos22=ame_getpos(self); VALUE oldlen19=ame_getlen(self); VALUE oldsrc19=IGET(src); int fail19=0;
ISET(src,rb_ary_new3(1,BGET(autovar_23))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_24,it); VALUE oldpos23=ame_getpos(self); VALUE oldlen20=ame_getlen(self); VALUE oldsrc20=IGET(src); int fail20=0;
ISET(src,BGET(autovar_24)); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_25,it); VALUE oldpos25=ame_getpos(self); VALUE oldlen21=ame_getlen(self); VALUE oldsrc21=IGET(src); int fail21=0;
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_28,it); VALUE oldpos28=ame_getpos(self); VALUE oldlen24=ame_getlen(self); VALUE oldsrc24=IGET(src); int fail24=0;
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_29,it); VALUE oldpos29=ame_getpos(self); VALUE oldlen25=ame_getlen(self); VALUE oldsrc25=IGET(src); int fail25=0;
...
it=CALL(trans_AmethystTranslatorcb_9,1,bind); 
 ...
 BSET(autovar_4,it); VALUE oldpos5=ame_getpos(self); VALUE oldlen4=ame_getlen(self); VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,rb_ary_new3(1,BGET(autovar_4))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_AmethystTranslatorcb_57,1,bind); 
 BSET(autovar_26,it); VALUE oldpos26=ame_getpos(self); VALUE oldlen22=ame_getlen(self); VALUE oldsrc22=IGET(src); int fail22=0;
ISET(src,rb_ary_new3(1,BGET(autovar_26))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
...
it=CALL(trans_AmethystTranslatorcb_58,1,bind); 
 BSET(autovar_27,it); VALUE oldpos27=ame_getpos(self); VALUE oldlen23=ame_getlen(self); VALUE oldsrc23=IGET(src); int fail23=0;
ISET(src,rb_ary_new3(1,BGET(autovar_27))); ame_setpos(self,INT2FIX(0)); ame_setlen(self,rb_funcall(IGET(src),rb_intern("size"),0));
