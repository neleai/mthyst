...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_2,BGET(it)); VALUE oldinput193; while(1){oldinput193=IGET(input);   BSET(it,AmethystOptimizer_arg(self)); FAILTEST(break192);
...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_2,BGET(it)); VALUE oldinput179; while(1){oldinput179=IGET(input);   BSET(it,AmethystOptimizer_arg(self)); FAILTEST(break178);
...
alt172: ISET(input,oldinput170);if (IGET(cut)!=Qnil) goto fail;
 ...
 BSET(autovar_4,BGET(it)); VALUE oldinput182; while(1){oldinput182=IGET(input);   BSET(it,AmethystOptimizer_arg(self)); FAILTEST(break181);
...
ISET(src,BGET(autovar_6)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_7,BGET(it)); VALUE oldinput45; while(1){oldinput45=IGET(input);   BSET(it,AmethystOptimizer_transfn(self)); FAILTEST(break44);
...
ISET(src,BGET(autovar_9)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_10,BGET(it)); VALUE oldinput53; while(1){oldinput53=IGET(input);   BSET(it,AmethystOptimizer_trans(self)); FAILTEST(break52);
...
ISET(src,BGET(autovar_19)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_20,BGET(it)); BSET(it,CALL(trans_cb36,1,bind));   BSET(it,AmethystOptimizer_args(self)); FAILTEST(pass75);
...
ISET(src,BGET(autovar_29)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_30,BGET(it)); VALUE oldinput125; while(1){oldinput125=IGET(input);   BSET(it,AmethystOptimizer_arg(self)); FAILTEST(break124);
...
ISET(src,BGET(autovar_1)); ISET(input,INT2FIX(0));
 ...
 BSET(autovar_2,BGET(it)); VALUE oldinput168; while(1){oldinput168=IGET(input);   BSET(it,AmethystOptimizer_trans(self)); FAILTEST(break167);
