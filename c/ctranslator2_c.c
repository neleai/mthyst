...
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_2))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=CALL(rbcode_AmethystCTranslatorcb_5,1,bind); 
 BSET(autovar_5,it); it=CALL(rbcode_AmethystCTranslatorcb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos3); it=BGET(autovar_1);
 BSET(x_1,it); 
...
ame_setsrc(self,BGET(autovar_6)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_7,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_7))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_8)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_9,it); it=CALL(trans_AmethystCTranslatorcb_16,1,bind);  if (IGET(stop)!=Qnil){{oldpos5=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos5); it=BGET(autovar_1);
 BSET(t_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
 ...
 BSET(rbcode_1,it); it=CALL(trans_AmethystCTranslatorcb_17,1,bind); 
 BSET(s_1,it); it=CALL(trans_AmethystCTranslatorcb_18,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_19,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_3);
...
ame_setsrc(self,BGET(autovar_10)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystCTranslatorcb_21,1,bind); it=CALL(trans_AmethystCTranslatorcb_22,1,bind); 
 BSET(autovar_11,it); int oldpos7=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_11))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_24,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_4);
...
ame_setsrc(self,BGET(autovar_12)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_13,it); it=CALL(trans_AmethystCTranslatorcb_26,1,bind);  if (IGET(stop)!=Qnil){{oldpos9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos9); it=BGET(autovar_2);
...
ISET(cut,Qnil);goto accept1;
alt1_4: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_29,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_5);
...
ame_setsrc(self,BGET(autovar_14)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_15,it); int oldpos11=ame_getpos(self); int oldlen8=ame_getlen(self); VALUE oldsrc8=ame_getsrc(self); int fail8=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_15))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ame_setsrc(self,BGET(autovar_16)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
  arg0=CALL(trans_AmethystCTranslatorcb_30,1,bind); it=CALL(token,1 ,arg0); FAILTEST(pass9);
...
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_32,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_6);
...
ame_setsrc(self,BGET(autovar_17)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystCTranslatorcb_33,1,bind); 
 ...
 BSET(autovar_18,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind);  if (IGET(stop)!=Qnil){{oldpos14=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldpos14); it=BGET(autovar_3);
 BSET(args_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_36,1,bind); it=CALL(failwrap,1 ,arg0); FAILTEST(pass10);
 BSET(_result_1,it); 
...
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_37,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_7);
...
ame_setsrc(self,BGET(autovar_19)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_20,it); it=CALL(trans_AmethystCTranslatorcb_39,1,bind);  if (IGET(stop)!=Qnil){{oldpos16=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos16); it=BGET(autovar_4);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_40,1,bind); 
 BSET(_result_1,it); 
...
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_41,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_8);
...
ame_setsrc(self,BGET(autovar_21)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_22,it); int oldpos18=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_22))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_44,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_9);
...
ame_setsrc(self,BGET(autovar_23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_46,1,bind); 
 BSET(fail_1,it); it=CALL(trans_AmethystCTranslatorcb_47,1,bind); 
 BSET(oldpos_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_48,1,bind); it=CALL(label,1 ,arg0); FAILTEST(pass14);
 BSET(alt_1,it); it=CALL(trans_AmethystCTranslatorcb_49,1,bind); 
 BSET(altno_1,it); it=CALL(trans_AmethystCTranslatorcb_50,1,bind); 
 BSET(autovar_5,it); int oldpos20; while(1){oldpos20=ame_getpos(self); int oldpos21=ame_getpos(self);
   it=CALL(anything,0 ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldpos21); if (x==0) goto break5;it=CALL(trans_AmethystCTranslatorcb_51,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_52,1,bind);arg1=CALL(trans_AmethystCTranslatorcb_53,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(break5);
 BSET(autovar_24,it); it=CALL(trans_AmethystCTranslatorcb_54,1,bind);  if (IGET(stop)!=Qnil){{oldpos20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos20); it=BGET(autovar_5);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_55,1,bind); it=CALL(trans_AmethystCTranslatorcb_56,1,bind); it=CALL(trans_AmethystCTranslatorcb_57,1,bind); 
 BSET(_result_1,it); 
...
alt1_9: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_58,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_10);
...
it=CALL(trans_AmethystCTranslatorcb_59,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_60,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_11);
...
it=CALL(trans_AmethystCTranslatorcb_61,1,bind); 
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_62,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_12);
...
ame_setsrc(self,BGET(autovar_27)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(brk_1,it); it=CALL(trans_AmethystCTranslatorcb_64,1,bind); 
 BSET(oldpos_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_65,1,bind);arg1=CALL(trans_AmethystCTranslatorcb_66,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(pass17);it=CALL(trans_AmethystCTranslatorcb_67,1,bind); 
 BSET(_result_1,it); 
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_68,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_13);
...
ame_setsrc(self,BGET(autovar_28)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(accept_1,it); it=CALL(trans_AmethystCTranslatorcb_70,1,bind); 
 BSET(reject_1,it); it=CALL(trans_AmethystCTranslatorcb_71,1,bind); 
 BSET(oldpos_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_72,1,bind);arg1=CALL(trans_AmethystCTranslatorcb_73,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(pass18);it=CALL(trans_AmethystCTranslatorcb_74,1,bind); 
 BSET(_result_1,it); 
...
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_75,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_14);
...
ame_setsrc(self,BGET(autovar_29)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos27; while(1){oldpos27=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break6); if (IGET(stop)!=Qnil){{oldpos27=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldpos27); it=CALL(trans_AmethystCTranslatorcb_76,1,bind); 
 BSET(_result_1,it); 
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_77,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_15);
...
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_31))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_80,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_16);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(fail_1,it);  arg0=CALL(trans_AmethystCTranslatorcb_87,1,bind);arg1=CALL(trans_AmethystCTranslatorcb_89,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(pass22);it=CALL(trans_AmethystCTranslatorcb_90,1,bind); 
 BSET(_result_1,it); 
...
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_33))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
