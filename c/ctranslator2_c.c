...
it=CALL(itrans_AmethystCTranslatorcb_1,1,bind); 
 ...
 BSET(init_1,it); VALUE oldinput1; while(1){oldinput1=ame_getpos(self); VALUE oldinput2=ame_getpos(self);
...
ISET(cut,Qnil);goto accept1;
 ...
 accept1:;
 if (IGET(stop)!=Qnil){{oldinput1=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput1); it=CALL(itrans_AmethystCTranslatorcb_6,1,bind); 
 BSET(_result_1,it); it=BGET(_result_1);
return it;
fail: return failobj; }
...
ISET(src,BGET(autovar_2)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_3,it); VALUE oldinput3; while(1){oldinput3=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break1);
 BSET(autovar_4,it); VALUE oldinput4=ame_getpos(self);  VALUE oldsrc3=IGET(src); int fail3=0;
...
it=CALL(rbcode_AmethystCTranslatorcb_4,1,bind); 
 BSET(autovar_5,it); it=CALL(rbcode_AmethystCTranslatorcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=BGET(autovar_3);
 BSET(x_1,it); 
...
ISET(src,BGET(autovar_1)); ame_setpos(self,INT2FIX(0));
 VALUE oldinput3; while(1){oldinput3=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break1); if (IGET(stop)!=Qnil){{oldinput3=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput3); it=CALL(rbtrans_AmethystCTranslatorcb_2,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass1;
	goto success1;
	pass1: fail1=1;
...
ISET(src,BGET(autovar_2)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_3,it); VALUE oldinput5; while(1){oldinput5=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break2);
 BSET(autovar_4,it); it=CALL(rbtrans_AmethystCTranslatorcb_5,1,bind);  if (IGET(stop)!=Qnil){{oldinput5=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput5); it=BGET(autovar_3);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass2;
	goto success2;
	pass2: fail2=1;
...
alt1_3: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_5,it); VALUE oldinput6=ame_getpos(self);  VALUE oldsrc3=IGET(src); int fail3=0;
ISET(src,BGET(autovar_5)); ame_setpos(self,INT2FIX(0));
 it=CALL(rbtrans_AmethystCTranslatorcb_8,1,bind); 
 BSET(autovar_6,it); VALUE oldinput7; while(1){oldinput7=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break3);
 BSET(autovar_7,it); it=CALL(rbtrans_AmethystCTranslatorcb_9,1,bind);  if (IGET(stop)!=Qnil){{oldinput7=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldinput7); it=BGET(autovar_6);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
	success3: ISET(src,oldsrc3); ame_setpos(self,oldinput6);
...
alt1_4: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_8,it); VALUE oldinput8=ame_getpos(self);  VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0));
 it=CALL(rbtrans_AmethystCTranslatorcb_12,1,bind); 
 BSET(autovar_9,it); VALUE oldinput9; while(1){oldinput9=ame_getpos(self);   it=CALL(rbtrans,0 ); FAILTEST(break4);
 BSET(autovar_10,it); it=CALL(rbtrans_AmethystCTranslatorcb_13,1,bind);  if (IGET(stop)!=Qnil){{oldinput9=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldinput9); it=BGET(autovar_9);
 BSET(a_1,it); 
	if (CALL(eof,0)==failobj) goto pass4;
	goto success4;
	pass4: fail4=1;
	success4: ISET(src,oldsrc4); ame_setpos(self,oldinput8);
...
alt1_5: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_11,it); VALUE oldinput10=ame_getpos(self);  VALUE oldsrc5=IGET(src); int fail5=0;
...
alt1_6: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_12,it); VALUE oldinput11=ame_getpos(self);  VALUE oldsrc6=IGET(src); int fail6=0;
...
alt1_7: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_13,it); VALUE oldinput12=ame_getpos(self);  VALUE oldsrc7=IGET(src); int fail7=0;
...
alt1_8: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
  alt1_9:  ame_setpos(self,oldinput1); goto fail;
 accept1:;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
ISET(src,BGET(autovar_3)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_4,it); VALUE oldinput5; while(1){oldinput5=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break1);
 BSET(autovar_5,it); it=CALL(trans_AmethystCTranslatorcb_11,1,bind);  if (IGET(stop)!=Qnil){{oldinput5=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldinput5); it=BGET(autovar_4);
 BSET(t_1,it); 
	if (CALL(eof,0)==failobj) goto pass3;
	goto success3;
	pass3: fail3=1;
...
alt1_2: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_6,it); VALUE oldinput6=ame_getpos(self);  VALUE oldsrc4=IGET(src); int fail4=0;
ISET(src,BGET(autovar_6)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_7,it); VALUE oldinput7=ame_getpos(self);  VALUE oldsrc5=IGET(src); int fail5=0;
...
it=CALL(trans_AmethystCTranslatorcb_18,1,bind); 
 BSET(_result_1,it); 
	...
	goto success4;
	pass4: fail4=1;
	success4: ISET(src,oldsrc4); ame_setpos(self,oldinput6);
	if(fail4) goto alt1_3;
 
ISET(cut,Qnil);goto accept1;
alt1_3: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_19,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_4);
 BSET(autovar_8,it); VALUE oldinput8=ame_getpos(self);  VALUE oldsrc6=IGET(src); int fail6=0;
ISET(src,BGET(autovar_8)); ame_setpos(self,INT2FIX(0));
 it=CALL(trans_AmethystCTranslatorcb_20,1,bind); 
 BSET(autovar_9,it); VALUE oldinput9; while(1){oldinput9=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break2);
 BSET(autovar_10,it); it=CALL(trans_AmethystCTranslatorcb_21,1,bind);  if (IGET(stop)!=Qnil){{oldinput9=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldinput9); it=BGET(autovar_9);
...
alt1_4: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_11,it); VALUE oldinput10=ame_getpos(self);  VALUE oldsrc7=IGET(src); int fail7=0;
ISET(src,BGET(autovar_11)); ame_setpos(self,INT2FIX(0));
   it=CALL(anything,0 ); FAILTEST(pass7);
 BSET(autovar_12,it); VALUE oldinput11=ame_getpos(self);  VALUE oldsrc8=IGET(src); int fail8=0;
ISET(src,rb_ary_new3(1,BGET(autovar_12))); ame_setpos(self,INT2FIX(0));
   it=CALL(anything,0 ); FAILTEST(pass8);
 BSET(autovar_13,it); VALUE oldinput12=ame_getpos(self);  VALUE oldsrc9=IGET(src); int fail9=0;
ISET(src,BGET(autovar_13)); ame_setpos(self,INT2FIX(0));
  arg0=CALL(trans_AmethystCTranslatorcb_25,1,bind); it=CALL(token,1 ,arg0); FAILTEST(pass9);
	if (CALL(eof,0)==failobj) goto pass9;
	goto success9;
	pass9: fail9=1;
	success9: ISET(src,oldsrc9); ame_setpos(self,oldinput12);
	if(fail9) goto pass8;

	if (CALL(eof,0)==failobj) goto pass8;
	goto success8;
	pass8: fail8=1;
	success8: ISET(src,oldsrc8); ame_setpos(self,oldinput11);
	if(fail8) goto pass7;
it=CALL(trans_AmethystCTranslatorcb_26,1,bind); 
 BSET(_result_1,it); 
	...
	goto success7;
	pass7: fail7=1;
	success7: ISET(src,oldsrc7); ame_setpos(self,oldinput10);
	if(fail7) goto alt1_5;
 
ISET(cut,Qnil);goto accept1;
alt1_5: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_27,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_6);
 BSET(autovar_14,it); VALUE oldinput13=ame_getpos(self);  VALUE oldsrc10=IGET(src); int fail10=0;
ISET(src,BGET(autovar_14)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_15,it); VALUE oldinput14; while(1){oldinput14=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break3);
 BSET(it_1,it); it=CALL(trans_AmethystCTranslatorcb_29,1,bind); 
 BSET(autovar_16,it); it=CALL(trans_AmethystCTranslatorcb_30,1,bind);  if (IGET(stop)!=Qnil){{oldinput14=ame_getpos(self);goto break3;} } } break3: ISET(stop,Qnil);  ame_setpos(self,oldinput14); it=BGET(autovar_15);
 ...
 BSET(_result_1,it); 
	...
	goto success10;
	pass10: fail10=1;
	success10: ISET(src,oldsrc10); ame_setpos(self,oldinput13);
	if(fail10) goto alt1_6;
 
ISET(cut,Qnil);goto accept1;
alt1_6: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_32,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_7);
 BSET(autovar_17,it); VALUE oldinput15=ame_getpos(self);  VALUE oldsrc11=IGET(src); int fail11=0;
ISET(src,BGET(autovar_17)); ame_setpos(self,INT2FIX(0));
 it=CALL(trans_AmethystCTranslatorcb_33,1,bind); 
 BSET(autovar_18,it); VALUE oldinput16; while(1){oldinput16=ame_getpos(self);   it=CALL(trans,0 ); FAILTEST(break4);
 BSET(autovar_19,it); it=CALL(trans_AmethystCTranslatorcb_34,1,bind);  if (IGET(stop)!=Qnil){{oldinput16=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldinput16); it=BGET(autovar_18);
 BSET(t_1,it); it=CALL(trans_AmethystCTranslatorcb_35,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass11;
	goto success11;
	pass11: fail11=1;
	success11: ISET(src,oldsrc11); ame_setpos(self,oldinput15);
	if(fail11) goto alt1_7;
 
ISET(cut,Qnil);goto accept1;
alt1_7: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_36,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_8);
 BSET(autovar_20,it); VALUE oldinput17=ame_getpos(self);  VALUE oldsrc12=IGET(src); int fail12=0;
ISET(src,BGET(autovar_20)); ame_setpos(self,INT2FIX(0));
 it=CALL(trans_AmethystCTranslatorcb_37,1,bind); 
 BSET(autovar_21,it); VALUE oldinput18=ame_getpos(self);  VALUE oldsrc13=IGET(src); int fail13=0;
ISET(src,rb_ary_new3(1,BGET(autovar_21))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(e_1,it); 
	...
	goto success13;
	pass13: fail13=1;
	success13: ISET(src,oldsrc13); ame_setpos(self,oldinput18);
...
it=CALL(trans_AmethystCTranslatorcb_38,1,bind); 
 BSET(_result_1,it); 
	...
	goto success12;
	pass12: fail12=1;
	success12: ISET(src,oldsrc12); ame_setpos(self,oldinput17);
	if(fail12) goto alt1_8;
 
ISET(cut,Qnil);goto accept1;
alt1_8: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_39,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_9);
 BSET(autovar_22,it); VALUE oldinput19=ame_getpos(self);  VALUE oldsrc14=IGET(src); int fail14=0;
ISET(src,BGET(autovar_22)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(autovar_23,it); VALUE oldinput20; while(1){oldinput20=ame_getpos(self); VALUE oldinput21=ame_getpos(self);
   it=CALL(anything,0 ); FAILTEST(reject1); x=1; goto accept2;  reject1: x=0; accept2: it=Qnil; ame_setpos(self,oldinput21); if (x==0) goto break5;it=CALL(trans_AmethystCTranslatorcb_46,1,bind);  arg0=CALL(trans_AmethystCTranslatorcb_47,1,bind);arg1=CALL(trans_AmethystCTranslatorcb_48,1,bind); it=CALL(rw,2 ,arg0,arg1); FAILTEST(break5);
 BSET(autovar_24,it); it=CALL(trans_AmethystCTranslatorcb_49,1,bind);  if (IGET(stop)!=Qnil){{oldinput20=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldinput20); it=BGET(autovar_23);
 ...
 BSET(_result_1,it); 
	...
	goto success14;
	pass14: fail14=1;
	success14: ISET(src,oldsrc14); ame_setpos(self,oldinput19);
...
alt1_9: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_25,it); VALUE oldinput22=ame_getpos(self);  VALUE oldsrc15=IGET(src); int fail15=0;
ISET(src,BGET(autovar_25)); ame_setpos(self,INT2FIX(0));
 
	if (CALL(eof,0)==failobj) goto pass15;
	goto success15;
	pass15: fail15=1;
	success15: ISET(src,oldsrc15); ame_setpos(self,oldinput22);
...
alt1_10: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_26,it); VALUE oldinput23=ame_getpos(self);  VALUE oldsrc16=IGET(src); int fail16=0;
ISET(src,BGET(autovar_26)); ame_setpos(self,INT2FIX(0));
 
	if (CALL(eof,0)==failobj) goto pass16;
	goto success16;
	pass16: fail16=1;
	success16: ISET(src,oldsrc16); ame_setpos(self,oldinput23);
...
alt1_11: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 ...
 BSET(autovar_27,it); VALUE oldinput24=ame_getpos(self);  VALUE oldsrc17=IGET(src); int fail17=0;
ISET(src,BGET(autovar_27)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success17;
	pass17: fail17=1;
	success17: ISET(src,oldsrc17); ame_setpos(self,oldinput24);
	if(fail17) goto alt1_12;
 
ISET(cut,Qnil);goto accept1;
alt1_12: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_63,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_13);
 BSET(autovar_28,it); VALUE oldinput25=ame_getpos(self);  VALUE oldsrc18=IGET(src); int fail18=0;
ISET(src,BGET(autovar_28)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success18;
	pass18: fail18=1;
	success18: ISET(src,oldsrc18); ame_setpos(self,oldinput25);
	if(fail18) goto alt1_13;
 
ISET(cut,Qnil);goto accept1;
alt1_13: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_70,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_14);
 BSET(autovar_29,it); VALUE oldinput26=ame_getpos(self);  VALUE oldsrc19=IGET(src); int fail19=0;
ISET(src,BGET(autovar_29)); ame_setpos(self,INT2FIX(0));
 VALUE oldinput27; while(1){oldinput27=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break6); if (IGET(stop)!=Qnil){{oldinput27=ame_getpos(self);goto break6;} } } break6: ISET(stop,Qnil);  ame_setpos(self,oldinput27); it=CALL(trans_AmethystCTranslatorcb_71,1,bind); 
 BSET(_result_1,it); 
	if (CALL(eof,0)==failobj) goto pass19;
	goto success19;
	pass19: fail19=1;
	success19: ISET(src,oldsrc19); ame_setpos(self,oldinput26);
	if(fail19) goto alt1_14;
 
ISET(cut,Qnil);goto accept1;
alt1_14: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_72,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_15);
 BSET(autovar_30,it); VALUE oldinput28=ame_getpos(self);  VALUE oldsrc20=IGET(src); int fail20=0;
ISET(src,BGET(autovar_30)); ame_setpos(self,INT2FIX(0));
 it=CALL(trans_AmethystCTranslatorcb_73,1,bind); 
 BSET(autovar_31,it); VALUE oldinput29=ame_getpos(self);  VALUE oldsrc21=IGET(src); int fail21=0;
ISET(src,rb_ary_new3(1,BGET(autovar_31))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(argss_1,it); 
	...
	goto success21;
	pass21: fail21=1;
	success21: ISET(src,oldsrc21); ame_setpos(self,oldinput29);
...
it=CALL(trans_AmethystCTranslatorcb_74,1,bind); 
 BSET(_result_1,it); 
	...
	goto success20;
	pass20: fail20=1;
	success20: ISET(src,oldsrc20); ame_setpos(self,oldinput28);
	if(fail20) goto alt1_15;
 
ISET(cut,Qnil);goto accept1;
alt1_15: ame_setpos(self,oldinput1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystCTranslatorcb_75,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_16);
 BSET(autovar_32,it); VALUE oldinput30=ame_getpos(self);  VALUE oldsrc22=IGET(src); int fail22=0;
ISET(src,BGET(autovar_32)); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success22;
	pass22: fail22=1;
	success22: ISET(src,oldsrc22); ame_setpos(self,oldinput30);
	if(fail22) goto alt1_16;
 
ISET(cut,Qnil);goto accept1;
  alt1_16:  ame_setpos(self,oldinput1); goto fail;
 accept1:;
it=BGET(_result_1);
return it;
fail: return failobj; }
...
it=CALL(trans_AmethystCTranslatorcb_82,1,bind); 
 BSET(autovar_33,it); VALUE oldinput31=ame_getpos(self);  VALUE oldsrc23=IGET(src); int fail23=0;
ISET(src,rb_ary_new3(1,BGET(autovar_33))); ame_setpos(self,INT2FIX(0));
 ...
 BSET(_result_1,it); 
	...
	goto success23;
	pass23: fail23=1;
	success23: ISET(src,oldsrc23); ame_setpos(self,oldinput31);
	if(fail23) goto fail;
it=BGET(_result_1);
return it;
fail: return failobj; }
