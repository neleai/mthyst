...
it=CALL(traverse_Traversercb_1,1,bind); 
 BSET(autovar_1,it); it=CALL(traverse_Traversercb_2,1,bind); 
 BSET(autovar_2,it); int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(traverse_Traversercb_3,1,bind); 
 BSET(autovar_1,it); int oldpos2; while(1){oldpos2=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(traverse_Traversercb_4,1,bind);  if (IGET(stop)!=Qnil){{oldpos2=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos2); it=BGET(autovar_1);it=CALL(traverse_Traversercb_5,1,bind); 
 BSET(this_1,it); it=CALL(traverse_Traversercb_6,1,bind); 
 BSET(autovar_4,it); it=CALL(traverse_Traversercb_7,1,bind); int oldpos3=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_5,it); it=CALL(traverse_Traversercb_8,1,bind); int oldpos4=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
alt2_1: ame_setpos(self,oldpos5);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
 it=CALL(traverse_Traversercb_9,1,bind); 
 BSET(autovar_2,it); int oldpos6; while(1){oldpos6=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break2);
 BSET(autovar_6,it); it=CALL(traverse_Traversercb_10,1,bind); int oldpos7=ame_getpos(self); int oldlen3=ame_getlen(self); VALUE oldsrc3=ame_getsrc(self); int fail3=0;
...
alt3_1: ame_setpos(self,oldpos8);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass3;}
   it=CALL(anything,0 ); FAILTEST(alt3_2);
 BSET(key_1,it);   it=CALL(traverse_item,0 ); FAILTEST(alt3_2);
 BSET(it_1,it); it=CALL(traverse_Traversercb_11,1,bind);  
ISET(cut,Qnil);goto accept3;
  alt3_2:  ame_setpos(self,oldpos8); goto pass3;
 accept3:;
 ...
 BSET(autovar_7,it); it=CALL(traverse_Traversercb_12,1,bind);  if (IGET(stop)!=Qnil){{oldpos6=ame_getpos(self);goto break2;} } } break2: ISET(stop,Qnil);  ame_setpos(self,oldpos6); it=BGET(autovar_2); 
ISET(cut,Qnil);goto accept2;
  alt2_2:  ame_setpos(self,oldpos5); goto pass2;
 accept2:;
...
it=CALL(traverse_Traversercb_13,1,bind);  
...
it=CALL(traverse_item_Traversercb_1,1,bind); 
 BSET(autovar_1,it); int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=CALL(visit,0 ); FAILTEST(alt1_2);
 BSET(a_1,it); it=CALL(traverse_item_Traversercb_2,1,bind); it=BGET(a_1); 
ISET(cut,Qnil);goto accept1;
alt1_2: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(traverse_item_Traversercb_3,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_3);
 BSET(autovar_2,it); it=CALL(traverse_item_Traversercb_4,1,bind); int oldpos2=ame_getpos(self); int oldlen1=ame_getlen(self); VALUE oldsrc1=ame_getsrc(self); int fail1=0;
...
alt2_1: ame_setpos(self,oldpos3);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass1;}
 ...
 BSET(autovar_1,it); int oldpos4; while(1){oldpos4=ame_getpos(self);   it=CALL(traverse_item,0 ); FAILTEST(break1);
 BSET(autovar_3,it); it=CALL(traverse_item_Traversercb_6,1,bind);  if (IGET(stop)!=Qnil){{oldpos4=ame_getpos(self);goto break1;} } } break1: ISET(stop,Qnil);  ame_setpos(self,oldpos4); it=BGET(autovar_1); 
ISET(cut,Qnil);goto accept2;
...
alt1_3: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(traverse_item_Traversercb_7,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_4);
 BSET(autovar_4,it); it=CALL(traverse_item_Traversercb_8,1,bind); int oldpos5=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
ame_setsrc(self,BGET(autovar_4)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos6=ame_getpos(self);
alt3_1: ame_setpos(self,oldpos6);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto pass2;}
   it=CALL(traverse,0 ); FAILTEST(alt3_2); 
ISET(cut,Qnil);goto accept3;
...
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
 it=CALL(root_Detectorcb_1,1,bind);   it=CALL(traverse,0 ); FAILTEST(alt1_2);it=CALL(root_Detectorcb_2,1,bind);  
ISET(cut,Qnil);goto accept1;
  alt1_2:  ame_setpos(self,oldpos1); goto fail;
 accept1:;
...
int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
   it=CALL(detect,0 ); FAILTEST(alt1_2);
