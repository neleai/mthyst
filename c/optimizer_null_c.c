...
ame_setsrc(self,BGET(autovar_9)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_10,it); int oldpos9=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_10))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(args_1,it); 
	...
	if(fail5) goto pass4;
it=CALL(arg_AmethystOptimizercb_18,1,bind); 
 BSET(autovar_11,it); int oldpos10=ame_getpos(self); int oldlen6=ame_getlen(self); VALUE oldsrc6=ame_getsrc(self); int fail6=0;
...
it=CALL(trans_AmethystOptimizercb_1,1,bind); 
 ...
 BSET(ary_1,it); it=CALL(trans_AmethystOptimizercb_6,1,bind); 
 BSET(ary_1,it); it=CALL(trans_AmethystOptimizercb_7,1,bind); 
 BSET(ary_1,it); it=CALL(trans_AmethystOptimizercb_8,1,bind); 
 BSET(autovar_4,it); int oldpos1=ame_getpos(self);
alt1_1: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_9,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_2);
...
ame_setsrc(self,BGET(autovar_5)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystOptimizercb_11,1,bind); 
 BSET(parent_1,it); it=CALL(trans_AmethystOptimizercb_12,1,bind); 
 BSET(autovar_6,it); int oldpos3=ame_getpos(self); int oldlen2=ame_getlen(self); VALUE oldsrc2=ame_getsrc(self); int fail2=0;
...
ame_setsrc(self,BGET(autovar_7)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(name_1,it); it=CALL(trans_AmethystOptimizercb_16,1,bind); 
 BSET(autovar_8,it); int oldpos5=ame_getpos(self); int oldlen4=ame_getlen(self); VALUE oldsrc4=ame_getsrc(self); int fail4=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_8))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(args_1,it); 
	...
	if(fail4) goto pass3;
it=CALL(trans_AmethystOptimizercb_17,1,bind); 
 BSET(autovar_9,it); int oldpos6=ame_getpos(self); int oldlen5=ame_getlen(self); VALUE oldsrc5=ame_getsrc(self); int fail5=0;
...
ame_setsrc(self,BGET(autovar_23)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(autovar_24,it); int oldpos17=ame_getpos(self); int oldlen13=ame_getlen(self); VALUE oldsrc13=ame_getsrc(self); int fail13=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_24))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=CALL(trans_AmethystOptimizercb_47,1,bind); 
 BSET(autovar_25,it); int oldpos18=ame_getpos(self); int oldlen14=ame_getlen(self); VALUE oldsrc14=ame_getsrc(self); int fail14=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_25))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt1_10: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_50,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_11);
...
ame_setsrc(self,BGET(autovar_26)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 ...
 BSET(ary_1,it); it=CALL(trans_AmethystOptimizercb_51,1,bind); 
 BSET(pred_1,it); 
...
alt1_11: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_53,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_12);
...
ame_setsrc(self,BGET(autovar_27)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystOptimizercb_54,1,bind); 
 BSET(name_1,it); it=CALL(trans_AmethystOptimizercb_55,1,bind); 
 BSET(autovar_28,it); int oldpos21=ame_getpos(self); int oldlen17=ame_getlen(self); VALUE oldsrc17=ame_getsrc(self); int fail17=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_28))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
it=CALL(trans_AmethystOptimizercb_56,1,bind); 
 BSET(autovar_29,it); int oldpos22=ame_getpos(self); int oldlen18=ame_getlen(self); VALUE oldsrc18=ame_getsrc(self); int fail18=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_29))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt1_12: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_58,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_13);
...
ame_setsrc(self,BGET(autovar_30)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystOptimizercb_59,1,bind); 
 BSET(autovar_4,it); int oldpos24; while(1){oldpos24=ame_getpos(self);   it=CALL(arg,0 ); FAILTEST(break4);
 BSET(autovar_31,it); it=CALL(trans_AmethystOptimizercb_60,1,bind);  if (IGET(stop)!=Qnil){{oldpos24=ame_getpos(self);goto break4;} } } break4: ISET(stop,Qnil);  ame_setpos(self,oldpos24); it=BGET(autovar_4);
 BSET(ary_1,it); 
...
it=CALL(trans_AmethystOptimizercb_61,1,bind);
 BSET(_result_1,it);  
ISET(cut,Qnil);goto accept1;
alt1_13: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_62,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_14);
...
ame_setsrc(self,BGET(autovar_32)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 it=CALL(trans_AmethystOptimizercb_63,1,bind); 
 BSET(autovar_33,it); int oldpos26=ame_getpos(self); int oldlen21=ame_getlen(self); VALUE oldsrc21=ame_getsrc(self); int fail21=0;
...
it=CALL(trans_AmethystOptimizercb_64,1,bind); 
 BSET(autovar_34,it); int oldpos27=ame_getpos(self); int oldlen22=ame_getlen(self); VALUE oldsrc22=ame_getsrc(self); int fail22=0;
ame_setsrc(self,rb_ary_new3(1,BGET(autovar_34))); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
...
alt1_14: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_67,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_15);
...
alt1_15: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_69,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_16);
...
alt1_16: ame_setpos(self,oldpos1);if (IGET(cut)!=Qnil) {ISET(cut,Qnil); goto fail;}
  arg0=CALL(trans_AmethystOptimizercb_71,1,bind); it=CALL(clas,1 ,arg0); FAILTEST(alt1_17);
...
ame_setsrc(self,BGET(autovar_37)); ame_setpos(self,0); ame_setlen(self,FIX2INT(rb_funcall(ame_getsrc(self),rb_intern("size"),0)));
 int oldpos31; while(1){oldpos31=ame_getpos(self);   it=CALL(anything,0 ); FAILTEST(break5); if (IGET(stop)!=Qnil){{oldpos31=ame_getpos(self);goto break5;} } } break5: ISET(stop,Qnil);  ame_setpos(self,oldpos31); it=CALL(trans_AmethystOptimizercb_72,1,bind); 
 BSET(_result_1,it); 
